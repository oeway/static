...
C$.tmpdir=$I$(4).get$S$SA(java.security.AccessController.doPrivileged$java_security_PrivilegedAction(Clazz.new_($I$(5,1).c$$S,["java.io.tmpdir"])), []);
C$.isPosix=$I$(6).getDefault$().supportedFileAttributeViews$().contains$O("posix");
C$.random=Clazz.new_($I$(7,1));
}
