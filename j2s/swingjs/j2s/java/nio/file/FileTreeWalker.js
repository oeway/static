...
this.stack=Clazz.new_(1,{E:"java.nio.file.FileTreeWalker.DirectoryNode"},$I$(1,1));
}, 1);
...
var ioe = e$$;
{
return Clazz.new_($I$(7,1).c$$java_nio_file_FileTreeWalker_EventType$java_nio_file_Path$java_io_IOException,[$I$(8).ENTRY, entry, ioe]);
}
...
return Clazz.new_($I$(7,1).c$$java_nio_file_FileTreeWalker_EventType$java_nio_file_Path$java_nio_file_attribute_BasicFileAttributes,[$I$(8).ENTRY, entry, attrs]);
}if (this.followLinks && p$1.wouldLoop$java_nio_file_Path$O.apply(this, [entry, attrs.fileKey$()]) ) {
return Clazz.new_($I$(7,1).c$$java_nio_file_FileTreeWalker_EventType$java_nio_file_Path$java_io_IOException,[$I$(8).ENTRY, entry, Clazz.new_(Clazz.load('java.nio.file.FileSystemLoopException').c$$S,[entry.toString()])]);
}var stream=null;
try {
...
this.stack.push$TE(Clazz.new_($I$(9,1).c$$java_nio_file_Path$O$java_nio_file_DirectoryStream,[entry, attrs.fileKey$(), stream]));
return Clazz.new_($I$(7,1).c$$java_nio_file_FileTreeWalker_EventType$java_nio_file_Path$java_nio_file_attribute_BasicFileAttributes,[$I$(8).START_DIRECTORY, entry, attrs]);
}, p$1);
...
this.stack.pop$();
return Clazz.new_($I$(7,1).c$$java_nio_file_FileTreeWalker_EventType$java_nio_file_Path$java_io_IOException,[$I$(8).END_DIRECTORY, top.directory$(), ioe]);
