(function(){var P$=Clazz.newPackage("java.nio.file.spi"),I$=[[0,'RuntimePermission','java.util.ArrayList','java.util.ServiceLoader','java.nio.file.FileSystems','Error','java.security.AccessController','java.util.Collections','java.nio.file.StandardOpenOption','java.nio.channels.Channels','java.nio.file.Files','java.util.HashSet']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var list=Clazz.new_(1,{E:"java.nio.file.spi.FileSystemProvider"},$I$(2,1));
...
var opts=Clazz.new_(1,{E:"java.nio.file.OpenOption"},$I$(11,1).c$$I,[len + 3]);
if (len == 0) {
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:49:44 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
