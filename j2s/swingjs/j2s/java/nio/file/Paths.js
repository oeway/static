(function(){var P$=Clazz.newPackage("java.nio.file"),I$=[[0,'java.nio.file.FileSystems','java.nio.file.spi.FileSystemProvider']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
