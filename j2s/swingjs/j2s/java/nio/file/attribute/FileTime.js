(function(){var P$=Clazz.newPackage("java.nio.file.attribute"),p$1={},I$=[[0,'java.util.Objects','java.util.concurrent.TimeUnit','AssertionError','java.time.Instant','java.time.LocalDateTime','java.time.ZoneOffset','StringBuilder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['L',['value'],'S',['valueAsString'],'O',['unit','java.util.concurrent.TimeUnit','instant','java.time.Instant']]]
