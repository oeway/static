(function(){var P$=Clazz.newPackage("java.nio.file.attribute"),I$=[[0,'StringBuilder','java.nio.file.attribute.PosixFilePermission','java.util.EnumSet','java.util.HashSet','java.util.Collections']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
perms=Clazz.new_(1,{E:"java.nio.file.attribute.PosixFilePermission"},$I$(4,1).c$$java_util_Collection,[perms]);
