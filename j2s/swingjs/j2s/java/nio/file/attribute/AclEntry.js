...
return Clazz.new_(1,{E:"java.nio.file.attribute.AclEntryPermission"},$I$(7,1).c$$java_util_Collection,[this.perms]);
});

Clazz.newMeth(C$, 'flags$', function () {
return Clazz.new_(1,{E:"java.nio.file.attribute.AclEntryFlag"},$I$(7,1).c$$java_util_Collection,[this.flags]);
});
