(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.HeapCharBuffer','java.nio.StringCharBuffer','java.util.stream.StreamSupport','java.nio.CharBufferSpliterator']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return $I$(3).intStream$java_util_function_Supplier$I$Z((P$.CharBuffer$lambda1$||(P$.CharBuffer$lambda1$=(((P$.CharBuffer$lambda1||
...
/*lambda_E*/
Clazz.newMeth(C$, 'get$', function () { return (Clazz.new_($I$(4,1).c$$java_nio_CharBuffer,[this.b$['java.nio.CharBuffer']]));});
})()
), Clazz.new_(1,{T:"? extends java.util.Spliterator.OfInt"},P$.CharBuffer$lambda1.$init$, [this, null]))))), 16464, false);
});
