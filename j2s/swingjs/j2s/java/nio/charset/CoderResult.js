(function(){var P$=Clazz.newPackage("java.nio.charset"),p$1={},I$=[[0,'java.util.HashMap','java.nio.charset.CoderResult',['java.nio.charset.CoderResult','.Cache']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var e=null;
if (this.cache == null ) {
this.cache=Clazz.new_(1,{K:"Integer",V:"java.nio.charset.CoderResult"},$I$(1,1));
