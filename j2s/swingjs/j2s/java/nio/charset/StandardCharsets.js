(function(){var P$=Clazz.newPackage("java.nio.charset"),I$=[[0,'java.nio.charset.Charset','AssertionError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
