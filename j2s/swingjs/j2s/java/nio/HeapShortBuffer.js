(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.HeapShortBufferR','java.nio.ByteOrder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(1,1).c$$HA$I$I$I$I$I,[this.hb, this.markValue$(), this.position$(), this.limit$(), this.capacity$(), this.offset]);
});
