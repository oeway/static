(function(){var P$=Clazz.newPackage("java.nio"),I$=[[0,'java.nio.Bits','java.nio.ByteOrder','java.nio.DirectByteBuffer','java.nio.HeapByteBuffer','StringBuffer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
