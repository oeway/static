...
return Clazz.new_($I$(1,1).c$$BA$I$I$I$I$I,[this.hb, this.markValue$(), this.position$(), this.limit$(), this.capacity$(), this.offset]);
});
...
return (this.bigEndian ? (Clazz.new_($I$(3,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])) : (Clazz.new_($I$(4,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])));
});
...
var size=this.remaining$() >> 1;
var off=this.offset + this.position$();
return (this.bigEndian ? (Clazz.new_($I$(5,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])) : (Clazz.new_($I$(6,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])));
});
...
var off=this.offset + this.position$();
return (this.bigEndian ? (Clazz.new_($I$(7,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])) : (Clazz.new_($I$(8,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])));
});
...
var off=this.offset + this.position$();
return (this.bigEndian ? (Clazz.new_($I$(9,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])) : (Clazz.new_($I$(10,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])));
});
...
var size=this.remaining$() >> 2;
var off=this.offset + this.position$();
return (this.bigEndian ? (Clazz.new_($I$(11,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])) : (Clazz.new_($I$(12,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])));
});
...
var size=this.remaining$() >> 3;
var off=this.offset + this.position$();
return (this.bigEndian ? (Clazz.new_($I$(13,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])) : (Clazz.new_($I$(14,1).c$$java_nio_ByteBuffer$I$I$I$I$I,[this, -1, 0, size, size, off])));
});
