(function(){var P$=Clazz.newPackage("java.text"),I$=[[0,'StringBuffer','java.text.FieldPosition','java.text.ParsePosition','java.text.AttributedString']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
