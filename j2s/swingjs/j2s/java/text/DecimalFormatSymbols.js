(function(){var P$=Clazz.newPackage("java.text"),p$1={},I$=[[0,'java.util.Hashtable','java.util.Locale','InternalError','sun.util.resources.LocaleData']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['C',['zeroDigit','groupingSeparator','decimalSeparator','perMill','percent','digit','patternSeparator','minusSign','monetarySeparator','exponential'],'I',['serialVersionOnStream'],'S',['infinity','NaN','currencySymbol','intlCurrencySymbol','exponentialSeparator'],'O',['locale','java.util.Locale']]
