(function(){var P$=Clazz.newPackage("java.text"),p$1={},p$2={},I$=[[0,'InternalError','java.util.Hashtable',['java.text.AttributedString','.AttributeMap'],'java.util.HashSet','java.text.AttributeEntry','StringBuffer','java.util.Vector',['java.text.AttributedString','.AttributedStringIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var newRunAttributes=Clazz.new_($I$(7,1).c$$I,[attributeCount]);
var newRunAttributeValues=Clazz.new_($I$(7,1).c$$I,[attributeCount]);
...
var newRunAttributes=Clazz.new_($I$(7,1));
var newRunAttributeValues=Clazz.new_($I$(7,1));
...
return Clazz.new_($I$(8,1).c$$java_text_AttributedCharacterIterator_AttributeA$I$I, [this, null, attributes, beginIndex, endIndex]);
});
...
var runAttrs=Clazz.new_($I$(7,1).c$$I,[size]);
var runValues=Clazz.new_($I$(7,1).c$$I,[size]);
...
}return Clazz.new_($I$(3,1).c$$I$I$I, [this, null, this.currentRunIndex, this.beginIndex, this.endIndex]);
});
...
if (value == null ) {
continue;
}}var entry=Clazz.new_($I$(5,1).c$$java_text_AttributedCharacterIterator_Attribute$O,[key, value]);
set.add$TE(entry);
}
}return set;
});
