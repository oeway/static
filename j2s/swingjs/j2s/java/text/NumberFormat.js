(function(){var P$=Clazz.newPackage("java.text"),I$=[[0,'java.util.HashMap','java.util.Hashtable','StringBuffer','java.text.DontCareFieldPosition','java.text.ParsePosition','java.util.Locale','sun.util.resources.LocaleData','java.text.DecimalFormatSymbols','java.text.DecimalFormat']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return this.format$D$StringBuffer$java_text_FieldPosition(number, Clazz.new_($I$(3,1)), $I$(4).INSTANCE).toString();
});

Clazz.newMeth(C$, 'format$J', function (number) {
return this.format$J$StringBuffer$java_text_FieldPosition(number, Clazz.new_($I$(3,1)), $I$(4).INSTANCE).toString();
});

Clazz.newMeth(C$, 'parse$S', function (source) {
var parsePosition=Clazz.new_($I$(5,1).c$$I,[0]);
...
var format=Clazz.new_($I$(9,1).c$$S$java_text_DecimalFormatSymbols,[numberPatterns[entry], symbols]);
if (choice == 4) {
