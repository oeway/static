...
C$.$fields$=[['Z',['decimalSeparatorAlwaysShown','parseBigDecimal','isCurrencyFormat','useExponentialNotation'],'B',['groupingSize','minExponentDigits'],'I',['multiplier','$maximumIntegerDigits','$minimumIntegerDigits','$maximumFractionDigits','$minimumFractionDigits'],'S',['positivePrefix','positiveSuffix','negativePrefix','negativeSuffix','posPrefixPattern','posSuffixPattern','negPrefixPattern','negSuffixPattern'],'O',['digitList','java.text.DigitList','symbols','java.text.DecimalFormatSymbols','positivePrefixFieldPositions','java.text.FieldPosition[]','+positiveSuffixFieldPositions','+negativePrefixFieldPositions','+negativeSuffixFieldPositions','roundingMode','java.math.RoundingMode']]
...
Clazz.super_(C$, this);
this.symbols=Clazz.new_($I$(6,1).c$$java_util_Locale,[$I$(4).getDefault$()]);
p$1.applyPattern$S$Z.apply(this, [pattern, false]);
}, 1);
...
var pos=Clazz.new_($I$(10,1).c$$I,[position + exponentString.length$()]);
...
if (positions == null ) {
positions=Clazz.new_($I$(12,1).c$$I,[2]);
}var fp=Clazz.new_($I$(1,1).c$$java_text_Format_Field,[$I$(7).CURRENCY]);
...
var inQuote=false;
var prefix=Clazz.new_($I$(9,1));
var suffix=Clazz.new_($I$(9,1));
var decimalPos=-1;
var multiplier=1;
