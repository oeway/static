...
this.calendar.setTime$java_util_Date(Clazz.new_($I$(11,1)));
...
var delegate=Clazz.new_($I$(13,1));
...
p$1.format$java_util_Date$StringBuffer$java_text_Format_FieldDelegate.apply(this, [Clazz.new_($I$(11,1).c$$J,[(obj).longValue$()]), sb, delegate]);
} else if (obj == null ) {
