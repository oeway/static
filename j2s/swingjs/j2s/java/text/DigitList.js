(function(){var P$=Clazz.newPackage("java.text"),p$1={},I$=[[0,'java.math.RoundingMode','InternalError','StringBuffer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['isNegative'],'I',['decimalAt','count'],'O',['+digits','+data','roundingMode','java.math.RoundingMode','tempBuffer','StringBuffer']]
,['O',['LONG_MIN_REP','char[]']]]
...
this.tempBuffer=Clazz.new_($I$(3,1).c$$I,[19]);
} else {
