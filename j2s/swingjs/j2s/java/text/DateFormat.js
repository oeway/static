(function(){var P$=Clazz.newPackage("java.text"),I$=[[0,'java.util.HashMap','java.util.Date','StringBuffer','java.text.DontCareFieldPosition','java.text.ParsePosition','java.util.Locale','java.text.SimpleDateFormat']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (Clazz.instanceOf(obj, "java.util.Date")) return this.format$java_util_Date$StringBuffer$java_text_FieldPosition(obj, toAppendTo, fieldPosition);
 else if (Clazz.instanceOf(obj, "java.lang.Number")) return this.format$java_util_Date$StringBuffer$java_text_FieldPosition(Clazz.new_($I$(2,1).c$$J,[(obj).longValue$()]), toAppendTo, fieldPosition);
...
return this.format$java_util_Date$StringBuffer$java_text_FieldPosition(date, Clazz.new_($I$(3,1)), $I$(4).INSTANCE).toString();
});

Clazz.newMeth(C$, 'parse$S', function (source) {
var pos=Clazz.new_($I$(5,1).c$$I,[0]);
...
return Clazz.new_($I$(7,1).c$$I$I$java_util_Locale,[timeStyle, dateStyle, loc]);
} catch (e) {
if (Clazz.exceptionOf(e,"java.util.MissingResourceException")){
return Clazz.new_($I$(7,1).c$$S,["M/d/yy h:mm a"]);
} else {
throw e;
}
}
