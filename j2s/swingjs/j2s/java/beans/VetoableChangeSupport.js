(function(){var P$=Clazz.newPackage("java.beans"),p$1={},I$=[[0,'java.beans.VetoableChangeListener','java.beans.VetoableChangeListenerProxy','java.io.ObjectStreamField','java.util.Hashtable',['java.beans.VetoableChangeSupport','.VetoableChangeListenerMap'],'java.beans.PropertyChangeEvent','Boolean']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.serialPersistentFields=Clazz.array($I$(3), -1, [Clazz.new_($I$(3,1).c$$S$Class,["children", Clazz.getClass($I$(4))]), Clazz.new_($I$(3,1).c$$S$Class,["source", Clazz.getClass(java.lang.Object)]), Clazz.new_($I$(3,1).c$$S$Class,["vetoableChangeSupportSerializedDataVersion", Integer.TYPE])]);
}
...
event=Clazz.new_($I$(6,1).c$$O$S$O$O,[this.source, event.getPropertyName$(), event.getNewValue$(), event.getOldValue$()]);
for (var listener, $listener = 0, $$listener = listeners; $listener<$$listener.length&&((listener=($$listener[$listener])),1);$listener++) {
try {
listener.vetoableChange$(event);
} catch (ex) {
