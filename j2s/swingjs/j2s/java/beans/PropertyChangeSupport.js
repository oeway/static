(function(){var P$=Clazz.newPackage("java.beans"),p$1={},I$=[[0,'java.beans.PropertyChangeListener','java.beans.PropertyChangeListenerProxy',['java.beans.PropertyChangeSupport','.PropertyChangeListenerMap'],'java.beans.PropertyChangeEvent','Boolean','java.beans.IndexedPropertyChangeEvent']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.firePropertyChange$java_beans_PropertyChangeEvent(Clazz.new_($I$(6,1).c$$O$S$O$O$I,[this.source, propertyName, oldValue, newValue, index]));
});
