(function(){var P$=java.util,p$1={},I$=[[0,'java.util.TreeMap','InternalError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.c$$java_util_NavigableMap.apply(this, [Clazz.new_(1,{K:"Object",V:"java.lang.Object"},$I$(1,1))]);
}, 1);

Clazz.newMeth(C$, 'c$$java_util_Comparator', function (comparator) {
C$.c$$java_util_NavigableMap.apply(this, [Clazz.new_(1,{K:"Object",V:"java.lang.Object"},$I$(1,1).c$$java_util_Comparator,[comparator])]);
}, 1);
...
clone.m=Clazz.new_(1,{K:"Object",V:"java.lang.Object"},$I$(1,1).c$$java_util_SortedMap,[this.m]);
return clone;
});
...
s.defaultReadObject$();
var c=s.readObject$();
var tm=Clazz.new_(1,{K:"Object",V:"java.lang.Object"},$I$(1,1).c$$java_util_Comparator,[c]);
this.m=tm;
var size=s.readInt$();
