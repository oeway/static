(function(){var P$=java.util,p$1={},I$=[[0,'java.util.Objects',['java.util.HashMap','.KeyIterator'],['java.util.HashMap','.KeySpliterator'],['java.util.HashMap','.ValueIterator'],['java.util.HashMap','.ValueSpliterator'],['java.util.HashMap','.EntryIterator'],['java.util.HashMap','.EntrySpliterator'],['java.util.HashMap','.Node'],['java.util.HashMap','.KeySet'],['java.util.HashMap','.Values'],['java.util.HashMap','.EntrySet'],'InternalError',['java.util.HashMap','.TreeNode']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['F',['loadFactor'],'I',['size','modCount','threshold'],'O',['table','java.util.HashMap.Node[]','entrySet','java.util.Set']]]
...
throw Clazz.new_($I$(12,1).c$$Throwable,[e]);
} else {
throw e;
}
}
...
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(8,1).c$$I$TK$TV$java_util_HashMap_Node,[hash, key, value, next]);
});

Clazz.newMeth(C$, 'replacementNode$java_util_HashMap_Node$java_util_HashMap_Node', function (p, next) {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(8,1).c$$I$TK$TV$java_util_HashMap_Node,[p.hash, p.key, p.value, next]);
});

Clazz.newMeth(C$, ['newTreeNode$I$TK$TV$java_util_HashMap_Node'], function (hash, key, value, next) {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(13,1).c$$I$TK$TV$java_util_HashMap_Node,[hash, key, value, next]);
});

Clazz.newMeth(C$, 'replacementTreeNode$java_util_HashMap_Node$java_util_HashMap_Node', function (p, next) {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(13,1).c$$I$TK$TV$java_util_HashMap_Node,[p.hash, p.key, p.value, next]);
});
...
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(3,1).c$$java_util_HashMap$I$I$I$I,[this.b$['java.util.HashMap'], 0, -1, 0, 0]);
});
...
Clazz.newMeth(C$, 'spliterator$', function () {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(5,1).c$$java_util_HashMap$I$I$I$I,[this.b$['java.util.HashMap'], 0, -1, 0, 0]);
});
...
Clazz.newMeth(C$, 'spliterator$', function () {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(7,1).c$$java_util_HashMap$I$I$I$I,[this.b$['java.util.HashMap'], 0, -1, 0, 0]);
});
...
C$.$fields$=[['I',['expectedModCount','index'],'O',['next_','java.util.HashMap.Node','+current']]]
...
C$.$fields$=[['I',['index','fence','est','expectedModCount'],'O',['map','java.util.HashMap','current','java.util.HashMap.Node']]]
...
var lo=this.index;
var mid=(lo + hi) >>> 1;
return (lo >= mid || this.current != null  ) ? null : Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_HashMap$I$I$I$I,[this.map, lo, this.index=mid, this.est>>>=1, this.expectedModCount]);
});
...
;C$.superclazz.c$$I$TK$TV$java_util_HashMap_Node.apply(this,[hash, key, val, next]);C$.$init$.apply(this);
}, 1);
