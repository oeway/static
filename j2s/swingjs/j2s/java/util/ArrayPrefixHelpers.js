(function(){var P$=java.util,I$=[[0,'java.util.concurrent.ForkJoinPool']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (lt == null ) {
var mid=(l + h) >>> 1;
f=rt=t.right=Clazz.new_(1,{T:"Object"},C$.c$$java_util_ArrayPrefixHelpers_CumulateTask$java_util_function_BinaryOperator$TTA$I$I$I$I$I,[t, fn, a, org, fnc, th, mid, h]);
t=lt=t.left=Clazz.new_(1,{T:"Object"},C$.c$$java_util_ArrayPrefixHelpers_CumulateTask$java_util_function_BinaryOperator$TTA$I$I$I$I$I,[t, fn, a, org, fnc, th, l, mid]);
} else {
var pin=t.$in;
lt.$in=pin;
f=t=null;
...
C$.$fields$=[['I',['lo','hi','origin','fence','threshold'],'L',['$in','out'],'O',['array','long[]','$function','java.util.function.LongBinaryOperator','left','java.util.ArrayPrefixHelpers.LongCumulateTask','+right']]]
