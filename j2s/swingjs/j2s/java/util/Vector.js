(function(){var P$=java.util,p$1={},p$2={},I$=[[0,'java.util.Objects','java.util.Arrays','OutOfMemoryError','InternalError','java.util.Collections',['java.util.Vector','.ListItr'],['java.util.Vector','.Itr'],'java.util.BitSet',['java.util.Vector','.VectorSpliterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_(1,{E:"Object"},$I$(9,1).c$$java_util_Vector$OA$I$I$I,[this, null, 0, -1, 0]);
});
;
...
var lo=this.index;
var mid=(lo + hi) >>> 1;
return (lo >= mid) ? null : Clazz.new_(1,{E:"Object"},C$.c$$java_util_Vector$OA$I$I$I,[this.list, this.array, lo, this.index=mid, this.expectedModCount]);
});
