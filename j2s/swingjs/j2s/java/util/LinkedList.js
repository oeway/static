...
var f=this.first;
var newNode=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$java_util_LinkedList_Node$TE$java_util_LinkedList_Node,[null, e, f]);
this.first=newNode;
...
var l=this.last;
var newNode=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$java_util_LinkedList_Node$TE$java_util_LinkedList_Node,[l, e, null]);
this.last=newNode;
...
var pred=succ.prev;
var newNode=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$java_util_LinkedList_Node$TE$java_util_LinkedList_Node,[pred, e, succ]);
succ.prev=newNode;
...
var e=o;
var newNode=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$java_util_LinkedList_Node$TE$java_util_LinkedList_Node,[pred, e, null]);
if (pred == null ) this.first=newNode;
 else pred.next_=newNode;
pred=newNode;
}
...
return Clazz.new_(1,{E:"Object"},$I$(8,1).c$$java_util_LinkedList$I$I,[this, -1, 0]);
});
;
...
Clazz.newMeth(C$, '$init$', function () {
this.itr=Clazz.new_($I$(2,1).c$$I, [this, null, this.b$['java.util.LinkedList'].size$.apply(this.b$['java.util.LinkedList'], [])]);
}, 1);
