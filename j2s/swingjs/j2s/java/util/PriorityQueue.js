(function(){var P$=java.util,p$1={},p$2={},I$=[[0,'java.util.ArrayDeque','java.util.Arrays','OutOfMemoryError',['java.util.PriorityQueue','.Itr'],['java.util.PriorityQueue','.PriorityQueueSpliterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_(1,{E:"Object"},$I$(5,1).c$$java_util_PriorityQueue$I$I$I,[this, 0, -1, 0]);
});
;
...
if (this.forgetMeNot == null ) this.forgetMeNot=Clazz.new_(1,{E:"Object"},$I$(1,1));
...
var lo=this.index;
var mid=(lo + hi) >>> 1;
return (lo >= mid) ? null : Clazz.new_(1,{E:"Object"},C$.c$$java_util_PriorityQueue$I$I$I,[this.pq, lo, this.index=mid, this.expectedModCount]);
});
