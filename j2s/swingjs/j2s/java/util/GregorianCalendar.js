(function(){var P$=java.util,p$1={},I$=[[0,'sun.util.calendar.CalendarSystem','java.util.TimeZone','java.util.Locale','java.util.Date','sun.util.calendar.AbstractCalendar','sun.util.calendar.CalendarUtils']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['gregorianCutoverYear','gregorianCutoverYearJulian'],'L',['gregorianCutover','gregorianCutoverDate','cachedFixedDate'],'O',['gdate','sun.util.calendar.BaseCalendar.Date','+cdate','calsys','sun.util.calendar.BaseCalendar','zoneOffsets','int[]','+originalFields']]
,['O',['MONTH_LENGTH','int[]','+LEAP_MONTH_LENGTH','+MIN_VALUES','+LEAST_MAX_VALUES','+MAX_VALUES','gcal','sun.util.calendar.Gregorian']]]
...
return Clazz.new_($I$(4,1).c$$J,[this.gregorianCutover]);
});
