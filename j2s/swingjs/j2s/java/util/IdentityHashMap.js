(function(){var P$=java.util,p$1={},I$=[[0,['java.util.IdentityHashMap','.EntryIterator','.Entry'],['java.util.IdentityHashMap','.KeyIterator'],'java.util.Objects','java.lang.reflect.Array',['java.util.IdentityHashMap','.KeySpliterator'],['java.util.IdentityHashMap','.ValueIterator'],['java.util.IdentityHashMap','.ValueSpliterator'],['java.util.IdentityHashMap','.EntryIterator'],['java.util.AbstractMap','.SimpleEntry'],['java.util.IdentityHashMap','.EntrySpliterator'],['java.util.AbstractMap','.SimpleImmutableEntry'],'InternalError',['java.util.IdentityHashMap','.KeySet'],['java.util.IdentityHashMap','.Values'],['java.util.IdentityHashMap','.EntrySet']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (ks != null ) return ks;
 else return this.keySet=Clazz.new_($I$(13,1), [this, null]);
});

Clazz.newMeth(C$, 'values$', function () {
var vs=this.values;
if (vs != null ) return vs;
 else return this.values=Clazz.new_($I$(14,1), [this, null]);
});

Clazz.newMeth(C$, 'entrySet$', function () {
var es=this.entrySet;
if (es != null ) return es;
 else return this.entrySet=Clazz.new_($I$(15,1), [this, null]);
});
...
Clazz.newMeth(C$, 'next$', function () {
this.lastReturnedEntry=Clazz.new_($I$(1,1).c$$I, [this, null, this.nextIndex$()]);
...
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(5,1).c$$java_util_IdentityHashMap$I$I$I$I,[this.b$['java.util.IdentityHashMap'], 0, -1, 0, 0]);
});
...
Clazz.newMeth(C$, 'spliterator$', function () {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(7,1).c$$java_util_IdentityHashMap$I$I$I$I,[this.b$['java.util.IdentityHashMap'], 0, -1, 0, 0]);
});
...
if (ti >= size) {
throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
}a[ti++]=Clazz.new_(1,{K:"java.lang.Object",V:"java.lang.Object"},$I$(9,1).c$$TK$TV,[P$.IdentityHashMap.unmaskNull$O(key), tab[si + 1]]);
}}
if (ti < size || expectedModCount != this.this$0.modCount ) {
throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
}if (ti < a.length) {
...
Clazz.newMeth(C$, 'spliterator$', function () {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(10,1).c$$java_util_IdentityHashMap$I$I$I$I,[this.b$['java.util.IdentityHashMap'], 0, -1, 0, 0]);
});
...
var lo=this.index;
var mid=((lo + hi) >>> 1) & ~1;
return (lo >= mid) ? null : Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_IdentityHashMap$I$I$I$I,[this.map, lo, this.index=mid, this.est>>>=1, this.expectedModCount]);
});
...
var v=a[i + 1];
action.accept$(Clazz.new_(1,{K:"Object",V:"Object"},$I$(11,1).c$$TK$TV,[k, v]));
}}
if (m.modCount == this.expectedModCount) return;
}throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
});
