(function(){var P$=java.util,p$1={},I$=[[0,'java.util.ServiceConfigurationError','java.util.ServiceLoader','sun.util.spi.XmlPropertiesProvider','java.security.AccessController','jdk.internal.util.xml.BasicXmlPropertiesProvider',['java.util.Properties','.LineReader'],'StringBuffer','java.io.BufferedWriter','java.io.OutputStreamWriter','java.util.Date',['java.util.Properties','.XmlSupport'],'java.util.Objects','java.util.Hashtable']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
p$1.load0$java_util_Properties_LineReader.apply(this, [Clazz.new_($I$(6,1).c$$java_io_Reader, [this, null, reader])]);
});

Clazz.newMeth(C$, 'load$java_io_InputStream', function (inStream) {
p$1.load0$java_util_Properties_LineReader.apply(this, [Clazz.new_($I$(6,1).c$$java_io_InputStream, [this, null, inStream])]);
});
...
if (bufLen < 0) {
bufLen=2147483647;
}var outBuffer=Clazz.new_($I$(7,1).c$$I,[bufLen]);
for (var x=0; x < len; x++) {
...
p$1.store0$java_io_BufferedWriter$S$Z.apply(this, [(Clazz.instanceOf(writer, "java.io.BufferedWriter")) ? writer : Clazz.new_($I$(8,1).c$$java_io_Writer,[writer]), comments, false]);
});

Clazz.newMeth(C$, 'store$java_io_OutputStream$S', function (out, comments) {
p$1.store0$java_io_BufferedWriter$S$Z.apply(this, [Clazz.new_($I$(8,1).c$$java_io_Writer,[Clazz.new_($I$(9,1).c$$java_io_OutputStream$S,[out, "8859_1"])]), comments, true]);
});
...
}bw.write$S("#" + Clazz.new_($I$(10,1)).toString());
bw.newLine$();
{
...
$I$(11).load$java_util_Properties$java_io_InputStream(this, $I$(12).requireNonNull$TT($in));
$in.close$();
});
...
$I$(11).save$java_util_Properties$java_io_OutputStream$S$S(this, $I$(12).requireNonNull$TT(os), comment, $I$(12).requireNonNull$TT(encoding));
});
...
var h=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(13,1));
p$1.enumerate$java_util_Hashtable.apply(this, [h]);
return h.keys$();
});

Clazz.newMeth(C$, 'stringPropertyNames$', function () {
var h=Clazz.new_(1,{K:"String",V:"String"},$I$(13,1));
...
var provider=P$.Properties.XmlSupport.loadProviderFromProperty$ClassLoader(cl);
if (provider != null ) return provider;
provider=P$.Properties.XmlSupport.loadProviderAsService$ClassLoader(cl);
if (provider != null ) return provider;
