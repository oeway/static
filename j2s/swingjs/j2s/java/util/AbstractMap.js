(function(){var P$=java.util,I$=[[0,'java.util.AbstractSet','java.util.AbstractCollection','StringBuilder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
), Clazz.new_(1,{E:"Object"},$I$(1,1), [this, null],P$.AbstractMap$1));
}return this.keySet;
});
...
), Clazz.new_(1,{E:"Object"},$I$(2,1), [this, null],P$.AbstractMap$2));
}return this.values;
});
