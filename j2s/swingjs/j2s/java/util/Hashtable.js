(function(){var P$=java.util,p$1={},I$=[[0,'java.util.Objects',['java.util.Hashtable','.Entry'],'InternalError','StringBuilder','java.util.Collections',['java.util.Hashtable','.Enumerator'],['java.util.Hashtable','.KeySet'],['java.util.Hashtable','.EntrySet'],['java.util.Hashtable','.ValueCollection']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['F',['loadFactor'],'I',['count','threshold','modCount'],'O',['table','java.util.Hashtable.Entry[]','keySet','java.util.Set','+entrySet','values','java.util.Collection']]]
...
tab[index]=Clazz.new_(1,{K:"Object",V:"Object"},$I$(2,1).c$$I$TK$TV$java_util_Hashtable_Entry,[hash, key, value, e]);
this.count++;
}, p$1);
...
return Clazz.new_(1,{T:"Object"},$I$(6,1).c$$I$Z, [this, null, type, false]);
}}, p$1);
...
return Clazz.new_(1,{T:"Object"},$I$(6,1).c$$I$Z, [this, null, type, true]);
}}, p$1);

Clazz.newMeth(C$, 'keySet$', function () {
if (this.keySet == null ) this.keySet=$I$(5).synchronizedSet$java_util_Set$O(Clazz.new_($I$(7,1), [this, null]), this);
return this.keySet;
});

Clazz.newMeth(C$, 'entrySet$', function () {
if (this.entrySet == null ) this.entrySet=$I$(5).synchronizedSet$java_util_Set$O(Clazz.new_($I$(8,1), [this, null]), this);
return this.entrySet;
});

Clazz.newMeth(C$, 'values$', function () {
if (this.values == null ) this.values=$I$(5).synchronizedCollection$java_util_Collection$O(Clazz.new_($I$(9,1), [this, null]), this);
return this.values;
});
...
while (entry != null ){
entryStack=Clazz.new_(1,{K:"java.lang.Object",V:"java.lang.Object"},$I$(2,1).c$$I$TK$TV$java_util_Hashtable_Entry,[0, entry.key, entry.value, entryStack]);
entry=entry.next_;
}
}
...
Clazz.newMeth(C$, 'clone$', function () {
return Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$I$TK$TV$java_util_Hashtable_Entry,[this.hash, this.key, this.value, (this.next_ == null  ? null : this.next_.clone$())]);
});
...
C$.$fields$=[['Z',['iterator'],'I',['index','type','expectedModCount'],'O',['table','java.util.Hashtable.Entry[]','entry','java.util.Hashtable.Entry','+lastReturned']]]
