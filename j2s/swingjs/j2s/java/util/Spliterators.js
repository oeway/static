...
C$.EMPTY_SPLITERATOR=Clazz.new_(1,{T:"java.lang.Object"},$I$(10,1));
...
return Clazz.new_(1,{T:"Object"},$I$(3,1).c$$OA$I,[$I$(1).requireNonNull$TT(array), additionalCharacteristics]);
}, 1);
...
return Clazz.new_(1,{T:"Object"},$I$(3,1).c$$OA$I$I$I,[array, fromIndex, toIndex, additionalCharacteristics]);
}, 1);

Clazz.newMeth(C$, 'spliterator$IA$I', function (array, additionalCharacteristics) {
return Clazz.new_($I$(5,1).c$$IA$I,[$I$(1).requireNonNull$TT(array), additionalCharacteristics]);
}, 1);
...
return Clazz.new_($I$(7,1).c$$JA$I,[$I$(1).requireNonNull$TT(array), additionalCharacteristics]);
}, 1);
...
return Clazz.new_($I$(9,1).c$$DA$I,[$I$(1).requireNonNull$TT(array), additionalCharacteristics]);
}, 1);
...
return Clazz.new_(1,{T:"Object"},$I$(14,1).c$$java_util_Collection$I,[$I$(1).requireNonNull$TT(c), characteristics]);
}, 1);

Clazz.newMeth(C$, 'spliterator$java_util_Iterator$J$I', function (iterator, size, characteristics) {
return Clazz.new_(1,{T:"Object"},$I$(14,1).c$$java_util_Iterator$J$I,[$I$(1).requireNonNull$TT(iterator), size, characteristics]);
}, 1);

Clazz.newMeth(C$, 'spliteratorUnknownSize$java_util_Iterator$I', function (iterator, characteristics) {
return Clazz.new_(1,{T:"Object"},$I$(14,1).c$$java_util_Iterator$I,[$I$(1).requireNonNull$TT(iterator), characteristics]);
}, 1);

Clazz.newMeth(C$, 'spliterator$java_util_PrimitiveIterator_OfInt$J$I', function (iterator, size, characteristics) {
return Clazz.new_($I$(15,1).c$$java_util_PrimitiveIterator_OfInt$J$I,[$I$(1).requireNonNull$TT(iterator), size, characteristics]);
}, 1);

Clazz.newMeth(C$, 'spliteratorUnknownSize$java_util_PrimitiveIterator_OfInt$I', function (iterator, characteristics) {
return Clazz.new_($I$(15,1).c$$java_util_PrimitiveIterator_OfInt$I,[$I$(1).requireNonNull$TT(iterator), characteristics]);
}, 1);

Clazz.newMeth(C$, 'spliterator$java_util_PrimitiveIterator_OfLong$J$I', function (iterator, size, characteristics) {
return Clazz.new_($I$(16,1).c$$java_util_PrimitiveIterator_OfLong$J$I,[$I$(1).requireNonNull$TT(iterator), size, characteristics]);
}, 1);

Clazz.newMeth(C$, 'spliteratorUnknownSize$java_util_PrimitiveIterator_OfLong$I', function (iterator, characteristics) {
return Clazz.new_($I$(16,1).c$$java_util_PrimitiveIterator_OfLong$I,[$I$(1).requireNonNull$TT(iterator), characteristics]);
}, 1);

Clazz.newMeth(C$, 'spliterator$java_util_PrimitiveIterator_OfDouble$J$I', function (iterator, size, characteristics) {
return Clazz.new_($I$(17,1).c$$java_util_PrimitiveIterator_OfDouble$J$I,[$I$(1).requireNonNull$TT(iterator), size, characteristics]);
}, 1);

Clazz.newMeth(C$, 'spliteratorUnknownSize$java_util_PrimitiveIterator_OfDouble$I', function (iterator, characteristics) {
return Clazz.new_($I$(17,1).c$$java_util_PrimitiveIterator_OfDouble$I,[$I$(1).requireNonNull$TT(iterator), characteristics]);
}, 1);
...
C$.$fields$=[['Z',['valueReady'],'L',['nextElement']]]
...
return (lo >= mid) ? null : Clazz.new_(1,{T:"Object"},C$.c$$OA$I$I$I,[this.array, lo, this.index=mid, this.characteristics]);
});
...
C$.$fields$=[['I',['characteristics','batch'],'L',['est']]]
...
Clazz.newMeth(C$, 'trySplit$', function () {
var holder=Clazz.new_(1,{T:"Object"},$I$(2,1));
var s=this.est;
...
return Clazz.new_(1,{T:"Object"},$I$(3,1).c$$OA$I$I$I,[a, 0, j, this.characteristics$()]);
}return null;
});
...
C$.$fields$=[['I',['characteristics','batch'],'L',['est'],'O',['collection','java.util.Collection','it','java.util.Iterator']]]
...
C$.$fields$=[['I',['characteristics','batch'],'L',['est'],'O',['it','java.util.PrimitiveIterator.OfInt']]]
...
C$.$fields$=[['I',['characteristics','batch'],'L',['est'],'O',['it','java.util.PrimitiveIterator.OfLong']]]
...
C$.$fields$=[['I',['characteristics','batch'],'L',['est'],'O',['it','java.util.PrimitiveIterator.OfDouble']]]
