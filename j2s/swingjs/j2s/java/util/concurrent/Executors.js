...
return Clazz.new_($I$(4,1).c$$I$I$J$java_util_concurrent_TimeUnit$java_util_concurrent_BlockingQueue,[nThreads, nThreads, 0, $I$(5).MILLISECONDS, Clazz.new_(1,{E:"Runnable"},$I$(6,1))]);
}, 1);

Clazz.newMeth(C$, 'newFixedThreadPool$I$java_util_concurrent_ThreadFactory', function (nThreads, threadFactory) {
return Clazz.new_($I$(4,1).c$$I$I$J$java_util_concurrent_TimeUnit$java_util_concurrent_BlockingQueue$java_util_concurrent_ThreadFactory,[nThreads, nThreads, 0, $I$(5).MILLISECONDS, Clazz.new_(1,{E:"Runnable"},$I$(6,1)), threadFactory]);
}, 1);

Clazz.newMeth(C$, 'newSingleThreadExecutor$', function () {
return Clazz.new_($I$(7,1).c$$java_util_concurrent_ExecutorService,[Clazz.new_($I$(4,1).c$$I$I$J$java_util_concurrent_TimeUnit$java_util_concurrent_BlockingQueue,[1, 1, 0, $I$(5).MILLISECONDS, Clazz.new_(1,{E:"Runnable"},$I$(6,1))])]);
}, 1);

Clazz.newMeth(C$, 'newSingleThreadExecutor$java_util_concurrent_ThreadFactory', function (threadFactory) {
return Clazz.new_($I$(7,1).c$$java_util_concurrent_ExecutorService,[Clazz.new_($I$(4,1).c$$I$I$J$java_util_concurrent_TimeUnit$java_util_concurrent_BlockingQueue$java_util_concurrent_ThreadFactory,[1, 1, 0, $I$(5).MILLISECONDS, Clazz.new_(1,{E:"Runnable"},$I$(6,1)), threadFactory])]);
}, 1);

Clazz.newMeth(C$, 'newCachedThreadPool$', function () {
return Clazz.new_($I$(4,1).c$$I$I$J$java_util_concurrent_TimeUnit$java_util_concurrent_BlockingQueue,[0, 2147483647, 60, $I$(5).SECONDS, Clazz.new_(1,{E:"Runnable"},$I$(8,1))]);
}, 1);

Clazz.newMeth(C$, 'newCachedThreadPool$java_util_concurrent_ThreadFactory', function (threadFactory) {
return Clazz.new_($I$(4,1).c$$I$I$J$java_util_concurrent_TimeUnit$java_util_concurrent_BlockingQueue$java_util_concurrent_ThreadFactory,[0, 2147483647, 60, $I$(5).SECONDS, Clazz.new_(1,{E:"Runnable"},$I$(8,1)), threadFactory]);
}, 1);

Clazz.newMeth(C$, 'newSingleThreadScheduledExecutor$', function () {
return Clazz.new_($I$(9,1).c$$java_util_concurrent_ScheduledExecutorService,[Clazz.new_($I$(10,1).c$$I,[1])]);
}, 1);

Clazz.newMeth(C$, 'newSingleThreadScheduledExecutor$java_util_concurrent_ThreadFactory', function (threadFactory) {
return Clazz.new_($I$(9,1).c$$java_util_concurrent_ScheduledExecutorService,[Clazz.new_($I$(10,1).c$$I$java_util_concurrent_ThreadFactory,[1, threadFactory])]);
}, 1);
...
return Clazz.new_(1,{T:"Object"},$I$(14,1).c$$Runnable$TT,[task, result]);
}, 1);

Clazz.newMeth(C$, 'callable$Runnable', function (task) {
if (task == null ) throw Clazz.new_(Clazz.load('NullPointerException'));
return Clazz.new_(1,{T:"java.lang.Object"},$I$(14,1).c$$Runnable$TT,[task, null]);
}, 1);
...
return Clazz.new_(1,{T:"Object"},$I$(15,1).c$$java_util_concurrent_Callable,[callable]);
}, 1);

Clazz.newMeth(C$, 'privilegedCallableUsingCurrentClassLoader$java_util_concurrent_Callable', function (callable) {
if (callable == null ) throw Clazz.new_(Clazz.load('NullPointerException'));
return Clazz.new_(1,{T:"Object"},$I$(16,1).c$$java_util_concurrent_Callable,[callable]);
}, 1);
...
var t=Clazz.new_($I$(2,1).c$$ThreadGroup$Runnable$S$J,[this.group, r, this.namePrefix + this.threadNumber.getAndIncrement$(), 0]);
