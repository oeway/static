(function(){var P$=Clazz.newPackage("java.util.concurrent"),p$1={},I$=[[0,'java.util.concurrent.locks.ReentrantLock','java.util.PriorityQueue',['java.util.concurrent.PriorityBlockingQueue','.Itr']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
Clazz.super_(C$, this);
this.q=Clazz.new_(1,{E:"Object"},$I$(2,1));
}, 1);

Clazz.newMeth(C$, 'c$$I', function (initialCapacity) {
Clazz.super_(C$, this);
this.q=Clazz.new_(1,{E:"Object"},$I$(2,1).c$$I$java_util_Comparator,[initialCapacity, null]);
}, 1);

Clazz.newMeth(C$, 'c$$I$java_util_Comparator', function (initialCapacity, comparator) {
Clazz.super_(C$, this);
this.q=Clazz.new_(1,{E:"Object"},$I$(2,1).c$$I$java_util_Comparator,[initialCapacity, comparator]);
}, 1);

Clazz.newMeth(C$, 'c$$java_util_Collection', function (c) {
Clazz.super_(C$, this);
this.q=Clazz.new_(1,{E:"Object"},$I$(2,1).c$$java_util_Collection,[c]);
}, 1);
...
return Clazz.new_($I$(3,1).c$$OA, [this, null, this.toArray$()]);
});
