(function(){var P$=Clazz.newPackage("java.util.concurrent"),p$1={},I$=[[0,['java.util.concurrent.ConcurrentHashMap','.HashEntry'],['java.util.concurrent.ConcurrentHashMap','.WriteThroughEntry'],['java.util.concurrent.ConcurrentHashMap','.KeyIterator'],['java.util.concurrent.ConcurrentHashMap','.ValueIterator'],['java.util.concurrent.ConcurrentHashMap','.EntryIterator'],['java.util.concurrent.ConcurrentHashMap','.Segment'],['java.util.concurrent.ConcurrentHashMap','.KeySet'],['java.util.concurrent.ConcurrentHashMap','.Values'],['java.util.concurrent.ConcurrentHashMap','.EntrySet']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
for (var i=0; i < this.segments.length; ++i) this.segments[i]=Clazz.new_(1,{K:"Object",V:"Object"},$I$(6,1).c$$I$F,[cap, loadFactor]);
...
oldValue=null;
++this.modCount;
tab[index]=Clazz.new_(1,{K:"Object",V:"Object"},$I$(1,1).c$$TK$I$java_util_concurrent_ConcurrentHashMap_HashEntry$TV,[key, hash, first, value]);
this.count=c;
}return oldValue;
} finally {
this.unlock$();
...
var n=newTable[k];
newTable[k]=Clazz.new_(1,{K:"Object",V:"Object"},$I$(1,1).c$$TK$I$java_util_concurrent_ConcurrentHashMap_HashEntry$TV,[p.key, p.hash, n, p.value]);
}
}}}
this.table=newTable;
});
...
for (var p=first; p !== e ; p=p.nextEntry) newFirst=Clazz.new_(1,{K:"Object",V:"Object"},$I$(1,1).c$$TK$I$java_util_concurrent_ConcurrentHashMap_HashEntry$TV,[p.key, p.hash, newFirst, p.value]);
...
;C$.superclazz.c$$TK$TV.apply(this,[k, v]);C$.$init$.apply(this);
}, 1);
...
return Clazz.new_($I$(2,1).c$$TK$TV, [this, null, e.key, e.value]);
});
