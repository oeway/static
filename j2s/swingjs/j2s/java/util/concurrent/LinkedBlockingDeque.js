(function(){var P$=Clazz.newPackage("java.util.concurrent"),p$1={},I$=[[0,'java.util.concurrent.locks.ReentrantLock',['java.util.concurrent.LinkedBlockingDeque','.Node'],'java.lang.reflect.Array',['java.util.concurrent.LinkedBlockingDeque','.Itr'],['java.util.concurrent.LinkedBlockingDeque','.DescendingItr']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
++this.count;
var f=this.first;
var x=Clazz.new_(1,{E:"Object"},$I$(2,1).c$$TE$java_util_concurrent_LinkedBlockingDeque_Node$java_util_concurrent_LinkedBlockingDeque_Node,[e, null, f]);
this.first=x;
...
++this.count;
var l=this.last;
var x=Clazz.new_(1,{E:"Object"},$I$(2,1).c$$TE$java_util_concurrent_LinkedBlockingDeque_Node$java_util_concurrent_LinkedBlockingDeque_Node,[e, l, null]);
this.last=x;
