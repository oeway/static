...
this.ctl=Clazz.new_($I$(3,1).c$$I,[C$.ctlOf$I$I(-536870912, 0)]);
this.mainLock=Clazz.new_($I$(4,1));
this.workers=Clazz.new_(1,{E:"java.util.concurrent.ThreadPoolExecutor.Worker"},$I$(5,1));
this.termination=this.mainLock.newCondition$();
}, 1);

C$.$fields$=[['Z',['allowCoreThreadTimeOut'],'I',['largestPoolSize','corePoolSize','maximumPoolSize'],'L',['completedTaskCount','keepAliveTime'],'O',['ctl','java.util.concurrent.atomic.AtomicInteger','workQueue','java.util.concurrent.BlockingQueue','mainLock','java.util.concurrent.locks.ReentrantLock','workers','java.util.HashSet','termination','java.util.concurrent.locks.Condition','threadFactory','java.util.concurrent.ThreadFactory','handler','java.util.concurrent.RejectedExecutionHandler']]
...
var taskList=Clazz.new_(1,{E:"Runnable"},$I$(6,1));
...
{
thrown=x;
throw Clazz.new_($I$(9,1).c$$Throwable,[x]);
}
}
} finally {
...
C$.$fields$=[['L',['completedTasks'],'O',['thread','Thread','firstTask','Runnable']]]
