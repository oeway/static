...
C$.$fields$=[['L',['state'],'O',['parent','java.util.concurrent.Phaser','+root','evenQ','java.util.concurrent.atomic.AtomicReference','+oddQ']]
,['I',['NCPU','SPINS_PER_ARRIVAL'],'L',['stateOffset'],'O',['UNSAFE','sun.misc.Unsafe']]]
...
this.root=this;
this.evenQ=Clazz.new_(1,{V:"java.util.concurrent.Phaser.QNode"},$I$(6,1));
this.oddQ=Clazz.new_(1,{V:"java.util.concurrent.Phaser.QNode"},$I$(6,1));
...
C$.$fields$=[['Z',['interruptible','timed','wasInterrupted'],'I',['phase'],'L',['nanos','deadline'],'O',['phaser','java.util.concurrent.Phaser','thread','Thread','next','java.util.concurrent.Phaser.QNode']]]
