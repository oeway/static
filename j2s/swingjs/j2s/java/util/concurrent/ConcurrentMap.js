(function(){var P$=Clazz.newPackage("java.util.concurrent"),I$=[[0,'java.util.Objects']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
), Clazz.new_(1,{T:"_.? super K",U:"_.? super V"},P$.ConcurrentMap$lambda1.$init$, [this, {$function:$function}])));
});
