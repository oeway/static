(function(){var P$=Clazz.newPackage("java.util.concurrent.atomic"),p$1={},p$2={},I$=[[0,'java.util.concurrent.atomic.DoubleAccumulator',['java.util.concurrent.atomic.DoubleAccumulator','.SerializationProxy']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['L',['identity'],'O',['$function','java.util.function.DoubleBinaryOperator']]]
...
var m;
var a;
if ((as=this.cells) != null  || (r=Double.doubleToRawLongBits$D(this.$function.applyAsDouble$(Double.longBitsToDouble$J(b=this.base), x))) != b && !this.casBase$J$J(b, r)  ) {
var uncontended=true;
if (as == null  || (m=as.length - 1) < 0  || (a=as[P$.Striped64.getProbe$() & m]) == null   || !(uncontended=(r=Double.doubleToRawLongBits$D(this.$function.applyAsDouble$(Double.longBitsToDouble$J(v=a.value), x))) == v || a.cas$J$J(v, r) ) ) this.doubleAccumulate$D$java_util_function_DoubleBinaryOperator$Z(x, this.$function, uncontended);
}});
...
if ((a=as[i]) != null ) result=this.$function.applyAsDouble$(result, Double.longBitsToDouble$J(a.value));
}
}return result;
});
...
return Clazz.new_($I$(2,1).c$$java_util_concurrent_atomic_DoubleAccumulator,[this]);
}, p$2);
...
C$.$fields$=[['D',['value'],'L',['identity'],'O',['$function','java.util.function.DoubleBinaryOperator']]]
