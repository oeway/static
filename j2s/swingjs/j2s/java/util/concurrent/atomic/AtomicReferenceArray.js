(function(){var P$=Clazz.newPackage("java.util.concurrent.atomic"),p$1={},I$=[[0,'sun.misc.Unsafe','Error','java.util.Arrays','StringBuilder','java.lang.reflect.Array']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.arrayFieldOffset=C$.unsafe.objectFieldOffset$reflect_Field(Clazz.getClass(C$).getDeclaredField$S("array"));
...
,['I',['base','shift'],'L',['arrayFieldOffset'],'O',['unsafe','sun.misc.Unsafe']]]
...
;C$.$init$.apply(this);
this.array=$I$(3).copyOf$TUA$I$Class(array, array.length, Clazz.array(java.lang.Object, -1));
}, 1);
...
Clazz.newMeth(C$, 'set$I$TE', function (i, newValue) {
C$.unsafe.putObjectVolatile$O$J$O(this.array, p$1.checkedByteOffset$I.apply(this, [i]), newValue);
});

Clazz.newMeth(C$, 'lazySet$I$TE', function (i, newValue) {
C$.unsafe.putOrderedObject$O$J$O(this.array, p$1.checkedByteOffset$I.apply(this, [i]), newValue);
});

Clazz.newMeth(C$, 'getAndSet$I$TE', function (i, newValue) {
return C$.unsafe.getAndSetObject$O$J$O(this.array, p$1.checkedByteOffset$I.apply(this, [i]), newValue);
});

Clazz.newMeth(C$, 'compareAndSet$I$TE$TE', function (i, expect, update) {
return p$1.compareAndSetRaw$J$TE$TE.apply(this, [p$1.checkedByteOffset$I.apply(this, [i]), expect, update]);
});

Clazz.newMeth(C$, 'compareAndSetRaw$J$TE$TE', function (offset, expect, update) {
return C$.unsafe.compareAndSwapObject$O$J$O$O(this.array, offset, expect, update);
}, p$1);

Clazz.newMeth(C$, 'weakCompareAndSet$I$TE$TE', function (i, expect, update) {
return this.compareAndSet$I$TE$TE(i, expect, update);
});
...
} while (!p$1.compareAndSetRaw$J$TE$TE.apply(this, [offset, prev, next]));
return prev;
});
...
Clazz.newMeth(C$, 'getAndAccumulate$I$TE$java_util_function_BinaryOperator', function (i, x, accumulatorFunction) {
var offset=p$1.checkedByteOffset$I.apply(this, [i]);
var prev;
var next;
do {
...
Clazz.newMeth(C$, 'accumulateAndGet$I$TE$java_util_function_BinaryOperator', function (i, x, accumulatorFunction) {
var offset=p$1.checkedByteOffset$I.apply(this, [i]);
var prev;
var next;
do {
...
if (a.getClass$() !== Clazz.array(java.lang.Object, -1) ) a=$I$(3).copyOf$TUA$I$Class(a, $I$(5).getLength$O(a), Clazz.array(java.lang.Object, -1));
