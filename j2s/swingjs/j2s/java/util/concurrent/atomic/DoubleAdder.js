(function(){var P$=Clazz.newPackage("java.util.concurrent.atomic"),p$1={},p$2={},I$=[[0,'java.util.concurrent.atomic.DoubleAdder',['java.util.concurrent.atomic.DoubleAdder','.SerializationProxy']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (as == null  || (m=as.length - 1) < 0  || (a=as[P$.Striped64.getProbe$() & m]) == null   || !(uncontended=a.cas$J$J(v=a.value, Double.doubleToRawLongBits$D(Double.longBitsToDouble$J(v) + x))) ) this.doubleAccumulate$D$java_util_function_DoubleBinaryOperator$Z(x, null, uncontended);
}});
...
return Clazz.new_($I$(2,1).c$$java_util_concurrent_atomic_DoubleAdder,[this]);
}, p$2);
