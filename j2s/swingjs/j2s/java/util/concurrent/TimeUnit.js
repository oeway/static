(function(){var P$=Clazz.newPackage("java.util.concurrent"),I$=[[0,'AbstractMethodError','Thread']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
