(function(){var P$=Clazz.newPackage("java.util.concurrent"),p$1={},I$=[[0,'java.util.concurrent.atomic.AtomicReferenceFieldUpdater',['java.util.concurrent.ConcurrentLinkedQueue','.Node'],'java.util.ArrayList',['java.util.concurrent.ConcurrentLinkedQueue','.Itr']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.head=Clazz.new_(1,{E:"Object"},$I$(2,1).c$$TE$java_util_concurrent_ConcurrentLinkedQueue_Node,[null, null]);
this.tail=this.head;
}, 1);
...
var n=Clazz.new_(1,{E:"Object"},$I$(2,1).c$$TE$java_util_concurrent_ConcurrentLinkedQueue_Node,[e, null]);
for (; ; ) {
var t=this.tail;
var s=t.getNext$();
if (t === this.tail ) {
...
var al=Clazz.new_(1,{E:"Object"},$I$(3,1));
for (var p=this.first$(); p != null ; p=p.getNext$()) {
var item=p.getItem$();
