...
var t=this.decorateTask$Runnable$java_util_concurrent_RunnableScheduledFuture(command, Clazz.new_(1,{V:"Void"},$I$(6,1).c$$Runnable$TV$J, [this, null, command, null, triggerTime]));
...
if (delay < 0) delay=0;
var triggerTime=this.now$() + unit.toNanos$J(delay);
var t=this.decorateTask$java_util_concurrent_Callable$java_util_concurrent_RunnableScheduledFuture(callable, Clazz.new_(1,{V:"Object"},$I$(6,1).c$$java_util_concurrent_Callable$J, [this, null, callable, triggerTime]));
p$2.delayedExecute$java_util_concurrent_RunnableScheduledFuture.apply(this, [t]);
return t;
});
...
var sft=Clazz.new_(1,{V:"Void"},$I$(6,1).c$$Runnable$TV$J$J, [this, null, command, null, triggerTime, unit.toNanos$J(period)]);
...
if (initialDelay < 0) initialDelay=0;
var triggerTime=this.now$() + unit.toNanos$J(initialDelay);
var sft=Clazz.new_(1,{V:"Void"},$I$(6,1).c$$Runnable$TV$J$J, [this, null, command, null, triggerTime, unit.toNanos$J(-delay)]);
var t=this.decorateTask$Runnable$java_util_concurrent_RunnableScheduledFuture(command, sft);
sft.outerTask=t;
p$2.delayedExecute$java_util_concurrent_RunnableScheduledFuture.apply(this, [t]);
return t;
...
C$.$fields$=[['L',['sequenceNumber','time','period'],'O',['outerTask','java.util.concurrent.RunnableScheduledFuture']]]

Clazz.newMeth(C$, ['c$$Runnable$TV$J'], function (r, result, ns) {
;C$.superclazz.c$$Runnable$TV.apply(this,[r, result]);C$.$init$.apply(this);
this.time=ns;
this.period=0;
...
Clazz.newMeth(C$, '$init$', function () {
this.dq=Clazz.new_(1,{E:"java.util.concurrent.RunnableScheduledFuture"},$I$(3,1));
}, 1);
