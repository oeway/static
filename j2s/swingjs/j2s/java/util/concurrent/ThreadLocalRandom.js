...
C$.seeder=Clazz.new_($I$(3,1).c$$J,[C$.initialSeed$()]);
...
,['L',['SEED','PROBE','SECONDARY'],'O',['probeGenerator','java.util.concurrent.atomic.AtomicInteger','seeder','java.util.concurrent.atomic.AtomicLong','nextLocalGaussian','Double','instance','java.util.concurrent.ThreadLocalRandom','serialPersistentFields','java.io.ObjectStreamField[]','UNSAFE','sun.misc.Unsafe']]]
...
C$.$fields$=[['I',['origin','bound'],'L',['index','fence']]]
...
C$.$fields$=[['L',['index','fence','origin','bound']]]
...
C$.$fields$=[['D',['origin','bound'],'L',['index','fence']]]
