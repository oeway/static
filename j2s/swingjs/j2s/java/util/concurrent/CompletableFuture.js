...
,['Z',['useCommonPool'],'L',['RESULT','STACK','NEXT'],'O',['NIL','java.util.concurrent.CompletableFuture.AltResult','asyncPool','java.util.concurrent.Executor','UNSAFE','sun.misc.Unsafe']]]
...
return Clazz.new_($I$(3,1).c$$Throwable,[(Clazz.instanceOf(x, "java.util.concurrent.CompletionException")) ? x : Clazz.new_(Clazz.load('java.util.concurrent.CompletionException').c$$Throwable,[x])]);
}, 1);
...
var x;
return (((Clazz.instanceOf(r, "java.util.concurrent.CompletableFuture.AltResult")) && (x=(r).ex) != null   && !(Clazz.instanceOf(x, "java.util.concurrent.CompletionException")) ) ? Clazz.new_($I$(3,1).c$$Throwable,[Clazz.new_(Clazz.load('java.util.concurrent.CompletionException').c$$Throwable,[x])]) : r);
}, 1);
...
var c=Clazz.new_(1,{T:"Object",V:"Object"},$I$(9,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_Function,[e, d, this, f]);
...
var c=Clazz.new_(1,{T:"Object"},$I$(10,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_Consumer,[e, d, this, f]);
this.push$java_util_concurrent_CompletableFuture_UniCompletion(c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var c=Clazz.new_(1,{T:"Object"},$I$(11,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$Runnable,[e, d, this, f]);
this.push$java_util_concurrent_CompletableFuture_UniCompletion(c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var c=Clazz.new_(1,{T:"Object"},$I$(12,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_BiConsumer,[e, d, this, f]);
this.push$java_util_concurrent_CompletableFuture_UniCompletion(c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var c=Clazz.new_(1,{T:"Object",V:"Object"},$I$(13,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_BiFunction,[e, d, this, f]);
this.push$java_util_concurrent_CompletableFuture_UniCompletion(c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var c=Clazz.new_(1,{T:"Object"},$I$(14,1).c$$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_Function,[d, this, f]);
this.push$java_util_concurrent_CompletableFuture_UniCompletion(c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var copy=Clazz.new_(1,{T:"Object"},$I$(15,1).c$$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture,[this, g]);
...
if (Clazz.instanceOf(r, "java.util.concurrent.CompletableFuture.AltResult")) {
if ((x=(r).ex) != null ) {
return Clazz.new_(1,{T:"Object"},C$.c$$O,[C$.encodeThrowable$Throwable$O(x, r)]);
}r=null;
}try {
var t=r;
var g=f.apply$(t).toCompletableFuture$();
var s=g.result;
if (s != null ) return Clazz.new_(1,{T:"Object"},C$.c$$O,[C$.encodeRelay$O(s)]);
var d=Clazz.new_(1,{T:"Object"},C$);
var copy=Clazz.new_(1,{T:"Object"},$I$(15,1).c$$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture,[d, g]);
g.push$java_util_concurrent_CompletableFuture_UniCompletion(copy);
copy.tryFire$I(0);
return d;
} catch (ex) {
return Clazz.new_(1,{T:"Object"},C$.c$$O,[C$.encodeThrowable$Throwable(ex)]);
}
}var d=Clazz.new_(1,{T:"Object"},C$);
var c=Clazz.new_(1,{T:"Object",V:"Object"},$I$(16,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_Function,[e, d, this, f]);
this.push$java_util_concurrent_CompletableFuture_UniCompletion(c);
c.tryFire$I(0);
return d;
}, p$1);
...
var c=Clazz.new_(1,{T:"Object",U:"Object",V:"Object"},$I$(18,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_BiFunction,[e, d, this, b, f]);
...
var c=Clazz.new_(1,{T:"Object",U:"Object"},$I$(19,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_BiConsumer,[e, d, this, b, f]);
this.bipush$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture_BiCompletion(b, c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var c=Clazz.new_(1,{T:"Object",U:""},$I$(20,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$Runnable,[e, d, this, b, f]);
this.bipush$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture_BiCompletion(b, c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var c=Clazz.new_(1,{T:"",U:""},$I$(21,1).c$$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture,[d, a, b]);
...
var c=Clazz.new_(1,{T:"Object",U:"Object",V:"Object"},$I$(22,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_Function,[e, d, this, b, f]);
...
var c=Clazz.new_(1,{T:"Object",U:"Object"},$I$(23,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_function_Consumer,[e, d, this, b, f]);
this.orpush$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture_BiCompletion(b, c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var c=Clazz.new_(1,{T:"Object",U:""},$I$(24,1).c$$java_util_concurrent_Executor$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$Runnable,[e, d, this, b, f]);
this.orpush$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture_BiCompletion(b, c);
c.tryFire$I(0);
}return d;
}, p$1);
...
var d=Clazz.new_(1,{T:"java.lang.Object"},C$);
if (lo <= hi) {
var a;
var b;
var mid=(lo + hi) >>> 1;
...
var c=Clazz.new_(1,{T:"",U:""},$I$(25,1).c$$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture$java_util_concurrent_CompletableFuture,[d, a, b]);
...
if (f == null ) throw Clazz.new_(Clazz.load('NullPointerException'));
var d=Clazz.new_(1,{T:"Object"},C$);
e.execute$(Clazz.new_(1,{T:"Object"},$I$(26,1).c$$java_util_concurrent_CompletableFuture$java_util_function_Supplier,[d, f]));
return d;
}, 1);
...
if (f == null ) throw Clazz.new_(Clazz.load('NullPointerException'));
var d=Clazz.new_(1,{T:"Void"},C$);
e.execute$(Clazz.new_($I$(27,1).c$$java_util_concurrent_CompletableFuture$Runnable,[d, f]));
return d;
}, 1);
...
var q=Clazz.new_($I$(30,1).c$$Z$J$J,[true, nanos, d == 0 ? 1 : d]);
var queued=false;
var r;
while ((r=this.result) == null ){
...
return Clazz.new_(1,{T:"Object"},C$.c$$O,[(value == null ) ? C$.NIL : value]);
}, 1);
...
var cancelled=(this.result == null ) && this.internalComplete$O(Clazz.new_($I$(3,1).c$$Throwable,[Clazz.new_(Clazz.load('java.util.concurrent.CancellationException'))])) ;
this.postComplete$();
...
C$.$fields$=[['I',['interruptControl'],'L',['nanos','deadline'],'O',['thread','Thread']]]
