(function(){var P$=Clazz.newPackage("java.util.concurrent"),p$1={},I$=[[0,'java.util.concurrent.FutureTask','java.util.ArrayList','java.util.concurrent.ExecutorCompletionService','java.util.concurrent.TimeUnit']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_(1,{V:"Object"},$I$(1,1).c$$Runnable$TV,[runnable, value]);
});

Clazz.newMeth(C$, 'newTaskFor$java_util_concurrent_Callable', function (callable) {
return Clazz.new_(1,{V:"Object"},$I$(1,1).c$$java_util_concurrent_Callable,[callable]);
});
...
var futures=Clazz.new_(1,{E:"java.util.concurrent.Future"},$I$(2,1).c$$I,[ntasks]);
var ecs=Clazz.new_(1,{V:"Object"},$I$(3,1).c$$java_util_concurrent_Executor,[this]);
try {
var ee=null;
...
if (tasks == null ) throw Clazz.new_(Clazz.load('NullPointerException'));
var futures=Clazz.new_(1,{E:"java.util.concurrent.Future"},$I$(2,1).c$$I,[tasks.size$()]);
var done=false;
try {
