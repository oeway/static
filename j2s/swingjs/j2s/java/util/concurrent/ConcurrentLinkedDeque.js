(function(){var P$=Clazz.newPackage("java.util.concurrent"),p$1={},I$=[[0,'sun.misc.Unsafe','Error','java.util.Spliterators',['java.util.concurrent.ConcurrentLinkedDeque','.Node'],'java.util.ArrayList',['java.util.concurrent.ConcurrentLinkedDeque','.Itr'],['java.util.concurrent.ConcurrentLinkedDeque','.DescendingItr'],['java.util.concurrent.ConcurrentLinkedDeque','.CLDSpliterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
{
C$.PREV_TERMINATOR=Clazz.new_(1,{E:"java.lang.Object"},$I$(4,1));
C$.PREV_TERMINATOR.next=C$.PREV_TERMINATOR;
C$.NEXT_TERMINATOR=Clazz.new_(1,{E:"java.lang.Object"},$I$(4,1));
...
,['L',['headOffset','tailOffset'],'O',['PREV_TERMINATOR','java.util.concurrent.ConcurrentLinkedDeque.Node','+NEXT_TERMINATOR','UNSAFE','sun.misc.Unsafe']]]
...
C$.checkNotNull$O(e);
var newNode=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$TE,[e]);
...
Clazz.super_(C$, this);
this.head=this.tail=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$TE,[null]);
}, 1);
...
if (h === t ) {
if (h == null ) h=t=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$TE,[null]);
 else {
var newNode=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$TE,[null]);
t.lazySetNext$java_util_concurrent_ConcurrentLinkedDeque_Node(newNode);
newNode.lazySetPrev$java_util_concurrent_ConcurrentLinkedDeque_Node(t);
t=newNode;
}}this.head=h;
...
return Clazz.new_(1,{E:"Object"},$I$(8,1).c$$java_util_concurrent_ConcurrentLinkedDeque,[this]);
});
...
var newNode=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$TE,[item]);
if (h == null ) h=t=newNode;
 else {
t.lazySetNext$java_util_concurrent_ConcurrentLinkedDeque_Node(newNode);
newNode.lazySetPrev$java_util_concurrent_ConcurrentLinkedDeque_Node(t);
...
,['L',['prevOffset','itemOffset','nextOffset'],'O',['UNSAFE','sun.misc.Unsafe']]]
