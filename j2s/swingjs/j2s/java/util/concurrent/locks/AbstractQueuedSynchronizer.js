(function(){var P$=Clazz.newPackage("java.util.concurrent.locks"),p$1={},p$2={},I$=[[0,['java.util.concurrent.locks.AbstractQueuedSynchronizer','.Node'],'Thread','java.util.concurrent.locks.LockSupport','java.util.ArrayList']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var node=Clazz.new_($I$(1,1).c$$Thread$java_util_concurrent_locks_AbstractQueuedSynchronizer_Node,[$I$(2).currentThread$(), mode]);
var pred=this.tail;
if (pred != null ) {
node.prev=pred;
