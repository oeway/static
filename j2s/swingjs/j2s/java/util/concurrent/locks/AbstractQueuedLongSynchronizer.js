(function(){var P$=Clazz.newPackage("java.util.concurrent.locks"),p$1={},p$2={},I$=[[0,['java.util.concurrent.locks.AbstractQueuedLongSynchronizer','.Node'],'Thread','java.util.concurrent.locks.LockSupport','java.util.ArrayList']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['L',['state'],'O',['head','java.util.concurrent.locks.AbstractQueuedLongSynchronizer.Node','+tail']]]
...
var node=Clazz.new_($I$(1,1).c$$Thread$java_util_concurrent_locks_AbstractQueuedLongSynchronizer_Node,[$I$(2).currentThread$(), mode]);
var pred=this.tail;
if (pred != null ) {
node.prev=pred;
...
var list=Clazz.new_(1,{E:"Thread"},$I$(4,1));
for (var p=this.tail; p != null ; p=p.prev) {
var t=p.thread;
...
t=this.lastWaiter;
}var node=Clazz.new_($I$(1,1).c$$Thread$I,[$I$(2).currentThread$(), -2]);
