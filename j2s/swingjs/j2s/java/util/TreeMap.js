(function(){var P$=java.util,p$1={},I$=[[0,['java.util.TreeMap','.ValueIterator'],['java.util.TreeMap','.ValueSpliterator'],['java.util.TreeMap','.EntryIterator'],['java.util.TreeMap','.EntrySpliterator'],'java.util.TreeMap',['java.util.TreeMap','.KeySet'],['java.util.TreeMap','.NavigableSubMap','.SubMapEntryIterator'],['java.util.TreeMap','.DescendingSubMap'],['java.util.TreeMap','.NavigableSubMap','.SubMapKeyIterator'],['java.util.TreeMap','.NavigableSubMap','.DescendingSubMapKeyIterator'],['java.util.TreeMap','.AscendingSubMap','.AscendingEntrySetView'],['java.util.TreeMap','.NavigableSubMap','.DescendingSubMapEntryIterator'],'java.util.Collections',['java.util.TreeMap','.AscendingSubMap'],['java.util.TreeMap','.DescendingSubMap','.DescendingEntrySetView'],'InternalError',['java.util.Map','.Entry'],['java.util.TreeMap','.Entry'],['java.util.TreeMap','.Values'],['java.util.TreeMap','.EntrySet'],'java.util.Objects',['java.util.TreeMap','.KeyIterator'],['java.util.TreeMap','.DescendingKeyIterator'],['java.util.AbstractMap','.SimpleImmutableEntry'],['java.util.TreeMap','.KeySpliterator'],['java.util.TreeMap','.DescendingKeySpliterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.root=Clazz.new_(1,{K:"Object",V:"Object"},$I$(18,1).c$$TK$TV$java_util_TreeMap_Entry,[key, value, null]);
this.size=1;
this.modCount++;
return null;
}var cmp;
...
}var e=Clazz.new_(1,{K:"Object",V:"Object"},$I$(18,1).c$$TK$TV$java_util_TreeMap_Entry,[key, value, parent]);
...
return (nks != null ) ? nks : (this.navigableKeySet=Clazz.new_(1,{E:"Object"},$I$(6,1).c$$java_util_NavigableMap,[this]));
});
...
return (km != null ) ? km : (this.descendingMap=Clazz.new_(1,{K:"Object",V:"Object"},$I$(8,1).c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this, true, null, true, true, null, true]));
});

Clazz.newMeth(C$, ['subMap$TK$Z$TK$Z'], function (fromKey, fromInclusive, toKey, toInclusive) {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(14,1).c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this, false, fromKey, fromInclusive, false, toKey, toInclusive]);
});

Clazz.newMeth(C$, ['headMap$TK$Z'], function (toKey, inclusive) {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(14,1).c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this, true, null, true, false, toKey, inclusive]);
});

Clazz.newMeth(C$, ['tailMap$TK$Z'], function (fromKey, inclusive) {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(14,1).c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this, false, fromKey, inclusive, true, null, true]);
});
...
return Clazz.new_($I$(22,1).c$$java_util_TreeMap_Entry, [this, null, this.getFirstEntry$()]);
});

Clazz.newMeth(C$, 'descendingKeyIterator$', function () {
return Clazz.new_($I$(23,1).c$$java_util_TreeMap_Entry, [this, null, this.getLastEntry$()]);
});
...
return (e == null ) ? null : Clazz.new_(1,{K:"Object",V:"Object"},$I$(24,1).c$$java_util_Map_Entry,[e]);
}, 1);
...
}var middle=Clazz.new_(1,{K:"Object",V:"Object"},$I$(18,1).c$$TK$TV$java_util_TreeMap_Entry,[key, value, null]);
...
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(25,1).c$$java_util_TreeMap$java_util_TreeMap_Entry$java_util_TreeMap_Entry$I$I$I,[this, null, null, 0, -1, 0]);
});

Clazz.newMeth(C$, 'descendingKeySpliterator$', function () {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(26,1).c$$java_util_TreeMap$java_util_TreeMap_Entry$java_util_TreeMap_Entry$I$I$I,[this, null, null, 0, -2, 0]);
});
;
...
return Clazz.new_($I$(1,1).c$$java_util_TreeMap_Entry, [this, null, this.b$['java.util.TreeMap'].getFirstEntry$.apply(this.b$['java.util.TreeMap'], [])]);
});
...
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(2,1).c$$java_util_TreeMap$java_util_TreeMap_Entry$java_util_TreeMap_Entry$I$I$I,[this.b$['java.util.TreeMap'], null, null, 0, -1, 0]);
});
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(3,1).c$$java_util_TreeMap_Entry, [this, null, this.b$['java.util.TreeMap'].getFirstEntry$.apply(this.b$['java.util.TreeMap'], [])]);
});
...
Clazz.newMeth(C$, 'spliterator$', function () {
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(4,1).c$$java_util_TreeMap$java_util_TreeMap_Entry$java_util_TreeMap_Entry$I$I$I,[this.b$['java.util.TreeMap'], null, null, 0, -1, 0]);
});
...
return Clazz.new_(1,{E:"Object"},C$.c$$java_util_NavigableMap,[this.m.subMap$TK$Z$TK$Z(fromElement, fromInclusive, toElement, toInclusive)]);
});

Clazz.newMeth(C$, ['headSet$TE$Z'], function (toElement, inclusive) {
return Clazz.new_(1,{E:"Object"},C$.c$$java_util_NavigableMap,[this.m.headMap$TK$Z(toElement, inclusive)]);
});

Clazz.newMeth(C$, ['tailSet$TE$Z'], function (fromElement, inclusive) {
return Clazz.new_(1,{E:"Object"},C$.c$$java_util_NavigableMap,[this.m.tailMap$TK$Z(fromElement, inclusive)]);
});
...
return Clazz.new_(1,{E:"Object"},C$.c$$java_util_NavigableMap,[this.m.descendingMap$()]);
});
...
return (nksv != null ) ? nksv : (this.navigableKeySetView=Clazz.new_(1,{E:"Object"},$I$(6,1).c$$java_util_NavigableMap,[this]));
});
...
Clazz.newMeth(C$, ['c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z'], function (m, fromStart, lo, loInclusive, toEnd, hi, hiInclusive) {
;C$.superclazz.c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z.apply(this,[m, fromStart, lo, loInclusive, toEnd, hi, hiInclusive]);C$.$init$.apply(this);
}, 1);
...
return Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.m, false, fromKey, fromInclusive, false, toKey, toInclusive]);
});

Clazz.newMeth(C$, ['headMap$TK$Z'], function (toKey, inclusive) {
if (!this.inRange$O$Z(toKey, inclusive)) throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["toKey out of range"]);
return Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.m, this.fromStart, this.lo, this.loInclusive, false, toKey, inclusive]);
});

Clazz.newMeth(C$, ['tailMap$TK$Z'], function (fromKey, inclusive) {
if (!this.inRange$O$Z(fromKey, inclusive)) throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["fromKey out of range"]);
return Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.m, false, fromKey, inclusive, this.toEnd, this.hi, this.hiInclusive]);
});

Clazz.newMeth(C$, 'descendingMap$', function () {
var mv=this.descendingMapView;
return (mv != null ) ? mv : (this.descendingMapView=Clazz.new_(1,{K:"Object",V:"Object"},$I$(8,1).c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.m, this.fromStart, this.lo, this.loInclusive, this.toEnd, this.hi, this.hiInclusive]));
});

Clazz.newMeth(C$, 'keyIterator$', function () {
return Clazz.new_($I$(9,1).c$$java_util_TreeMap_Entry$java_util_TreeMap_Entry, [this, null, this.absLowest$(), this.absHighFence$()]);
});
...
Clazz.newMeth(C$, 'descendingKeyIterator$', function () {
return Clazz.new_($I$(10,1).c$$java_util_TreeMap_Entry$java_util_TreeMap_Entry, [this, null, this.absHighest$(), this.absLowFence$()]);
});
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(7,1).c$$java_util_TreeMap_Entry$java_util_TreeMap_Entry, [this, null, this.b$['java.util.TreeMap.NavigableSubMap'].absLowest$.apply(this.b$['java.util.TreeMap.NavigableSubMap'], []), this.b$['java.util.TreeMap.NavigableSubMap'].absHighFence$.apply(this.b$['java.util.TreeMap.NavigableSubMap'], [])]);
});
...
if (!this.inRange$O$Z(fromKey, fromInclusive)) throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["fromKey out of range"]);
if (!this.inRange$O$Z(toKey, toInclusive)) throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["toKey out of range"]);
return Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.m, false, toKey, toInclusive, false, fromKey, fromInclusive]);
});

Clazz.newMeth(C$, ['headMap$TK$Z'], function (toKey, inclusive) {
if (!this.inRange$O$Z(toKey, inclusive)) throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["toKey out of range"]);
return Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.m, false, toKey, inclusive, this.toEnd, this.hi, this.hiInclusive]);
});

Clazz.newMeth(C$, ['tailMap$TK$Z'], function (fromKey, inclusive) {
if (!this.inRange$O$Z(fromKey, inclusive)) throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["fromKey out of range"]);
return Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.m, this.fromStart, this.lo, this.loInclusive, false, fromKey, inclusive]);
});

Clazz.newMeth(C$, 'descendingMap$', function () {
var mv=this.descendingMapView;
return (mv != null ) ? mv : (this.descendingMapView=Clazz.new_(1,{K:"Object",V:"Object"},$I$(14,1).c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.m, this.fromStart, this.lo, this.loInclusive, this.toEnd, this.hi, this.hiInclusive]));
});
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(12,1).c$$java_util_TreeMap_Entry$java_util_TreeMap_Entry, [this, null, this.b$['java.util.TreeMap.NavigableSubMap'].absHighest$.apply(this.b$['java.util.TreeMap.NavigableSubMap'], []), this.b$['java.util.TreeMap.NavigableSubMap'].absLowFence$.apply(this.b$['java.util.TreeMap.NavigableSubMap'], [])]);
});
...
return Clazz.new_(1,{K:"Object",V:"Object"},$I$(14,1).c$$java_util_TreeMap$Z$TK$Z$Z$TK$Z,[this.b$['java.util.TreeMap'], this.fromStart, this.fromKey, true, this.toEnd, this.toKey, false]);
}, p$1);
...
this.side=1;
return Clazz.new_(1,{K:"Object",V:"Object"},C$.c$$java_util_TreeMap$java_util_TreeMap_Entry$java_util_TreeMap_Entry$I$I$I,[this.tree, e, this.current=s, -1, this.est>>>=1, this.expectedModCount]);
}return null;
});
