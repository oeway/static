(function(){var P$=Clazz.newPackage("java.util.zip"),p$1={},I$=[[0,'javajs.util.Lst','java.util.Hashtable','java.util.zip.CRC32','java.util.zip.Deflater','swingjs.jzlib.ZStream','Boolean']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "ZipOutputStream", null, 'java.util.zip.DeflaterOutputStream', 'java.util.zip.ZipConstants');

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.xentries=Clazz.new_(1,{V:"java.util.zip.ZipEntry"},$I$(1,1));
this.names=Clazz.new_(1,{K:"String",V:"Boolean"},$I$(2,1));
...
C$.$fields$=[['Z',['finished','$closed'],'I',['method'],'L',['written','locoff'],'O',['current','java.util.zip.ZipEntry','xentries','javajs.util.Lst','names','java.util.Map','crc','java.util.zip.CRC32','comment','byte[]']]]
