(function(){var P$=java.util,I$=[[0,['java.util.JSHashMap','.KeyIterator'],['java.util.JSHashMap','.EntryIterator'],['java.util.JSHashMap','.KeySet'],['java.util.JSHashMap','.EntrySet'],'InternalError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.putVal$TK$TV$Z$Z(key, value, false, evict);
}
}});
...
return this.putVal$TK$TV$Z$Z(key, value, false, true);
});

Clazz.newMeth(C$, ['putVal$TK$TV$Z$Z'], function (key, value, onlyIfAbsent, evict) {
...
return this.putVal$TK$TV$Z$Z(key, value, true, true);
});
...
return Clazz.new_($I$(1,1).c$$O, [this, null, this.this$0.jsmap]);
});
...
var map=this.this$0.jsmap;
var mc=this.this$0.modCount;

a = [];
for (var k in map)a.push(k);
for (var i=0; i < this.this$0.size; ++i) {
action.accept$(a[i]);
}
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(2,1).c$$O, [this, null, this.this$0.jsmap]);
});
...
var key=null;
var value=null;
action.accept$(((P$.JSHashMap$EntrySet$1||
...
Clazz.newMeth(C$, ['setValue$O','setValue$TV'], function (val) {
this.b$['java.util.JSHashMap'].put$TK$TV.apply(this.b$['java.util.JSHashMap'], [this.$finals$.key, val]);
return this.$finals$.value;
});
})()
