(function(){var P$=java.util,p$1={},I$=[[0,'java.util.Hashtable','java.util.TimeZone','java.util.Locale','java.util.GregorianCalendar','java.util.Date','java.text.DateFormatSymbols','java.util.HashMap','InternalError','StringBuilder','sun.util.resources.LocaleData']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "Calendar", null, null, ['Cloneable', 'Comparable']);

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.cachedLocaleData=Clazz.new_(1,{K:"java.util.Locale",V:"int[]"},$I$(1,1).c$$I,[3]);
...
C$.$fields$=[['Z',['isTimeSet','areFieldsSet','areAllFieldsSet','lenient','sharedZone'],'I',['firstDayOfWeek','minimalDaysInFirstWeek','nextStamp'],'L',['time'],'O',['fields','int[]','isSet','boolean[]','stamp','int[]','zone','java.util.TimeZone']]
,['O',['cachedLocaleData','java.util.Hashtable','FIELD_NAME','String[]']]]
...
return Clazz.new_($I$(4,1).c$$java_util_TimeZone$java_util_Locale,[zone, aLocale]);
}, 1);

Clazz.newMeth(C$, 'getTime$', function () {
return Clazz.new_($I$(5,1).c$$J,[this.getTimeInMillis$()]);
});
...
var strings=p$1.getFieldStrings$I$I$java_text_DateFormatSymbols.apply(this, [field, style, symbols]);
if (strings != null ) {
var names=Clazz.new_(1,{K:"String",V:"Integer"},$I$(7,1));
...
var buffer=Clazz.new_($I$(9,1).c$$I,[800]);
