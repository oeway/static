(function(){var P$=java.util,I$=[[0,'java.util.Date','sun.util.calendar.ZoneInfo','InternalError','java.util.HashMap']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TimeZone", null, null, 'Cloneable');
...
C$.$fields$=[['S',['ID']]
,['O',['NO_TIMEZONE','java.util.TimeZone','+defaultTimeZone','zoneInfoObjects','java.util.Map']]]
...
if (this.inDaylightTime$java_util_Date(Clazz.new_($I$(1,1).c$$J,[date]))) {
...
if (tz == null  && fallback ) {
tz=Clazz.new_($I$(2,1).c$$S$I,["GMT", 0]);
}return tz;
}, 1);
...
C$.addToCache$S$sun_util_calendar_ZoneInfo(gmtOffsetID, Clazz.new_($I$(2,1).c$$S$I,[gmtOffsetID, ms]));
...
if (zi == null ) {
zi=Clazz.new_($I$(2,1).c$$S$I,[id, gmtOffset]);
...
if (C$.zoneInfoObjects == null ) {
C$.zoneInfoObjects=Clazz.new_(1,{K:"String",V:"sun.util.calendar.ZoneInfo"},$I$(4,1));
} else {
