...
), Clazz.new_(1,{T:"java.util.Spliterator"},P$.AbstractPipeline$lambda1.$init$, [this, null]))))), this.isParallel$());
}});
...
Clazz.newMeth(C$, ['wrapAndCopyInto$TS$java_util_Spliterator','wrapAndCopyIntonull'], function (sink, spliterator) {
...
), Clazz.new_(1,{T:"java.util.Spliterator"},P$.AbstractPipeline$lambda2.$init$, [this, {sourceSpliterator:sourceSpliterator}])), this.isParallel$());
}});
...
), Clazz.new_(1,{R:"_.E_OUT[]"},P$.AbstractPipeline$lambda3.$init$, [this, null])))))).spliterator$();
});
