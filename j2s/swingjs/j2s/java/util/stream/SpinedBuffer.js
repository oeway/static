(function(){var P$=Clazz.newPackage("java.util.stream"),p$1={},p$2={},I$=[[0,'java.util.Objects','java.util.Arrays','java.util.stream.Tripwire','java.util.Spliterators',['java.util.stream.SpinedBuffer','.OfPrimitive','.BaseSpliterator'],'java.util.ArrayList']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['O',['curChunk','_.E[]','spine','_.E[][]']]]
...
var list=Clazz.new_(1,{E:"Object"},$I$(6,1));
...
/*lambda_M*/
Clazz.newMeth(C$, ['accept$'], function (t) { return $$.add$TE.apply($$,[t])});
})()
)); return Clazz.new_(1,{T:"_.? super E"},P$.SpinedBuffer$lambda1.$init$, [this, null])})(list));
...
Clazz.newMeth(C$, 'spliterator$', function () {
return Clazz.new_(1,{T_SPLITR:"java.util.Spliterator.OfInt"},$I$(5,1).c$$I$I$I$I, [this, null, 0, this.spineIndex, 0, this.elementIndex],P$.SpinedBuffer$OfInt$1Splitr);
});
...
return Clazz.new_(1,{T_SPLITR:"java.util.Spliterator.OfInt"},$I$(5,1).c$$I$I$I$I, [this, null, firstSpineIndex, lastSpineIndex, firstSpineElementIndex, lastSpineElementFence],C$);
});
...
Clazz.newMeth(C$, 'spliterator$', function () {
return Clazz.new_(1,{T_SPLITR:"java.util.Spliterator.OfLong"},$I$(5,1).c$$I$I$I$I, [this, null, 0, this.spineIndex, 0, this.elementIndex],P$.SpinedBuffer$OfLong$1Splitr);
});
...
Clazz.newMeth(C$, 'newSpliterator$I$I$I$I', function (firstSpineIndex, lastSpineIndex, firstSpineElementIndex, lastSpineElementFence) {
return Clazz.new_(1,{T_SPLITR:"java.util.Spliterator.OfLong"},$I$(5,1).c$$I$I$I$I, [this, null, firstSpineIndex, lastSpineIndex, firstSpineElementIndex, lastSpineElementFence],C$);
});
...
Clazz.newMeth(C$, 'spliterator$', function () {
return Clazz.new_(1,{T_SPLITR:"java.util.Spliterator.OfDouble"},$I$(5,1).c$$I$I$I$I, [this, null, 0, this.spineIndex, 0, this.elementIndex],P$.SpinedBuffer$OfDouble$1Splitr);
});
...
Clazz.newMeth(C$, 'newSpliterator$I$I$I$I', function (firstSpineIndex, lastSpineIndex, firstSpineElementIndex, lastSpineElementFence) {
return Clazz.new_(1,{T_SPLITR:"java.util.Spliterator.OfDouble"},$I$(5,1).c$$I$I$I$I, [this, null, firstSpineIndex, lastSpineIndex, firstSpineElementIndex, lastSpineElementFence],C$);
});
