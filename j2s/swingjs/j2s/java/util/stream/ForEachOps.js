(function(){var P$=Clazz.newPackage("java.util.stream"),I$=[[0,'java.util.stream.StreamShape','java.util.stream.StreamOpFlag',['java.util.stream.ForEachOps','.ForEachOrderedTask'],['java.util.stream.ForEachOps','.ForEachTask'],'java.util.stream.AbstractTask','java.util.concurrent.ConcurrentHashMap','java.util.Objects',['java.util.stream.ForEachOps','.ForEachOp','.OfRef'],['java.util.stream.ForEachOps','.ForEachOp','.OfInt'],['java.util.stream.ForEachOps','.ForEachOp','.OfLong'],['java.util.stream.ForEachOps','.ForEachOp','.OfDouble']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_(1,{T:"Object"},$I$(8,1).c$$java_util_function_Consumer$Z,[action, ordered]);
}, 1);
...
if (this.ordered) Clazz.new_(1,{S:"Object",T:"Object"},$I$(3,1).c$$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_stream_Sink,[helper, spliterator, this]).invoke$();
 else Clazz.new_(1,{S:"Object",T:"Object"},$I$(4,1).c$$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_stream_Sink,[helper, spliterator, helper.wrapSink$java_util_stream_Sink(this)]).invoke$();
return null;
});
...
C$.$fields$=[['L',['targetSize'],'O',['spliterator','java.util.Spliterator','sink','java.util.stream.Sink','helper','java.util.stream.PipelineHelper']]]
...
break;
}var leftTask=Clazz.new_(1,{S:"Object",T:"Object"},C$.c$$java_util_stream_ForEachOps_ForEachTask$java_util_Spliterator,[task, leftSplit]);
...
C$.$fields$=[['L',['targetSize'],'O',['helper','java.util.stream.PipelineHelper','spliterator','java.util.Spliterator','completionMap','java.util.concurrent.ConcurrentHashMap','action','java.util.stream.Sink','leftPredecessor','java.util.stream.ForEachOps.ForEachOrderedTask','node','java.util.stream.Node']]]
...
this.completionMap=Clazz.new_(1,{K:"java.util.stream.ForEachOps.ForEachOrderedTask",V:"java.util.stream.ForEachOps.ForEachOrderedTask"},$I$(6,1).c$$I,[Math.max(16, $I$(5).LEAF_TARGET << 1)]);
this.action=action;
...
var leftChild=Clazz.new_(1,{S:"Object",T:"Object"},C$.c$$java_util_stream_ForEachOps_ForEachOrderedTask$java_util_Spliterator$java_util_stream_ForEachOps_ForEachOrderedTask,[task, leftSplit, task.leftPredecessor]);
var rightChild=Clazz.new_(1,{S:"Object",T:"Object"},C$.c$$java_util_stream_ForEachOps_ForEachOrderedTask$java_util_Spliterator$java_util_stream_ForEachOps_ForEachOrderedTask,[task, rightSplit, leftChild]);
task.addToPendingCount$I(1);
...
), Clazz.new_(1,{R:"_.T[]"},P$.ForEachOps$ForEachOrderedTask$lambda1.$init$, [this, null])))));
