...
), Clazz.new_(P$.DoubleStream$1.$init$, [this, {f:f,seed:seed}]));
...
return $I$(2).doubleStream$java_util_Spliterator_OfDouble$Z(Clazz.new_($I$(6,1).c$$J$java_util_function_DoubleSupplier,[9223372036854775807, s]), false);
}, 1);
...
var split=Clazz.new_($I$(7,1).c$$java_util_Spliterator_OfDouble$java_util_Spliterator_OfDouble,[a.spliterator$(), b.spliterator$()]);
