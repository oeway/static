...
switch (shape) {
case $I$(3).REFERENCE:
return Clazz.new_(1,{T:"Object"},$I$(4,1).c$$java_util_Spliterator$J$J,[s, skip, sliceFence]);
case $I$(3).INT_VALUE:
...
), Clazz.new_(1,{R:"_.T[]"},P$.SliceOps$lambda1.$init$, [this, null])))));
}, 1);
...
skip=0;
}return Clazz.new_(1,{T:"Object"},$I$(8,1).c$$java_util_Spliterator$J$J,[s, skip, limit]);
});
...
return Clazz.new_(1,{T:"Object"},$I$(4,1).c$$java_util_Spliterator$J$J,[helper.wrapSpliterator$java_util_Spliterator(spliterator), this.$finals$.skip, P$.SliceOps.calcSliceFence$J$J(this.$finals$.skip, this.$finals$.limit)]);
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Object"},$I$(9,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J,[this, helper, spliterator, P$.SliceOps.castingArray$(), this.$finals$.skip, this.$finals$.limit]).invoke$().spliterator$();
}});
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Object"},$I$(9,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J,[this, helper, spliterator, generator, this.$finals$.skip, this.$finals$.limit]).invoke$();
}});
...
), Clazz.new_(1,{T:"Object",E_OUT:"Object"},$I$(10,1).c$$java_util_stream_Sink, [this, {skip:this.$finals$.skip,limit:this.$finals$.limit}, sink],P$.SliceOps$1$1));
});
})()
), Clazz.new_(1,{E_IN:"Object",E_OUT:"Object"},$I$(11,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {skip:skip,limit:limit}, upstream, $I$(3).REFERENCE, C$.flags$J(limit)],P$.SliceOps$1));
}, 1);
...
limit=limit >= 0 ? Math.min(limit, sizeIfKnown - skip) : sizeIfKnown - skip;
skip=0;
}return Clazz.new_($I$(12,1).c$$java_util_Spliterator_OfInt$J$J,[s, skip, limit]);
});

Clazz.newMeth(C$, 'opEvaluateParallelLazy$java_util_stream_PipelineHelper$java_util_Spliterator', function (helper, spliterator) {
var size=helper.exactOutputSizeIfKnown$java_util_Spliterator(spliterator);
if (size > 0 && spliterator.hasCharacteristics$I(16384) ) {
return Clazz.new_($I$(5,1).c$$java_util_Spliterator_OfInt$J$J,[helper.wrapSpliterator$java_util_Spliterator(spliterator), this.$finals$.skip, P$.SliceOps.calcSliceFence$J$J(this.$finals$.skip, this.$finals$.limit)]);
} else if (!$I$(2).ORDERED.isKnown$I(helper.getStreamAndOpFlags$())) {
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Integer"},$I$(9,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J,[this, helper, spliterator, ((P$.SliceOps$2$lambda2||
...
), Clazz.new_(1,{R:"Integer[]"},P$.SliceOps$2$lambda2.$init$, [this, null])), this.$finals$.skip, this.$finals$.limit]).invoke$().spliterator$();
}});
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Integer"},$I$(9,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J,[this, helper, spliterator, generator, this.$finals$.skip, this.$finals$.limit]).invoke$();
}});
...
), Clazz.new_(1,{E_OUT:"Integer"},$I$(13,1).c$$java_util_stream_Sink, [this, {skip:this.$finals$.skip,limit:this.$finals$.limit}, sink],P$.SliceOps$2$1));
});
})()
), Clazz.new_(1,{E_IN:"Integer"},$I$(14,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {skip:skip,limit:limit}, upstream, $I$(3).INT_VALUE, C$.flags$J(limit)],P$.SliceOps$2));
}, 1);
...
limit=limit >= 0 ? Math.min(limit, sizeIfKnown - skip) : sizeIfKnown - skip;
skip=0;
}return Clazz.new_($I$(15,1).c$$java_util_Spliterator_OfLong$J$J,[s, skip, limit]);
});

Clazz.newMeth(C$, 'opEvaluateParallelLazy$java_util_stream_PipelineHelper$java_util_Spliterator', function (helper, spliterator) {
var size=helper.exactOutputSizeIfKnown$java_util_Spliterator(spliterator);
if (size > 0 && spliterator.hasCharacteristics$I(16384) ) {
return Clazz.new_($I$(6,1).c$$java_util_Spliterator_OfLong$J$J,[helper.wrapSpliterator$java_util_Spliterator(spliterator), this.$finals$.skip, P$.SliceOps.calcSliceFence$J$J(this.$finals$.skip, this.$finals$.limit)]);
} else if (!$I$(2).ORDERED.isKnown$I(helper.getStreamAndOpFlags$())) {
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Long"},$I$(9,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J,[this, helper, spliterator, ((P$.SliceOps$3$lambda3||
(function(){/*m*/var C$=Clazz.newClass(P$, "SliceOps$3$lambda3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.IntFunction', 1);
...
), Clazz.new_(1,{R:"Long[]"},P$.SliceOps$3$lambda3.$init$, [this, null])), this.$finals$.skip, this.$finals$.limit]).invoke$().spliterator$();
}});
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Long"},$I$(9,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J,[this, helper, spliterator, generator, this.$finals$.skip, this.$finals$.limit]).invoke$();
}});
...
), Clazz.new_(1,{E_OUT:"Long"},$I$(16,1).c$$java_util_stream_Sink, [this, {skip:this.$finals$.skip,limit:this.$finals$.limit}, sink],P$.SliceOps$3$1));
});
})()
), Clazz.new_(1,{E_IN:"Long"},$I$(17,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {skip:skip,limit:limit}, upstream, $I$(3).LONG_VALUE, C$.flags$J(limit)],P$.SliceOps$3));
}, 1);
...
limit=limit >= 0 ? Math.min(limit, sizeIfKnown - skip) : sizeIfKnown - skip;
skip=0;
}return Clazz.new_($I$(18,1).c$$java_util_Spliterator_OfDouble$J$J,[s, skip, limit]);
});

Clazz.newMeth(C$, 'opEvaluateParallelLazy$java_util_stream_PipelineHelper$java_util_Spliterator', function (helper, spliterator) {
var size=helper.exactOutputSizeIfKnown$java_util_Spliterator(spliterator);
if (size > 0 && spliterator.hasCharacteristics$I(16384) ) {
return Clazz.new_($I$(7,1).c$$java_util_Spliterator_OfDouble$J$J,[helper.wrapSpliterator$java_util_Spliterator(spliterator), this.$finals$.skip, P$.SliceOps.calcSliceFence$J$J(this.$finals$.skip, this.$finals$.limit)]);
} else if (!$I$(2).ORDERED.isKnown$I(helper.getStreamAndOpFlags$())) {
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Double"},$I$(9,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J,[this, helper, spliterator, ((P$.SliceOps$4$lambda4||
(function(){/*m*/var C$=Clazz.newClass(P$, "SliceOps$4$lambda4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.IntFunction', 1);
...
), Clazz.new_(1,{R:"Double[]"},P$.SliceOps$4$lambda4.$init$, [this, null])), this.$finals$.skip, this.$finals$.limit]).invoke$().spliterator$();
}});
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Double"},$I$(9,1).c$$java_util_stream_AbstractPipeline$java_util_stream_PipelineHelper$java_util_Spliterator$java_util_function_IntFunction$J$J,[this, helper, spliterator, generator, this.$finals$.skip, this.$finals$.limit]).invoke$();
}});
...
), Clazz.new_(1,{E_OUT:"Double"},$I$(19,1).c$$java_util_stream_Sink, [this, {limit:this.$finals$.limit,skip:this.$finals$.skip}, sink],P$.SliceOps$4$1));
});
})()
), Clazz.new_(1,{E_IN:"Double"},$I$(20,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {limit:limit,skip:skip}, upstream, $I$(3).DOUBLE_VALUE, C$.flags$J(limit)],P$.SliceOps$4));
}, 1);
...
C$.$fields$=[['Z',['completed'],'L',['targetOffset','$targetSize','thisNodeSize'],'O',['op','java.util.stream.AbstractPipeline','generator','java.util.function.IntFunction']]]
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Object"},C$.c$$java_util_stream_SliceOps_SliceTask$java_util_Spliterator,[this, spliterator]);
});
