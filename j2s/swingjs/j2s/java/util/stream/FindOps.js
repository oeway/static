...
return Clazz.new_(1,{T:"Object",O:"java.util.Optional"},$I$(7,1).c$$Z$java_util_stream_StreamShape$TO$java_util_function_Predicate$java_util_function_Supplier,[mustFindFirst, $I$(8).REFERENCE, $I$(3).empty$(), (function($$){((
...
)); return Clazz.new_(1,{T:"java.util.Optional"},P$.FindOps$lambda1.$init$, [this, null])})($I$(3)), ((P$.FindOps$lambda2||
...
), Clazz.new_(1,{T:"java.util.stream.TerminalSink"},P$.FindOps$lambda2.$init$, [this, null]))]);
}, 1);

Clazz.newMeth(C$, 'makeInt$Z', function (mustFindFirst) {
return Clazz.new_(1,{T:"Integer",O:"java.util.OptionalInt"},$I$(7,1).c$$Z$java_util_stream_StreamShape$TO$java_util_function_Predicate$java_util_function_Supplier,[mustFindFirst, $I$(8).INT_VALUE, $I$(4).empty$(), (function($$){((
...
)); return Clazz.new_(1,{T:"java.util.OptionalInt"},P$.FindOps$lambda3.$init$, [this, null])})($I$(4)), ((P$.FindOps$lambda4||
...
), Clazz.new_(1,{T:"java.util.stream.TerminalSink"},P$.FindOps$lambda4.$init$, [this, null]))]);
}, 1);

Clazz.newMeth(C$, 'makeLong$Z', function (mustFindFirst) {
return Clazz.new_(1,{T:"Long",O:"java.util.OptionalLong"},$I$(7,1).c$$Z$java_util_stream_StreamShape$TO$java_util_function_Predicate$java_util_function_Supplier,[mustFindFirst, $I$(8).LONG_VALUE, $I$(5).empty$(), (function($$){((
...
)); return Clazz.new_(1,{T:"java.util.OptionalLong"},P$.FindOps$lambda5.$init$, [this, null])})($I$(5)), ((P$.FindOps$lambda6||
...
), Clazz.new_(1,{T:"java.util.stream.TerminalSink"},P$.FindOps$lambda6.$init$, [this, null]))]);
}, 1);

Clazz.newMeth(C$, 'makeDouble$Z', function (mustFindFirst) {
return Clazz.new_(1,{T:"Double",O:"java.util.OptionalDouble"},$I$(7,1).c$$Z$java_util_stream_StreamShape$TO$java_util_function_Predicate$java_util_function_Supplier,[mustFindFirst, $I$(8).DOUBLE_VALUE, $I$(6).empty$(), (function($$){((
...
)); return Clazz.new_(1,{T:"java.util.OptionalDouble"},P$.FindOps$lambda7.$init$, [this, null])})($I$(6)), ((P$.FindOps$lambda8||
...
), Clazz.new_(1,{T:"java.util.stream.TerminalSink"},P$.FindOps$lambda8.$init$, [this, null]))]);
}, 1);
;
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Object",O:"Object"},$I$(2,1).c$$java_util_stream_FindOps_FindOp$java_util_stream_PipelineHelper$java_util_Spliterator,[this, helper, spliterator]).invoke$();
});
...
Clazz.newMeth(C$, 'get$', function () {
return this.hasValue ? $I$(4).of$I((this.value).valueOf()) : null;
});
...
return Clazz.new_(1,{P_IN:"Object",P_OUT:"Object",O:"Object"},C$.c$$java_util_stream_FindOps_FindTask$java_util_Spliterator,[this, spliterator]);
});
