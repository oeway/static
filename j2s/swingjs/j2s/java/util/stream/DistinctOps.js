...
), Clazz.new_(1,{T:"java.util.LinkedHashSet"},P$.DistinctOps$1$lambda1.$init$, [this, null])), (function($$){((
...
)); return Clazz.new_(1,{T:"java.util.LinkedHashSet",U:"_.? super T"},P$.DistinctOps$1$lambda2.$init$, [this, null])})($I$(3)), (function($$){((
...
)); return Clazz.new_(1,{T:"java.util.LinkedHashSet",U:"java.util.LinkedHashSet"},P$.DistinctOps$1$lambda3.$init$, [this, null])})($I$(4)));
...
var map=Clazz.new_(1,{K:"Object",V:"Boolean"},$I$(8,1));
...
), Clazz.new_(1,{T:"_.? super T"},P$.DistinctOps$1$lambda4.$init$, [this, {map:map,seenNull:seenNull}])), false);
forEachOp.evaluateParallel$java_util_stream_PipelineHelper$java_util_Spliterator(helper, spliterator);
var keys=map.keySet$();
if (seenNull.get$()) {
keys=Clazz.new_(1,{E:"Object"},$I$(3,1).c$$java_util_Collection,[keys]);
keys.add$TE(null);
...
return Clazz.new_(1,{T:"Object"},$I$(11,1).c$$java_util_Spliterator,[helper.wrapSpliterator$java_util_Spliterator(spliterator)]);
}});
...
), Clazz.new_(1,{T:"Object",E_OUT:"Object"},$I$(13,1).c$$java_util_stream_Sink, [this, null, sink],P$.DistinctOps$1$1));
} else {
...
Clazz.newMeth(C$, 'begin$J', function (size) {
this.seen=Clazz.new_(1,{E:"Object"},$I$(3,1));
this.downstream.begin$J(-1);
});
...
), Clazz.new_(1,{T:"Object",E_OUT:"Object"},$I$(13,1).c$$java_util_stream_Sink, [this, null, sink],P$.DistinctOps$1$2));
}});
})()
), Clazz.new_(1,{E_IN:"Object",E_OUT:"Object"},$I$(14,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, null, upstream, $I$(15).REFERENCE, $I$(6).IS_DISTINCT | $I$(6).NOT_SIZED],P$.DistinctOps$1));
}, 1);
})();
