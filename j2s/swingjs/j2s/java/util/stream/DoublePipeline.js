...
/*lambda_M*/
Clazz.newMeth(C$, 'apply$', function (t) { return $$.valueOf$D.apply(null,[t])});
})()
)); return Clazz.new_(1,{R:"? extends java.lang.Double"},P$.DoublePipeline$lambda2.$init$, [this, null])})(Double)))));
});
...
), Clazz.new_(1,{E_OUT:"Double"},$I$(9,1).c$$java_util_stream_Sink, [this, {mapper:this.$finals$.mapper}, sink],P$.DoublePipeline$1$1));
});
})()
), Clazz.new_(1,{E_IN:"Double"},$I$(10,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {mapper:mapper}, this, $I$(3).DOUBLE_VALUE, $I$(11).NOT_SORTED | $I$(11).NOT_DISTINCT],P$.DoublePipeline$1));
});
...
), Clazz.new_(1,{E_OUT:"Object"},$I$(9,1).c$$java_util_stream_Sink, [this, {mapper:this.$finals$.mapper}, sink],P$.DoublePipeline$2$1));
});
})()
), Clazz.new_(1,{E_IN:"Double",E_OUT:"Object"},$I$(12,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {mapper:mapper}, this, $I$(3).DOUBLE_VALUE, $I$(11).NOT_SORTED | $I$(11).NOT_DISTINCT],P$.DoublePipeline$2));
});
...
), Clazz.new_(1,{E_OUT:"Integer"},$I$(9,1).c$$java_util_stream_Sink, [this, {mapper:this.$finals$.mapper}, sink],P$.DoublePipeline$3$1));
});
})()
), Clazz.new_(1,{E_IN:"Double"},$I$(13,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {mapper:mapper}, this, $I$(3).DOUBLE_VALUE, $I$(11).NOT_SORTED | $I$(11).NOT_DISTINCT],P$.DoublePipeline$3));
});
...
), Clazz.new_(1,{E_OUT:"Long"},$I$(9,1).c$$java_util_stream_Sink, [this, {mapper:this.$finals$.mapper}, sink],P$.DoublePipeline$4$1));
});
})()
), Clazz.new_(1,{E_IN:"Double"},$I$(14,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {mapper:mapper}, this, $I$(3).DOUBLE_VALUE, $I$(11).NOT_SORTED | $I$(11).NOT_DISTINCT],P$.DoublePipeline$4));
});
...
/*try*/ {
if (result != null ) result.sequential$().forEach$java_util_function_DoubleConsumer((P$.DoublePipeline$5$1$lambda3$||(P$.DoublePipeline$5$1$lambda3$=(((P$.DoublePipeline$5$1$lambda3||
...
/*lambda_E*/
Clazz.newMeth(C$, 'accept$', function (i) { return (this.b$['java.util.stream.DoublePipeline$5$1'].downstream.accept$(i));});
})()
...
), Clazz.new_(1,{E_OUT:"Double"},$I$(9,1).c$$java_util_stream_Sink, [this, {mapper:this.$finals$.mapper}, sink],P$.DoublePipeline$5$1));
});
})()
), Clazz.new_(1,{E_IN:"Double"},$I$(10,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {mapper:mapper}, this, $I$(3).DOUBLE_VALUE, $I$(11).NOT_SORTED | $I$(11).NOT_DISTINCT | $I$(11).NOT_SIZED ],P$.DoublePipeline$5));
});
...
), Clazz.new_(1,{E_IN:"Double"},$I$(10,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, null, this, $I$(3).DOUBLE_VALUE, $I$(11).NOT_ORDERED],P$.DoublePipeline$6));
});
...
), Clazz.new_(1,{E_OUT:"Double"},$I$(9,1).c$$java_util_stream_Sink, [this, {predicate:this.$finals$.predicate}, sink],P$.DoublePipeline$7$1));
});
})()
), Clazz.new_(1,{E_IN:"Double"},$I$(10,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {predicate:predicate}, this, $I$(3).DOUBLE_VALUE, $I$(11).NOT_SIZED],P$.DoublePipeline$7));
});
...
), Clazz.new_(1,{E_OUT:"Double"},$I$(9,1).c$$java_util_stream_Sink, [this, {action:this.$finals$.action}, sink],P$.DoublePipeline$8$1));
});
})()
), Clazz.new_(1,{E_IN:"Double"},$I$(10,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I, [this, {action:action}, this, $I$(3).DOUBLE_VALUE, 0],P$.DoublePipeline$8));
});
...
return this.boxed$().distinct$().mapToDouble$java_util_function_ToDoubleFunction((P$.DoublePipeline$lambda4$||(P$.DoublePipeline$lambda4$=(((P$.DoublePipeline$lambda4||
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.ToDoubleFunction', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, 'applyAsDouble$', function (i) { return ((i).valueOf());});
})()
), Clazz.new_(1,{T:"? super java.lang.Double"},P$.DoublePipeline$lambda4.$init$, [this, null]))))));
});
...
var summation=this.collect$java_util_function_Supplier$java_util_function_ObjDoubleConsumer$java_util_function_BiConsumer((P$.DoublePipeline$lambda5$||(P$.DoublePipeline$lambda5$=(((P$.DoublePipeline$lambda5||
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Supplier', 1);
...
), Clazz.new_(1,{T:"double[]"},P$.DoublePipeline$lambda5.$init$, [this, null]))))), (P$.DoublePipeline$lambda6$||(P$.DoublePipeline$lambda6$=(((P$.DoublePipeline$lambda6||
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.ObjDoubleConsumer', 1);
...
), Clazz.new_(1,{T:"double[]"},P$.DoublePipeline$lambda6.$init$, [this, null]))))), (P$.DoublePipeline$lambda7$||(P$.DoublePipeline$lambda7$=(((P$.DoublePipeline$lambda7||
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.BiConsumer', 1);
...
), Clazz.new_(1,{T:"double[]",U:"double[]"},P$.DoublePipeline$lambda7.$init$, [this, null]))))));
...
/*lambda_M*/
Clazz.newMeth(C$, 'applyAsDouble$', function (t,u) { return $$.min.apply(null,[t,u])});
})()
)); return Clazz.new_(P$.DoublePipeline$lambda8.$init$, [this, null])})(Math)))));
});

Clazz.newMeth(C$, 'max$', function () {
return this.reduce$java_util_function_DoubleBinaryOperator((P$.DoublePipeline$lambda9$||(P$.DoublePipeline$lambda9$=((function($$){((
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda9", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.DoubleBinaryOperator', 1);
...
/*lambda_M*/
Clazz.newMeth(C$, 'applyAsDouble$', function (t,u) { return $$.max.apply(null,[t,u])});
})()
)); return Clazz.new_(P$.DoublePipeline$lambda9.$init$, [this, null])})(Math)))));
});

Clazz.newMeth(C$, 'average$', function () {
var avg=this.collect$java_util_function_Supplier$java_util_function_ObjDoubleConsumer$java_util_function_BiConsumer((P$.DoublePipeline$lambda10$||(P$.DoublePipeline$lambda10$=(((P$.DoublePipeline$lambda10||
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda10", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Supplier', 1);
...
), Clazz.new_(1,{T:"double[]"},P$.DoublePipeline$lambda10.$init$, [this, null]))))), (P$.DoublePipeline$lambda11$||(P$.DoublePipeline$lambda11$=(((P$.DoublePipeline$lambda11||
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda11", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.ObjDoubleConsumer', 1);
...
), Clazz.new_(1,{T:"double[]"},P$.DoublePipeline$lambda11.$init$, [this, null]))))), (P$.DoublePipeline$lambda12$||(P$.DoublePipeline$lambda12$=(((P$.DoublePipeline$lambda12||
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda12", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.BiConsumer', 1);
...
), Clazz.new_(1,{T:"double[]",U:"double[]"},P$.DoublePipeline$lambda12.$init$, [this, null]))))));
return avg[2] > 0  ? $I$(19).of$D($I$(18).computeFinalSum$DA(avg) / avg[2]) : $I$(19).empty$();
});

Clazz.newMeth(C$, 'count$', function () {
return this.mapToLong$java_util_function_DoubleToLongFunction((P$.DoublePipeline$lambda13$||(P$.DoublePipeline$lambda13$=(((P$.DoublePipeline$lambda13||
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda13", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.DoubleToLongFunction', 1);
...
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda14", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Supplier', 1);
...
), Clazz.new_(1,{T:"java.util.DoubleSummaryStatistics"},P$.DoublePipeline$lambda14.$init$, [this, null])), (function($$){((
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda15", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.ObjDoubleConsumer', 1);
...
)); return Clazz.new_(1,{T:"java.util.DoubleSummaryStatistics"},P$.DoublePipeline$lambda15.$init$, [this, null])})($I$(20)), (function($$){((
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda16", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.BiConsumer', 1);
...
)); return Clazz.new_(1,{T:"java.util.DoubleSummaryStatistics",U:"java.util.DoubleSummaryStatistics"},P$.DoublePipeline$lambda16.$init$, [this, null])})($I$(20)));
});

Clazz.newMeth(C$, 'reduce$D$java_util_function_DoubleBinaryOperator', function (identity, op) {
return (this.evaluate$java_util_stream_TerminalOp($I$(21).makeDouble$D$java_util_function_DoubleBinaryOperator(identity, op))).valueOf();
});
...
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda17", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.BinaryOperator', 1);
...
), Clazz.new_(1,{T:"Object"},P$.DoublePipeline$lambda17.$init$, [this, {combiner:combiner}]));
...
return (this.evaluate$java_util_stream_TerminalOp($I$(22).makeDouble$java_util_function_DoublePredicate$java_util_stream_MatchOps_MatchKind(predicate, $I$(23).ANY))).valueOf();
});

Clazz.newMeth(C$, 'allMatch$java_util_function_DoublePredicate', function (predicate) {
return (this.evaluate$java_util_stream_TerminalOp($I$(22).makeDouble$java_util_function_DoublePredicate$java_util_stream_MatchOps_MatchKind(predicate, $I$(23).ALL))).valueOf();
});

Clazz.newMeth(C$, 'noneMatch$java_util_function_DoublePredicate', function (predicate) {
return (this.evaluate$java_util_stream_TerminalOp($I$(22).makeDouble$java_util_function_DoublePredicate$java_util_stream_MatchOps_MatchKind(predicate, $I$(23).NONE))).valueOf();
});
...
(function(){/*m*/var C$=Clazz.newClass(P$, "DoublePipeline$lambda18", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.IntFunction', 1);
...
), Clazz.new_(1,{R:"Double[]"},P$.DoublePipeline$lambda18.$init$, [this, null])))).asPrimitiveArray$();
});
;
