...
al.add$TE(Clazz.new_($I$(15,1).c$$S, [this, null, s.substring$I$I(i, m.start$())]));
}var n=m.groupCount$() - 1;
var sa=Clazz.array(String, [n]);
for (var j=0; j < n; j++) {
sa[j]=m.group$I(j + 1);
}
al.add$TE(Clazz.new_($I$(16,1).c$$java_util_Formatter$SA, [this, null, this, sa]));
i=m.end$();
} else {
p$3.checkText$S.apply(this, [s.substring$I(i)]);
al.add$TE(Clazz.new_($I$(15,1).c$$S, [this, null, s.substring$I(i)]));
break;
}}
...
if (this.formatter.locale$() !== l ) fmt=Clazz.new_($I$(5,1).c$$Appendable$java_util_Locale,[this.formatter.out$(), l]);
