...
C$.cacheList=Clazz.new_(1,{K:"java.util.ResourceBundle.CacheKey",V:"java.util.ResourceBundle"},$I$(12,1).c$$I,[32]);
}
...
}var cacheKey=Clazz.new_($I$(13,1).c$$S$java_util_Locale$O,[baseName, locale, loader]);
var bundle=null;
...
var locales=Clazz.new_(1,{E:"java.util.Locale"},$I$(6,1).c$$I,[4]);
if (variant.length$() > 0) {
...
return baseName;
}var sb=Clazz.new_($I$(10,1).c$$S,[baseName]);
sb.append$C("_");
if (variant != "") {
...
var sb=Clazz.new_($I$(10,1).c$$I,[bundleName.length$() + 1 + suffix.length$() ]);
