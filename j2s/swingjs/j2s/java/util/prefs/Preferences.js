(function(){var P$=Clazz.newPackage("java.util.prefs"),I$=[[0,'RuntimePermission','java.security.AccessController','java.security.AllPermission','Thread','InternalError','java.util.prefs.XmlSupport']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(6).importPreferences$java_io_InputStream(is);
}, 1);
})();
