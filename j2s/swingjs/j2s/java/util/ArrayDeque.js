...
return Clazz.new_(1,{E:"Object"},$I$(7,1).c$$java_util_ArrayDeque$I$I,[this, -1, -1]);
});
...
if (h > t) t+=n;
var m=((h + t) >>> 1) & (n - 1);
return Clazz.new_(1,{E:"Object"},C$.c$$java_util_ArrayDeque$I$I,[this.deq, h, this.index=m]);
}return null;
});
