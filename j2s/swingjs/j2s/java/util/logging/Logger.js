(function(){var P$=Clazz.newPackage("java.util.logging"),p$1={},I$=[[0,'java.util.logging.Logger','java.security.AccessController','Boolean','java.util.logging.Handler','java.util.logging.Level',['java.util.logging.Logger','.LoggerBundle'],'java.util.concurrent.CopyOnWriteArrayList','java.util.logging.LogManager','sun.reflect.Reflection','java.util.logging.LogRecord','java.util.ResourceBundle','InternalError','java.util.Locale','Thread','java.util.ArrayList',['java.util.logging.LogManager','.LoggerWeakRef']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.emptyHandlers=Clazz.array($I$(4), [0]);
C$.offValue=$I$(5).OFF.intValue$();
C$.SYSTEM_BUNDLE=Clazz.new_($I$(6,1).c$$S$java_util_ResourceBundle,["sun.util.logging.resources.logging", null]);
C$.NO_RESOURCE_BUNDLE=Clazz.new_($I$(6,1).c$$S$java_util_ResourceBundle,[null, null]);
C$.global=Clazz.new_(C$.c$$S,["global"]);
}

Clazz.newMeth(C$, '$init$', function () {
this.handlers=Clazz.new_(1,{E:"java.util.logging.Handler"},$I$(7,1));
...
C$.c$$S$S$Class$java_util_logging_LogManager$Z.apply(this, [name, resourceBundleName, null, $I$(8).getLogManager$(), false]);
}, 1);
...
this.name=name;
this.levelValue=$I$(5).INFO.intValue$();
}, 1);
...
var manager=$I$(8).getLogManager$();
var result=Clazz.new_(C$.c$$S$S$Class$java_util_logging_LogManager$Z,[null, resourceBundleName, $I$(9).getCallerClass$(), manager, false]);
...
return;
}var lr=Clazz.new_($I$(10,1).c$$java_util_logging_Level$S,[level, msg]);
...
if (!this.isLoggable$java_util_logging_Level(level)) {
return;
}var lr=Clazz.new_($I$(10,1).c$$java_util_logging_Level$S,[level, msgSupplier.get$()]);
p$1.doLog$java_util_logging_LogRecord.apply(this, [lr]);
});
...
this.logp$java_util_logging_Level$S$S$S($I$(5).FINER, sourceClass, sourceMethod, "ENTRY");
});

Clazz.newMeth(C$, 'entering$S$S$O', function (sourceClass, sourceMethod, param1) {
this.logp$java_util_logging_Level$S$S$S$O($I$(5).FINER, sourceClass, sourceMethod, "ENTRY {0}", param1);
});

Clazz.newMeth(C$, 'entering$S$S$OA', function (sourceClass, sourceMethod, params) {
var msg="ENTRY";
if (params == null ) {
this.logp$java_util_logging_Level$S$S$S($I$(5).FINER, sourceClass, sourceMethod, msg);
return;
}if (!this.isLoggable$java_util_logging_Level($I$(5).FINER)) return;
for (var i=0; i < params.length; i++) {
msg=msg + " {" + i + "}" ;
}
this.logp$java_util_logging_Level$S$S$S$OA($I$(5).FINER, sourceClass, sourceMethod, msg, params);
});

Clazz.newMeth(C$, 'exiting$S$S', function (sourceClass, sourceMethod) {
this.logp$java_util_logging_Level$S$S$S($I$(5).FINER, sourceClass, sourceMethod, "RETURN");
});

Clazz.newMeth(C$, 'exiting$S$S$O', function (sourceClass, sourceMethod, result) {
this.logp$java_util_logging_Level$S$S$S$O($I$(5).FINER, sourceClass, sourceMethod, "RETURN {0}", result);
});

Clazz.newMeth(C$, 'throwing$S$S$Throwable', function (sourceClass, sourceMethod, thrown) {
if (!this.isLoggable$java_util_logging_Level($I$(5).FINER)) {
return;
}var lr=Clazz.new_($I$(10,1).c$$java_util_logging_Level$S,[$I$(5).FINER, "THROW"]);
lr.setSourceClassName$S(sourceClass);
lr.setSourceMethodName$S(sourceMethod);
lr.setThrown$Throwable(thrown);
p$1.doLog$java_util_logging_LogRecord.apply(this, [lr]);
...
this.log$java_util_logging_Level$S($I$(5).SEVERE, msg);
});

Clazz.newMeth(C$, 'warning$S', function (msg) {
this.log$java_util_logging_Level$S($I$(5).WARNING, msg);
});

Clazz.newMeth(C$, 'info$S', function (msg) {
this.log$java_util_logging_Level$S($I$(5).INFO, msg);
});

Clazz.newMeth(C$, 'config$S', function (msg) {
this.log$java_util_logging_Level$S($I$(5).CONFIG, msg);
});

Clazz.newMeth(C$, 'fine$S', function (msg) {
this.log$java_util_logging_Level$S($I$(5).FINE, msg);
});

Clazz.newMeth(C$, 'finer$S', function (msg) {
this.log$java_util_logging_Level$S($I$(5).FINER, msg);
});

Clazz.newMeth(C$, 'finest$S', function (msg) {
this.log$java_util_logging_Level$S($I$(5).FINEST, msg);
});

Clazz.newMeth(C$, 'severe$java_util_function_Supplier', function (msgSupplier) {
this.log$java_util_logging_Level$java_util_function_Supplier($I$(5).SEVERE, msgSupplier);
});

Clazz.newMeth(C$, 'warning$java_util_function_Supplier', function (msgSupplier) {
this.log$java_util_logging_Level$java_util_function_Supplier($I$(5).WARNING, msgSupplier);
});

Clazz.newMeth(C$, 'info$java_util_function_Supplier', function (msgSupplier) {
this.log$java_util_logging_Level$java_util_function_Supplier($I$(5).INFO, msgSupplier);
});

Clazz.newMeth(C$, 'config$java_util_function_Supplier', function (msgSupplier) {
this.log$java_util_logging_Level$java_util_function_Supplier($I$(5).CONFIG, msgSupplier);
});

Clazz.newMeth(C$, 'fine$java_util_function_Supplier', function (msgSupplier) {
this.log$java_util_logging_Level$java_util_function_Supplier($I$(5).FINE, msgSupplier);
});

Clazz.newMeth(C$, 'finer$java_util_function_Supplier', function (msgSupplier) {
this.log$java_util_logging_Level$java_util_function_Supplier($I$(5).FINER, msgSupplier);
});

Clazz.newMeth(C$, 'finest$java_util_function_Supplier', function (msgSupplier) {
this.log$java_util_logging_Level$java_util_function_Supplier($I$(5).FINEST, msgSupplier);
});
...
return this.handlers.toArray$TTA(C$.emptyHandlers);
});
...
try {
return $I$(11).getBundle$S$java_util_Locale$O("sun.util.logging.resources.logging", this.$finals$.locale, ClassLoader.getSystemClassLoader$());
} catch (e) {
if (Clazz.exceptionOf(e,"java.util.MissingResourceException")){
throw Clazz.new_($I$(12,1).c$$S,[e.toString()]);
} else {
throw e;
}
}
...
if (name == null ) {
return null;
}var currentLocale=$I$(13).getDefault$();
...
return this.catalog;
}var cl=$I$(14).currentThread$().getContextClassLoader$();
if (cl == null ) {
cl=ClassLoader.getSystemClassLoader$();
}try {
this.catalog=$I$(11).getBundle$S$java_util_Locale$O(name, currentLocale, cl);
this.catalogName=name;
this.catalogLocale=currentLocale;
return this.catalog;
} catch (ex) {
...
this.catalog=$I$(11).getBundle$S$java_util_Locale$O(name, currentLocale, callersClassLoader);
this.catalogName=name;
this.catalogLocale=currentLocale;
return this.catalog;
} catch (ex) {
...
this.loggerBundle=$I$(6).get$S$java_util_ResourceBundle(name, null);
}, p$1);
...
}this.loggerBundle=$I$(6).get$S$java_util_ResourceBundle(baseName, bundle);
}});
...
this.parent.kids=Clazz.new_(1,{E:"java.util.logging.LogManager.LoggerWeakRef"},$I$(15,1).c$$I,[2]);
}if (ref == null ) {
ref=Clazz.new_($I$(16,1).c$$java_util_logging_Logger, [this.manager, null, this]);
}ref.setParentRef$java_util_logging_Logger(this.parent);
this.parent.kids.add$TE(ref);
p$1.updateEffectiveLevel.apply(this, []);
}, p$1);
...
newLevelValue=$I$(5).INFO.intValue$();
...
return $I$(6).get$S$java_util_ResourceBundle(rbName, b);
...
if (rbName != null ) {
return $I$(6).get$S$java_util_ResourceBundle(rbName, p$1.findResourceBundle$S$Z.apply(this, [rbName, true]));
...
return ($I$(3).valueOf$S(s)).valueOf();
}, 1);
