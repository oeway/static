(function(){var P$=Clazz.newPackage("java.util.logging"),I$=[[0,'java.text.MessageFormat']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
