(function(){var P$=Clazz.newPackage("java.util.logging"),I$=[[0,'java.util.logging.Logger','java.util.logging.LogManager','java.util.logging.Level']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
