...
this.listenerMap=Clazz.new_(1,{K:"java.lang.Object",V:"Integer"},$I$(6,1));
...
var listener=$I$(17).requireNonNull$TT(l);
this.checkPermission$();
{
var value=this.listenerMap.get$O(listener);
value=new Integer((value == null ) ? 1 : ((value).valueOf() + 1));
this.listenerMap.put$TK$TV(listener, value);
}});
...
this.listenerMap.put$TK$TV(listener, new Integer(i - 1));
}}}}});
...
var cxs=Clazz.new_(1,{E:"java.util.logging.LogManager.LoggerContext"},$I$(18,1));
cxs.add$TE(this.getSystemContext$());
cxs.add$TE(p$2.getUserContext.apply(this, []));
return cxs;
}, p$2);
...
var ix=0;
var result=Clazz.new_(1,{E:"String"},$I$(18,1));
...
return result.toArray$TTA(Clazz.array(String, [result.size$()]));
}, p$2);
...
var listeners=null;
{
if (!this.listenerMap.isEmpty$()) listeners=Clazz.new_(1,{K:"java.lang.Object",V:"Integer"},$I$(6,1).c$$java_util_Map,[this.listenerMap]);
}if (listeners != null ) {
...
this.this$0.reset$.apply(this.this$0, []);
});
})()
;
...
Clazz.newMeth(C$, '$init$', function () {
this.namedLoggers=Clazz.new_(1,{K:"String",V:"java.util.logging.LogManager.LoggerWeakRef"},$I$(1,1));
}, 1);
...
if (!this.requiresDefaultLoggers$() || logger == null   || logger !== $I$(4).global  && logger !== this.this$0.rootLogger   ) {
...
this.namedLoggers.put$TK$TV(name, ref);
var level=owner.getLevelProperty$S$java_util_logging_Level(name + ".level", null);
if (level != null  && !logger.isLevelInitialized$() ) {
P$.LogManager.doSetLevel$java_util_logging_Logger$java_util_logging_Level(logger, level);
...
if (parent != null ) {
P$.LogManager.doSetParent$java_util_logging_Logger$java_util_logging_Logger(logger, parent);
...
node.children=Clazz.new_(1,{K:"String",V:"java.util.logging.LogManager.LogNode"},$I$(6,1));
...
node.children.put$TK$TV(head, child);
}node=child;
}
return node;
});
...
if (result == null ) {
var newLogger=Clazz.new_($I$(4,1).c$$S$S$Class$java_util_logging_LogManager$Z,[name, resourceBundleName, null, this.getOwner$(), true]);
do {
...
Clazz.newMeth(C$, 'c$', function () {
;C$.superclazz.c$$S$S$Class$java_util_logging_LogManager$Z.apply(this,["", null, null, this.this$0, true]);C$.$init$.apply(this);
...
p$2.initializeGlobalHandlers.apply(this.this$0, []);
...
C$.propertyChangeMethod=C$.getMethod$Class$S$ClassA(C$.propertyChangeListenerClass, "propertyChange", [C$.propertyChangeEventClass]);
C$.propertyEventCtor=C$.getConstructor$Class$ClassA(C$.propertyChangeEventClass, [Clazz.getClass(java.lang.Object), Clazz.getClass(String), Clazz.getClass(java.lang.Object), Clazz.getClass(java.lang.Object)]);
}
...
try {
return C$.propertyEventCtor.newInstance$OA([source, prop, oldValue, newValue]);
} catch (e$$) {
...
try {
C$.propertyChangeMethod.invoke$O$OA(listener, [ev]);
} catch (e$$) {
