(function(){var P$=Clazz.newPackage("java.util.logging"),p$1={},I$=[[0,'java.util.concurrent.atomic.AtomicLong','java.util.concurrent.atomic.AtomicInteger','ThreadLocal','Thread','java.util.ResourceBundle','java.util.Locale']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.threadIds=Clazz.new_(1,{T:"Integer"},$I$(3,1));
}

Clazz.newMeth(C$, '$init$', function () {
}, 1);

C$.$fields$=[['Z',['needToInferCaller'],'I',['threadID'],'L',['sequenceNumber','millis'],'S',['sourceClassName','sourceMethodName','message','loggerName','resourceBundleName'],'O',['level','java.util.logging.Level','thrown','Throwable','parameters','Object[]','resourceBundle','java.util.ResourceBundle']]
...
if (id == null ) {
id=new Integer(C$.nextThreadId.getAndIncrement$());
C$.threadIds.set$TT(id);
}return (id).valueOf();
}}, p$1);
...
var major=($b$[0] = $in.readByte$(), $b$[0]);
var minor=($b$[0] = $in.readByte$(), $b$[0]);
if (major != 1) {
...
try {
var bundle=$I$(5).getBundle$S$java_util_Locale$O(this.resourceBundleName, $I$(6).getDefault$(), ClassLoader.getSystemClassLoader$());
this.resourceBundle=bundle;
} catch (ex) {
