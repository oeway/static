(function(){var P$=Clazz.newPackage("java.util.logging"),p$1={},I$=[[0,'java.util.HashSet','java.io.FileOutputStream','java.io.BufferedOutputStream',['java.util.logging.FileHandler','.MeteredStream'],'java.util.logging.LogManager','java.util.logging.Level','java.util.logging.XMLFormatter','java.nio.file.Files',['java.util.logging.FileHandler','.InitializationErrorManager'],'java.nio.file.Paths','java.nio.channels.FileChannel','java.nio.file.StandardOpenOption','java.nio.file.LinkOption','java.io.File','java.util.logging.ErrorManager','java.security.AccessController']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.locks=Clazz.new_(1,{E:"String"},$I$(1,1));
}
...
if (append) {
len=(fname.length$()|0);
}var fout=Clazz.new_($I$(2,1).c$$S$Z,[fname.toString(), append]);
...
continue;
}var lockFilePath=$I$(10).get$S$SA(this.lockFileName, []);
var channel=null;
var retries=-1;
var fileCreated=false;
while (channel == null  && retries++ < 1 ){
try {
channel=$I$(11).open$java_nio_file_Path$java_nio_file_OpenOptionA(lockFilePath, [$I$(12).CREATE_NEW, $I$(12).WRITE]);
fileCreated=true;
} catch (ix) {
if (Clazz.exceptionOf(ix,"java.nio.file.FileAlreadyExistsException")){
if ($I$(8).isRegularFile$java_nio_file_Path$java_nio_file_LinkOptionA(lockFilePath, [$I$(13).NOFOLLOW_LINKS]) && p$1.isParentWritable$java_nio_file_Path.apply(this, [lockFilePath]) ) {
try {
channel=$I$(11).open$java_nio_file_Path$java_nio_file_OpenOptionA(lockFilePath, [$I$(12).WRITE, $I$(12).APPEND]);
} catch (e$$) {
...
if (available) {
C$.locks.add$TE(this.lockFileName);
break;
}this.lockFileChannel.close$();
}}
this.files=Clazz.array($I$(14), [this.count]);
...
}}this.setErrorManager$java_util_logging_ErrorManager(Clazz.new_($I$(15,1)));
}, p$1);
...
if (file == null ) {
file=Clazz.new_($I$(14,1).c$$S,[word]);
} else {
file=Clazz.new_($I$(14,1).c$$java_io_File$S,[file, word]);
}word="";
continue;
} else if (ch == "%") {
if (ch2 == "t") {
...
}file=Clazz.new_($I$(14,1).c$$S,[tmpDir]);
ix++;
word="";
continue;
} else if (ch2 == "h") {
file=Clazz.new_($I$(14,1).c$$S,[System.getProperty$S("user.home")]);
if (C$.isSetUID$()) {
...
$I$(16).doPrivileged$java_security_PrivilegedAction(((P$.FileHandler$1||
...
}Clazz.new_($I$(14,1).c$$S,[this.lockFileName]).delete$();
