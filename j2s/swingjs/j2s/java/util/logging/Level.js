...
C$.$static$ = function() {C$.$static$=0;
C$.nameToLevels=Clazz.new_(1,{K:"String",V:"java.util.List"},$I$(1,1));
C$.intToLevels=Clazz.new_(1,{K:"Integer",V:"java.util.List"},$I$(1,1));
}
...
if (list == null ) {
list=Clazz.new_(1,{E:"java.util.logging.Level.KnownLevel"},$I$(3,1));
