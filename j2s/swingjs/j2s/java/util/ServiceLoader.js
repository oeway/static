(function(){var P$=java.util,p$1={},I$=[[0,'Error','java.security.AccessController','java.util.LinkedHashMap',['java.util.ServiceLoader','.LazyIterator'],'java.util.Objects','java.util.ServiceConfigurationError','java.util.ArrayList','java.io.BufferedReader','java.io.InputStreamReader','Thread']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.providers=Clazz.new_(1,{K:"String",V:"Object"},$I$(3,1));
}, 1);
...
this.lookupIterator=Clazz.new_($I$(4,1).c$$Class$ClassLoader, [this, null, this.service, this.loader]);
});
...
throw Clazz.new_($I$(6,1).c$$S$Throwable,[service.getName$() + ": " + msg , cause]);
}, 1);

Clazz.newMeth(C$, 'fail$Class$S', function (service, msg) {
throw Clazz.new_($I$(6,1).c$$S,[service.getName$() + ": " + msg ]);
}, 1);
...
var $in=null;
var r=null;
var names=Clazz.new_(1,{E:"String"},$I$(7,1));
try {
$in=u.openStream$();
r=Clazz.new_($I$(8,1).c$$java_io_Reader,[Clazz.new_($I$(9,1).c$$java_io_InputStream$S,[$in, "utf-8"])]);
var lc=1;
...
return Clazz.new_(1,{S:"Object"},C$.c$$Class$ClassLoader,[service, loader]);
}, 1);
...
C$.$fields$=[['S',['nextName'],'O',['service','Class','loader','ClassLoader','configs','java.util.Enumeration','pending','java.util.Iterator']]]
...
return ($I$(2).doPrivileged$java_security_PrivilegedAction$java_security_AccessControlContext(action, this.this$0.acc)).valueOf();
}});
