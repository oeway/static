(function(){var P$=Clazz.newPackage("java.util.jar"),p$1={},I$=[[0,'java.util.jar.Manifest','java.io.BufferedInputStream','java.io.ByteArrayInputStream','java.util.jar.JarVerifier','sun.security.util.ManifestEntryVerifier','java.io.ByteArrayOutputStream','java.util.jar.JarEntry']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
