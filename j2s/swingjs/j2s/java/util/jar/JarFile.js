...
man=Clazz.new_($I$(3,1).c$$java_io_InputStream,[Clazz.new_($I$(4,1).c$$BA,[b])]);
if (!this.jvInitialized) {
}} else {
man=Clazz.new_($I$(3,1).c$$java_io_InputStream,[C$.superclazz.prototype.getInputStream$java_util_zip_ZipEntry.apply(this, [manEntry])]);
}this.manRef=man;
}}return man;
}, p$1);
...
return Clazz.new_(1,{E:"java.lang.Object"},$I$(10,1));
});
;
