...
this.urlToCodeSourceMap=Clazz.new_(1,{K:"java.net.URL",V:"java.util.Map"},$I$(3,1));
this.signerToCodeSource=Clazz.new_(1,{K:"java.security.CodeSigner[]",V:"java.security.CodeSource"},$I$(3,1));
...
this.sigFileSigners=Clazz.new_(1,{K:"String",V:"java.security.CodeSigner[]"},$I$(5,1));
this.verifiedSigners=Clazz.new_(1,{K:"String",V:"java.security.CodeSigner[]"},$I$(5,1));
this.sigFileData=Clazz.new_(1,{K:"String",V:"byte[]"},$I$(5,1).c$$I,[11]);
this.pendingBlocks=Clazz.new_(1,{E:"sun.security.util.SignatureFileVerifier"},$I$(6,1));
this.baos=Clazz.new_($I$(7,1));
this.manifestDigests=Clazz.new_(1,{E:"java.lang.Object"},$I$(6,1));
}, 1);
...
if (this.signerCache == null ) this.signerCache=Clazz.new_(1,{E:"java.security.CodeSigner[]"},$I$(6,1));
if (this.manDig == null ) {
{
if (this.manDig == null ) {
this.manDig=Clazz.new_($I$(10,1).c$$BA,[this.manifestRawBytes]);
this.manifestRawBytes=null;
}}}var sfv=Clazz.new_($I$(9,1).c$$java_util_ArrayList$sun_security_util_ManifestDigester$S$BA,[this.signerCache, this.manDig, uname, this.baos.toByteArray$()]);
...
if (signers != null ) {
var certChains=Clazz.new_(1,{E:"java.security.cert.Certificate"},$I$(6,1));
...
if (map == null ) {
map=Clazz.new_(1,{K:"java.security.CodeSigner[]",V:"java.security.CodeSource"},$I$(3,1));
...
var sources=Clazz.new_(1,{E:"java.security.CodeSource"},$I$(6,1));
...
var sourceList=Clazz.new_(1,{E:"java.security.CodeSource"},$I$(6,1));
...
this.signerMap=Clazz.new_(1,{K:"String",V:"java.security.CodeSigner[]"},$I$(3,1).c$$I,[this.verifiedSigners.size$() + this.sigFileSigners.size$()]);
...
var req=Clazz.new_(1,{E:"java.security.CodeSigner[]"},$I$(6,1).c$$I,[cs.length]);
...
), Clazz.new_(P$.JarVerifier$2.$init$, [this, {itor:itor,enum2:enum2,signersReq:signersReq}]));
});

Clazz.newMeth(C$, 'entries2$java_util_jar_JarFile$java_util_Enumeration', function (jar, e) {
var map=Clazz.new_(1,{K:"String",V:"java.security.CodeSigner[]"},$I$(3,1));
...
var set=Clazz.new_(1,{E:"java.security.CodeSigner[]"},$I$(17,1));
set.addAll$java_util_Collection(p$2.signerMap.apply(this, []).values$());
this.jarCodeSigners=Clazz.new_(1,{E:"java.security.CodeSigner[]"},$I$(6,1));
...
C$.$fields$=[['L',['numLeft'],'O',['is','java.io.InputStream','jv','java.util.jar.JarVerifier','mev','sun.security.util.ManifestEntryVerifier']]]
