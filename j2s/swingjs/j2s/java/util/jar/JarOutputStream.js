(function(){var P$=Clazz.newPackage("java.util.jar"),I$=[[0,'java.util.zip.ZipEntry','java.io.BufferedOutputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
