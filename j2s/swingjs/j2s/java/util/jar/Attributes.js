...
;C$.$init$.apply(this);
this.map=Clazz.new_(1,{K:"java.lang.Object",V:"java.lang.Object"},$I$(2,1).c$$I,[size]);
}, 1);

Clazz.newMeth(C$, 'c$$java_util_jar_Attributes', function (attr) {
;C$.$init$.apply(this);
this.map=Clazz.new_(1,{K:"java.lang.Object",V:"java.lang.Object"},$I$(2,1).c$$java_util_Map,[attr]);
}, 1);
...
while (it.hasNext$()){
var e=it.next$();
var buffer=Clazz.new_($I$(4,1).c$$S,[(e.getKey$()).toString()]);
buffer.append$S(": ");
