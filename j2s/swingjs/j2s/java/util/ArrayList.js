(function(){var P$=java.util,p$1={},p$2={},I$=[[0,'java.util.Objects',['java.util.ArrayList','.ArrayListSpliterator'],'java.util.Arrays','OutOfMemoryError','InternalError',['java.util.ArrayList','.ListItr'],['java.util.ArrayList','.Itr'],['java.util.ArrayList','.SubList'],'java.util.BitSet']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (minCapacity < 0) throw Clazz.new_($I$(4,1));
...
return Clazz.new_($I$(8,1).c$$java_util_AbstractList$I$I$I, [this, null, this, 0, fromIndex, toIndex]);
});
...
return Clazz.new_(1,{E:"Object"},$I$(2,1).c$$java_util_ArrayList$I$I$I,[this, 0, -1, 0]);
});

Clazz.newMeth(C$, 'removeIf$java_util_function_Predicate', function (filter) {
$I$(1).requireNonNull$TT(filter);
var removeCount=0;
var removeSet=Clazz.new_($I$(9,1).c$$I,[this.size]);
var expectedModCount=this.modCount;
var size=this.size;
for (var i=0; this.modCount == expectedModCount && i < size ; i++) {
...
), Clazz.new_(P$.ArrayList$SubList$1.$init$, [this, {offset:offset,index:index}]));
});
...
Clazz.newMeth(C$, 'spliterator$', function () {
p$1.checkForComodification.apply(this, []);
return Clazz.new_(1,{E:"Object"},$I$(2,1).c$$java_util_ArrayList$I$I$I,[this.b$['java.util.ArrayList'], this.offset, this.offset + this.size, this.modCount]);
});
...
var lo=this.index;
var mid=(lo + hi) >>> 1;
return (lo >= mid) ? null : Clazz.new_(1,{E:"Object"},C$.c$$java_util_ArrayList$I$I$I,[this.list, lo, this.index=mid, this.expectedModCount]);
});
