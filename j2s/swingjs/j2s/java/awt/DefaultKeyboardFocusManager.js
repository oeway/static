(function(){var P$=Clazz.newPackage("java.awt"),p$1={},I$=[[0,'java.awt.KeyboardFocusManager','java.util.LinkedList',['sun.awt.CausedFocusEvent','.Cause'],'sun.awt.AppContext',['java.awt.DefaultKeyboardFocusManager','.DefaultKeyboardFocusManagerSentEvent'],'sun.awt.SunToolkit','java.awt.SequencedEvent','java.awt.event.WindowEvent','sun.awt.CausedFocusEvent','java.awt.EventQueue','java.awt.AWTKeyStroke',['java.awt.DefaultKeyboardFocusManager','.TypeAheadMarker']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.enqueuedKeyEvents=Clazz.new_(1,{E:"java.awt.event.KeyEvent"},$I$(2,1));
this.typeAheadMarkers=Clazz.new_(1,{E:"java.awt.DefaultKeyboardFocusManager.TypeAheadMarker"},$I$(2,1));
}, 1);
...
var isEventDispatched=C$.sendMessage$java_awt_Component$java_awt_AWTEvent(oldFocusOwner, Clazz.new_($I$(9,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[oldFocusOwner, 1005, fe.isTemporary$(), newFocusOwner, cause]));
if (!isEventDispatched) {
this.setGlobalFocusOwner$java_awt_Component(null);
if (!fe.isTemporary$()) {
...
fe=Clazz.new_($I$(9,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[newFocusOwner, 1004, fe.isTemporary$(), realOppositeComponent, cause]);
(fe).isPosted=true;
...
}C$.sendMessage$java_awt_Component$java_awt_AWTEvent(currentFocusOwner, Clazz.new_($I$(9,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[currentFocusOwner, 1005, true, oppositeComp, $I$(3).ACTIVATION]));
}this.setGlobalFocusedWindow$java_awt_Window(null);
...
this.typeAheadMarkers.add$I$TE(insertionIndex, Clazz.new_($I$(12,1).c$$J$java_awt_Component,[after, untilFocused]));
});
...
C$.$fields$=[['L',['after'],'O',['untilFocused','java.awt.Component']]]
