(function(){var P$=Clazz.newPackage("java.awt"),I$=[[0,'swingjs.JSUtil','java.awt.GraphicsEnvironment']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if ($I$(2).isHeadless$()) throw Clazz.new_(Clazz.load('java.awt.HeadlessException'));
throw Clazz.new_(Clazz.load('UnsupportedOperationException').c$$S,[msg]);
}, 1);
