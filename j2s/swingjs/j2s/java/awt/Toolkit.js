...
,['L',['enabledOnToolkitMask'],'O',['lightweightMarker','java.awt.peer.LightweightPeer','toolkit','java.awt.Toolkit','resources','java.util.ResourceBundle']]]

Clazz.newMeth(C$, 'createComponent$java_awt_Component', function (target) {
if (C$.lightweightMarker == null ) {
C$.lightweightMarker=Clazz.new_($I$(2,1));
...
return (C$.toolkit == null  ? C$.toolkit=Clazz.new_($I$(4,1)) : C$.toolkit);
}, 1);
...
ret[i]=Clazz.new_($I$(11,1).c$$J$java_awt_event_AWTEventListener,[sael.getEventMask$(), tempL]);
}
return ret;
}});
...
list.add$TE(Clazz.new_($I$(11,1).c$$J$java_awt_event_AWTEventListener,[sael.getEventMask$(), sael.getListener$()]));
}}
...
C$.$fields$=[['L',['eventMask'],'O',['listener','java.awt.event.AWTEventListener','calls','int[]']]]
