...
C$.$fields$=[['Z',['isMouseInNativeContainer'],'L',['eventMask'],'O',['targetLastDown','java.awt.Component','+targetLastKnown','nativeContainer','java.awt.Container','mouseEventTarget','java.awt.Component','+targetLastEntered']]]
...
break;
default:
actualTarget=$I$(15).getJ2SEventTarget$java_awt_event_MouseEvent(e);
break;
}
...
case 504:
case 505:
if ($I$(15).getJ2SEventTarget$java_awt_event_MouseEvent(e) === this.mouseEventTarget ) this.retargetMouseEvent$java_awt_Component$I$java_awt_event_MouseEvent(this.mouseEventTarget, id, e);
break;
case 501:
...
return;
}me=Clazz.new_($I$(16,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I,[this.nativeContainer, 1500, srcEvent.getWhen$(), srcEvent.getModifiersEx$() | srcEvent.getModifiers$(), srcEvent.getX$(), srcEvent.getY$(), srcEvent.getXOnScreen$(), srcEvent.getYOnScreen$(), srcEvent.getClickCount$(), srcEvent.isPopupTrigger$(), srcEvent.getButton$()]);
...
if (component != null ) {
if (id == 507) {
retargeted=Clazz.new_($I$(17,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I$I$I$D,[target, id, e.getWhen$(), e.getModifiersEx$() | e.getModifiers$(), x, y, e.getXOnScreen$(), e.getYOnScreen$(), e.getClickCount$(), e.isPopupTrigger$(), (e).getScrollType$(), (e).getScrollAmount$(), (e).getWheelRotation$(), (e).getPreciseWheelRotation$()]);
} else {
retargeted=Clazz.new_($I$(16,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I,[target, id, e.getWhen$(), e.getModifiersEx$() | e.getModifiers$(), x, y, e.getXOnScreen$(), e.getYOnScreen$(), e.getClickCount$(), e.isPopupTrigger$(), e.getButton$()]);
...
target.dispatchEvent$java_awt_AWTEvent(retargeted);
$I$(15).setPropagation$java_awt_Component$java_awt_event_MouseEvent(target, e);
}}}});

Clazz.newMeth(C$);
})();
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:49:17 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
