(function(){var P$=Clazz.newPackage("java.awt.font"),I$=[[0,'java.awt.geom.AffineTransform','java.awt.RenderingHints']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.tx=Clazz.new_($I$(1,1).c$$java_awt_geom_AffineTransform,[tx]);
}}, 1);
...
return (this.tx == null ) ? Clazz.new_($I$(1,1)) : Clazz.new_($I$(1,1).c$$java_awt_geom_AffineTransform,[this.tx]);
});
