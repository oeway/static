(function(){var P$=Clazz.newPackage("java.awt.font"),p$1={},I$=[[0,'sun.font.Decoration','sun.font.FontResolver','java.util.Vector','sun.text.CodePointIterator','java.awt.font.TextAttribute','java.awt.Toolkit','java.util.HashMap']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.decorations=Clazz.new_(1,{E:"sun.font.Decoration"},$I$(3,1).c$$I,[C$.INITIAL_SIZE]);
...
this.fonts=Clazz.new_(1,{E:"java.lang.Object"},$I$(3,1).c$$I,[C$.INITIAL_SIZE]);
...
var newStyles=Clazz.new_(1,{K:"java.text.AttributedCharacterIterator.Attribute",V:"java.lang.Object"},$I$(7,1).c$$I$F,[5, 0.9]);
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:49:26 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
