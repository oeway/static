(function(){var P$=Clazz.newPackage("java.awt.font"),I$=[[0,'java.util.HashMap','Boolean']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TextAttribute", null, ['java.text.AttributedCharacterIterator','.Attribute']);

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.$instanceMap=Clazz.new_(1,{K:"String",V:"java.awt.font.TextAttribute"},$I$(1,1).c$$I,[29]);
