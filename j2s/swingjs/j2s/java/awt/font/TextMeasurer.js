...
var fmap=Clazz.new_(1,{K:"java.text.AttributedCharacterIterator.Attribute",V:"java.lang.Object"},$I$(8,1).c$$I$F,[5, 0.9]);
...
this.layoutCount++;
}return Clazz.new_($I$(7,1).c$$java_awt_font_TextLine$B$FA$F,[textLine, ($b$[0] = this.fBaseline, $b$[0]), this.fBaselineOffsets, this.fJustifyRatio]);
});
