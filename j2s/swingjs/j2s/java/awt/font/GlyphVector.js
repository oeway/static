(function(){var P$=Clazz.newPackage("java.awt.font"),I$=[[0,'java.awt.Rectangle','java.awt.geom.AffineTransform']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
