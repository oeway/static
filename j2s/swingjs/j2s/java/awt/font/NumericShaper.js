(function(){var P$=Clazz.newPackage("java.awt.font"),p$1={},p$2={},I$=[[0,'java.util.EnumSet',['java.awt.font.NumericShaper','.Range'],'java.util.Arrays','StringBuilder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var buf=Clazz.new_($I$(4,1).c$$S,[C$.superclazz.prototype.toString.apply(this, [])]);
