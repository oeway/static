...
this.ownedWindowList=Clazz.new_(1,{E:"java.awt.Window"},$I$(2,1));
...
}window.setBackground$java_awt_Color(Clazz.new_($I$(1,1).c$$I$I$I$I,[bg.getRed$(), bg.getGreen$(), bg.getBlue$(), opaque ? 255 : 0]));
});
...
return Clazz.new_(1,{E:"java.awt.Image"},$I$(6,1));
}return Clazz.new_(1,{E:"java.awt.Image"},$I$(6,1).c$$java_util_Collection,[icons]);
});

Clazz.newMeth(C$, 'setIconImages$java_util_List', function (icons) {
this.icons=(icons == null ) ? Clazz.new_(1,{E:"java.awt.Image"},$I$(6,1)) : Clazz.new_(1,{E:"java.awt.Image"},$I$(6,1).c$$java_util_Collection,[icons]);
this.firePropertyChange$S$O$O("iconImage", null, null);
});

Clazz.newMeth(C$, 'setIconImage$java_awt_Image', function (image) {
var imageList=Clazz.new_(1,{E:"java.awt.Image"},$I$(6,1));
if (image != null ) {
...
realCopy=$I$(10).copyOf$TTA$I(fullCopy, realSize);
} else {
realCopy=fullCopy;
}}return realCopy;
});
...
var v=Clazz.new_(1,{E:"java.awt.Window"},$I$(6,1));
...
var unblocked=Clazz.new_(1,{E:"java.awt.Window"},$I$(6,1));
...
}if (!$I$(7).getDefaultToolkit$().isModalExclusionTypeSupported$java_awt_Dialog_ModalExclusionType(exclusionType)) {
exclusionType=$I$(5).NO_EXCLUDE;
...
if (windowList == null ) {
windowList=Clazz.new_(1,{E:"java.awt.Window"},$I$(2,1));
...
var centerPoint=$I$(20).getLocalGraphicsEnvironment$().getCenterPoint$();
...
return Clazz.new_($I$(21,1).c$$I$I,[0, 0]);
});
})();
