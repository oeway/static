(function(){var P$=Clazz.newPackage("java.awt.print"),I$=[[0,'java.awt.AWTError','java.awt.print.PageFormat']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
