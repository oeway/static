(function(){var P$=Clazz.newPackage("java.awt"),p$1={},I$=[[0,'java.util.LinkedList',['java.awt.KeyboardFocusManager','.LightweightFocusRequest'],'java.awt.AWTKeyStroke','java.util.HashMap','java.awt.DefaultFocusTraversalPolicy','java.util.Set','sun.awt.AppContext','java.awt.DefaultKeyboardFocusManager','Boolean','java.util.StringTokenizer','java.util.Collections','java.util.HashSet','java.awt.Toolkit','java.awt.GraphicsEnvironment','java.beans.PropertyChangeSupport','java.beans.VetoableChangeSupport','sun.awt.SunToolkit',['java.awt.KeyboardFocusManager','.HeavyweightFocusRequest'],['sun.awt.CausedFocusEvent','.Cause'],'java.awt.event.FocusEvent','sun.awt.CausedFocusEvent','java.awt.EventQueue']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.mostRecentFocusOwners=Clazz.new_(1,{K:"java.awt.Window",V:"java.awt.Component"},$I$(4,1));
C$.heavyweightRequests=Clazz.new_(1,{E:"java.awt.KeyboardFocusManager.HeavyweightFocusRequest"},$I$(1,1));
...
oldManager.firePropertyChange$S$O$O("managingFocus", $I$(9).TRUE, $I$(9).FALSE);
}if (newManager != null ) {
newManager.firePropertyChange$S$O$O("managingFocus", $I$(9).FALSE, $I$(9).TRUE);
}}, 1);
...
var tokens=Clazz.new_($I$(10,1).c$$S$S,[value, ","]);
while (tokens.hasMoreTokens$()){
targetSet.add$TE($I$(3).getAWTKeyStroke$S(tokens.nextToken$()));
}
return (targetSet.isEmpty$()) ? $I$(11).EMPTY_SET : $I$(11).unmodifiableSet$java_util_Set(targetSet);
}, 1);

Clazz.newMeth(C$, 'c$', function () {
;C$.$init$.apply(this);
for (var i=0; i < 4; i++) {
var work_set=Clazz.new_(1,{E:"java.awt.AWTKeyStroke"},$I$(12,1));
for (var j=0; j < C$.defaultFocusTraversalKeyStrokes[i].length; j++) {
work_set.add$TE(C$.defaultFocusTraversalKeyStrokes[i][j]);
}
this.defaultFocusTraversalKeys[i]=(work_set.isEmpty$()) ? $I$(11).EMPTY_SET : $I$(11).unmodifiableSet$java_util_Set(work_set);
}
...
this.defaultFocusTraversalKeys[id]=$I$(11).unmodifiableSet$java_util_Set(Clazz.new_(1,{E:""},$I$(12,1).c$$java_util_Collection,[keystrokes]));
...
this.changeSupport=Clazz.new_($I$(15,1).c$$O,[this]);
...
this.vetoableSupport=Clazz.new_($I$(16,1).c$$O,[this]);
...
this.keyEventDispatchers=Clazz.new_(1,{E:"java.awt.KeyEventDispatcher"},$I$(1,1));
...
this.keyEventPostProcessors=Clazz.new_(1,{E:"java.awt.KeyEventPostProcessor"},$I$(1,1));
...
var parentWindow=$I$(17).getContainingWindow$java_awt_Component(heavyweight);
if (parentWindow == null  || !parentWindow.syncLWRequests ) {
return false;
}if (descendant == null ) {
descendant=heavyweight;
}var manager=C$.getCurrentKeyboardFocusManager$sun_awt_AppContext($I$(17).targetToAppContext$O(descendant));
...
hwFocusRequest=Clazz.new_($I$(18,1).c$$java_awt_Component$java_awt_Component$Z$sun_awt_CausedFocusEvent_Cause,[heavyweight, descendant, temporary, $I$(19).UNKNOWN]);
C$.heavyweightRequests.add$TE(hwFocusRequest);
if (currentFocusOwner != null ) {
currentFocusOwnerEvent=Clazz.new_($I$(20,1).c$$java_awt_Component$I$Z$java_awt_Component,[currentFocusOwner, 1005, temporary, descendant]);
}newFocusOwnerEvent=Clazz.new_($I$(20,1).c$$java_awt_Component$I$Z$java_awt_Component,[descendant, 1004, temporary, currentFocusOwner]);
}}var result=false;
...
hwFocusRequest=Clazz.new_($I$(18,1).c$$java_awt_Component$java_awt_Component$Z$sun_awt_CausedFocusEvent_Cause,[heavyweight, descendant, temporary, cause]);
C$.heavyweightRequests.add$TE(hwFocusRequest);
if (currentFocusOwner != null ) {
var currentFocusOwnerEvent=Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[currentFocusOwner, 1005, temporary, descendant, cause]);
$I$(17).postEvent$sun_awt_AppContext$java_awt_AWTEvent(currentFocusOwner.appContext, currentFocusOwnerEvent);
}var newFocusOwnerEvent=Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[descendant, 1004, temporary, currentFocusOwner, cause]);
$I$(17).postEvent$sun_awt_AppContext$java_awt_AWTEvent(descendant.appContext, newFocusOwnerEvent);
return 1;
...
if (hwFocusRequest === $I$(18).CLEAR_GLOBAL_FOCUS_OWNER ) {
...
C$.heavyweightRequests.add$TE(Clazz.new_($I$(18,1).c$$java_awt_Component$java_awt_Component$Z$sun_awt_CausedFocusEvent_Cause,[heavyweight, descendant, temporary, cause]));
return 2;
}}}, 1);
...
if (hwFocusRequest === $I$(18).CLEAR_GLOBAL_FOCUS_OWNER ) {
return null;
}C$.heavyweightRequests.add$TE($I$(18).CLEAR_GLOBAL_FOCUS_OWNER);
var activeWindow=((hwFocusRequest != null ) ? $I$(17).getContainingWindow$java_awt_Component(hwFocusRequest.heavyweight) : nativeFocusedWindow);
...
if (currentFocusOwner != null ) {
currentFocusOwnerEvent=Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[currentFocusOwner, 1005, lwFocusRequest.temporary, lwFocusRequest.component, lwFocusRequest.cause]);
}var newFocusOwnerEvent=Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[lwFocusRequest.component, 1004, lwFocusRequest.temporary, currentFocusOwner == null  ? lastFocusOwner : currentFocusOwner, lwFocusRequest.cause]);
if (currentFocusOwner != null ) {
(currentFocusOwnerEvent).isPosted=true;
caughtEx=C$.dispatchAndCatchException$Throwable$java_awt_Component$java_awt_event_FocusEvent(caughtEx, currentFocusOwner, currentFocusOwnerEvent);
}(newFocusOwnerEvent).isPosted=true;
...
temporary=true;
}return Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[source, fe.getID$(), temporary, opposite, $I$(19).NATIVE_SYSTEM]);
}}, 1);
...
$I$(22).invokeLater$Runnable(((P$.KeyboardFocusManager$1||
...
}return Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[newSource, 1004, temporary, opposite, lwFocusRequest.cause]);
...
return Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[currentFocusOwner, 1004, false, null, $I$(19).ACTIVATION]);
}return C$.retargetUnexpectedFocusEvent$java_awt_event_FocusEvent(fe);
}}, 1);
...
if (currentFocusOwner != null ) {
C$.heavyweightRequests.removeFirst$();
return Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[currentFocusOwner, 1005, false, null, $I$(19).CLEAR_GLOBAL_FOCUS_OWNER]);
}} else if (opposite == null ) {
if (currentFocusOwner != null ) {
return Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[currentFocusOwner, 1005, true, null, $I$(19).ACTIVATION]);
} else {
return fe;
...
return Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[currentFocusOwner, 1005, temporary, lwFocusRequest.component, lwFocusRequest.cause]);
...
fe=Clazz.new_($I$(21,1).c$$java_awt_Component$I$Z$java_awt_Component$sun_awt_CausedFocusEvent_Cause,[currentFocusOwner, 1005, true, opposite, $I$(19).ACTIVATION]);
}return fe;
}return C$.retargetUnexpectedFocusEvent$java_awt_event_FocusEvent(fe);
}}, 1);
...
var wto=$I$(17).getContainingWindow$java_awt_Component(to);
var wfrom=$I$(17).getContainingWindow$java_awt_Component(from);
...
this.lightweightRequests=Clazz.new_(1,{E:"java.awt.KeyboardFocusManager.LightweightFocusRequest"},$I$(1,1));
...
this.lightweightRequests.add$TE(Clazz.new_($I$(2,1).c$$java_awt_Component$Z$sun_awt_CausedFocusEvent_Cause,[descendant, temporary, cause]));
return true;
} else {
return false;
}});
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:49:20 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
