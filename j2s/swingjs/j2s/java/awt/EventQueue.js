...
C$.$fields$=[['I',['waitForID'],'L',['mostRecentEventTime'],'S',['name'],'O',['queues','java.awt.Queue[]','nextQueue','java.awt.EventQueue','+previousQueue','dispatchThread','java.awt.EventDispatchThread','threadGroup','ThreadGroup','currentEvent','java.awt.AWTEvent']]
,['I',['threadInitNumber']]]
...
$I$(7).getEventQueue$().postEvent$java_awt_AWTEvent(Clazz.new_($I$(10,1).c$$O$I$Runnable$O$Z,[$I$(7).getDefaultToolkit$(), 1200, runnable, null, false]));
}, 1);
