...
C$.$fields$=[['Z',['hasLayoutAttributes','createdFont','nonIdentityTx'],'F',['pointSize'],'I',['style','size','hash'],'S',['family','name'],'O',['fm','java.awt.FontMetrics','font2DHandle','sun.font.Font2DHandle','values','sun.font.AttributeValues','mapLineMetrics','java.util.Map']]
,['Z',['haveMasks'],'I',['RECOGNIZED_MASK','PRIMARY_MASK','SECONDARY_MASK','LAYOUT_MASK','EXTRA_MASK']]]
...
return Clazz.new_($I$(7,1).c$$sun_font_AttributeValues,[p$1.getAttributeValues.apply(this, [])]);
});
...
return Clazz.new_($I$(10,1).c$$F$F$F$F,[0, -dec, width, asc + dec]);
});
...
if (this.mapLineMetrics == null ) this.mapLineMetrics=Clazz.new_(1,{K:"String",V:"java.awt.font.LineMetrics"},$I$(11,1));
var lm=this.mapLineMetrics.get$O(s);
return (lm == null  ? Clazz.new_($I$(12,1).c$$java_awt_Font$S,[this, s]) : lm);
}, p$1);
