(function(){var P$=Clazz.newPackage("java.awt.dnd"),I$=[[0,'java.util.ArrayList','java.awt.dnd.DragGestureEvent']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "DragGestureRecognizer", null, null, 'java.io.Serializable');

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.events=Clazz.new_(1,{E:"java.awt.event.InputEvent"},$I$(1,1).c$$I,[1]);
}, 1);
...
this.dragGestureListener.dragGestureRecognized$(Clazz.new_($I$(2,1).c$$java_awt_dnd_DragGestureRecognizer$I$java_awt_Point$java_util_List,[this, dragAction, p, this.events]));
}} finally {
this.events.clear$();
}
});
