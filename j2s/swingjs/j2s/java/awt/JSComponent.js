(function(){var P$=Clazz.newPackage("java.awt"),I$=[[0,'Thread','java.awt.Container','java.awt.Insets','javax.swing.JComponent','swingjs.JSFrameViewer','Boolean','javax.swing.UIManager','swingjs.plaf.JSComponentUI','java.util.Arrays','swingjs.JSUtil']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "JSComponent", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'java.awt.Component');
C$.$classes$=[['A2SComponentWrapper',9],['A2SWrappedComponent',9]];
...
C$.$fields$=[['Z',['秘isAppletFrame','秘isFramedApplet','秘isRootPane','秘isContentPane','秘iPaintMyselfEntirely','秘repaintAsUpdate','秘isDesktop'],'I',['秘num','秘iPaintMyself'],'S',['秘htmlName','秘uiClassID'],'O',['秘keyAction','javax.swing.Action','秘tempInsets','java.awt.Insets','秘gtemp','swingjs.JSGraphics2D','秘appletViewer','swingjs.JSAppletViewer','秘frameViewer','swingjs.JSFrameViewer','+秘topFrameViewer','秘canvas','swingjs.api.js.HTML5Canvas','ui','javax.swing.plaf.ComponentUI','秘peerVis','Boolean','秘border','javax.swing.border.AbstractBorder','秘paintClass','Class','+秘updateClass']]
...
return ((this.font == null  ? null : new Boolean(this.isAWT$ ||false ? !(Clazz.instanceOf(this.font, "javax.swing.plaf.FontUIResource")) : true))).valueOf();
});
...
for (var i=0; i < n; i++) zorders[i]=$I$(8).getInheritedZ$javax_swing_JComponent(components[i]);
...
return (this.秘border != null  && !(Clazz.instanceOf(this.秘border, "javax.swing.plaf.BorderUIResource.CompoundBorderUIResource")) );
});
