(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[[0,'java.awt.image.DataBuffer','java.awt.image.DataBufferByte','java.awt.image.DataBufferInt']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
case 0:
dataBuffer=Clazz.new_($I$(2,1).c$$I,[size + ((this.dataBitOffset + 7)/8|0)]);
break;
case 3:
dataBuffer=Clazz.new_($I$(3,1).c$$I,[size + ((this.dataBitOffset + 31)/32|0)]);
break;
}
return dataBuffer;
});
