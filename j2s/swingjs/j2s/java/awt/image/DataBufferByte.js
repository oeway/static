...
;C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I.apply(this,[$I$(1).STABLE, 0, size]);C$.$init$.apply(this);
...
;C$.superclazz.c$$sun_java2d_StateTrackable_State$I$I$I.apply(this,[$I$(1).STABLE, 0, size, numBanks]);C$.$init$.apply(this);
