...
image=Clazz.new_($I$(5,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, src.getRaster$().createCompatibleWritableRaster$I$I(w, h), cm.isAlphaPremultiplied$(), null]);
}} else {
image=Clazz.new_($I$(5,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[destCM, destCM.createCompatibleWritableRaster$I$I(w, h), destCM.isAlphaPremultiplied$(), null]);
}return image;
});
...
this.hints=Clazz.new_($I$(1,1).c$$java_awt_RenderingHints_Key$O,[$I$(1).KEY_INTERPOLATION, val]);
}return this.hints;
});
