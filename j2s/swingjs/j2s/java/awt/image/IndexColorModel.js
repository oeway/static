...
C$.$fields$=[['Z',['allgrayopaque'],'I',['map_size','pixel_mask','transparent_index'],'O',['+rgb','+lookupcache']]
...
off[0]=0;
if (this.pixel_bits == 1 || this.pixel_bits == 2  || this.pixel_bits == 4 ) {
return Clazz.new_($I$(4,1).c$$I$I$I$I,[this.transferType, w, h, this.pixel_bits]);
} else {
return Clazz.new_($I$(5,1).c$$I$I$I$I$I$IA,[this.transferType, w, h, 1, w, off]);
}});
...
cm=Clazz.new_($I$(6,1).c$$I$I$I$I$I,[25, 16711680, 65280, 255, 16777216]);
} else {
cm=Clazz.new_($I$(6,1).c$$I$I$I$I,[24, 16711680, 65280, 255]);
...
return Clazz.new_($I$(8,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, discreteRaster, false, null]);
});
