...
image=Clazz.new_($I$(4,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, src.getRaster$().createCompatibleWritableRaster$(), cm.isAlphaPremultiplied$(), null]);
} else {
var w=src.getWidth$();
var h=src.getHeight$();
image=Clazz.new_($I$(4,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[destCM, destCM.createCompatibleWritableRaster$I$I(w, h), destCM.isAlphaPremultiplied$(), null]);
}return image;
});
