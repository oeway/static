(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[[0,'java.awt.image.DataBufferByte','java.awt.image.DataBufferUShort','java.awt.image.DataBufferInt','java.awt.image.DataBuffer','java.awt.Point','java.awt.image.PixelInterleavedSampleModel','sun.awt.image.ByteInterleavedRaster','swingjs.JSUtil','java.awt.image.BandedSampleModel','sun.awt.image.ByteBandedRaster','sun.awt.image.ShortBandedRaster','sun.awt.image.SunWritableRaster','java.awt.image.SinglePixelPackedSampleModel','swingjs.api.Interface','java.awt.image.MultiPixelPackedSampleModel','sun.awt.image.BytePackedRaster','sun.awt.image.ShortInterleavedRaster','sun.awt.image.IntegerInterleavedRaster','java.awt.Rectangle']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['minX','minY','width','height','sampleModelTranslateX','sampleModelTranslateY','numBands','numDataElements'],'O',['image','java.awt.image.BufferedImage','sampleModel','java.awt.image.SampleModel','dataBuffer','java.awt.image.DataBuffer','parent','java.awt.image.Raster']]]
...
switch (dataType) {
case 0:
d=Clazz.new_($I$(1,1).c$$I,[((Math.ceil(fw / ((8/bitsPerBand|0))))|0) * h]);
break;
case 3:
d=Clazz.new_($I$(3,1).c$$I,[((Math.ceil(fw / ((32/bitsPerBand|0))))|0) * h]);
break;
default:
throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["Unsupported data type " + dataType]);
}
...
case 1:
$I$(8).notImplemented$S("USHORT-interleaved raster");
return null;
default:
throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["Unsupported data type " + dataType]);
}
...
var r=$I$(14).getInstance$S$Z("sun.awt.image." + (dataType == 0 ? "Byte" : "Integer") + "InterleavedRaster" , true);
...
case 1:
return Clazz.new_($I$(17,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
}
...
return Clazz.new_($I$(17,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
case 3:
return Clazz.new_($I$(18,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
}
...
if (dataType == 3) {
var r=Clazz.new_($I$(12,1).c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point,[sm, db, location]);
r.秘pix=$I$(12).stealData$java_awt_image_DataBufferInt$I(db, 0);
return r;
}if (Clazz.instanceOf(sm, "java.awt.image.PixelInterleavedSampleModel")) {
switch (dataType) {
case 0:
...
;C$.$init$.apply(this);
this.setRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster(sampleModel, sampleModel.createDataBuffer$(), Clazz.new_($I$(19,1).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth$(), sampleModel.getHeight$()]), origin, null);
}, 1);
...
;C$.$init$.apply(this);
this.setRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster(sampleModel, dataBuffer, Clazz.new_($I$(19,1).c$$I$I$I$I,[origin.x, origin.y, sampleModel.getWidth$(), sampleModel.getHeight$()]), origin, null);
}, 1);
...
return Clazz.new_($I$(12,1).c$$java_awt_image_SampleModel$java_awt_Point,[this.sampleModel, Clazz.new_($I$(5,1).c$$I$I,[0, 0])]);
});
...
return Clazz.new_($I$(12,1).c$$java_awt_image_SampleModel$java_awt_Point,[sm, Clazz.new_($I$(5,1).c$$I$I,[0, 0])]);
});
...
return Clazz.new_(C$.c$$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Rectangle$java_awt_Point$java_awt_image_Raster,[subSampleModel, this.getDataBuffer$(), Clazz.new_($I$(19,1).c$$I$I$I$I,[childMinX, childMinY, width, height]), Clazz.new_($I$(5,1).c$$I$I,[this.sampleModelTranslateX + deltaX, this.sampleModelTranslateY + deltaY]), this]);
});

Clazz.newMeth(C$, 'getBounds$', function () {
return Clazz.new_($I$(19,1).c$$I$I$I$I,[this.minX, this.minY, this.width, this.height]);
});
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:49:28 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
