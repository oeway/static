(function(){var P$=Clazz.newPackage("java.awt.image"),I$=[[0,'java.awt.color.ColorSpace','java.awt.image.DirectColorModel']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
,['O',['RGBdefault','java.awt.image.ColorModel','l8Tos8','byte[]','+s8Tol8','+l16Tos8','s8Tol16','short[]','g8Tos8Map','java.util.Map','+lg16Toog8Map','+g16Tos8Map','+lg16Toog16Map']]]

Clazz.newMeth(C$, 'getRGBdefault$', function () {
if (C$.RGBdefault == null ) {
C$.RGBdefault=Clazz.new_($I$(2,1).c$$I$I$I$I$I,[32, 16711680, 65280, 255, -16777216]);
}return C$.RGBdefault;
}, 1);
