...
C$.coalesceMap=Clazz.new_(1,{K:"Class",V:"Boolean"},$I$(1,1));
}
...
if (rv == null ) return Clazz.new_($I$(12,1).c$$I$I$I$I,[this.getX$(), this.getY$(), this.getWidth$(), this.getHeight$()]);
...
if (rv == null ) {
return Clazz.new_($I$(11,1).c$$I$I,[this.getWidth$(), this.getHeight$()]);
} else {
...
if (rv == null ) {
return Clazz.new_($I$(7,1).c$$I$I,[this.getX$(), this.getY$()]);
} else {
...
var e=Clazz.new_($I$(15,1).c$$java_awt_Component$I$java_awt_Rectangle,[this, 801, Clazz.new_($I$(12,1).c$$I$I$I$I,[x, y, width, height])]);
$I$(6).getEventQueue$().postEvent$java_awt_AWTEvent(e);
} else {
...
newMWE=Clazz.new_($I$(17,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I$I$I$D,[anc, e.getID$(), e.getWhen$(), e.getModifiers$(), newX, newY, e.getXOnScreen$(), e.getYOnScreen$(), e.getClickCount$(), e.isPopupTrigger$(), e.getScrollType$(), e.getScrollAmount$(), e.getWheelRotation$(), e.getPreciseWheelRotation$()]);
...
}var enabled=$I$(30).valueOf$Z(p$1.checkCoelescence.apply(this, []));
...
var e=Clazz.new_($I$(22,1).c$$java_awt_Component$I$java_awt_Component$java_awt_Container$J,[this, 1400, this, this.parent, 2 | ((this.isRecursivelyVisible$()) ? 4 : 0)]);
this.dispatchEvent$java_awt_AWTEvent(e);
}}});
...
this.firePropertyChange$S$O$O("focusable", $I$(30).valueOf$Z(oldFocusable), $I$(30).valueOf$Z(focusable));
...
this.focusTraversalKeys[id]=(keystrokes != null ) ? $I$(31).unmodifiableSet$java_util_Set(Clazz.new_(1,{E:"java.awt.AWTKeyStroke"},$I$(32,1).c$$java_util_Collection,[keystrokes])) : null;
...
return this.requestFocusHelper$Z$Z$sun_awt_CausedFocusEvent_Cause(temporary, focusedWindowChangeAllowed, $I$(33).UNKNOWN);
});
...
return true;
}if ($I$(33).ACTIVATION === cause ) {
return true;
}if (C$.requestFocusController == null ) C$.requestFocusController=$I$(34).focusController;
...
C$.requestFocusController=Clazz.new_($I$(35,1));
} else {
...
res=toFocus.requestFocusInWindow$sun_awt_CausedFocusEvent_Cause($I$(33).TRAVERSAL_FORWARD);
...
res=toFocus.requestFocusInWindow$sun_awt_CausedFocusEvent_Cause($I$(33).TRAVERSAL_BACKWARD);
}}if (!res) {
$I$(8).getCurrentKeyboardFocusManager$().clearGlobalFocusOwner$();
}return res;
});
...
rootAncestor.requestFocus$sun_awt_CausedFocusEvent_Cause($I$(33).TRAVERSAL_UP);
} else {
var window=this.getContainingWindow$();
if (window != null ) {
...
toFocus.requestFocus$sun_awt_CausedFocusEvent_Cause($I$(33).TRAVERSAL_UP);
}}}});
...
this.changeSupport=Clazz.new_($I$(36,1).c$$O,[this]);
...
return;
}changeSupport.firePropertyChange$S$O$O(propertyName, $I$(30).valueOf$Z(oldValue), $I$(30).valueOf$Z(newValue));
});
...
return $I$(37).getContainingWindow$java_awt_Component(this);
});
