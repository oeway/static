...
return Clazz.new_($I$(1,1).c$$D$D$D$D,[this.getX$(), this.getY$(), this.getWidth$(), this.getHeight$()]);
});
...
return Clazz.new_($I$(2,1).c$$I$I$I$I,[(x1|0), (y1|0), ((x2 - x1)|0), ((y2 - y1)|0)]);
});

Clazz.newMeth(C$, 'getPathIterator$java_awt_geom_AffineTransform$D', function (at, flatness) {
return Clazz.new_($I$(3,1).c$$java_awt_geom_PathIterator$D,[this.getPathIterator$java_awt_geom_AffineTransform(at), flatness]);
});
