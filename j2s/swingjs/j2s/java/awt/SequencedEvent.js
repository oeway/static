(function(){var P$=Clazz.newPackage("java.awt"),I$=[[0,'java.util.LinkedList','sun.awt.AppContext','java.awt.EventQueue','Thread','swingjs.JSUtil','java.awt.Toolkit','sun.awt.SunToolkit','java.awt.SentEvent']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
