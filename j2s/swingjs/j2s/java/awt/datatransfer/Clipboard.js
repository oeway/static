(function(){var P$=Clazz.newPackage("java.awt.datatransfer"),p$1={},I$=[[0,'java.awt.EventQueue','java.awt.datatransfer.DataFlavor','sun.awt.EventListenerAggregate','java.awt.datatransfer.FlavorListener','java.awt.datatransfer.FlavorEvent','java.util.HashSet','java.util.Arrays']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
), Clazz.new_(P$.Clipboard$1.$init$, [this, {oldContents:oldContents,oldOwner:oldOwner}])));
...
this.flavorListeners=Clazz.new_($I$(3,1).c$$Class,[Clazz.getClass($I$(4),['flavorsChanged$java_awt_datatransfer_FlavorEvent'])]);
...
(function(){/*a*/var C$=Clazz.newClass(P$, "Clipboard$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
Clazz.newMeth(C$, 'run$', function () {
this.$finals$.listener.flavorsChanged$(Clazz.new_($I$(5,1).c$$java_awt_datatransfer_Clipboard,[this.b$['java.awt.datatransfer.Clipboard']]));
});
})()
