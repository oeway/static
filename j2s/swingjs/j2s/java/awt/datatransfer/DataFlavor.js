(function(){var P$=Clazz.newPackage("java.awt.datatransfer"),p$1={},I$=[[0,'java.io.InputStream','java.awt.datatransfer.MimeTypeParameterList','java.awt.datatransfer.MimeType','sun.awt.datatransfer.DataTransferer',['java.awt.datatransfer.DataFlavor','.TextFlavorComparator'],'java.util.Collections','java.util.Arrays','java.io.StringReader','java.io.CharArrayReader','java.io.ByteArrayInputStream','java.io.InputStreamReader','java.io.Reader','java.util.List']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
