...
C$.$fields$=[['I',['prefixLength'],'L',['lastModified'],'S',['path'],'O',['秘bytes','byte[]','filePath','java.nio.file.Path']]
...
return Clazz.new_($I$(2,1).c$$S$S$S$S,["file", null, sp, null]);
} catch (x) {
...
n=Math.abs(n);
}return Clazz.new_($I$(6,1).c$$java_io_File$S,[dir, prefix + Long.toString$J(n) + suffix ]);
}, 1);
