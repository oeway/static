(function(){var P$=java.io,p$1={},I$=[[0,'java.io.File','java.io.FileDescriptor',['swingjs.JSFileSystem','.JSFileChannel'],'StringBuffer','java.io.DataInputStream','java.io.DataOutputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.fd._setTempFile$Z(Clazz.instanceOf(file, "swingjs.JSTempFile"));
...
if (this.rw && this.hasWritten && this.channel.size$() > 0  ) this.channel.doSave$();
...
return ((this.readInt$()) << 32) + (this.readInt$() & 4294967295);
});
...
this.write$I(((v >>> 56)|0) & 255);
this.write$I(((v >>> 48)|0) & 255);
this.write$I(((v >>> 40)|0) & 255);
this.write$I(((v >>> 32)|0) & 255);
this.write$I(((v >>> 24)|0) & 255);
this.write$I(((v >>> 16)|0) & 255);
this.write$I(((v >>> 8)|0) & 255);
this.write$I(((v >>> 0)|0) & 255);
});
