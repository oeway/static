(function(){var P$=java.io,p$1={},I$=[[0,'java.io.BufferedWriter','java.io.OutputStreamWriter','java.io.FileOutputStream','java.io.File','Thread','java.util.Locale','swingjs.api.Interface','Appendable','java.util.Formatter']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.c$$java_io_Writer$Z.apply(this, [Clazz.new_($I$(1,1).c$$java_io_Writer,[Clazz.new_($I$(2,1).c$$java_io_OutputStream,[out])]), autoFlush]);
if (Clazz.instanceOf(out, "java.io.PrintStream")) {
this.psOut=out;
}}, 1);

Clazz.newMeth(C$, 'c$$S', function (fileName) {
C$.c$$java_io_Writer$Z.apply(this, [Clazz.new_($I$(1,1).c$$java_io_Writer,[Clazz.new_($I$(2,1).c$$java_io_OutputStream,[Clazz.new_($I$(3,1).c$$java_io_File,[Clazz.new_($I$(4,1).c$$S,[fileName])])])]), false]);
}, 1);

Clazz.newMeth(C$, 'c$$S$S', function (fileName, csn) {
C$.c$$java_io_Writer$Z.apply(this, [Clazz.new_($I$(1,1).c$$java_io_Writer,[Clazz.new_($I$(2,1).c$$java_io_OutputStream$S,[Clazz.new_($I$(3,1).c$$java_io_File,[Clazz.new_($I$(4,1).c$$S,[fileName])]), csn])]), false]);
}, 1);

Clazz.newMeth(C$, 'c$$java_io_File', function (file) {
C$.c$$java_io_Writer$Z.apply(this, [Clazz.new_($I$(1,1).c$$java_io_Writer,[Clazz.new_($I$(2,1).c$$java_io_OutputStream,[Clazz.new_($I$(3,1).c$$java_io_File,[file])])]), false]);
}, 1);

Clazz.newMeth(C$, 'c$$java_io_File$S', function (file, csn) {
C$.c$$java_io_Writer$Z.apply(this, [Clazz.new_($I$(1,1).c$$java_io_Writer,[Clazz.new_($I$(2,1).c$$java_io_OutputStream$S,[Clazz.new_($I$(3,1).c$$java_io_File,[file]), csn])]), false]);
}, 1);
