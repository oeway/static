(function(){var P$=java.io,p$1={},I$=[[0,'java.util.concurrent.ConcurrentHashMap','java.lang.ref.ReferenceQueue','Thread','java.security.AccessController','Void','sun.misc.Unsafe','java.util.ArrayList','java.util.HashSet','java.io.Bits','InternalError','StringBuilder','java.io.ObjectStreamField',['sun.reflect.ReflectionFactory','.GetReflectionFactoryAction'],'sun.reflect.Reflection','sun.reflect.misc.ReflectUtil',['java.io.ObjectStreamClass','.Caches'],['java.io.ObjectStreamClass','.WeakClassKey'],['java.io.ObjectStreamClass','.EntryFuture'],'java.lang.ref.SoftReference','java.lang.reflect.Proxy','Enum','java.io.Externalizable','java.io.ObjectStreamClass',['java.io.ObjectStreamClass','.ExceptionInfo'],'java.io.ObjectOutputStream','java.io.ObjectInputStream',['java.io.ObjectStreamClass','.ClassDataSlot'],'java.util.Collections','Boolean','java.util.Arrays',['java.io.ObjectStreamClass','.FieldReflectorKey'],['java.io.ObjectStreamClass','.FieldReflector']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.NO_FIELDS=Clazz.array($I$(12), [0]);
C$.serialPersistentFields=C$.NO_FIELDS;
C$.reflFactory=$I$(4).doPrivileged$java_security_PrivilegedAction(Clazz.new_($I$(13,1)));
}
...
return new Long(P$.ObjectStreamClass.computeDefaultSUID$Class(this.b$['java.io.ObjectStreamClass'].cl));
});
})()
...
var $caller=$I$(14).getCallerClass$();
if ($I$(15).needsPackageAccessCheck$ClassLoader$ClassLoader($caller.getClassLoader$(), this.cl.getClassLoader$())) {
$I$(15).checkPackageAccess$Class(this.cl);
}}return this.cl;
});
...
return null;
}C$.processQueue$ref_ReferenceQueue$java_util_concurrent_ConcurrentMap($I$(16).localDescsQueue, $I$(16).localDescs);
var key=Clazz.new_($I$(17,1).c$$Class$ref_ReferenceQueue,[cl, $I$(16).localDescsQueue]);
var ref=$I$(16).localDescs.get$O(key);
var entry=null;
if (ref != null ) {
entry=ref.get$();
}var future=null;
if (entry == null ) {
var newEntry=Clazz.new_($I$(18,1));
var newRef=Clazz.new_(1,{T:"java.io.ObjectStreamClass.EntryFuture"},$I$(19,1).c$$TT,[newEntry]);
do {
if (ref != null ) {
$I$(16).localDescs.remove$O$O(key, ref);
}ref=$I$(16).localDescs.putIfAbsent$TK$TV(key, newRef);
if (ref != null ) {
entry=ref.get$();
...
$I$(16).localDescs.put$TK$TV(key, Clazz.new_(1,{T:"java.lang.Object"},$I$(19,1).c$$TT,[entry]));
} else {
entry=future.get$();
}}if (Clazz.instanceOf(entry, "java.io.ObjectStreamClass")) {
return entry;
...
throw Clazz.new_($I$(10,1).c$$S,["unexpected entry: " + entry]);
}}, 1);
...
this.isProxy=$I$(20).isProxyClass$Class(cl);
this.isEnum=Clazz.getClass($I$(21)).isAssignableFrom$Class(cl);
this.serializable=true;
this.externalizable=Clazz.getClass($I$(22),['readExternal$java_io_ObjectInput','writeExternal$java_io_ObjectOutput']).isAssignableFrom$Class(cl);
...
this.b$['java.io.ObjectStreamClass'].fields=$I$(23).NO_FIELDS;
return null;
}if (this.$finals$.cl.isArray$()) {
this.b$['java.io.ObjectStreamClass'].fields=$I$(23).NO_FIELDS;
return null;
}this.b$['java.io.ObjectStreamClass'].suid=P$.ObjectStreamClass.getDeclaredSUID$Class(this.$finals$.cl);
try {
this.b$['java.io.ObjectStreamClass'].fields=P$.ObjectStreamClass.getSerialFields$Class(this.$finals$.cl);
p$1.computeFieldOffsets.apply(this.b$['java.io.ObjectStreamClass'], []);
} catch (e) {
if (Clazz.exceptionOf(e,"java.io.InvalidClassException")){
this.b$['java.io.ObjectStreamClass'].serializeEx=this.b$['java.io.ObjectStreamClass'].deserializeEx=Clazz.new_($I$(24,1).c$$S$S,[e.classname, e.getMessage$()]);
this.b$['java.io.ObjectStreamClass'].fields=$I$(23).NO_FIELDS;
} else {
throw e;
}
...
this.b$['java.io.ObjectStreamClass'].cons=P$.ObjectStreamClass.getExternalizableConstructor$Class(this.$finals$.cl);
} else {
this.b$['java.io.ObjectStreamClass'].cons=P$.ObjectStreamClass.getSerializableConstructor$Class(this.$finals$.cl);
this.b$['java.io.ObjectStreamClass'].writeObjectMethod=P$.ObjectStreamClass.getPrivateMethod$Class$S$ClassA$Class(this.$finals$.cl, "writeObject", Clazz.array(Class, -1, [Clazz.getClass($I$(25))]), $I$(5).TYPE);
this.b$['java.io.ObjectStreamClass'].readObjectMethod=P$.ObjectStreamClass.getPrivateMethod$Class$S$ClassA$Class(this.$finals$.cl, "readObject", Clazz.array(Class, -1, [Clazz.getClass($I$(26))]), $I$(5).TYPE);
this.b$['java.io.ObjectStreamClass'].readObjectNoDataMethod=P$.ObjectStreamClass.getPrivateMethod$Class$S$ClassA$Class(this.$finals$.cl, "readObjectNoData", null, $I$(5).TYPE);
this.b$['java.io.ObjectStreamClass'].hasWriteObjectData=(this.b$['java.io.ObjectStreamClass'].writeObjectMethod != null );
}this.b$['java.io.ObjectStreamClass'].writeReplaceMethod=P$.ObjectStreamClass.getInheritableMethod$Class$S$ClassA$Class(this.$finals$.cl, "writeReplace", null, Clazz.getClass(java.lang.Object));
this.b$['java.io.ObjectStreamClass'].readResolveMethod=P$.ObjectStreamClass.getInheritableMethod$Class$S$ClassA$Class(this.$finals$.cl, "readResolve", null, Clazz.getClass(java.lang.Object));
return null;
});
})()
...
throw Clazz.new_($I$(10,1).c$$Throwable,[ex]);
} else {
throw ex;
}
}
...
this.defaultSerializeEx=Clazz.new_($I$(24,1).c$$S$S,[this.name, "unmatched serializable field(s) declared"]);
}}
}, 1);
...
throw Clazz.new_(Clazz.load('java.io.InvalidClassException').c$$S$S,[this.localDesc.name, "local class incompatible: stream classdesc serialVersionUID = " + this.suid + ", local class serialVersionUID = " + this.localDesc.getSerialVersionUID$() ]);
...
}this.fields=(numFields > 0) ? Clazz.array($I$(12), [numFields]) : C$.NO_FIELDS;
...
try {
this.fields[i]=Clazz.new_($I$(12,1).c$$S$S$Z,[fname, signature, false]);
} catch (e) {
...
flags=($b$[0] = flags|(4), $b$[0]);
var protocol=out.getProtocolVersion$();
if (protocol != 1) {
flags=($b$[0] = flags|(8), $b$[0]);
}} else if (this.serializable) {
flags=($b$[0] = flags|(2), $b$[0]);
}if (this.hasWriteObjectData) {
flags=($b$[0] = flags|(1), $b$[0]);
}if (this.isEnum) {
flags=($b$[0] = flags|(16), $b$[0]);
...
if (this.cons != null ) {
try {
return this.cons.newInstance$OA([]);
} catch (ex) {
...
C$.throwMiscException$Throwable(th);
throw Clazz.new_($I$(10,1).c$$Throwable,[th]);
}}
} else if (Clazz.exceptionOf(e$$,"IllegalAccessException")){
var ex = e$$;
{
...
var slots=Clazz.new_(1,{E:"java.io.ObjectStreamClass.ClassDataSlot"},$I$(7,1));
var start=this.cl;
var end=this.cl;
while (end != null  && Clazz.getClass(java.io.Serializable,[]).isAssignableFrom$Class(end) ){
end=end.getSuperclass$();
}
var oscNames=Clazz.new_(1,{E:"String"},$I$(8,1).c$$I,[3]);
...
slots.add$TE(Clazz.new_($I$(27,1).c$$java_io_ObjectStreamClass$Z,[C$.lookup$Class$Z(c, true), false]));
}
start=match.getSuperclass$();
}slots.add$TE(Clazz.new_($I$(27,1).c$$java_io_ObjectStreamClass$Z,[p$1.getVariantFor$Class.apply(d, [match]), true]));
}
for (var c=start; c !== end ; c=c.getSuperclass$()) {
slots.add$TE(Clazz.new_($I$(27,1).c$$java_io_ObjectStreamClass$Z,[C$.lookup$Class$Z(c, true), false]));
}
$I$(28).reverse$java_util_List(slots);
return slots.toArray$TTA(Clazz.array($I$(27), [slots.size$()]));
}, p$1);
...
return null;
}cons=C$.reflFactory.newConstructorForSerialization$Class$reflect_Constructor(cl, cons);
cons.setAccessible$Z(true);
return cons;
} catch (ex) {
if (Clazz.exceptionOf(ex,"NoSuchMethodException")){
...
var fields;
if (Clazz.getClass(java.io.Serializable,[]).isAssignableFrom$Class(cl) && !Clazz.getClass($I$(22),['readExternal$java_io_ObjectInput','writeExternal$java_io_ObjectOutput']).isAssignableFrom$Class(cl) && !$I$(20).isProxyClass$Class(cl) && !cl.isInterface$()  ) {
...
return C$.NO_FIELDS;
}var boundFields=Clazz.array($I$(12), [serialPersistentFields.length]);
var fieldNames=Clazz.new_(1,{E:"String"},$I$(8,1).c$$I,[serialPersistentFields.length]);
...
}fieldNames.add$TE(fname);
try {
var f=cl.getDeclaredField$S(fname);
if ((f.getType$() === spf.getType$() ) && ((f.getModifiers$() & 8) == 0) ) {
boundFields[i]=Clazz.new_($I$(12,1).c$$reflect_Field$Z$Z,[f, spf.isUnshared$(), true]);
}} catch (ex) {
...
boundFields[i]=Clazz.new_($I$(12,1).c$$S$Class$Z,[fname, spf.getType$(), spf.isUnshared$()]);
}}
return boundFields;
}, 1);
...
var list=Clazz.new_(1,{E:"java.io.ObjectStreamField"},$I$(7,1));
var mask=136;
for (var i=0; i < clFields.length; i++) {
if ((clFields[i].getModifiers$() & mask) == 0) {
list.add$TE(Clazz.new_($I$(12,1).c$$reflect_Field$Z$Z,[clFields[i], false, true]));
}}
var size=list.size$();
return (size == 0) ? C$.NO_FIELDS : list.toArray$TTA(Clazz.array($I$(12), [size]));
}, 1);
...
if (false && !Clazz.getClass(java.io.Serializable,[]).isAssignableFrom$Class(cl)  || $I$(20).isProxyClass$Class(cl) ) {
return 0;
}return 1;
}, 1);
...
C$.processQueue$ref_ReferenceQueue$java_util_concurrent_ConcurrentMap($I$(16).reflectorsQueue, $I$(16).reflectors);
var key=Clazz.new_($I$(31,1).c$$Class$java_io_ObjectStreamFieldA$ref_ReferenceQueue,[cl, fields, $I$(16).reflectorsQueue]);
var ref=$I$(16).reflectors.get$O(key);
var entry=null;
if (ref != null ) {
entry=ref.get$();
}var future=null;
...
do {
if (ref != null ) {
$I$(16).reflectors.remove$O$O(key, ref);
}ref=$I$(16).reflectors.putIfAbsent$TK$TV(key, newRef);
if (ref != null ) {
entry=ref.get$();
}} while (ref != null  && entry == null  );
if (entry == null ) {
...
try {
entry=Clazz.new_($I$(32,1).c$$java_io_ObjectStreamFieldA,[C$.matchFields$java_io_ObjectStreamFieldA$java_io_ObjectStreamClass(fields, localDesc)]);
} catch (th) {
entry=th;
}
future.set$O(entry);
$I$(16).reflectors.put$TK$TV(key, Clazz.new_(1,{T:"java.lang.Object"},$I$(19,1).c$$TT,[entry]));
}if (Clazz.instanceOf(entry, "java.io.ObjectStreamClass.FieldReflector")) {
return entry;
...
var matches=Clazz.array($I$(12), [fields.length]);
...
m=Clazz.new_($I$(12,1).c$$reflect_Field$Z$Z,[lf.getField$(), lf.isUnshared$(), false]);
} else {
m=Clazz.new_($I$(12,1).c$$S$S$Z,[lf.getName$(), lf.getSignature$(), lf.isUnshared$()]);
}}}
if (m == null ) {
m=Clazz.new_($I$(12,1).c$$S$S$Z,[f.getName$(), f.getSignature$(), false]);
...
Clazz.newMeth(C$, 'processQueue$ref_ReferenceQueue$java_util_concurrent_ConcurrentMap', function (queue, map) {
var ref;
...
C$.$static$ = function() {C$.$static$=0;
C$.localDescs=Clazz.new_(1,{K:"java.io.ObjectStreamClass.WeakClassKey",V:"java.lang.ref.Reference"},$I$(1,1));
C$.reflectors=Clazz.new_(1,{K:"java.io.ObjectStreamClass.FieldReflectorKey",V:"java.lang.ref.Reference"},$I$(1,1));
C$.localDescsQueue=Clazz.new_(1,{T:"Class"},$I$(2,1));
C$.reflectorsQueue=Clazz.new_(1,{T:"Class"},$I$(2,1));
}
...
Clazz.newMeth(C$, 'c$$reflect_Field', function (field) {
;C$.$init$.apply(this);
this.member=field;
this.name=field.getName$();
this.signature=P$.ObjectStreamClass.getClassSignature$Class(field.getType$());
}, 1);

Clazz.newMeth(C$, 'c$$reflect_Constructor', function (cons) {
;C$.$init$.apply(this);
this.member=cons;
this.name=cons.getName$();
this.signature=P$.ObjectStreamClass.getMethodSignature$ClassA$Class(cons.getParameterTypes$(), $I$(5).TYPE);
}, 1);

Clazz.newMeth(C$, 'c$$reflect_Method', function (meth) {
;C$.$init$.apply(this);
this.member=meth;
this.name=meth.getName$();
this.signature=P$.ObjectStreamClass.getMethodSignature$ClassA$Class(meth.getParameterTypes$(), meth.getReturnType$());
}, 1);
...
var typeList=Clazz.new_(1,{E:"Class"},$I$(7,1));
var usedKeys=Clazz.new_(1,{E:"Long"},$I$(8,1));
for (var i=0; i < nfields; i++) {
var f=fields[i];
var rf=f.getField$();
var key=(rf != null ) ? C$.unsafe.objectFieldOffset$reflect_Field(rf) : -1;
this.readKeys[i]=key;
this.writeKeys[i]=usedKeys.add$TE(new Long(key)) ? key : -1;
this.offsets[i]=f.getOffset$();
this.typeCodes[i]=f.getTypeCode$();
if (!f.isPrimitive$()) {
typeList.add$TE((rf != null ) ? rf.getType$() : null);
}}
this.types=typeList.toArray$TTA(Clazz.array(Class, [typeList.size$()]));
...
case 90:
$I$(9).putBoolean$BA$I$Z(buf, off, C$.unsafe.getBoolean$O$J(obj, key));
break;
case 66:
buf[off]=(C$.unsafe.getByte$O$J(obj, key)|0);
break;
case 67:
$I$(9).putChar$BA$I$C(buf, off, C$.unsafe.getChar$O$J(obj, key));
break;
case 83:
$I$(9).putShort$BA$I$H(buf, off, C$.unsafe.getShort$O$J(obj, key));
break;
case 73:
$I$(9).putInt$BA$I$I(buf, off, C$.unsafe.getInt$O$J(obj, key));
break;
case 70:
$I$(9).putFloat$BA$I$F(buf, off, C$.unsafe.getFloat$O$J(obj, key));
break;
case 74:
$I$(9).putLong$BA$I$J(buf, off, C$.unsafe.getLong$O$J(obj, key));
break;
case 68:
$I$(9).putDouble$BA$I$D(buf, off, C$.unsafe.getDouble$O$J(obj, key));
break;
default:
throw Clazz.new_($I$(10,1));
}
...
switch ((this.typeCodes[i]).$c()) {
case 90:
C$.unsafe.putBoolean$O$J$Z(obj, key, $I$(9).getBoolean$BA$I(buf, off));
break;
case 66:
C$.unsafe.putByte$O$J$B(obj, key, ($b$[0] = buf[off], $b$[0]));
break;
case 67:
C$.unsafe.putChar$O$J$C(obj, key, $I$(9).getChar$BA$I(buf, off));
break;
case 83:
C$.unsafe.putShort$O$J$H(obj, key, $I$(9).getShort$BA$I(buf, off));
break;
case 73:
C$.unsafe.putInt$O$J$I(obj, key, $I$(9).getInt$BA$I(buf, off));
break;
case 70:
C$.unsafe.putFloat$O$J$F(obj, key, $I$(9).getFloat$BA$I(buf, off));
break;
case 74:
C$.unsafe.putLong$O$J$J(obj, key, $I$(9).getLong$BA$I(buf, off));
break;
case 68:
C$.unsafe.putDouble$O$J$D(obj, key, $I$(9).getDouble$BA$I(buf, off));
break;
default:
throw Clazz.new_($I$(10,1));
}
...
Clazz.newMeth(C$, 'c$$Class$java_io_ObjectStreamFieldA$ref_ReferenceQueue', function (cl, fields, queue) {
;C$.superclazz.c$$TT$ref_ReferenceQueue.apply(this,[cl, queue]);C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$Class$ref_ReferenceQueue', function (cl, refQueue) {
;C$.superclazz.c$$TT$ref_ReferenceQueue.apply(this,[cl, refQueue]);C$.$init$.apply(this);
