(function(){var P$=java.io,p$1={},I$=[[0,'swingjs.JSTempFile','java.io.File','java.io.FileDescriptor','java.io.ByteArrayOutputStream','swingjs.JSUtil',['swingjs.JSFileSystem','.JSFileChannel']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.c$$java_io_File$Z.apply(this, [name == null  ? null : name.startsWith$S("/TEMP/") ? Clazz.new_($I$(1,1).c$$S,[name]) : Clazz.new_($I$(2,1).c$$S,[name]), append]);
}, 1);
...
if (!this.b$['java.io.FileOutputStream'].fd._isTempFile$()) $I$(5).saveFile$S$O$S$S(this.b$['java.io.FileOutputStream'].path, this.b$['java.io.FileOutputStream'].秘bytes, null, null);
} else {
...
try {
this.channel=$I$(6).open$java_io_FileDescriptor$S$Z$Z$Z$O(this.fd, this.path, false, true, this.append, null);
} catch (e) {
...
if (this.fd != null ) {
if (this.fd === $I$(3).out  || this.fd === $I$(3).err  ) {
this.flush$();
} else {
this.close$();
}}});
