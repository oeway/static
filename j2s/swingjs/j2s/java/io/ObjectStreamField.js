(function(){var P$=java.io,I$=[[0,'Boolean','sun.reflect.Reflection','sun.reflect.misc.ReflectUtil','StringBuilder','Void','InternalError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
Clazz.newMeth(C$, 'c$$reflect_Field$Z$Z', function (field, unshared, showType) {
;C$.$init$.apply(this);
this.field=field;
this.unshared=unshared;
...
var $caller=$I$(2).getCallerClass$();
if ($I$(3).needsPackageAccessCheck$ClassLoader$ClassLoader($caller.getClassLoader$(), this.type.getClassLoader$())) {
$I$(3).checkPackageAccess$Class(this.type);
}}return this.type;
});
