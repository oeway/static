(function(){var P$=java.io,p$1={},I$=[[0,'swingjs.JSUtil']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return (file.秘bytes != null  || $I$(1).getFileAsBytes$O(file) != null  );
});
