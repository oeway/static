(function(){var P$=java.io,p$1={},I$=[[0,'org.apache.harmony.luni.util.Msg','StringBuilder','java.util.stream.StreamSupport','java.util.Spliterators']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['marklimit','count','markpos','pos'],'O',['$in','java.io.Reader','buf','char[]']]]
...
var eol="\u0000";
var result=Clazz.new_($I$(2,1).c$$I,[80]);
