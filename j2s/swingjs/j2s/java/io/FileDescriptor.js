...
C$.$fields$=[['Z',['isTempFile','closed'],'I',['pos','len','fd'],'L',['handle'],'O',['_file','java.io.File','useCount','java.util.concurrent.atomic.AtomicInteger','parent','java.io.Closeable','otherParents','java.util.List']]
...
this.otherParents=Clazz.new_(1,{E:"java.io.Closeable"},$I$(3,1));
