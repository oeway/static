(function(){var P$=java.io,p$1={},p$2={},p$3={},p$4={},I$=[[0,'Boolean','java.io.Bits','java.security.AccessController',['java.io.ObjectInputStream','.ValidationList','.Callback'],['java.io.ObjectInputStream','.PeekInputStream'],'java.io.DataInputStream','StringBuilder',['java.io.ObjectInputStream','.HandleTable','.HandleList'],'InternalError','java.util.Arrays','java.util.HashMap',['java.io.ObjectInputStream','.BlockDataInputStream'],['java.io.ObjectInputStream','.HandleTable'],['java.io.ObjectInputStream','.ValidationList'],['java.io.ObjectInputStream','.GetFieldImpl'],'IllegalAccessError','java.lang.reflect.Proxy','java.io.ObjectStreamClass','java.io.ObjectInputStream','sun.reflect.misc.ReflectUtil','java.lang.reflect.Array','Enum','java.io.SerialCallbackContext','javajs.util.BC','sun.misc.VM','AssertionError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.primClasses=Clazz.new_(1,{K:"String",V:"Class"},$I$(11,1).c$$I$F,[8, 1.0]);
{
C$.primClasses.put$TK$TV("boolean", Boolean.TYPE);
C$.primClasses.put$TK$TV("byte", Byte.TYPE);
C$.primClasses.put$TK$TV("char", Character.TYPE);
C$.primClasses.put$TK$TV("short", Short.TYPE);
C$.primClasses.put$TK$TV("int", Integer.TYPE);
C$.primClasses.put$TK$TV("long", Long.TYPE);
C$.primClasses.put$TK$TV("float", Float.TYPE);
C$.primClasses.put$TK$TV("double", Double.TYPE);
C$.primClasses.put$TK$TV("void", Void.TYPE);
};
}
...
if (s0 != -21267 || s1 != 5 ) {
throw Clazz.new_(Clazz.load('java.io.StreamCorruptedException').c$$S,[String.format$S$OA("invalid stream header: %04X%04X", [new Short(s0), new Short(s1)])]);
}});
...
return $b$[0] = this.bin.readByte$(), $b$[0];
});
...
var result=$I$(3).doPrivileged$java_security_PrivilegedAction(((P$.ObjectInputStream$1||
...
for (var cl=this.$finals$.subcl; cl !== Clazz.getClass($I$(19)) ; cl=cl.getSuperclass$()) {
try {
...
while ((tc=($b$[0] = this.bin.peekByte$(), $b$[0])) == 121){
this.bin.readByte$();
...
throw Clazz.new_(Clazz.load('java.io.StreamCorruptedException').c$$S,[String.format$S$OA("invalid type code: %02X", [new Byte(tc)])]);
}
} finally {
this.depth--;
...
try {
var tc=($b$[0] = this.bin.peekByte$(), $b$[0]);
switch (tc) {
case 112:
return p$2.readNull.apply(this, []);
case 113:
...
throw Clazz.new_(Clazz.load('java.io.StreamCorruptedException').c$$S,[String.format$S$OA("invalid handle value: %08X", [new Integer(this.passHandle + 8257536)])]);
}if (unshared) {
...
$I$(20).checkProxyPackageAccess$ClassLoader$ClassA(this.getClass$().getClassLoader$(), cl.getInterfaces$());
}} catch (ex) {
if (Clazz.exceptionOf(ex,"ClassNotFoundException")){
resolveEx=ex;
} else {
...
$I$(20).checkPackageAccess$Class(cl);
}} catch (ex) {
if (Clazz.exceptionOf(ex,"ClassNotFoundException")){
resolveEx=ex;
} else {
...
var str;
var tc=($b$[0] = this.bin.readByte$(), $b$[0]);
switch (tc) {
case 116:
...
if (cl != null ) {
try {
var en=$I$(22).valueOf$Class$S(cl, name);
result=en;
} catch (ex) {
...
var oldContext=this.curContext;
try {
this.curContext=Clazz.new_($I$(23,1).c$$O$java_io_ObjectStreamClass,[obj, slotDesc]);
this.bin.setBlockDataMode$Z(true);
...
$I$(24).bytesToFloats$BA$I$FA$I$I(src, srcpos, dst, dstpos, nfloats);
}, 1);

Clazz.newMeth(C$, 'bytesToDoubles$BA$I$DA$I$I', function (src, srcpos, dst, dstpos, ndoubles) {
$I$(24).bytesToDouble$BA$I$DA$I$I(src, srcpos, dst, dstpos, ndoubles);
}, 1);

Clazz.newMeth(C$, 'latestUserDefinedLoader$', function () {
return $I$(25).latestUserDefinedLoader$();
}, 1);
...
this.this$0.handles.markDependency$I$I(this.this$0.passHandle, objHandle);
return (this.this$0.handles.lookupException$I(objHandle) == null ) ? this.objVals[off] : null;
} else {
return val;
}});

Clazz.newMeth(C$, 'readFields$', function () {
this.this$0.bin.readFully$BA$I$I$Z(this.primVals, 0, this.primVals.length, false);
var oldHandle=this.this$0.passHandle;
...
this.objVals[i]=p$2.readObject0$Z.apply(this.this$0, [fields[numPrimFields + i].isUnshared$()]);
...
var acc=$I$(3).getContext$();
if (prev != null ) {
prev.next=Clazz.new_($I$(4,1).c$$java_io_ObjectInputValidation$I$java_io_ObjectInputStream_ValidationList_Callback$java_security_AccessControlContext,[obj, priority, cur, acc]);
} else {
this.list=Clazz.new_($I$(4,1).c$$java_io_ObjectInputValidation$I$java_io_ObjectInputStream_ValidationList_Callback$java_security_AccessControlContext,[obj, priority, this.list, acc]);
}});

Clazz.newMeth(C$, 'doCallbacks$', function () {
try {
while (this.list != null ){
$I$(3).doPrivileged$java_security_PrivilegedExceptionAction$java_security_AccessControlContext(((P$.ObjectInputStream$ValidationList$1||
...
Clazz.newMeth(C$, 'c$$java_io_InputStream', function ($in) {
Clazz.super_(C$, this);
this.$in=Clazz.new_($I$(5,1).c$$java_io_InputStream,[$in]);
this.din=Clazz.new_($I$(6,1).c$$java_io_InputStream,[this]);
}, 1);
...
var len=$I$(2).getInt$BA$I(this.hbuf, 1);
if (len < 0) {
throw Clazz.new_(Clazz.load('java.io.StreamCorruptedException').c$$S,["illegal block data header length: " + len]);
}return len;
case 121:
this.$in.read$();
p$2.handleReset.apply(this.this$0, []);
break;
default:
if (tc >= 0 && (tc < 112 || tc > 126 ) ) {
throw Clazz.new_(Clazz.load('java.io.StreamCorruptedException').c$$S,[String.format$S$OA("invalid type code: %02X", [new Integer(tc)])]);
}return -1;
}
}
} catch (ex) {
...
break;
}var nread=(Math.min(remain, this.end - this.pos)|0);
remain-=nread;
this.pos+=nread;
} else {
var nread=(Math.min(remain, 1024)|0);
...
}var v=$I$(2).getChar$BA$I(this.buf, this.pos);
this.pos+=2;
return v;
});
...
}var v=$I$(2).getShort$BA$I(this.buf, this.pos);
this.pos+=2;
return v;
});
...
}var v=$I$(2).getShort$BA$I(this.buf, this.pos) & 65535;
this.pos+=2;
return v;
});
...
}var v=$I$(2).getInt$BA$I(this.buf, this.pos);
this.pos+=4;
return v;
});
...
}var v=$I$(2).getFloat$BA$I(this.buf, this.pos);
this.pos+=4;
return v;
});
...
}var v=$I$(2).getLong$BA$I(this.buf, this.pos);
this.pos+=8;
return v;
});
...
}var v=$I$(2).getDouble$BA$I(this.buf, this.pos);
this.pos+=8;
return v;
});
...
v[off++]=$I$(2).getBoolean$BA$I(this.buf, this.pos++);
}
}
});
...
v[off++]=$I$(2).getChar$BA$I(this.buf, this.pos);
this.pos+=2;
}
}
});
...
v[off++]=$I$(2).getShort$BA$I(this.buf, this.pos);
this.pos+=2;
}
}
});
...
v[off++]=$I$(2).getInt$BA$I(this.buf, this.pos);
this.pos+=4;
}
}
});
...
}P$.ObjectInputStream.bytesToFloats$BA$I$FA$I$I(this.buf, this.pos, v, off, span);
off+=span;
this.pos+=span << 2;
}
});
...
v[off++]=$I$(2).getLong$BA$I(this.buf, this.pos);
this.pos+=8;
}
}
});
...
}P$.ObjectInputStream.bytesToDoubles$BA$I$DA$I$I(this.buf, this.pos, v, off, span);
off+=span;
this.pos+=span << 3;
}
});
...
utflen-=p$3.readUTFSpan$StringBuilder$J.apply(this, [sbuf, utflen]);
} else {
if (this.blkmode) {
utflen-=p$3.readUTFChar$StringBuilder$J.apply(this, [sbuf, utflen]);
} else {
if (avail > 0) {
System.arraycopy$O$I$O$I$I(this.buf, this.pos, this.buf, 0, avail);
}this.pos=0;
this.end=(Math.min(1024, utflen)|0);
...
var stop=this.pos + ((utflen > avail) ? avail - 2 : (utflen|0));
...
Clazz.newMeth(C$, 'clear$', function () {
$I$(10).fill$BA$I$I$B(this.status, 0, this.size, ($b$[0] = 0, $b$[0]));
