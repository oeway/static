(function(){var P$=java.io,p$1={},I$=[[0,'org.apache.harmony.luni.util.Msg']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['markpos','pos','count'],'S',['str']]]

Clazz.newMeth(C$, 'c$$S', function (str) {
;C$.superclazz.c$$O.apply(this,[str]);C$.$init$.apply(this);
this.str=str;
