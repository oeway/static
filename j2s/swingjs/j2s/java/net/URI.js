(function(){var P$=Clazz.newPackage("java.net"),p$1={},p$2={},I$=[[0,'java.net.URI',['java.net.URI','.Parser'],'java.net.URL','StringBuffer','InternalError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['port','hash'],'S',['scheme','fragment','authority','userInfo','host','path','query','schemeSpecificPart','decodedUserInfo','decodedAuthority','decodedPath','decodedQuery','decodedFragment','decodedSchemeSpecificPart','string']]
...
;C$.$init$.apply(this);
Clazz.new_($I$(2,1).c$$S, [this, null, p$2.toString$S$S$S$S$S$I$S$S$S.apply(this, [scheme, ssp, null, null, null, -1, null, null, fragment])]).parse$Z(false);
}, 1);
...
return Clazz.new_($I$(3,1).c$$S,[this.toString()]);
});
...
var sb=Clazz.new_($I$(4,1).c$$I,[base.length$() + cn]);
