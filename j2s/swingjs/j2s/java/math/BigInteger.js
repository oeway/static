...
Clazz.new_($I$(4,1).c$$java_math_BigInteger,[a1.multiply$java_math_BigInteger(m2)]).multiply$java_math_MutableBigInteger$java_math_MutableBigInteger(Clazz.new_($I$(4,1).c$$java_math_BigInteger,[y1]), t1);
var t2=Clazz.new_($I$(4,1));
Clazz.new_($I$(4,1).c$$java_math_BigInteger,[a2.multiply$java_math_BigInteger(m1)]).multiply$java_math_MutableBigInteger$java_math_MutableBigInteger(Clazz.new_($I$(4,1).c$$java_math_BigInteger,[y2]), t2);
