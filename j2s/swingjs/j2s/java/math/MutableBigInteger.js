(function(){var P$=Clazz.newPackage("java.math"),p$1={},I$=[[0,'java.util.Arrays','java.math.BigInteger','java.math.BigDecimal','java.math.SignedMutableBigInteger']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(2,1).c$$IA$I,[p$1.getMagnitudeArray.apply(this, []), sign]);
});
...
var len=mag.length;
var d=mag[0];
if (len > 2 || (d < 0 && len == 2 ) ) return Clazz.new_($I$(3,1).c$$java_math_BigInteger$J$I$I,[Clazz.new_($I$(2,1).c$$IA$I,[mag, sign]), -281474976710656, scale, 0]);
...
var sign=len > 0 ? 1 : 0;
return Clazz.new_($I$(2,1).c$$IA$I,[$I$(1).copyOfRange$IA$I$I(this.value, this.offset + this.intLen - len, this.offset + this.intLen), sign]);
}}, p$1);
