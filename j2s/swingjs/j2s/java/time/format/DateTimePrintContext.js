...
), Clazz.new_(P$.DateTimePrintContext$1.$init$, [this, {effectiveChrono:effectiveChrono,effectiveZone:effectiveZone,effectiveDate:effectiveDate,temporal:temporal}]));
}, 1);
...
try {
return new Long(this.temporal.getLong$java_time_temporal_TemporalField(field));
} catch (ex) {
