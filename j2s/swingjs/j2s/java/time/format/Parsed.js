(function(){var P$=Clazz.newPackage("java.time.format"),p$1={},I$=[[0,'java.util.HashMap','java.time.Period','java.util.Objects','java.time.temporal.TemporalQueries','java.time.LocalDate','java.time.temporal.ChronoField','java.time.ZoneOffset','java.time.Instant','java.time.format.ResolverStyle','java.time.LocalTime','StringBuilder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(3).requireNonNull$TT$S(field, "field");
...
var old=this.fieldValues.put$TK$TV(changeField, changeValue);
...
var instant=$I$(8).ofEpochSecond$J((this.fieldValues.remove$O($I$(6).INSTANT_SECONDS)).longValue$());
...
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).INSTANT_SECONDS, $I$(6).SECOND_OF_DAY, new Long(zdt.toLocalTime$().toSecondOfDay$())]);
}, p$1);
...
var ch=(this.fieldValues.remove$O($I$(6).CLOCK_HOUR_OF_DAY)).longValue$();
if (this.resolverStyle === $I$(9).STRICT  || (this.resolverStyle === $I$(9).SMART  && ch != 0 ) ) {
$I$(6).CLOCK_HOUR_OF_DAY.checkValidValue$J(ch);
}p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).CLOCK_HOUR_OF_DAY, $I$(6).HOUR_OF_DAY, new Long(ch == 24 ? 0 : ch)]);
}if (this.fieldValues.containsKey$O($I$(6).CLOCK_HOUR_OF_AMPM)) {
var ch=(this.fieldValues.remove$O($I$(6).CLOCK_HOUR_OF_AMPM)).longValue$();
if (this.resolverStyle === $I$(9).STRICT  || (this.resolverStyle === $I$(9).SMART  && ch != 0 ) ) {
$I$(6).CLOCK_HOUR_OF_AMPM.checkValidValue$J(ch);
}p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).CLOCK_HOUR_OF_AMPM, $I$(6).HOUR_OF_AMPM, new Long(ch == 12 ? 0 : ch)]);
}if (this.fieldValues.containsKey$O($I$(6).AMPM_OF_DAY) && this.fieldValues.containsKey$O($I$(6).HOUR_OF_AMPM) ) {
var ap=(this.fieldValues.remove$O($I$(6).AMPM_OF_DAY)).longValue$();
var hap=(this.fieldValues.remove$O($I$(6).HOUR_OF_AMPM)).longValue$();
if (this.resolverStyle === $I$(9).LENIENT ) {
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).AMPM_OF_DAY, $I$(6).HOUR_OF_DAY, new Long(Math.addExact(Math.multiplyExact(ap, 12), hap))]);
} else {
$I$(6).AMPM_OF_DAY.checkValidValue$J(ap);
$I$(6).HOUR_OF_AMPM.checkValidValue$J(ap);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).AMPM_OF_DAY, $I$(6).HOUR_OF_DAY, new Long(ap * 12 + hap)]);
}}if (this.fieldValues.containsKey$O($I$(6).NANO_OF_DAY)) {
var nod=(this.fieldValues.remove$O($I$(6).NANO_OF_DAY)).longValue$();
if (this.resolverStyle !== $I$(9).LENIENT ) {
$I$(6).NANO_OF_DAY.checkValidValue$J(nod);
}p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).NANO_OF_DAY, $I$(6).HOUR_OF_DAY, new Long((nod/3600000000000|0))]);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).NANO_OF_DAY, $I$(6).MINUTE_OF_HOUR, new Long(((nod/60000000000|0)) % 60)]);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).NANO_OF_DAY, $I$(6).SECOND_OF_MINUTE, new Long(((nod/1000000000|0)) % 60)]);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).NANO_OF_DAY, $I$(6).NANO_OF_SECOND, new Long(nod % 1000000000)]);
}if (this.fieldValues.containsKey$O($I$(6).MICRO_OF_DAY)) {
var cod=(this.fieldValues.remove$O($I$(6).MICRO_OF_DAY)).longValue$();
if (this.resolverStyle !== $I$(9).LENIENT ) {
$I$(6).MICRO_OF_DAY.checkValidValue$J(cod);
}p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MICRO_OF_DAY, $I$(6).SECOND_OF_DAY, new Long((cod/1000000|0))]);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MICRO_OF_DAY, $I$(6).MICRO_OF_SECOND, new Long(cod % 1000000)]);
}if (this.fieldValues.containsKey$O($I$(6).MILLI_OF_DAY)) {
var lod=(this.fieldValues.remove$O($I$(6).MILLI_OF_DAY)).longValue$();
if (this.resolverStyle !== $I$(9).LENIENT ) {
$I$(6).MILLI_OF_DAY.checkValidValue$J(lod);
}p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MILLI_OF_DAY, $I$(6).SECOND_OF_DAY, new Long((lod/1000|0))]);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MILLI_OF_DAY, $I$(6).MILLI_OF_SECOND, new Long(lod % 1000)]);
}if (this.fieldValues.containsKey$O($I$(6).SECOND_OF_DAY)) {
var sod=(this.fieldValues.remove$O($I$(6).SECOND_OF_DAY)).longValue$();
if (this.resolverStyle !== $I$(9).LENIENT ) {
$I$(6).SECOND_OF_DAY.checkValidValue$J(sod);
}p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).SECOND_OF_DAY, $I$(6).HOUR_OF_DAY, new Long((sod/3600|0))]);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).SECOND_OF_DAY, $I$(6).MINUTE_OF_HOUR, new Long(((sod/60|0)) % 60)]);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).SECOND_OF_DAY, $I$(6).SECOND_OF_MINUTE, new Long(sod % 60)]);
}if (this.fieldValues.containsKey$O($I$(6).MINUTE_OF_DAY)) {
var mod=(this.fieldValues.remove$O($I$(6).MINUTE_OF_DAY)).longValue$();
if (this.resolverStyle !== $I$(9).LENIENT ) {
$I$(6).MINUTE_OF_DAY.checkValidValue$J(mod);
}p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MINUTE_OF_DAY, $I$(6).HOUR_OF_DAY, new Long((mod/60|0))]);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MINUTE_OF_DAY, $I$(6).MINUTE_OF_HOUR, new Long(mod % 60)]);
}if (this.fieldValues.containsKey$O($I$(6).NANO_OF_SECOND)) {
var nos=(this.fieldValues.get$O($I$(6).NANO_OF_SECOND)).longValue$();
if (this.resolverStyle !== $I$(9).LENIENT ) {
$I$(6).NANO_OF_SECOND.checkValidValue$J(nos);
}if (this.fieldValues.containsKey$O($I$(6).MICRO_OF_SECOND)) {
var cos=(this.fieldValues.remove$O($I$(6).MICRO_OF_SECOND)).longValue$();
if (this.resolverStyle !== $I$(9).LENIENT ) {
$I$(6).MICRO_OF_SECOND.checkValidValue$J(cos);
}nos=cos * 1000 + (nos % 1000);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MICRO_OF_SECOND, $I$(6).NANO_OF_SECOND, new Long(nos)]);
}if (this.fieldValues.containsKey$O($I$(6).MILLI_OF_SECOND)) {
var los=(this.fieldValues.remove$O($I$(6).MILLI_OF_SECOND)).longValue$();
if (this.resolverStyle !== $I$(9).LENIENT ) {
$I$(6).MILLI_OF_SECOND.checkValidValue$J(los);
}p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MILLI_OF_SECOND, $I$(6).NANO_OF_SECOND, new Long(los * 1000000 + (nos % 1000000))]);
...
var hod=(this.fieldValues.remove$O($I$(6).HOUR_OF_DAY)).longValue$();
var moh=(this.fieldValues.remove$O($I$(6).MINUTE_OF_HOUR)).longValue$();
var som=(this.fieldValues.remove$O($I$(6).SECOND_OF_MINUTE)).longValue$();
var nos=(this.fieldValues.remove$O($I$(6).NANO_OF_SECOND)).longValue$();
...
var los=(this.fieldValues.remove$O($I$(6).MILLI_OF_SECOND)).longValue$();
if (this.fieldValues.containsKey$O($I$(6).MICRO_OF_SECOND)) {
var cos=los * 1000 + ((this.fieldValues.get$O($I$(6).MICRO_OF_SECOND)).longValue$() % 1000);
p$1.updateCheckConflict$java_time_temporal_TemporalField$java_time_temporal_TemporalField$Long.apply(this, [$I$(6).MILLI_OF_SECOND, $I$(6).MICRO_OF_SECOND, new Long(cos)]);
this.fieldValues.remove$O($I$(6).MICRO_OF_SECOND);
this.fieldValues.put$TK$TV($I$(6).NANO_OF_SECOND, new Long(cos * 1000));
} else {
this.fieldValues.put$TK$TV($I$(6).NANO_OF_SECOND, new Long(los * 1000000));
...
return;
}var mohVal=(moh != null  ? (moh).longValue$() : 0);
var somVal=(som != null  ? (som).longValue$() : 0);
var nosVal=(nos != null  ? (nos).longValue$() : 0);
p$1.resolveTime$J$J$J$J.apply(this, [(hod).longValue$(), mohVal, somVal, nosVal]);
...
(field).checkValidValue$J((entry.getValue$()).longValue$());
}}
}}, p$1);
...
if (this.fieldValues.containsKey$O($I$(6).NANO_OF_SECOND)) {
var nos=(this.fieldValues.get$O($I$(6).NANO_OF_SECOND)).longValue$();
this.fieldValues.put$TK$TV($I$(6).MICRO_OF_SECOND, new Long((nos/1000|0)));
this.fieldValues.put$TK$TV($I$(6).MILLI_OF_SECOND, new Long((nos/1000000|0)));
} else {
this.fieldValues.put$TK$TV($I$(6).NANO_OF_SECOND, new Long(0));
this.fieldValues.put$TK$TV($I$(6).MICRO_OF_SECOND, new Long(0));
this.fieldValues.put$TK$TV($I$(6).MILLI_OF_SECOND, new Long(0));
}}}, p$1);
...
this.fieldValues.put$TK$TV($I$(6).INSTANT_SECONDS, new Long(instant));
} else {
var offsetSecs=this.fieldValues.get$O($I$(6).OFFSET_SECONDS);
if (offsetSecs != null ) {
var offset=$I$(7).ofTotalSeconds$I(offsetSecs.intValue$());
...
var val2=(entry.getValue$()).longValue$();
if (val1 != val2) {
