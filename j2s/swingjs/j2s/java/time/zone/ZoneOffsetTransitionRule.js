...
$I$(2).requireNonNull$TT$S(time, "time");
$I$(2).requireNonNull$TT$S(timeDefnition, "timeDefnition");
$I$(2).requireNonNull$TT$S(standardOffset, "standardOffset");
$I$(2).requireNonNull$TT$S(offsetBefore, "offsetBefore");
$I$(2).requireNonNull$TT$S(offsetAfter, "offsetAfter");
...
;C$.$init$.apply(this);
this.month=month;
this.dom=($b$[0] = (dayOfMonthIndicator|0), $b$[0]);
this.dow=dayOfWeek;
this.time=time;
...
return Clazz.new_($I$(4,1).c$$B$O,[($b$[0] = 3, $b$[0]), this]);
}, p$1);
...
if (this.dow != null ) {
date=date.with$java_time_temporal_TemporalAdjuster(java.time.temporal.TemporalAdjusters.previousOrSame$java_time_DayOfWeek(this.dow));
}} else {
date=$I$(8).of$I$java_time_Month$I(year, this.month, this.dom);
if (this.dow != null ) {
date=date.with$java_time_temporal_TemporalAdjuster(java.time.temporal.TemporalAdjusters.nextOrSame$java_time_DayOfWeek(this.dow));
}}if (this.timeEndOfDay) {
date=date.plusDays$J(1);
}var localDT=$I$(10).of$java_time_LocalDate$java_time_LocalTime(date, this.time);
...
return Clazz.new_($I$(11,1).c$$java_time_LocalDateTime$java_time_ZoneOffset$java_time_ZoneOffset,[transition, this.offsetBefore, this.offsetAfter]);
});
