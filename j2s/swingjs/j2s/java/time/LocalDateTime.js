...
$I$(4).requireNonNull$TT$S(clock, "clock");
...
$I$(4).requireNonNull$TT$S(date, "date");
$I$(4).requireNonNull$TT$S(time, "time");
return Clazz.new_(C$.c$$java_time_LocalDate$java_time_LocalTime,[date, time]);
}, 1);

Clazz.newMeth(C$, 'ofInstant$java_time_Instant$java_time_ZoneId', function (instant, zone) {
$I$(4).requireNonNull$TT$S(instant, "instant");
$I$(4).requireNonNull$TT$S(zone, "zone");
...
$I$(4).requireNonNull$TT$S(formatter, "formatter");
...
}$I$(4).requireNonNull$TT$S(amountToAdd, "amountToAdd");
...
case $I$(7).MICROS:
return this.plusDays$J((amountToAdd/86400000000|0)).plusNanos$J((amountToAdd % 86400000000) * 1000);
case $I$(7).MILLIS:
return this.plusDays$J((amountToAdd/86400000|0)).plusNanos$J((amountToAdd % 86400000) * 1000000);
case $I$(7).SECONDS:
...
case $I$(7).HALF_DAYS:
return this.plusDays$J((amountToAdd/256|0)).plusHours$J((amountToAdd % 256) * 12);
}
...
}$I$(4).requireNonNull$TT$S(amountToSubtract, "amountToSubtract");
...
return p$1.with$java_time_LocalDate$java_time_LocalTime.apply(this, [newDate, this.time]);
}var totDays=(nanos/86400000000000|0) + (seconds/86400|0) + (minutes/1440|0) + (hours/24|0);
totDays*=sign;
...
timePart=(timePart/1000|0);
break;
case $I$(7).MILLIS:
amount=Math.multiplyExact(amount, 86400000);
timePart=(timePart/1000000|0);
break;
case $I$(7).SECONDS:
amount=Math.multiplyExact(amount, 86400);
timePart=(timePart/1000000000|0);
break;
case $I$(7).MINUTES:
amount=Math.multiplyExact(amount, 1440);
timePart=(timePart/60000000000|0);
break;
case $I$(7).HOURS:
amount=Math.multiplyExact(amount, 24);
timePart=(timePart/3600000000000|0);
break;
case $I$(7).HALF_DAYS:
amount=Math.multiplyExact(amount, 2);
timePart=(timePart/(43200000000000)|0);
break;
}
...
Clazz.newMeth(C$, ['compareTo$java_time_chrono_ChronoLocalDateTime','compareTo$','compareTo$TT'], function (other) {
if (Clazz.instanceOf(other, "java.time.LocalDateTime")) {
return p$1.compareTo0$java_time_LocalDateTime.apply(this, [other]);
}return C$.superclazz.prototype.compareTo$java_time_chrono_ChronoLocalDateTime.apply(this, [other]);
});
...
}return C$.superclazz.prototype.isAfter$java_time_chrono_ChronoLocalDateTime.apply(this, [other]);
});

Clazz.newMeth(C$, 'isBefore$java_time_chrono_ChronoLocalDateTime', function (other) {
if (Clazz.instanceOf(other, "java.time.LocalDateTime")) {
return p$1.compareTo0$java_time_LocalDateTime.apply(this, [other]) < 0;
}return C$.superclazz.prototype.isBefore$java_time_chrono_ChronoLocalDateTime.apply(this, [other]);
});

Clazz.newMeth(C$, 'isEqual$java_time_chrono_ChronoLocalDateTime', function (other) {
if (Clazz.instanceOf(other, "java.time.LocalDateTime")) {
return p$1.compareTo0$java_time_LocalDateTime.apply(this, [other]) == 0;
}return C$.superclazz.prototype.isEqual$java_time_chrono_ChronoLocalDateTime.apply(this, [other]);
});
...
return Clazz.new_($I$(11,1).c$$B$O,[($b$[0] = 5, $b$[0]), this]);
}, p$1);
...
;Clazz.setTVer('3.2.5-v3');//Created 2019-12-13 10:18:51 Java2ScriptVisitor version 3.2.5-v3 net.sf.j2s.core.jar version 3.2.5-v3
