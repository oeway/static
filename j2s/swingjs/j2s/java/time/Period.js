(function(){var P$=Clazz.newPackage("java.time"),p$1={},I$=[[0,'java.util.regex.Pattern','java.util.Collections','java.util.Arrays','java.time.temporal.ChronoUnit','java.time.chrono.IsoChronology','java.util.Objects','java.time.temporal.TemporalQueries','StringBuilder','java.time.Ser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.SUPPORTED_UNITS=$I$(2).unmodifiableList$java_util_List($I$(3).asList$TTA([$I$(4).YEARS, $I$(4).MONTHS, $I$(4).DAYS]));
}
...
if ($I$(5).INSTANCE.equals$O((amount).getChronology$()) == false ) {
...
var splitYears=(totalMonths/12|0);
...
var totalMonths=this.toTotalMonths$();
if (totalMonths != 0) {
temporal=temporal.plus$J$java_time_temporal_TemporalUnit(totalMonths, $I$(4).MONTHS);
}}if (this.days != 0) {
...
var totalMonths=this.toTotalMonths$();
if (totalMonths != 0) {
temporal=temporal.minus$J$java_time_temporal_TemporalUnit(totalMonths, $I$(4).MONTHS);
}}if (this.days != 0) {
...
$I$(6).requireNonNull$TT$S(temporal, "temporal");
var temporalChrono=temporal.query$java_time_temporal_TemporalQuery($I$(7).chronology$());
if (temporalChrono != null  && $I$(5).INSTANCE.equals$O(temporalChrono) == false  ) {
...
return Clazz.new_($I$(9,1).c$$B$O,[($b$[0] = 14, $b$[0]), this]);
}, p$1);
