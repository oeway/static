...
return yearsUntil;
case $I$(9).DECADES:
return (yearsUntil/10|0);
case $I$(9).CENTURIES:
return (yearsUntil/100|0);
case $I$(9).MILLENNIA:
return (yearsUntil/1000|0);
case $I$(9).ERAS:
...
Clazz.newMeth(C$, ['compareTo$java_time_Year','compareTo$','compareTo$TT'], function (other) {
...
return Clazz.new_($I$(13,1).c$$B$O,[($b$[0] = 11, $b$[0]), this]);
}, p$1);
