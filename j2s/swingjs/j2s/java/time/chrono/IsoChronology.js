...
$I$(5).requireNonNull$TT$S(clock, "clock");
...
$I$(8).PROLEPTIC_MONTH.checkValidValue$J((pMonth).longValue$());
}this.addFieldValue$java_util_Map$java_time_temporal_ChronoField$J(fieldValues, $I$(8).MONTH_OF_YEAR, Math.floorMod((pMonth).longValue$(), 12) + 1);
this.addFieldValue$java_util_Map$java_time_temporal_ChronoField$J(fieldValues, $I$(8).YEAR, Math.floorDiv((pMonth).longValue$(), 12));
}});
...
if (yoeLong != null ) {
if (resolverStyle !== $I$(9).LENIENT ) {
$I$(8).YEAR_OF_ERA.checkValidValue$J((yoeLong).longValue$());
}var era=fieldValues.remove$O($I$(8).ERA);
if (era == null ) {
var year=fieldValues.get$O($I$(8).YEAR);
if (resolverStyle === $I$(9).STRICT ) {
if (year != null ) {
this.addFieldValue$java_util_Map$java_time_temporal_ChronoField$J(fieldValues, $I$(8).YEAR, ((year).longValue$() > 0  ? (yoeLong).longValue$() : Math.subtractExact(1, (yoeLong).longValue$())));
} else {
fieldValues.put$TK$TV($I$(8).YEAR_OF_ERA, yoeLong);
}} else {
this.addFieldValue$java_util_Map$java_time_temporal_ChronoField$J(fieldValues, $I$(8).YEAR, (year == null  || (year).longValue$() > 0   ? (yoeLong).longValue$() : Math.subtractExact(1, (yoeLong).longValue$())));
}} else if (era.longValue$() == 1) {
this.addFieldValue$java_util_Map$java_time_temporal_ChronoField$J(fieldValues, $I$(8).YEAR, (yoeLong).longValue$());
} else if (era.longValue$() == 0) {
this.addFieldValue$java_util_Map$java_time_temporal_ChronoField$J(fieldValues, $I$(8).YEAR, Math.subtractExact(1, (yoeLong).longValue$()));
} else {
...
$I$(8).ERA.checkValidValue$J((fieldValues.get$O($I$(8).ERA)).longValue$());
}return null;
});

Clazz.newMeth(C$, 'resolveYMD$java_util_Map$java_time_format_ResolverStyle', function (fieldValues, resolverStyle) {
var y=$I$(8).YEAR.checkValidIntValue$J((fieldValues.remove$O($I$(8).YEAR)).longValue$());
if (resolverStyle === $I$(9).LENIENT ) {
...
}var moy=$I$(8).MONTH_OF_YEAR.checkValidIntValue$J((fieldValues.remove$O($I$(8).MONTH_OF_YEAR)).longValue$());
var dom=$I$(8).DAY_OF_MONTH.checkValidIntValue$J((fieldValues.remove$O($I$(8).DAY_OF_MONTH)).longValue$());
