...
/*lambda_E*/
Clazz.newMeth(C$, ['compare$'], function (date1, date2) {
return null;
});
})()
...
(function(){/*m*/var C$=Clazz.newClass(P$, "AbstractChronology$lambda2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, '', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, ['compare$'], function (dateTime1, dateTime2) {
...
(function(){/*m*/var C$=Clazz.newClass(P$, "AbstractChronology$lambda3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, '', 1);
...
var prev=C$.CHRONOS_BY_ID.putIfAbsent$TK$TV(id, chrono);
if (prev == null ) {
var type=chrono.getCalendarType$();
if (type != null ) {
C$.CHRONOS_BY_TYPE.putIfAbsent$TK$TV(type, chrono);
}}return prev;
}, 1);
...
$I$(9).requireNonNull$TT$S(locale, "locale");
var type;
...
C$.initCache$();
var chronos=Clazz.new_($I$(11,1).c$$java_util_Collection,[C$.CHRONOS_BY_ID.values$()]);
var loader=$I$(6).load$Class(Clazz.getClass($I$(10),['compareTo$java_time_chrono_Chronology','date$java_time_chrono_Era$I$I$I','date$I$I$I','date$java_time_temporal_TemporalAccessor','dateEpochDay$J','dateNow$','dateNow$java_time_ZoneId','dateNow$java_time_Clock','dateYearDay$java_time_chrono_Era$I$I','dateYearDay$I$I','equals$O','eraOf$I','eras$','from$java_time_temporal_TemporalAccessor','getAvailableChronologies$','getCalendarType$','getDisplayName$java_time_format_TextStyle$java_util_Locale','getId$','hashCode$','isLeapYear$J','localDateTime$java_time_temporal_TemporalAccessor','of$S','ofLocale$java_util_Locale','period$I$I$I','prolepticYear$java_time_chrono_Era$I','range$java_time_temporal_ChronoField','resolveDate$java_util_Map$java_time_format_ResolverStyle','toString','zonedDateTime$java_time_temporal_TemporalAccessor','zonedDateTime$java_time_Instant$java_time_ZoneId']));
for (var chrono, $chrono = loader.iterator$(); $chrono.hasNext$()&&((chrono=($chrono.next$())),1);) {
chronos.add$TE(chrono);
}
return chronos;
}, 1);
...
return this.dateEpochDay$J((fieldValues.remove$O($I$(12).EPOCH_DAY)).longValue$());
...
$I$(12).PROLEPTIC_MONTH.checkValidValue$J((pMonth).longValue$());
}var chronoDate=this.dateNow$().with$java_time_temporal_TemporalField$J($I$(12).DAY_OF_MONTH, 1).with$java_time_temporal_TemporalField$J($I$(12).PROLEPTIC_MONTH, (pMonth).longValue$());
...
var yoe;
if (resolverStyle !== $I$(13).LENIENT ) {
yoe=this.range$java_time_temporal_ChronoField($I$(12).YEAR_OF_ERA).checkValidIntValue$J$java_time_temporal_TemporalField((yoeLong).longValue$(), $I$(12).YEAR_OF_ERA);
} else {
yoe=Math.toIntExact((yoeLong).longValue$());
}if (eraLong != null ) {
var eraObj=this.eraOf$I(this.range$java_time_temporal_ChronoField($I$(12).ERA).checkValidIntValue$J$java_time_temporal_TemporalField((eraLong).longValue$(), $I$(12).ERA));
...
if (fieldValues.containsKey$O($I$(12).YEAR)) {
var year=this.range$java_time_temporal_ChronoField($I$(12).YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.get$O($I$(12).YEAR)).longValue$(), $I$(12).YEAR);
...
fieldValues.put$TK$TV($I$(12).YEAR_OF_ERA, yoeLong);
} else {
var eras=this.eras$();
if (eras.isEmpty$()) {
...
this.range$java_time_temporal_ChronoField($I$(12).ERA).checkValidValue$J$java_time_temporal_TemporalField((fieldValues.get$O($I$(12).ERA)).longValue$(), $I$(12).ERA);
}return null;
});

Clazz.newMeth(C$, 'resolveYMD$java_util_Map$java_time_format_ResolverStyle', function (fieldValues, resolverStyle) {
var y=this.range$java_time_temporal_ChronoField($I$(12).YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).YEAR)).longValue$(), $I$(12).YEAR);
if (resolverStyle === $I$(13).LENIENT ) {
var months=Math.subtractExact((fieldValues.remove$O($I$(12).MONTH_OF_YEAR)).longValue$(), 1);
var days=Math.subtractExact((fieldValues.remove$O($I$(12).DAY_OF_MONTH)).longValue$(), 1);
...
}var moy=this.range$java_time_temporal_ChronoField($I$(12).MONTH_OF_YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).MONTH_OF_YEAR)).longValue$(), $I$(12).MONTH_OF_YEAR);
var domRange=this.range$java_time_temporal_ChronoField($I$(12).DAY_OF_MONTH);
var dom=domRange.checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).DAY_OF_MONTH)).longValue$(), $I$(12).DAY_OF_MONTH);
...
var y=this.range$java_time_temporal_ChronoField($I$(12).YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).YEAR)).longValue$(), $I$(12).YEAR);
if (resolverStyle === $I$(13).LENIENT ) {
var days=Math.subtractExact((fieldValues.remove$O($I$(12).DAY_OF_YEAR)).longValue$(), 1);
return this.dateYearDay$I$I(y, 1).plus$J$java_time_temporal_TemporalUnit(days, $I$(14).DAYS);
}var doy=this.range$java_time_temporal_ChronoField($I$(12).DAY_OF_YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).DAY_OF_YEAR)).longValue$(), $I$(12).DAY_OF_YEAR);
...
if (resolverStyle === $I$(13).LENIENT ) {
var months=Math.subtractExact((fieldValues.remove$O($I$(12).MONTH_OF_YEAR)).longValue$(), 1);
var weeks=Math.subtractExact((fieldValues.remove$O($I$(12).ALIGNED_WEEK_OF_MONTH)).longValue$(), 1);
var days=Math.subtractExact((fieldValues.remove$O($I$(12).ALIGNED_DAY_OF_WEEK_IN_MONTH)).longValue$(), 1);
...
var aw=this.range$java_time_temporal_ChronoField($I$(12).ALIGNED_WEEK_OF_MONTH).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).ALIGNED_WEEK_OF_MONTH)).longValue$(), $I$(12).ALIGNED_WEEK_OF_MONTH);
var ad=this.range$java_time_temporal_ChronoField($I$(12).ALIGNED_DAY_OF_WEEK_IN_MONTH).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).ALIGNED_DAY_OF_WEEK_IN_MONTH)).longValue$(), $I$(12).ALIGNED_DAY_OF_WEEK_IN_MONTH);
...
var months=Math.subtractExact((fieldValues.remove$O($I$(12).MONTH_OF_YEAR)).longValue$(), 1);
var weeks=Math.subtractExact((fieldValues.remove$O($I$(12).ALIGNED_WEEK_OF_MONTH)).longValue$(), 1);
var dow=Math.subtractExact((fieldValues.remove$O($I$(12).DAY_OF_WEEK)).longValue$(), 1);
return this.resolveAligned$java_time_chrono_ChronoLocalDate$J$J$J(this.date$I$I$I(y, 1, 1), months, weeks, dow);
}var moy=this.range$java_time_temporal_ChronoField($I$(12).MONTH_OF_YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).MONTH_OF_YEAR)).longValue$(), $I$(12).MONTH_OF_YEAR);
var aw=this.range$java_time_temporal_ChronoField($I$(12).ALIGNED_WEEK_OF_MONTH).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).ALIGNED_WEEK_OF_MONTH)).longValue$(), $I$(12).ALIGNED_WEEK_OF_MONTH);
var dow=this.range$java_time_temporal_ChronoField($I$(12).DAY_OF_WEEK).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).DAY_OF_WEEK)).longValue$(), $I$(12).DAY_OF_WEEK);
var date=this.date$I$I$I(y, moy, 1).plus$J$java_time_temporal_TemporalUnit((aw - 1) * 7, $I$(14).DAYS).with$java_time_temporal_TemporalAdjuster(java.time.temporal.TemporalAdjusters.nextOrSame$java_time_DayOfWeek($I$(16).of$I(dow)));
if (resolverStyle === $I$(13).STRICT  && date.get$java_time_temporal_TemporalField($I$(12).MONTH_OF_YEAR) != moy ) {
throw Clazz.new_(Clazz.load('java.time.DateTimeException').c$$S,["Strict mode rejected resolved date as it is in a different month"]);
}return date;
});
...
var y=this.range$java_time_temporal_ChronoField($I$(12).YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).YEAR)).longValue$(), $I$(12).YEAR);
if (resolverStyle === $I$(13).LENIENT ) {
var weeks=Math.subtractExact((fieldValues.remove$O($I$(12).ALIGNED_WEEK_OF_YEAR)).longValue$(), 1);
var days=Math.subtractExact((fieldValues.remove$O($I$(12).ALIGNED_DAY_OF_WEEK_IN_YEAR)).longValue$(), 1);
...
}var aw=this.range$java_time_temporal_ChronoField($I$(12).ALIGNED_WEEK_OF_YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).ALIGNED_WEEK_OF_YEAR)).longValue$(), $I$(12).ALIGNED_WEEK_OF_YEAR);
var ad=this.range$java_time_temporal_ChronoField($I$(12).ALIGNED_DAY_OF_WEEK_IN_YEAR).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).ALIGNED_DAY_OF_WEEK_IN_YEAR)).longValue$(), $I$(12).ALIGNED_DAY_OF_WEEK_IN_YEAR);
...
var dow=this.range$java_time_temporal_ChronoField($I$(12).DAY_OF_WEEK).checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.remove$O($I$(12).DAY_OF_WEEK)).longValue$(), $I$(12).DAY_OF_WEEK);
var date=this.dateYearDay$I$I(y, 1).plus$J$java_time_temporal_TemporalUnit((aw - 1) * 7, $I$(14).DAYS).with$java_time_temporal_TemporalAdjuster(java.time.temporal.TemporalAdjusters.nextOrSame$java_time_DayOfWeek($I$(16).of$I(dow)));
if (resolverStyle === $I$(13).STRICT  && date.get$java_time_temporal_TemporalField($I$(12).YEAR) != y ) {
throw Clazz.new_(Clazz.load('java.time.DateTimeException').c$$S,["Strict mode rejected resolved date as it is in a different year"]);
}return date;
});
...
if (dow > 7) {
date=date.plus$J$java_time_temporal_TemporalUnit(((dow - 1)/7|0), $I$(14).WEEKS);
dow=((dow - 1) % 7) + 1;
} else if (dow < 1) {
date=date.plus$J$java_time_temporal_TemporalUnit((Math.subtractExact(dow, 7)/7|0), $I$(14).WEEKS);
dow=((dow + 6) % 7) + 1;
}return date.with$java_time_temporal_TemporalAdjuster(java.time.temporal.TemporalAdjusters.nextOrSame$java_time_DayOfWeek($I$(16).of$I((dow|0))));
});
...
}fieldValues.put$TK$TV(field, new Long(value));
});

Clazz.newMeth(C$, ['compareTo$java_time_chrono_Chronology','compareTo$','compareTo$TT'], function (other) {
...
return Clazz.new_($I$(17,1).c$$B$O,[($b$[0] = 1, $b$[0]), this]);
});
