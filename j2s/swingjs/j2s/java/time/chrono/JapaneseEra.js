(function(){var P$=Clazz.newPackage("java.time.chrono"),p$1={},I$=[[0,'java.time.LocalDate','java.time.chrono.JapaneseChronology','java.util.Objects','java.util.Arrays','java.time.chrono.JapaneseDate','java.time.temporal.ChronoField','java.time.chrono.Ser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(3).requireNonNull$TT$S(japaneseEra, "japaneseEra");
...
return $I$(4).copyOf$TTA$I(C$.KNOWN_ERAS, C$.KNOWN_ERAS.length);
}, 1);
...
return Clazz.new_($I$(7,1).c$$B$O,[($b$[0] = 5, $b$[0]), this]);
}, p$1);
...
var eraValue=($b$[0] = $in.readByte$(), $b$[0]);
