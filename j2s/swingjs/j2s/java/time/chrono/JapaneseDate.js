(function(){var P$=Clazz.newPackage("java.time.chrono"),p$1={},I$=[[0,'java.time.LocalDate','java.time.Clock','java.util.Objects','java.time.chrono.JapaneseChronology','java.time.chrono.JapaneseEra','java.util.Calendar','java.time.temporal.ChronoField','java.time.temporal.ValueRange','java.time.chrono.Ser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(3).requireNonNull$TT$S(era, "era");
...
return Clazz.new_($I$(9,1).c$$B$O,[($b$[0] = 4, $b$[0]), this]);
}, p$1);
