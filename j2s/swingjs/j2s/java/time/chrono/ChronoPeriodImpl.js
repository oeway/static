(function(){var P$=Clazz.newPackage("java.time.chrono"),p$1={},I$=[[0,'java.util.Collections','java.util.Arrays','java.time.temporal.ChronoUnit','java.util.Objects','java.time.temporal.ChronoField','java.time.temporal.TemporalQueries','StringBuilder','java.time.chrono.Ser','java.time.chrono.Chronology']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "ChronoPeriodImpl", null, null, ['java.time.chrono.ChronoPeriod', 'java.io.Serializable']);
C$.SUPPORTED_UNITS=null;

C$.$clinit$=1;

C$.$static$ = function() {C$.$static$=0;
C$.SUPPORTED_UNITS=$I$(1).unmodifiableList$java_util_List($I$(2).asList$TTA([$I$(3).YEARS, $I$(3).MONTHS, $I$(3).DAYS]));
}
...
;C$.$init$.apply(this);
$I$(4).requireNonNull$TT$S(chrono, "chrono");
this.chrono=chrono;
this.years=years;
this.months=months;
this.days=days;
...
if (unit === $I$(3).YEARS ) {
return this.years;
} else if (unit === $I$(3).MONTHS ) {
return this.months;
} else if (unit === $I$(3).DAYS ) {
return this.days;
} else {
...
$I$(4).requireNonNull$TT$S(amount, "amount");
...
var splitYears=(totalMonths/monthRange|0);
...
var startRange=this.chrono.range$java_time_temporal_ChronoField($I$(5).MONTH_OF_YEAR);
...
if (this.months == 0) {
if (this.years != 0) {
temporal=temporal.plus$J$java_time_temporal_TemporalUnit(this.years, $I$(3).YEARS);
}} else {
var monthRange=p$1.monthRange.apply(this, []);
if (monthRange > 0) {
temporal=temporal.plus$J$java_time_temporal_TemporalUnit(this.years * monthRange + this.months, $I$(3).MONTHS);
} else {
if (this.years != 0) {
temporal=temporal.plus$J$java_time_temporal_TemporalUnit(this.years, $I$(3).YEARS);
}temporal=temporal.plus$J$java_time_temporal_TemporalUnit(this.months, $I$(3).MONTHS);
}}if (this.days != 0) {
temporal=temporal.plus$J$java_time_temporal_TemporalUnit(this.days, $I$(3).DAYS);
}return temporal;
});
...
if (this.months == 0) {
if (this.years != 0) {
temporal=temporal.minus$J$java_time_temporal_TemporalUnit(this.years, $I$(3).YEARS);
}} else {
var monthRange=p$1.monthRange.apply(this, []);
if (monthRange > 0) {
temporal=temporal.minus$J$java_time_temporal_TemporalUnit(this.years * monthRange + this.months, $I$(3).MONTHS);
} else {
if (this.years != 0) {
temporal=temporal.minus$J$java_time_temporal_TemporalUnit(this.years, $I$(3).YEARS);
}temporal=temporal.minus$J$java_time_temporal_TemporalUnit(this.months, $I$(3).MONTHS);
}}if (this.days != 0) {
temporal=temporal.minus$J$java_time_temporal_TemporalUnit(this.days, $I$(3).DAYS);
}return temporal;
});

Clazz.newMeth(C$, 'validateChrono$java_time_temporal_TemporalAccessor', function (temporal) {
$I$(4).requireNonNull$TT$S(temporal, "temporal");
var temporalChrono=temporal.query$java_time_temporal_TemporalQuery($I$(6).chronology$());
...
return Clazz.new_($I$(8,1).c$$B$O,[($b$[0] = 9, $b$[0]), this]);
});
...
var chrono=$I$(9).of$S($in.readUTF$());
...
;Clazz.setTVer('3.2.5-v3');//Created 2019-12-13 10:18:54 Java2ScriptVisitor version 3.2.5-v3 net.sf.j2s.core.jar version 3.2.5-v3
