(function(){var P$=Clazz.newPackage("java.time.chrono"),p$1={},I$=[[0,'InternalError','java.time.chrono.AbstractChronology','sun.util.logging.PlatformLogger','java.time.chrono.HijrahDate','java.time.Clock','java.time.LocalDate','java.time.temporal.ChronoField','java.time.chrono.HijrahEra','java.util.Arrays','java.time.temporal.ValueRange','java.security.AccessController','java.io.File','java.util.Properties','java.io.FileInputStream','java.util.Objects','java.util.HashMap']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "HijrahChronology", null, 'java.time.chrono.AbstractChronology', 'java.io.Serializable');
C$.INSTANCE=null;
C$.calendarProperties=null;
...
this.hijrahEpochMonthStartDays=null;
this.minEpochDay=0;
this.maxEpochDay=0;
this.hijrahStartEpochMonth=0;
this.minMonthLength=0;
this.maxMonthLength=0;
this.minYearLength=0;
this.maxYearLength=0;
}, 1);
...
return $I$(9).asList$TTA($I$(8).values$());
});
...
$I$(15).requireNonNull$TT$S(resourceName, "Resource missing for calendar: " + "calendar.hijrah." + this.typeId );
...
try {
var year=(Integer.valueOf$S(key)).intValue$();
var months=p$1.parseMonths$S.apply(this, [entry.getValue$()]);
years.put$TK$TV(new Integer(year), months);
...
for (var year=minYear; year <= maxYear; year++) {
var months=years.get$O(new Integer(year));
...
try {
months[i]=(Integer.valueOf$S(numbers[i])).intValue$();
} catch (nfe) {
if (Clazz.exceptionOf(nfe,"NumberFormatException")){
...
ymd[0]=(Integer.valueOf$S(string.substring$I$I(0, 4))).intValue$();
ymd[1]=(Integer.valueOf$S(string.substring$I$I(5, 7))).intValue$();
ymd[2]=(Integer.valueOf$S(string.substring$I$I(8, 10))).intValue$();
return ymd;
} catch (ex) {
