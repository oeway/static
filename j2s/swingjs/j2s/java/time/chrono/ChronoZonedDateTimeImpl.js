(function(){var P$=Clazz.newPackage("java.time.chrono"),p$1={},I$=[[0,'java.util.Objects','java.time.LocalDateTime','java.time.temporal.ChronoField','java.time.temporal.ChronoUnit','java.time.ZoneOffset','java.time.chrono.Ser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(1).requireNonNull$TT$S(localDateTime, "localDateTime");
$I$(1).requireNonNull$TT$S(zone, "zone");
...
offset=validOffsets.get$I(0);
}}$I$(1).requireNonNull$TT$S(offset, "offset");
...
;C$.$init$.apply(this);
this.dateTime=$I$(1).requireNonNull$TT$S(dateTime, "dateTime");
this.offset=$I$(1).requireNonNull$TT$S(offset, "offset");
this.zone=$I$(1).requireNonNull$TT$S(zone, "zone");
}, 1);
...
}return C$.ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.getChronology$(), field.adjustInto$TR$J(this, newValue));
});
...
}return C$.ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.getChronology$(), unit.addTo$TR$J(this, amountToAdd));
});
...
return Clazz.new_($I$(6,1).c$$B$O,[($b$[0] = 3, $b$[0]), this]);
}, p$1);
