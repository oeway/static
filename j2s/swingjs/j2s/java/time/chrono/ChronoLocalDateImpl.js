...
return C$.superclazz.prototype.with$java_time_temporal_TemporalField$J.apply(this, [field, value]);
});
...
$I$(3).requireNonNull$TT$S(endExclusive, "endExclusive");
...
case $I$(1).WEEKS:
return (p$1.daysUntil$java_time_chrono_ChronoLocalDate.apply(this, [end])/7|0);
case $I$(1).MONTHS:
return p$1.monthsUntil$java_time_chrono_ChronoLocalDate.apply(this, [end]);
case $I$(1).YEARS:
return (p$1.monthsUntil$java_time_chrono_ChronoLocalDate.apply(this, [end])/12|0);
case $I$(1).DECADES:
return (p$1.monthsUntil$java_time_chrono_ChronoLocalDate.apply(this, [end])/120|0);
case $I$(1).CENTURIES:
return (p$1.monthsUntil$java_time_chrono_ChronoLocalDate.apply(this, [end])/1200|0);
case $I$(1).MILLENNIA:
return (p$1.monthsUntil$java_time_chrono_ChronoLocalDate.apply(this, [end])/12000|0);
case $I$(1).ERAS:
return end.getLong$java_time_temporal_TemporalField($I$(2).ERA) - this.getLong$java_time_temporal_TemporalField($I$(2).ERA);
}
throw Clazz.new_(Clazz.load('java.time.temporal.UnsupportedTemporalTypeException').c$$S,["Unsupported unit: " + unit]);
}$I$(3).requireNonNull$TT$S(unit, "unit");
