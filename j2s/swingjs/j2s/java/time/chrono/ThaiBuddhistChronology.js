...
{
C$.ERA_NARROW_NAMES.put$TK$TV("en", Clazz.array(String, -1, ["BB", "BE"]));
C$.ERA_NARROW_NAMES.put$TK$TV("th", Clazz.array(String, -1, ["BB", "BE"]));
C$.ERA_SHORT_NAMES.put$TK$TV("en", Clazz.array(String, -1, ["B.B.", "B.E."]));
C$.ERA_SHORT_NAMES.put$TK$TV("th", Clazz.array(String, -1, ["\u0e1e.\u0e28.", "\u0e1b\u0e35\u0e01\u0e48\u0e2d\u0e19\u0e04\u0e23\u0e34\u0e2a\u0e15\u0e4c\u0e01\u0e32\u0e25\u0e17\u0e35\u0e48"]));
C$.ERA_FULL_NAMES.put$TK$TV("en", Clazz.array(String, -1, ["Before Buddhist", "Budhhist Era"]));
C$.ERA_FULL_NAMES.put$TK$TV("th", Clazz.array(String, -1, ["\u0e1e\u0e38\u0e17\u0e18\u0e28\u0e31\u0e01\u0e23\u0e32\u0e0a", "\u0e1b\u0e35\u0e01\u0e48\u0e2d\u0e19\u0e04\u0e23\u0e34\u0e2a\u0e15\u0e4c\u0e01\u0e32\u0e25\u0e17\u0e35\u0e48"]));
};
}
...
return Clazz.new_($I$(2,1).c$$java_time_LocalDate,[$I$(3).of$I$I$I(prolepticYear - 543, month, dayOfMonth)]);
});
...
return Clazz.new_($I$(2,1).c$$java_time_LocalDate,[$I$(3).ofYearDay$I$I(prolepticYear - 543, dayOfYear)]);
});
