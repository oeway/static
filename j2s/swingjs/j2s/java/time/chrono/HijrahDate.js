(function(){var P$=Clazz.newPackage("java.time.chrono"),p$1={},I$=[[0,'java.time.Clock','java.time.chrono.HijrahChronology','java.time.LocalDate','java.time.chrono.HijrahEra','java.time.temporal.ChronoField','java.time.temporal.ValueRange','java.time.chrono.Ser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(7,1).c$$B$O,[($b$[0] = 6, $b$[0]), this]);
}, p$1);
