...
return Clazz.new_($I$(1,1).c$$java_time_LocalDate,[$I$(2).of$I$I$I(prolepticYear + 1911, month, dayOfMonth)]);
});
...
return Clazz.new_($I$(1,1).c$$java_time_LocalDate,[$I$(2).ofYearDay$I$I(prolepticYear + 1911, dayOfYear)]);
});

Clazz.newMeth(C$, 'dateEpochDay$J', function (epochDay) {
return Clazz.new_($I$(1,1).c$$java_time_LocalDate,[$I$(2).ofEpochDay$J(epochDay)]);
});
...
return temporal;
}return Clazz.new_($I$(1,1).c$$java_time_LocalDate,[$I$(2).from$java_time_temporal_TemporalAccessor(temporal)]);
});
...
return $I$(6).asList$TTA($I$(5).values$());
});
