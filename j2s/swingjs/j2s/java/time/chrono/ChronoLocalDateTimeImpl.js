...
Clazz.newMeth(C$, ['of$TR$java_time_LocalTime'], function (date, time) {
return Clazz.new_(C$.c$$TD$java_time_LocalTime,[date, time]);
}, 1);
...
Clazz.newMeth(C$, ['c$$TD$java_time_LocalTime'], function (date, time) {
;C$.$init$.apply(this);
$I$(1).requireNonNull$TT$S(date, "date");
$I$(1).requireNonNull$TT$S(time, "time");
this.date=date;
this.time=time;
}, 1);
...
return Clazz.new_(C$.c$$TD$java_time_LocalTime,[cd, newTime]);
}, p$1);
...
}return C$.ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.date.getChronology$(), adjuster.adjustInto$(this));
});
...
}}return C$.ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.date.getChronology$(), field.adjustInto$TR$J(this, newValue));
});
...
case $I$(3).MICROS:
return p$1.plusNanos$J.apply(p$1.plusDays$J.apply(this, [(amountToAdd/86400000000|0)]), [(amountToAdd % 86400000000) * 1000]);
case $I$(3).MILLIS:
return p$1.plusNanos$J.apply(p$1.plusDays$J.apply(this, [(amountToAdd/86400000|0)]), [(amountToAdd % 86400000) * 1000000]);
case $I$(3).SECONDS:
...
case $I$(3).HALF_DAYS:
return p$1.plusHours$J.apply(p$1.plusDays$J.apply(this, [(amountToAdd/256|0)]), [(amountToAdd % 256) * 12]);
}
...
}return C$.ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.date.getChronology$(), unit.addTo$TR$J(this, amountToAdd));
});
...
return p$1.plusWithOverflow$TD$J$J$J$J.apply(this, [this.date, hours, 0, 0, 0]);
}, p$1);

Clazz.newMeth(C$, 'plusMinutes$J', function (minutes) {
return p$1.plusWithOverflow$TD$J$J$J$J.apply(this, [this.date, 0, minutes, 0, 0]);
}, p$1);

Clazz.newMeth(C$, 'plusSeconds$J', function (seconds) {
return p$1.plusWithOverflow$TD$J$J$J$J.apply(this, [this.date, 0, 0, seconds, 0]);
});

Clazz.newMeth(C$, 'plusNanos$J', function (nanos) {
return p$1.plusWithOverflow$TD$J$J$J$J.apply(this, [this.date, 0, 0, 0, nanos]);
}, p$1);

Clazz.newMeth(C$, ['plusWithOverflow$TD$J$J$J$J'], function (newDate, hours, minutes, seconds, nanos) {
...
$I$(1).requireNonNull$TT$S(endExclusive, "endExclusive");
...
return Clazz.new_($I$(7,1).c$$B$O,[($b$[0] = 2, $b$[0]), this]);
}, p$1);
