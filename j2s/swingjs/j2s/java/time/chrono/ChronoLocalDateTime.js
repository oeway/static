(function(){var P$=Clazz.newPackage("java.time.chrono"),I$=[[0,'java.time.chrono.AbstractChronology','java.util.Objects','java.time.temporal.TemporalQueries','java.time.temporal.ChronoUnit','java.time.chrono.ChronoLocalDateTimeImpl','java.time.temporal.ChronoField','java.time.Instant']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(2).requireNonNull$TT$S(offset, "offset");
