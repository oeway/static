(function(){var P$=Clazz.newPackage("java.time.chrono"),I$=[[0,'java.time.chrono.AbstractChronology','java.util.Objects','java.time.temporal.TemporalQueries','java.time.temporal.ChronoField','java.time.temporal.ChronoUnit','java.time.chrono.ChronoZonedDateTimeImpl','java.time.Instant']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return $I$(6).ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.getChronology$(), C$.superclazz.prototype.with$java_time_temporal_TemporalAdjuster.apply(this, [adjuster]));
});

Clazz.newMeth(C$, 'plus$java_time_temporal_TemporalAmount', function (amount) {
return $I$(6).ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.getChronology$(), C$.superclazz.prototype.plus$java_time_temporal_TemporalAmount.apply(this, [amount]));
});

Clazz.newMeth(C$, 'minus$java_time_temporal_TemporalAmount', function (amount) {
return $I$(6).ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.getChronology$(), C$.superclazz.prototype.minus$java_time_temporal_TemporalAmount.apply(this, [amount]));
});

Clazz.newMeth(C$, 'minus$J$java_time_temporal_TemporalUnit', function (amountToSubtract, unit) {
return $I$(6).ensureValid$java_time_chrono_Chronology$java_time_temporal_Temporal(this.getChronology$(), C$.superclazz.prototype.minus$J$java_time_temporal_TemporalUnit.apply(this, [amountToSubtract, unit]));
});
...
Clazz.newMeth(C$, ['compareTo$java_time_chrono_ChronoZonedDateTime','compareTo$','compareTo$TT'], function (other) {
