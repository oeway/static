(function(){var P$=Clazz.newPackage("java.time.chrono"),p$1={},I$=[[0,'java.time.Clock','java.time.LocalDate','java.time.chrono.MinguoChronology','java.util.Objects','java.time.chrono.MinguoEra','java.time.temporal.ChronoField','java.time.temporal.ValueRange','java.time.chrono.Ser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "MinguoDate", null, 'java.time.chrono.ChronoLocalDateImpl', ['java.time.chrono.ChronoLocalDate', 'java.io.Serializable']);
...
return Clazz.new_(C$.c$$java_time_LocalDate,[$I$(2).of$I$I$I(prolepticYear + 1911, month, dayOfMonth)]);
}, 1);
...
Clazz.super_(C$, this);
$I$(4).requireNonNull$TT$S(isoDate, "isoDate");
...
return (p$1.getProlepticYear.apply(this, []) >= 1 ? $I$(5).ROC : $I$(5).BEFORE_ROC);
});
...
var max=(p$1.getProlepticYear.apply(this, []) <= 0 ? -range.getMinimum$() + 1 + 1911  : range.getMaximum$() - 1911);
...
switch (f) {
case $I$(6).YEAR_OF_ERA:
return p$1.with$java_time_LocalDate.apply(this, [this.isoDate.withYear$I(p$1.getProlepticYear.apply(this, []) >= 1 ? nvalue + 1911 : (1 - nvalue) + 1911)]);
case $I$(6).YEAR:
return p$1.with$java_time_LocalDate.apply(this, [this.isoDate.withYear$I(nvalue + 1911)]);
case $I$(6).ERA:
return p$1.with$java_time_LocalDate.apply(this, [this.isoDate.withYear$I((1 - p$1.getProlepticYear.apply(this, [])) + 1911)]);
}
}}
...
if (this === obj ) {
return true;
}if (Clazz.instanceOf(obj, "java.time.chrono.MinguoDate")) {
var otherDate=obj;
...
return Clazz.new_($I$(8,1).c$$B$O,[($b$[0] = 7, $b$[0]), this]);
}, p$1);
