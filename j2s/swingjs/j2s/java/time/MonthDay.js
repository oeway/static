...
$I$(5).requireNonNull$TT$S(month, "month");
...
$I$(5).requireNonNull$TT$S(formatter, "formatter");
...
Clazz.newMeth(C$, ['compareTo$java_time_MonthDay','compareTo$','compareTo$TT'], function (other) {
...
return Clazz.new_($I$(13,1).c$$B$O,[($b$[0] = 13, $b$[0]), this]);
}, p$1);
...
var month=($b$[0] = $in.readByte$(), $b$[0]);
var day=($b$[0] = $in.readByte$(), $b$[0]);
