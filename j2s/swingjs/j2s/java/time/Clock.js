(function(){var P$=Clazz.newPackage("java.time"),I$=[[0,'java.time.Instant','java.time.Duration',['java.time.Clock','.SystemClock'],'java.time.ZoneOffset','java.time.ZoneId','java.util.Objects',['java.time.Clock','.TickClock'],['java.time.Clock','.FixedClock'],['java.time.Clock','.OffsetClock']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(3,1).c$$java_time_ZoneId,[$I$(4).UTC]);
}, 1);

Clazz.newMeth(C$, 'systemDefaultZone$', function () {
return Clazz.new_($I$(3,1).c$$java_time_ZoneId,[$I$(5).systemDefault$()]);
}, 1);

Clazz.newMeth(C$, 'system$java_time_ZoneId', function (zone) {
$I$(6).requireNonNull$TT$S(zone, "zone");
return Clazz.new_($I$(3,1).c$$java_time_ZoneId,[zone]);
}, 1);

Clazz.newMeth(C$, 'tickSeconds$java_time_ZoneId', function (zone) {
return Clazz.new_($I$(7,1).c$$java_time_Clock$J,[C$.system$java_time_ZoneId(zone), 1000000000]);
}, 1);

Clazz.newMeth(C$, 'tickMinutes$java_time_ZoneId', function (zone) {
return Clazz.new_($I$(7,1).c$$java_time_Clock$J,[C$.system$java_time_ZoneId(zone), 60000000000]);
}, 1);

Clazz.newMeth(C$, 'tick$java_time_Clock$java_time_Duration', function (baseClock, tickDuration) {
$I$(6).requireNonNull$TT$S(baseClock, "baseClock");
$I$(6).requireNonNull$TT$S(tickDuration, "tickDuration");
...
$I$(6).requireNonNull$TT$S(fixedInstant, "fixedInstant");
$I$(6).requireNonNull$TT$S(zone, "zone");
...
$I$(6).requireNonNull$TT$S(baseClock, "baseClock");
$I$(6).requireNonNull$TT$S(offsetDuration, "offsetDuration");
...
return millis - Math.floorMod(millis, (this.tickNanos/1000000|0));
});

Clazz.newMeth(C$, 'instant$', function () {
if ((this.tickNanos % 1000000) == 0) {
var millis=this.baseClock.millis$();
return $I$(1).ofEpochMilli$J(millis - Math.floorMod(millis, (this.tickNanos/1000000|0)));
...
;Clazz.setTVer('3.2.5-v3');//Created 2019-12-13 10:18:49 Java2ScriptVisitor version 3.2.5-v3 net.sf.j2s.core.jar version 3.2.5-v3
