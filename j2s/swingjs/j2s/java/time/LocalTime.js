...
var hours=(((secondOfDay/3600|0))|0);
secondOfDay-=hours * 3600;
var minutes=(((secondOfDay/60|0))|0);
...
var hours=(((nanoOfDay/3600000000000|0))|0);
nanoOfDay-=hours * 3600000000000;
var minutes=(((nanoOfDay/60000000000|0))|0);
nanoOfDay-=minutes * 60000000000;
var seconds=(((nanoOfDay/1000000000|0))|0);
...
;C$.$init$.apply(this);
this.hour=($b$[0] = (hour|0), $b$[0]);
this.minute=($b$[0] = (minute|0), $b$[0]);
this.second=($b$[0] = (second|0), $b$[0]);
...
return (this.toNanoOfDay$()/1000|0);
}return p$1.get0$java_time_temporal_TemporalField.apply(this, [field]);
...
return (((this.toNanoOfDay$()/1000000|0))|0);
...
return (this.hour == 0 ? ($b$[0] = 24, $b$[0]) : ($b$[0] = this.hour, $b$[0]));
...
return C$.ofNanoOfDay$J(((nod/dur|0)) * dur);
});
...
if (nofd == newNofd) {
return this;
}var newHour=(((newNofd/3600000000000|0))|0);
var newMinute=((((newNofd/60000000000|0)) % 60)|0);
var newSecond=((((newNofd/1000000000|0)) % 60)|0);
...
return nanosUntil;
case $I$(6).MICROS:
return (nanosUntil/1000|0);
case $I$(6).MILLIS:
return (nanosUntil/1000000|0);
case $I$(6).SECONDS:
return (nanosUntil/1000000000|0);
case $I$(6).MINUTES:
return (nanosUntil/60000000000|0);
case $I$(6).HOURS:
return (nanosUntil/3600000000000|0);
case $I$(6).HALF_DAYS:
return (nanosUntil/(43200000000000)|0);
}
throw Clazz.new_(Clazz.load('java.time.temporal.UnsupportedTemporalTypeException').c$$S,["Unsupported unit: " + unit]);
...
Clazz.newMeth(C$, ['compareTo$java_time_LocalTime','compareTo$','compareTo$TT'], function (other) {
...
return Clazz.new_($I$(10,1).c$$B$O,[($b$[0] = 4, $b$[0]), this]);
}, p$1);
