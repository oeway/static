...
$I$(6).requireNonNull$TT$S(month, "month");
...
$I$(6).requireNonNull$TT$S(formatter, "formatter");
...
return monthsUntil;
case $I$(9).YEARS:
return (monthsUntil/12|0);
case $I$(9).DECADES:
return (monthsUntil/120|0);
case $I$(9).CENTURIES:
return (monthsUntil/1200|0);
case $I$(9).MILLENNIA:
return (monthsUntil/12000|0);
case $I$(9).ERAS:
...
Clazz.newMeth(C$, ['compareTo$java_time_YearMonth','compareTo$','compareTo$TT'], function (other) {
...
return Clazz.new_($I$(14,1).c$$B$O,[($b$[0] = 12, $b$[0]), this]);
}, p$1);
