...
/*lambda_M*/
Clazz.newMeth(C$, ['compare$'], function (t,u) { return $$.compareInstant$java_time_OffsetDateTime$java_time_OffsetDateTime.apply(null,[t,u])});
})()
...
;C$.$init$.apply(this);
this.dateTime=$I$(4).requireNonNull$TT$S(dateTime, "dateTime");
...
Clazz.newMeth(C$, ['compareTo$java_time_OffsetDateTime','compareTo$','compareTo$TT'], function (other) {
...
return Clazz.new_($I$(13,1).c$$B$O,[($b$[0] = 10, $b$[0]), this]);
}, p$1);
