(function(){var P$=Clazz.newPackage("java.time"),p$1={},I$=[[0,'java.time.LocalTime','java.time.ZoneOffset','java.time.Clock','java.util.Objects','java.time.format.DateTimeFormatter','java.time.temporal.ChronoField','java.time.temporal.TemporalQueries','java.time.temporal.ChronoUnit','java.time.OffsetDateTime','java.time.Ser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
;C$.$init$.apply(this);
this.time=$I$(4).requireNonNull$TT$S(time, "time");
this.offset=$I$(4).requireNonNull$TT$S(offset, "offset");
}, 1);
...
Clazz.newMeth(C$, ['compareTo$java_time_OffsetTime','compareTo$','compareTo$TT'], function (other) {
...
return Clazz.new_($I$(10,1).c$$B$O,[($b$[0] = 9, $b$[0]), this]);
}, p$1);
