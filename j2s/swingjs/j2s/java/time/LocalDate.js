...
$I$(2).requireNonNull$TT$S(month, "month");
...
var adjust=0;
if (zeroDay < 0) {
var adjustCycles=((zeroDay + 1)/146097|0) - 1;
adjust=adjustCycles * 400;
zeroDay+=-adjustCycles * 146097;
}var yearEst=((400 * zeroDay + 591)/146097|0);
var doyEst=zeroDay - (365 * yearEst + (yearEst/4|0) - (yearEst/100|0) + (yearEst/400|0));
if (doyEst < 0) {
yearEst--;
doyEst=zeroDay - (365 * yearEst + (yearEst/4|0) - (yearEst/100|0) + (yearEst/400|0));
}yearEst+=adjust;
...
$I$(2).requireNonNull$TT$S(formatter, "formatter");
...
return C$.superclazz.prototype.isSupported$java_time_temporal_TemporalField.apply(this, [field]);
});

Clazz.newMeth(C$, 'isSupported$java_time_temporal_TemporalUnit', function (unit) {
return C$.superclazz.prototype.isSupported$java_time_temporal_TemporalUnit.apply(this, [unit]);
});
...
}return C$.superclazz.prototype.get$java_time_temporal_TemporalField.apply(this, [field]);
});
...
return C$.superclazz.prototype.getEra$.apply(this, []);
});
...
}$I$(2).requireNonNull$TT$S(amountToAdd, "amountToAdd");
...
}$I$(2).requireNonNull$TT$S(amountToSubtract, "amountToSubtract");
...
return C$.superclazz.prototype.adjustInto$java_time_temporal_Temporal.apply(this, [temporal]);
});
...
case $I$(10).WEEKS:
return (this.daysUntil$java_time_LocalDate(end)/7|0);
case $I$(10).MONTHS:
return p$1.monthsUntil$java_time_LocalDate.apply(this, [end]);
case $I$(10).YEARS:
return (p$1.monthsUntil$java_time_LocalDate.apply(this, [end])/12|0);
case $I$(10).DECADES:
return (p$1.monthsUntil$java_time_LocalDate.apply(this, [end])/120|0);
case $I$(10).CENTURIES:
return (p$1.monthsUntil$java_time_LocalDate.apply(this, [end])/1200|0);
case $I$(10).MILLENNIA:
return (p$1.monthsUntil$java_time_LocalDate.apply(this, [end])/12000|0);
case $I$(10).ERAS:
...
$I$(2).requireNonNull$TT$S(zone, "zone");
...
total+=365 * y;
if (y >= 0) {
total+=((y + 3)/4|0) - ((y + 99)/100|0) + ((y + 399)/400|0);
} else {
total-=(y/-4|0) - (y/-100|0) + (y/-400|0);
}total+=(((367 * m - 362)/12|0));
total+=this.day - 1;
if (m > 2) {
total--;
...
Clazz.newMeth(C$, ['compareTo$java_time_chrono_ChronoLocalDate','compareTo$','compareTo$TT'], function (other) {
if (Clazz.instanceOf(other, "java.time.LocalDate")) {
return this.compareTo0$java_time_LocalDate(other);
}return C$.superclazz.prototype.compareTo$java_time_chrono_ChronoLocalDate.apply(this, [other]);
});
...
}return C$.superclazz.prototype.isAfter$java_time_chrono_ChronoLocalDate.apply(this, [other]);
});

Clazz.newMeth(C$, 'isBefore$java_time_chrono_ChronoLocalDate', function (other) {
if (Clazz.instanceOf(other, "java.time.LocalDate")) {
return this.compareTo0$java_time_LocalDate(other) < 0;
}return C$.superclazz.prototype.isBefore$java_time_chrono_ChronoLocalDate.apply(this, [other]);
});

Clazz.newMeth(C$, 'isEqual$java_time_chrono_ChronoLocalDate', function (other) {
if (Clazz.instanceOf(other, "java.time.LocalDate")) {
return this.compareTo0$java_time_LocalDate(other) == 0;
}return C$.superclazz.prototype.isEqual$java_time_chrono_ChronoLocalDate.apply(this, [other]);
});
...
return Clazz.new_($I$(17,1).c$$B$O,[($b$[0] = 3, $b$[0]), this]);
}, p$1);
