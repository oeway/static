...
$I$(1).requireNonNull$TT$S(dateBasedAdjuster, "dateBasedAdjuster");
...
/*lambda_E*/
Clazz.newMeth(C$, 'adjustInto$', function (temporal) {
var input=$I$(2).from$java_time_temporal_TemporalAccessor(temporal);
var output=this.$finals$.dateBasedAdjuster.apply$(input);
...
/*lambda_E*/
Clazz.newMeth(C$, 'adjustInto$', function (temporal) { return (temporal.with$java_time_temporal_TemporalField$J($I$(3).DAY_OF_MONTH, 1));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, 'adjustInto$', function (temporal) { return (temporal.with$java_time_temporal_TemporalField$J($I$(3).DAY_OF_MONTH, temporal.range$java_time_temporal_TemporalField($I$(3).DAY_OF_MONTH).getMaximum$()));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, 'adjustInto$', function (temporal) { return (temporal.with$java_time_temporal_TemporalField$J($I$(3).DAY_OF_MONTH, 1).plus$J$java_time_temporal_TemporalUnit(1, $I$(4).MONTHS));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, 'adjustInto$', function (temporal) { return (temporal.with$java_time_temporal_TemporalField$J($I$(3).DAY_OF_YEAR, 1));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, 'adjustInto$', function (temporal) { return (temporal.with$java_time_temporal_TemporalField$J($I$(3).DAY_OF_YEAR, temporal.range$java_time_temporal_TemporalField($I$(3).DAY_OF_YEAR).getMaximum$()));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, 'adjustInto$', function (temporal) { return (temporal.with$java_time_temporal_TemporalField$J($I$(3).DAY_OF_YEAR, 1).plus$J$java_time_temporal_TemporalUnit(1, $I$(4).YEARS));});
})()
...
$I$(1).requireNonNull$TT$S(dayOfWeek, "dayOfWeek");
...
), Clazz.new_(P$.TemporalAdjusters$lambda8.$init$, [this, {dowValue:dowValue,ordinal:ordinal}]));
} else {
...
), Clazz.new_(P$.TemporalAdjusters$lambda9.$init$, [this, {dowValue:dowValue,ordinal:ordinal}]));
}}, 1);
