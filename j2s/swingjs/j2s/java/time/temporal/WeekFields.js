...
this.weekOfWeekBasedYear=null;
this.weekBasedYear=null;
}, 1);
...
locale=Clazz.new_($I$(13,1).c$$S$S,[locale.getLanguage$(), locale.getCountry$()]);
...
C$.CACHE.putIfAbsent$TK$TV(key, rules);
...
;C$.$init$.apply(this);
$I$(8).requireNonNull$TT$S(firstDayOfWeek, "firstDayOfWeek");
...
C$.DAY_OF_WEEK_RANGE=null;
C$.WEEK_OF_MONTH_RANGE=null;
C$.WEEK_OF_YEAR_RANGE=null;
C$.WEEK_OF_WEEK_BASED_YEAR_RANGE=null;
...
var value=(fieldValues.get$O(this)).longValue$();
...
fieldValues.put$TK$TV($I$(4).DAY_OF_WEEK, new Long(isoDow));
return null;
}if (fieldValues.containsKey$O($I$(4).DAY_OF_WEEK) == false ) {
return null;
}var isoDow=$I$(4).DAY_OF_WEEK.checkValidIntValue$J((fieldValues.get$O($I$(4).DAY_OF_WEEK)).longValue$());
...
var year=$I$(4).YEAR.checkValidIntValue$J((fieldValues.get$O($I$(4).YEAR)).longValue$());
if (this.rangeUnit === $I$(2).MONTHS  && fieldValues.containsKey$O($I$(4).MONTH_OF_YEAR) ) {
var month=(fieldValues.get$O($I$(4).MONTH_OF_YEAR)).longValue$();
...
var yowby=this.weekDef.weekBasedYear.range$().checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.get$O(this.weekDef.weekBasedYear)).longValue$(), this.weekDef.weekBasedYear);
var date;
if (resolverStyle === $I$(7).LENIENT ) {
date=p$1.ofWeekBasedYear$java_time_chrono_Chronology$I$I$I.apply(this, [chrono, yowby, 1, localDow]);
var wowby=(fieldValues.get$O(this.weekDef.weekOfWeekBasedYear)).longValue$();
var weeks=Math.subtractExact(wowby, 1);
date=date.plus$J$java_time_temporal_TemporalUnit(weeks, $I$(2).WEEKS);
} else {
var wowby=this.weekDef.weekOfWeekBasedYear.range$().checkValidIntValue$J$java_time_temporal_TemporalField((fieldValues.get$O(this.weekDef.weekOfWeekBasedYear)).longValue$(), this.weekDef.weekOfWeekBasedYear);
