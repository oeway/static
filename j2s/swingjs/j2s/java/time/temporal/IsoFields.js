(function(){var P$=Clazz.newPackage("java.time.temporal"),I$=[[0,'java.time.temporal.ChronoUnit','java.time.temporal.IsoFields','java.time.temporal.ValueRange','java.time.temporal.ChronoField',['java.time.temporal.IsoFields','.Field'],'java.time.chrono.IsoChronology','java.time.format.ResolverStyle','java.time.LocalDate','java.util.Objects','sun.util.locale.provider.LocaleProviderAdapter','java.time.chrono.Chronology','java.time.DayOfWeek','java.time.Duration',['java.time.temporal.IsoFields','.Unit'],'AssertionError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "IsoFields", function(){
Clazz.newInstance(this, arguments,0,C$);
});
C$.DAY_OF_QUARTER=null;
C$.QUARTER_OF_YEAR=null;
C$.WEEK_OF_WEEK_BASED_YEAR=null;
C$.WEEK_BASED_YEAR=null;
C$.WEEK_BASED_YEARS=null;
C$.QUARTER_YEARS=null;
...
return temporal.isSupported$java_time_temporal_TemporalField($I$(4).DAY_OF_YEAR) && temporal.isSupported$java_time_temporal_TemporalField($I$(4).MONTH_OF_YEAR) && temporal.isSupported$java_time_temporal_TemporalField($I$(4).YEAR) && P$.IsoFields.Field.isIso$java_time_temporal_TemporalAccessor(temporal)  ;
});
...
Clazz.newMeth(C$, 'adjustInto$TR$J', function (temporal, newValue) {
...
return null;
}var y=$I$(4).YEAR.checkValidIntValue$J((yearLong).longValue$());
var doq=(fieldValues.get$O($I$(5).DAY_OF_QUARTER)).longValue$();
P$.IsoFields.Field.ensureIso$java_time_temporal_TemporalAccessor(partialTemporal);
var date;
if (resolverStyle === $I$(7).LENIENT ) {
date=$I$(8).of$I$I$I(y, 1, 1).plusMonths$J(Math.multiplyExact(Math.subtractExact((qoyLong).longValue$(), 1), 3));
doq=Math.subtractExact(doq, 1);
} else {
var qoy=$I$(5).QUARTER_OF_YEAR.range$().checkValidIntValue$J$java_time_temporal_TemporalField((qoyLong).longValue$(), $I$(5).QUARTER_OF_YEAR);
...
Clazz.newMeth(C$, 'isSupportedBy$java_time_temporal_TemporalAccessor', function (temporal) {
return temporal.isSupported$java_time_temporal_TemporalField($I$(4).MONTH_OF_YEAR) && P$.IsoFields.Field.isIso$java_time_temporal_TemporalAccessor(temporal) ;
});
...
Clazz.newMeth(C$, 'isSupportedBy$java_time_temporal_TemporalAccessor', function (temporal) {
return temporal.isSupported$java_time_temporal_TemporalField($I$(4).EPOCH_DAY) && P$.IsoFields.Field.isIso$java_time_temporal_TemporalAccessor(temporal) ;
});
...
}return P$.IsoFields.Field.getWeekRange$java_time_LocalDate($I$(8).from$java_time_temporal_TemporalAccessor(temporal));
});

Clazz.newMeth(C$, 'getFrom$java_time_temporal_TemporalAccessor', function (temporal) {
if (this.isSupportedBy$java_time_temporal_TemporalAccessor(temporal) == false ) {
throw Clazz.new_(Clazz.load('java.time.temporal.UnsupportedTemporalTypeException').c$$S,["Unsupported field: WeekOfWeekBasedYear"]);
}return P$.IsoFields.Field.getWeek$java_time_LocalDate($I$(8).from$java_time_temporal_TemporalAccessor(temporal));
});
...
return null;
}var wby=$I$(5).WEEK_BASED_YEAR.range$().checkValidIntValue$J$java_time_temporal_TemporalField((wbyLong).longValue$(), $I$(5).WEEK_BASED_YEAR);
var wowby=(fieldValues.get$O($I$(5).WEEK_OF_WEEK_BASED_YEAR)).longValue$();
P$.IsoFields.Field.ensureIso$java_time_temporal_TemporalAccessor(partialTemporal);
var date=$I$(8).of$I$I$I(wby, 1, 4);
if (resolverStyle === $I$(7).LENIENT ) {
var dow=(dowLong).longValue$();
if (dow > 7) {
date=date.plusWeeks$J(((dow - 1)/7|0));
dow=((dow - 1) % 7) + 1;
} else if (dow < 1) {
date=date.plusWeeks$J((Math.subtractExact(dow, 7)/7|0));
dow=((dow + 6) % 7) + 1;
}date=date.plusWeeks$J(Math.subtractExact(wowby, 1)).with$java_time_temporal_TemporalField$J($I$(4).DAY_OF_WEEK, dow);
} else {
var dow=$I$(4).DAY_OF_WEEK.checkValidIntValue$J((dowLong).longValue$());
if (wowby < 1 || wowby > 52 ) {
if (resolverStyle === $I$(7).STRICT ) {
P$.IsoFields.Field.getWeekRange$java_time_LocalDate(date).checkValidValue$J$java_time_temporal_TemporalField(wowby, this);
} else {
...
}return P$.IsoFields.Field.getWeekBasedYear$java_time_LocalDate($I$(8).from$java_time_temporal_TemporalAccessor(temporal));
});
...
var week=P$.IsoFields.Field.getWeek$java_time_LocalDate(date);
if (week == 53 && P$.IsoFields.Field.getWeekRange$I(newWby) == 52 ) {
week=52;
...
Clazz.newMeth(C$, 'addTo$TR$J', function (temporal, amount) {
switch (this) {
...
return temporal.plus$J$java_time_temporal_TemporalUnit((amount/256|0), $I$(1).YEARS).plus$J$java_time_temporal_TemporalUnit((amount % 256) * 3, $I$(1).MONTHS);
default:
...
case C$.QUARTER_YEARS:
return (temporal1Inclusive.until$java_time_temporal_Temporal$java_time_temporal_TemporalUnit(temporal2Exclusive, $I$(1).MONTHS)/3|0);
default:
throw Clazz.new_(Clazz.load('IllegalStateException').c$$S,["Unreachable"]);
}
});
