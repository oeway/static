(function(){var P$=Clazz.newPackage("java.security"),p$1={},I$=[[0,'java.util.regex.Pattern','sun.security.util.Debug','sun.security.provider.SecureRandom','sun.security.jca.Providers','sun.security.jca.GetInstance','java.security.SecureRandomSpi','java.security.AccessController','java.security.Security',['java.security.SecureRandom','.StrongPatternHolder']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['randomBytesUsed'],'L',['counter'],'S',['algorithm'],'O',['provider','java.security.Provider','secureRandomSpi','java.security.SecureRandomSpi','state','byte[]','digest','java.security.MessageDigest','randomBytes','byte[]']]
