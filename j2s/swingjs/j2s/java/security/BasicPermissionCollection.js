(function(){var P$=Clazz.newPackage("java.security"),p$1={},p$2={},I$=[[0,'java.security.BasicPermissionCollection','java.io.ObjectStreamField','java.util.Hashtable','Boolean','java.util.HashMap','java.util.Collections']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "BasicPermissionCollection", null, 'java.security.PermissionCollection', 'java.io.Serializable');

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.serialPersistentFields=Clazz.array($I$(2), -1, [Clazz.new_($I$(2,1).c$$S$Class,["permissions", Clazz.getClass($I$(3))]), Clazz.new_($I$(2,1).c$$S$Class,["all_allowed", $I$(4).TYPE]), Clazz.new_($I$(2,1).c$$S$Class,["permClass", Clazz.getClass(Class)])]);
}
...
Clazz.super_(C$, this);
this.perms=Clazz.new_(1,{K:"String",V:"java.security.Permission"},$I$(5,1).c$$I,[11]);
...
this.perms.put$TK$TV(bp.getCanonicalName$(), permission);
}if (!this.all_allowed) {
...
{
return $I$(6).enumeration$java_util_Collection(this.perms.values$());
}});

Clazz.newMeth(C$, 'writeObject$java_io_ObjectOutputStream', function (out) {
var permissions=Clazz.new_(1,{K:"String",V:"java.security.Permission"},$I$(3,1).c$$I,[this.perms.size$() * 2]);
{
...
this.perms=Clazz.new_(1,{K:"String",V:"java.security.Permission"},$I$(5,1).c$$I,[permissions.size$() * 2]);
