...
var certChains=Clazz.new_(1,{E:"java.security.cert.Certificate"},$I$(1,1));
...
this.certs=certChains.toArray$TTA(Clazz.array($I$(2), [certChains.size$()]));
return this.certs.clone$();
} else {
return null;
}});
...
if (size > 0) {
cfs=Clazz.new_(1,{K:"String",V:"java.security.cert.CertificateFactory"},$I$(5,1).c$$I,[3]);
...
var signers=Clazz.new_(1,{E:"java.security.CodeSigner"},$I$(1,1));
while (i < certs.length){
var certChain=Clazz.new_(1,{E:"java.security.cert.Certificate"},$I$(1,1));
certChain.add$TE(certs[i++]);
var j=i;
while (j < certs.length && Clazz.instanceOf(certs[j], "java.security.cert.X509Certificate")  && (certs[j]).getBasicConstraints$() != -1 ){
certChain.add$TE(certs[j]);
j++;
}
i=j;
var certPath=this.factory.generateCertPath$java_util_List(certChain);
signers.add$TE(Clazz.new_($I$(8,1).c$$java_security_cert_CertPath$java_security_Timestamp,[certPath, null]));
}
if (signers.isEmpty$()) {
return null;
} else {
return signers.toArray$TTA(Clazz.array($I$(8), [signers.size$()]));
}} catch (e) {
