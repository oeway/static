(function(){var P$=Clazz.newPackage("java.security.cert"),I$=[[0,'java.security.cert.CertificateFactory','java.io.ByteArrayInputStream','StringBuffer',['java.security.cert.CertPath','.CertPathRep']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
return Clazz.new_($I$(4,1).c$$S$BA,[this.type, this.getEncoded$()]);
} catch (ce) {
