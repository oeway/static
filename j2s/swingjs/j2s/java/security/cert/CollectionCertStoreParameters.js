(function(){var P$=Clazz.newPackage("java.security.cert"),I$=[[0,'java.util.Collections','InternalError','StringBuffer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
throw Clazz.new_($I$(2,1).c$$S$Throwable,[e.toString(), e]);
} else {
throw e;
}
}
