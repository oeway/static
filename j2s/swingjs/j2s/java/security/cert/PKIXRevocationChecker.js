(function(){var P$=Clazz.newPackage("java.security.cert"),I$=[[0,'java.util.Collections','java.util.ArrayList','java.util.HashMap','java.util.HashSet']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.ocspExtensions=(extensions == null ) ? $I$(1).emptyList$() : Clazz.new_(1,{E:"java.security.cert.Extension"},$I$(2,1).c$$java_util_Collection,[extensions]);
});
...
var copy=Clazz.new_(1,{K:"java.security.cert.X509Certificate",V:"byte[]"},$I$(3,1).c$$I,[responses.size$()]);
for (var e, $e = responses.entrySet$().iterator$(); $e.hasNext$()&&((e=($e.next$())),1);) {
copy.put$TK$TV(e.getKey$(), e.getValue$().clone$());
}
this.ocspResponses=copy;
}});

Clazz.newMeth(C$, 'getOcspResponses$', function () {
var copy=Clazz.new_(1,{K:"java.security.cert.X509Certificate",V:"byte[]"},$I$(3,1).c$$I,[this.ocspResponses.size$()]);
...
this.options=(options == null ) ? $I$(1).emptySet$() : Clazz.new_(1,{E:"java.security.cert.PKIXRevocationChecker.Option"},$I$(4,1).c$$java_util_Collection,[options]);
});
...
copy.ocspExtensions=Clazz.new_(1,{E:"java.security.cert.Extension"},$I$(2,1).c$$java_util_Collection,[this.ocspExtensions]);
copy.ocspResponses=Clazz.new_(1,{K:"java.security.cert.X509Certificate",V:"byte[]"},$I$(3,1).c$$java_util_Map,[this.ocspResponses]);
for (var entry, $entry = copy.ocspResponses.entrySet$().iterator$(); $entry.hasNext$()&&((entry=($entry.next$())),1);) {
var encoded=entry.getValue$();
entry.setValue$TV(encoded.clone$());
}
copy.options=Clazz.new_(1,{E:"java.security.cert.PKIXRevocationChecker.Option"},$I$(4,1).c$$java_util_Collection,[this.options]);
return copy;
});
;
