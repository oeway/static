...
C$.$fields$=[['L',['skew'],'O',['issuerNames','java.util.HashSet','+issuerX500Principals','minCRL','java.math.BigInteger','+maxCRL','dateAndTime','java.util.Date','certChecking','java.security.cert.X509Certificate']]
...
this.issuerX500Principals=Clazz.new_(1,{E:"javax.security.auth.x500.X500Principal"},$I$(3,1).c$$java_util_Collection,[issuers]);
this.issuerNames=Clazz.new_(1,{E:"java.lang.Object"},$I$(3,1));
for (var p, $p = this.issuerX500Principals.iterator$(); $p.hasNext$()&&((p=($p.next$())),1);) {
this.issuerNames.add$TE(p.getEncoded$());
}
}});
...
this.issuerX500Principals=Clazz.new_(1,{E:"javax.security.auth.x500.X500Principal"},$I$(3,1));
}this.issuerNames.add$TE(name);
this.issuerX500Principals.add$TE(principal);
}, p$1);

Clazz.newMeth(C$, 'cloneAndCheckIssuerNames$java_util_Collection', function (names) {
var namesCopy=Clazz.new_(1,{E:"java.lang.Object"},$I$(3,1));
...
if (Clazz.instanceOf(nameObject, Clazz.array(Byte.TYPE, -1))) namesCopy.add$TE((nameObject).clone$());
 else namesCopy.add$TE(nameObject);
}
return (namesCopy);
}, 1);
...
var x500Principals=Clazz.new_(1,{E:"javax.security.auth.x500.X500Principal"},$I$(3,1));
for (var t=names.iterator$(); t.hasNext$(); ) {
var nameObject=t.next$();
if (Clazz.instanceOf(nameObject, "java.lang.String")) {
x500Principals.add$TE(Clazz.new_($I$(4,1).c$$S,[nameObject]).asX500Principal$());
} else {
try {
x500Principals.add$TE(Clazz.new_($I$(5,1).c$$BA,[nameObject]));
} catch (e) {
...
if (dateAndTime == null ) this.dateAndTime=null;
 else this.dateAndTime=Clazz.new_($I$(6,1).c$$J,[dateAndTime.getTime$()]);
this.skew=0;
});

Clazz.newMeth(C$, 'setDateAndTime$java_util_Date$J', function (dateAndTime, skew) {
this.dateAndTime=(dateAndTime == null  ? null : Clazz.new_($I$(6,1).c$$J,[dateAndTime.getTime$()]));
this.skew=skew;
});
...
if (this.issuerX500Principals == null ) {
return null;
}return $I$(7).unmodifiableCollection$java_util_Collection(this.issuerX500Principals);
});
...
try {
var $in=Clazz.new_($I$(9,1).c$$BA,[crlNumExtVal]);
var encoded=$in.getOctetString$();
var crlNumExt=Clazz.new_($I$(10,1).c$$Boolean$O,[$I$(11).FALSE, encoded]);
...
if (this.skew > 0) {
nowPlusSkew=Clazz.new_($I$(6,1).c$$J,[this.dateAndTime.getTime$() + this.skew]);
nowMinusSkew=Clazz.new_($I$(6,1).c$$J,[this.dateAndTime.getTime$() - this.skew]);
...
if (this.issuerNames != null ) {
copy.issuerNames=Clazz.new_(1,{E:"java.lang.Object"},$I$(3,1).c$$java_util_Collection,[this.issuerNames]);
copy.issuerX500Principals=Clazz.new_(1,{E:"javax.security.auth.x500.X500Principal"},$I$(3,1).c$$java_util_Collection,[this.issuerX500Principals]);
}return copy;
} catch (e) {
if (Clazz.exceptionOf(e,"CloneNotSupportedException")){
throw Clazz.new_($I$(12,1).c$$S$Throwable,[e.toString(), e]);
} else {
throw e;
}
}
