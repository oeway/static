(function(){var P$=Clazz.newPackage("java.security.cert"),p$1={},I$=[[0,'javax.security.auth.x500.X500Principal','sun.security.x509.NameConstraintsExtension','Boolean','StringBuffer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
this.nc=Clazz.new_($I$(2,1).c$$Boolean$O,[$I$(3).FALSE, bytes]);
} catch (ioe) {
