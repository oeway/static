(function(){var P$=Clazz.newPackage("java.security.cert"),I$=[[0,'java.security.cert.CertificateFactory','java.io.ByteArrayInputStream','sun.security.x509.X509CertImpl','java.util.Arrays',['java.security.cert.Certificate','.CertificateRep']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
return Clazz.new_($I$(5,1).c$$S$BA,[this.type, this.getEncoded$()]);
} catch (e) {
if (Clazz.exceptionOf(e,"java.security.cert.CertificateException")){
