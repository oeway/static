(function(){var P$=Clazz.newPackage("java.security.cert"),I$=[[0,'sun.security.x509.X509CertImpl']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(1).verify$java_security_cert_X509Certificate$java_security_PublicKey$java_security_Provider(this, key, sigProvider);
});
})();
