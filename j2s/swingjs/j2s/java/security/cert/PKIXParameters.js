(function(){var P$=Clazz.newPackage("java.security.cert"),I$=[[0,'java.util.Collections','java.util.ArrayList','java.util.HashSet','java.security.cert.TrustAnchor','InternalError','StringBuffer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.certPathCheckers=Clazz.new_(1,{E:"java.security.cert.PKIXCertPathChecker"},$I$(2,1));
this.certStores=Clazz.new_(1,{E:"java.security.cert.CertStore"},$I$(2,1));
}, 1);
...
var hashSet=Clazz.new_(1,{E:"java.security.cert.TrustAnchor"},$I$(3,1));
var aliases=keystore.aliases$();
while (aliases.hasMoreElements$()){
var alias=aliases.nextElement$();
if (keystore.isCertificateEntry$S(alias)) {
var cert=keystore.getCertificate$S(alias);
if (Clazz.instanceOf(cert, "java.security.cert.X509Certificate")) hashSet.add$TE(Clazz.new_($I$(4,1).c$$java_security_cert_X509Certificate$BA,[cert, null]));
}}
...
this.unmodTrustAnchors=$I$(1).unmodifiableSet$java_util_Set(Clazz.new_(1,{E:"java.security.cert.TrustAnchor"},$I$(3,1).c$$java_util_Collection,[trustAnchors]));
});
...
this.unmodInitialPolicies=$I$(1).unmodifiableSet$java_util_Set(Clazz.new_(1,{E:"String"},$I$(3,1).c$$java_util_Collection,[initialPolicies]));
...
this.certStores=Clazz.new_(1,{E:"java.security.cert.CertStore"},$I$(2,1).c$$java_util_Collection,[stores]);
}});

Clazz.newMeth(C$, 'addCertStore$java_security_cert_CertStore', function (store) {
if (store != null ) {
this.certStores.add$TE(store);
}});

Clazz.newMeth(C$, 'getCertStores$', function () {
return $I$(1).unmodifiableList$java_util_List(Clazz.new_(1,{E:"java.security.cert.CertStore"},$I$(2,1).c$$java_util_Collection,[this.certStores]));
});
...
if (checkers != null ) {
var tmpList=Clazz.new_(1,{E:"java.security.cert.PKIXCertPathChecker"},$I$(2,1));
for (var checker, $checker = checkers.iterator$(); $checker.hasNext$()&&((checker=($checker.next$())),1);) {
tmpList.add$TE(checker.clone$());
}
...
if (checker != null ) {
this.certPathCheckers.add$TE(checker.clone$());
}});
...
copy.certStores=Clazz.new_(1,{E:"java.security.cert.CertStore"},$I$(2,1).c$$java_util_Collection,[this.certStores]);
}if (this.certPathCheckers != null ) {
copy.certPathCheckers=Clazz.new_(1,{E:"java.security.cert.PKIXCertPathChecker"},$I$(2,1).c$$I,[this.certPathCheckers.size$()]);
for (var checker, $checker = this.certPathCheckers.iterator$(); $checker.hasNext$()&&((checker=($checker.next$())),1);) {
copy.certPathCheckers.add$TE(checker.clone$());
}
}return copy;
} catch (e) {
if (Clazz.exceptionOf(e,"CloneNotSupportedException")){
throw Clazz.new_($I$(5,1).c$$S$Throwable,[e.toString(), e]);
} else {
throw e;
}
}
