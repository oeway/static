...
this.issuer=Clazz.new_($I$(5,1).c$$S,[issuerDN]).asX500Principal$();
}});

Clazz.newMeth(C$, 'setIssuer$BA', function (issuerDN) {
try {
this.issuer=(issuerDN == null  ? null : Clazz.new_($I$(6,1).c$$BA,[issuerDN]));
} catch (e) {
...
this.subject=Clazz.new_($I$(5,1).c$$S,[subjectDN]).asX500Principal$();
}});

Clazz.newMeth(C$, 'setSubject$BA', function (subjectDN) {
try {
this.subject=(subjectDN == null  ? null : Clazz.new_($I$(6,1).c$$BA,[subjectDN]));
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
throw Clazz.new_(Clazz.load('java.io.IOException').c$$S$Throwable,["Invalid name", e]);
} else {
...
this.subjectPublicKey=$I$(7).parse$sun_security_util_DerValue(Clazz.new_($I$(8,1).c$$BA,[this.subjectPublicKeyBytes]));
}});
...
this.keyPurposeSet=$I$(9).unmodifiableSet$java_util_Set(Clazz.new_(1,{E:"String"},$I$(10,1).c$$java_util_Collection,[keyPurposeSet]));
this.keyPurposeOIDSet=Clazz.new_(1,{E:"sun.security.util.ObjectIdentifier"},$I$(10,1));
for (var s, $s = this.keyPurposeSet.iterator$(); $s.hasNext$()&&((s=($s.next$())),1);) {
this.keyPurposeOIDSet.add$TE(Clazz.new_($I$(2,1).c$$S,[s]));
}
}});
...
this.subjectAlternativeNames=Clazz.new_(1,{E:"java.util.List"},$I$(10,1));
}if (this.subjectAlternativeGeneralNames == null ) {
this.subjectAlternativeGeneralNames=Clazz.new_(1,{E:"sun.security.x509.GeneralNameInterface"},$I$(10,1));
}var list=Clazz.new_(1,{E:"java.lang.Object"},$I$(11,1).c$$I,[2]);
list.add$TE(Integer.valueOf$I(type));
list.add$TE(name);
this.subjectAlternativeNames.add$TE(list);
this.subjectAlternativeGeneralNames.add$TE(tempName);
}, p$1);

Clazz.newMeth(C$, 'parseNames$java_util_Collection', function (names) {
var genNames=Clazz.new_(1,{E:"sun.security.x509.GeneralNameInterface"},$I$(10,1));
...
o=nameList.get$I(1);
genNames.add$TE(C$.makeGeneralNameInterface$I$O(nameType, o));
}
return genNames;
}, 1);
...
break;
case 4:
result=Clazz.new_($I$(5,1).c$$S,[name]);
break;
case 6:
...
break;
case 8:
result=Clazz.new_($I$(16,1).c$$S,[name]);
break;
default:
...
var val=Clazz.new_($I$(8,1).c$$BA,[name]);
if (C$.debug != null ) {
...
break;
case 4:
result=Clazz.new_($I$(5,1).c$$sun_security_util_DerValue,[val]);
break;
case 5:
result=Clazz.new_($I$(19,1).c$$sun_security_util_DerValue,[val]);
break;
case 6:
...
this.nc=Clazz.new_($I$(20,1).c$$Boolean$O,[C$.FALSE, bytes]);
}});
...
var tempSet=$I$(9).unmodifiableSet$java_util_Set(Clazz.new_(1,{E:"String"},$I$(10,1).c$$java_util_Collection,[certPolicySet]));
var i=tempSet.iterator$();
var polIdVector=Clazz.new_(1,{E:"sun.security.x509.CertificatePolicyId"},$I$(21,1));
while (i.hasNext$()){
var o=i.next$();
if (!(Clazz.instanceOf(o, "java.lang.String"))) {
throw Clazz.new_(Clazz.load('java.io.IOException').c$$S,["non String in certPolicySet"]);
}polIdVector.add$TE(Clazz.new_($I$(22,1).c$$sun_security_util_ObjectIdentifier,[Clazz.new_($I$(2,1).c$$S,[o])]));
}
this.policySet=tempSet;
this.policy=Clazz.new_($I$(23,1).c$$java_util_Vector,[polIdVector]);
}});
...
this.pathToNames=Clazz.new_(1,{E:"java.util.List"},$I$(10,1));
this.pathToGeneralNames=Clazz.new_(1,{E:"sun.security.x509.GeneralNameInterface"},$I$(10,1));
}var list=Clazz.new_(1,{E:"java.lang.Object"},$I$(11,1).c$$I,[2]);
list.add$TE(Integer.valueOf$I(type));
list.add$TE(name);
this.pathToNames.add$TE(list);
this.pathToGeneralNames.add$TE(tempName);
}, p$1);
...
var namesCopy=Clazz.new_(1,{E:"java.util.List"},$I$(10,1));
for (var o, $o = names.iterator$(); $o.hasNext$()&&((o=($o.next$())),1);) {
namesCopy.add$TE(Clazz.new_(1,{E:"java.lang.Object"},$I$(11,1).c$$java_util_Collection,[o]));
}
...
nameList.set$I$TE(1, (nameObject).clone$());
}}
return namesCopy;
}, 1);
...
if (rawExtVal == null ) {
return null;
}var $in=Clazz.new_($I$(26,1).c$$BA,[rawExtVal]);
...
case 2:
return Clazz.new_($I$(20,1).c$$Boolean$O,[C$.FALSE, encoded]);
case 3:
return Clazz.new_($I$(29,1).c$$Boolean$O,[C$.FALSE, encoded]);
case 4:
return Clazz.new_($I$(30,1).c$$Boolean$O,[C$.FALSE, encoded]);
default:
return null;
}
}, 1);
...
if (!$I$(31).equals$BA$BA(this.subjectPublicKeyBytes, certKey)) {
if (C$.debug != null ) {
...
}var $in=Clazz.new_($I$(26,1).c$$BA,[extVal]);
var certSubjectKeyID=$in.getOctetString$();
if (certSubjectKeyID == null  || !$I$(31).equals$BA$BA(this.subjectKeyID, certSubjectKeyID) ) {
if (C$.debug != null ) {
...
if (certAuthKeyID == null  || !$I$(31).equals$BA$BA(this.authorityKeyID, certAuthKeyID) ) {
if (C$.debug != null ) {
...
var val=Clazz.new_($I$(8,1).c$$BA,[encodedKey]);
if (val.tag != 48) {
throw Clazz.new_(Clazz.load('java.io.IOException').c$$S,["invalid key format"]);
}var algID=$I$(32).parse$sun_security_util_DerValue(val.data.getDerValue$());
if (C$.debug != null ) {
...
var policyIDs=Clazz.new_(1,{E:"sun.security.x509.CertificatePolicyId"},$I$(11,1).c$$I,[policies.size$()]);
for (var info, $info = policies.iterator$(); $info.hasNext$()&&((info=($info.next$())),1);) {
policyIDs.add$TE(info.getPolicyIdentifier$());
}
if (this.policy != null ) {
var foundOne=false;
...
return Clazz.new_(1,{E:"Object"},$I$(10,1).c$$java_util_Collection,[set]);
}}, 1);
...
throw Clazz.new_($I$(33,1).c$$S$Throwable,[e.toString(), e]);
} else {
throw e;
}
}
