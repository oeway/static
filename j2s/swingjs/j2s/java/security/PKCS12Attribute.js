...
var bytes=Clazz.new_($I$(5,1).c$$S$I,[value.replace$CharSequence$CharSequence(":", ""), 16]).toByteArray$();
if (bytes[0] == 0) {
...
attribute.write$B$sun_security_util_DerOutputStream(($b$[0] = 49, $b$[0]), attrContent);
var attributeValue=Clazz.new_($I$(4,1));
attributeValue.write$B$sun_security_util_DerOutputStream(($b$[0] = 48, $b$[0]), attribute);
...
var attrContent=Clazz.new_($I$(6,1).c$$BA,[attrSeq[1].toByteArray$()]);
