...
C$.serialPersistentFields=Clazz.array($I$(1), -1, [Clazz.new_($I$(1,1).c$$S$Class,["perms", Clazz.getClass($I$(2))])]);
}
...
Clazz.super_(C$, this);
this.permsMap=Clazz.new_(1,{K:"java.security.Permission",V:"java.security.Permission"},$I$(4,1).c$$I,[11]);
}, 1);

Clazz.newMeth(C$, 'add$java_security_Permission', function (permission) {
{
this.permsMap.put$TK$TV(permission, permission);
}});
...
var perms=Clazz.new_(1,{K:"java.security.Permission",V:"java.security.Permission"},$I$(2,1).c$$I,[this.permsMap.size$() * 2]);
{
...
this.permsMap=Clazz.new_(1,{K:"java.security.Permission",V:"java.security.Permission"},$I$(4,1).c$$I,[perms.size$() * 2]);
