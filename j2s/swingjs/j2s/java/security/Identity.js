(function(){var P$=Clazz.newPackage("java.security"),p$1={},I$=[[0,'java.util.Vector','java.util.Arrays','java.security.Certificate']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.publicKey=key;
this.certificates=Clazz.new_(1,{E:"java.security.Certificate"},$I$(1,1));
});
...
}this.certificates.addElement$TE(certificate);
});
