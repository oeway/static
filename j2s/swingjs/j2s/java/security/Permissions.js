...
Clazz.super_(C$, this);
this.permsMap=Clazz.new_(1,{K:"Class",V:"java.security.PermissionCollection"},$I$(4,1).c$$I,[11]);
...
{
return Clazz.new_($I$(5,1).c$$java_util_Iterator,[this.permsMap.values$().iterator$()]);
}});
...
var perms=Clazz.new_(1,{K:"Class",V:"java.security.PermissionCollection"},$I$(2,1).c$$I,[this.permsMap.size$() * 2]);
{
...
this.permsMap=Clazz.new_(1,{K:"Class",V:"java.security.PermissionCollection"},$I$(4,1).c$$I,[perms.size$() * 2]);
