(function(){var P$=Clazz.newPackage("java.security"),I$=[[0,'java.util.Arrays','java.util.Collections','java.security.cert.X509Certificate','java.util.HashSet','StringBuilder','java.security.KeyStore','java.io.FileInputStream','javax.security.auth.callback.PasswordCallback','javax.security.auth.callback.Callback',['java.security.KeyStore','.PasswordProtection'],'java.security.AccessController',['java.security.KeyStore','.Builder','.FileBuilder'],['java.security.KeyStore','.SimpleLoadStoreParameter'],'sun.security.util.Debug','java.security.Security']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}this.attributes=$I$(2).unmodifiableSet$java_util_Set(Clazz.new_(1,{E:"java.security.KeyStore.Entry.Attribute"},$I$(4,1).c$$java_util_Collection,[attributes]));
}, 1);
...
}return Clazz.new_($I$(12,1).c$$S$java_security_Provider$java_io_File$java_security_KeyStore_ProtectionParameter$java_security_AccessControlContext,[type, provider, file, protection, $I$(11).getContext$()]);
}, 1);
...
), Clazz.new_(P$.KeyStore$Builder$2$1.$init$, [this, {provider:this.$finals$.provider,protection:this.$finals$.protection,type:this.$finals$.type}]));
}, 1);
...
), Clazz.new_(C$, [this, {provider:provider,protection:protection,type:type,context:context}],P$.KeyStore$Builder$2));
}, 1);
;
...
var callback=Clazz.new_($I$(8,1).c$$S$Z,["Password for keystore " + this.b$['java.security.KeyStore.Builder.FileBuilder'].file.getName$(), false]);
handler.handle$(Clazz.array($I$(9), -1, [callback]));
