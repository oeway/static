(function(){var P$=Clazz.newPackage("java.security"),p$1={},p$2={},I$=[[0,'java.util.Locale','java.util.Collections','java.util.ArrayList','java.util.HashMap',['java.security.Provider','.UString'],'java.security.Provider','java.lang.reflect.Modifier','Boolean','sun.security.util.Debug',['java.security.Provider','.ServiceKey'],'java.util.Properties','java.util.LinkedHashMap',['java.security.Provider','.Service'],'java.util.LinkedHashSet',['java.security.Provider','.EngineDescription']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.debug=$I$(9).getInstance$S$S("provider", "Provider");
C$.ALIAS_LENGTH="Alg.Alias.".length$();
C$.previousKey=Clazz.new_($I$(10,1).c$$S$S$Z,["", "", false]);
{
C$.knownEngines=Clazz.new_(1,{K:"String",V:"java.security.Provider.EngineDescription"},$I$(4,1));
...
}var tempProperties=Clazz.new_($I$(11,1));
...
Clazz.newMeth(C$, ['putIfAbsent$O$O','putIfAbsent$TK$TV'], function (key, value) {
p$2.check$S.apply(this, ["putProviderProperty." + this.name]);
if (C$.debug != null ) {
C$.debug.println$S("Set " + this.name + " provider property [" + key + "/" + value + "]" );
...
Clazz.newMeth(C$, ['replace$O$O$O','replace$TK$TV$TV'], function (key, oldValue, newValue) {
p$2.check$S.apply(this, ["putProviderProperty." + this.name]);
if (C$.debug != null ) {
...
Clazz.newMeth(C$, ['replace$O$O','replace$TK$TV'], function (key, value) {
p$2.check$S.apply(this, ["putProviderProperty." + this.name]);
if (C$.debug != null ) {
C$.debug.println$S("Replace " + this.name + " provider property " + key );
...
Clazz.newMeth(C$, ['compute$O$java_util_function_BiFunction','compute$TK$java_util_function_BiFunction'], function (key, remappingFunction) {
p$2.check$S.apply(this, ["putProviderProperty." + this.name]);
p$2.check$S.apply(this, ["removeProviderProperty" + this.name]);
if (C$.debug != null ) {
...
Clazz.newMeth(C$, ['computeIfAbsent$O$java_util_function_Function','computeIfAbsent$TK$java_util_function_Function'], function (key, mappingFunction) {
p$2.check$S.apply(this, ["putProviderProperty." + this.name]);
p$2.check$S.apply(this, ["removeProviderProperty" + this.name]);
if (C$.debug != null ) {
...
Clazz.newMeth(C$, ['computeIfPresent$O$java_util_function_BiFunction','computeIfPresent$TK$java_util_function_BiFunction'], function (key, remappingFunction) {
p$2.check$S.apply(this, ["putProviderProperty." + this.name]);
p$2.check$S.apply(this, ["removeProviderProperty" + this.name]);
if (C$.debug != null ) {
...
Clazz.newMeth(C$, ['merge$O$O$java_util_function_BiFunction','merge$TK$TV$java_util_function_BiFunction'], function (key, value, remappingFunction) {
p$2.check$S.apply(this, ["putProviderProperty." + this.name]);
p$2.check$S.apply(this, ["removeProviderProperty" + this.name]);
if (C$.debug != null ) {
...
Clazz.newMeth(C$, ['getOrDefault$O$O','getOrDefault$O$TV'], function (key, defaultValue) {
p$2.checkInitialized.apply(this, []);
return C$.superclazz.prototype.getOrDefault$O$TV.apply(this, [key, defaultValue]);
});
...
C$.superclazz.prototype.put$TK$TV.apply(this, ["Provider.id name", String.valueOf$O(this.name)]);
C$.superclazz.prototype.put$TK$TV.apply(this, ["Provider.id version", String.valueOf$D(this.version)]);
C$.superclazz.prototype.put$TK$TV.apply(this, ["Provider.id info", String.valueOf$O(this.info)]);
C$.superclazz.prototype.put$TK$TV.apply(this, ["Provider.id className", this.getClass$().getName$()]);
}, p$2);

Clazz.newMeth(C$, 'readObject$java_io_ObjectInputStream', function ($in) {
var copy=Clazz.new_(1,{K:"java.lang.Object",V:"java.lang.Object"},$I$(4,1));
for (var entry, $entry = C$.superclazz.prototype.entrySet$.apply(this, []).iterator$(); $entry.hasNext$()&&((entry=($entry.next$())),1);) {
copy.put$TK$TV(entry.getKey$(), entry.getValue$());
}
this.defaults=null;
...
this.legacyStrings=Clazz.new_(1,{K:"String",V:"String"},$I$(12,1));
}return true;
}, p$2);
...
if (!p$2.checkLegacy$O.apply(this, [key])) {
return false;
}this.legacyStrings.replace$TK$TV$TV(key, oldValue, newValue);
}return C$.superclazz.prototype.replace$TK$TV$TV.apply(this, [key, oldValue, newValue]);
}, p$2);
...
if (!p$2.checkLegacy$O.apply(this, [key])) {
return null;
}this.legacyStrings.replace$TK$TV(key, value);
}return C$.superclazz.prototype.replace$TK$TV.apply(this, [key, value]);
}, p$2);
...
if (!p$2.checkLegacy$O.apply(this, [key])) {
return null;
}this.legacyStrings.merge$TK$TV$java_util_function_BiFunction(key, value, remappingFunction);
}return C$.superclazz.prototype.merge$TK$TV$java_util_function_BiFunction.apply(this, [key, value, remappingFunction]);
}, p$2);
...
if (!p$2.checkLegacy$O.apply(this, [key])) {
return null;
}this.legacyStrings.computeIfAbsent$TK$java_util_function_Function(key, remappingFunction);
}return C$.superclazz.prototype.compute$TK$java_util_function_BiFunction.apply(this, [key, remappingFunction]);
}, p$2);
...
if (!p$2.checkLegacy$O.apply(this, [key])) {
return null;
}this.legacyStrings.computeIfAbsent$TK$java_util_function_Function(key, mappingFunction);
}return C$.superclazz.prototype.computeIfAbsent$TK$java_util_function_Function.apply(this, [key, mappingFunction]);
}, p$2);
...
if (!p$2.checkLegacy$O.apply(this, [key])) {
return null;
}this.legacyStrings.computeIfPresent$TK$java_util_function_BiFunction(key, remappingFunction);
}return C$.superclazz.prototype.computeIfPresent$TK$java_util_function_BiFunction.apply(this, [key, remappingFunction]);
}, p$2);
...
if (!p$2.checkLegacy$O.apply(this, [key])) {
return null;
}this.legacyStrings.put$TK$TV(key, value);
}return C$.superclazz.prototype.put$TK$TV.apply(this, [key, value]);
}, p$2);
...
if (!p$2.checkLegacy$O.apply(this, [key])) {
return null;
}this.legacyStrings.putIfAbsent$TK$TV(key, value);
}return C$.superclazz.prototype.putIfAbsent$TK$TV.apply(this, [key, value]);
}, p$2);
...
if (this.legacyMap == null ) {
this.legacyMap=Clazz.new_(1,{K:"java.security.Provider.ServiceKey",V:"java.security.Provider.Service"},$I$(12,1));
} else {
this.legacyMap.clear$();
...
var key=Clazz.new_($I$(10,1).c$$S$S$Z,[type, stdAlg, true]);
var s=this.legacyMap.get$O(key);
if (s == null ) {
s=Clazz.new_($I$(13,1).c$$java_security_Provider,[this]);
s.type=type;
s.algorithm=stdAlg;
this.legacyMap.put$TK$TV(key, s);
}this.legacyMap.put$TK$TV(Clazz.new_($I$(10,1).c$$S$S$Z,[type, aliasAlg, true]), s);
...
key=Clazz.new_($I$(10,1).c$$S$S$Z,[type, algorithm, false]);
C$.previousKey=key;
}if (this.serviceMap != null ) {
...
p$2.ensureLegacyParsed.apply(this, []);
var set=Clazz.new_(1,{E:"java.security.Provider.Service"},$I$(14,1));
if (this.serviceMap != null ) {
...
this.serviceMap=Clazz.new_(1,{K:"java.security.Provider.ServiceKey",V:"java.security.Provider.Service"},$I$(12,1));
}this.servicesChanged=true;
var type=s.getType$();
var algorithm=s.getAlgorithm$();
var key=Clazz.new_($I$(10,1).c$$S$S$Z,[type, algorithm, true]);
p$2.implRemoveService$java_security_Provider_Service.apply(this, [this.serviceMap.get$O(key)]);
this.serviceMap.put$TK$TV(key, s);
for (var alias, $alias = p$1.getAliases.apply(s, []).iterator$(); $alias.hasNext$()&&((alias=($alias.next$())),1);) {
this.serviceMap.put$TK$TV(Clazz.new_($I$(10,1).c$$S$S$Z,[type, alias, true]), s);
}
...
var type=s.getType$();
var algorithm=s.getAlgorithm$();
C$.superclazz.prototype.put$TK$TV.apply(this, [type + "." + algorithm , s.getClassName$()]);
for (var alias, $alias = p$1.getAliases.apply(s, []).iterator$(); $alias.hasNext$()&&((alias=($alias.next$())),1);) {
C$.superclazz.prototype.put$TK$TV.apply(this, ["Alg.Alias." + type + "." + alias , algorithm]);
}
for (var entry, $entry = s.attributes.entrySet$().iterator$(); $entry.hasNext$()&&((entry=($entry.next$())),1);) {
var key=type + "." + algorithm + " " + entry.getKey$() ;
C$.superclazz.prototype.put$TK$TV.apply(this, [key, entry.getValue$()]);
}
}, p$2);
...
var algorithm=s.getAlgorithm$();
var key=Clazz.new_($I$(10,1).c$$S$S$Z,[type, algorithm, false]);
...
for (var alias, $alias = p$1.getAliases.apply(s, []).iterator$(); $alias.hasNext$()&&((alias=($alias.next$())),1);) {
this.serviceMap.remove$O(Clazz.new_($I$(10,1).c$$S$S$Z,[type, alias, false]));
}
...
var ed=Clazz.new_($I$(15,1).c$$S$Z$S,[name, sp, paramName]);
C$.knownEngines.put$TK$TV(name.toLowerCase$java_util_Locale($I$(1).ENGLISH), ed);
C$.knownEngines.put$TK$TV(name, ed);
}, 1);
...
this.aliases=Clazz.new_(1,{E:"String"},$I$(3,1).c$$I,[2]);
}this.aliases.add$TE(alias);
}, p$1);

Clazz.newMeth(C$, 'addAttribute$S$S', function (type, value) {
if (this.attributes.isEmpty$()) {
this.attributes=Clazz.new_(1,{K:"java.security.Provider.UString",V:"String"},$I$(4,1).c$$I,[8]);
}this.attributes.put$TK$TV(Clazz.new_($I$(5,1).c$$S,[type]), value);
});
...
this.type=P$.Provider.getEngineName$S(type);
this.algorithm=algorithm;
this.className=className;
if (aliases == null ) {
this.aliases=$I$(2).emptyList$();
} else {
this.aliases=Clazz.new_(1,{E:"String"},$I$(3,1).c$$java_util_Collection,[aliases]);
}if (attributes == null ) {
this.attributes=$I$(2).emptyMap$();
} else {
this.attributes=Clazz.new_(1,{K:"java.security.Provider.UString",V:"String"},$I$(4,1));
for (var entry, $entry = attributes.entrySet$().iterator$(); $entry.hasNext$()&&((entry=($entry.next$())),1);) {
this.attributes.put$TK$TV(Clazz.new_($I$(5,1).c$$S,[entry.getKey$()]), entry.getValue$());
}
}}, 1);
...
var cons=clazz.getConstructor$ClassA([paramClass]);
return cons.newInstance$OA([constructorParameter]);
}} catch (e$$) {
...
continue;
}return con.newInstance$OA([constructorParameter]);
}
...
var classList=Clazz.new_(1,{E:"Class"},$I$(3,1).c$$I,[classNames.length]);
...
if (clazz != null ) {
classList.add$TE(clazz);
}}
this.supportedClasses=classList.toArray$TTA(C$.CLASS0);
}var bool=(this.supportedFormats != null ) || (this.supportedClasses != null ) ;
b=$I$(8).valueOf$Z(bool);
