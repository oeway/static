(function(){var P$=Clazz.newPackage("java.security"),I$=[[0,'java.security.Security','java.security.SecureRandom']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
