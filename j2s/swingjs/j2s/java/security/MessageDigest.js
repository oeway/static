(function(){var P$=Clazz.newPackage("java.security"),I$=[[0,'sun.security.util.Debug','java.security.Security',['java.security.MessageDigest','.Delegate'],'java.io.ByteArrayOutputStream','java.io.PrintStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.engineUpdate$B(($b$[0] = input, $b$[0]));
this.state=1;
});
...
this.digestSpi.engineUpdate$B(($b$[0] = input, $b$[0]));
});
