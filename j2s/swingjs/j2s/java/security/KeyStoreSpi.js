(function(){var P$=Clazz.newPackage("java.security"),I$=[[0,'javax.security.auth.callback.PasswordCallback','javax.security.auth.callback.Callback',['java.security.KeyStore','.TrustedCertificateEntry'],['java.security.KeyStore','.PrivateKeyEntry'],['java.security.KeyStore','.SecretKeyEntry']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
handler.handle$(Clazz.array($I$(2), -1, [callback]));
} catch (e) {
...
return Clazz.new_($I$(3,1).c$$java_security_cert_Certificate,[this.engineGetCertificate$S(alias)]);
} else {
