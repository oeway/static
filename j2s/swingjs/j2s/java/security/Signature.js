(function(){var P$=Clazz.newPackage("java.security"),p$1={},I$=[[0,'javax.crypto.Cipher',['java.security.Signature','.CipherAdapter'],'java.security.Signature','AssertionError','java.io.ByteArrayOutputStream','java.util.Arrays','sun.security.util.Debug','sun.security.jca.ServiceId','java.util.concurrent.ConcurrentHashMap','Boolean','sun.security.jca.GetInstance',['java.security.Signature','.Delegate'],'java.security.SignatureSpi','java.security.Security']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.rsaIds=$I$(6).asList$TTA(Clazz.array($I$(8), -1, [Clazz.new_($I$(8,1).c$$S$S,["Signature", "NONEwithRSA"]), Clazz.new_($I$(8,1).c$$S$S,["Cipher", "RSA/ECB/PKCS1Padding"]), Clazz.new_($I$(8,1).c$$S$S,["Cipher", "RSA/ECB"]), Clazz.new_($I$(8,1).c$$S$S,["Cipher", "RSA//PKCS1Padding"]), Clazz.new_($I$(8,1).c$$S$S,["Cipher", "RSA"])]));
{
C$.signatureInfo=Clazz.new_(1,{K:"String",V:"Boolean"},$I$(9,1));
var TRUE=$I$(10).TRUE;
C$.signatureInfo.put$TK$TV("sun.security.provider.DSA$RawDSA", TRUE);
C$.signatureInfo.put$TK$TV("sun.security.provider.DSA$SHA1withDSA", TRUE);
C$.signatureInfo.put$TK$TV("sun.security.rsa.RSASignature$MD2withRSA", TRUE);
C$.signatureInfo.put$TK$TV("sun.security.rsa.RSASignature$MD5withRSA", TRUE);
C$.signatureInfo.put$TK$TV("sun.security.rsa.RSASignature$SHA1withRSA", TRUE);
C$.signatureInfo.put$TK$TV("sun.security.rsa.RSASignature$SHA256withRSA", TRUE);
C$.signatureInfo.put$TK$TV("sun.security.rsa.RSASignature$SHA384withRSA", TRUE);
C$.signatureInfo.put$TK$TV("sun.security.rsa.RSASignature$SHA512withRSA", TRUE);
C$.signatureInfo.put$TK$TV("com.sun.net.ssl.internal.ssl.RSASignature", TRUE);
C$.signatureInfo.put$TK$TV("sun.security.pkcs11.P11Signature", TRUE);
};
}
...
list=$I$(11).getServices$java_util_List(C$.rsaIds);
} else {
list=$I$(11).getServices$S$S("Signature", algorithm);
}var t=list.iterator$();
if (t.hasNext$() == false ) {
...
return Clazz.new_($I$(12,1).c$$java_security_Provider_Service$java_util_Iterator$S,[s, t, algorithm]);
} else {
try {
var instance=$I$(11).getInstance$java_security_Provider_Service$Class(s, Clazz.getClass($I$(13)));
...
sig=Clazz.new_($I$(12,1).c$$java_security_SignatureSpi$S,[spi, algorithm]);
...
}result=$I$(10).valueOf$Z(r);
C$.signatureInfo.put$TK$TV(className, result);
} catch (e) {
...
}var p=$I$(14).getProvider$S(provider);
if (p == null ) {
...
}var instance=$I$(11).getInstance$S$Class$S$S("Signature", Clazz.getClass($I$(13)), algorithm, provider);
return C$.getInstance$sun_security_jca_GetInstance_Instance$S(instance, algorithm);
}, 1);
...
}var instance=$I$(11).getInstance$S$Class$S$java_security_Provider("Signature", Clazz.getClass($I$(13)), algorithm, provider);
return C$.getInstance$sun_security_jca_GetInstance_Instance$S(instance, algorithm);
}, 1);
...
return Clazz.new_($I$(12,1).c$$java_security_SignatureSpi$S,[Clazz.new_($I$(2,1).c$$javax_crypto_Cipher,[c]), "NONEwithRSA"]);
} catch (e) {
...
}if (P$.Signature.isSpi$java_security_Provider_Service(s) == false ) {
continue;
}try {
...
this.chooseFirstProvider$();
this.sigSpi.engineUpdate$B(($b$[0] = b, $b$[0]));
});
