(function(){var P$=Clazz.newPackage("java.security"),p$1={},I$=[[0,'java.util.ArrayList','java.security.cert.Certificate','java.security.UnresolvedPermissionCollection','java.util.Hashtable','java.security.cert.CertificateFactory','java.io.ByteArrayInputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var signerCerts=Clazz.new_(1,{E:"java.security.cert.Certificate"},$I$(1,1));
i=0;
while (i < certs.length){
signerCerts.add$TE(certs[i]);
while (((i + 1) < certs.length) && (certs[i]).getIssuerDN$().equals$O((certs[i + 1]).getSubjectDN$()) ){
i++;
}
i++;
...
signerCerts.toArray$TTA(this.certs);
}}}}, 1);
...
if (size > 0) {
cfs=Clazz.new_(1,{K:"String",V:"java.security.cert.CertificateFactory"},$I$(4,1).c$$I,[3]);
