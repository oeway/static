(function(){var P$=java.lang.reflect,p$1={},I$=[[0,'Boolean',['sun.reflect.annotation.AnnotationParser','.JSAnnotationObject'],'sun.reflect.annotation.AnnotationParser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return (this.parameterTypes === Class.UNKNOWN_PARAMETERS  ? this.parameterTypes=$I$(2).guessMethodParameterTypes$S(this.signature) : this.parameterTypes);
});
...
return (this.returnType=$I$(2).typeForString$S$Z(this.returnType.toString(), false));
});
...
return $I$(3).toArray$java_util_Map(p$1.declaredAnnotations.apply(this, []));
});

Clazz.newMeth(C$, 'declaredAnnotations', function () {
if (this.declaredAnnotations == null ) {
this.declaredAnnotations=$I$(3).parseAnnotations$S$Class$Z(this.signature, this.getDeclaringClass$(), true);
}return this.declaredAnnotations;
}, p$1);

Clazz.newMeth(C$, '_setJSMethod$O', function (o) {
this.$meth$=o;
