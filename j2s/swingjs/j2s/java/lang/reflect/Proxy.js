(function(){var P$=java.lang.reflect,I$=[[0,'java.lang.reflect.InvocationHandler','java.util.HashMap','java.util.Collections','java.util.HashSet','java.util.Arrays','InternalError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.loaderToCache=Clazz.new_(1,{K:"ClassLoader",V:"java.util.Map"},$I$(2,1));
C$.nextUniqueNumber=0;
C$.nextUniqueNumberLock= Clazz.new_();
C$.proxyClasses=$I$(3).synchronizedMap$java_util_Map(Clazz.new_(1,{K:"Class",V:"String"},$I$(2,1)));
}
...
,['L',['nextUniqueNumber'],'O',['constructorParams','Class[]','loaderToCache','java.util.Map','nextUniqueNumberLock','java.lang.Object','proxyClasses','java.util.Map']]]
...
var interfaceSet=Clazz.new_(1,{E:"Class"},$I$(4,1));
...
if (cache == null ) {
cache=Clazz.new_(1,{K:"java.lang.Object",V:"java.lang.Object"},$I$(2,1));
...
var e = e$$;
{
throw Clazz.new_($I$(6,1).c$$S,[e.toString()]);
}
...
C$.setJSPrototype$Class$reflect_Method$Z(cl, methods[j], interfaces[i].isAnnotation$());
}
...
Clazz.newMeth(C$, 'setJSPrototype$Class$reflect_Method$Z', function (cl, m, add$) {
var mname=m.getName$();
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:49:36 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
