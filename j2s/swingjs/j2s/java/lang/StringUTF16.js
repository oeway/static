(function(){var P$=java.lang,I$=[[0,'OutOfMemoryError','StringLatin1','String9','ConditionalSpecialCasing','java.util.Arrays']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
throw Clazz.new_($I$(1,1).c$$S,["UTF16 String size is " + len + ", should be less than " + 1073741823 ]);
