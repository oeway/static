(function(){var P$=java.lang,I$=[[0,'java.io.ObjectStreamField',['String','.CaseInsensitiveComparator'],'java.util.Arrays','StringCoding','java.util.regex.Pattern','java.util.regex.Matcher','ConditionalSpecialCasing','java.util.Locale','java.util.Formatter']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['offset','count','hash'],'O',['value','char[]']]
...
return Clazz.new_($I$(9,1)).format$S$OA(format, args).toString();
}, 1);

Clazz.newMeth(C$, 'format$java_util_Locale$S$OA', function (l, format, args) {
return Clazz.new_($I$(9,1).c$$java_util_Locale,[l]).format$S$OA(format, args).toString();
}, 1);
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:49:34 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
