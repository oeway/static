(function(){var P$=java.lang,p$1={},I$=[[0,'swingjs.JSThreadGroup','swingjs.JSUtil','ThreadLocal','ThreadGroup','swingjs.JSToolkit','ThreadDeath','NoSuchMethodError','java.util.HashMap',['Thread','.State']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['daemon','stopBeforeStart','started','interrupted','stopped'],'I',['priority','threadStatus'],'L',['tid'],'S',['name'],'O',['target','Runnable','group','ThreadGroup','threadLocals','ThreadLocal.ThreadLocalMap','+inheritableThreadLocals','parkBlocker','java.lang.Object','throwableFromStop','Throwable','me','Thread','uncaughtExceptionHandler','Thread.UncaughtExceptionHandler']]
,['I',['threadInitNumber'],'L',['threadSeqNumber'],'O',['秘thisThread','javajs.util.JSThread','defaultUncaughtExceptionHandler','Thread.UncaughtExceptionHandler']]]
...
var m=Clazz.new_(1,{K:"Thread",V:"StackTraceElement[]"},$I$(8,1).c$$I,[threads.length]);
