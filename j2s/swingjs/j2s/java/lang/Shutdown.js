(function(){var P$=java.lang,I$=[[0,'InternalError','java.util.Hashtable','Thread']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.groupHooks=Clazz.new_(1,{K:"ThreadGroup",V:"Runnable[]"},$I$(2,1));
}var g=$I$(3).currentThread$().getThreadGroup$();
var hooks=C$.groupHooks.get$O(g);
if (hooks == null ) {
if (!andCreate) return null;
C$.groupHooks.put$TK$TV(g, hooks=Clazz.array(Runnable, [10]));
}return hooks;
}, 1);
