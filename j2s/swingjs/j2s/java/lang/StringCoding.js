...
if (cs != null ) sd=Clazz.new_($I$(8,1).c$$java_nio_charset_Charset$S,[cs, csn]);
} catch (x) {
...
try {
var cs=C$.lookupCharset$S(csn);
if (cs != null ) se=Clazz.new_($I$(9,1).c$$java_nio_charset_Charset$S,[cs, csn]);
} catch (x) {
if (Clazz.exceptionOf(x,"java.nio.charset.IllegalCharsetNameException")){
} else {
throw x;
