(function(){var P$=java.lang,I$=[[0,'Shutdown','java.util.IdentityHashMap']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.hooks=Clazz.new_(1,{K:"Thread",V:"Thread"},$I$(2,1));
} catch (e) {
