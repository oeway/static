(function(){var P$=java.lang,p$1={},p$2={},I$=[[0,'java.util.Objects',['ThreadLocal','.ThreadLocalMap','.Entry'],'java.util.concurrent.atomic.AtomicInteger',['ThreadLocal','.SuppliedThreadLocal'],'Thread',['ThreadLocal','.ThreadLocalMap']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_(1,{T:"Object"},$I$(4,1).c$$java_util_function_Supplier,[supplier]);
}, 1);
...
if (map != null ) p$1.set$ThreadLocal$O.apply(map, [this, value]);
 else this.createMap$Thread$TT(t, value);
return value;
}, p$2);
...
Clazz.super_(C$, this);
this.supplier=$I$(1).requireNonNull$TT(supplier);
}, 1);
...
var key=e.get$();
if (key != null ) {
var value=key.childValue$TT(e.value);
...
;C$.superclazz.c$$TT.apply(this,[k]);C$.$init$.apply(this);
this.value=v;
}, 1);
