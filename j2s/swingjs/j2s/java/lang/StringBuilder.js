...
/*c*/var C$=Clazz.newClass(P$, "StringBuilder", null, 'AbstractStringBuilder', ['Appendable', 'CharSequence', 'java.io.Serializable']);
...
;C$.superclazz.c$$S.apply(this,[seq.toString()]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$S', function (str) {
;C$.superclazz.c$$S.apply(this,[str]);C$.$init$.apply(this);
}, 1);
