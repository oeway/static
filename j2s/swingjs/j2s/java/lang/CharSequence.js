(function(){var P$=java.lang,I$=[[0,'java.util.stream.StreamSupport','java.util.Spliterators']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*i*/var C$=Clazz.newInterface(P$, "CharSequence");
C$.$defaults$ = function(C$){

Clazz.newMeth(C$, 'chars$', function () {
return $I$(1).intStream$java_util_function_Supplier$I$Z((CharSequence$lambda1$||(CharSequence$lambda1$=(((P$.CharSequence$lambda1||
...
), Clazz.new_(1,{T:"? extends java.util.Spliterator.OfInt"},CharSequence$lambda1.$init$, [this, null]))))), 16464, false);
});
...
), Clazz.new_(1,{T:"? extends java.util.Spliterator.OfInt"},CharSequence$lambda2.$init$, [this, null]))))), 16, false);
});
};;
