(function(){var P$=Clazz.newPackage("org.json"),p$1={},I$=[[0,'org.json.JSONObject','org.json.JSONArray']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
