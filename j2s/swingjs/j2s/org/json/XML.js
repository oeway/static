(function(){var P$=Clazz.newPackage("org.json"),I$=[[0,'StringBuilder','org.json.XMLTokener','org.json.JSONObject','Boolean','java.io.StringReader','org.json.JSONArray']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var sb=Clazz.new_($I$(1,1).c$$I,[string.length$()]);
...
return C$.toJSONObject$java_io_Reader$Z(Clazz.new_($I$(5,1).c$$S,[string]), keepStrings);
}, 1);
...
value=Clazz.new_($I$(6,1).c$$O,[value]);
...
ja=Clazz.new_($I$(6,1).c$$O,[object]);
} else {
ja=object;
}var jaLength=ja.length$();
for (var i=0; i < jaLength; i++) {
