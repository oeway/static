(function(){var P$=Clazz.newPackage("org.json"),p$1={},I$=[[0,'java.util.ArrayList','org.json.JSONPointer',['org.json.JSONPointer','.Builder'],'java.util.Collections','java.net.URLDecoder','StringBuilder','java.net.URLEncoder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}this.refTokens=Clazz.new_(1,{E:"String"},$I$(1,1));
var slashIdx=-1;
var prevSlashIdx=0;
do {
...
;C$.$init$.apply(this);
this.refTokens=Clazz.new_(1,{E:"String"},$I$(1,1).c$$java_util_Collection,[refTokens]);
}, 1);
