...
this.map=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(2,1).c$$I,[m.size$()]);
...
;C$.$init$.apply(this);
this.map=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(2,1).c$$I,[initialCapacity]);
}, 1);
...
var object=this.get$S(key);
try {
return Clazz.new_($I$(8,1).c$$S,[object.toString()]);
} catch (e) {
...
return Clazz.new_($I$(9,1).c$$S,[object.toString()]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
...
if (this.map.isEmpty$()) {
return null;
}return Clazz.new_($I$(6,1).c$$java_util_Collection,[this.map.keySet$()]);
});
...
return Clazz.new_($I$(9,1).c$$java_math_BigInteger,[val]);
}if (Clazz.instanceOf(val, "java.lang.Double") || Clazz.instanceOf(val, "java.lang.Float") ) {
return Clazz.new_($I$(9,1).c$$D,[(val).doubleValue$()]);
...
return Clazz.new_($I$(9,1).c$$J,[(val).longValue$()]);
}try {
return Clazz.new_($I$(9,1).c$$S,[val.toString()]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return defaultValue;
} else {
...
return Clazz.new_($I$(9,1).c$$D,[(val).doubleValue$()]).toBigInteger$();
}if (Clazz.instanceOf(val, "java.lang.Long") || Clazz.instanceOf(val, "java.lang.Integer") || Clazz.instanceOf(val, "java.lang.Short") || Clazz.instanceOf(val, "java.lang.Byte")  ) {
return $I$(8).valueOf$J((val).longValue$());
}try {
var valStr=val.toString();
if (C$.isDecimalNotation$S(valStr)) {
return Clazz.new_($I$(9,1).c$$S,[valStr]).toBigInteger$();
}return Clazz.new_($I$(8,1).c$$S,[valStr]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return defaultValue;
} else {
...
try {
return Clazz.new_($I$(9,1).c$$S,[val]).intValue$();
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return defaultValue;
} else {
...
try {
return Clazz.new_($I$(9,1).c$$S,[val]).longValue$();
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return defaultValue;
} else {
...
if ($I$(11).isPublic$I(modifiers) && !$I$(11).isStatic$I(modifiers) && method.getParameterTypes$().length == 0   && !method.isBridge$()  && p$1.isValidMethodName$S.apply(this, [method.getName$()]) ) {
...
key=key.toLowerCase$java_util_Locale($I$(12).ROOT);
} else if (!Character.isUpperCase$C(key.charAt$I(1))) {
key=key.substring$I$I(0, 1).toLowerCase$java_util_Locale($I$(12).ROOT) + key.substring$I(1);
...
return this.query$org_json_JSONPointer(Clazz.new_($I$(13,1).c$$S,[jsonPointer]));
});
...
return this.optQuery$org_json_JSONPointer(Clazz.new_($I$(13,1).c$$S,[jsonPointer]));
});
...
var d;
return (val.length$() <= 14 && !(d=Double.valueOf$S(val)).isInfinite$()  && !d.isNaN$()  ? d : Clazz.new_($I$(9,1).c$$S,[val]));
}var n=(1 ? parseInt(val) :0);
if (n >= -2147483648 && n <= 2147483647 ) {
return Integer.valueOf$S(val);
}if (val.equals$O("" + n)) {
return Long.valueOf$S(val);
}return Clazz.new_($I$(8,1).c$$S,[val]);
...
return $I$(15).valueToString$O(value);
}, 1);
...
writer.write$S($I$(15).valueToString$O(value));
}return writer;
}, 1);
...
var results=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(2,1));
for (var entry, $entry = this.entrySet$().iterator$(); $entry.hasNext$()&&((entry=($entry.next$())),1);) {
var value;
