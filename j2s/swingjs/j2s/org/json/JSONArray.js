(function(){var P$=Clazz.newPackage("org.json"),I$=[[0,'java.util.ArrayList','org.json.JSONObject','org.json.JSONTokener','java.lang.reflect.Array','Boolean','java.math.BigDecimal','java.math.BigInteger','StringBuilder','Enum','org.json.JSONPointer','java.io.StringWriter']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
;C$.$init$.apply(this);
this.myArrayList=Clazz.new_(1,{E:"java.lang.Object"},$I$(1,1));
}, 1);
...
this.myArrayList=Clazz.new_(1,{E:"java.lang.Object"},$I$(1,1).c$$I,[collection.size$()]);
...
var object=this.get$I(index);
try {
return Clazz.new_($I$(6,1).c$$S,[object.toString()]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
...
var object=this.get$I(index);
try {
return Clazz.new_($I$(7,1).c$$S,[object.toString()]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
...
try {
return Clazz.new_($I$(6,1).c$$S,[val.toString()]).intValue$();
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return defaultValue;
} else {
...
return Clazz.new_($I$(6,1).c$$D,[(val).doubleValue$()]).toBigInteger$();
...
return Clazz.new_($I$(6,1).c$$S,[valStr]).toBigInteger$();
...
return Clazz.new_($I$(6,1).c$$java_math_BigInteger,[val]);
}if (Clazz.instanceOf(val, "java.lang.Double") || Clazz.instanceOf(val, "java.lang.Float") ) {
return Clazz.new_($I$(6,1).c$$D,[(val).doubleValue$()]);
}if (Clazz.instanceOf(val, "java.lang.Long") || Clazz.instanceOf(val, "java.lang.Integer") || Clazz.instanceOf(val, "java.lang.Short") || Clazz.instanceOf(val, "java.lang.Byte")  ) {
return Clazz.new_($I$(6,1).c$$J,[(val).longValue$()]);
}try {
return Clazz.new_($I$(6,1).c$$S,[val.toString()]);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return defaultValue;
} else {
...
try {
return Clazz.new_($I$(6,1).c$$S,[val.toString()]).longValue$();
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return defaultValue;
} else {
...
return this.query$org_json_JSONPointer(Clazz.new_($I$(10,1).c$$S,[jsonPointer]));
});
...
return this.optQuery$org_json_JSONPointer(Clazz.new_($I$(10,1).c$$S,[jsonPointer]));
});
...
return null;
}var jo=Clazz.new_($I$(2,1).c$$I,[names.length$()]);
...
var results=Clazz.new_(1,{E:"java.lang.Object"},$I$(1,1).c$$I,[this.myArrayList.size$()]);
