(function(){var P$=Clazz.newPackage("org.json.simple"),I$=[[0,'java.util.ArrayList','java.util.StringTokenizer','StringBuffer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
