(function(){var P$=Clazz.newPackage("org.json"),I$=[[0,'java.util.HashMap','org.json.XML','StringBuilder','Boolean']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
{
C$.entity=Clazz.new_(1,{K:"String",V:"Character"},$I$(1,1).c$$I,[8]);
