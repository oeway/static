(function(){var P$=Clazz.newPackage("org.apache.logging.log4j.message"),I$=[[0,'org.apache.logging.log4j.message.FormattedMessage']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "FormattedMessageFactory", null, 'org.apache.logging.log4j.message.AbstractMessageFactory');
...
return Clazz.new_($I$(1,1).c$$S$O,[message, p0]);
});

Clazz.newMeth(C$, 'newMessage$S$O$O', function (message, p0, p1) {
return Clazz.new_($I$(1,1).c$$S$O$O,[message, p0, p1]);
});
