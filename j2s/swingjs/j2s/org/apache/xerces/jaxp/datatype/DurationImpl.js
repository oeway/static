...
buf=Clazz.new_($I$(8,1).c$$I,[3 - insertionPoint + intString.length$()]);
buf.append$S("0.");
...
}return Clazz.new_($I$(3,1).c$$java_math_BigInteger,[value.negate$()]);
}, 1);
...
return Clazz.new_($I$(9,1).c$$S,[this.toString()]);
}, p$1);
