...
C$.PURE_GREGORIAN_CHANGE=Clazz.new_($I$(4,1).c$$J,[-9223372036854775808]);
...
minutes=-minutes;
var d=Clazz.new_($I$(6,1).c$$Z$I$I$I$I$I$I,[minutes >= 0, 0, 0, 0, 0, minutes < 0 ? -minutes : minutes, 0]);
...
var carry=Clazz.new_($I$(3,1).c$$java_math_BigInteger,[temp.subtract$java_math_BigInteger($I$(2).ONE)]).divide$java_math_BigDecimal$I(Clazz.new_($I$(3,1).c$$java_math_BigInteger,[C$.TWELVE]), 3).toBigInteger$();
...
var fQuotient=Clazz.new_($I$(3,1).c$$java_math_BigInteger,[Clazz.new_($I$(3,1).c$$java_math_BigInteger,[tempBD.toBigInteger$()]).divide$java_math_BigDecimal$I(C$.DECIMAL_SIXTY, 3).toBigInteger$()]);
...
var tempFracSeconds=endSeconds.subtract$java_math_BigDecimal(Clazz.new_($I$(3,1).c$$java_math_BigInteger,[$I$(2).valueOf$J(this.getSecond$())]));
...
carry=Clazz.new_($I$(3,1).c$$java_math_BigInteger,[temp]).divide$java_math_BigDecimal$I(C$.DECIMAL_SIXTY, 3).toBigInteger$();
...
carry=Clazz.new_($I$(3,1).c$$java_math_BigInteger,[temp]).divide$java_math_BigDecimal$I(Clazz.new_($I$(3,1).c$$java_math_BigInteger,[C$.TWENTY_FOUR]), 3).toBigInteger$();
var tempDays;
...
quotient=$I$(3).valueOf$J(intTemp - 1).divide$java_math_BigDecimal$I(Clazz.new_($I$(3,1).c$$java_math_BigInteger,[C$.TWELVE]), 0).intValue$();
} else {
...
buf=Clazz.new_($I$(12,1).c$$I,[3 - insertionPoint + intString.length$()]);
buf.append$S("0.");
...
return Clazz.new_($I$(13,1).c$$S,[this.toXMLFormat$()]);
}, p$2);
;
...
this.this$0.setYear$java_math_BigInteger.apply(this.this$0, [Clazz.new_($I$(2,1).c$$S,[yearString])]);
}}, p$1);
...
return Clazz.new_($I$(3,1).c$$S,[this.value.substring$I$I(vstart, this.vidx)]);
}, p$1);
