(function(){var P$=Clazz.newPackage("org.apache.xerces.jaxp.datatype"),I$=[[0,'org.apache.xerces.jaxp.datatype.DurationImpl','org.apache.xerces.jaxp.datatype.XMLGregorianCalendarImpl']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
