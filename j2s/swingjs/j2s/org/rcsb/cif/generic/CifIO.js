(function(){var P$=Clazz.newPackage("org.rcsb.cif.generic"),I$=[[0,'org.rcsb.cif.CifOptions','java.net.URL','java.nio.file.Files','java.io.BufferedInputStream',['org.rcsb.cif.CifOptions','.CifOptionsBuilder','.FileFormat'],'java.util.zip.GZIPInputStream','org.rcsb.cif.generic.BinaryCifReader','org.rcsb.cif.text.TextCifReader','org.rcsb.cif.generic.BinaryCifWriter','java.util.zip.GZIPOutputStream','java.io.ByteArrayOutputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
Clazz.newMeth(C$, 'writeBinary$org_rcsb_cif_generic_CifFile$java_nio_file_Path', function (cifFile, outputFile) {
C$.writeBinary$org_rcsb_cif_generic_CifFile$java_nio_file_Path$org_rcsb_cif_CifOptions(cifFile, outputFile, C$.DEFAULT_OPTIONS);
}, 1);

Clazz.newMeth(C$, 'writeBinary$org_rcsb_cif_generic_CifFile$java_nio_file_Path$org_rcsb_cif_CifOptions', function (cifFile, outputFile, options) {
$I$(3).write$java_nio_file_Path$BA$java_nio_file_OpenOptionA(outputFile, C$.writeBinary$org_rcsb_cif_generic_CifFile$org_rcsb_cif_CifOptions(cifFile, options), []);
}, 1);

Clazz.newMeth(C$, 'writeBinary$org_rcsb_cif_generic_CifFile', function (cifFile) {
return C$.writeBinary$org_rcsb_cif_generic_CifFile$org_rcsb_cif_CifOptions(cifFile, C$.DEFAULT_OPTIONS);
}, 1);

Clazz.newMeth(C$, 'writeBinary$org_rcsb_cif_generic_CifFile$org_rcsb_cif_CifOptions', function (cifFile, options) {
var raw=Clazz.new_($I$(9,1).c$$org_rcsb_cif_CifOptions,[options]).write$org_rcsb_cif_generic_CifFile(cifFile);
return options.isGzip$() ? C$.compress$BA(raw) : raw;
}, 1);

Clazz.newMeth(C$, 'writeText$org_rcsb_cif_generic_CifFile$java_nio_file_Path', function (cifFile, outputFile) {
C$.writeText$org_rcsb_cif_generic_CifFile$java_nio_file_Path$org_rcsb_cif_CifOptions(cifFile, outputFile, C$.DEFAULT_OPTIONS);
}, 1);

Clazz.newMeth(C$, 'writeText$org_rcsb_cif_generic_CifFile$java_nio_file_Path$org_rcsb_cif_CifOptions', function (cifFile, outputFile, options) {
$I$(3).write$java_nio_file_Path$BA$java_nio_file_OpenOptionA(outputFile, C$.writeText$org_rcsb_cif_generic_CifFile$org_rcsb_cif_CifOptions(cifFile, options), []);
}, 1);

Clazz.newMeth(C$, 'writeText$org_rcsb_cif_generic_CifFile', function (cifFile) {
return C$.writeText$org_rcsb_cif_generic_CifFile$org_rcsb_cif_CifOptions(cifFile, C$.DEFAULT_OPTIONS);
}, 1);

Clazz.newMeth(C$, 'writeText$org_rcsb_cif_generic_CifFile$org_rcsb_cif_CifOptions', function (cifFile, options) {
var raw;
return options.isGzip$() ? C$.compress$BA(raw) : raw;
}, 1);
...
var output;
try {
var byteStream=Clazz.new_($I$(11,1).c$$I,[bytes.length]);
/*try*/ {
try {
var zipStream=Clazz.new_($I$(10,1).c$$java_io_OutputStream,[byteStream]);
/*try*/ {
