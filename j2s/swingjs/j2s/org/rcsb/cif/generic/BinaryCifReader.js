(function(){var P$=Clazz.newPackage("org.rcsb.cif.generic"),p$1={},I$=[[0,'org.rcsb.cif.binary.codec.Codec','org.rcsb.cif.model.ProxyCategory','java.util.stream.Stream','org.rcsb.cif.Platform','org.rcsb.cif.generic.BaseBlock','java.util.Collections','java.util.stream.Collectors','org.rcsb.cif.generic.BinaryFile']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var name=($I$(1).getStringFromBytes$BA(encodedCategory.get$O("name")).substring$I(1));
var rawColumns=encodedCategory.get$O("columns");
var rowCount=((encodedCategory.get$O("rowCount")).objectValue$()|0);
var encodedFields=rawColumns;
return Clazz.new_($I$(2,1).c$$S$I$OA$Z,[name, rowCount, encodedFields, true]);
}, p$1);
...
var dataBlocks=$I$(3).of$TTA((unpacked.get$O("dataBlocks"))).map$java_util_function_Function(/*addLambdaReuse org.rcsb.cif.generic.BinaryCifReader$lambda1*/(P$.BinaryCifReader$lambda1$||(P$.BinaryCifReader$lambda1$=(((P$.BinaryCifReader$lambda1||
...
var categories=$I$(4).getMap$();
try {
for (var o, $o = 0, $$o = map.get$O("categories"); $o<$$o.length&&((o=($$o[$o])),1);$o++) {
var cat=o;
var name=$I$(1).getStringFromBytes$BA(cat.get$O("name"));
categories.put$TK$TV(name.substring$I(1), p$1.createProxyCategory$java_util_Map.apply(this.b$['org.rcsb.cif.generic.BinaryCifReader'], [cat]));
}
return Clazz.new_($I$(5,1).c$$java_util_Map$S,[categories, header]);
} catch (e) {
if (Clazz.exceptionOf(e,"NullPointerException")){
return Clazz.new_($I$(5,1).c$$java_util_Map$S,[$I$(6).emptyMap$(), header]);
} else {
throw e;
}
}
...
), Clazz.new_(P$.BinaryCifReader$lambda1.$init$, [this, null])))))).collect$java_util_stream_Collector($I$(7).toList$());
return Clazz.new_($I$(8,1).c$$java_util_List$S$S,[dataBlocks, versionString, encoder]);
});
