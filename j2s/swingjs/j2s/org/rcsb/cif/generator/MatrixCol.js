...
/*c*/var C$=Clazz.newClass(P$, "MatrixCol", null, 'org.rcsb.cif.generator.Col');
...
Clazz.newMeth(C$, 'c$$S', function (description) {
;C$.superclazz.c$$S$S.apply(this, ["matrix", description]);C$.$init$.apply(this);
}, 1);
