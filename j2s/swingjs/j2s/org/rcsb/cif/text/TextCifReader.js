(function(){var P$=Clazz.newPackage("org.rcsb.cif.text"),I$=[[0,'java.io.BufferedReader','java.io.InputStreamReader','java.util.stream.Collectors','java.util.ArrayList','org.rcsb.cif.api.TextFile','org.rcsb.cif.text.TokenizerState','org.rcsb.cif.api.BaseBlock','org.rcsb.cif.model.ModelFactory']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(5,1).c$$java_util_List,[Clazz.new_($I$(6,1).c$$org_rcsb_cif_text_TextReader$S,[this, data]).getDataBlocks$java_util_List(dataBlocks)]);
});

Clazz.newMeth(C$, 'createBlock$java_util_Map$S', function (categories, name) {
return Clazz.new_($I$(7,1).c$$java_util_Map$S,[categories, name]);
});
...
return $I$(8).createCategoryText$S$java_util_Map(name, columns);
});
