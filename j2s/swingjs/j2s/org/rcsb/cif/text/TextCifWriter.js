(function(){var P$=Clazz.newPackage("org.rcsb.cif.text"),p$1={},I$=[[0,'java.util.stream.IntStream','java.util.stream.Collectors','StringBuilder','org.rcsb.cif.model.Column','org.rcsb.cif.model.ValueKind']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.PADDING_SPACES=$I$(1).range$I$I(0, 80).mapToObj$java_util_function_IntFunction(/*addLambdaReuse org.rcsb.cif.text.TextCifWriter$lambda1*/(P$.TextCifWriter$lambda1$||(P$.TextCifWriter$lambda1$=((function($$){((P$.TextCifWriter$lambda1||
...
/*lambda_M*/
Clazz.newMeth(C$, 'apply$', function (t) { return /*addmeth isclasstarget true classIsTarget=true ivarbinding=false exp=org.eclipse.jdt.core.dom.SimpleName org.rcsb.cif.text.TextCifWriter*/$$.whitespaceString$I.apply(null,[t])});
})()
...
Clazz.newMeth(C$, 'write$org_rcsb_cif_api_CifFile', function (cifFile) {
...
if (rowCount == 0) {
continue;
}var columns=cifCategory.getColumnNamesEncoded$().stream$().filter$java_util_function_Predicate(((P$.TextCifWriter$lambda2||
(function(){/*m*/var C$=Clazz.newClass(P$, "TextCifWriter$lambda2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Predicate', 1);
...
/*lambda_E*/
Clazz.newMeth(C$, 'test$', function (columnName) { return (this.b$['org.rcsb.cif.text.TextCifWriter'].options.filterColumn$S$S(this.$finals$.categoryName, columnName));});
})()
), Clazz.new_(P$.TextCifWriter$lambda2.$init$, [this, {categoryName:categoryName}]))).map$java_util_function_Function((function($$){((P$.TextCifWriter$lambda3||
(function(){/*m*/var C$=Clazz.newClass(P$, "TextCifWriter$lambda3", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
/*lambda_M*/
Clazz.newMeth(C$, 'apply$', function (t) { return /*addmeth isclasstarget false classIsTarget=true ivarbinding=true exp=org.eclipse.jdt.core.dom.SimpleName org.rcsb.cif.model.Category*/$$.getColumn$S.apply($$,[t])});
})()
)); return Clazz.new_(P$.TextCifWriter$lambda3.$init$, [this, null])})(cifCategory)).collect$java_util_stream_Collector($I$(2).toList$());
if (columns.isEmpty$()) {
continue;
}if (rowCount == 1) {
...
var width=columns.stream$().map$java_util_function_Function((function($$){((P$.TextCifWriter$lambda4||
(function(){/*m*/var C$=Clazz.newClass(P$, "TextCifWriter$lambda4", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
)); return Clazz.new_(P$.TextCifWriter$lambda4.$init$, [this, null])})($I$(4))).mapToInt$java_util_function_ToIntFunction((function($$){((P$.TextCifWriter$lambda5||
(function(){/*m*/var C$=Clazz.newClass(P$, "TextCifWriter$lambda5", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.ToIntFunction', 1);
...
)); return Clazz.new_(P$.TextCifWriter$lambda5.$init$, [this, null])})(String)).max$().orElseThrow$java_util_function_Supplier(/*addLambdaReuse org.rcsb.cif.text.TextCifWriter$lambda6*/(P$.TextCifWriter$lambda6$||(P$.TextCifWriter$lambda6$=(((P$.TextCifWriter$lambda6||
(function(){/*m*/var C$=Clazz.newClass(P$, "TextCifWriter$lambda6", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Supplier', 1);
...
), Clazz.new_(P$.TextCifWriter$lambda6.$init$, [this, null])))))) + 6 + cifCategory.getCategoryName$().length$() ;
...
for (var cifField, $cifField = columns.iterator$(); $cifField.hasNext$()&&((cifField=($cifField.next$())),1);) {
output.append$S("_").append$S(cifCategory.getCategoryName$()).append$S(".").append$S(cifField.getColumnName$()).append$S("\n");
}
for (var row=0; row < columns.get$I(0).getRowCount$(); row++) {
var multiline=false;
for (var cifField, $cifField = columns.iterator$(); $cifField.hasNext$()&&((cifField=($cifField.next$())),1);) {
...
return $I$(1).range$I$I(0, width).mapToObj$java_util_function_IntFunction(/*addLambdaReuse org.rcsb.cif.text.TextCifWriter$lambda7*/(P$.TextCifWriter$lambda7$||(P$.TextCifWriter$lambda7$=(((P$.TextCifWriter$lambda7||
(function(){/*m*/var C$=Clazz.newClass(P$, "TextCifWriter$lambda7", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.IntFunction', 1);
...
), Clazz.new_(P$.TextCifWriter$lambda7.$init$, [this, null])))))).collect$java_util_stream_Collector($I$(2).joining$());
}, 1);

Clazz.newMeth(C$, 'getPaddingSpaces$I', function (width) {
try {
return C$.PADDING_SPACES.get$I(width);
} catch (e) {
if (Clazz.exceptionOf(e,"ArrayIndexOutOfBoundsException")){
return C$.whitespaceString$I(width);
} else {
throw e;
}
}
