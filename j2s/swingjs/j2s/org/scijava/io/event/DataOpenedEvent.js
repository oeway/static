...
/*c*/var C$=Clazz.newClass(P$, "DataOpenedEvent", null, 'org.scijava.io.event.IOEvent');
...
Clazz.newMeth(C$, 'c$$S$O', function (source, data) {
;C$.superclazz.c$$S$O.apply(this,[source, data]);C$.$init$.apply(this);
}, 1);
