...
/*c*/var C$=Clazz.newClass(P$, "DoubleColumn", null, 'org.scijava.util.DoubleArray', 'org.scijava.table.PrimitiveColumn');
...
Clazz.newMeth(C$, ['fill$DA','fill$TArrayType'], function (values) {
this.setArray$DA(values);
this.setSize$I(values.length);
});

Clazz.newMeth(C$, ['fill$DA$I','fill$TArrayType$I'], function (values, offset) {
if (this.getArray$() == null ) this.setArray$DA(values);
 else {
