...
/*i*/var C$=Clazz.newInterface(P$, "ShortTable", null, null, 'org.scijava.table.Table');
...
Clazz.newMeth(C$, 'setValue$I$I$H', function (col, row, value) {
this.get$I(col).setValue$I$H(row, value);
});
};})();
