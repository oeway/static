...
/*i*/var C$=Clazz.newInterface(P$, "DoubleTable", null, null, 'org.scijava.table.Table');
...
Clazz.newMeth(C$, 'setValue$I$I$D', function (col, row, value) {
this.get$I(col).setValue$I$D(row, value);
});
};})();
