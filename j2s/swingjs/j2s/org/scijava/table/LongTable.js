...
/*i*/var C$=Clazz.newInterface(P$, "LongTable", null, null, 'org.scijava.table.Table');
...
Clazz.newMeth(C$, 'setValue$I$I$J', function (col, row, value) {
this.get$I(col).setValue$I$J(row, value);
});
};})();
