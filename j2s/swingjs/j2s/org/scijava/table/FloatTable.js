...
/*i*/var C$=Clazz.newInterface(P$, "FloatTable", null, null, 'org.scijava.table.Table');
...
Clazz.newMeth(C$, 'setValue$I$I$F', function (col, row, value) {
this.get$I(col).setValue$I$F(row, value);
});
};})();
