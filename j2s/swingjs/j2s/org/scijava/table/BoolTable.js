...
/*i*/var C$=Clazz.newInterface(P$, "BoolTable", null, null, 'org.scijava.table.Table');
...
Clazz.newMeth(C$, 'setValue$I$I$Z', function (col, row, value) {
this.get$I(col).setValue$I$Z(row, value);
});
};})();
