(function(){var P$=Clazz.newPackage("org.scijava.util"),p$1={},I$=[[0,'Thread','java.util.HashMap','java.util.LinkedHashSet','java.util.concurrent.Executors','java.util.TreeSet','java.util.LinkedHashMap','java.util.concurrent.TimeUnit',['org.scijava.util.MirrorWebsite','.MirrorJob'],'java.net.URL','java.io.File','java.util.ArrayList','StringBuffer','java.util.Collections','java.io.FileInputStream','java.io.FileOutputStream','java.io.ByteArrayInputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.jobs=Clazz.new_(1,{K:"String",V:"org.scijava.util.MirrorWebsite.MirrorJob"},$I$(6,1));
