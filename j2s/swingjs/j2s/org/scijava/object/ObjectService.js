(function(){var P$=Clazz.newPackage("org.scijava.object"),I$=[[0,'org.scijava.event.EventService']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*i*/var C$=Clazz.newInterface(P$, "ObjectService", null, null, 'org.scijava.service.SciJavaService');
