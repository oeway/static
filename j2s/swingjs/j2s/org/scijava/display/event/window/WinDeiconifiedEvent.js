...
/*c*/var C$=Clazz.newClass(P$, "WinDeiconifiedEvent", null, 'org.scijava.display.event.window.WinEvent');
...
;C$.superclazz.c$$org_scijava_display_Display$O.apply(this,[display, window]);C$.$init$.apply(this);
}, 1);
