...
/*c*/var C$=Clazz.newClass(P$, "MsReleasedEvent", null, 'org.scijava.display.event.input.MsButtonEvent');
...
;C$.superclazz.c$$org_scijava_display_Display$org_scijava_input_InputModifiers$I$I$I$I$Z.apply(this,[display, modifiers, x, y, button, numClicks, isPopupTrigger]);C$.$init$.apply(this);
}, 1);
