...
/*c*/var C$=Clazz.newClass(P$, "AppMenusCreatedEvent", null, 'org.scijava.platform.event.ApplicationEvent');
...
C$.$fields$=[['O',['menus','java.lang.Object']]]

Clazz.newMeth(C$, 'c$$O', function (menus) {
Clazz.super_(C$, this);
this.menus=menus;
}, 1);

Clazz.newMeth(C$, 'getMenus$', function () {
return this.menus;
});
