...
/*e*/var C$=Clazz.newClass(P$, "ItemVisibility", null, 'Enum');
...
Clazz.newEnumConst($vals, C$.c$, "TRANSIENT", 1, []);
Clazz.newEnumConst($vals, C$.c$, "INVISIBLE", 2, []);
Clazz.newEnumConst($vals, C$.c$, "MESSAGE", 3, []);
}
