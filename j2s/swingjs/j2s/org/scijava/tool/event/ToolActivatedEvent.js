...
/*c*/var C$=Clazz.newClass(P$, "ToolActivatedEvent", null, 'org.scijava.tool.event.ToolEvent');
...
;C$.superclazz.c$$org_scijava_tool_Tool.apply(this,[tool]);C$.$init$.apply(this);
}, 1);
