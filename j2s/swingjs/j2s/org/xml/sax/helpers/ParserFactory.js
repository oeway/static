(function(){var P$=Clazz.newPackage("org.xml.sax.helpers"),I$=[[0,'org.xml.sax.helpers.NewInstance']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
