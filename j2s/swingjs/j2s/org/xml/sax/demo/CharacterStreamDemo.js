(function(){var P$=Clazz.newPackage("org.xml.sax.demo"),I$=[[0,'org.xml.sax.helpers.ParserFactory','org.xml.sax.demo.DemoHandler','java.io.StringReader','org.xml.sax.InputSource']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
