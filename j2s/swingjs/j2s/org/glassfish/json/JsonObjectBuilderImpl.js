(function(){var P$=Clazz.newPackage("org.glassfish.json"),p$1={},I$=[[0,'javax.json.JsonValue',['javax.json.JsonValue','.ValueType'],'java.io.StringWriter','org.glassfish.json.JsonWriterImpl','java.util.LinkedHashMap','org.glassfish.json.JsonStringImpl','org.glassfish.json.JsonNumberImpl',['org.glassfish.json.JsonObjectBuilderImpl','.JsonObjectImpl'],'java.util.Collections']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
;C$.$init$.apply(this);
this.valueMap=Clazz.new_(1,{K:"String",V:"javax.json.JsonValue"},$I$(5,1));
}, 1);
...
this.valueMap.put$TK$TV(name, value);
return this;
});
...
p$1.validateName$S.apply(this, [name]);
p$1.validateValue$O.apply(this, [value]);
this.valueMap.put$TK$TV(name, Clazz.new_($I$(6,1).c$$S,[value]));
return this;
});
...
p$1.validateName$S.apply(this, [name]);
p$1.validateValue$O.apply(this, [value]);
this.valueMap.put$TK$TV(name, Clazz.new_($I$(7,1).c$$java_math_BigInteger,[value]));
return this;
});
...
p$1.validateName$S.apply(this, [name]);
p$1.validateValue$O.apply(this, [value]);
this.valueMap.put$TK$TV(name, Clazz.new_($I$(7,1).c$$java_math_BigDecimal,[value]));
return this;
});

Clazz.newMeth(C$, 'add$S$I', function (name, value) {
p$1.validateName$S.apply(this, [name]);
this.valueMap.put$TK$TV(name, Clazz.new_($I$(7,1).c$$I,[value]));
return this;
});

Clazz.newMeth(C$, 'add$S$J', function (name, value) {
p$1.validateName$S.apply(this, [name]);
this.valueMap.put$TK$TV(name, Clazz.new_($I$(7,1).c$$J,[value]));
return this;
});

Clazz.newMeth(C$, 'add$S$D', function (name, value) {
p$1.validateName$S.apply(this, [name]);
this.valueMap.put$TK$TV(name, Clazz.new_($I$(7,1).c$$D,[value]));
return this;
});

Clazz.newMeth(C$, 'add$S$Z', function (name, value) {
p$1.validateName$S.apply(this, [name]);
this.valueMap.put$TK$TV(name, value ? $I$(1).TRUE : $I$(1).FALSE);
return this;
});

Clazz.newMeth(C$, 'addNull$S', function (name) {
p$1.validateName$S.apply(this, [name]);
this.valueMap.put$TK$TV(name, $I$(1).NULL);
return this;
});
...
}this.valueMap.put$TK$TV(name, builder.build$());
return this;
});
...
var snapshot=Clazz.new_(1,{K:"String",V:"javax.json.JsonValue"},$I$(5,1).c$$java_util_Map,[this.valueMap]);
return Clazz.new_($I$(8,1).c$$java_util_Map,[$I$(9).unmodifiableMap$java_util_Map(snapshot)]);
});
