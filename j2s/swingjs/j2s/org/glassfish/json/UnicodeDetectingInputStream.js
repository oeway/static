(function(){var P$=Clazz.newPackage("org.glassfish.json"),p$1={},I$=[[0,'java.nio.charset.Charset']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
