...
this.currentContext=Clazz.new_($I$(8,1).c$$org_glassfish_json_JsonParserImpl,[this]);
this.stack=Clazz.new_(1,{E:"org.glassfish.json.JsonParserImpl.Context"},$I$(9,1));
}, 1);
...
;C$.$init$.apply(this);
this.tokenizer=Clazz.new_($I$(10,1).c$$java_io_Reader,[reader]);
this.stateIterator=Clazz.new_($I$(11,1), [this, null]);
}, 1);

Clazz.newMeth(C$, 'c$$java_io_InputStream', function ($in) {
;C$.$init$.apply(this);
var uin=Clazz.new_($I$(12,1).c$$java_io_InputStream,[$in]);
this.tokenizer=Clazz.new_($I$(10,1).c$$java_io_Reader,[Clazz.new_($I$(13,1).c$$java_io_InputStream$java_nio_charset_Charset,[uin, uin.getCharset$()])]);
this.stateIterator=Clazz.new_($I$(11,1), [this, null]);
}, 1);

Clazz.newMeth(C$, 'c$$java_io_InputStream$java_nio_charset_Charset', function ($in, encoding) {
;C$.$init$.apply(this);
this.tokenizer=Clazz.new_($I$(10,1).c$$java_io_Reader,[Clazz.new_($I$(13,1).c$$java_io_InputStream$java_nio_charset_Charset,[$in, encoding])]);
this.stateIterator=Clazz.new_($I$(11,1), [this, null]);
}, 1);
...
}var bigDecimal=Clazz.new_($I$(14,1).c$$S,[this.tokenizer.getValue$()]);
...
}return Clazz.new_($I$(14,1).c$$S,[this.tokenizer.getValue$()]).intValue$();
});

Clazz.newMeth(C$, 'getLong$', function () {
if (this.currentEvent !== $I$(4).VALUE_NUMBER ) {
throw Clazz.new_(Clazz.load('IllegalStateException').c$$S,["JsonParser#getNumberType() is valid only " + "VALUE_NUMBER parser state. " + "But current parser state is " + this.currentEvent ]);
}return Clazz.new_($I$(14,1).c$$S,[this.tokenizer.getValue$()]).longValue$();
});

Clazz.newMeth(C$, 'getBigDecimal$', function () {
if (this.currentEvent !== $I$(4).VALUE_NUMBER ) {
throw Clazz.new_(Clazz.load('IllegalStateException').c$$S,["JsonParser#getNumberType() is valid only " + "VALUE_NUMBER parser state. " + "But current parser state is " + this.currentEvent ]);
}return Clazz.new_($I$(14,1).c$$S,[this.tokenizer.getValue$()]);
});
...
try {
return this.this$0.tokenizer.nextToken$();
} catch (ioe) {
...
Clazz.newMeth(C$, 'hasNext$', function () {
if (this.this$0.stack.isEmpty$() && (this.this$0.currentState === $I$(1).END_ARRAY  || this.this$0.currentState === $I$(1).END_OBJECT  ) ) {
var token=p$1.nextToken.apply(this, []);
if (token !== $I$(2).EOF ) {
throw Clazz.new_(Clazz.load('javax.json.stream.JsonParsingException').c$$S$javax_json_stream_JsonLocation,["Expected EOF, but got=" + token, this.this$0.getLastCharLocation$.apply(this.this$0, [])]);
}return false;
}return true;
});
...
var token=p$1.nextToken.apply(this, []);
this.this$0.currentState=this.this$0.currentContext.getTransition$org_glassfish_json_JsonParserImpl_State$org_glassfish_json_JsonTokenizer_JsonToken(this.this$0.currentState, token);
switch (this.this$0.currentState) {
case $I$(1).START_DOCUMENT:
continue;
case $I$(1).START_OBJECT:
this.this$0.stack.push$TE(this.this$0.currentContext);
this.this$0.currentContext=Clazz.new_($I$(3,1).c$$org_glassfish_json_JsonParserImpl,[this.this$0]);
return this.this$0.currentEvent=$I$(4).START_OBJECT;
case $I$(1).KEY:
return this.this$0.currentEvent=$I$(4).KEY_NAME;
case $I$(1).COLON:
continue;
case $I$(1).OBJECT_STRING:
return this.this$0.currentEvent=$I$(4).VALUE_STRING;
case $I$(1).OBJECT_NUMBER:
return this.this$0.currentEvent=$I$(4).VALUE_NUMBER;
case $I$(1).OBJECT_TRUE:
return this.this$0.currentEvent=$I$(4).VALUE_TRUE;
case $I$(1).OBJECT_FALSE:
return this.this$0.currentEvent=$I$(4).VALUE_FALSE;
case $I$(1).OBJECT_NULL:
return this.this$0.currentEvent=$I$(4).VALUE_NULL;
case $I$(1).OBJECT_COMMA:
continue;
case $I$(1).END_OBJECT:
this.this$0.currentContext=this.this$0.stack.pop$();
return this.this$0.currentEvent=$I$(4).END_OBJECT;
case $I$(1).START_ARRAY:
this.this$0.stack.push$TE(this.this$0.currentContext);
this.this$0.currentContext=Clazz.new_($I$(5,1).c$$org_glassfish_json_JsonParserImpl,[this.this$0]);
return this.this$0.currentEvent=$I$(4).START_ARRAY;
...
case $I$(1).END_ARRAY:
this.this$0.currentContext=this.this$0.stack.pop$();
return this.this$0.currentEvent=$I$(4).END_ARRAY;
...
EXPECTED_TOKENS.put$TK$TV(current, allowed);
}allowed.add$TE(token);
}, 1);
...
C$.EXPECTED_TOKENS=Clazz.new_(1,{K:"org.glassfish.json.JsonParserImpl.State",V:"java.util.Set"},$I$(7,1).c$$Class,[Clazz.getClass($I$(1))]);
{
...
P$.JsonParserImpl.Context.transition$org_glassfish_json_JsonParserImpl_StateAA$java_util_EnumMap$org_glassfish_json_JsonParserImpl_State$org_glassfish_json_JsonTokenizer_JsonToken$org_glassfish_json_JsonParserImpl_State(C$.TRANSITIONS, C$.EXPECTED_TOKENS, current, token, next);
}, 1);
