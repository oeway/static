...
this.currentContext=Clazz.new_($I$(2,1).c$$org_glassfish_json_JsonGeneratorImpl_Scope,[$I$(3).IN_NONE]);
this.stack=Clazz.new_(1,{E:"org.glassfish.json.JsonGeneratorImpl.Context"},$I$(4,1));
}, 1);
...
this.stack.push$TE(this.currentContext);
this.currentContext=Clazz.new_($I$(2,1).c$$org_glassfish_json_JsonGeneratorImpl_Scope,[$I$(3).IN_OBJECT]);
return this;
});
...
this.stack.push$TE(this.currentContext);
this.currentContext=Clazz.new_($I$(2,1).c$$org_glassfish_json_JsonGeneratorImpl_Scope,[$I$(3).IN_ARRAY]);
return this;
});
