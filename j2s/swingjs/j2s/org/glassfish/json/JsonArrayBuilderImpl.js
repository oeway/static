...
;C$.$init$.apply(this);
this.valueList=Clazz.new_(1,{E:"javax.json.JsonValue"},$I$(5,1));
}, 1);

Clazz.newMeth(C$, 'add$javax_json_JsonValue', function (value) {
p$1.validateValue$O.apply(this, [value]);
this.valueList.add$TE(value);
return this;
});

Clazz.newMeth(C$, 'add$S', function (value) {
p$1.validateValue$O.apply(this, [value]);
this.valueList.add$TE(Clazz.new_($I$(6,1).c$$S,[value]));
return this;
});

Clazz.newMeth(C$, 'add$java_math_BigDecimal', function (value) {
p$1.validateValue$O.apply(this, [value]);
this.valueList.add$TE(Clazz.new_($I$(7,1).c$$java_math_BigDecimal,[value]));
return this;
});

Clazz.newMeth(C$, 'add$java_math_BigInteger', function (value) {
p$1.validateValue$O.apply(this, [value]);
this.valueList.add$TE(Clazz.new_($I$(7,1).c$$java_math_BigInteger,[value]));
return this;
});

Clazz.newMeth(C$, 'add$I', function (value) {
this.valueList.add$TE(Clazz.new_($I$(7,1).c$$I,[value]));
return this;
});

Clazz.newMeth(C$, 'add$J', function (value) {
this.valueList.add$TE(Clazz.new_($I$(7,1).c$$J,[value]));
return this;
});

Clazz.newMeth(C$, 'add$D', function (value) {
this.valueList.add$TE(Clazz.new_($I$(7,1).c$$D,[value]));
return this;
});

Clazz.newMeth(C$, 'add$Z', function (value) {
this.valueList.add$TE(value ? $I$(1).TRUE : $I$(1).FALSE);
return this;
});

Clazz.newMeth(C$, 'addNull$', function () {
this.valueList.add$TE($I$(1).NULL);
return this;
});
...
}this.valueList.add$TE(builder.build$());
return this;
});
...
var snapshot=Clazz.new_(1,{E:"javax.json.JsonValue"},$I$(5,1).c$$java_util_Collection,[this.valueList]);
return Clazz.new_($I$(8,1).c$$java_util_List,[$I$(9).unmodifiableList$java_util_List(snapshot)]);
});
