(function(){var P$=Clazz.newPackage("org.glassfish.json"),I$=[[0,'java.math.BigDecimal',['javax.json.JsonValue','.ValueType']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
