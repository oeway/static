(function(){var P$=Clazz.newPackage("org.glassfish.json"),I$=[[0,'java.nio.charset.Charset','java.util.Collections','org.glassfish.json.JsonProviderImpl','org.glassfish.json.JsonPrettyGeneratorImpl','org.glassfish.json.JsonGeneratorImpl']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
