(function(){var P$=Clazz.newPackage("org.glassfish.json"),I$=[[0,'org.glassfish.json.JsonProviderImpl','java.util.HashMap','java.util.Collections','org.glassfish.json.JsonWriterImpl']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var providerConfig=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(2,1));
if (prettyPrinting) {
providerConfig.put$TK$TV("javax.json.stream.JsonGenerator.prettyPrinting", new Boolean(true));
