(function(){var P$=Clazz.newPackage("org.glassfish.json"),p$1={},I$=[[0,'java.io.BufferedReader','java.util.Arrays',['org.glassfish.json.JsonTokenizer','.DirectReader'],['org.glassfish.json.JsonTokenizer','.JsonToken'],'org.glassfish.json.JsonLocationImpl']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['unread'],'I',['prevChar'],'L',['lineNo','columnNo','streamOffset'],'O',['reader','org.glassfish.json.JsonTokenizer.TokenizerReader']]]
...
return Clazz.new_($I$(5,1).c$$J$J$J,[this.lineNo, this.columnNo - 1, this.streamOffset - 1]);
});
