(function(){var P$=Clazz.newPackage("org.bushe.swing.event.annotation"),I$=[[0,'org.bushe.swing.event.annotation.UseTheClassOfTheAnnotatedMethodsParameter','org.bushe.swing.event.annotation.ReferenceStrength','org.bushe.swing.event.ThreadSafeEventService']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*@*/var C$=Clazz.newClass(P$, "EventSubscriber", null, null, 'java.lang.annotation.Annotation');
...
a.push(['eventClass','Class',Clazz.getClass($I$(1))]);
a.push(['priority','int',0]);
a.push(['exact','boolean',false]);
a.push(['referenceStrength','org.bushe.swing.event.annotation.ReferenceStrength',$I$(2).WEAK]);
a.push(['eventServiceName','String',"EventBus"]);
a.push(['autoCreateEventServiceClass','Class',Clazz.getClass($I$(3))]);
return a}
Clazz.newMeth(C$);
})();
