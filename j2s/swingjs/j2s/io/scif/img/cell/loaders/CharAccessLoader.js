(function(){var P$=Clazz.newPackage("io.scif.img.cell.loaders"),I$=[[0,'java.nio.ByteBuffer','java.nio.ByteOrder','io.scif.util.FormatTools','net.imglib2.type.numeric.integer.GenericByteType']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "CharAccessLoader", null, 'io.scif.img.cell.loaders.AbstractArrayLoader');
...
Clazz.newMeth(C$, ['convertBytes$net_imglib2_img_basictypeaccess_CharAccess$BA$I','convertBytes$TA$BA$I'], function (data, bytes, planesRead) {
...
for (var k=offset; bb.hasRemaining$(); ++k) data.setValue$I$C(k, bb.getChar$());
