(function(){var P$=Clazz.newPackage("io.scif.img.cell.loaders"),I$=[[0,'java.nio.ByteBuffer','java.nio.ByteOrder','io.scif.util.FormatTools','net.imglib2.img.basictypeaccess.array.CharArray','net.imglib2.type.numeric.integer.GenericByteType']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "CharArrayLoader", null, 'io.scif.img.cell.loaders.AbstractArrayLoader');
...
Clazz.newMeth(C$, ['convertBytes$net_imglib2_img_basictypeaccess_array_CharArray$BA$I','convertBytes$TA$BA$I'], function (data, bytes, planesRead) {
...
bb.asCharBuffer$().get$CA$I$I(data.getCurrentStorageArray$(), offset, bytes.length);
} else {
...
var value=String.fromCharCode(this.utils$().decodeWord$BA$I$I$Z(bytes, index * bpp, pixelType, iMeta.isLittleEndian$()));
data.setValue$I$C(offset + index, value);
}
}});
