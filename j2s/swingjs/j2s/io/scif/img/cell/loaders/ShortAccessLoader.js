(function(){var P$=Clazz.newPackage("io.scif.img.cell.loaders"),I$=[[0,'java.nio.ByteBuffer','java.nio.ByteOrder','io.scif.util.FormatTools','net.imglib2.type.numeric.integer.GenericShortType']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "ShortAccessLoader", null, 'io.scif.img.cell.loaders.AbstractArrayLoader');
...
Clazz.newMeth(C$, ['convertBytes$net_imglib2_img_basictypeaccess_ShortAccess$BA$I','convertBytes$TA$BA$I'], function (data, bytes, planesRead) {
var iMeta=this.reader$().getMetadata$().get$I(0);
if (this.isCompatible$()) {
var offset=planesRead * ((bytes.length/2|0));
var bb=$I$(1).wrap$BA(bytes);
bb.order$java_nio_ByteOrder(iMeta.isLittleEndian$() ? $I$(2).LITTLE_ENDIAN : $I$(2).BIG_ENDIAN);
for (var k=offset; bb.hasRemaining$(); ++k) data.setValue$I$H(k, bb.getShort$());
