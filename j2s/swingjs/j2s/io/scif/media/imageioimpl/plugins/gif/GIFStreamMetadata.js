(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.gif"),p$1={},I$=[[0,'javax.imageio.metadata.IIOMetadataNode']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "GIFStreamMetadata", null, 'io.scif.media.imageioimpl.plugins.gif.GIFMetadata');
...
C$.c$$Z$S$S$SA$SA.apply(this, [true, "javax_imageio_gif_stream_1.0", "io.scif.media.imageioimpl.plugins.gif.GIFStreamMetadataFormat", null, null]);
}, 1);
