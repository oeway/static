(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.gif"),I$=[[0,'java.util.Arrays','io.scif.media.imageioimpl.plugins.gif.GIFStreamMetadata']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.addAttribute$S$S$I$Z$S$java_util_List("Version", "value", 0, true, null, $I$(1).asList$TTA($I$(2).versionStrings));
...
this.addAttribute$S$S$I$Z$S$java_util_List("GlobalColorTable", "sizeOfGlobalColorTable", 2, true, null, $I$(1).asList$TTA($I$(2).colorTableSizes));
