(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.bmp"),p$1={},I$=[[0,'io.scif.media.imageioimpl.plugins.bmp.I18N','java.nio.ByteOrder','io.scif.media.imageio.plugins.bmp.BMPImageWriteParam','io.scif.media.imageioimpl.plugins.bmp.BMPMetadata','io.scif.media.imageioimpl.common.ImageUtil','java.awt.Rectangle','javax.imageio.ImageTypeSpecifier','io.scif.media.imageioimpl.plugins.bmp.BMPConstants','java.awt.image.DataBuffer','java.io.ByteArrayOutputStream','javax.imageio.ImageIO',['io.scif.media.imageioimpl.plugins.bmp.BMPImageWriter','.IIOWriteProgressAdapter']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "BMPImageWriter", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'javax.imageio.ImageWriter', 'io.scif.media.imageioimpl.plugins.bmp.BMPConstants');
...
C$.$fields$=[['Z',['isTopDown'],'I',['compressionType','w','h','compImageSize'],'O',['stream','javax.imageio.stream.ImageOutputStream','embedded_stream','java.io.ByteArrayOutputStream','bitMasks','int[]','+bitPos','bpixels','byte[]','spixels','short[]','ipixels','int[]']]]
...
meta.initialize$java_awt_image_ColorModel$java_awt_image_SampleModel$javax_imageio_ImageWriteParam(imageType.getColorModel$(), imageType.getSampleModel$(), param);
return meta;
});
...
if (Clazz.instanceOf(inData, "io.scif.media.imageioimpl.plugins.bmp.BMPMetadata")) {
outData=(inData).clone$();
} else {
try {
outData=Clazz.new_($I$(4,1).c$$javax_imageio_metadata_IIOMetadata,[inData]);
} catch (e) {
if (Clazz.exceptionOf(e,"javax.imageio.metadata.IIOInvalidTreeException")){
outData=Clazz.new_($I$(4,1));
} else {
throw e;
}
}
}outData.initialize$java_awt_image_ColorModel$java_awt_image_SampleModel$javax_imageio_ImageWriteParam(imageType.getColorModel$(), imageType.getSampleModel$(), param);
return outData;
});
...
colorModel=$I$(5).createColorModel$java_awt_color_ColorSpace$java_awt_image_SampleModel(null, sampleModel);
...
var imageType=Clazz.new_($I$(7,1).c$$java_awt_image_ColorModel$java_awt_image_SampleModel,[colorModel, sampleModel]);
if (imageMetadata != null ) {
bmpImageMetadata=this.convertImageMetadata$javax_imageio_metadata_IIOMetadata$javax_imageio_ImageTypeSpecifier$javax_imageio_ImageWriteParam(imageMetadata, imageType, param);
} else {
...
var destinationRegion=Clazz.new_($I$(6,1).c$$I$I$I$I,[minX, minY, this.w, this.h]);
...
case 2:
this.compressionType=C$.getCompressionType$S(bmpParam.getCompressionType$());
break;
case 3:
this.compressionType=bmpImageMetadata.compression;
break;
case 1:
this.compressionType=C$.getPreferredCompressionType$java_awt_image_ColorModel$java_awt_image_SampleModel(colorModel, sampleModel);
break;
default:
...
throw Clazz.new_(Clazz.load('javax.imageio.IIOException').c$$S,["Image can not be encoded with " + "compression type " + $I$(8).compressionTypeNames[this.compressionType] ]);
} else {
this.compressionType=C$.getPreferredCompressionType$java_awt_image_ColorModel$java_awt_image_SampleModel(colorModel, sampleModel);
}}var r=null;
var g=null;
...
throw Clazz.new_(Clazz.load('java.io.IOException').c$$S,["Image can not be encoded with " + "compression type " + $I$(8).compressionTypeNames[this.compressionType] ]);
...
var headerSize=0;
var imageSize=0;
var xPelsPerMeter=bmpImageMetadata.xPixelsPerMeter;
var yPelsPerMeter=bmpImageMetadata.yPixelsPerMeter;
var colorsUsed=bmpImageMetadata.colorsUsed > 0 ? bmpImageMetadata.colorsUsed : paletteEntries;
...
if (Clazz.instanceOf(param, "io.scif.media.imageio.plugins.bmp.BMPImageWriteParam")) {
this.isTopDown=(param).isTopDown$();
if (this.compressionType != 0 && this.compressionType != 3 ) this.isTopDown=false;
} else {
...
var src=inputRaster;
var srcRect=Clazz.new_($I$(6,1).c$$I$I$I$I,[minX * scaleX + xOffset, row * scaleY + yOffset, (this.w - 1) * scaleX + 1, 1]);
...
this.bpixels[k++]=((((pixels[l++] << 7) | (pixels[l++] << 6) | (pixels[l++] << 5) | (pixels[l++] << 4) | (pixels[l++] << 3) | (pixels[l++] << 2) | (pixels[l++] << 1) | pixels[l++] )|0)|0);
}
...
for (var h=0; h < scanlineBytes; h++) {
this.bpixels[h]=((pixels[l++]|0)|0);
}
p$1.encodeRLE8$BA$I.apply(this, [this.bpixels, scanlineBytes]);
} else {
for (var j=0; j < scanlineBytes; j++) {
this.bpixels[j]=((pixels[l++]|0)|0);
}
...
this.bpixels[k++]=(((pixels[l + 2])|0)|0);
this.bpixels[k++]=(((pixels[l + 1])|0)|0);
this.bpixels[k++]=(((pixels[l])|0)|0);
l+=3;
}
this.stream.write$BA$I$I(this.bpixels, 0, scanlineBytes);
} else {
...
for (var j=0; j < scanlineBytes; j++) {
index=pixels[l];
this.bpixels[k++]=(b[index]|0);
this.bpixels[k++]=(g[index]|0);
this.bpixels[k++]=(b[index]|0);
l++;
}
...
absBuf[++absVal]=(runVal|0);
absBuf[++absVal]=(nextVal|0);
} else if (absVal < 254) {
absBuf[++absVal]=(nextVal|0);
} else {
this.stream.writeByte$I(0);
...
var absBuf=Clazz.array(Byte.TYPE, [256]);
runVal1=($b$[0] = bipixels[++j], $b$[0]);
runVal2=($b$[0] = bipixels[++j], $b$[0]);
while (j < scanlineBytes - 2){
nextVal1=($b$[0] = bipixels[++j], $b$[0]);
nextVal2=($b$[0] = bipixels[++j], $b$[0]);
if (nextVal1 == runVal1) {
if (absVal >= 4) {
this.stream.writeByte$I(0);
this.stream.writeByte$I(absVal - 1);
...
absBuf[++absVal]=(runVal1|0);
absBuf[++absVal]=(runVal2|0);
absBuf[++absVal]=(nextVal1|0);
absBuf[++absVal]=(nextVal2|0);
} else if (absVal < 253) {
absBuf[++absVal]=(nextVal1|0);
absBuf[++absVal]=(nextVal2|0);
} else {
...
p$1.incCompImageSize$I.apply(this, [1]);
absVal=-1;
}runVal1=($b$[0] = nextVal1, $b$[0]);
runVal2=($b$[0] = nextVal2, $b$[0]);
runCount=2;
...
if (this.isTopDown == true ) this.stream.writeInt$I(-this.h);
 else this.stream.writeInt$I(this.h);
...
Clazz.newMeth(C$, 'getCompressionType$S', function (typeString) {
for (var i=0; i < $I$(8).compressionTypeNames.length; i++) if ($I$(8).compressionTypeNames[i].equals$O(typeString)) return i;
...
(function(){/*a*/var C$=Clazz.newClass(P$, "BMPImageWriter$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load(['io.scif.media.imageioimpl.plugins.bmp.BMPImageWriter','.IIOWriteProgressAdapter']), null, 1);
...
Clazz.newMeth(C$, ['warningOccurred$javax_imageio_ImageWriter$I$S','warningOccurred$'], function (source, imageIndex, warning) {
...
var emb_ios=$I$(11).createImageOutputStream$O(this.embedded_stream);
writer.setOutput$O(emb_ios);
...
var imageType=Clazz.new_($I$(7,1).c$$java_awt_image_ColorModel$java_awt_image_SampleModel,[cm, sm]);
return C$.getPreferredCompressionType$javax_imageio_ImageTypeSpecifier(imageType);
}, 1);

Clazz.newMeth(C$, 'getPreferredCompressionType$javax_imageio_ImageTypeSpecifier', function (imageType) {
var biType=imageType.getBufferedImageType$();
...
var imgType=Clazz.new_($I$(7,1).c$$java_awt_image_ColorModel$java_awt_image_SampleModel,[cm, sm]);
