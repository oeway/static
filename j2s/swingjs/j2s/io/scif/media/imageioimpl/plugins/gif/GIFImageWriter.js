(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.gif"),p$1={},I$=[[0,'javax.imageio.ImageWriteParam','io.scif.media.imageioimpl.plugins.gif.GIFWritableImageMetadata','java.awt.Rectangle','java.awt.Dimension','io.scif.media.imageioimpl.plugins.gif.GIFWritableStreamMetadata','io.scif.media.imageioimpl.plugins.gif.GIFImageWriteParam','java.nio.ByteOrder','io.scif.media.imageioimpl.common.PaletteBuilder','javax.imageio.ImageTypeSpecifier','java.util.Arrays','io.scif.media.imageioimpl.common.LZWCompressor']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['isWritingSequence','wroteSequenceHeader'],'I',['imageIndex'],'O',['stream','javax.imageio.stream.ImageOutputStream','theStreamMetadata','io.scif.media.imageioimpl.plugins.gif.GIFWritableStreamMetadata']]]
...
colorTable[idx++]=(reds[i]|0);
colorTable[idx++]=(greens[i]|0);
colorTable[idx++]=(blues[i]|0);
}
...
Clazz.newMeth(C$, 'c$$io_scif_media_imageioimpl_plugins_gif_GIFImageWriterSpi', function (originatingProvider) {
...
var sourceBounds=Clazz.new_($I$(3,1).c$$I$I,[sampleModel.getWidth$(), sampleModel.getHeight$()]);
...
return Clazz.new_($I$(6,1).c$$java_util_Locale,[this.getLocale$()]);
});
...
var sampleModel=image.getSampleModel$();
var sourceBounds=Clazz.new_($I$(3,1).c$$I$I$I$I,[image.getMinX$(), image.getMinY$(), image.getWidth$(), image.getHeight$()]);
var destSize=Clazz.new_($I$(4,1));
...
}p$1.writeImage$java_awt_image_RenderedImage$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata$javax_imageio_ImageWriteParam$BA$java_awt_Rectangle$java_awt_Dimension.apply(this, [iioimage.getRenderedImage$(), imageMetadata, p, globalColorTable, sourceBounds, destSize]);
if (writeTrailer) {
p$1.writeTrailer.apply(this, []);
}}, p$1);

Clazz.newMeth(C$, 'writeImage$java_awt_image_RenderedImage$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata$javax_imageio_ImageWriteParam$BA$java_awt_Rectangle$java_awt_Dimension', function (image, imageMetadata, param, globalColorTable, sourceBounds, destSize) {
var colorModel=image.getColorModel$();
var sampleModel=image.getSampleModel$();
...
p$1.writeGraphicControlExtension$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata.apply(this, [imageMetadata]);
}p$1.writePlainTextExtension$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata.apply(this, [imageMetadata]);
p$1.writeApplicationExtension$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata.apply(this, [imageMetadata]);
p$1.writeCommentExtension$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata.apply(this, [imageMetadata]);
...
p$1.writeImageDescriptor$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata$I.apply(this, [imageMetadata, bitsPerPixel]);
...
Clazz.newMeth(C$, 'writeRows$java_awt_image_RenderedImage$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I$I$I$I$I$I', function (image, compressor, sx, sdx, sy, sdy, sw, dy, ddy, dw, dh, numRowsWritten, progressReportRowPeriod) {
...
Clazz.newMeth(C$, 'writeRowsOpt$BA$I$I$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I', function (data, offset, lineStride, compressor, dy, ddy, dw, dh, numRowsWritten, progressReportRowPeriod) {
...
var isOptimizedCase=periodX == 1 && periodY == 1  && Clazz.instanceOf(sampleModel, "java.awt.image.ComponentSampleModel")  && image.getNumXTiles$() == 1  && image.getNumYTiles$() == 1  && Clazz.instanceOf(image.getTile$I$I(0, 0).getDataBuffer$(), "java.awt.image.DataBufferByte") ;
...
var offset=csm.getOffset$I$I$I(sourceXOffset - tile.getSampleModelTranslateX$(), sourceYOffset - tile.getSampleModelTranslateY$(), 0);
var lineStride=csm.getScanlineStride$();
p$1.writeRowsOpt$BA$I$I$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I.apply(this, [data, offset, lineStride, compressor, 0, 8, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
if (this.abortRequested$()) {
return;
}numRowsWritten+=(destHeight/8|0);
p$1.writeRowsOpt$BA$I$I$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I.apply(this, [data, offset, lineStride, compressor, 4, 8, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
if (this.abortRequested$()) {
return;
}numRowsWritten+=((destHeight - 4)/8|0);
p$1.writeRowsOpt$BA$I$I$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I.apply(this, [data, offset, lineStride, compressor, 2, 4, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
if (this.abortRequested$()) {
return;
}numRowsWritten+=((destHeight - 2)/4|0);
p$1.writeRowsOpt$BA$I$I$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I.apply(this, [data, offset, lineStride, compressor, 1, 2, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
} else {
p$1.writeRows$java_awt_image_RenderedImage$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I$I$I$I$I$I.apply(this, [image, compressor, sourceXOffset, periodX, sourceYOffset, 8 * periodY, sourceWidth, 0, 8, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
if (this.abortRequested$()) {
return;
}numRowsWritten+=(destHeight/8|0);
p$1.writeRows$java_awt_image_RenderedImage$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I$I$I$I$I$I.apply(this, [image, compressor, sourceXOffset, periodX, sourceYOffset + 4 * periodY, 8 * periodY, sourceWidth, 4, 8, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
if (this.abortRequested$()) {
return;
}numRowsWritten+=((destHeight - 4)/8|0);
p$1.writeRows$java_awt_image_RenderedImage$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I$I$I$I$I$I.apply(this, [image, compressor, sourceXOffset, periodX, sourceYOffset + 2 * periodY, 4 * periodY, sourceWidth, 2, 4, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
if (this.abortRequested$()) {
return;
}numRowsWritten+=((destHeight - 2)/4|0);
p$1.writeRows$java_awt_image_RenderedImage$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I$I$I$I$I$I.apply(this, [image, compressor, sourceXOffset, periodX, sourceYOffset + periodY, 2 * periodY, sourceWidth, 1, 2, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
}} else {
...
var offset=csm.getOffset$I$I$I(sourceXOffset - tile.getSampleModelTranslateX$(), sourceYOffset - tile.getSampleModelTranslateY$(), 0);
var lineStride=csm.getScanlineStride$();
p$1.writeRowsOpt$BA$I$I$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I.apply(this, [data, offset, lineStride, compressor, 0, 1, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
} else {
p$1.writeRows$java_awt_image_RenderedImage$io_scif_media_imageioimpl_common_LZWCompressor$I$I$I$I$I$I$I$I$I$I$I.apply(this, [image, compressor, sourceXOffset, periodX, sourceYOffset, periodY, sourceWidth, 0, 1, destWidth, destHeight, numRowsWritten, progressReportRowPeriod]);
}}if (this.abortRequested$()) {
return;
...
var sm;
if (Clazz.instanceOf(streamMetadata, "io.scif.media.imageioimpl.plugins.gif.GIFWritableStreamMetadata")) {
sm=streamMetadata;
} else {
sm=Clazz.new_($I$(5,1));
...
Clazz.newMeth(C$, 'writeGraphicControlExtension$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata', function (im) {
...
Clazz.newMeth(C$, 'writePlainTextExtension$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata', function (im) {
...
Clazz.newMeth(C$, 'writeApplicationExtension$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata', function (im) {
...
Clazz.newMeth(C$, 'writeCommentExtension$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata', function (im) {
if (im.comments != null ) {
try {
...
Clazz.newMeth(C$, 'writeImageDescriptor$io_scif_media_imageioimpl_plugins_gif_GIFWritableImageMetadata$I', function (imageMetadata, bitsPerPixel) {
