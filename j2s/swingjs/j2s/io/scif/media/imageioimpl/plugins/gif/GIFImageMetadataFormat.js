(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.gif"),I$=[[0,'java.util.Arrays','io.scif.media.imageioimpl.plugins.gif.GIFStreamMetadata','io.scif.media.imageioimpl.plugins.gif.GIFImageMetadata']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.addAttribute$S$S$I$Z$S$java_util_List("LocalColorTable", "sizeOfLocalColorTable", 2, true, null, $I$(1).asList$TTA($I$(2).colorTableSizes));
...
this.addAttribute$S$S$I$Z$S$java_util_List("GraphicControlExtension", "disposalMethod", 0, true, null, $I$(1).asList$TTA($I$(3).disposalMethodNames));
