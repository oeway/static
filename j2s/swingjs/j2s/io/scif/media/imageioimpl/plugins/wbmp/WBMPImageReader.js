(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.wbmp"),p$1={},I$=[[0,'io.scif.media.imageioimpl.plugins.wbmp.I18N','io.scif.media.imageioimpl.plugins.wbmp.WBMPMetadata','io.scif.media.imageioimpl.common.ImageUtil','java.awt.image.BufferedImage','java.util.ArrayList','javax.imageio.ImageTypeSpecifier','javax.imageio.ImageReadParam','java.awt.Rectangle']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['gotHeader'],'I',['width','height','wbmpType'],'L',['imageDataOffset'],'O',['iis','javax.imageio.stream.ImageInputStream','metadata','io.scif.media.imageioimpl.plugins.wbmp.WBMPMetadata']]]
...
var fixHeaderField=($b$[0] = this.iis.readByte$(), $b$[0]);
...
list.add$TE(Clazz.new_($I$(6,1).c$$java_awt_image_RenderedImage,[bi]));
...
var noTransform=destinationRegion.equals$O(Clazz.new_($I$(8,1).c$$I$I$I$I,[0, 0, this.width, this.height])) && destinationRegion.equals$O(Clazz.new_($I$(8,1).c$$I$I$I$I,[0, 0, bi.getWidth$(), bi.getHeight$()])) ;
