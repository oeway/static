(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.bmp"),I$=[];
...
;C$.superclazz.c$$S$I.apply(this,["com_sun_media_imageio_plugins_bmp_image_1.0", 2]);C$.$init$.apply(this);
this.addElement$S$S$I("ImageDescriptor", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
...
this.addElement$S$S$I("PixelsPerMeter", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
...
this.addElement$S$S$I("ColorsUsed", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
this.addAttribute$S$S$I$Z$S$S$S$Z$Z("ColorsUsed", "value", 2, true, null, "0", "65535", true, true);
this.addElement$S$S$I("ColorsImportant", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
this.addAttribute$S$S$I$Z$S$S$S$Z$Z("ColorsImportant", "value", 2, false, null, "0", "65535", true, true);
this.addElement$S$S$I("BI_BITFIELDS_Mask", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
...
this.addElement$S$S$I("ColorSpace", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
this.addAttribute$S$S$I$Z$S$S$S$Z$Z("ColorSpace", "value", 2, false, null, "0", "65535", true, true);
this.addElement$S$S$I("LCS_CALIBRATED_RGB", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
...
this.addElement$S$S$I("LCS_CALIBRATED_RGB_GAMMA", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
...
this.addElement$S$S$I("Intent", "com_sun_media_imageio_plugins_bmp_image_1.0", 0);
this.addAttribute$S$S$I$Z$S$S$S$Z$Z("Intent", "value", 2, false, null, "0", "65535", true, true);
this.addElement$S$S$I$I("Palette", "com_sun_media_imageio_plugins_bmp_image_1.0", 2, 256);
...
this.addElement$S$S$I$I("CommentExtensions", "com_sun_media_imageio_plugins_bmp_image_1.0", 1, 2147483647);
