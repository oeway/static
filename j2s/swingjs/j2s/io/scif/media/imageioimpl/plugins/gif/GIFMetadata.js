(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.gif"),I$=[];
...
if (value.equalsIgnoreCase$S("TRUE")) {
return true;
} else if (value.equalsIgnoreCase$S("FALSE")) {
return false;
} else {
...
if (index > maxIndex) {
maxIndex=index;
}red[index]=((C$.getIntAttribute$org_w3c_dom_Node$S$Z$I$I(entry, "red", true, 0, 255)|0)|0);
green[index]=((C$.getIntAttribute$org_w3c_dom_Node$S$Z$I$I(entry, "green", true, 0, 255)|0)|0);
blue[index]=((C$.getIntAttribute$org_w3c_dom_Node$S$Z$I$I(entry, "blue", true, 0, 255)|0)|0);
...
colorTable[j++]=(red[i]|0);
colorTable[j++]=(green[i]|0);
colorTable[j++]=(blue[i]|0);
}
return colorTable;
});
