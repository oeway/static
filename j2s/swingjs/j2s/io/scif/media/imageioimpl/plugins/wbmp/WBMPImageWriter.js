...
multiBytes[b]=((((intValue >>> ((maxIndex - b) * 7)) & 127)|0)|0);
if (b != maxIndex) {
multiBytes[b]=(multiBytes[b]|(-128)|0);
}}
return multiBytes;
}, 1);
...
var raster=$I$(5).createWritableRaster$java_awt_image_SampleModel$java_awt_Point(destSM, Clazz.new_($I$(6,1).c$$I$I,[inputRaster.getMinX$(), inputRaster.getMinY$()]));
...
inverted[col]=(((~(bdata[col + offset]))|0)|0);
}
