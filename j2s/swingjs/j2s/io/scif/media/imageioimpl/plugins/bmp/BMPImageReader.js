(function(){var P$=Clazz.newPackage("io.scif.media.imageioimpl.plugins.bmp"),p$1={},I$=[[0,'java.nio.ByteOrder','io.scif.media.imageioimpl.plugins.bmp.I18N','io.scif.media.imageioimpl.plugins.bmp.BMPMetadata','java.awt.color.ColorSpace','java.awt.color.ICC_ColorSpace','java.awt.color.ICC_Profile','java.awt.image.PixelInterleavedSampleModel','java.awt.image.MultiPixelPackedSampleModel','io.scif.media.imageioimpl.common.ImageUtil','java.awt.image.IndexColorModel','java.awt.image.SinglePixelPackedSampleModel','java.awt.image.DirectColorModel','java.util.ArrayList','javax.imageio.ImageTypeSpecifier','javax.imageio.ImageReadParam','java.awt.Rectangle','java.awt.image.Raster','java.awt.Point','java.awt.image.BufferedImage','javax.imageio.ImageIO','java.io.ByteArrayInputStream',['io.scif.media.imageioimpl.plugins.bmp.BMPImageReader','.EmbeddedProgressAdapter']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "BMPImageReader", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'javax.imageio.ImageReader', 'io.scif.media.imageioimpl.plugins.bmp.BMPConstants');
...
C$.$fields$=[['Z',['isBottomUp','gotHeader','noTransform','seleBand'],'I',['imageType','numBands','bitsPerPixel','redMask','greenMask','blueMask','alphaMask','width','height','scaleX','scaleY'],'L',['bitmapFileSize','bitmapOffset','compression','imageSize','imageDataOffset'],'O',['palette','byte[]','sampleModel','java.awt.image.SampleModel','+originalSampleModel','colorModel','java.awt.image.ColorModel','+originalColorModel','iis','javax.imageio.stream.ImageInputStream','destinationRegion','java.awt.Rectangle','+sourceRegion','metadata','io.scif.media.imageioimpl.plugins.bmp.BMPMetadata','bi','java.awt.image.BufferedImage','sourceBands','int[]','+destBands']]]
...
this.imageType=3;
}var numberOfEntries=((((this.bitmapOffset - 14 - size )/3|0))|0);
...
this.metadata.compression=(this.compression|0);
this.metadata.imageSize=(this.imageSize|0);
this.metadata.xPixelsPerMeter=(xPelsPerMeter|0);
this.metadata.yPixelsPerMeter=(yPelsPerMeter|0);
this.metadata.colorsUsed=(colorsUsed|0);
this.metadata.colorsImportant=(colorsImportant|0);
if (size == 40) {
switch ((this.compression|0)) {
case 4:
case 5:
...
case 1:
case 2:
var numberOfEntries=((((this.bitmapOffset - 14 - size )/4|0))|0);
...
this.imageType=9;
}this.redMask=(this.iis.readUnsignedInt$()|0);
this.greenMask=(this.iis.readUnsignedInt$()|0);
this.blueMask=(this.iis.readUnsignedInt$()|0);
this.metadata.redMask=this.redMask;
this.metadata.greenMask=this.greenMask;
this.metadata.blueMask=this.blueMask;
if (colorsUsed != 0) {
sizeOfPalette=(colorsUsed|0) * 4;
this.palette=Clazz.array(Byte.TYPE, [sizeOfPalette]);
this.iis.readFully$BA$I$I(this.palette, 0, sizeOfPalette);
this.metadata.palette=this.palette;
this.metadata.paletteSize=(colorsUsed|0);
}this.metadata.bmpVersion="BMP v. 3.x NT";
break;
default:
throw Clazz.new_(Clazz.load('RuntimeException').c$$S,[$I$(2).getString$S("BMPImageReader2")]);
}
} else if (size == 108 || size == 124 ) {
if (size == 108) this.metadata.bmpVersion="BMP v. 4.x";
 else if (size == 124) this.metadata.bmpVersion="BMP v. 5.x";
this.redMask=(this.iis.readUnsignedInt$()|0);
this.greenMask=(this.iis.readUnsignedInt$()|0);
this.blueMask=(this.iis.readUnsignedInt$()|0);
this.alphaMask=(this.iis.readUnsignedInt$()|0);
...
this.iis.skipBytes$I(4);
}this.metadata.colorSpace=(csType|0);
if (csType == 0) {
...
this.metadata.gammaRed=(gammaRed|0);
this.metadata.gammaGreen=(gammaGreen|0);
this.metadata.gammaBlue=(gammaBlue|0);
}var numberOfEntries=((((this.bitmapOffset - 14 - size )/4|0))|0);
var sizeOfPalette=numberOfEntries * 4;
this.palette=Clazz.array(Byte.TYPE, [sizeOfPalette]);
this.iis.readFully$BA$I$I(this.palette, 0, sizeOfPalette);
...
throw Clazz.new_(Clazz.load('RuntimeException').c$$S,[$I$(2).getString$S("BMPImageReader3")]);
}}if (this.height > 0) {
...
this.iis.mark$();
this.iis.skipBytes$J(profileData - size);
var profile=Clazz.array(Byte.TYPE, [profileSize]);
this.iis.readFully$BA$I$I(profile, 0, profileSize);
this.iis.reset$();
try {
if (this.metadata.colorSpace == 3) colorSpace=Clazz.new_($I$(5,1).c$$java_awt_color_ICC_Profile,[$I$(6).getInstance$S( String.instantialize(profile))]);
 else colorSpace=Clazz.new_($I$(5,1).c$$java_awt_color_ICC_Profile,[$I$(6).getInstance$BA(profile)]);
} catch (e) {
...
r=Clazz.array(Byte.TYPE, [(size|0)]);
g=Clazz.array(Byte.TYPE, [(size|0)]);
b=Clazz.array(Byte.TYPE, [(size|0)]);
for (var i=0; i < (size|0); i++) {
off=3 * i;
b[i]=(this.palette[off]|0);
g[i]=(this.palette[off + 1]|0);
r[i]=(this.palette[off + 2]|0);
}
} else {
...
r[i]=(this.palette[off + 2]|0);
 ...
 else this.colorModel=Clazz.new_($I$(10,1).c$$I$I$BA$BA$BA,[this.bitsPerPixel, (size|0), r, g, b]);
} else if (this.bitsPerPixel == 16) {
this.numBands=3;
this.sampleModel=Clazz.new_($I$(11,1).c$$I$I$I$IA,[1, this.width, this.height, Clazz.array(Integer.TYPE, -1, [this.redMask, this.greenMask, this.blueMask])]);
...
list.add$TE(Clazz.new_($I$(14,1).c$$java_awt_image_ColorModel$java_awt_image_SampleModel,[this.originalColorModel, this.originalSampleModel]));
...
raster=$I$(17).createWritableRaster$java_awt_image_SampleModel$java_awt_Point(this.sampleModel, Clazz.new_($I$(18,1)));
this.bi=Clazz.new_($I$(19,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[this.colorModel, raster, false, null]);
}} else {
...
break;
default:
throw Clazz.new_(Clazz.load('RuntimeException').c$$S,[$I$(2).getString$S("BMPImageReader1")]);
}
break;
case 6:
switch ((this.compression|0)) {
...
case 17:
case 18:
this.bi=p$1.readEmbedded$I$java_awt_image_BufferedImage$javax_imageio_ImageReadParam.apply(this, [(this.compression|0), this.bi, param]);
break;
case 10:
p$1.read1Bit$BA.apply(this, [bdata]);
break;
...
var n=3 * i + k;
for (var b=0; b < this.destBands.length; b++) bdata[n + this.destBands[b]]=(buf[m + this.sourceBands[b]]|0);
...
var imSize=(this.imageSize|0);
if (imSize == 0) {
imSize=((this.bitmapFileSize - this.bitmapOffset)|0);
}var padding=0;
...
for (var i=0; i < this.width; i++) bdata[pos++]=(val[i]|0);
...
for (var i=this.sourceRegion.x; i < this.sourceRegion.x + this.sourceRegion.width; i+=this.scaleX) bdata[pos++]=(val[i]|0);
...
if (this.abortRequested$()) {
break;
}if ((values[count - 1] & 255) == 1) flag=true;
break;
case 2:
...
for (var i=0, j=0; i < this.width >> 1; i++) bdata[pos++]=((((val[j++] << 4) | val[j++])|0)|0);
...
var end=values[count - 1] & 255;
for (var i=0; i < end; i++) {
val[l++]=(((((i & 1) == 0) ? (values[count] & 240) >> 4 : (values[count++] & 15))|0)|0);
}
if ((end & 1) == 1) {
count++;
...
var reader=$I$(20).getImageReadersByFormatName$S(format).next$();
if (reader == null ) {
throw Clazz.new_(Clazz.load('RuntimeException').c$$S,[$I$(2).getString$S("BMPImageReader4") + " " + format ]);
}var buff=Clazz.array(Byte.TYPE, [(this.imageSize|0)]);
this.iis.read$BA(buff);
reader.setInput$O($I$(20).createImageInputStream$O(Clazz.new_($I$(21,1).c$$BA,[buff])));
if (bi == null ) {
...
(function(){/*a*/var C$=Clazz.newClass(P$, "BMPImageReader$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load(['io.scif.media.imageioimpl.plugins.bmp.BMPImageReader','.EmbeddedProgressAdapter']), null, 1);
...
), Clazz.new_($I$(22,1), [this, null],P$.BMPImageReader$1)));
...
Clazz.newMeth(C$, ['warningOccurred$javax_imageio_ImageReader$S','warningOccurred$'], function (source, warning) {
