...
/*c*/var C$=Clazz.newClass(P$, "InvertedCMYKColorSpace", null, 'java.awt.color.ColorSpace');
...
return o != null  && Clazz.instanceOf(o, "io.scif.media.imageioimpl.common.InvertedCMYKColorSpace") ;
});
...
var Y=colorvalue[2];
var K=colorvalue[3];
var rgbvalue=Clazz.array(Float.TYPE, -1, [K * C, K * M, K * Y]);
for (var i=0; i < 3; i++) {
var v=rgbvalue[i];
if (v < 0.0 ) v=0.0;
if (v < 0.0031308 ) {
