...
/*e*/var C$=Clazz.newClass(P$, "ResolutionUnit", null, 'Enum', 'io.scif.enumeration.CodedEnum');

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
$vals=Clazz.array(C$,[0]);
Clazz.newEnumConst($vals, C$.c$$I$S, "NONE", 0, [1, "None"]);
Clazz.newEnumConst($vals, C$.c$$I$S, "INCH", 1, [2, "Inch"]);
Clazz.newEnumConst($vals, C$.c$$I$S, "CENTIMETER", 2, [3, "Centimeter"]);
C$.lookup=Clazz.new_(1,{K:"Integer",V:"io.scif.formats.tiff.ResolutionUnit"},$I$(1,1));
{
...
if (toReturn == null ) {
throw Clazz.new_(Clazz.load('io.scif.enumeration.EnumException').c$$S,["Unable to find ResolutionUnit with code: " + code]);
}return toReturn;
}, 1);
