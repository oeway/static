...
/*c*/var C$=Clazz.newClass(P$, "AnWTFilterInt", null, 'io.scif.jj2000.j2k.wavelet.analysis.AnWTFilter');
...
this.analyze_lpf$IA$I$I$I$IA$I$I$IA$I$I(inSig, inOff, inLen, inStep, lowSig, lowOff, lowStep, highSig, highOff, highStep);
});
...
this.analyze_hpf$IA$I$I$I$IA$I$I$IA$I$I(inSig, inOff, inLen, inStep, lowSig, lowOff, lowStep, highSig, highOff, highStep);
});
