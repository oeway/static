...
/*c*/var C$=Clazz.newClass(P$, "SynWTFilterFloat", null, 'io.scif.jj2000.j2k.wavelet.synthesis.SynWTFilter');
...
this.synthetize_lpf$FA$I$I$I$FA$I$I$I$FA$I$I(lowSig, lowOff, lowLen, lowStep, highSig, highOff, highLen, highStep, outSig, outOff, outStep);
});
...
this.synthetize_hpf$FA$I$I$I$FA$I$I$I$FA$I$I(lowSig, lowOff, lowLen, lowStep, highSig, highOff, highLen, highStep, outSig, outOff, outStep);
});
