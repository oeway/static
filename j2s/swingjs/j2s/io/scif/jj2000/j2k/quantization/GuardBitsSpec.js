...
/*c*/var C$=Clazz.newClass(P$, "GuardBitsSpec", null, 'io.scif.jj2000.j2k.ModuleSpec');
...
;C$.superclazz.c$$I$I$B.apply(this,[nt, nc, ($b$[0] = type, $b$[0])]);C$.$init$.apply(this);
if (values == null ) {
this.setDefault$O( new Integer(this.defaultValue));
return;
}var param=values;
...
throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["Bad parameter for " + "-Qguard_bits option" + " : " + word ]);
} else {
throw e;
}
}
if (value.floatValue$() <= 0.0 ) {
throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["Guard bits value " + "must be positive : " + value ]);
}if (curSpecType == 0) {
