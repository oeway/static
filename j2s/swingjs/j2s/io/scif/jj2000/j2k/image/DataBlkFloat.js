...
/*c*/var C$=Clazz.newClass(P$, "DataBlkFloat", null, 'io.scif.jj2000.j2k.image.DataBlk');
...
this.offset=0;
this.scanw=w;
this.data=Clazz.array(Float.TYPE, [w * h]);
}, 1);

Clazz.newMeth(C$, 'c$$io_scif_jj2000_j2k_image_DataBlkFloat', function (src) {
Clazz.super_(C$, this);
this.ulx=src.ulx;
this.uly=src.uly;
this.w=src.w;
...
this.offset=0;
this.scanw=this.w;
this.data=Clazz.array(Float.TYPE, [this.w * this.h]);
...
Clazz.newMeth(C$, 'getDataFloat$', function () {
return this.data;
});
...
Clazz.newMeth(C$, 'setDataFloat$FA', function (arr) {
this.data=arr;
});
