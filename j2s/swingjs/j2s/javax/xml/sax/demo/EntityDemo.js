(function(){var P$=Clazz.newPackage("javax.xml.sax.demo"),I$=[[0,'java.io.StringReader','javax.xml.sax.helpers.ParserFactory','javax.xml.sax.InputSource','java.net.URL']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
