(function(){var P$=Clazz.newPackage("javax.xml.sax.helpers"),I$=[[0,'javax.xml.sax.helpers.NewInstance','javax.xml.sax.helpers.ParserAdapter','javax.xml.sax.helpers.ParserFactory']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
return Clazz.new_($I$(2,1).c$$javax_xml_sax_Parser,[$I$(3).makeParser$()]);
} catch (e) {
