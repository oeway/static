(function(){var P$=Clazz.newPackage("javax.xml.sax.helpers"),p$1={},I$=[[0,'java.util.Vector','javax.xml.sax.helpers.NamespaceSupport','java.util.Hashtable',['javax.xml.sax.helpers.NamespaceSupport','.Context']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
