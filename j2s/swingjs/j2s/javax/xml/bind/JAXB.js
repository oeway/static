...
var url=xml;
return Clazz.new_($I$(3,1).c$$S,[url.toExternalForm$()]);
...
if (r == null ) {
jaxbObject=Clazz.new_($I$(7,1).c$$javax_xml_namespace_QName$Class$TT,[Clazz.new_($I$(8,1).c$$S,[C$.inferName$Class(clazz)]), clazz, jaxbObject]);
...
con.connect$();
return Clazz.new_($I$(10,1).c$$java_io_OutputStream,[con.getOutputStream$()]);
