...
return Clazz.new_($I$(5,1).c$$S,[C$.removeOptionalPlus$CharSequence($I$(6).trim$CharSequence(s)).toString()]);
}, 1);
...
if (content.length$() <= 0) {
return null;
}return Clazz.new_($I$(7,1).c$$S,[content.toString()]);
}, 1);
