(function(){var P$=Clazz.newPackage("javax.xml.bind.helpers"),p$1={},I$=[[0,'javax.xml.bind.helpers.DefaultValidationEventHandler','javax.xml.transform.stream.StreamResult','java.io.BufferedOutputStream','java.io.FileOutputStream','javax.xml.transform.sax.SAXResult','javax.xml.transform.dom.DOMResult','Boolean','javax.xml.bind.helpers.Messages']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
var os=Clazz.new_($I$(3,1).c$$java_io_OutputStream,[Clazz.new_($I$(4,1).c$$java_io_File,[output])]);
try {
