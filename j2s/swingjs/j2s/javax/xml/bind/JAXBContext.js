(function(){var P$=Clazz.newPackage("javax.xml.bind"),I$=[[0,'java.util.Collections','javax.xml.bind.ContextFinder','org.w3c.dom.Node','Thread','java.security.AccessController']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
