(function(){var P$=Clazz.newPackage("javax.xml.parsers"),I$=[[0,'org.xml.sax.InputSource']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}var input=Clazz.new_($I$(1,1).c$$S,[f.toURI$().toASCIIString$()]);
this.parse$org_xml_sax_InputSource$org_xml_sax_HandlerBase(input, hb);
});
