(function(){var P$=Clazz.newPackage("javax.xml.xpath"),p$1={},I$=[[0,'javax.xml.xpath.SecuritySupport','java.util.Properties','javax.xml.xpath.XPathFactory','java.io.File','java.io.BufferedReader','java.io.InputStreamReader','javax.xml.xpath.XPathFactoryFinder',['javax.xml.xpath.XPathFactoryFinder','.SingleIterator'],'java.util.ArrayList']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
,['Z',['debug','firstTime'],'S',['SERVICE_ID'],'O',['ss','javax.xml.xpath.SecuritySupport','cacheProps','java.util.Properties','SERVICE_CLASS','Class']]]
...
try {
xpathFactory=p$1.loadFromService$S$S$java_io_InputStream.apply(this, [uri, resource.toExternalForm$(), C$.ss.getURLInputStream$java_net_URL(resource)]);
if (xpathFactory != null ) {
return xpathFactory;
}} catch (e) {
...
var creationMethod=providerClass.getDeclaredMethod$S$ClassA("newXPathFactoryNoServiceLoader", []);
...
if (this.classLoader == null ) {
return ((P$.XPathFactoryFinder$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "XPathFactoryFinder$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load(['javax.xml.xpath.XPathFactoryFinder','.SingleIterator']), null, 1);
...
), Clazz.new_($I$(8,1), [this, null],P$.XPathFactoryFinder$1));
} else {
try {
var e=C$.ss.getResources$ClassLoader$S(this.classLoader, C$.SERVICE_ID);
if (!e.hasMoreElements$()) {
C$.debugPrintln$S("no " + C$.SERVICE_ID + " file was found" );
}return ((P$.XPathFactoryFinder$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "XPathFactoryFinder$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.Iterator', 1);
...
), Clazz.new_(P$.XPathFactoryFinder$2.$init$, [this, {e:e}]));
} catch (e) {
if (Clazz.exceptionOf(e,"java.io.IOException")){
