(function(){var P$=Clazz.newPackage("javax.xml.xpath"),I$=[[0,'javax.xml.xpath.SecuritySupport','javax.xml.xpath.XPathFactoryFinder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
