(function(){var P$=Clazz.newPackage("javax.xml.datatype"),I$=[[0,['javax.xml.datatype.DatatypeConstants','.Field'],'javax.xml.namespace.QName']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
