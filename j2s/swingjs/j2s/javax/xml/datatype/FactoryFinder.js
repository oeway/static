(function(){var P$=Clazz.newPackage("javax.xml.datatype"),I$=[[0,'java.util.Properties','javax.xml.datatype.SecuritySupport',['javax.xml.datatype.FactoryFinder','.ConfigurationError'],'java.io.File']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
