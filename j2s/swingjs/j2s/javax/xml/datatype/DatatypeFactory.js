(function(){var P$=Clazz.newPackage("javax.xml.datatype"),I$=[[0,'java.util.regex.Pattern','javax.xml.datatype.FactoryFinder','java.math.BigInteger','java.math.BigDecimal','javax.xml.datatype.DatatypeConstants']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
