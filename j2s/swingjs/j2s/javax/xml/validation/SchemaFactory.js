(function(){var P$=Clazz.newPackage("javax.xml.validation"),I$=[[0,'javax.xml.validation.SecuritySupport','javax.xml.validation.SchemaFactoryFinder','javax.xml.transform.Source','javax.xml.transform.stream.StreamSource']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return this.newSchema$javax_xml_transform_Source(Clazz.new_($I$(4,1).c$$S,[schema.toExternalForm$()]));
});
})();
