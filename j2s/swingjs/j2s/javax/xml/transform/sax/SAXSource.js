(function(){var P$=Clazz.newPackage("javax.xml.transform.sax"),I$=[[0,'org.xml.sax.InputSource']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var ss=source;
var isource=Clazz.new_($I$(1,1).c$$S,[ss.getSystemId$()]);
