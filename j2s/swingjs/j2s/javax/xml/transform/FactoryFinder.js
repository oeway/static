(function(){var P$=Clazz.newPackage("javax.xml.transform"),I$=[[0,'java.util.Properties','javax.xml.transform.SecuritySupport',['javax.xml.transform.FactoryFinder','.ConfigurationError'],'java.io.File']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var creationMethod=providerClass.getDeclaredMethod$S$ClassA("newTransformerFactoryNoServiceLoader", []);
