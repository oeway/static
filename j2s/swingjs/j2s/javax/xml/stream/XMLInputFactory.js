(function(){var P$=Clazz.newPackage("javax.xml.stream"),I$=[[0,'swingjs.xml.JSXMLInputFactory','javax.xml.stream.FactoryFinder','javax.xml.stream.FactoryConfigurationError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
throw Clazz.new_($I$(3,1).c$$Exception$S,[e.getException$(), e.getMessage$()]);
} else {
throw e;
}
}
