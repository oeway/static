(function(){var P$=Clazz.newPackage("javax.xml.stream"),I$=[[0,'java.security.AccessController','Thread','java.io.FileInputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
