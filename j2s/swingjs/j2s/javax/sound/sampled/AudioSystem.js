...
return Clazz.new_($I$(3,1).c$$javax_sound_sampled_AudioFileFormat_Type$javax_sound_sampled_AudioFormat$I,[$I$(4).getType$javax_sound_sampled_AudioFormat(format), format, -1]);
}, 1);
...
return C$.getAudioInputStream$java_io_ByteArrayInputStream(Clazz.new_($I$(5,1).c$$BA,[$I$(6).getLimitedStreamBytes$java_io_InputStream$J(stream, -1)]));
}, 1);
