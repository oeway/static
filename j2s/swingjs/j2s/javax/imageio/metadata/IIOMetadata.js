(function(){var P$=Clazz.newPackage("javax.imageio.metadata"),p$1={},I$=[[0,'javax.imageio.metadata.IIOMetadataFormatImpl','java.security.AccessController','Thread','javax.imageio.metadata.IIOMetadataNode']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
