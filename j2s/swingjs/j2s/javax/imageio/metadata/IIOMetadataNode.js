(function(){var P$=Clazz.newPackage("javax.imageio.metadata"),p$1={},I$=[[0,'java.util.ArrayList','javax.imageio.metadata.IIONamedNodeMap','javax.imageio.metadata.IIOAttr','javax.imageio.metadata.IIONodeList']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.attributes.add$TE(Clazz.new_($I$(3,1).c$$org_w3c_dom_Element$S$S,[this, name, value]));
});
...
attr=Clazz.new_($I$(3,1).c$$org_w3c_dom_Element$S$S,[this, newAttr.getName$(), newAttr.getValue$()]);
}var oldAttr=this.getAttributeNode$S(attr.getName$());
if (oldAttr != null ) {
this.removeAttributeNode$org_w3c_dom_Attr(oldAttr);
}this.attributes.add$TE(attr);
return oldAttr;
});
