(function(){var P$=Clazz.newPackage("javax.imageio"),I$=[[0,'javax.imageio.ImageIO','Boolean','javax.imageio.spi.ImageReaderSpi','java.util.Arrays','javax.imageio.spi.ImageWriterSpi',['javax.imageio.ImageIO','.SpiInfo'],'swingjs.JSUtil','java.util.HashSet','swingjs.image.PngImageWriter','swingjs.image.JpgImageWriter','swingjs.image.GifImageWriter','javax.imageio.spi.IIORegistry','sun.awt.AppContext',['javax.imageio.ImageIO','.CacheInfo'],'sun.security.action.GetPropertyAction','java.security.AccessController','java.io.File','java.io.FilePermission','javax.imageio.spi.ImageInputStreamSpi','javax.imageio.spi.ImageOutputStreamSpi','java.util.Collections',['javax.imageio.ImageIO','.CanDecodeInputFilter'],['javax.imageio.ImageIO','.ImageReaderIterator'],['javax.imageio.ImageIO','.ContainsFilter'],['javax.imageio.ImageIO','.ImageWriterIterator'],['javax.imageio.ImageIO','.CanEncodeImageAndFormatFilter'],['javax.imageio.ImageIO','.TranscoderFilter'],'javax.imageio.spi.ImageTranscoderSpi',['javax.imageio.ImageIO','.ImageTranscoderIterator'],'java.awt.Toolkit','java.io.BufferedInputStream','javax.imageio.ImageTypeSpecifier']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
if (C$.useSPI) {
C$.readerFormatNamesMethod=Clazz.getClass($I$(3)).getMethod$S$ClassA("getFormatNames", []);
C$.readerFileSuffixesMethod=Clazz.getClass($I$(3)).getMethod$S$ClassA("getFileSuffixes", []);
C$.readerMIMETypesMethod=Clazz.getClass($I$(3)).getMethod$S$ClassA("getMIMETypes", []);
C$.writerFormatNamesMethod=Clazz.getClass($I$(5)).getMethod$S$ClassA("getFormatNames", []);
C$.writerFileSuffixesMethod=Clazz.getClass($I$(5)).getMethod$S$ClassA("getFileSuffixes", []);
C$.writerMIMETypesMethod=Clazz.getClass($I$(5)).getMethod$S$ClassA("getMIMETypes", []);
}} catch (e) {
...
return (C$.useSPI ? C$.getReaderWriterInfo$Class$javax_imageio_ImageIO_SpiInfo(Clazz.getClass($I$(3)), $I$(6).FORMAT_NAMES) : C$.readerFormatNames);
}, 1);

Clazz.newMeth(C$, 'getReaderMIMETypes$', function () {
return C$.useSPI ? C$.getReaderWriterInfo$Class$javax_imageio_ImageIO_SpiInfo(Clazz.getClass($I$(3)), $I$(6).MIME_TYPES) : C$.readerTypes;
}, 1);

Clazz.newMeth(C$, 'getReaderFileSuffixes$', function () {
return C$.useSPI ? C$.getReaderWriterInfo$Class$javax_imageio_ImageIO_SpiInfo(Clazz.getClass($I$(3)), $I$(6).FILE_SUFFIXES) : C$.readerSuffixes;
}, 1);
...
$I$(7).notImplemented$S("ImageIO.read(ImageInputStream");
return null;
}, 1);
...
}var set=Clazz.new_(1,{E:"javax.imageio.ImageWriter"},$I$(8,1));
switch (formatName.toLowerCase$()) {
case "png":
set.add$TE(Clazz.new_($I$(9,1)));
break;
case "jpg":
case "jpeg":
set.add$TE(Clazz.new_($I$(10,1)));
break;
case "gif":
set.add$TE(Clazz.new_($I$(11,1)));
break;
default:
break;
}
...
var a=Clazz.new_($I$(15,1).c$$S,["java.io.tmpdir"]);
return $I$(16).doPrivileged$java_security_PrivilegedAction(a);
}, 1);
...
C$.getCacheInfo$().setHasPermission$Boolean($I$(2).FALSE);
return false;
}}var filepath=cachepath;
if (!filepath.endsWith$S($I$(17).separator)) {
filepath += $I$(17).separator;
}filepath += "*";
security.checkPermission$java_security_Permission(Clazz.new_($I$(18,1).c$$S$S,[filepath, "read, write, delete"]));
}} catch (e) {
...
C$.getCacheInfo$().setHasPermission$Boolean($I$(2).TRUE);
return true;
}}, 1);
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$Z(Clazz.getClass($I$(19)), true);
} catch (e) {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$Z(Clazz.getClass($I$(20)), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return null;
} else {
...
var s=Clazz.new_(1,{E:"String"},$I$(8,1));
while (iter.hasNext$()){
var spi=iter.next$();
$I$(21).addAll$java_util_Collection$TTA(s, spiInfo.info$javax_imageio_spi_ImageReaderWriterSpi(spi));
}
return s.toArray$TTA(Clazz.array(String, [s.size$()]));
}, 1);
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(3)), Clazz.new_($I$(22,1).c$$O,[input]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
throw e;
}
}
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(3)), Clazz.new_($I$(24,1).c$$reflect_Method$S,[C$.readerFormatNamesMethod, formatName]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(3)), Clazz.new_($I$(24,1).c$$reflect_Method$S,[C$.readerFileSuffixesMethod, fileSuffix]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(3)), Clazz.new_($I$(24,1).c$$reflect_Method$S,[C$.readerMIMETypesMethod, MIMEType]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
...
return C$.getReaderWriterInfo$Class$javax_imageio_ImageIO_SpiInfo(Clazz.getClass($I$(5)), $I$(6).FORMAT_NAMES);
}, 1);

Clazz.newMeth(C$, 'getWriterMIMETypes$', function () {
return C$.getReaderWriterInfo$Class$javax_imageio_ImageIO_SpiInfo(Clazz.getClass($I$(5)), $I$(6).MIME_TYPES);
}, 1);

Clazz.newMeth(C$, 'getWriterFileSuffixes$', function () {
return C$.getReaderWriterInfo$Class$javax_imageio_ImageIO_SpiInfo(Clazz.getClass($I$(5)), $I$(6).FILE_SUFFIXES);
}, 1);
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(5)), Clazz.new_($I$(24,1).c$$reflect_Method$S,[C$.writerFormatNamesMethod, formatName]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
...
return Clazz.new_($I$(25,1).c$$java_util_Iterator,[iter]);
}, 1);
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(5)), Clazz.new_($I$(24,1).c$$reflect_Method$S,[C$.writerFileSuffixesMethod, fileSuffix]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(5)), Clazz.new_($I$(24,1).c$$reflect_Method$S,[C$.writerMIMETypesMethod, MIMEType]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
...
var readerSpiIter;
try {
readerSpiIter=C$.getRegistry$().getServiceProviders$Class$Z(Clazz.getClass($I$(3)), false);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return null;
} else {
...
if (Clazz.exceptionOf(e,"java.io.IOException")){
C$.getRegistry$().deregisterServiceProvider$TT$Class(writerSpi, Clazz.getClass($I$(5)));
return null;
} else {
throw e;
}
...
var writerSpiIter;
try {
writerSpiIter=C$.getRegistry$().getServiceProviders$Class$Z(Clazz.getClass($I$(5)), false);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return null;
} else {
...
if (Clazz.exceptionOf(e,"java.io.IOException")){
C$.getRegistry$().deregisterServiceProvider$TT$Class(readerSpi, Clazz.getClass($I$(3)));
return null;
} else {
throw e;
}
...
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(5)), Clazz.new_($I$(26,1).c$$javax_imageio_ImageTypeSpecifier$S,[type, formatName]), true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
...
var writerSpi=writer.getOriginatingProvider$();
var filter=Clazz.new_($I$(27,1).c$$javax_imageio_spi_ImageReaderSpi$javax_imageio_spi_ImageWriterSpi,[readerSpi, writerSpi]);
var iter;
try {
iter=C$.getRegistry$().getServiceProviders$Class$javax_imageio_spi_ServiceRegistry_Filter$Z(Clazz.getClass($I$(28)), filter, true);
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(21).emptyIterator$();
} else {
...
return Clazz.new_($I$(29,1).c$$java_util_Iterator,[iter]);
}, 1);
...
return $I$(30).getDefaultToolkit$().createImage$BA($I$(7).getSignedStreamBytes$java_io_BufferedInputStream(Clazz.instanceOf(input, "java.io.BufferedInputStream") ? input : Clazz.new_($I$(31,1).c$$java_io_InputStream,[input])));
}, 1);
...
var type=$I$(32).createFromRenderedImage$java_awt_image_RenderedImage(im);
...
if (Clazz.exceptionOf(e,"java.io.IOException")){
P$.ImageIO.getRegistry$().deregisterServiceProvider$TT$Class(spi, Clazz.getClass($I$(3)));
} else {
throw e;
}
}
...
Clazz.newMeth(C$, ['filter$O','filter$'], function (elt) {
try {
var spi=elt;
var stream=null;
...
Clazz.newMeth(C$, ['filter$O','filter$'], function (elt) {
var spi=elt;
return $I$(4).asList$TTA(spi.getFormatNames$()).contains$O(this.formatName) && spi.canEncodeImage$javax_imageio_ImageTypeSpecifier(this.type) ;
});
...
Clazz.newMeth(C$, 'c$$reflect_Method$S', function (method, name) {
;C$.$init$.apply(this);
this.method=method;
this.name=name;
}, 1);
...
Clazz.newMeth(C$, ['filter$O','filter$'], function (elt) {
try {
return P$.ImageIO.contains$SA$S(this.method.invoke$O$OA(elt, []), this.name);
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return false;
} else {
...
if (Clazz.exceptionOf(e,"java.io.IOException")){
P$.ImageIO.getRegistry$().deregisterServiceProvider$TT$Class(spi, Clazz.getClass($I$(5)));
} else {
throw e;
}
}
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:15 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
