(function(){var P$=Clazz.newPackage("javax.imageio.stream"),I$=[[0,'java.nio.file.Files','java.io.RandomAccessFile','com.sun.imageio.stream.StreamCloser']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['L',['maxStreamPos'],'O',['stream','java.io.OutputStream','cacheFile','java.io.File','cache','java.io.RandomAccessFile','closeAction','com.sun.imageio.stream.StreamCloser.CloseAction']]]
...
while (flushBytes > 0){
var len=(Math.min(flushBytes, bufLen)|0);
