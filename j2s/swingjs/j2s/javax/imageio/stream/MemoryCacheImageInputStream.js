(function(){var P$=Clazz.newPackage("javax.imageio.stream"),I$=[[0,'javax.imageio.stream.MemoryCache',['javax.imageio.stream.MemoryCacheImageInputStream','.StreamDisposerRecord'],'sun.java2d.Disposer','com.sun.imageio.stream.StreamFinalizer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.checkClosed$();
this.bitOffset=0;
var pos=this.cache.loadFromStream$java_io_InputStream$J(this.stream, this.streamPos + 1);
if (pos >= this.streamPos + 1) {
return this.cache.read$J(this.streamPos++);
} else {
return -1;
}});
...
if (len == 0) {
return 0;
}var pos=this.cache.loadFromStream$java_io_InputStream$J(this.stream, this.streamPos + len);
len=((pos - this.streamPos)|0);
if (len > 0) {
