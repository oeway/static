(function(){var P$=Clazz.newPackage("javax.imageio.stream"),p$1={},I$=[[0,'java.util.Stack','java.nio.ByteOrder','StringBuffer','java.io.DataInputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['isClosed'],'I',['bitOffset'],'L',['streamPos','flushedPos'],'O',['markByteStack','java.util.Stack','+markBitStack','byteBuf','byte[]','byteOrder','java.nio.ByteOrder']]]
...
return (this.readInt$()) & 4294967295;
});
...
var i2=this.readInt$();
if (this.byteOrder === $I$(2).BIG_ENDIAN ) {
return (i1 << 32) + (i2 & 4294967295);
} else {
return (i2 << 32) + (i1 & 4294967295);
}});
...
this.seek$J(pos + n);
return ((this.getStreamPosition$() - pos)|0);
});
...
try {
this.markByteStack.push$TE(Long.valueOf$J(this.getStreamPosition$()));
this.markBitStack.push$TE(Integer.valueOf$I(this.getBitOffset$()));
} catch (e) {
if (Clazz.exceptionOf(e,"java.io.IOException")){
} else {
throw e;
