(function(){var P$=Clazz.newPackage("javax.imageio.stream"),I$=[[0,'java.nio.ByteOrder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.byteBuf[0]=(((v >>> 8)|0)|0);
this.byteBuf[1]=(((v >>> 0)|0)|0);
} else {
this.byteBuf[0]=(((v >>> 0)|0)|0);
this.byteBuf[1]=(((v >>> 8)|0)|0);
...
if (this.byteOrder === $I$(1).BIG_ENDIAN ) {
this.byteBuf[0]=(((v >>> 24)|0)|0);
this.byteBuf[1]=(((v >>> 16)|0)|0);
this.byteBuf[2]=(((v >>> 8)|0)|0);
this.byteBuf[3]=(((v >>> 0)|0)|0);
} else {
this.byteBuf[0]=(((v >>> 0)|0)|0);
this.byteBuf[1]=(((v >>> 8)|0)|0);
this.byteBuf[2]=(((v >>> 16)|0)|0);
this.byteBuf[3]=(((v >>> 24)|0)|0);
}this.write$BA$I$I(this.byteBuf, 0, 4);
});

Clazz.newMeth(C$, 'writeLong$J', function (v) {
if (this.byteOrder === $I$(1).BIG_ENDIAN ) {
this.byteBuf[0]=(((v >>> 56)|0)|0);
this.byteBuf[1]=(((v >>> 48)|0)|0);
this.byteBuf[2]=(((v >>> 40)|0)|0);
this.byteBuf[3]=(((v >>> 32)|0)|0);
this.byteBuf[4]=(((v >>> 24)|0)|0);
this.byteBuf[5]=(((v >>> 16)|0)|0);
this.byteBuf[6]=(((v >>> 8)|0)|0);
this.byteBuf[7]=(((v >>> 0)|0)|0);
} else {
this.byteBuf[0]=(((v >>> 0)|0)|0);
this.byteBuf[1]=(((v >>> 8)|0)|0);
this.byteBuf[2]=(((v >>> 16)|0)|0);
this.byteBuf[3]=(((v >>> 24)|0)|0);
this.byteBuf[4]=(((v >>> 32)|0)|0);
this.byteBuf[5]=(((v >>> 40)|0)|0);
this.byteBuf[6]=(((v >>> 48)|0)|0);
this.byteBuf[7]=(((v >>> 56)|0)|0);
}this.write$BA$I$I(this.byteBuf, 0, 4);
...
b[boff++]=((((utflen >>> 8) & 255)|0)|0);
b[boff++]=((((utflen >>> 0) & 255)|0)|0);
for (var i=0; i < strlen; i++) {
c=charr[i].$c();
if ((c >= 1) && (c <= 127) ) {
b[boff++]=((c|0)|0);
} else if (c > 2047) {
b[boff++]=(((224 | ((c >> 12) & 15))|0)|0);
b[boff++]=(((128 | ((c >> 6) & 63))|0)|0);
b[boff++]=(((128 | ((c >> 0) & 63))|0)|0);
} else {
b[boff++]=(((192 | ((c >> 6) & 31))|0)|0);
b[boff++]=(((128 | ((c >> 0) & 63))|0)|0);
}}
...
return;
}if ((this.getStreamPosition$() > 0) || (this.bitOffset > 0) ) {
var offset=this.bitOffset;
var partialByte=this.read$();
if (partialByte != -1) {
this.seek$J(this.getStreamPosition$() - 1);
} else {
partialByte=0;
}if (numBits + offset < 8) {
...
var value=(((shift == 0) ? bits & 255 : (bits >> shift) & 255)|0);
this.write$I(value);
}
numBits=extra;
}if (numBits != 0) {
