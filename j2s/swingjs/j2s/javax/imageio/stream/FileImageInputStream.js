(function(){var P$=Clazz.newPackage("javax.imageio.stream"),I$=[[0,'java.io.RandomAccessFile','com.sun.imageio.stream.CloseableDisposerRecord','sun.java2d.Disposer','com.sun.imageio.stream.StreamFinalizer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
