(function(){var P$=Clazz.newPackage("javax.imageio"),p$1={},I$=[[0,'javax.imageio.ImageReadParam','java.util.ArrayList','javax.imageio.IIOImage','java.util.Locale','java.security.AccessController','Thread','java.util.ResourceBundle','java.awt.Rectangle']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
thumbnails.add$TE(this.readThumbnail$I$I(imageIndex, j));
}
...
if (image != null ) {
var destImageRect=Clazz.new_($I$(8,1).c$$I$I$I$I,[0, 0, image.getWidth$(), image.getHeight$()]);
