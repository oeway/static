(function(){var P$=Clazz.newPackage("javax.print.attribute"),p$1={},I$=[[0,'java.util.HashMap','javax.print.attribute.Attribute','javax.print.attribute.AttributeSetUtilities']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
