(function(){var P$=Clazz.newPackage("javax.annotation"),I$=[[0,'java.util.regex.Pattern','javax.annotation.meta.When']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
Clazz.newMeth(C$, ['forConstantValue$javax_annotation_MatchesPattern$O','forConstantValue$','forConstantValue$TA$O'], function (annotation, value) {
