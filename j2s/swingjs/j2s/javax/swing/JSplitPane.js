(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'javax.swing.JButton','javax.swing.UIManager','Boolean']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['continuousLayout','dividerSizeSet','oneTouchExpandable','oneTouchExpandableSet','dividerLocationSetByUser'],'D',['resizeWeight'],'I',['orientation','dividerSize','lastDividerLocation','dividerLocation'],'O',['leftComponent','java.awt.Component','+rightComponent']]]

Clazz.newMeth(C$, 'c$', function () {
C$.c$$I$Z$java_awt_Component$java_awt_Component.apply(this, [1, false, Clazz.new_($I$(1,1).c$$S,[$I$(2).getString$O("SplitPane.leftButtonText")]), Clazz.new_($I$(1,1).c$$S,[$I$(2).getString$O("SplitPane.rightButtonText")])]);
}, 1);
