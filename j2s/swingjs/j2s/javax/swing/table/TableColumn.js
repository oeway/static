(function(){var P$=Clazz.newPackage("javax.swing.table"),p$1={},I$=[[0,'Boolean','javax.swing.event.SwingPropertyChangeSupport','java.beans.PropertyChangeListener','javax.swing.UIManager','javax.swing.table.DefaultTableCellRenderer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
), Clazz.new_($I$(5,1), [this, null],P$.TableColumn$1));
