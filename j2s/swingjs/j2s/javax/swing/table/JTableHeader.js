...
newEvent=Clazz.new_($I$(2,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I,[component, event.getID$(), event.getWhen$(), event.getModifiers$(), p.x, p.y, event.getXOnScreen$(), event.getYOnScreen$(), event.getClickCount$(), event.isPopupTrigger$(), 0]);
