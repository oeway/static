(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'javax.swing.BoxLayout',['javax.swing.JToolBar','.DefaultToolBarLayout'],'java.awt.JSComponent','java.awt.Insets','Boolean',['javax.swing.JToolBar','.Separator'],'javax.swing.JButton']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.setLayout$java_awt_LayoutManager(Clazz.new_($I$(2,1).c$$I, [this, null, this.getOrientation$()]));
}this.invalidate$();
});
...
var s=Clazz.new_($I$(6,1).c$$java_awt_Dimension,[size]);
...
), Clazz.new_($I$(7,1), [this, null],P$.JToolBar$1));
