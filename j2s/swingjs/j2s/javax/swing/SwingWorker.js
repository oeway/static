(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'javax.swing.Timer','javax.swing.SwingUtilities','StringBuilder',['javax.swing.SwingWorker','.StateValue'],'java.util.concurrent.FutureTask',['javax.swing.SwingWorker','.SwingWorkerPropertyChangeSupport'],'sun.swing.AccumulativeRunnable','sun.awt.AppContext',['javax.swing.SwingWorker','.DoSubmitAccumulativeRunnable']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.DO_SUBMIT_KEY=Clazz.new_($I$(3,1).c$$S,["doSubmit"]);
}
...
p$1.setState$javax_swing_SwingWorker_StateValue.apply(this.b$['javax.swing.SwingWorker'], [$I$(4).STARTED]);
...
p$1.setState$javax_swing_SwingWorker_StateValue.apply(this.b$['javax.swing.SwingWorker'], [$I$(4).DONE]);
});
})()
), Clazz.new_(1,{V:"Object"},$I$(5,1).c$$java_util_concurrent_Callable, [this, null, callable],P$.SwingWorker$2));
this.state=$I$(4).PENDING;
this.propertyChangeSupport=Clazz.new_($I$(6,1).c$$O, [this, null, this]);
this.doProcess=null;
...
Clazz.newMeth(C$, ['publish$TVA'], function (chunks) {
{
...
this.b$['javax.swing.SwingWorker'].doSubmit.add$TTA([this]);
});
})()
), Clazz.new_(1,{T:"Object"},$I$(7,1), [this, null],P$.SwingWorker$3));
}}this.doProcess.add$TTA(chunks);
});
...
), Clazz.new_(1,{T:"Integer"},$I$(7,1), [this, null],P$.SwingWorker$4));
}}this.doNotifyProgressChange.add$TTA([new Integer(oldProgress), new Integer(progress)]);
});
...
if (doSubmit == null ) {
doSubmit=Clazz.new_($I$(9,1));
appContext.put$O$O(C$.DO_SUBMIT_KEY, doSubmit);
}return doSubmit;
}}, 1);
C$.$getAnn$ = function(){ return [
[['M:publish','void',['publish$TVA'],['SafeVarargs']],['']]]}
;
...
this.this$0.doSubmit.add$TTA([((P$.SwingWorker$SwingWorkerPropertyChangeSupport$1||
