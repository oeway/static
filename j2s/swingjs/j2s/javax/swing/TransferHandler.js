...
C$.recognizer=null;
C$.cutAction=Clazz.new_($I$(13,1).c$$S,["cut"]);
C$.copyAction=Clazz.new_($I$(13,1).c$$S,["copy"]);
C$.pasteAction=Clazz.new_($I$(13,1).c$$S,["paste"]);
}
...
C$.recognizer=Clazz.new_($I$(15,1).c$$java_awt_dnd_DragGestureListener,[Clazz.new_($I$(16,1))]);
...
Clazz.newMeth(C$, '$init$', function () {
this.outer=Clazz.new_($I$(6,1));
this.inner=Clazz.new_($I$(6,1));
this.hysteresis=10;
this.support=Clazz.new_($I$(7,1).c$$java_awt_Component$java_awt_dnd_DropTargetEvent,[null, null]);
}, 1);
...
var i=Clazz.new_($I$(8,1).c$$I$I$I$I,[0, 0, 0, 0]);
...
var r=Clazz.new_($I$(6,1).c$$I$I$I$I,[this.inner.x, this.outer.y - dy, this.inner.width, dy]);
c.scrollRectToVisible$java_awt_Rectangle(r);
} else if (pos.y > (this.inner.y + this.inner.height)) {
var dy=s.getScrollableUnitIncrement$java_awt_Rectangle$I$I(this.outer, 1, 1);
var r=Clazz.new_($I$(6,1).c$$I$I$I$I,[this.inner.x, this.outer.y + this.outer.height, this.inner.width, dy]);
c.scrollRectToVisible$java_awt_Rectangle(r);
}if (pos.x < this.inner.x) {
var dx=s.getScrollableUnitIncrement$java_awt_Rectangle$I$I(this.outer, 0, -1);
var r=Clazz.new_($I$(6,1).c$$I$I$I$I,[this.outer.x - dx, this.inner.y, dx, this.inner.height]);
c.scrollRectToVisible$java_awt_Rectangle(r);
} else if (pos.x > (this.inner.x + this.inner.width)) {
var dx=s.getScrollableUnitIncrement$java_awt_Rectangle$I$I(this.outer, 0, 1);
var r=Clazz.new_($I$(6,1).c$$I$I$I$I,[this.outer.x + this.outer.width, this.inner.y, dx, this.inner.height]);
c.scrollRectToVisible$java_awt_Rectangle(r);
}}}, p$2);
...
this.timer=Clazz.new_($I$(10,1).c$$I$java_awt_event_ActionListener,[prop == null  ? 100 : prop.intValue$(), this]);
...
;C$.superclazz.c$$java_awt_dnd_DragSource$java_awt_Component$I$java_awt_dnd_DragGestureListener.apply(this,[$I$(11).getDefaultDragSource$(), null, 0, dgl]);C$.$init$.apply(this);
}, 1);
...
if (trans != null ) {
th.importData$javax_swing_TransferHandler_TransferSupport(Clazz.new_($I$(7,1).c$$java_awt_Component$java_awt_datatransfer_Transferable,[c, trans]));
}}}, p$3);
