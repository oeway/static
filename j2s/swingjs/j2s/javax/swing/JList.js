...
), Clazz.new_(1,{E:"Object"},$I$(3,1), [this, {listData:listData}],P$.JList$1))]);
}, 1);
...
), Clazz.new_(1,{E:"Object"},$I$(3,1), [this, {listData:listData}],P$.JList$2))]);
}, 1);
...
), Clazz.new_(1,{E:"Object"},$I$(3,1), [this, null],P$.JList$3))]);
}, 1);
...
first=this.locationToIndex$java_awt_Point(Clazz.new_($I$(5,1).c$$I$I,[(r.x + r.width) - 1, r.y]));
}if (first != -1) {
...
var lastPoint;
if (leftToRight) {
lastPoint=Clazz.new_($I$(5,1).c$$I$I,[(r.x + r.width) - 1, (r.y + r.height) - 1]);
} else {
lastPoint=Clazz.new_($I$(5,1).c$$I$I,[r.x, (r.y + r.height) - 1]);
...
case $I$(1).USE_SELECTION:
case $I$(1).ON:
location=Clazz.new_($I$(6,1).c$$java_awt_Point$I$Z,[p, (rect != null  && rect.contains$java_awt_Point(p) ) ? index : -1, false]);
break;
case $I$(1).INSERT:
if (index == -1) {
location=Clazz.new_($I$(6,1).c$$java_awt_Point$I$Z,[p, this.getModel$().getSize$(), true]);
break;
...
newEvent=Clazz.new_($I$(10,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I,[rComponent, event.getID$(), event.getWhen$(), event.getModifiers$(), p.x, p.y, event.getXOnScreen$(), event.getYOnScreen$(), event.getClickCount$(), event.isPopupTrigger$(), 0]);
...
), Clazz.new_(1,{E:"Object"},$I$(3,1), [this, {listData:listData}],P$.JList$5)));
});
...
}var selectedItems=Clazz.new_(1,{E:"Object"},$I$(16,1));
for (var i=iMin; i <= iMax; i++) {
if (sm.isSelectedIndex$I(i)) {
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:23 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
