(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.awt.Toolkit','javax.swing.SwingUtilities',['javax.swing.Popup','.DefaultFrame'],['javax.swing.Popup','.HeavyWeightWindow']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(4,1).c$$java_awt_Window,[p$1.getParentWindow$java_awt_Component.apply(this, [owner])]);
});
