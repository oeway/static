...
return Clazz.new_($I$(3,1).c$$javax_swing_MultiUIDefaults_MultiUIDefaultsEnumerator_Type$java_util_Set,[$I$(1).KEYS, this.entrySet$()]);
});

Clazz.newMeth(C$, 'elements$', function () {
return Clazz.new_($I$(3,1).c$$javax_swing_MultiUIDefaults_MultiUIDefaultsEnumerator_Type$java_util_Set,[$I$(1).ELEMENTS, this.entrySet$()]);
});

Clazz.newMeth(C$, 'entrySet$', function () {
var set=Clazz.new_(1,{E:"java.util.Map.Entry"},$I$(4,1));
