...
Clazz.newMeth(C$, '$init$', function () {
this.horizontalHistory=Clazz.new_(1,{V:"String"},$I$(1,1));
this.verticalHistory=Clazz.new_(1,{V:"String"},$I$(1,1));
}, 1);
