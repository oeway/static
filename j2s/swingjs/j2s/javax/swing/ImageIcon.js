(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'StringBuilder','java.awt.Toolkit']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['loadStatus','width','height'],'S',['filename','description'],'O',['location','java.net.URL','image','java.awt.Image','imageObserver','java.awt.image.ImageObserver']]
