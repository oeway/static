...
var root=Clazz.new_($I$(4,1).c$$O,["JTree"]);
var parent;
parent=Clazz.new_($I$(4,1).c$$O,["colors"]);
root.add$javax_swing_tree_MutableTreeNode(parent);
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["blue"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["violet"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["red"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["yellow"]));
parent=Clazz.new_($I$(4,1).c$$O,["sports"]);
root.add$javax_swing_tree_MutableTreeNode(parent);
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["basketball"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["soccer"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["football"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["hockey"]));
parent=Clazz.new_($I$(4,1).c$$O,["food"]);
root.add$javax_swing_tree_MutableTreeNode(parent);
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["hot dogs"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["pizza"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["ravioli"]));
parent.add$javax_swing_tree_MutableTreeNode(Clazz.new_($I$(4,1).c$$O,["bananas"]));
return Clazz.new_($I$(5,1).c$$javax_swing_tree_TreeNode,[root]);
}, 1);
...
root=Clazz.new_($I$(4,1).c$$O,["root"]);
$I$(6).createChildren$javax_swing_tree_DefaultMutableTreeNode$O(root, value);
} else {
root=Clazz.new_($I$(6,1).c$$O$O,["root", value]);
}return Clazz.new_($I$(5,1).c$$javax_swing_tree_TreeNode$Z,[root, false]);
}, 1);
...
C$.c$$javax_swing_tree_TreeModel.apply(this, [Clazz.new_($I$(5,1).c$$javax_swing_tree_TreeNode$Z,[root, asksAllowsChildren])]);
}, 1);

Clazz.newMeth(C$, 'c$$javax_swing_tree_TreeModel', function (newModel) {
;C$.superclazz.c$.apply(this,[]);C$.$init$.apply(this);
this.expandedStack=Clazz.new_($I$(7,1));
this.toggleClickCount=2;
this.expandedState=Clazz.new_($I$(8,1));
this.setLayout$java_awt_LayoutManager(null);
this.rowHeight=16;
this.visibleRowCount=20;
this.rootVisible=true;
this.selectionModel=Clazz.new_($I$(9,1));
...
this.expandedState.put$TK$TV(Clazz.new_($I$(11,1).c$$O,[this.treeModel.getRoot$()]), $I$(1).TRUE);
...
var rootPath=(root == null ) ? null : Clazz.new_($I$(11,1).c$$O,[root]);
var child=null;
var parent=null;
...
case $I$(3).ON:
if (outside) {
location=Clazz.new_($I$(12,1).c$$java_awt_Point$javax_swing_tree_TreePath$I,[p, null, -1]);
} else {
location=Clazz.new_($I$(12,1).c$$java_awt_Point$javax_swing_tree_TreePath$I,[p, this.getPathForRow$I(row), -1]);
}break;
case $I$(3).INSERT:
case $I$(3).ON_OR_INSERT:
if (row == -1) {
if (root != null  && !model.isLeaf$O(root)  && this.isExpanded$javax_swing_tree_TreePath(rootPath) ) {
location=Clazz.new_($I$(12,1).c$$java_awt_Point$javax_swing_tree_TreePath$I,[p, rootPath, 0]);
} else {
location=Clazz.new_($I$(12,1).c$$java_awt_Point$javax_swing_tree_TreePath$I,[p, null, -1]);
}break;
...
location=Clazz.new_($I$(12,1).c$$java_awt_Point$javax_swing_tree_TreePath$I,[p, parent, index]);
}break;
...
location=Clazz.new_($I$(12,1).c$$java_awt_Point$javax_swing_tree_TreePath$I,[p, parent, model.getIndexOfChild$O$O(parent.getLastPathComponent$(), child.getLastPathComponent$())]);
} else if (checkOn || !model.isLeaf$O(root) ) {
location=Clazz.new_($I$(12,1).c$$java_awt_Point$javax_swing_tree_TreePath$I,[p, rootPath, -1]);
} else {
location=Clazz.new_($I$(12,1).c$$java_awt_Point$javax_swing_tree_TreePath$I,[p, null, -1]);
}break;
default:
...
this.dropTimer=Clazz.new_($I$(15,1), [this, null]);
...
newEvent=Clazz.new_($I$(16,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I,[rComponent, event.getID$(), event.getWhen$(), event.getModifiers$(), p.x, p.y, event.getXOnScreen$(), event.getYOnScreen$(), event.getClickCount$(), event.isPopupTrigger$(), 0]);
...
e=Clazz.new_($I$(21,1).c$$O$javax_swing_tree_TreePath,[this, path]);
...
if (e == null ) e=Clazz.new_($I$(21,1).c$$O$javax_swing_tree_TreePath,[this, path]);
...
this.selectionRedirector=Clazz.new_($I$(23,1), [this, null]);
this.selectionModel.addTreeSelectionListener$javax_swing_event_TreeSelectionListener(this.selectionRedirector);
}});
...
this.expandPath$javax_swing_tree_TreePath(Clazz.new_($I$(11,1).c$$O,[model.getRoot$()]));
}}, p$1);
...
height=16 * visRows;
}}return Clazz.new_($I$(25,1).c$$I$I,[width, height]);
});
...
var descendants=Clazz.new_($I$(2,1));
...
var toRemove=Clazz.new_(1,{E:"javax.swing.tree.TreePath"},$I$(2,1).c$$I,[1]);
...
var rPath;
var toRemove=Clazz.new_(1,{E:"javax.swing.tree.TreePath"},$I$(2,1).c$$I,[Math.max(1, children.length)]);
