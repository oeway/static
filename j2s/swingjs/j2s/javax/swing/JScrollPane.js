(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'Boolean',['javax.swing.ScrollPaneLayout','.UIResource'],'java.awt.Point','java.awt.Rectangle','javax.swing.SwingUtilities',['javax.swing.JScrollPane','.ScrollBar'],'javax.swing.JViewport']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.viewport.setViewPosition$java_awt_Point(Clazz.new_($I$(3,1).c$$I$I,[2147483647, 0]));
...
var borderR=Clazz.new_($I$(4,1).c$$java_awt_Dimension,[this.getSize$()]);
...
return Clazz.new_($I$(6,1).c$$I, [this, null, 1]);
});
