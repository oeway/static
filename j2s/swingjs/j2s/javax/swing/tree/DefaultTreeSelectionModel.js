(function(){var P$=Clazz.newPackage("javax.swing.tree"),I$=[[0,'javax.swing.event.EventListenerList','javax.swing.DefaultListSelectionModel','java.util.Hashtable','javax.swing.tree.TreePath','java.util.Vector','Boolean','javax.swing.tree.PathPlaceHolder','javax.swing.event.TreeSelectionEvent','javax.swing.event.TreeSelectionListener','javax.swing.event.SwingPropertyChangeSupport','java.beans.PropertyChangeListener','java.util.BitSet','StringBuffer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
cPaths.addElement$TE(Clazz.new_($I$(7,1).c$$javax_swing_tree_TreePath$Z,[paths[newCounter], true]));
...
}for (oldCounter=0; oldCounter < oldCount; oldCounter++) if (this.selection[oldCounter] != null  && this.lastPaths.get$O(this.selection[oldCounter]) == null  ) cPaths.addElement$TE(Clazz.new_($I$(7,1).c$$javax_swing_tree_TreePath$Z,[this.selection[oldCounter], false]));
...
cPaths.addElement$TE(Clazz.new_($I$(7,1).c$$javax_swing_tree_TreePath$Z,[paths[counter], true]));
...
pathsToRemove.addElement$TE(Clazz.new_($I$(7,1).c$$javax_swing_tree_TreePath$Z,[paths[removeCounter], false]));
}}}
...
var event=Clazz.new_($I$(8,1).c$$O$javax_swing_tree_TreePathA$ZA$javax_swing_tree_TreePath$javax_swing_tree_TreePath,[this, this.selection, newness, this.leadPath, null]);
this.leadPath=null;
this.leadIndex=this.leadRow=-1;
...
this.changeSupport=Clazz.new_($I$(10,1).c$$O,[this]);
...
var bitSet=Clazz.new_($I$(12,1).c$$I,[32]);
var anIndex;
var counter;
var min;
...
var event=Clazz.new_($I$(8,1).c$$O$javax_swing_tree_TreePathA$ZA$javax_swing_tree_TreePath$javax_swing_tree_TreePath,[this, paths, newness, oldLeadSelection, this.leadPath]);
this.fireValueChanged$javax_swing_event_TreeSelectionEvent(event);
});
...
var retBuffer=Clazz.new_($I$(13,1));
var rows;
