(function(){var P$=Clazz.newPackage("javax.swing.tree"),p$1={},I$=[[0,'sun.swing.DefaultLookup','javax.swing.border.EmptyBorder','java.awt.Dimension']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return (retDimension == null  ? null : Clazz.new_($I$(3,1).c$$I$I,[retDimension.width + 3, retDimension.height]));
});
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:40 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
