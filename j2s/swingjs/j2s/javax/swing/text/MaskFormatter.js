...
switch (maskChar.$c()) {
case 35:
temp.add$TE(Clazz.new_($I$(4,1), [this, null]));
break;
case 39:
if (++counter < maxCounter) {
maskChar=mask.charAt$I(counter);
temp.add$TE(Clazz.new_($I$(5,1).c$$C, [this, null, maskChar]));
}break;
case 85:
temp.add$TE(Clazz.new_($I$(6,1), [this, null]));
break;
case 76:
temp.add$TE(Clazz.new_($I$(7,1), [this, null]));
break;
case 65:
temp.add$TE(Clazz.new_($I$(8,1), [this, null]));
break;
case 63:
temp.add$TE(Clazz.new_($I$(9,1), [this, null]));
break;
case 42:
temp.add$TE(Clazz.new_($I$(1,1), [this, null]));
break;
case 72:
temp.add$TE(Clazz.new_($I$(10,1), [this, null]));
break;
default:
temp.add$TE(Clazz.new_($I$(5,1).c$$C, [this, null, maskChar]));
break;
