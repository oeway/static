...
this.listeningStyles=Clazz.new_(1,{E:"javax.swing.text.Style"},$I$(1,1));
this.buffer=Clazz.new_($I$(12,1).c$$javax_swing_text_Element, [this, null, this.createDefaultRoot$()]);
...
var evnt=Clazz.new_($I$(10,1).c$$I$I$javax_swing_event_DocumentEvent_EventType, [this, null, 0, length, $I$(11).INSERT]);
...
var length=sb.length$();
var evnt=Clazz.new_($I$(10,1).c$$I$I$javax_swing_event_DocumentEvent_EventType, [this, null, offset, length, $I$(11).INSERT]);
evnt.addEdit$javax_swing_undo_UndoableEdit(cEdit);
...
var dde=Clazz.new_($I$(10,1).c$$I$I$javax_swing_event_DocumentEvent_EventType, [this, null, removeFrom, length, $I$(11).REMOVE]);
var ue=null;
...
var e=Clazz.new_($I$(10,1).c$$I$I$javax_swing_event_DocumentEvent_EventType, [this, null, p0, p1 - p0, $I$(11).CHANGE]);
...
this.writeLock$();
var changes=Clazz.new_($I$(10,1).c$$I$I$javax_swing_event_DocumentEvent_EventType, [this, null, offset, length, $I$(11).CHANGE]);
...
try {
var s=Clazz.new_($I$(21,1));
var parseBuffer=Clazz.new_(1,{E:"javax.swing.text.DefaultStyledDocument.ElementSpec"},$I$(1,1));
...
if (txt[i] == "\n") {
var breakOffset=i + 1;
parseBuffer.addElement$TE(Clazz.new_($I$(22,1).c$$javax_swing_text_AttributeSet$H$I,[attr, 3, breakOffset - lastOffset]));
parseBuffer.addElement$TE(Clazz.new_($I$(22,1).c$$javax_swing_text_AttributeSet$H,[null, 2]));
lastStartSpec=Clazz.new_($I$(22,1).c$$javax_swing_text_AttributeSet$H,[pattr, 1]);
parseBuffer.addElement$TE(lastStartSpec);
lastOffset=breakOffset;
}}
if (lastOffset < n) {
parseBuffer.addElement$TE(Clazz.new_($I$(22,1).c$$javax_swing_text_AttributeSet$H$I,[attr, 3, n - lastOffset]));
...
var spec=Clazz.new_($I$(22,1).c$$javax_swing_text_AttributeSet$H,[pattr, 2]);
parseBuffer.addElement$TE(spec);
spec=Clazz.new_($I$(22,1).c$$javax_swing_text_AttributeSet$H,[pattr, 1]);
parseBuffer.addElement$TE(spec);
if (pParagraph.getEndOffset$() != endOffset) return 7;
var parent=pParagraph.getParentElement$();
if ((parent.getElementIndex$I(offset) + 1) < parent.getElementCount$()) return 5;
} else {
var leftParents=Clazz.new_(1,{E:"javax.swing.text.Element"},$I$(1,1));
var rightParents=Clazz.new_(1,{E:"javax.swing.text.Element"},$I$(1,1));
var e=pParagraph;
while (e != null ){
...
spec=Clazz.new_($I$(22,1).c$$javax_swing_text_AttributeSet$H,[rightParents.elementAt$I(counter).getAttributes$(), 1]);
...
this.writeLock$();
var section=Clazz.new_($I$(24,1), [this, null]);
var paragraph=Clazz.new_($I$(25,1).c$$javax_swing_text_Element$javax_swing_text_AttributeSet, [this, null, section, null]);
var brk=Clazz.new_($I$(26,1).c$$javax_swing_text_Element$javax_swing_text_AttributeSet$I$I, [this, null, paragraph, null, 0, 1]);
...
this.updateRunnable=Clazz.new_($I$(27,1), [this, null]);
}{
...
return Clazz.new_($I$(31,1).c$$javax_swing_text_DefaultStyledDocument,[this]);
});
...
;C$.$init$.apply(this);
this.root=root;
this.changes=Clazz.new_(1,{E:"javax.swing.text.DefaultStyledDocument.ElementBuffer.ElemChanges"},$I$(1,1));
this.path=Clazz.new_(1,{E:"javax.swing.text.DefaultStyledDocument.ElementBuffer.ElemChanges"},$I$(2,1));
}, 1);
...
rj=null;
}var children=Clazz.new_(1,{E:"javax.swing.text.Element"},$I$(1,1));
...
var n=clonee.getElementCount$();
var childrenList=Clazz.new_(1,{E:"javax.swing.text.Element"},$I$(9,1).c$$I,[n]);
for (var i=0; i < n; i++) {
...
this.added=Clazz.new_(1,{E:"javax.swing.text.Element"},$I$(1,1));
this.removed=Clazz.new_(1,{E:"javax.swing.text.Element"},$I$(1,1));
}, 1);
...
var dde=Clazz.new_($I$(10,1).c$$I$I$javax_swing_event_DocumentEvent_EventType, [this, null, 0, this.b$['javax.swing.text.AbstractDocument'].getLength$.apply(this.b$['javax.swing.text.AbstractDocument'], []), $I$(11).CHANGE]);
dde.end$();
