...
var filtered=Clazz.new_($I$(4,1).c$$S,[str]);
...
var ee=Clazz.new_($I$(7,1).c$$javax_swing_text_Element$I$javax_swing_text_ElementA$javax_swing_text_ElementA,[lineMap, index, relems, aelems]);
...
throw Clazz.new_($I$(9,1).c$$S,["Internal error: " + e.toString()]);
} else {
throw e;
}
}
...
var relems=Clazz.array($I$(5), [this.removed.size$()]);
this.removed.copyInto$OA(relems);
var ee=Clazz.new_($I$(7,1).c$$javax_swing_text_Element$I$javax_swing_text_ElementA$javax_swing_text_ElementA,[map, line0, relems, aelems]);
chng.addEdit$javax_swing_undo_UndoableEdit(ee);
...
relem[0]=line;
var ee=Clazz.new_($I$(7,1).c$$javax_swing_text_Element$I$javax_swing_text_ElementA$javax_swing_text_ElementA,[map, line0, relem, aelem]);
chng.addEdit$javax_swing_undo_UndoableEdit(ee);
...
var ee=Clazz.new_($I$(7,1).c$$javax_swing_text_Element$I$javax_swing_text_ElementA$javax_swing_text_ElementA,[lineMap, index, relem, abelem]);
chng.addEdit$javax_swing_undo_UndoableEdit(ee);
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:39 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
