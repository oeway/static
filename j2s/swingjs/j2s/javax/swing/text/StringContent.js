...
}return Clazz.new_($I$(2,1).c$$I$I, [this, null, where, str.length$()]);
});
...
i-=1;
n-=1;
} else if (mark.offset >= offset && mark.offset <= end ) placeIn.addElement$TE(Clazz.new_($I$(6,1).c$$javax_swing_text_StringContent_PosRec, [this, null, mark]));
}
return placeIn;
});
