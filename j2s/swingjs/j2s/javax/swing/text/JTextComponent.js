(function(){var P$=Clazz.newPackage("javax.swing.text"),p$1={},I$=[[0,'java.awt.Point','java.util.Hashtable','javax.swing.KeyStroke','javax.swing.Action','java.util.Vector',['javax.swing.text.JTextComponent','.KeymapWrapper'],'sun.awt.AppContext','javax.swing.text.JTextComponent','javax.swing.DropMode',['javax.swing.text.JTextComponent','.MutableCaretEvent'],'javax.swing.event.CaretListener',['javax.swing.text.Position','.Bias'],['javax.swing.text.JTextComponent','.DropLocation'],'Boolean',['javax.swing.text.JTextComponent','.KeymapActionMap'],['javax.swing.text.JTextComponent','.DefaultKeymap'],'java.util.HashMap',['javax.swing.text.DefaultEditorKit','.DefaultKeyTypedAction'],'swingjs.JSUtil']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$classes$=[['KeyBinding',9],['DropLocation',25],['DefaultKeymap',8],['KeymapWrapper',8],['KeymapActionMap',8],['MutableCaretEvent',9]];
...
C$.$fields$=[['Z',['editable','dragEnabled'],'C',['focusAccelerator'],'S',['composedTextContent'],'O',['model','javax.swing.text.Document','caret','javax.swing.text.Caret','navigationFilter','javax.swing.text.NavigationFilter','highlighter','javax.swing.text.Highlighter','keymap','javax.swing.text.Keymap','caretEvent','javax.swing.text.JTextComponent.MutableCaretEvent','caretColor','java.awt.Color','+selectionColor','+selectedTextColor','+disabledTextColor','margin','java.awt.Insets','dropMode','javax.swing.DropMode','dropLocation','javax.swing.text.JTextComponent.DropLocation','composedTextAttribute','javax.swing.text.SimpleAttributeSet','composedTextStart','javax.swing.text.Position','+composedTextEnd']]
,['O',['overrideMap','java.util.Map','FOCUSED_COMPONENT','java.lang.Object']]]

Clazz.newMeth(C$, 'c$', function () {
Clazz.super_(C$, this);
this.enableEvents$J(2056);
this.caretEvent=Clazz.new_($I$(10,1).c$$javax_swing_text_JTextComponent,[this]);
...
if (bias[0] == null ) {
bias[0]=$I$(12).Forward;
}return Clazz.new_($I$(13,1).c$$java_awt_Point$I$javax_swing_text_Position_Bias,[p, index, bias[0]]);
});
...
var newKM=Clazz.new_($I$(6,1).c$$javax_swing_text_Keymap,[newKm]);
...
var newAM=Clazz.new_($I$(15,1).c$$javax_swing_text_Keymap,[newKm]);
...
var map=Clazz.new_($I$(16,1).c$$S$javax_swing_text_Keymap,[nm, parent]);
if (nm != null ) {
...
if (keymapTable == null ) {
keymapTable=Clazz.new_(1,{K:"String",V:"javax.swing.text.Keymap"},$I$(17,1).c$$I,[17]);
appContext.put$O$O("JTextComponent_KeymapTable", keymapTable);
var binding=C$.addKeymap$S$javax_swing_text_Keymap("default", null);
binding.setDefaultAction$javax_swing_Action(Clazz.new_($I$(18,1)));
}return keymapTable;
}}, 1);
...
var ui=(this.getUI$());
if (ui != null ) {
retValue=ui.getToolTipText$javax_swing_text_JTextComponent$java_awt_Point(this, Clazz.new_($I$(1,1).c$$I$I,[event.getX$(), event.getY$()]));
}}return retValue;
});
...
this.nm=nm;
this.parent=parent;
this.bindings=Clazz.new_($I$(2,1));
}, 1);
