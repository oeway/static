(function(){var P$=Clazz.newPackage("javax.swing.text"),p$1={},I$=[[0,'javax.swing.text.Utilities','javax.swing.text.SegmentCache','java.awt.Rectangle',['javax.swing.text.Position','.Bias'],'java.awt.Toolkit']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var text;
if (pos == p1) {
return Clazz.new_($I$(3,1).c$$I$I$I$I,[alloc.x + alloc.width, alloc.y, 0, this.metrics.getHeight$()]);
}if ((pos >= p0) && (pos <= p1) ) {
...
$I$(2).releaseSharedSegment$javax_swing_text_Segment(text);
return Clazz.new_($I$(3,1).c$$I$I$I$I,[alloc.x + width, alloc.y, 0, this.metrics.getHeight$()]);
