...
}var chng=Clazz.new_($I$(13,1).c$$I$I$javax_swing_event_DocumentEvent_EventType, [this, null, offs, len, $I$(7).REMOVE]);
...
var e=Clazz.new_($I$(13,1).c$$I$I$javax_swing_event_DocumentEvent_EventType, [this, null, offs, str.length$(), $I$(7).INSERT]);
if (u != null ) {
...
return Clazz.new_($I$(20,1).c$$javax_swing_text_Element$javax_swing_text_AttributeSet$I$I, [this, null, parent, a, p0, p1]);
});

Clazz.newMeth(C$, 'createBranchElement$javax_swing_text_Element$javax_swing_text_AttributeSet', function (parent, a) {
return Clazz.new_($I$(21,1).c$$javax_swing_text_Element$javax_swing_text_AttributeSet, [this, null, parent, a]);
});
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:36 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
