...
return Clazz.new_($I$(3,1).c$$I$I, [this, null, where, str.length$()]);
});
...
endIndex=this.findMarkAdjustIndex$I(endOffset + (g1 - g0) + 1 );
}var placeIn=(v == null ) ? Clazz.new_($I$(7,1).c$$I,[Math.max(1, endIndex - startIndex)]) : v;
for (var counter=startIndex; counter < endIndex; counter++) {
placeIn.addElement$TE(Clazz.new_($I$(8,1).c$$javax_swing_text_GapContent_MarkData, [this, null, this.marks.elementAt$I(counter)]));
}
return placeIn;
});
