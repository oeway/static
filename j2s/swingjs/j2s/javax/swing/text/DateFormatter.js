(function(){var P$=Clazz.newPackage("javax.swing.text"),p$1={},I$=[[0,'java.text.DateFormat','java.util.Calendar',['java.text.DateFormat','.Field']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
