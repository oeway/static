...
var leadingSpaces=0;
var hasTab=false;
var spaceMap=Clazz.new_($I$(7,1).c$$I,[endOffset - startOffset + 1]);
...
}this.justificationInfo=Clazz.new_($I$(8,1).c$$I$I$I$I$I$Z$java_util_BitSet,[startJustifiableContent, endJustifiableContent, leadingSpaces, contentSpaces, trailingSpaces, hasTab, spaceMap]);
return this.justificationInfo;
});
;
