(function(){var P$=Clazz.newPackage("javax.swing.text"),p$1={},p$2={},I$=[[0,'java.util.Stack','InternalError',['javax.swing.text.ElementIterator','.StackItem']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.elementStack.push$TE(Clazz.new_($I$(3,1).c$$javax_swing_text_Element, [this, null, this.root]));
}return this.root;
});
...
this.elementStack.push$TE(Clazz.new_($I$(3,1).c$$javax_swing_text_Element, [this, null, child]));
}return child;
} else {
