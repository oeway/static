...
this.volatileMap=Clazz.new_(1,{K:"java.awt.GraphicsConfiguration",V:"java.awt.image.VolatileImage"},$I$(1,1).c$$I,[1]);
this.paintDepth=0;
...
this.dirtyComponents=Clazz.new_(1,{K:"java.awt.Component",V:"java.awt.Rectangle"},$I$(6,1));
this.tmpDirtyComponents=Clazz.new_(1,{K:"java.awt.Component",V:"java.awt.Rectangle"},$I$(6,1));
this.hwDirtyComponents=Clazz.new_(1,{K:"java.awt.Container",V:"java.awt.Rectangle"},$I$(6,1));
}, p$1);
...
this.invalidComponents=Clazz.new_(1,{V:"java.awt.Component"},$I$(7,1));
} else {
...
if (p$1.extendDirtyRegion$java_awt_Component$I$I$I$I.apply(this, [c, x, y, w, h])) {
return;
}this.dirtyComponents.put$TK$TV(c, Clazz.new_($I$(2,1).c$$I$I$I$I,[x, y, w, h]));
...
if (dirty == null ) {
this.hwDirtyComponents.put$TK$TV(c, Clazz.new_($I$(2,1).c$$I$I$I$I,[x, y, w, h]));
} else {
...
}var windows=Clazz.new_(1,{E:"java.awt.Window"},$I$(9,1));
...
var roots=Clazz.new_(1,{V:"java.awt.Component"},$I$(7,1));
...
$I$(14).getSystemEventQueueImplPP$sun_awt_AppContext(context).postEvent$java_awt_AWTEvent(Clazz.new_($I$(15,1).c$$O$I$Runnable$O$Z,[$I$(8).getDefaultToolkit$(), 1200, this.processingRunnable, null, false]));
}}, p$1);
;
