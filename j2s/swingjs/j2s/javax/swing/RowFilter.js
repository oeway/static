(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,['javax.swing.RowFilter','.ComparisonType'],'java.util.ArrayList',['javax.swing.RowFilter','.RegexFilter'],'java.util.regex.Pattern',['javax.swing.RowFilter','.DateFilter'],['javax.swing.RowFilter','.NumberFilter'],['javax.swing.RowFilter','.OrFilter'],['javax.swing.RowFilter','.AndFilter'],['javax.swing.RowFilter','.NotFilter']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(3,1).c$$java_util_regex_Pattern$IA,[$I$(4).compile$S(regex), indices]);
}, 1);

Clazz.newMeth(C$, 'dateFilter$javax_swing_RowFilter_ComparisonType$java_util_Date$IA', function (type, date, indices) {
return Clazz.new_($I$(5,1).c$$javax_swing_RowFilter_ComparisonType$J$IA,[type, date.getTime$(), indices]);
}, 1);

Clazz.newMeth(C$, 'numberFilter$javax_swing_RowFilter_ComparisonType$Number$IA', function (type, number, indices) {
return Clazz.new_($I$(6,1).c$$javax_swing_RowFilter_ComparisonType$Number$IA,[type, number, indices]);
}, 1);

Clazz.newMeth(C$, 'orFilter$Iterable', function (filters) {
return Clazz.new_(1,{M:"Object",I:"Object"},$I$(7,1).c$$Iterable,[filters]);
}, 1);

Clazz.newMeth(C$, 'andFilter$Iterable', function (filters) {
return Clazz.new_(1,{M:"Object",I:"Object"},$I$(8,1).c$$Iterable,[filters]);
}, 1);

Clazz.newMeth(C$, 'notFilter$javax_swing_RowFilter', function (filter) {
return Clazz.new_(1,{M:"Object",I:"Object"},$I$(9,1).c$$javax_swing_RowFilter,[filter]);
}, 1);
;
...
C$.$fields$=[['L',['date'],'O',['type','javax.swing.RowFilter.ComparisonType']]]
...
Clazz.super_(C$, this);
this.filters=Clazz.new_(1,{E:"javax.swing.RowFilter"},$I$(2,1));
