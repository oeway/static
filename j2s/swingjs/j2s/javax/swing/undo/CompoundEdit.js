(function(){var P$=Clazz.newPackage("javax.swing.undo"),I$=[[0,'java.util.Vector']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['inProgress'],'O',['edits','java.util.Vector']]]

Clazz.newMeth(C$, 'c$', function () {
;C$.superclazz.c$.apply(this,[]);C$.$init$.apply(this);
this.inProgress=true;
this.edits=Clazz.new_(1,{E:"javax.swing.undo.UndoableEdit"},$I$(1,1));
}, 1);
