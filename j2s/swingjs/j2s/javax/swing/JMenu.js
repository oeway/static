...
var screenBounds=Clazz.new_($I$(3,1).c$$java_awt_Dimension,[toolkit.getScreenSize$()]);
if (gc != null ) {
...
throw Clazz.new_($I$(9,1).c$$S,["boolean isTearOff() {} not yet implemented"]);
});
...
throw Clazz.new_($I$(9,1).c$$S,[this.getText$() + " has a NULL Listener!! " + i ]);
} else {
...
throw Clazz.new_($I$(9,1).c$$S,["setAccelerator() is not defined for JMenu.  Use setMnemonic() instead."]);
});
