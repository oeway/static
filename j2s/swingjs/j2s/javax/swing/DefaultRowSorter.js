(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.util.Collections','java.util.ArrayList',['javax.swing.RowSorter','.SortKey'],'javax.swing.SortOrder','java.util.Arrays',['javax.swing.DefaultRowSorter','.Row'],'java.util.Comparator',['javax.swing.DefaultRowSorter','.FilterEntry']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.sortKeys=$I$(1).unmodifiableList$java_util_List(Clazz.new_(1,{E:"javax.swing.RowSorter.SortKey"},$I$(2,1).c$$java_util_Collection,[sortKeys]));
} else {
this.sortKeys=$I$(1).emptyList$();
...
var keys=Clazz.new_(1,{E:"javax.swing.RowSorter.SortKey"},$I$(2,1).c$$java_util_Collection,[this.getSortKeys$()]);
var sortKey;
var sortIndex;
...
if (sortIndex == -1) {
sortKey=Clazz.new_($I$(3,1).c$$I$javax_swing_SortOrder,[column, $I$(4).ASCENDING]);
...
keys.add$I$TE(0, Clazz.new_($I$(3,1).c$$I$javax_swing_SortOrder,[column, $I$(4).ASCENDING]));
...
return Clazz.new_($I$(3,1).c$$I$javax_swing_SortOrder,[key.getColumn$(), $I$(4).DESCENDING]);
}return Clazz.new_($I$(3,1).c$$I$javax_swing_SortOrder,[key.getColumn$(), $I$(4).ASCENDING]);
}, p$1);
...
var added=Clazz.new_(1,{E:"javax.swing.DefaultRowSorter.Row"},$I$(2,1).c$$I,[delta]);
for (i=firstRow; i <= lastRow; i++) {
if (p$1.include$I.apply(this, [i])) {
added.add$TE(Clazz.new_($I$(6,1).c$$javax_swing_DefaultRowSorter$I,[this, i]));
}}
var viewIndex;
...
var updated=Clazz.new_(1,{E:"javax.swing.DefaultRowSorter.Row"},$I$(2,1).c$$I,[delta]);
var newlyVisible=0;
var newlyHidden=0;
var effected=0;
for (i=firstRow; i <= lastRow; i++) {
if (this.modelToView[i] == -1) {
if (p$1.include$I.apply(this, [i])) {
updated.add$TE(Clazz.new_($I$(6,1).c$$javax_swing_DefaultRowSorter$I,[this, i]));
newlyVisible++;
}} else {
if (!p$1.include$I.apply(this, [i])) {
newlyHidden++;
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:19 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
