(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.util.Hashtable','java.util.Vector','Thread',['javax.swing.KeyboardManager','.ComponentKeyStrokePair'],'javax.swing.KeyStroke','javax.swing.JMenuBar','java.awt.JSComponent']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}if (k != null ) this.componentKeyStrokeMap.put$TK$TV(Clazz.new_($I$(4,1).c$$O$O, [this, null, c, k]), top);
return keyMap;
}, p$1);
