...
this.componentInfos=Clazz.new_(1,{K:"java.awt.Component",V:"javax.swing.GroupLayout.ComponentInfo"},$I$(14,1));
this.tmpParallelSet=Clazz.new_(1,{E:"javax.swing.GroupLayout.Spring"},$I$(15,1));
}, 1);
...
return Clazz.new_($I$(16,1), [this, null]);
});
...
return Clazz.new_($I$(17,1).c$$Z, [this, null, resizable]);
}return Clazz.new_($I$(18,1).c$$javax_swing_GroupLayout_Alignment$Z, [this, null, alignment, resizable]);
});

Clazz.newMeth(C$, 'createBaselineGroup$Z$Z', function (resizable, anchorBaselineToTop) {
return Clazz.new_($I$(17,1).c$$Z$Z, [this, null, resizable, anchorBaselineToTop]);
});
...
return Clazz.new_($I$(20,1).c$$I$I,[width + insets.left + insets.right , height + insets.top + insets.bottom ]);
}, p$4);
...
if (info == null ) {
info=Clazz.new_($I$(21,1).c$$java_awt_Component, [this, null, component]);
...
this.horizontalGroup.insertAutopadding$I$java_util_List$java_util_List$java_util_List$java_util_List$Z(0, Clazz.new_(1,{E:"javax.swing.GroupLayout.AutoPreferredGapSpring"},$I$(2,1).c$$I,[1]), Clazz.new_(1,{E:"javax.swing.GroupLayout.AutoPreferredGapSpring"},$I$(2,1).c$$I,[1]), Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentSpring"},$I$(2,1).c$$I,[1]), Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentSpring"},$I$(2,1).c$$I,[1]), insert);
this.verticalGroup.insertAutopadding$I$java_util_List$java_util_List$java_util_List$java_util_List$Z(1, Clazz.new_(1,{E:"javax.swing.GroupLayout.AutoPreferredGapSpring"},$I$(2,1).c$$I,[1]), Clazz.new_(1,{E:"javax.swing.GroupLayout.AutoPreferredGapSpring"},$I$(2,1).c$$I,[1]), Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentSpring"},$I$(2,1).c$$I,[1]), Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentSpring"},$I$(2,1).c$$I,[1]), insert);
}, p$4);
...
Clazz.newMeth(C$, 'c$', function () {
Clazz.super_(C$, this);
this.springs=Clazz.new_(1,{E:"javax.swing.GroupLayout.Spring"},$I$(2,1));
}, 1);
...
var sorted=Clazz.new_(1,{E:"javax.swing.GroupLayout.SpringDelta"},$I$(2,1).c$$I,[size]);
...
sorted.add$TE(Clazz.new_($I$(9,1).c$$I$I,[counter, sDelta]));
}}
...
var newLeadingPadding=Clazz.new_(1,{E:"javax.swing.GroupLayout.AutoPreferredGapSpring"},$I$(2,1).c$$java_util_Collection,[leadingPadding]);
var newTrailingPadding=Clazz.new_(1,{E:"javax.swing.GroupLayout.AutoPreferredGapSpring"},$I$(2,1).c$$I,[1]);
var newLeading=Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentSpring"},$I$(2,1).c$$java_util_Collection,[leading]);
...
if (newTrailing == null ) {
newTrailing=Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentSpring"},$I$(2,1).c$$I,[1]);
} else {
newTrailing.clear$();
...
this.sources=Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentSpring"},$I$(2,1).c$$java_util_Collection,[sources]);
});
...
if (this.matches == null ) {
this.matches=Clazz.new_(1,{E:"javax.swing.GroupLayout.AutoPreferredGapMatch"},$I$(2,1).c$$I,[1]);
}this.matches.add$TE(Clazz.new_($I$(12,1).c$$javax_swing_GroupLayout_ComponentSpring$javax_swing_GroupLayout_ComponentSpring,[source, target]));
}, p$7);
...
this.targets=Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentSpring"},$I$(2,1).c$$I,[1]);
...
;C$.$init$.apply(this);
this.linked=Clazz.new_(1,{E:"javax.swing.GroupLayout.ComponentInfo"},$I$(2,1));
this.size=-2147483648;
this.axis=axis;
}, 1);
...
Clazz.new_($I$(13,1).c$$I,[0]).add$javax_swing_GroupLayout_ComponentInfo(this);
}return this.horizontalMaster;
} else {
if (this.verticalMaster == null  && create ) {
Clazz.new_($I$(13,1).c$$I,[1]).add$javax_swing_GroupLayout_ComponentInfo(this);
