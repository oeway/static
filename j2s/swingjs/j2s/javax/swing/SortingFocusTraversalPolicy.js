(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'javax.swing.SwingContainerOrderFocusTraversalPolicy','java.util.ArrayList','java.util.Collections']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var cycle=Clazz.new_(1,{E:"java.awt.Component"},$I$(2,1));
...
var index;
try {
index=$I$(3).binarySearch$java_util_List$TT$java_util_Comparator(cycle, aComponent, this.comparator);
} catch (e) {
