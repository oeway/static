(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'sun.awt.AppContext','javax.swing.UIManager']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
