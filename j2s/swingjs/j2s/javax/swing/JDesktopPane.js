(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.util.Vector','javax.swing.JInternalFrame','java.util.TreeSet',['javax.swing.JDesktopPane','.ComponentPosition'],'java.util.ArrayList']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var c;
var set=Clazz.new_(1,{E:"javax.swing.JDesktopPane.ComponentPosition"},$I$(3,1));
for (var i=0; i < this.getComponentCount$(); i++) {
c=this.getComponent$I(i);
if (Clazz.instanceOf(c, "javax.swing.JInternalFrame")) {
set.add$TE(Clazz.new_($I$(4,1).c$$javax_swing_JInternalFrame$I$I,[c, P$.JLayeredPane.getLayer$java_awt_Component(c), i]));
} else if (Clazz.instanceOf(c, "javax.swing.JInternalFrame.JDesktopIcon")) {
c=(c).getInternalFrame$();
set.add$TE(Clazz.new_($I$(4,1).c$$javax_swing_JInternalFrame$I$I,[c, P$.JLayeredPane.getLayer$java_awt_Component(c), i]));
}}
var frames=Clazz.new_(1,{E:"javax.swing.JInternalFrame"},$I$(5,1).c$$I,[set.size$()]);
