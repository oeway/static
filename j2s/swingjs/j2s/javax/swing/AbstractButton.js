...
this.setMnemonic$I((n == null ) ? "\u0000".$c() : (n).valueOf());
}, p$1);
...
}e=Clazz.new_($I$(9,1).c$$O$I$S$J$I,[this, 1001, actionCommand, event.getWhen$(), event.getModifiers$()]);
...
if (e == null ) {
e=Clazz.new_($I$(11,1).c$$java_awt_ItemSelectable$I$O$I,[this, 701, this, event.getStateChange$()]);
...
;C$.superclazz.c$$TT$javax_swing_Action.apply(this,[b, a]);C$.$init$.apply(this);
}, 1);
