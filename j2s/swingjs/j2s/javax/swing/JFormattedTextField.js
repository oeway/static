...
this.focusLostHandler=Clazz.new_($I$(7,1), [this, null]);
...
this.documentListener=Clazz.new_($I$(9,1), [this, null]);
...
this.textFormatterActionMap=Clazz.new_($I$(10,1));
while (map != null ){
...
return Clazz.new_($I$(5,1).c$$javax_swing_JFormattedTextField_AbstractFormatter,[Clazz.new_($I$(12,1).c$$java_text_NumberFormat,[type])]);
}if (Clazz.instanceOf(type, "java.text.Format")) {
return Clazz.new_($I$(5,1).c$$javax_swing_JFormattedTextField_AbstractFormatter,[Clazz.new_($I$(13,1).c$$java_text_Format,[type])]);
}if (Clazz.instanceOf(type, "java.util.Date")) {
return Clazz.new_($I$(5,1).c$$javax_swing_JFormattedTextField_AbstractFormatter,[Clazz.new_($I$(14,1))]);
}if (Clazz.instanceOf(type, "java.lang.Number")) {
var displayFormatter=Clazz.new_($I$(12,1));
(displayFormatter).setValueClass$Class(type.getClass$());
var editFormatter=Clazz.new_($I$(12,1).c$$java_text_NumberFormat,[Clazz.new_($I$(15,1).c$$S,["#.#"])]);
...
}return Clazz.new_($I$(5,1).c$$javax_swing_JFormattedTextField_AbstractFormatter,[Clazz.new_($I$(16,1))]);
}, p$1);
;
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:22 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
