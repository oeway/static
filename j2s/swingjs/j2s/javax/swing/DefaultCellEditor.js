(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,['javax.swing.DefaultCellEditor','.EditorDelegate'],'Boolean','java.awt.event.ActionEvent','swingjs.plaf.CellHolder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.$finals$.comboBox.actionPerformed$java_awt_event_ActionEvent(Clazz.new_($I$(3,1).c$$O$I$S,[this.b$['javax.swing.DefaultCellEditor'], 0, ""]));
