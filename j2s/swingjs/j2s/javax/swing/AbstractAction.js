(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'Boolean','javax.swing.ArrayTable','javax.swing.event.SwingPropertyChangeSupport','java.beans.PropertyChangeListener']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (this.arrayTable == null ) {
this.arrayTable=Clazz.new_($I$(2,1));
