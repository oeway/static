...
C$.$fields$=[['Z',['isViewSizeSet','backingStore','scrollUnderway','repaintAll','waitingForRepaint','inBlitPaint','hasHadValidView'],'I',['scrollMode'],'O',['lastPaintPosition','java.awt.Point','backingStoreImage','java.awt.Image','viewListener','java.awt.event.ComponentListener','changeEvent','javax.swing.event.ChangeEvent']]
...
return Clazz.new_($I$(2,1).c$$I$I$I$I,[1, 1, 1, 1]);
});
...
return Clazz.new_($I$(3,1).c$$I$I,[0, 0]);
}}, p$1);
...
var blitFrom=Clazz.new_($I$(3,1));
var blitTo=Clazz.new_($I$(3,1));
var blitSize=Clazz.new_($I$(4,1));
var blitPaint=Clazz.new_($I$(5,1));
...
return Clazz.new_($I$(5,1).c$$java_awt_Point$java_awt_Dimension,[this.getViewPosition$(), this.getExtentSize$()]);
});
...
return Clazz.new_($I$(4,1).c$$java_awt_Dimension,[size]);
});

Clazz.newMeth(C$, 'toViewCoordinates$java_awt_Point', function (p) {
return Clazz.new_($I$(3,1).c$$java_awt_Point,[p]);
});
...
return false;
}var clip=Clazz.new_($I$(5,1).c$$I$I$I$I,[0, 0, this.getWidth$(), this.getHeight$()]);
var oldClip=Clazz.new_($I$(5,1));
var tmp2=null;
var parent;
var lastParent=null;
var x;
