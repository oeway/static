(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'java.awt.event.ItemEvent','java.awt.EventQueue','java.awt.event.ActionEvent',['javax.swing.JToggleButton','.ToggleButtonModel']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.fireItemStateChanged$java_awt_event_ItemEvent(Clazz.new_($I$(1,1).c$$java_awt_ItemSelectable$I$O$I,[this, 701, this, this.isSelected$() ? 1 : 2]));
});
...
modifiers=(currentEvent).getModifiers$();
}this.fireActionPerformed$java_awt_event_ActionEvent(Clazz.new_($I$(3,1).c$$O$I$S$J$I,[this, 1001, this.getActionCommand$(), $I$(2).getMostRecentEventTime$(), modifiers]));
}});
})()
})();
