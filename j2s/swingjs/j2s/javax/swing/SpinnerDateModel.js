(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.util.Calendar','java.util.Date']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.c$$java_util_Date$Comparable$Comparable$I.apply(this, [Clazz.new_($I$(2,1)), null, null, 5]);
}, 1);
