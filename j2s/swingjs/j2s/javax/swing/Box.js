(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'javax.swing.BoxLayout',['javax.swing.Box','.Filler'],'java.awt.Dimension','java.awt.AWTError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(2,1).c$$java_awt_Dimension$java_awt_Dimension$java_awt_Dimension,[Clazz.new_($I$(3,1).c$$I$I,[width, 0]), Clazz.new_($I$(3,1).c$$I$I,[width, 0]), Clazz.new_($I$(3,1).c$$I$I,[width, 32767])]);
}, 1);

Clazz.newMeth(C$, 'createVerticalStrut$I', function (height) {
return Clazz.new_($I$(2,1).c$$java_awt_Dimension$java_awt_Dimension$java_awt_Dimension,[Clazz.new_($I$(3,1).c$$I$I,[0, height]), Clazz.new_($I$(3,1).c$$I$I,[0, height]), Clazz.new_($I$(3,1).c$$I$I,[32767, height])]);
}, 1);

Clazz.newMeth(C$, 'createGlue$', function () {
return Clazz.new_($I$(2,1).c$$java_awt_Dimension$java_awt_Dimension$java_awt_Dimension,[Clazz.new_($I$(3,1).c$$I$I,[0, 0]), Clazz.new_($I$(3,1).c$$I$I,[0, 0]), Clazz.new_($I$(3,1).c$$I$I,[32767, 32767])]);
}, 1);

Clazz.newMeth(C$, 'createHorizontalGlue$', function () {
return Clazz.new_($I$(2,1).c$$java_awt_Dimension$java_awt_Dimension$java_awt_Dimension,[Clazz.new_($I$(3,1).c$$I$I,[0, 0]), Clazz.new_($I$(3,1).c$$I$I,[0, 0]), Clazz.new_($I$(3,1).c$$I$I,[32767, 0])]);
}, 1);

Clazz.newMeth(C$, 'createVerticalGlue$', function () {
return Clazz.new_($I$(2,1).c$$java_awt_Dimension$java_awt_Dimension$java_awt_Dimension,[Clazz.new_($I$(3,1).c$$I$I,[0, 0]), Clazz.new_($I$(3,1).c$$I$I,[0, 0]), Clazz.new_($I$(3,1).c$$I$I,[0, 32767])]);
}, 1);
