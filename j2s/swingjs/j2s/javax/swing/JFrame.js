(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,'javax.swing.JComponent','javax.swing.UIManager','javax.swing.JRootPane','javax.swing.SwingUtilities','javax.swing.RepaintManager','Boolean']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var rp=Clazz.new_($I$(3,1).c$$S$Z$java_awt_Container,["_Frame" + (++C$.frameCount), false, this]);
rp.setOpaque$Z(true);
return rp;
});
