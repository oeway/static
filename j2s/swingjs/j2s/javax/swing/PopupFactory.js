(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'javax.swing.SwingUtilities','javax.swing.PopupFactory','java.awt.JSComponent','java.util.HashMap','javax.swing.Popup','java.util.ArrayList','java.awt.event.WindowAdapter','java.awt.Toolkit','java.awt.Rectangle','java.awt.Insets','javax.swing.JLayeredPane','javax.swing.JPanel','java.awt.BorderLayout',['javax.swing.PopupFactory','.MediumWeightPopup','.MediumWeightComponent'],'javax.swing.JRootPane','javax.swing.ClientPropertyKey','Boolean',['javax.swing.PopupFactory','.LightWeightPopup'],['javax.swing.PopupFactory','.MediumWeightPopup'],['javax.swing.PopupFactory','.HeavyWeightPopup']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
), Clazz.new_($I$(7,1), [this, {w:w}],P$.PopupFactory$HeavyWeightPopup$1)));
}if (cache.size$() < 5) {
cache.add$TE(popup);
} else {
popup._dispose$();
...
screenBounds=Clazz.new_($I$(9,1).c$$java_awt_Dimension,[toolkit.getScreenSize$()]);
insets=Clazz.new_($I$(10,1).c$$I$I$I$I,[0, 0, 0, 0]);
...
(parent).add$java_awt_Component$O$I(component, $I$(11).POPUP_LAYER, 0);
} else {
parent.add$java_awt_Component(component);
}});

Clazz.newMeth(C$, 'createComponent$java_awt_Component', function (owner) {
var component=Clazz.new_($I$(12,1).c$$java_awt_LayoutManager$Z,[Clazz.new_($I$(13,1)), true]);
...
Clazz.newMeth(C$, 'createComponent$java_awt_Component', function (owner) {
var component=Clazz.new_($I$(14,1));
this.rootPane=Clazz.new_($I$(15,1).c$$S$Z$java_awt_Container,["_Popup" + (++$I$(2).popupCount), false, component]);
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:28 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
