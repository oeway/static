...
C$.$classes$=[['PrintMode',25],['Resizable2',10],['Resizable3',10],['SortManager',18],['ModelChange',18],['NumberRenderer',8],['DoubleRenderer',8],['DateRenderer',8],['IconRenderer',8],['BooleanRenderer',9],['GenericEditor',8],['NumberEditor',8],['BooleanEditor',8]];

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.tmpRect=Clazz.new_($I$(12,1));
}
...
C$.c$$javax_swing_table_TableModel.apply(this, [Clazz.new_($I$(14,1).c$$I$I,[numRows, numColumns])]);
}, 1);

Clazz.newMeth(C$, 'c$$java_util_Vector$java_util_Vector', function (rowData, columnNames) {
C$.c$$javax_swing_table_TableModel.apply(this, [Clazz.new_($I$(14,1).c$$java_util_Vector$java_util_Vector,[rowData, columnNames])]);
}, 1);
...
), Clazz.new_($I$(15,1), [this, {rowData:rowData,columnNames:columnNames}],P$.JTable$1))]);
}, 1);
...
return Clazz.new_($I$(16,1).c$$java_awt_Component,[aTable]);
}, 1);
...
this.rowModel=Clazz.new_($I$(1,1).c$$I$I,[this.getRowCount$(), this.getRowHeight$()]);
...
return Clazz.new_($I$(17,1).c$$I$I,[this.getColumnModel$().getColumnMargin$(), this.rowMargin]);
});
...
var newColumn=Clazz.new_($I$(18,1).c$$I,[i]);
...
this.setRowSorter$javax_swing_RowSorter(Clazz.new_($I$(19,1).c$$TM,[this.getModel$()]));
...
if (sorter != null ) {
this.sortManager=Clazz.new_($I$(20,1).c$$javax_swing_RowSorter, [this, null, sorter]);
}this.resizeAnd秘repaint$();
...
var newEvent=Clazz.new_($I$(22,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I,[component, event.getID$(), event.getWhen$(), event.getModifiers$(), p.x, p.y, event.getXOnScreen$(), event.getYOnScreen$(), event.getClickCount$(), event.isPopupTrigger$(), 0]);
...
this.setRowSorter$javax_swing_RowSorter(Clazz.new_($I$(19,1).c$$TM,[dataModel]));
}}});
...
var dirtyRegion;
if (modelColumn == -1) {
dirtyRegion=Clazz.new_($I$(12,1).c$$I$I$I$I,[0, start * this.getRowHeight$(), this.getColumnModel$().getTotalColumnWidth$(), 0]);
} else {
...
var drawRect=Clazz.new_($I$(12,1).c$$I$I$I$I,[0, start * rh, this.getColumnModel$().getTotalColumnWidth$(), (this.getRowCount$() - start) * rh]);
this.revalidate$();
...
var drawRect=Clazz.new_($I$(12,1).c$$I$I$I$I,[0, start * rh, this.getColumnModel$().getTotalColumnWidth$(), (previousRowCount - start) * rh]);
this.revalidate$();
this.repaint$java_awt_Rectangle(drawRect);
}, p$2);
...
h.put$TK$TV(c, Clazz.new_($I$(28,1).c$$S,[s]));
}, p$2);
...
this.setPreferredScrollableViewportSize$java_awt_Dimension(Clazz.new_($I$(17,1).c$$I$I,[450, 400]));
...
return Clazz.new_($I$(34,1).c$$javax_swing_table_TableColumnModel,[this.columnModel]);
});
...
this.modelRowSizes=Clazz.new_($I$(1,1).c$$I$I,[this.this$0.getModel$.apply(this.this$0, []).getRowCount$(), this.this$0.getRowHeight$.apply(this.this$0, [])]);
...
if (Clazz.exceptionOf(e,"Exception")){
(this.getComponent$()).setBorder$javax_swing_border_Border(Clazz.new_($I$(9,1).c$$java_awt_Color,[$I$(10).red]));
return false;
} else {
throw e;
}
...
this.value=null;
(this.getComponent$()).setBorder$javax_swing_border_Border(Clazz.new_($I$(9,1).c$$java_awt_Color,[$I$(10).black]));
try {
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:26 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
