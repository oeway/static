(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.util.concurrent.atomic.AtomicLong','java.util.concurrent.TimeUnit','StringBuffer','java.util.concurrent.DelayQueue','javax.swing.SwingUtilities','sun.awt.AppContext','Thread',['javax.swing.TimerQueue','.DelayedTimer'],'StringBuilder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.sharedInstanceKey=Clazz.new_($I$(3,1).c$$S,["TimerQueue.sharedInstanceKey"]);
C$.expiredTimersKey=Clazz.new_($I$(3,1).c$$S,["TimerQueue.expiredTimersKey"]);
...
,['L',['NANO_ORIGIN'],'O',['sharedInstanceKey','java.lang.Object','+expiredTimersKey','+classLock']]]

Clazz.newMeth(C$, 'c$', function () {
;C$.$init$.apply(this);
this.queue=Clazz.new_(1,{E:"javax.swing.TimerQueue.DelayedTimer"},$I$(4,1));
this.start$();
}, 1);
...
var timerThread=Clazz.new_($I$(7,1).c$$ThreadGroup$Runnable$S,[threadGroup, this, "TimerQueue"]);
...
p$1.addTimer$javax_swing_TimerQueue_DelayedTimer.apply(this, [Clazz.new_($I$(8,1).c$$javax_swing_Timer$J,[timer, $I$(2).MILLISECONDS.toNanos$J(delayMillis) + C$.now$()])]);
}} finally {
}
});
...
C$.$fields$=[['L',['sequenceNumber','time'],'O',['timer','javax.swing.Timer']]
