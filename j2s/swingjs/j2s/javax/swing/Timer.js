...
C$.$fields$=[['Z',['repeats0','repeats','coalesce'],'I',['initialDelay','delay','html5Id'],'L',['postTime','dispatchTime'],'S',['actionCommand'],'O',['listenerList','javax.swing.event.EventListenerList','notify','java.util.concurrent.atomic.AtomicBoolean','doPostEvent','Runnable','delayedTimer','javax.swing.TimerQueue.DelayedTimer']]
,['Z',['logTimers']]]
...
this.this$0.fireActionPerformed$java_awt_event_ActionEvent.apply(this.this$0, [Clazz.new_($I$(2,1).c$$O$I$S$J$I,[this.this$0, 0, this.this$0.getActionCommand$.apply(this.this$0, []), System.currentTimeMillis$(), 0])]);
