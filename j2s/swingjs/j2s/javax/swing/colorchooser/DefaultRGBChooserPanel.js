...
var enclosure=Clazz.new_($I$(2,1));
enclosure.setLayout$java_awt_LayoutManager(Clazz.new_($I$(3,1).c$$I$I,[3, 3]));
enclosure.setInheritsPopupMenu$Z(true);
this.add$java_awt_Component$O(enclosure, "Center");
var l=Clazz.new_($I$(4,1).c$$S,[redString]);
...
this.redField=Clazz.new_($I$(6,1).c$$javax_swing_SpinnerModel,[Clazz.new_($I$(7,1).c$$I$I$I$I,[color.getRed$(), 0, 255, 1])]);
this.redField.setInheritsPopupMenu$Z(true);
var redFieldHolder=Clazz.new_($I$(2,1).c$$java_awt_LayoutManager,[Clazz.new_($I$(8,1))]);
...
l=Clazz.new_($I$(4,1).c$$S,[greenString]);
...
this.greenField=Clazz.new_($I$(6,1).c$$javax_swing_SpinnerModel,[Clazz.new_($I$(7,1).c$$I$I$I$I,[color.getGreen$(), 0, 255, 1])]);
this.greenField.setInheritsPopupMenu$Z(true);
var greenFieldHolder=Clazz.new_($I$(2,1).c$$java_awt_LayoutManager,[Clazz.new_($I$(8,1))]);
...
l=Clazz.new_($I$(4,1).c$$S,[blueString]);
...
this.blueField=Clazz.new_($I$(6,1).c$$javax_swing_SpinnerModel,[Clazz.new_($I$(7,1).c$$I$I$I$I,[color.getBlue$(), 0, 255, 1])]);
this.blueField.setInheritsPopupMenu$Z(true);
var blueFieldHolder=Clazz.new_($I$(2,1).c$$java_awt_LayoutManager,[Clazz.new_($I$(8,1))]);
...
var s=Clazz.new_($I$(10,1).c$$I$I$I$I,[0, 0, 255, val]);
s.setFont$java_awt_Font(Clazz.new_($I$(11,1).c$$S$I$I,["Helvetica", 0, 8]));
...
var color=Clazz.new_($I$(12,1).c$$I$I$I,[red, green, blue]);
