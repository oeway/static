(function(){var P$=Clazz.newPackage("javax.swing.border"),p$1={},I$=[[0,'java.awt.Color','java.awt.Insets']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
