(function(){var P$=Clazz.newPackage("javax.swing.border"),I$=[[0,'java.awt.Color',['java.awt.geom.RoundRectangle2D','.Float'],['java.awt.geom.Rectangle2D','.Float'],['java.awt.geom.Path2D','.Float'],'java.awt.Insets']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
