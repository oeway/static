(function(){var P$=Clazz.newPackage("javax.swing.border"),I$=[[0,'java.awt.Point','java.awt.Rectangle','java.awt.Insets','javax.swing.UIManager','java.awt.Dimension',['java.awt.Component','.BaselineResizeBehavior'],'java.awt.Font']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}var grooveRect=Clazz.new_($I$(2,1).c$$I$I$I$I,[x + 2, y + 2, width - (4), height - (4)]);
var font=g.getFont$();
...
var minSize=Clazz.new_($I$(5,1).c$$I$I,[insets.right + insets.left, insets.top + insets.bottom]);
var font=this.getFont$java_awt_Component(c);
...
return font;
}return Clazz.new_($I$(7,1).c$$S$I$I,["Dialog", 0, 12]);
});
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:31 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
