...
if (!c.isVisible$()) {
this.xChildren[i]=Clazz.new_($I$(3,1).c$$I$I$I$F,[0, 0, 0, c.getAlignmentX$()]);
this.yChildren[i]=Clazz.new_($I$(3,1).c$$I$I$I$F,[0, 0, 0, c.getAlignmentY$()]);
continue;
}var min=c.getMinimumSize$();
var typ=c.getPreferredSize$();
var max=c.getMaximumSize$();
this.xChildren[i]=Clazz.new_($I$(3,1).c$$I$I$I$F,[min.width, typ.width, max.width, c.getAlignmentX$()]);
this.yChildren[i]=Clazz.new_($I$(3,1).c$$I$I$I$F,[min.height, typ.height, max.height, c.getAlignmentY$()]);
}
