(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.awt.event.MouseEvent','javax.swing.Timer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.event=Clazz.new_($I$(1,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I,[C$.component, e.getID$(), e.getWhen$(), e.getModifiers$(), e.getX$() + screenLocation.x, e.getY$() + screenLocation.y, e.getXOnScreen$(), e.getYOnScreen$(), e.getClickCount$(), e.isPopupTrigger$(), 0]);
if (C$.timer == null ) {
...
var e=Clazz.new_($I$(1,1).c$$java_awt_Component$I$J$I$I$I$I$I$I$Z$I,[component, C$.event.getID$(), C$.event.getWhen$(), C$.event.getModifiers$(), C$.event.getX$() - screenLocation.x, C$.event.getY$() - screenLocation.y, C$.event.getXOnScreen$(), C$.event.getYOnScreen$(), C$.event.getClickCount$(), C$.event.isPopupTrigger$(), 0]);
