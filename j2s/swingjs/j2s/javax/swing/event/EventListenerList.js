(function(){var P$=Clazz.newPackage("javax.swing.event"),p$1={},I$=[[0,'java.lang.reflect.Array']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
