...
var buttonBorder=Clazz.new_($I$(4,1).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_($I$(5,1).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("Button.shadow"), table.getColor$O("Button.darkShadow"), table.getColor$O("Button.light"), table.getColor$O("Button.highlight")]), Clazz.new_($I$(6,1))]);
return buttonBorder;
}, 1);

Clazz.newMeth(C$, 'getRadioButtonBorder$', function () {
var table=$I$(3).getLookAndFeelDefaults$();
var radioButtonBorder=Clazz.new_($I$(4,1).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_($I$(7,1).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("RadioButton.shadow"), table.getColor$O("RadioButton.darkShadow"), table.getColor$O("RadioButton.light"), table.getColor$O("RadioButton.highlight")]), Clazz.new_($I$(6,1))]);
return radioButtonBorder;
}, 1);

Clazz.newMeth(C$, 'getToggleButtonBorder$', function () {
var table=$I$(3).getLookAndFeelDefaults$();
var toggleButtonBorder=Clazz.new_($I$(4,1).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_($I$(8,1).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("ToggleButton.shadow"), table.getColor$O("ToggleButton.darkShadow"), table.getColor$O("ToggleButton.light"), table.getColor$O("ToggleButton.highlight")]), Clazz.new_($I$(6,1))]);
return toggleButtonBorder;
}, 1);

Clazz.newMeth(C$, 'getMenuBarBorder$', function () {
var table=$I$(3).getLookAndFeelDefaults$();
var menuBarBorder=Clazz.new_($I$(9,1).c$$java_awt_Color$java_awt_Color,[table.getColor$O("MenuBar.shadow"), table.getColor$O("MenuBar.highlight")]);
return menuBarBorder;
}, 1);

Clazz.newMeth(C$, 'getSplitPaneBorder$', function () {
var table=$I$(3).getLookAndFeelDefaults$();
var splitPaneBorder=Clazz.new_($I$(10,1).c$$java_awt_Color$java_awt_Color,[table.getColor$O("SplitPane.highlight"), table.getColor$O("SplitPane.darkShadow")]);
return splitPaneBorder;
}, 1);

Clazz.newMeth(C$, 'getTextFieldBorder$', function () {
var table=$I$(3).getLookAndFeelDefaults$();
var textFieldBorder=Clazz.new_($I$(11,1).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("TextField.shadow"), table.getColor$O("TextField.darkShadow"), table.getColor$O("TextField.light"), table.getColor$O("TextField.highlight")]);
return textFieldBorder;
}, 1);

Clazz.newMeth(C$, 'getProgressBarBorder$', function () {
var progressBarBorder=Clazz.new_($I$(12,1).c$$java_awt_Color$I,[$I$(13).green, 2]);
return progressBarBorder;
}, 1);

Clazz.newMeth(C$, 'getInternalFrameBorder$', function () {
var table=$I$(3).getLookAndFeelDefaults$();
var internalFrameBorder=Clazz.new_($I$(4,1).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_($I$(14,1).c$$I$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[0, table.getColor$O("InternalFrame.borderLight"), table.getColor$O("InternalFrame.borderHighlight"), table.getColor$O("InternalFrame.borderDarkShadow"), table.getColor$O("InternalFrame.borderShadow")]), $I$(15).createLineBorder$java_awt_Color$I(table.getColor$O("InternalFrame.borderColor"), 1)]);
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:50:35 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
