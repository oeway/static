(function(){var P$=Clazz.newPackage("javax.swing"),I$=[[0,['javax.swing.JColorChooser','.ASYNCHRONOUS_COLOR'],'javax.swing.colorchooser.AbstractColorChooserPanel','java.awt.Color','javax.swing.JOptionPane','javax.swing.ColorChooserDialog','javax.swing.colorchooser.DefaultColorSelectionModel','StringBuffer','javax.swing.JColorChooser','java.awt.BorderLayout','javax.swing.JPanel','java.awt.FlowLayout','javax.swing.JButton','javax.swing.AbstractAction','javax.swing.KeyStroke','sun.swing.SwingUtilities2','javax.swing.JDialog','javax.swing.UIManager',['javax.swing.ColorChooserDialog','.Closer']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
}if (okListener == null  && cancelListener == null  ) java.awt.JSComponent.秘ensurePropertyChangeListener$java_awt_Component$java_awt_Component(this, $I$(8).listener == null  ? c : $I$(8).listener);
this.chooserPane=chooserPane;
var contentPane=this.getContentPane$();
contentPane.setLayout$java_awt_LayoutManager(Clazz.new_($I$(9,1)));
contentPane.add$java_awt_Component$O(chooserPane, "Center");
var okString="OK";
var cancelString="Cancel";
var resetString="Reset";
var buttonPane=Clazz.new_($I$(10,1));
buttonPane.setLayout$java_awt_LayoutManager(Clazz.new_($I$(11,1).c$$I,[1]));
var okButton=Clazz.new_($I$(12,1).c$$S,[okString]);
...
this.cancelButton=Clazz.new_($I$(12,1).c$$S,[cancelString]);
...
), Clazz.new_($I$(13,1), [this, null],P$.ColorChooserDialog$2));
...
var resetButton=Clazz.new_($I$(12,1).c$$S,[resetString]);
...
this.addWindowListener$java_awt_event_WindowListener(Clazz.new_($I$(18,1), [this, null]));
});
