...
C$._tempRect=Clazz.new_(1,{V:"java.awt.Rectangle"},$I$(3,1));
...
C$.managingFocusForwardTraversalKeys=Clazz.new_(1,{E:"javax.swing.KeyStroke"},$I$(6,1).c$$I,[1]);
...
C$.managingFocusBackwardTraversalKeys=Clazz.new_(1,{E:"javax.swing.KeyStroke"},$I$(6,1).c$$I,[1]);
...
java.awt.JSComponent.秘setIsRepaint$Z(false);
jc.秘paint$java_awt_Graphics(jsg);
java.awt.JSComponent.秘setIsRepaint$Z(true);
...
policy=Clazz.new_($I$(10,1).c$$java_awt_FocusTraversalPolicy,[policy]);
...
var $in=null;
if (insets == null ) {
insets=Clazz.new_($I$(12,1).c$$I$I$I$I,[0, 0, 0, 0]);
...
var oldInputVerifier=this.getClientProperty$O($I$(13).JComponent_INPUT_VERIFIER);
this.putClientProperty$O$O($I$(13).JComponent_INPUT_VERIFIER, inputVerifier);
this.firePropertyChange$S$O$O("inputVerifier", oldInputVerifier, inputVerifier);
});

Clazz.newMeth(C$, 'getInputVerifier$', function () {
return this.getClientProperty$O($I$(13).JComponent_INPUT_VERIFIER);
});
...
var action=Clazz.new_($I$(14,1).c$$java_awt_event_ActionListener$S, [this, null, anAction, aCommand]);
...
if (registered == null ) {
registered=Clazz.new_($I$(15,1).c$$I,[strokes.length]);
...
$I$(16).getCurrentManager$().registerKeyStroke$javax_swing_KeyStroke$javax_swing_JComponent(aKeyStroke, this);
}, p$1);

Clazz.newMeth(C$, 'unregisterWithKeyboardManager$javax_swing_KeyStroke', function (aKeyStroke) {
$I$(16).getCurrentManager$().unregisterKeyStroke$javax_swing_KeyStroke$javax_swing_JComponent(aKeyStroke, this);
}, p$1);
...
var km=Clazz.new_($I$(18,1).c$$javax_swing_JComponent,[this]);
this.setInputMap$I$javax_swing_InputMap(condition, km);
return km;
}break;
default:
...
}shouldProcessKey=$I$(22).shouldProcess$java_awt_event_KeyEvent(e);
if (!e.isConsumed$() && (shouldProcessKey && this.processKeyBindings$java_awt_event_KeyEvent$Z(e, e.getID$() == 401)  || this.秘getUI$().processKeyEvent$java_awt_event_KeyEvent(e) ) ) {
e.consume$();
}});
...
while (true){
if ($I$(16).getCurrentManager$().fireKeyboardAction$java_awt_event_KeyEvent$Z$java_awt_Container(e, pressed, container)) {
return true;
}if ($I$(23).isHeavyWeight$java_awt_Container(container)) {
...
var toolTipManager=$I$(24).sharedInstance$();
if (text != null ) {
if (oldText == null ) {
...
$I$(26).stop$javax_swing_JComponent(this);
}}});
...
dispatch=!$I$(26).isRunning$javax_swing_JComponent(this);
$I$(26).processMouseDragged$java_awt_event_MouseEvent(e);
}if (dispatch) {
...
this.clientProperties=Clazz.new_($I$(27,1));
...
System.out.println$S(this.getClass$().getName$() + " property \"" + propertyName + "\" cannot be set using this method" + $I$(28).getStackTrace$I(5) );
}});

Clazz.newMeth(C$, 'setFocusTraversalKeys$I$java_util_Set', function (id, keystrokes) {
if (id == 0) {
p$1.setFlag$I$Z.apply(this, [26, true]);
} else if (id == 1) {
p$1.setFlag$I$Z.apply(this, [27, true]);
...
return this.getClientProperty$O($I$(13).JComponent_ANCESTOR_NOTIFIER);
}, p$1);
...
ancestorNotifier=Clazz.new_($I$(29,1).c$$javax_swing_JComponent,[this]);
this.putClientProperty$O$O($I$(13).JComponent_ANCESTOR_NOTIFIER, ancestorNotifier);
...
this.putClientProperty$O$O($I$(13).JComponent_ANCESTOR_NOTIFIER, null);
}});
...
var result;
if (listenerType === Clazz.getClass($I$(30),['ancestorAdded$javax_swing_event_AncestorEvent','ancestorMoved$javax_swing_event_AncestorEvent','ancestorRemoved$javax_swing_event_AncestorEvent']) ) {
result=this.getAncestorListeners$();
} else if (listenerType === Clazz.getClass($I$(31),['propertyChange$java_beans_PropertyChangeEvent']) ) {
...
this.invalidate$();
if (!this.秘isAWT$()) $I$(9).currentManager$javax_swing_JComponent(this).addInvalidComponent$javax_swing_JComponent(this);
} else {
...
var path=Clazz.new_(1,{E:"java.awt.Component"},$I$(32,1).c$$I,[7]);
var pIndex=-1;
var pCount=0;
...
var children=$I$(33).秘getChildArray$java_awt_Container(c);
var i=0;
