...
this.setSelectionModel$javax_swing_SingleSelectionModel(Clazz.new_($I$(3,1)));
...
return this.add$javax_swing_JMenuItem(Clazz.new_($I$(5,1).c$$S,[s]));
});
...
var p=Clazz.new_($I$(6,1).c$$I$I,[xposition, yposition]);
...
), Clazz.new_($I$(5,1), [this, null],P$.JPopupMenu$1));
...
var tempItems=Clazz.new_($I$(9,1));
...
if (e == null ) e=Clazz.new_($I$(12,1).c$$O,[this]);
...
this.setPopupSize$java_awt_Dimension(Clazz.new_($I$(15,1).c$$I$I,[width, height]));
});
...
if (this.margin == null ) {
return Clazz.new_($I$(16,1).c$$I$I$I$I,[0, 0, 0, 0]);
} else {
return this.margin;
}});
...
var mke=Clazz.new_($I$(17,1).c$$java_awt_Component$I$J$I$I$C$javax_swing_MenuElementA$javax_swing_MenuSelectionManager,[e.getComponent$(), e.getID$(), e.getWhen$(), e.getModifiers$(), e.getKeyCode$(), e.getKeyChar$(), path, manager]);
