(function(){var P$=Clazz.newPackage("javax.swing"),p$1={},I$=[[0,'java.util.ArrayList','java.io.File','swingjs.JSUtil','javax.swing.JDialog','java.awt.event.WindowAdapter','javax.swing.JOptionPane','java.awt.BorderLayout','javax.swing.UIManager','javax.swing.filechooser.FileFilter','java.awt.Toolkit','java.awt.event.ActionListener','java.awt.EventQueue','java.awt.event.ActionEvent']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.filters=Clazz.new_(1,{E:"javax.swing.filechooser.FileFilter"},$I$(1,1).c$$I,[5]);
this.dialog=null;
this.dialogType=0;
this.returnValue=-1;
this.accessory=null;
...
return Clazz.new_($I$(2,1).c$$S,[path.substring$I$I(0, path.lastIndexOf$S("/"))]);
}, p$1);
...
return Clazz.new_($I$(9,1).c$$SA,[Clazz.array(String, -1, ["*.*", "All Files"])]);
});
