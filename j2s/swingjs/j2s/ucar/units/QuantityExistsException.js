...
/*c*/var C$=Clazz.newClass(P$, "QuantityExistsException", null, 'ucar.units.UnitException');
...
Clazz.newMeth(C$, 'c$$ucar_units_BaseQuantity', function (quantity) {
C$.c$$S.apply(this, ["Base quantity \"" + quantity + " already exists" ]);
}, 1);
