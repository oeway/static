...
/*c*/var C$=Clazz.newClass(P$, "PrefixDBAccessException", null, 'ucar.units.PrefixDBException');
...
;C$.superclazz.c$$S.apply(this,["Couldn't access unit-prefix database: " + reason]);C$.$init$.apply(this);
}, 1);
