...
/*c*/var C$=Clazz.newClass(P$, "SpecificationException", null, 'ucar.units.UnitException');
...
;C$.superclazz.c$$S.apply(this,["Specification error: " + reason]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$S$S', function (spec, reason) {
;C$.superclazz.c$$S.apply(this,["Specification error in \"" + spec + "\": " + reason ]);C$.$init$.apply(this);
}, 1);
