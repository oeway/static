(function(){var P$=Clazz.newPackage("ucar.units"),I$=[[0,'Error','java.io.InputStreamReader']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "SimpleCharStream");
...
C$.$fields$=[['Z',['prevCharIsCR','prevCharIsLF'],'I',['bufsize','available','tokenBegin','bufpos','column','line','maxNextCharInd','inBuf','tabSize'],'O',['bufline','int[]','+bufcolumn','inputStream','java.io.Reader','buffer','char[]']]]

Clazz.newMeth(C$, 'setTabSize$I', function (i) {
this.tabSize=i;
});

Clazz.newMeth(C$, 'getTabSize$I', function (i) {
return this.tabSize;
});
...
this.available=this.tokenBegin;
 ...
 else this.ExpandBuff$Z(false);
} else if (this.available > this.tokenBegin) this.available=this.bufsize;
 else if ((this.tokenBegin - this.available) < 2048) this.ExpandBuff$Z(true);
...
Clazz.newMeth(C$, 'c$$java_io_Reader', function (dstream) {
C$.c$$java_io_Reader$I$I$I.apply(this, [dstream, 1, 1, 4096]);
}, 1);
...
Clazz.newMeth(C$, 'ReInit$java_io_Reader', function (dstream) {
this.ReInit$java_io_Reader$I$I$I(dstream, 1, 1, 4096);
});

Clazz.newMeth(C$, 'c$$java_io_InputStream$S$I$I$I', function (dstream, encoding, startline, startcolumn, buffersize) {
C$.c$$java_io_Reader$I$I$I.apply(this, [encoding == null  ? Clazz.new_($I$(2,1).c$$java_io_InputStream,[dstream]) : Clazz.new_($I$(2,1).c$$java_io_InputStream$S,[dstream, encoding]), startline, startcolumn, buffersize]);
}, 1);

Clazz.newMeth(C$, 'c$$java_io_InputStream$I$I$I', function (dstream, startline, startcolumn, buffersize) {
C$.c$$java_io_Reader$I$I$I.apply(this, [Clazz.new_($I$(2,1).c$$java_io_InputStream,[dstream]), startline, startcolumn, buffersize]);
}, 1);

Clazz.newMeth(C$, 'c$$java_io_InputStream$S$I$I', function (dstream, encoding, startline, startcolumn) {
C$.c$$java_io_InputStream$S$I$I$I.apply(this, [dstream, encoding, startline, startcolumn, 4096]);
}, 1);
...
Clazz.newMeth(C$, 'c$$java_io_InputStream$S', function (dstream, encoding) {
C$.c$$java_io_InputStream$S$I$I$I.apply(this, [dstream, encoding, 1, 1, 4096]);
}, 1);

Clazz.newMeth(C$, 'c$$java_io_InputStream', function (dstream) {
C$.c$$java_io_InputStream$I$I$I.apply(this, [dstream, 1, 1, 4096]);
}, 1);

Clazz.newMeth(C$, 'ReInit$java_io_InputStream$S$I$I$I', function (dstream, encoding, startline, startcolumn, buffersize) {
this.ReInit$java_io_Reader$I$I$I(encoding == null  ? Clazz.new_($I$(2,1).c$$java_io_InputStream,[dstream]) : Clazz.new_($I$(2,1).c$$java_io_InputStream$S,[dstream, encoding]), startline, startcolumn, buffersize);
});

Clazz.newMeth(C$, 'ReInit$java_io_InputStream$I$I$I', function (dstream, startline, startcolumn, buffersize) {
this.ReInit$java_io_Reader$I$I$I(Clazz.new_($I$(2,1).c$$java_io_InputStream,[dstream]), startline, startcolumn, buffersize);
});

Clazz.newMeth(C$, 'ReInit$java_io_InputStream$S', function (dstream, encoding) {
this.ReInit$java_io_InputStream$S$I$I$I(dstream, encoding, 1, 1, 4096);
});

Clazz.newMeth(C$, 'ReInit$java_io_InputStream', function (dstream) {
this.ReInit$java_io_InputStream$I$I$I(dstream, 1, 1, 4096);
});

Clazz.newMeth(C$, 'ReInit$java_io_InputStream$S$I$I', function (dstream, encoding, startline, startcolumn) {
this.ReInit$java_io_InputStream$S$I$I$I(dstream, encoding, startline, startcolumn, 4096);
});
