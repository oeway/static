(function(){var P$=Clazz.newPackage("javajs.async"),p$1={},I$=[[0,'javax.swing.JOptionPane','java.awt.event.ActionEvent']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['processed'],'O',['actionListener','java.awt.event.ActionListener','choice','java.lang.Object','options','Object[]']]]
...
case "inputValue":
p$1.process$O.apply(this, [val]);
break;
case "value":
if (val != null  && this.options == null   && !(Clazz.instanceOf(val, "java.lang.Integer")) ) {
p$1.process$I.apply(this, [p$1.getOptionIndex$OA$O.apply(this, [(evt.getSource$()).getOptions$(), val])]);
return;
}if (this.options != null ) {
var i=p$1.getOptionIndex$OA$O.apply(this, [this.options, val]);
val=Integer.valueOf$I(i >= 0 ? i : -1);
}p$1.process$O.apply(this, [val]);
break;
}
});
...
this.processed=true;
this.choice=new Integer(ret);
this.actionListener.actionPerformed$(Clazz.new_($I$(2,1).c$$O$I$S,[this, ret, "SelectedOption"]));
}, p$1);
...
this.processed=true;
this.choice=ret;
this.actionListener.actionPerformed$(Clazz.new_($I$(2,1).c$$O$I$S,[this, ret == null  ? 2 : 0, (ret == null  ? null : ret.toString())]));
}, p$1);
})();
