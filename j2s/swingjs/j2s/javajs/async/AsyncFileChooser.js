(function(){var P$=Clazz.newPackage("javajs.async"),p$1={},I$=[[0,'javajs.async.AsyncDialog']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.$finals$.processFile.apply$(this.$finals$.fc.getSelectedFile$());
});
})()
