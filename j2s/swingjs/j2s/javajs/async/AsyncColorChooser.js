(function(){var P$=Clazz.newPackage("javajs.async"),p$1={},I$=[[0,'javax.swing.JColorChooser','java.awt.event.ActionEvent']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
Clazz.loadClass("javax.swing.JColorChooser");javax.swing.JColorChooser.listener = this
}, p$1);
...
this.listener.actionPerformed$(Clazz.new_($I$(2,1).c$$O$I$S,[this, c == null  ? 0 : c.getRGB$(), c == null  ? null : c.toString()]));
}, p$1);
