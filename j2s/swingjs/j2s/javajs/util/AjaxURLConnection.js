...
C$.urlCache=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(1,1));
...
C$.$fields$=[['S',['postOut'],'O',['bytesOut','byte[]','streamOut','java.io.ByteArrayOutputStream','ajax','java.lang.Object']]
...
this.responseCode=-1;
var is=p$1.getInputStreamAndResponse$Z.apply(this, [false]);
...
C$.urlCache.put$TK$TV(p$1.getCacheKey.apply(this, []), data);
}}, p$1);
