...
return C$.streamToUTF8String$java_io_BufferedInputStream(Clazz.new_($I$(2,1).c$$java_io_InputStream,[Clazz.new_($I$(3,1).c$$BA,[bytes])]));
}, 1);
...
if (C$.getUTFEncodingForStream$java_io_BufferedInputStream(bis) === $I$(4).NONE ) return Clazz.new_($I$(5,1).c$$java_io_BufferedInputStream$S,[bis, (charSet == null  ? "UTF-8" : charSet)]);
...
return Clazz.new_($I$(2,1).c$$java_io_InputStream,[Clazz.new_($I$(3,1).c$$BA,[bytes])]);
}, 1);

Clazz.newMeth(C$, 'getBR$S', function (string) {
return Clazz.new_($I$(6,1).c$$java_io_Reader,[Clazz.new_($I$(7,1).c$$S,[string])]);
}, 1);
...
;C$.superclazz.c$$java_io_Reader.apply(this,[Clazz.new_($I$(1,1).c$$java_io_InputStream$S,[bis, (charSet == null  ? "UTF-8" : charSet)])]);C$.$init$.apply(this);
this.stream=bis;
}, 1);
