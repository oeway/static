(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,'java.util.Hashtable','javajs.util.SB','javajs.util.Lst','javajs.util.PT']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "CifDataParser", null, null, 'javajs.api.GenericCifDataParser');

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.htFields=Clazz.new_(1,{K:"String",V:"Integer"},$I$(1,1));
}
...
var data=null;
var data0=null;
var allData=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(1,1));
var models=Clazz.new_(1,{V:"java.util.Map"},$I$(3,1));
allData.put$TK$TV("models", models);
this.asObject=(this.getVersion$() >= 2);
this.nullString=null;
var saveFrames=Clazz.new_(1,{V:"java.util.Map"},$I$(3,1));
try {
while ((key=this.getNextToken$()) != null ){
if (key.startsWith$S("global_") || key.startsWith$S("data_") ) {
models.addLast$TV(data0=data=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(1,1)));
...
var d=data;
data=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(1,1));
...
var key;
var keyWords=Clazz.new_(1,{V:"String"},$I$(3,1));
var o;
...
data.put$TK$TV(key, Clazz.new_(1,{V:"String"},$I$(3,1)));
}
