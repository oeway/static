...
return (Clazz.instanceOf(is, "javajs.api.ZInputStream") ? is : Clazz.instanceOf(is, "java.io.BufferedInputStream") ? Clazz.new_($I$(1,1).c$$java_io_InputStream,[is]) : Clazz.new_($I$(1,1).c$$java_io_InputStream,[Clazz.new_($I$(2,1).c$$java_io_InputStream,[is])]));
}, 1);
...
bis=C$.getPngZipStream$java_io_BufferedInputStream$Z(bis, true);
var v=Clazz.new_(1,{V:"String"},$I$(7,1));
var zis=Clazz.new_($I$(6,1).c$$java_io_InputStream,[bis]);
var ze;
var manifest=null;
while ((ze=zis.getNextEntry$()) != null ){
...
return Clazz.new_($I$(2,1).c$$java_io_InputStream,[Clazz.new_($I$(8,1).c$$java_io_InputStream$I,[is, 512])]);
}, 1);

Clazz.newMeth(C$, 'newBZip2InputStream$java_io_InputStream', function (is) {
is.read$BA$I$I(Clazz.array(Byte.TYPE, [2]), 0, 2);
return Clazz.new_($I$(2,1).c$$java_io_InputStream,[Clazz.new_($I$(9,1).c$$java_io_InputStream,[is])]);
}, 1);
...
while ($I$(5).isGzipS$java_io_InputStream(bis))bis=Clazz.new_($I$(2,1).c$$java_io_InputStream,[C$.newGZIPInputStream$java_io_InputStream(bis)]);

return bis;
}, 1);

Clazz.newMeth(C$, 'getUnzippedInputStreamBZip2$java_io_BufferedInputStream', function (bis) {
while ($I$(5).isBZip2S$java_io_InputStream(bis))bis=Clazz.new_($I$(2,1).c$$java_io_InputStream,[C$.newBZip2InputStream$java_io_InputStream(bis)]);
...
if (name == null  || isImage ) bdata.put$TK$TV((isImage ? "_DATA_" : "_IMAGE_"), Clazz.new_($I$(13,1).c$$BA,[C$.getPngImageBytes$java_io_BufferedInputStream(bis)]));
...
bdata.put$TK$TV("_DATA_", Clazz.new_($I$(13,1).c$$BA,[$I$(5).getLimitedStreamBytes$java_io_InputStream$J(bis, -1)]));
} else {
