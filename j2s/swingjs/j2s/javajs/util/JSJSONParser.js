(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,'Boolean','javajs.util.SB','java.util.Hashtable','java.util.HashMap','javajs.util.Lst']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var map=(this.asHashTable ? Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(3,1)) : Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(4,1)));
var key=null;
...
var l=Clazz.new_(1,{V:"java.lang.Object"},$I$(5,1));
switch ((p$1.getChar.apply(this, [])).$c()) {
case 93:
return l;
case 0:
