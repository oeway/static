(function(){var P$=Clazz.newPackage("javajs.util"),I$=[[0,'javajs.util.V3','javajs.util.P3','javajs.util.T3','javajs.util.Lst','javajs.util.Quat','javajs.api.Interface','javajs.util.P4']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var v=Clazz.new_(1,{V:"javajs.util.P3"},$I$(4,1));
...
var list=Clazz.new_(1,{V:"java.lang.Object"},$I$(4,1));
