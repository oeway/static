(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,'javajs.util.BinaryDocument','javajs.util.BC','Boolean','java.util.Hashtable','javajs.util.SB']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var map=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(4,1));
for (var i=0; i < n; i++) {
