(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,['javajs.util.CBZip2InputStream','.Data']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
