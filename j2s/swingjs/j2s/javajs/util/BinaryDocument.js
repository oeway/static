(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,'java.io.DataInputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['isRandom','isBigEndian'],'L',['nBytes'],'O',['stream','java.io.DataInputStream','bis','java.io.BufferedInputStream','out','javajs.api.GenericOutputChannel','t8','byte[]']]]
