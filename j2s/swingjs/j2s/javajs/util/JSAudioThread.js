...
$I$(2).player.start$java_io_InputStream(Clazz.new_($I$(3,1).c$$sun_audio_AudioData,[Clazz.new_($I$(4,1).c$$BA,[data])]));
});
...
try {
var info=Clazz.new_($I$(5,1).c$$Class$javax_sound_sampled_AudioFormat,[Clazz.getClass($I$(6),['open$javax_sound_sampled_AudioFormat$I','open$javax_sound_sampled_AudioFormat','write$BA$I$I']), this.audioFormat]);
