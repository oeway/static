(function(){var P$=Clazz.newPackage("javajs.img"),p$1={},I$=[[0,'javajs.util.P3','javajs.util.M3','Boolean','javajs.util.Lst','java.util.Hashtable',['javajs.img.GifEncoder','.ColorItem'],'javajs.util.CU',['javajs.img.GifEncoder','.ColorCell']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var tempColors=Clazz.new_(1,{V:"javajs.img.GifEncoder.ColorItem"},$I$(4,1));
var ciHash=Clazz.new_(1,{K:"Integer",V:"javajs.img.GifEncoder.ColorItem"},$I$(5,1));
for (var i=0, n=this.pixels.length; i < n; i++) {
var rgb=this.pixels[i];
var key=Integer.valueOf$I(rgb);
var item=ciHash.get$O(key);
if (item == null ) {
item=Clazz.new_($I$(6,1).c$$I$Z, [this, null, rgb, rgb == this.backgroundColor]);
...
var colorMap=Clazz.new_(1,{K:"Integer",V:"javajs.img.GifEncoder.ColorCell"},$I$(5,1));
...
var cells=Clazz.new_(1,{V:"javajs.img.GifEncoder.ColorCell"},$I$(4,1));
var cc=Clazz.new_($I$(8,1).c$$I, [this, null, 0]);
cc.addLast$TV(Clazz.new_($I$(6,1).c$$I$Z, [this, null, this.backgroundColor, true]));
cells.addLast$TV(cc);
cc=Clazz.new_($I$(8,1).c$$I, [this, null, 1]);
...
if (n <= 256) {
cells.addLast$TV(cc);
cc=Clazz.new_($I$(8,1).c$$I, [this, null, cells.size$()]);
}}
tempColors.clear$();
...
var lab;
var rgb;
var nearestCell=Clazz.new_(1,{K:"Integer",V:"javajs.img.GifEncoder.ColorCell"},$I$(5,1));
