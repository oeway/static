(function(){var P$=Clazz.newPackage("javajs.img"),p$1={},I$=[[0,'javajs.export.PDFCreator','java.util.Hashtable']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var ht=Clazz.new_(1,{K:"String",V:"String"},$I$(2,1));
