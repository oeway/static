(function(){var P$=Clazz.newPackage("swingjs"),I$=[[0,'swingjs.JSMouse','swingjs.JSToolkit','java.awt.AWTKeyStroke']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
Clazz.newMeth(C$, 'dispatchKeyEvent$javax_swing_JComponent$I$O$J', function (c, id, jqevent, time) {
if (id == 0) id=$I$(1).fixEventType$O$I(jqevent, 0);
if (id == 400) {
$I$(2).consumeEvent$O(jqevent);
return false;
}if (c != null ) {
var ui=c.秘getUI$();
var e=C$.newJSKeyEvent$javax_swing_JComponent$O$I$Z(c, jqevent, id, false);
c.dispatchEvent$java_awt_AWTEvent(e);
if (!ui.j2sDoPropagate) $I$(2).consumeEvent$O(e);
