(function(){var P$=Clazz.newPackage("swingjs"),p$1={},p$2={},I$=[[0,['swingjs.JSDnD','.FileTransferable'],'java.awt.datatransfer.DataFlavor','java.util.ArrayList','java.io.File',['swingjs.JSDnD','.JSTransferable'],'swingjs.JSUtil',['swingjs.JSDnD','.JSDropMouseEvent'],'java.awt.dnd.DropTargetContext',['swingjs.JSDnD','.JSDropTargetContextPeer'],'java.awt.dnd.DropTargetDropEvent','java.awt.Point']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var t=Clazz.new_($I$(5,1).c$$O,[html5DataTransfer]);
if (name == null ) {
...
top.dispatchEvent$java_awt_AWTEvent(Clazz.new_($I$(7,1).c$$java_awt_Component$I$I$I$java_awt_datatransfer_Transferable$S$BA,[jc, 502, x, y, t, name, data]));
}, 1);

Clazz.newMeth(C$, 'drop$javax_swing_JComponent$O$OAA$I$I', function (jc, html5DataTransfer, data, x, y) {
if (html5DataTransfer == null ) return;
var t=Clazz.new_($I$(1,1).c$$OAA,[data]);
var target=jc.getDropTarget$();
System.out.println$S("JSDnD[] drop for " + jc.getUIClassID$() + " target " + target );
if (target != null ) {
...
top.dispatchEvent$java_awt_AWTEvent(Clazz.new_($I$(7,1).c$$java_awt_Component$I$I$I$java_awt_datatransfer_Transferable$S$BA,[jc, 502, x, y, t, null, null]));
}, 1);
...
var context=Clazz.new_($I$(8,1).c$$java_awt_dnd_DropTarget,[target]);
context.addNotify$java_awt_dnd_peer_DropTargetContextPeer(Clazz.new_($I$(9,1).c$$java_awt_dnd_DropTarget$java_awt_datatransfer_Transferable$S$BA,[target, t, null, null]));
return Clazz.new_($I$(10,1).c$$java_awt_dnd_DropTargetContext$java_awt_Point$I$I,[context, Clazz.new_($I$(11,1).c$$I$I,[x, y]), 2, 1073741827]);
}, 1);
...
var context=Clazz.new_($I$(8,1).c$$java_awt_dnd_DropTarget,[target]);
context.addNotify$java_awt_dnd_peer_DropTargetContextPeer(Clazz.new_($I$(9,1).c$$java_awt_dnd_DropTarget$java_awt_datatransfer_Transferable$S$BA,[target, t, name, data]));
return Clazz.new_($I$(10,1).c$$java_awt_dnd_DropTargetContext$java_awt_Point$I$I,[context, Clazz.new_($I$(11,1).c$$I$I,[x, y]), 2, 1073741827]);
}, 1);
;
...
if (this.name == null ) target.drop$java_awt_dnd_DropTargetDropEvent(P$.JSDnD.createDropEvent$java_awt_dnd_DropTarget$java_awt_datatransfer_Transferable$S$BA$I$I(target, this.transferable, null, null, this.getX$(), this.getY$()));
 else target.drop$java_awt_dnd_DropTargetDropEvent(P$.JSDnD.createDropEvent$java_awt_dnd_DropTarget$java_awt_datatransfer_Transferable$S$BA$I$I(target, this.transferable, this.name, this.getBData$(), this.getX$(), this.getY$()));
} catch (e) {
...
;C$.$init$.apply(this);
this.target=target;
this.transferable=(name == null  ? t : Clazz.new_($I$(1,1).c$$S$BA,[name, data]));
}, 1);
...
this.flavors=Clazz.array($I$(2), [this.mimeTypes.length]);
for (var i=0; i < this.mimeTypes.length; i++) {
try {
this.flavors[i]=Clazz.new_($I$(2,1).c$$S,[this.mimeTypes[i]]);
} catch (e) {
...
this.files=Clazz.new_(1,{E:"java.io.File"},$I$(3,1));
p$2.addFile$S$BA.apply(this, [name, data]);
}, 1);

Clazz.newMeth(C$, 'addFile$S$BA', function (name, data) {
var file=Clazz.new_($I$(4,1).c$$S,[name]);
file.秘bytes=data;
this.files.add$TE(file);
}, p$2);
...
Clazz.newMeth(C$, 'getTransferDataFlavors$', function () {
var flavors=Clazz.array($I$(2), [1]);
flavors[0]=$I$(2).javaFileListFlavor;
return flavors;
});
