...
this.status=0;
this.allWindows=Clazz.new_(1,{V:"java.awt.Window"},$I$(4,1));
}, 1);
...
try {
return Clazz.new_($I$(1,1).c$$S,[this.params.get$O("documentbase")]);
} catch (e) {
...
try {
return Clazz.new_($I$(1,1).c$$S,[this.params.get$O("codepath")]);
} catch (e) {
if (Clazz.exceptionOf(e,"java.net.MalformedURLException")){
return null;
} else {
...
var appletList=Clazz.new_(1,{E:"java.applet.JSApplet"},$I$(17,1));
