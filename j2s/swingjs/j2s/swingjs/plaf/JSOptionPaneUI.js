...
{
C$.newline=$I$(5).doPrivileged$java_security_PrivilegedAction(Clazz.new_($I$(6,1).c$$S,["line.separator"]));
if (C$.newline == null ) {
C$.newline="\n";
}};
}
...
map.put$javax_swing_Action(Clazz.new_($I$(7,1).c$$S,["close"]));
}, 1);
...
return Clazz.new_($I$(11,1).c$$java_awt_Container$I,[this.optionPane, 1]);
});
...
if (ourMin != null ) return Clazz.new_($I$(2,1).c$$I$I,[Math.max(lmSize.width, ourMin.width), Math.max(lmSize.height, ourMin.height)]);
return lmSize;
}return ourMin;
}return null;
});
...
}top.setLayout$java_awt_LayoutManager(Clazz.new_($I$(17,1)));
var body=Clazz.new_($I$(16,1).c$$java_awt_LayoutManager,[Clazz.new_($I$(18,1))]);
var realBody=Clazz.new_($I$(16,1).c$$java_awt_LayoutManager,[Clazz.new_($I$(17,1))]);
body.setName$S("OptionPane.body");
realBody.setName$S("OptionPane.realBody");
if (this.getIcon$() != null ) {
var sep=Clazz.new_($I$(16,1));
...
cons.insets=Clazz.new_($I$(20,1).c$$I$I$I$I,[0, 0, 3, 0]);
...
var label=Clazz.new_($I$(21,1).c$$javax_swing_Icon$I,[msg, 0]);
...
var f=this.getFont$();
if (f != null ) {
return Clazz.new_($I$(2,1).c$$I$I,[1, f.getSize$() + 2]);
}return Clazz.new_($I$(2,1).c$$I$I,[0, 0]);
});
})()
), Clazz.new_($I$(16,1), [this, null],P$.JSOptionPaneUI$1));
...
var label;
label=Clazz.new_($I$(21,1).c$$S$I,[s, 10]);
...
var list=Clazz.new_($I$(24,1).c$$TEA,[sValues]);
var sp=Clazz.new_($I$(25,1).c$$java_awt_Component,[list]);
...
var tf=Clazz.new_($I$(26,1).c$$I,[20]);
...
if (sideIcon != null ) {
var iconLabel=Clazz.new_($I$(21,1).c$$javax_swing_Icon,[sideIcon]);
...
return;
}}var label=Clazz.new_($I$(21,1).c$$S$I,[d, 2]);
label.setName$S("OptionPane.label");
p$2.configureMessageLabel$javax_swing_JLabel.apply(this, [label]);
...
aButton=(button).createButton$();
 ...
 else aButton=Clazz.new_($I$(4,1).c$$S,[button.toString()]);
...
aButton.setMargin$java_awt_Insets(Clazz.new_($I$(20,1).c$$I$I$I$I,[2, padSize, 2, padSize]));
}
}}});

Clazz.newMeth(C$, 'createButtonActionListener$I', function (buttonIndex) {
return Clazz.new_($I$(29,1).c$$I, [this, null, buttonIndex]);
});
...
return Clazz.new_($I$(2,1).c$$I$I,[extraWidth + (maxWidth * numChildren) + (numChildren - 1) * this.padding , extraHeight + height]);
} else {
var totalWidth=0;
for (var counter=0; counter < numChildren; counter++) {
aSize=children[counter].getPreferredSize$();
