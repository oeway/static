(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'javax.swing.border.EmptyBorder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
