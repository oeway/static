...
this.domNode=this.focusNode=this.enableNode=P$.JSComponentUI.newDOMObject$S$S$SA("div", this.id, []);
...
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectPreviousColumn"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectPreviousColumnExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectPreviousColumnChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectNextColumn"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectNextColumnExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectNextColumnChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectPreviousRow"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectPreviousRowExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectPreviousRowChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectNextRow"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectNextRowExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectNextRowChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectFirstRow"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectFirstRowExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectFirstRowChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectLastRow"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectLastRowExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectLastRowChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["scrollUp"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["scrollUpExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["scrollUpChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["scrollDown"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["scrollDownExtendSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["scrollDownChangeLead"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["selectAll"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["clearSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["addToSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["toggleAndAnchor"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["extendTo"]));
map.put$javax_swing_Action(Clazz.new_($I$(8,1).c$$S,["moveSelectionTo"]));
}, 1);
...
$I$(9).setTopLeftAbsolute(div, top, left);
div.appendChild(node);
this.innerNode.appendChild(div);
}} else {
jnode.empty();
if (node != null ) jnode.append(node);
}$I$(9).setSize(node, width, height);
}, p$3);
...
var lafDefaults=$I$(10).getLookAndFeelDefaults$();
var baselineComponent=lafDefaults.get$O(C$.BASELINE_COMPONENT_KEY);
if (baselineComponent == null ) {
var lcr=$I$(10).get$O("List.cellRenderer");
if (lcr == null ) {
lcr=Clazz.new_($I$(11,1));
...
height=0;
}}return Clazz.new_($I$(13,1).c$$I$I,[width, height]);
}, p$3);
...
$I$(14).installLazyActionMap$javax_swing_JComponent$Class$S(this.list, Clazz.getClass(C$), "List.actionMap");
});

Clazz.newMeth(C$, 'getInputMap$I', function (condition) {
if (condition == 0) {
var keyMap=$I$(15).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.list, this, "List.focusInputMap");
var rtlKeyMap;
if (this.isLeftToRight || ((rtlKeyMap=$I$(15).get$javax_swing_JComponent$javax_swing_plaf_ComponentUI$S(this.list, this, "List.focusInputMap.RightToLeft")) == null ) ) {
return keyMap;
} else {
...
$I$(16).installBorder$javax_swing_JComponent$S(this.list, "List.border");
$I$(16).installColorsAndFont$javax_swing_JComponent$S$S$S(this.list, "List.background", "List.foreground", "List.font");
$I$(16).installProperty$javax_swing_JComponent$S$O(this.list, "opaque", $I$(17).TRUE);
if (this.list.getCellRenderer$() == null ) {
this.list.setCellRenderer$javax_swing_ListCellRenderer(($I$(10).get$O("List.cellRenderer")));
}var sbg=this.list.getSelectionBackground$();
if (sbg == null  || Clazz.instanceOf(sbg, "javax.swing.plaf.UIResource") ) {
this.list.setSelectionBackground$java_awt_Color($I$(10).getColor$O("List.selectionBackground"));
}var sfg=this.list.getSelectionForeground$();
if (sfg == null  || Clazz.instanceOf(sfg, "javax.swing.plaf.UIResource") ) {
this.list.setSelectionForeground$java_awt_Color($I$(10).getColor$O("List.selectionForeground"));
}var l=$I$(10).get$O("List.timeFactor");
this.timeFactor=(l != null ) ? l.longValue$() : 1000;
this.updateIsFileList$();
});

Clazz.newMeth(C$, 'updateIsFileList$', function () {
var b=$I$(17).TRUE.equals$O(this.list.getClientProperty$O("List.isFileList"));
if (b != this.isFileList ) {
this.isFileList=b;
var oldFont=this.getFont$();
if (oldFont == null  || Clazz.instanceOf(oldFont, "javax.swing.plaf.UIResource") ) {
var newFont=$I$(10).getFont$O(b ? "FileChooser.listFont" : "List.font");
if (newFont != null  && newFont !== oldFont  ) {
this.list.setFont$java_awt_Font(newFont);
}}}});

Clazz.newMeth(C$, 'uninstallDefaults$', function () {
$I$(16).uninstallBorder$javax_swing_JComponent(this.list);
...
this.rendererPane=Clazz.new_($I$(18,1));
...
if (rect != null ) {
return Clazz.new_($I$(3,1).c$$I$I,[rect.x, rect.y]);
}return null;
});
...
return Clazz.new_($I$(2,1).c$$I$I$I$I,[x, y, w, h]);
}, p$3);
...
this.handler=Clazz.new_($I$(19,1).c$$javax_swing_JComponent, [this, null, this.jc]);
}return this.handler;
});
...
return Clazz.new_($I$(13,1).c$$I$I,[w + 24, h]);
});
...
return Clazz.new_($I$(13,1).c$$I$I,[this.getFont$().getSize$() * 10, h]);
});
;
...
break;
case "addToSelection":
index=P$.JSListUI.adjustIndex$I$javax_swing_JList(list.getSelectionModel$().getLeadSelectionIndex$(), list);
...
var lsm=list.getSelectionModel$();
var lead=P$.JSListUI.adjustIndex$I$javax_swing_JList(lsm.getLeadSelectionIndex$(), list);
var leadRect=(lead == -1) ? Clazz.new_($I$(2,1)) : list.getCellBounds$I$I(lead, lead);
if (list.getLayoutOrientation$() == 1 && list.getVisibleRowCount$() <= 0 ) {
if (!list.getComponentOrientation$().isLeftToRight$()) {
direction=-direction;
}if (direction < 0) {
visRect.x=leadRect.x + leadRect.width - visRect.width;
var p=Clazz.new_($I$(3,1).c$$I$I,[visRect.x - 1, leadRect.y]);
...
var p=Clazz.new_($I$(3,1).c$$I$I,[visRect.x + visRect.width, leadRect.y]);
index=list.locationToIndex$java_awt_Point(p);
var cellBounds=list.getCellBounds$I$I(index, index);
if (visRect.intersects$java_awt_Rectangle(cellBounds)) {
p.x=cellBounds.x + cellBounds.width;
...
if (direction < 0) {
var p=Clazz.new_($I$(3,1).c$$I$I,[leadRect.x, visRect.y]);
index=list.locationToIndex$java_awt_Point(p);
if (lead <= index) {
...
var p=Clazz.new_($I$(3,1).c$$I$I,[leadRect.x, visRect.y + visRect.height - 1]);
index=list.locationToIndex$java_awt_Point(p);
var cellBounds=list.getCellBounds$I$I(index, index);
...
var startIndex=list.locationToIndex$java_awt_Point(Clazz.new_($I$(3,1).c$$I$I,[x, cellBounds.y]));
...
var rightIndex=list.locationToIndex$java_awt_Point(Clazz.new_($I$(3,1).c$$I$I,[x, cellBounds.y]));
...
var startIndex=list.locationToIndex$java_awt_Point(Clazz.new_($I$(3,1).c$$I$I,[cellBounds.x, y]));
var startRect=list.getCellBounds$I$I(startIndex, startIndex);
...
C$.$fields$=[['Z',['dragPressDidSelection'],'L',['lastTime'],'S',['prefix','typedString']]]
...
if (oldModel2 != null ) {
oldModel2.removeListSelectionListener$javax_swing_event_ListSelectionListener(this.this$0.listSelectionListener);
}if (newModel2 != null ) {
newModel2.addListSelectionListener$javax_swing_event_ListSelectionListener(this.this$0.listSelectionListener);
}this.this$0.updateLayoutStateNeeded|=1;
this.this$0.redrawList$.apply(this.this$0, []);
break;
case "cellRenderer":
...
Clazz.newMeth(C$, 'mouseClicked$java_awt_event_MouseEvent', function (e) {
this.this$0.list.秘processUIEvent$java_awt_event_MouseEvent(e);
});
...
Clazz.newMeth(C$, 'mousePressed$java_awt_event_MouseEvent', function (e) {
if (this.this$0.list.秘processUIEvent$java_awt_event_MouseEvent(e)) {
return;
