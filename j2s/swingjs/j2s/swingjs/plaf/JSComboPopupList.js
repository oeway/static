...
if (i >= 0) this.cbui.comboBox.getRenderer$().getListCellRendererComponent$(this, this.getModel$().getElementAt$I(i), i, true, false);
this.updateZIndex$();
break;
}
return true;
...
var ui=l.getUI$();
for (var i=0; i < n; i++) {
var j=this.cbui.comboBox.getRenderer$().getListCellRendererComponent$(this, this.getModel$().getElementAt$I(i), i, true, false);
