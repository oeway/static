(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'java.awt.Insets','swingjs.plaf.JSComponentUI','swingjs.api.js.DOMNode','java.awt.Toolkit','java.awt.Color','java.awt.event.ComponentEvent','javax.swing.Timer','java.awt.event.WindowEvent','javax.swing.LookAndFeel','java.awt.Rectangle']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['isModal','isInternalFrame','doEmbed','isHidden'],'I',['state','zModal'],'O',['frame','javax.swing.JFrame','closerWrap','swingjs.api.js.DOMNode','bounds','java.awt.Rectangle']]
...
$I$(3).setStyles(this.modalNode, ["position", "sticky", "left", "0px", "top", "0px", "background", P$.JSComponentUI.toCSSString$java_awt_Color(Clazz.new_($I$(5,1).c$$I$I$I$I,[100, 100, 100, 100]))]);
...
Clazz.newMeth(C$, ['getEmbedded$S','getEmbedded$'], function (type) {
...
this.toFront$();
$I$(4).getEventQueue$().postEvent$java_awt_AWTEvent(Clazz.new_($I$(6,1).c$$java_awt_Component$I,[this.frame, 100]));
});
...
var t=Clazz.new_($I$(7,1).c$$I$java_awt_event_ActionListener,[100, ((P$.JSFrameUI$1||
...
this.b$['swingjs.plaf.JSFrameUI'].frame.dispatchEvent$java_awt_AWTEvent(Clazz.new_($I$(8,1).c$$java_awt_Window$I,[this.b$['swingjs.plaf.JSFrameUI'].frame, 201]));
});
})()
), Clazz.new_(P$.JSFrameUI$1.$init$, [this, null]))]);
...
$I$(9).installColorsAndFont$javax_swing_JComponent$S$S$S(jc, "Frame.background", "Frame.foreground", "Frame.font");
});
...
this.bounds=Clazz.new_($I$(10,1).c$$I$I$I$I,[x, y, width, height]);
});
