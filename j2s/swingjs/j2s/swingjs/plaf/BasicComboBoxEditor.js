(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,['swingjs.plaf.BasicComboBoxEditor','.BorderlessTextField'],'sun.reflect.misc.MethodUtil']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
newValue=$I$(2).invoke$reflect_Method$O$OA(method, this.oldValue, Clazz.array(java.lang.Object, -1, [this.editor.getText$()]));
} catch (ex) {
