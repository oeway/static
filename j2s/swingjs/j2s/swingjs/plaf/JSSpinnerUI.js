...
this.handler=Clazz.new_($I$(12,1));
}return this.handler;
}, p$3);
...
var b=Clazz.new_($I$(13,1).c$$I,[direction]);
var buttonBorder=$I$(2).getBorder$O("Spinner.arrowButtonBorder");
if (Clazz.instanceOf(buttonBorder, "javax.swing.plaf.UIResource")) {
b.setBorder$javax_swing_border_Border(Clazz.new_($I$(14,1).c$$javax_swing_border_Border$javax_swing_border_Border,[buttonBorder, null]));
} else {
