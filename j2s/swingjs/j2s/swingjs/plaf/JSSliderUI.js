(function(){var P$=Clazz.newPackage("swingjs.plaf"),p$1={},I$=[[0,'swingjs.jquery.JQueryUI','swingjs.JSUtil','swingjs.api.js.DOMNode','swingjs.plaf.JSComponentUI','java.awt.Color','swingjs.JSToolkit','javax.swing.LookAndFeel','java.awt.Dimension','sun.swing.DefaultLookup']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['paintTicks','paintLabels','snapToTicks','paintTrack','isScrollBar','isHoriz','isVerticalScrollBar','isInverted','noSnapping'],'I',['min','max','val','majorSpacing','minorSpacing','z0','disabled','myHeight'],'S',['orientation','foreColor'],'O',['slider','javax.swing.JSlider','labelTable','java.util.Dictionary','jqSlider','swingjs.api.js.DOMNode','model','javax.swing.BoundedRangeModel','myScrollPaneUI','swingjs.plaf.JSScrollPaneUI','jScrollBar','javax.swing.JScrollBar','sliderTrack','swingjs.api.js.DOMNode','+sliderHandle','ticks','int[]']]]
...
if (this.isScrollBar && ($I$(5).WHITE.equals$O(c) || c.getRGB$() == (-1118482) ) ) $I$(3).setStyles(this.sliderHandle, ["background", "#ccc"]);
...
return Clazz.new_($I$(8,1).c$$I$I,[(this.isHoriz ? this.actualWidth : d), (this.isHoriz ? d : this.actualHeight)]);
});
...
if (horizDim == null ) {
horizDim=Clazz.new_($I$(8,1).c$$I$I,[36, this.paintLabels ? 35 : 21]);
}return horizDim;
}, p$1);
...
if (vertDim == null ) {
vertDim=Clazz.new_($I$(8,1).c$$I$I,[this.paintLabels ? 35 : 21, 36]);
}return vertDim;
}, p$1);
...
return Clazz.new_($I$(8,1).c$$I$I,[horizDim.width, Math.max(horizDim.height, this.myHeight)]);
});
...
return Clazz.new_($I$(8,1).c$$I$I,[Math.max(vertDim.height, this.myHeight), vertDim.width]);
});
...
return (d != null  ? d : this.isHoriz ? Clazz.new_($I$(8,1).c$$I$I,[32767, 40]) : Clazz.new_($I$(8,1).c$$I$I,[40, 32767]));
});
})();
