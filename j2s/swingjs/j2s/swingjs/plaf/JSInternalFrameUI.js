...
$I$(2).setStyles(this.outerNode, ["position", "sticky"]);
return true;
});
...
$I$(3).installProperty$javax_swing_JComponent$S$O(this.iframe, "opaque", $I$(1).TRUE);
});
