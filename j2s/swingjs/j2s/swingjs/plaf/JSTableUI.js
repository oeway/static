...
if (cell != null ) $I$(9).updateCellNode$swingjs_api_js_DOMNode$java_awt_JSComponent$I$I(td, cell, -1, -1);
}, p$2);
...
this.table.dispatchEvent$java_awt_AWTEvent(Clazz.new_($I$(10,1).c$$java_awt_Component$I$J$I$I$I$I$Z,[this.table, (isEntry ? 504 : 505), System.currentTimeMillis$(), 0, -1, -1, 0, false]));
}, p$2);
...
this.table=c;
this.rendererPane=Clazz.new_($I$(12,1));
...
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectNextColumn", 1, 0, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectNextColumnChangeLead", 1, 0, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectPreviousColumn", -1, 0, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectPreviousColumnChangeLead", -1, 0, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectNextRow", 0, 1, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectNextRowChangeLead", 0, 1, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectPreviousRow", 0, -1, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectPreviousRowChangeLead", 0, -1, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectNextColumnExtendSelection", 1, 0, true, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectPreviousColumnExtendSelection", -1, 0, true, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectNextRowExtendSelection", 0, 1, true, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectPreviousRowExtendSelection", 0, -1, true, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["scrollUpChangeSelection", false, false, true, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["scrollDownChangeSelection", false, true, true, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["selectFirstColumn", false, false, false, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["selectLastColumn", false, true, false, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["scrollUpExtendSelection", true, false, true, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["scrollDownExtendSelection", true, true, true, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["selectFirstColumnExtendSelection", true, false, false, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["selectLastColumnExtendSelection", true, true, false, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["selectFirstRow", false, false, true, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["selectLastRow", false, true, true, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["selectFirstRowExtendSelection", true, false, true, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["selectLastRowExtendSelection", true, true, true, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectNextColumnCell", 1, 0, false, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectPreviousColumnCell", -1, 0, false, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectNextRowCell", 0, 1, false, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$I$I$Z$Z,["selectPreviousRowCell", 0, -1, false, true]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["selectAll"]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["clearSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["cancel"]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["startEditing"]));
...
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["scrollLeftChangeSelection", false, false, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["scrollRightChangeSelection", false, true, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["scrollLeftExtendSelection", true, false, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S$Z$Z$Z$Z,["scrollRightExtendSelection", true, true, false, false]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["addToSelection"]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["toggleAndAnchor"]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["extendTo"]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["moveSelectionTo"]));
map.put$javax_swing_Action(Clazz.new_($I$(17,1).c$$S,["focusHeader"]));
}, 1);
...
if (tmp > 2147483647) {
tmp=2147483647;
}return Clazz.new_($I$(21,1).c$$I$I,[(tmp|0), height]);
}, p$2);
...
var lowerRight=Clazz.new_($I$(22,1).c$$I$I,[clip.x + clip.width - 1, clip.y + clip.height - 1]);
...
C$.$fields$=[['Z',['dragPressDidSelection','dragStarted','shouldStartTimer','outsidePrefSize'],'I',['pressedRow','pressedCol'],'O',['dispatchComponent','java.awt.Component','pressedEvent','java.awt.event.MouseEvent','timer','javax.swing.Timer']]]
