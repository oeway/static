(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'swingjs.api.js.DOMNode','javax.swing.BorderFactory','swingjs.plaf.ButtonListener','javax.swing.UIManager','javax.swing.LookAndFeel','java.awt.Dimension','swingjs.plaf.JSLabelUI']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.setDoPropagate$();
this.domNode=this.enableNode=this.buttonNode=P$.JSComponentUI.newDOMObject$S$S$SA("button", this.id + "_dom", ["type", "button", "style", "padding:0"]);
...
this.buttonListener=Clazz.new_($I$(3,1).c$$swingjs_plaf_JSButtonUI,[this]);
...
return Clazz.new_($I$(6,1).c$$I$I,[(this.itemNode == null  ? 0 : 10), 0]);
});
...
if (this.isAWT && this.isSimpleButton ) return $I$(7).getMinimumSizePeer$javax_swing_JComponent$O(jc, this.button);
