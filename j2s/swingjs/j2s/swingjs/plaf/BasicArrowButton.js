(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'javax.swing.UIManager','java.awt.Dimension']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(2,1).c$$I$I,[2147483647, 2147483647]);
});
