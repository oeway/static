...
this.desktopManager=Clazz.new_($I$(6,1), [this, null]);
...
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).RESTORE]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).CLOSE]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).MOVE]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).RESIZE]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).LEFT]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).SHRINK_LEFT]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).RIGHT]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).SHRINK_RIGHT]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).UP]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).SHRINK_UP]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).DOWN]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).SHRINK_DOWN]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).ESCAPE]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).MINIMIZE]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).MAXIMIZE]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).NEXT_FRAME]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).PREVIOUS_FRAME]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).NAVIGATE_NEXT]));
map.put$javax_swing_Action(Clazz.new_($I$(9,1).c$$S,[$I$(9).NAVIGATE_PREVIOUS]));
}, 1);
