(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'swingjs.api.js.DOMNode','swingjs.plaf.JSComponentUI']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (this.jc.秘isDesktop$()) return;
this.z=this.J2S.setWindowZIndex(this.domNode, 2147483647);
this.setZ$I(this.z);
if (this.modalNode != null ) $I$(1).setZ(this.modalNode, this.z - 1);
});
...
if (this.modalNode != null ) $I$(1).dispose(this.modalNode);
