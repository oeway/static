...
this.domNode=this.focusNode=P$.JSComponentUI.newDOMObject$S$S$SA("div", this.id, []);
...
if (inTable != null ) {
this.isTableCellEditor=inTable.equals$O($I$(6).TRUE) ? true : false;
...
this.keySelectionManager=Clazz.new_($I$(15,1), [this, null]);
...
$I$(16).installColorsAndFont$javax_swing_JComponent$S$S$S(this.comboBox, "ComboBox.background", "ComboBox.foreground", "ComboBox.font");
$I$(16).installBorder$javax_swing_JComponent$S(this.comboBox, "ComboBox.border");
$I$(16).installProperty$javax_swing_JComponent$S$O(this.comboBox, "opaque", $I$(6).TRUE);
...
$I$(16).installColorsAndFont$javax_swing_JComponent$S$S$S(this.comboBox, "ComboBox.background", "ComboBox.foreground", "ComboBox.font");
$I$(16).uninstallBorder$javax_swing_JComponent(this.comboBox);
});
...
var renderer=$I$(17).getAppContext$().get$O(C$.COMBO_UI_LIST_CELL_RENDERER_KEY);
if (renderer == null ) {
$I$(17).getAppContext$().put$O$O(C$.COMBO_UI_LIST_CELL_RENDERER_KEY, renderer=Clazz.new_($I$(18,1)));
}return renderer;
}, 1);

Clazz.newMeth(C$, 'loadActionMap$swingjs_plaf_LazyActionMap', function (map) {
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["hidePopup"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["pageDownPassThrough"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["pageUpPassThrough"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["homePassThrough"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["endPassThrough"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["selectNext"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["selectNext2"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["togglePopup"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["spacePopup"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["selectPrevious"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["selectPrevious2"]));
map.put$javax_swing_Action(Clazz.new_($I$(19,1).c$$S,["enterPressed"]));
}, 1);

Clazz.newMeth(C$, 'createPopup$', function () {
return Clazz.new_($I$(20,1).c$$swingjs_plaf_JSComboBoxUI,[this]);
});
...
this.handler=Clazz.new_($I$(23,1), [this, null]);
}return this.handler;
}, p$1);
...
return Clazz.new_($I$(14,1).c$$java_awt_Dimension,[this.cachedMinimumSize]);
...
return Clazz.new_($I$(14,1).c$$java_awt_Dimension,[size]);
});

Clazz.newMeth(C$, 'getMaximumSize$javax_swing_JComponent', function (c) {
return Clazz.new_($I$(14,1).c$$I$I,[32767, 32767]);
});
...
}var component=renderer.getListCellRendererComponent$(this.listBox, value, -1, false, false);
...
if ($I$(7).isLeftToRight$java_awt_Component(this.comboBox)) {
return Clazz.new_($I$(25,1).c$$I$I$I$I,[insets.left, insets.top, width - (insets.left + insets.right + buttonSize ), height - (insets.top + insets.bottom)]);
} else {
return Clazz.new_($I$(25,1).c$$I$I$I$I,[insets.left + buttonSize, insets.top, width - (insets.left + insets.right + buttonSize ), height - (insets.top + insets.bottom)]);
}});
...
var d=this.getSizeForComponent$java_awt_Component(C$.getDefaultListCellRenderer$().getListCellRendererComponent$(this.listBox, " ", -1, false, false));
return Clazz.new_($I$(14,1).c$$I$I,[d.width, d.height]);
});

Clazz.newMeth(C$, 'getDisplaySize$', function () {
if (!this.isDisplaySizeDirty) {
return Clazz.new_($I$(14,1).c$$java_awt_Dimension,[this.cachedDisplaySize]);
}var result=Clazz.new_($I$(14,1));
this.renderer=this.comboBox.getRenderer$();
if (this.renderer == null ) {
this.renderer=Clazz.new_($I$(18,1));
}this.sameBaseline=true;
var prototypeValue=this.comboBox.getPrototypeDisplayValue$();
if (prototypeValue != null ) {
result=this.getSizeForComponent$java_awt_Component(this.renderer.getListCellRendererComponent$(this.listBox, prototypeValue, -1, false, false));
} else {
...
var c=this.renderer.getListCellRendererComponent$(this.listBox, value, -1, false, false);
...
$I$(26).installLazyActionMap$javax_swing_JComponent$Class$S(this.comboBox, Clazz.getClass(C$), "ComboBox.actionMap");
});
...
if (action != null ) {
action.actionPerformed$(Clazz.new_($I$(5,1).c$$O$I$S$J$I,[root, e.getID$(), e.getActionCommand$(), e.getWhen$(), e.getModifiers$()]));
}}}}}}});
...
this.this$0.isTableCellEditor=inTable.equals$O($I$(6).TRUE) ? true : false;
...
return !e.isAltDown$() && !$I$(7).isMenuShortcutKeyDown$java_awt_event_InputEvent(e) ;
}, p$3);
...
this.this$0.comboBox.actionPerformed$java_awt_event_ActionEvent(Clazz.new_($I$(5,1).c$$O$I$S$J$I,[editor, 0, "", $I$(8).getMostRecentEventTime$(), 0]));
...
if (action != null ) {
action.actionPerformed$(Clazz.new_($I$(5,1).c$$O$I$S$I,[this.this$0.comboBox, evt.getID$(), evt.getActionCommand$(), evt.getModifiers$()]));
}}}});
...
startIndex=0;
}var index=this.this$0.listBox.getNextMatch$S$I$javax_swing_text_Position_Bias(this.prefix, startIndex, $I$(9).Forward);
if (index < 0 && startingFromSelection ) {
index=this.this$0.listBox.getNextMatch$S$I$javax_swing_text_Position_Bias(this.prefix, 0, $I$(9).Forward);
}return index;
});
