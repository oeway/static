...
return (this.isAWT && (jc.getWidth$() != 0 || jc.getHeight$() != 0 )  ? Clazz.new_($I$(3,1).c$$I$I,[jc.getWidth$(), jc.getHeight$()]) : null);
});

Clazz.newMeth(C$, 'loadActionMap$swingjs_plaf_LazyActionMap', function (map) {
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["scrollUp"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["scrollDown"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["scrollHome"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["scrollEnd"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["unitScrollUp"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["unitScrollDown"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["scrollLeft"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["scrollRight"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["unitScrollRight"]));
map.put$javax_swing_Action(Clazz.new_($I$(4,1).c$$S,["unitScrollLeft"]));
}, 1);
...
return Clazz.new_($I$(3,1).c$$I$I,[32767, 32767]);
});
