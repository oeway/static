(function(){var P$=Clazz.newPackage("swingjs.plaf"),I$=[[0,'swingjs.api.js.DOMNode','java.awt.Dimension','swingjs.JSToolkit','java.awt.event.ActionEvent','swingjs.plaf.JSLabelUI']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(2,1).c$$I$I,[0, addingCSS ? 0 : -2]);
});
...
a.actionPerformed$(Clazz.new_($I$(4,1).c$$O$I$S$J$I,[this.c, 1001, "notify-field-accept", System.currentTimeMillis$(), 0]));
...
return (this.isAWT ? $I$(5).getMinimumSizePeer$javax_swing_JComponent$O(jc, this.editor) : C$.superclazz.prototype.getMinimumSize$javax_swing_JComponent.apply(this, [jc]));
});
