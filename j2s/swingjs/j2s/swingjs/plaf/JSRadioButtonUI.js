...
if (b.getIcon$() == null ) {
this.iconNode=this.actionNode=P$.JSComponentUI.newDOMObject$S$S$SA("input", this.id + "_inp", ["type", (this.getPropertyPrefix$() == "RadioButton" ? "radio" : "checkbox"), "name", this.id]);
...
$I$(1).setAttr(this.actionNode, "checked", b.isSelected$() ? "TRUE" : "FALSE");
