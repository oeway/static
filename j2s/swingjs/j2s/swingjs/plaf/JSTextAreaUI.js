(function(){var P$=Clazz.newPackage("swingjs.plaf"),p$1={},I$=[[0,'swingjs.api.js.DOMNode','javax.swing.text.WrappedPlainView','javax.swing.text.PlainView','java.awt.Point']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
$I$(1).setStyles(this.domNode, ["white-space", null, "overflow-wrap", null]);
if (area.getLineWrap$()) {
$I$(1).setStyles(this.domNode, ["overflow-wrap", area.getWrapStyleWord$() ? null : "anywhere"]);
} else {
$I$(1).setStyles(this.domNode, ["white-space", "pre"]);
}this.textListener.checkDocument$();
this.setCssFont$swingjs_api_js_DOMNode$java_awt_Font($I$(1).setAttr(this.domNode, "value", this.setCurrentText$()), this.c.getFont$());
...
return $I$(1).setStyles(this.setHTMLElementCUI$(), ["position", "absolute"]);
});
...
var v;
if (area.getLineWrap$()) {
v=Clazz.new_($I$(2,1).c$$javax_swing_text_Element$Z,[elem, area.getWrapStyleWord$()]);
} else {
v=Clazz.new_($I$(3,1).c$$javax_swing_text_Element,[elem]);
}return v;
});
