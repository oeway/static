...
return Clazz.new_($I$(18,1).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_($I$(19,1).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("controlShadow"), table.getColor$O("controlDkShadow"), table.getColor$O("controlHighlight"), table.getColor$O("controlLtHighlight")]), Clazz.new_($I$(20,1))]);
});
...
return Clazz.new_($I$(18,1).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_($I$(21,1).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("Button.shadow"), table.getColor$O("Button.darkShadow"), table.getColor$O("Button.light"), table.getColor$O("Button.highlight")]), Clazz.new_($I$(20,1))]);
});

Clazz.newMeth(C$, 'createNonRolloverToggleBorder', function () {
var table=$I$(4).getLookAndFeelDefaults$();
return Clazz.new_($I$(18,1).c$$javax_swing_border_Border$javax_swing_border_Border,[Clazz.new_($I$(22,1).c$$java_awt_Color$java_awt_Color$java_awt_Color$java_awt_Color,[table.getColor$O("ToggleButton.shadow"), table.getColor$O("ToggleButton.darkShadow"), table.getColor$O("ToggleButton.light"), table.getColor$O("ToggleButton.highlight")]), Clazz.new_($I$(20,1))]);
}, p$1);
...
), Clazz.new_($I$(23,1).c$$S$Z$java_awt_Container, [this, null, this.b$['swingjs.plaf.JSToolBarUI'].id + (++$I$(3).toolbarCount), false, this],P$.JSToolBarUI$1$1));
rootPane.setOpaque$Z(true);
return rootPane;
});
})()
), Clazz.new_($I$(24,1).c$$S$java_awt_GraphicsConfiguration, [this, null, toolbar.getName$(), (window != null ) ? window.getGraphicsConfiguration$() : null],P$.JSToolBarUI$1));
...
dialog=Clazz.new_($I$(25,1).c$$java_awt_JSFrame$S$Z, [this, null, window, toolbar.getName$(), false],P$.JSToolBarUI$1ToolBarDialog);
} else if (Clazz.instanceOf(window, "java.awt.JSDialog")) {
dialog=Clazz.new_($I$(25,1).c$$java_awt_JSDialog$S$Z, [this, null, window, toolbar.getName$(), false],P$.JSToolBarUI$1ToolBarDialog);
} else {
dialog=Clazz.new_($I$(25,1).c$$java_awt_JSFrame$S$Z, [this, null, null, toolbar.getName$(), false],P$.JSToolBarUI$1ToolBarDialog);
...
offset=Clazz.new_($I$(7,1).c$$I$I,[(size.width/2|0), (size.height/2|0)]);
...
), Clazz.new_($I$(23,1).c$$S$Z$java_awt_Container, [this, null, this.this$0.id + (++$I$(3).toolbarCount), false, this],P$.JSToolBarUI$1ToolBarDialog$1));
rootPane.setOpaque$Z(true);
return rootPane;
});
