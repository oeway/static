...
this.currentPadInsets=Clazz.new_($I$(13,1).c$$I$I$I$I,[0, 0, 0, 0]);
this.currentTabAreaInsets=Clazz.new_($I$(13,1).c$$I$I$I$I,[0, 0, 0, 0]);
...
return Clazz.new_($I$(1,1).c$$I$I,[this.c.getWidth$(), this.c.getHeight$()]);
});

Clazz.newMeth(C$, 'loadActionMap$swingjs_plaf_LazyActionMap', function (map) {
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["navigateNext"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["navigatePrevious"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["navigateRight"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["navigateLeft"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["navigateUp"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["navigateDown"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["navigatePageUp"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["navigatePageDown"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["requestFocus"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["requestFocusForVisibleComponent"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["setSelectedIndex"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["selectTabWithFocus"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["scrollTabsForwardAction"]));
map.put$javax_swing_Action(Clazz.new_($I$(15,1).c$$S,["scrollTabsBackwardAction"]));
}, 1);
...
this.tabScroller=Clazz.new_($I$(18,1).c$$I, [this, null, this.tabPane.getTabPlacement$()]);
...
this.tabContainer=Clazz.new_($I$(19,1), [this, null]);
...
}return Clazz.new_($I$(20,1).c$$I, [this, null, direction]);
});
...
this.mnemonicToIndexMap=Clazz.new_($I$(27,1));
this.mnemonicInputMap=Clazz.new_($I$(28,1).c$$javax_swing_JComponent,[this.tabPane]);
...
return Clazz.new_($I$(31,1).c$$IA$IA$I,[xp, yp, pcnt]);
} else {
return Clazz.new_($I$(31,1).c$$IA$IA$I,[yp, xp, pcnt]);
}}, 1);
...
var htmlViews=Clazz.new_($I$(32,1));
...
var delta=Clazz.new_($I$(4,1).c$$I$I,[-this.this$0.tabContainer.getX$(), -this.this$0.tabContainer.getY$()]);
...
action.actionPerformed$(Clazz.new_($I$(9,1).c$$O$I$S$J$I,[this.this$0.tabPane, 1001, null, e.getWhen$(), e.getModifiers$()]));
}}});
