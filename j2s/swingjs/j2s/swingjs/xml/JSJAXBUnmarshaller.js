...
C$.knownJavaClasses=Clazz.new_(1,{K:"String",V:"Boolean"},$I$(1,1));
C$.seeAlsoMap=Clazz.new_(1,{K:"String",V:"swingjs.xml.JSJAXBField"},$I$(1,1));
C$.knownJAXBClasses=Clazz.new_(1,{K:"String",V:"swingjs.xml.JSJAXBClass"},$I$(1,1));
}
...
return (mode == 2 ? Clazz.new_($I$(5,1).c$$javax_xml_namespace_QName$Class$TT,[qname, javaClass, javaObject]) : javaObject);
}, p$1);
...
if (map == null ) {
field.setValue$O$O(map=Clazz.new_(1,{K:"java.lang.Object",V:"java.lang.Object"},$I$(6,1)), this.javaObject);
}map.clear$();
if (nodes != null ) {
...
var key=p$1.getNodeObject$swingjs_xml_JSJAXBField$swingjs_api_js_DOMNode$S$O.apply(this, [keyFieldToUnmarshal, nodes.get$I(i++), keyType, null]);
var value=p$1.getNodeObject$swingjs_xml_JSJAXBField$swingjs_api_js_DOMNode$S$O.apply(this, [valueFieldToUnmarshal, nodes.get$I(i++), valueType, null]);
...
for (var i=0; i < n; i++) a[i]=(field.listValues != null  ? field.listValues.get$I(i) : p$1.getNodeObject$swingjs_xml_JSJAXBField$swingjs_api_js_DOMNode$S$O.apply(this, [fieldToUnmarshal, (node == null  ? field.boundListNodes.get$I(i) : node), arrayType, data[i]]));

return a;
}, p$1);

Clazz.newMeth(C$, 'getNodeObject$swingjs_xml_JSJAXBField$swingjs_api_js_DOMNode$S$O', function (fieldToUnmarshal, node, type, data) {
...
}return Clazz.new_($I$(8,1).c$$S$S$S,[uri, localName, ""]);
}, p$1);
...
case "dateTime":
return newVal=Clazz.new_($I$(13,1).c$$S,[+Date.parse(val) ||null]);
default:
...
p$1.start$swingjs_api_js_DOMNode$javax_xml_namespace_QName$org_xml_sax_Attributes.apply(this, [this.parser.getNode$(), Clazz.new_($I$(8,1).c$$S$S$S,[uri, localName, ""]), atts]);
});
