(function(){var P$=Clazz.newPackage("swingjs.xml"),I$=[[0,'swingjs.xml.JSXMLElement','swingjs.xml.JSXMLText','swingjs.xml.JSXMLComment','swingjs.xml.JSXMLNodeList','java.util.HashMap']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(4,1).c$$O,[1 ? this.node.childNodes :null]);
});
...
if (this.htData == null ) this.htData=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(5,1));
this.htData.put$TK$TV(key, data);
return data;
});
...
return Clazz.new_($I$(4,1).c$$O,[this.node.getElementsByTagName(tagname) ||null]);
});

Clazz.newMeth(C$, 'getElementsByTagNameNS$S$S', function (namespaceURI, localName) {
return Clazz.new_($I$(4,1).c$$O,[this.node.getElementsByTagNameNS(namespaceURI, localName) ||null]);
});
