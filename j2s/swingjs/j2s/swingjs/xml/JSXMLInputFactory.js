(function(){var P$=Clazz.newPackage("swingjs.xml"),I$=[[0,'java.util.HashMap','swingjs.xml.JSXMLStreamReader']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
