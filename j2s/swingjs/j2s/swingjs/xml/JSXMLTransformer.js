(function(){var P$=Clazz.newPackage("swingjs.xml"),p$1={},I$=[[0,'java.util.Properties','java.util.Hashtable','swingjs.JSUtil','javajs.util.PT']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.params=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(2,1));
}, 1);
...
Clazz.super_(C$, this);
this.source=source;
this.outputProperties.put$TK$TV("version", "1.0");
this.outputProperties.put$TK$TV("encoding", "UTF-8");
this.outputProperties.put$TK$TV("standalone", "no");
}, 1);
...
this.params.put$TK$TV(name, value);
});
...
this.outputProperties.put$TK$TV(name, value);
});
