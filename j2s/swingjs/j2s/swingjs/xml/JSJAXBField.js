(function(){var P$=Clazz.newPackage("swingjs.xml"),p$1={},I$=[[0,'java.util.Hashtable','java.util.ArrayList','javajs.util.PT','javax.xml.namespace.QName','swingjs.JSUtil','swingjs.api.js.DOMNode','swingjs.xml.JSJAXBClass']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['isNil','isTransient','isAttribute','isXmlID','isXmlIDREF','isXmlValue','asList','isNillable','isArray','isByteArray','isContainer','isMethod'],'I',['fieldType','holdsObjects','index'],'S',['defaultValue','xmlCharacterData','xmlAttributeData','xmlType','text','javaName','javaClassName','xmlSchemaType','typeAdapter','mimeType','enumValue','mapClassNameKey','mapClassNameValue','listClassName'],'O',['mapEntryValue','java.lang.Object','boundNode','swingjs.api.js.DOMNode','boundListNodes','java.util.List','qualifiedTypeName','javax.xml.namespace.QName','listFields','java.util.List','+listValues','listOwner','swingjs.xml.JSJAXBField','qualifiedName','javax.xml.namespace.QName','+qualifiedWrapName','methodSet','java.lang.Object','+methodGet','+clazz']]]
...
var attr=Clazz.new_(1,{K:"String",V:"String"},$I$(1,1));
this.text="";
...
this.boundListNodes=Clazz.new_(1,{E:"java.lang.Object"},$I$(2,1));
...
return;
case "@XmlElements":
this.listFields=Clazz.new_(1,{E:"swingjs.xml.JSJAXBField"},$I$(2,1));
return;
case "@XmlElement":
...
return Clazz.new_($I$(4,1).c$$S$S$S,[namespace == null  ? "##default" : namespace, name == null  ? "##default" : name, ""]);
}, p$1);
...
if (l == null ) {
l=Clazz.new_(1,{E:"java.lang.Object"},$I$(2,1));
} else {
l.clear$();
}var a=value;
...
if (this.listValues == null ) this.listValues=Clazz.new_(1,{E:"java.lang.Object"},$I$(2,1));
