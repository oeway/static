...
C$.cantmarshall="";
C$.mapQualifierLevel=Clazz.new_(1,{K:"String",V:"Integer"},$I$(1,1));
...
var jaxbClass=Clazz.new_($I$(3,1).c$$Class$O$Z$Z$javax_xml_namespace_QName,[javaClass, javaObject, tagField != null  && tagField.isXmlIDREF , true, qname]);
...
C$.mapQualifierLevel=Clazz.new_(1,{K:"String",V:"Integer"},$I$(1,1).c$$java_util_Map,[oldMap]);
return oldMap;
}, 1);
...
var jjc=Clazz.new_($I$(3,1).c$$Class$O$Z$Z$javax_xml_namespace_QName,[value.getClass$(), null, false, true, null]);
if (jjc.enumMap != null ) {
