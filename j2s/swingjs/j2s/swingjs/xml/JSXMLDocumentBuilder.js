(function(){var P$=Clazz.newPackage("swingjs.xml"),p$1={},I$=[[0,'swingjs.xml.JSXMLDocument']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
