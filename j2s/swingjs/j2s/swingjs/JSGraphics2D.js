(function(){var P$=Clazz.newPackage("swingjs"),p$1={},I$=[[0,'java.awt.RenderingHints','java.util.Hashtable','java.awt.geom.AffineTransform','java.awt.BasicStroke','java.awt.Color','swingjs.JSToolkit',['java.awt.geom.RoundRectangle2D','.Double'],'swingjs.JSUtil','swingjs.api.js.DOMNode','swingjs.JSGraphicsCompositor','swingjs.api.js.HTML5CanvasContext2D','java.awt.Font','java.awt.Toolkit','java.awt.Rectangle','java.awt.AlphaComposite']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['isShifted','inPath','clearing'],'I',['constrainX','constrainY','width','height','initialState','lastx','lasty','nx','ny','alpha'],'O',['canvas','swingjs.api.js.HTML5Canvas','ctx','swingjs.api.js.HTML5CanvasContext2D','gc','java.awt.GraphicsConfiguration','currentStroke','java.awt.BasicStroke','currentClip','java.awt.Shape','alphaComposite','java.awt.AlphaComposite','font','java.awt.Font','hints','java.awt.RenderingHints','transform','java.awt.geom.AffineTransform','backgroundColor','java.awt.Color','+foregroundColor','rrect','java.awt.geom.RoundRectangle2D.Double','imageData','swingjs.api.js.HTML5CanvasContext2D.ImageData','buf8','int[]','clearColorSaved','java.awt.Color']]
,['F',['pixelRatio']]]

Clazz.newMeth(C$, 'c$$O', function (canvas) {
;C$.$init$.apply(this);
this.hints=Clazz.new_($I$(1,1).c$$java_util_Map,[Clazz.new_($I$(2,1))]);
this.canvas=canvas;
this.ctx=this.canvas.getContext("2d");
this.transform=Clazz.new_($I$(3,1));
this.setStroke$java_awt_Stroke(Clazz.new_($I$(4,1)));
{
...
this.rrect=Clazz.new_($I$(7,1).c$$D$D$D$D$D$D,[x, y, w, h, aw, ah]);
...
$I$(8).notImplemented$S("transparent image pixel background fill is not supported in SwingJS");
return this.drawImagePriv$java_awt_Image$I$I$java_awt_image_ImageObserver(img, x, y, observer);
});
...
var imgNode=$I$(9).getImageNode(img);
return (imgNode == null  ? $I$(10).createImageNode$java_awt_Image(img) : imgNode);
}, p$1);
...
this.drawDirect$IA$I$I$I$I$Z(pixels, x, y, width, height, isRGB);
}if (observer != null ) p$1.observe$java_awt_Image$java_awt_image_ImageObserver$Z.apply(this, [img, observer, imgNode != null ]);
}return true;
});
...
this.hints=Clazz.new_($I$(1,1).c$$java_util_Map,[hints]);
});
...
if (this.font == null ) this.font=Clazz.new_($I$(12,1).c$$S$I$I,["Arial", 0, 12]);
return this.font;
});
...
if (r == null  || r.x != x  || r.y != y  || r.width != width  || r.height != height ) this.currentClip=Clazz.new_($I$(14,1).c$$I$I$I$I,[x, y, width, height]);
}, p$1);
...
if (c == null ) return;
var a=c.getAlpha$();
if (a != this.alpha && a != 255 ) this.ctx.globalAlpha=(this.alpha=a) / 256.0;
...
this.currentClip=Clazz.new_($I$(14,1).c$$I$I$I$I,[0, 0, this.width, this.height]);
...
if (isValid && $I$(10).setGraphicsCompositeAlpha$swingjs_JSGraphics2D$I(this, newRule) ) {
...
$I$(10).drawImageOp$swingjs_JSGraphics2D$java_awt_image_BufferedImage$java_awt_image_BufferedImageOp$I$I(this, img, op, x, y);
});

Clazz.newMeth(C$, 'setAlpha$F', function (f) {
this.ctx.globalAlpha=f;
this.alpha=(Math.floor(f * 256 + 0.0039)|0);
});
...
map[0]=Float.valueOf$F(this.ctx.globalAlpha);
...
var alpha=map[0];
if (alpha != null ) {
this.setAlpha$F(alpha.floatValue$());
...
g.transform=Clazz.new_($I$(3,1).c$$java_awt_geom_AffineTransform,[this.transform]);
if (this.hints != null ) {
