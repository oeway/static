...
var kit=$I$(6).getInstance$S$Z("swingjs.JSImagekit", true);
...
return p$1.getImagekit.apply(this, []).createImageFromBytes$BA$I$I$S($I$(3).getSignedStreamBytes$java_io_BufferedInputStream(Clazz.new_($I$(10,1).c$$java_io_InputStream,[Clazz.new_($I$(11,1).c$$BA,[$I$(3).getFileAsBytes$O(filename)])])), 0, -1, filename);
});
...
var ui=C$.getUI$java_awt_Component$Z(c, false);
if (ui == null  || ui.isNull  || !ui.jc.isFocusable$() ) return false;
var r=((P$.JSToolkit$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "JSToolkit$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
if (C$.systemClipboard == null ) C$.systemClipboard=$I$(3).getInstance$S("java.awt.datatransfer.Clipboard");
...
return (C$.focusManager == null  ? C$.focusManager=Clazz.new_($I$(12,1)) : C$.focusManager);
}, 1);
...
return $I$(3).J2S.getMousePosition(Clazz.new_($I$(13,1)));
}, 1);
