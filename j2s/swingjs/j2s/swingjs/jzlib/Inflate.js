(function(){var P$=Clazz.newPackage("swingjs.jzlib"),p$1={},I$=[[0,'swingjs.jzlib.InfBlocks','swingjs.jzlib.CRC32','swingjs.jzlib.GZIPHeader','swingjs.jzlib.Adler32',['swingjs.jzlib.Inflate','.Return'],'java.io.ByteArrayOutputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['mode','method','marker','wrap','wbits','flags','need秘bytes'],'L',['was','need'],'O',['blocks','swingjs.jzlib.InfBlocks','z','swingjs.jzlib.ZStream','crcbuf','byte[]','gheader','swingjs.jzlib.GZIPHeader','tmp_string','java.io.ByteArrayOutputStream']]
,['O',['mark','byte[]']]]
...
this.z.avail_in--;
this.z.total_in++;
this.need=((this.z.$in[this.z.in_index++] & 255) << 24) & 4278190080;
this.mode=3;
case 3:
if (this.z.avail_in == 0) return r;
r=f;
this.z.avail_in--;
this.z.total_in++;
this.need+=((this.z.$in[this.z.in_index++] & 255) << 16) & 16711680;
this.mode=4;
case 4:
if (this.z.avail_in == 0) return r;
r=f;
this.z.avail_in--;
this.z.total_in++;
this.need+=((this.z.$in[this.z.in_index++] & 255) << 8) & 65280;
this.mode=5;
case 5:
if (this.z.avail_in == 0) return r;
r=f;
this.z.avail_in--;
this.z.total_in++;
this.need+=(this.z.$in[this.z.in_index++] & 255);
...
this.z.total_in+=p - this.z.in_index;
this.z.in_index=p;
this.z.avail_in=n;
this.marker=m;
if (m != 4) {
...
this.z.avail_in--;
this.z.total_in++;
this.need=this.need | ((this.z.$in[this.z.in_index++] & 255) << ((n - this.need秘bytes) * 8));
this.need秘bytes--;
}
if (n == 2) {
this.need&=65535;
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:51:13 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
