(function(){var P$=Clazz.newPackage("swingjs.jzlib"),I$=[[0,'swingjs.jzlib.Adler32']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['I',['in_index','avail_in','next_out_index','avail_out','data_type'],'L',['total_in','total_out'],'S',['msg'],'O',['$in','byte[]','+next_out','dstate','swingjs.jzlib.Deflate','istate','swingjs.jzlib.Inflate','checksum','swingjs.jzlib.Checksum']]]
