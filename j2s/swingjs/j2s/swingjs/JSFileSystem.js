...
if (C$.views == null ) {
C$.views=Clazz.new_(1,{E:"String"},$I$(3,1));
...
return Clazz.new_($I$(20,1).c$$S$swingjs_JSFileSystem, [this, null, first, this]);
});
...
var options=Clazz.new_(1,{E:"java.nio.file.StandardOpenOption"},$I$(3,1));
...
try {
this.bc=Clazz.new_($I$(1,1).c$$java_io_FileDescriptor$swingjs_JSFileSystem_JSPath$java_util_Set$java_nio_file_attribute_FileAttributeA,[fd, this.path, options, $I$(5).NO_ATTRIBUTES]);
} catch (e) {
...
P$.JSFileSystem.ni$();
return Clazz.new_($I$(7,1).c$$BA$I$I$I$I$I$java_io_FileDescriptor,[this.bc.秘bytes, -1, (position|0), (size|0), (size|0), 0, this.fd]);
});

Clazz.newMeth(C$, 'lock$J$J$Z', function (position, size, shared) {
P$.JSFileSystem.ni$();
return Clazz.new_($I$(8,1).c$$java_nio_channels_FileChannel$J$J$Z,[this, position, size, shared]);
});
...
C$.$fields$=[['Z',['doSave','open','append','write','read','$delete'],'I',['pos','len'],'L',['tCreate','tMod','tAccess'],'O',['path','swingjs.JSFileSystem.JSPath','秘bytes','byte[]','bis','java.io.BufferedInputStream','attrs','swingjs.JSFileSystem.JSFileAttribute[]','fsAttrs','swingjs.JSFileSystem.JSFileAttributes']]]
...
$I$(6).cacheFileData$S$O(path.name, path.秘bytes);
} else if (truncate) {
path.秘bytes=null;
}if (path.秘bytes == null ) {
...
Clazz.newMeth(C$, 'read$', function () {
return (this.pos >= this.len ? ($b$[0] = -1, $b$[0]) : ($b$[0] = this.秘bytes[this.pos++], $b$[0]));
});
...
if (!this.path.isTempFile) $I$(6).saveFile$S$O$S$S(this.path.name, this.秘bytes, null, null);
}});
...
return (this.bis == null  ? (this.bis=Clazz.new_($I$(12,1).c$$java_io_InputStream,[Clazz.new_($I$(13,1).c$$BA,[p$1.getBytes.apply(this, [])])])) : this.bis);
});
...
return (this.fsAttrs == null  ? (this.fsAttrs=Clazz.new_($I$(14,1).c$$swingjs_JSFileSystem_JSByteChannel,[this])) : this.fsAttrs);
}, p$1);
...
C$.$fields$=[['Z',['isTempFile'],'S',['name'],'O',['fileSystem','swingjs.JSFileSystem','nameArray','String[]','秘bytes','byte[]']]]
...
;C$.$init$.apply(this);
while (name.startsWith$S("././"))name=name.substring$I(3);
...
try {
return Clazz.new_($I$(15,1).c$$S,[this.isAbsolute$() ? this.name : "http://./" + this.name]);
} catch (e) {
...
return Clazz.new_($I$(16,1).c$$swingjs_JSFileSystem_JSPath, [this, null, this]);
});
...
this.秘bytes=bytes;
this.setIsTempFile$Z(Clazz.instanceOf(file, "swingjs.JSTempFile"));
});
...
C$.fsMap=Clazz.new_(1,{K:"String",V:"swingjs.JSFileSystem"},$I$(17,1));
}
...
if (fs == null ) C$.fsMap.put$TK$TV(scheme, fs=Clazz.new_($I$(18,1).c$$S,[scheme]));
return fs;
});
...
$I$(6).removeCachedFileData$S(path.toString());
});
