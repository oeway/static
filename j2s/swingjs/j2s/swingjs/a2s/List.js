...
;C$.superclazz.c$$javax_swing_ListModel.apply(this,[Clazz.new_(1,{E:"String"},$I$(2,1))]);C$.$init$.apply(this);
...
this.processItemEvent$java_awt_event_ItemEvent(Clazz.new_($I$(7,1).c$$java_awt_ItemSelectable$I$O$I,[this, 701, this.getSelectedItem$(), 1]));
}});
...
this.processActionEvent$java_awt_event_ActionEvent(Clazz.new_($I$(8,1).c$$O$I$S,[this, 1001, this.getSelectedItem$()]));
if (this.itemListener != null ) this.processItemEvent$java_awt_event_ItemEvent(Clazz.new_($I$(7,1).c$$java_awt_ItemSelectable$I$O$I,[this, 701, this.getSelectedItem$(), 1]));
return true;
}}return false;
});
})();
