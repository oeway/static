(function(){var P$=Clazz.newPackage("swingjs.a2s"),p$1={},I$=[[0,'swingjs.a2s.A2SListener','swingjs.a2s.Util','java.awt.Font']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
;C$.superclazz.c$$java_awt_JSFrame$Z.apply(this,[owner, modal]);C$.$init$.apply(this);
p$1.setListener.apply(this, []);
}, 1);
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:51:10 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
