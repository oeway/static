(function(){var P$=Clazz.newPackage("swingjs.a2s"),I$=[[0,'java.awt.Event','Boolean']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return null;
}return Clazz.new_($I$(1,1).c$$O$J$I$I$I$I$I,[src, ke.getWhen$(), newid, 0, 0, C$.getOldEventKey$java_awt_event_KeyEvent(ke), (ke.getModifiers$() & ~16)]);
case 500:
case 501:
case 502:
case 503:
...
case 505:
var me=e;
var olde=Clazz.new_($I$(1,1).c$$O$J$I$I$I$I$I,[src, me.getWhen$(), newid, me.getX$(), me.getY$(), 0, (me.getModifiers$() & ~16)]);
...
}return Clazz.new_($I$(1,1).c$$O$J$I$I$I$I$I$O,[src, 0, newid, 0, 0, 0, ae.getModifiers$(), cmd]);
case 701:
var ie=e;
var arg;
...
return Clazz.new_($I$(1,1).c$$O$I$O,[src, newid, Integer.valueOf$I(aje.getValue$())]);
default:
}
return null;
}, 1);
