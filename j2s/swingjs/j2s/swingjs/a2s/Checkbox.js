(function(){var P$=Clazz.newPackage("swingjs.a2s"),I$=[[0,'javax.swing.JRadioButton','swingjs.a2s.A2SEvent']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
