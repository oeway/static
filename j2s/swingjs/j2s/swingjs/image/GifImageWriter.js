(function(){var P$=Clazz.newPackage("swingjs.image"),I$=[[0,'swingjs.image.GifImageWriteParam']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
