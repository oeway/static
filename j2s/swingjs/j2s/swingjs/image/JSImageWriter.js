(function(){var P$=Clazz.newPackage("swingjs.image"),p$1={},I$=[[0,'java.util.Hashtable','javajs.util.OC','javax.imageio.IIOImage','swingjs.JSUtil','swingjs.JSToolkit','javajs.util.PT','swingjs.api.Interface']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
outputChannel=out;
fileName=null;
}if (outputChannel == null ) outputChannel=Clazz.new_($I$(2,1)).setParams$javajs_api_BytePoster$S$Z$java_io_OutputStream(null, fileName, false, out);
...
this.params.put$TK$TV("image", image.getRenderedImage$());
try {
