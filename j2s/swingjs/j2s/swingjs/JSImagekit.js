(function(){var P$=Clazz.newPackage("swingjs"),I$=[[0,'swingjs.JSImage','swingjs.JSUtil','swingjs.api.Interface','swingjs.api.js.DOMNode','swingjs.JSGraphics2D','java.awt.image.ColorModel','java.awt.image.BufferedImage','javax.swing.ImageIcon']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.jsimage=Clazz.new_($I$(1,1).c$$IA$I$I$S,[this.pixels, this.width, this.height, null]);
});
...
var g=Clazz.new_($I$(5,1).c$$O,[canvas]);
icon.paintIcon$java_awt_Component$java_awt_Graphics$I$I(c, g, 0, 0);
var cm=$I$(6).getRGBdefault$();
var img=Clazz.new_($I$(7,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, cm.createCompatibleWritableRaster$I$I(width, height), false, null]);
img.setImageFromHTML5Canvas$swingjs_JSGraphics2D(g);
return Clazz.new_($I$(8,1).c$$java_awt_Image$S,[img, "paintedIcon"]);
}, 1);
})();
