(function(){var P$=Clazz.newPackage("swingjs.json"),p$1={},I$=[[0,'swingjs.JSUtil','swingjs.json.JSON','java.util.Hashtable',['swingjs.json.JSON','.JSONList','.ListIterator'],['swingjs.json.JSON','.JSONMap'],'Boolean',['swingjs.json.JSON','.JSONReader'],['swingjs.json.JSON','.JSONList']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(7,1).c$$java_io_InputStream,[is]);
}, 1);
...
}return Clazz.new_($I$(7,1).c$$O,[o]).data;
}, 1);

Clazz.newMeth(C$, 'parse$java_io_InputStream', function (json) {
return Clazz.new_($I$(7,1).c$$java_io_InputStream,[json]).data;
}, 1);

Clazz.newMeth(C$, 'parse$S', function (json) {
return Clazz.new_($I$(7,1).c$$S,[json]).data;
}, 1);
...
try {
return Clazz.new_($I$(7,1).c$$O,[$I$(1).parseJSON$O(url.getContent$())]).data;
} catch (e) {
...
return Clazz.new_($I$(8,1).c$$OA,[a]);
}, 1);
;
...
var ht=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(3,1));
