(function(){var P$=Clazz.newPackage("swingjs"),I$=[[0,'java.awt.Font','java.awt.Toolkit','swingjs.JSUtil','java.awt.Point','java.awt.GraphicsDevice']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(4,1).c$$I$I,[(d.width/2|0), (d.height/2|0)]);
});
