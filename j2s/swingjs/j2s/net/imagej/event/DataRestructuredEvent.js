...
/*c*/var C$=Clazz.newClass(P$, "DataRestructuredEvent", null, 'net.imagej.event.DataModifiedEvent');
...
;C$.superclazz.c$$net_imagej_Data.apply(this,[data]);C$.$init$.apply(this);
}, 1);
