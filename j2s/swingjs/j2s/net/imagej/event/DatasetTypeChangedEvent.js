...
/*c*/var C$=Clazz.newClass(P$, "DatasetTypeChangedEvent", null, 'net.imagej.event.DatasetUpdatedEvent');
...
;C$.superclazz.c$$net_imagej_Dataset$Z.apply(this,[dataset, false]);C$.$init$.apply(this);
}, 1);
