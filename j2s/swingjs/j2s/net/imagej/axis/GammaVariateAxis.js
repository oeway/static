...
/*c*/var C$=Clazz.newClass(P$, "GammaVariateAxis", null, 'net.imagej.axis.Variable4Axis');
...
return this.a$() * Math.pow((rawValue - this.b$()), this.c$$()) * Math.exp(-(rawValue - this.b$()) / this.d$()) ;
});
