...
/*c*/var C$=Clazz.newClass(P$, "PanZoomEvent", null, 'net.imagej.display.event.CanvasEvent');
...
return C$.superclazz.prototype.toString.apply(this, []) + "\n\tscale = " + new Double(this.getCanvas$().getZoomFactor$()).toString() + "\n\tcenterX = " + new Double(this.getCanvas$().getPanCenter$().x).toString() + "\n\tcenterY = " + new Double(this.getCanvas$().getPanCenter$().y).toString() ;
});
