...
/*c*/var C$=Clazz.newClass(P$, "AxisActivatedEvent", null, 'net.imagej.display.event.AxisEvent');
...
;C$.superclazz.c$$net_imagej_display_ImageDisplay$net_imagej_axis_AxisType.apply(this,[display, axis]);C$.$init$.apply(this);
}, 1);
