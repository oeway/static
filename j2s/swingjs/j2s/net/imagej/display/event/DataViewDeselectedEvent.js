...
/*c*/var C$=Clazz.newClass(P$, "DataViewDeselectedEvent", null, 'net.imagej.display.event.DataViewSelectionEvent');
...
;C$.superclazz.c$$net_imagej_display_DataView$Z.apply(this,[view, false]);C$.$init$.apply(this);
}, 1);
