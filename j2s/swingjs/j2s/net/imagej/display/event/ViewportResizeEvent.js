...
/*c*/var C$=Clazz.newClass(P$, "ViewportResizeEvent", null, 'net.imagej.display.event.CanvasEvent');
...
return C$.superclazz.prototype.toString.apply(this, []) + "\n\tviewport = " + this.getCanvas$().getViewportWidth$() + " x " + this.getCanvas$().getViewportHeight$() ;
});
