(function(){var P$=Clazz.newPackage("net.imagej.roi"),p$1={},I$=[[0,'net.imagej.roi.MaskConversionUtil','net.imglib2.roi.mask.real.RealRandomAccessibleAsRealMask','net.imglib2.roi.mask.real.RealRandomAccessibleRealIntervalAsRealMaskRealInterval']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "AbstractRealMaskToRRAConverter", null, 'org.scijava.convert.AbstractConverter');
