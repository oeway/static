...
/*c*/var C$=Clazz.newClass(P$, "AbstractRAToMaskConverter", null, 'org.scijava.convert.AbstractConverter');
...
return C$.superclazz.prototype.canConvert$O$reflect_Type.apply(this, [src, dest]) && $I$(1).isBoolType$net_imglib2_RandomAccessible(src) ;
});

Clazz.newMeth(C$, 'canConvert$O$Class', function (src, dest) {
return C$.superclazz.prototype.canConvert$O$Class.apply(this, [src, dest]) && $I$(1).isBoolType$net_imglib2_RandomAccessible(src) ;
});
