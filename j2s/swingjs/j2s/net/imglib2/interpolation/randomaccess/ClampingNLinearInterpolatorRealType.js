...
/*c*/var C$=Clazz.newClass(P$, "ClampingNLinearInterpolatorRealType", null, 'net.imglib2.interpolation.randomaccess.NLinearInterpolator');
...
C$.$fields$=[['D',['acc','clampMin','clampMax']]]

Clazz.newMeth(C$, 'c$$net_imglib2_interpolation_randomaccess_ClampingNLinearInterpolatorRealType', function (interpolator) {
...
this.fillWeights$();
this.acc=this.target.get$().getRealDouble$() * this.weights[0];
this.code=0;
...
return Clazz.new_(1,{T:"Object"},C$.c$$net_imglib2_interpolation_randomaccess_ClampingNLinearInterpolatorRealType,[this]);
});
...
this.acc += this.target.get$().getRealDouble$() * this.weights[this.code];
}, p$1);
