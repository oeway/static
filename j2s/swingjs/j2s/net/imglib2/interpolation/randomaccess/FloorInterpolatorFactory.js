(function(){var P$=Clazz.newPackage("net.imglib2.interpolation.randomaccess"),I$=[[0,'net.imglib2.interpolation.randomaccess.FloorInterpolator']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "FloorInterpolatorFactory", null, null, 'net.imglib2.interpolation.InterpolatorFactory');
