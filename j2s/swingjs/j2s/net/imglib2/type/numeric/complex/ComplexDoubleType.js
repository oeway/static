(function(){var P$=Clazz.newPackage("net.imglib2.type.numeric.complex"),I$=[[0,'net.imglib2.type.NativeTypeFactory','net.imglib2.type.numeric.complex.ComplexDoubleType','net.imglib2.img.basictypeaccess.array.DoubleArray','net.imglib2.util.Fraction']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "ComplexDoubleType", null, 'net.imglib2.type.numeric.complex.AbstractComplexType', 'net.imglib2.type.NativeType');

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.typeFactory=$I$(1).DOUBLE$java_util_function_Function((P$.ComplexDoubleType$lambda1$||(P$.ComplexDoubleType$lambda1$=(((P$.ComplexDoubleType$lambda1||
(function(){/*m*/var C$=Clazz.newClass(P$, "ComplexDoubleType$lambda1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
), Clazz.new_(1,{T:"net.imglib2.img.NativeImg",R:"net.imglib2.type.numeric.complex.ComplexDoubleType"},P$.ComplexDoubleType$lambda1.$init$, [this, null]))))));
}
...
C$.$fields$=[['I',['i','realI','imaginaryI'],'O',['img','net.imglib2.img.NativeImg','dataAccess','net.imglib2.img.basictypeaccess.DoubleAccess']]
...
this.dataAccess.setValue$I$D(this.realI, r);
});
...
this.dataAccess.setValue$I$D(this.imaginaryI, i);
});
...
Clazz.newMeth(C$, ['set$net_imglib2_type_numeric_complex_ComplexDoubleType','set$TT'], function (c) {
this.setReal$D(c.getRealDouble$());
this.setImaginary$D(c.getImaginaryDouble$());
});

Clazz.newMeth(C$, 'createVariable$', function () {
return Clazz.new_(C$.c$$D$D,[0, 0]);
});

Clazz.newMeth(C$, 'copy$', function () {
return Clazz.new_(C$.c$$D$D,[this.getRealFloat$(), this.getImaginaryFloat$()]);
});
