(function(){var P$=Clazz.newPackage("net.imglib2.type.volatiles"),I$=[[0,'net.imglib2.type.NativeTypeFactory','net.imglib2.type.volatiles.VolatileIntType',['net.imglib2.type.volatiles.VolatileIntType','.WrappedIntType'],'net.imglib2.img.basictypeaccess.volatiles.array.VolatileIntArray']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "VolatileIntType", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'net.imglib2.type.volatiles.AbstractVolatileNativeRealType');
C$.$classes$=[['WrappedIntType',10]];

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.typeFactory=$I$(1).INT$java_util_function_Function((P$.VolatileIntType$lambda1$||(P$.VolatileIntType$lambda1$=(((P$.VolatileIntType$lambda1||
(function(){/*m*/var C$=Clazz.newClass(P$, "VolatileIntType$lambda1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
), Clazz.new_(1,{T:"net.imglib2.img.NativeImg",R:"net.imglib2.type.volatiles.VolatileIntType"},P$.VolatileIntType$lambda1.$init$, [this, null]))))));
}
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.VolatileIntType, "WrappedIntType", function(){
