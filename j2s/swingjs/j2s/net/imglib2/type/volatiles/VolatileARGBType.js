(function(){var P$=Clazz.newPackage("net.imglib2.type.volatiles"),I$=[[0,'net.imglib2.type.NativeTypeFactory','net.imglib2.type.volatiles.VolatileARGBType',['net.imglib2.type.volatiles.VolatileARGBType','.WrappedARGBType'],'net.imglib2.img.basictypeaccess.volatiles.array.VolatileIntArray']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "VolatileARGBType", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'net.imglib2.type.volatiles.AbstractVolatileNativeNumericType');
C$.$classes$=[['WrappedARGBType',10]];

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.typeFactory=$I$(1).INT$java_util_function_Function((P$.VolatileARGBType$lambda1$||(P$.VolatileARGBType$lambda1$=(((P$.VolatileARGBType$lambda1||
(function(){/*m*/var C$=Clazz.newClass(P$, "VolatileARGBType$lambda1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Function', 1);
...
), Clazz.new_(1,{T:"net.imglib2.img.NativeImg",R:"net.imglib2.type.volatiles.VolatileARGBType"},P$.VolatileARGBType$lambda1.$init$, [this, null]))))));
}
...
;C$.superclazz.c$$TN$Z.apply(this,[Clazz.new_($I$(3,1).c$$net_imglib2_img_NativeImg,[img]), false]);C$.$init$.apply(this);
this.img=img;
}, 1);

Clazz.newMeth(C$, 'c$$net_imglib2_img_basictypeaccess_volatiles_VolatileIntAccess', function (access) {
;C$.superclazz.c$$TN$Z.apply(this,[Clazz.new_($I$(3,1).c$$net_imglib2_img_basictypeaccess_IntAccess,[access]), access.isValid$()]);C$.$init$.apply(this);
this.img=null;
}, 1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.VolatileARGBType, "WrappedARGBType", function(){
