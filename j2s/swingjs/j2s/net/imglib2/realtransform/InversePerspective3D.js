(function(){var P$=Clazz.newPackage("net.imglib2.realtransform"),I$=[[0,'net.imglib2.realtransform.Perspective3D']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "InversePerspective3D", null, null, ['net.imglib2.realtransform.InvertibleRealTransform', 'net.imglib2.EuclideanSpace']);
...
C$.$fields$=[[]
,['O',['instance','net.imglib2.realtransform.InversePerspective3D']]]
