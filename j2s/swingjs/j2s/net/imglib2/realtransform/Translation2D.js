...
/*c*/var C$=Clazz.newClass(P$, "Translation2D", null, 'net.imglib2.realtransform.AbstractTranslation', ['net.imglib2.concatenate.Concatenable', 'net.imglib2.concatenate.PreConcatenable']);

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.constDs=Clazz.array($I$(1), [2]);
}

Clazz.newMeth(C$, '$init$', function () {
{
C$.constDs[0]=Clazz.new_($I$(1,1).c$$DA,[[1.0, 0.0]]);
C$.constDs[1]=Clazz.new_($I$(1,1).c$$DA,[[0.0, 1.0]]);
}
}, 1);

C$.$fields$=[['O',['inverse','net.imglib2.realtransform.Translation2D']]
,['O',['constDs','net.imglib2.RealPoint[]']]]

Clazz.newMeth(C$, 'c$$DA$net_imglib2_realtransform_Translation2D', function (t, inverse) {
;C$.superclazz.c$$DA$net_imglib2_RealPointA.apply(this,[t, C$.constDs]);C$.$init$.apply(this);
Clazz.assert(C$, this, function(){return t.length == this.numDimensions$()}, function(){return "Input dimensions do not match or are not 2."});
this.inverse=inverse;
}, 1);

Clazz.newMeth(C$, 'c$', function () {
;C$.superclazz.c$$DA$net_imglib2_RealPointA.apply(this,[Clazz.array(Double.TYPE, [2]), C$.constDs]);C$.$init$.apply(this);
this.inverse=Clazz.new_(C$.c$$DA$net_imglib2_realtransform_Translation2D,[Clazz.array(Double.TYPE, [2]), this]);
}, 1);
...
Clazz.newMeth(C$, 'set$D$D', function (tx, ty) {
this.t[0]=tx;
this.t[1]=ty;
this.inverse.t[0]=-tx;
this.inverse.t[1]=-ty;
...
Clazz.assert(C$, this, function(){return t.length <= 2}, function(){return "Too many inputs."});
try {
this.t[0]=t[0];
this.t[1]=t[1];
...
this.set$D$D(this.t[0] + a.getTranslation$I(0), this.t[1] + a.getTranslation$I(1));
return this;
});
