...
/*c*/var C$=Clazz.newClass(P$, "Scale2D", null, 'net.imglib2.realtransform.AbstractScale', ['net.imglib2.concatenate.Concatenable', 'net.imglib2.concatenate.PreConcatenable']);
...
C$.$fields$=[['O',['inverse','net.imglib2.realtransform.Scale2D']]]

Clazz.newMeth(C$, 'c$$DA$net_imglib2_realtransform_Scale2D$net_imglib2_RealPointA', function (s, inverse, ds) {
;C$.superclazz.c$$DA$net_imglib2_RealPointA.apply(this,[s, ds]);C$.$init$.apply(this);
Clazz.assert(C$, this, function(){return s.length == this.numDimensions$()}, function(){return "Input dimensions do not match or are not 2."});
this.inverse=inverse;
}, 1);

Clazz.newMeth(C$, 'c$$D$D', function (sx, sy) {
;C$.superclazz.c$$DA$net_imglib2_RealPointA.apply(this,[Clazz.array(Double.TYPE, [2]), Clazz.array($I$(1), [2])]);C$.$init$.apply(this);
this.s[0]=sx;
this.s[1]=sy;
this.ds[0]=Clazz.new_($I$(1,1).c$$DA,[[sx, 0]]);
this.ds[1]=Clazz.new_($I$(1,1).c$$DA,[[0, sy]]);
var si=Clazz.array(Double.TYPE, [2]);
si[0]=1.0 / this.s[0];
si[1]=1.0 / this.s[1];
var dis=Clazz.array($I$(1), [2]);
dis[0]=Clazz.new_($I$(1,1).c$$DA,[[si[0], 0]]);
dis[1]=Clazz.new_($I$(1,1).c$$DA,[[0, si[1]]]);
this.inverse=Clazz.new_(C$.c$$DA$net_imglib2_realtransform_Scale2D$net_imglib2_RealPointA,[si, this, dis]);
}, 1);
...
Clazz.assert(C$, this, function(){return s.length == this.numDimensions$()}, function(){return "Input dimensions do not match or are not 2."});
this.ds[0]=Clazz.new_($I$(1,1).c$$DA,[[s[0], 0]]);
this.ds[1]=Clazz.new_($I$(1,1).c$$DA,[[0, s[1]]]);
var si=Clazz.array(Double.TYPE, [2]);
si[0]=1.0 / s[0];
si[1]=1.0 / s[1];
var dis=Clazz.array($I$(1), [2]);
...
Clazz.newMeth(C$, 'set$D$D', function (sx, sy) {
this.s[0]=sx;
this.s[1]=sy;
...
this.set$D$D(this.s[0] * a.getScale$I(0), this.s[1] * a.getScale$I(1));
return this;
});
