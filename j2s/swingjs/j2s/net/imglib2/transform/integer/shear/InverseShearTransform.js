(function(){var P$=Clazz.newPackage("net.imglib2.transform.integer.shear"),I$=[[0,'net.imglib2.transform.integer.shear.ShearTransform']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "InverseShearTransform", null, 'net.imglib2.transform.integer.shear.AbstractShearTransform');
...
bb.orderMinMax$();
var c=bb.corner1;
var diff=bb.corner2[this.referenceDimension] - c[this.referenceDimension];
