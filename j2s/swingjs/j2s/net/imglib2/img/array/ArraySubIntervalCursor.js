...
/*c*/var C$=Clazz.newClass(P$, "ArraySubIntervalCursor", null, 'net.imglib2.img.array.AbstractArrayCursor');
...
Clazz.newMeth(C$, 'c$$net_imglib2_img_array_ArraySubIntervalCursor', function (cursor) {
...
return Clazz.new_(1,{T:"Object"},C$.c$$net_imglib2_img_array_ArraySubIntervalCursor,[this]);
});
