...
/*c*/var C$=Clazz.newClass(P$, "AbstractFloatArray", null, null, ['net.imglib2.img.basictypeaccess.FloatAccess', 'net.imglib2.img.basictypeaccess.array.ArrayDataAccess']);
...
;C$.$init$.apply(this);
this.data=Clazz.array(Float.TYPE, [numEntities]);
}, 1);

Clazz.newMeth(C$, 'c$$FA', function (data) {
;C$.$init$.apply(this);
this.data=data;
}, 1);
