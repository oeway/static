...
/*c*/var C$=Clazz.newClass(P$, "AbstractIntArray", null, null, ['net.imglib2.img.basictypeaccess.IntAccess', 'net.imglib2.img.basictypeaccess.array.ArrayDataAccess']);
...
;C$.$init$.apply(this);
this.data=Clazz.array(Integer.TYPE, [numEntities]);
}, 1);
