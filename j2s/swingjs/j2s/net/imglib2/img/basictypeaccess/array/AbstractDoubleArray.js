...
/*c*/var C$=Clazz.newClass(P$, "AbstractDoubleArray", null, null, ['net.imglib2.img.basictypeaccess.DoubleAccess', 'net.imglib2.img.basictypeaccess.array.ArrayDataAccess']);
...
;C$.$init$.apply(this);
this.data=Clazz.array(Double.TYPE, [numEntities]);
}, 1);
