...
/*c*/var C$=Clazz.newClass(P$, "AbstractVolatileCharArray", null, 'net.imglib2.img.basictypeaccess.array.AbstractCharArray', 'net.imglib2.img.basictypeaccess.volatiles.VolatileArrayDataAccess');
...
;C$.superclazz.c$$CA.apply(this,[data]);C$.$init$.apply(this);
this.isValid=isValid;
}, 1);
