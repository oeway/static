...
/*c*/var C$=Clazz.newClass(P$, "AbstractVolatileFloatArray", null, 'net.imglib2.img.basictypeaccess.array.AbstractFloatArray', 'net.imglib2.img.basictypeaccess.volatiles.VolatileArrayDataAccess');
...
;C$.superclazz.c$$FA.apply(this,[data]);C$.$init$.apply(this);
this.isValid=isValid;
}, 1);
