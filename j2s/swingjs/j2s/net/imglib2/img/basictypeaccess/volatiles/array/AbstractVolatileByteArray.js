...
/*c*/var C$=Clazz.newClass(P$, "AbstractVolatileByteArray", null, 'net.imglib2.img.basictypeaccess.array.AbstractByteArray', 'net.imglib2.img.basictypeaccess.volatiles.VolatileArrayDataAccess');
...
;C$.superclazz.c$$BA.apply(this,[data]);C$.$init$.apply(this);
this.isValid=isValid;
}, 1);
