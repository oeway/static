...
/*c*/var C$=Clazz.newClass(P$, "DirtyVolatileDoubleArray", null, 'net.imglib2.img.basictypeaccess.volatiles.array.AbstractVolatileDoubleArray', ['net.imglib2.img.basictypeaccess.volatiles.VolatileDoubleAccess', 'net.imglib2.Dirty']);
...
Clazz.newMeth(C$, 'c$$DA$Z', function (data, isValid) {
;C$.superclazz.c$$DA$Z.apply(this,[data, isValid]);C$.$init$.apply(this);
}, 1);
