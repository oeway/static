...
/*c*/var C$=Clazz.newClass(P$, "AbstractVolatileDoubleArray", null, 'net.imglib2.img.basictypeaccess.array.AbstractDoubleArray', 'net.imglib2.img.basictypeaccess.volatiles.VolatileArrayDataAccess');
...
;C$.superclazz.c$$DA.apply(this,[data]);C$.$init$.apply(this);
this.isValid=isValid;
}, 1);
