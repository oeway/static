...
/*c*/var C$=Clazz.newClass(P$, "DirtyVolatileLongArray", null, 'net.imglib2.img.basictypeaccess.volatiles.array.AbstractVolatileLongArray', ['net.imglib2.img.basictypeaccess.volatiles.VolatileLongAccess', 'net.imglib2.Dirty']);
...
Clazz.newMeth(C$, 'c$$JA$Z', function (data, isValid) {
;C$.superclazz.c$$JA$Z.apply(this,[data, isValid]);C$.$init$.apply(this);
}, 1);
