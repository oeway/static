...
/*c*/var C$=Clazz.newClass(P$, "DirtyVolatileCharArray", null, 'net.imglib2.img.basictypeaccess.volatiles.array.AbstractVolatileCharArray', ['net.imglib2.img.basictypeaccess.volatiles.VolatileCharAccess', 'net.imglib2.Dirty']);
...
Clazz.newMeth(C$, 'c$$CA$Z', function (data, isValid) {
;C$.superclazz.c$$CA$Z.apply(this,[data, isValid]);C$.$init$.apply(this);
}, 1);
