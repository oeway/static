...
/*c*/var C$=Clazz.newClass(P$, "AbstractVolatileShortArray", null, 'net.imglib2.img.basictypeaccess.array.AbstractShortArray', 'net.imglib2.img.basictypeaccess.volatiles.VolatileArrayDataAccess');
