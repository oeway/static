...
/*c*/var C$=Clazz.newClass(P$, "DoubleNtree", null, null, ['net.imglib2.img.basictypeaccess.DoubleAccess', 'net.imglib2.img.sparse.NtreeAccess']);
...
Clazz.newMeth(C$, 'c$$JA$JA$D', function (dimensions, position, value) {
;C$.$init$.apply(this);
this.data=Clazz.new_(1,{T:"Double"},$I$(1,1).c$$JA$TT,[dimensions, new Double(value)]);
this.position=position;
}, 1);

Clazz.newMeth(C$, 'c$$net_imglib2_img_sparse_Ntree$JA', function (data, pos) {
;C$.$init$.apply(this);
this.data=data;
this.position=pos;
}, 1);
...
this.data.createNodeWithValue$JA$TT(this.position, new Double(value));
});
