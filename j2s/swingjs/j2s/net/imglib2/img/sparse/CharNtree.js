...
/*c*/var C$=Clazz.newClass(P$, "CharNtree", null, null, ['net.imglib2.img.basictypeaccess.CharAccess', 'net.imglib2.img.sparse.NtreeAccess']);
...
Clazz.newMeth(C$, 'c$$JA$JA$C', function (dimensions, position, value) {
;C$.$init$.apply(this);
this.data=Clazz.new_(1,{T:"Character"},$I$(1,1).c$$JA$TT,[dimensions, new Character(value)]);
...
this.data.createNodeWithValue$JA$TT(this.position, new Character(value));
});
