...
/*c*/var C$=Clazz.newClass(P$, "ByteNtree", null, null, ['net.imglib2.img.basictypeaccess.ByteAccess', 'net.imglib2.img.sparse.NtreeAccess']);
...
Clazz.newMeth(C$, 'c$$JA$JA$B', function (dimensions, position, value) {
;C$.$init$.apply(this);
this.data=Clazz.new_(1,{T:"Byte"},$I$(1,1).c$$JA$TT,[dimensions, new Byte(value)]);
...
this.data.createNodeWithValue$JA$TT(this.position, new Byte(value));
});
