...
/*c*/var C$=Clazz.newClass(P$, "BooleanNtree", null, null, 'net.imglib2.img.sparse.NtreeAccess');
...
Clazz.newMeth(C$, 'c$$JA$JA$Z', function (dimensions, position, value) {
;C$.$init$.apply(this);
this.data=Clazz.new_(1,{T:"Boolean"},$I$(1,1).c$$JA$TT,[dimensions, new Boolean(value)]);
...
this.data.createNodeWithValue$JA$TT(this.position, new Boolean(value));
});
