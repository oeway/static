...
/*c*/var C$=Clazz.newClass(P$, "ShortNtree", null, null, ['net.imglib2.img.basictypeaccess.ShortAccess', 'net.imglib2.img.sparse.NtreeAccess']);
...
Clazz.newMeth(C$, 'c$$JA$JA$H', function (dimensions, position, value) {
;C$.$init$.apply(this);
this.data=Clazz.new_(1,{T:"Short"},$I$(1,1).c$$JA$TT,[dimensions, new Short(value)]);
...
this.data.createNodeWithValue$JA$TT(this.position, new Short(value));
});
