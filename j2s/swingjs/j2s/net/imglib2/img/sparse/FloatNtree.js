...
/*c*/var C$=Clazz.newClass(P$, "FloatNtree", null, null, ['net.imglib2.img.basictypeaccess.FloatAccess', 'net.imglib2.img.sparse.NtreeAccess']);
...
Clazz.newMeth(C$, 'c$$JA$JA$F', function (dimensions, position, value) {
;C$.$init$.apply(this);
this.data=Clazz.new_(1,{T:"Float"},$I$(1,1).c$$JA$TT,[dimensions, new Float(value)]);
...
this.data.createNodeWithValue$JA$TT(this.position, new Float(value));
});
