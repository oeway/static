...
/*c*/var C$=Clazz.newClass(P$, "IntNtree", null, null, ['net.imglib2.img.basictypeaccess.IntAccess', 'net.imglib2.img.sparse.NtreeAccess']);
...
Clazz.newMeth(C$, 'c$$JA$JA$I', function (dimensions, position, value) {
;C$.$init$.apply(this);
this.data=Clazz.new_(1,{T:"Integer"},$I$(1,1).c$$JA$TT,[dimensions, new Integer(value)]);
...
this.data.createNodeWithValue$JA$TT(this.position, new Integer(value));
});
