(function(){var P$=Clazz.newPackage("net.imglib2.view.composite"),I$=[[0,'net.imglib2.view.composite.NumericComposite','net.imglib2.type.NativeType','net.imglib2.img.array.ArrayImgFactory','net.imglib2.img.list.ListImgFactory']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "NumericComposite", function(){
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.NumericComposite, "Factory", function(){
