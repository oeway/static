...
/*c*/var C$=Clazz.newClass(P$, "ConvertedRandomAccessible", null, 'net.imglib2.converter.AbstractConvertedRandomAccessible');
...
Clazz.newMeth(C$, ['c$$net_imglib2_RandomAccessible$net_imglib2_converter_Converter$TB'], function (source, converter, b) {
...
return Clazz.new_(1,{A:"Object",B:"Object"},$I$(1,1).c$$net_imglib2_RandomAccess$net_imglib2_converter_Converter$TB,[this.source.randomAccess$(), this.converter, this.converted]);
});

Clazz.newMeth(C$, 'randomAccess$net_imglib2_Interval', function (interval) {
return Clazz.new_(1,{A:"Object",B:"Object"},$I$(1,1).c$$net_imglib2_RandomAccess$net_imglib2_converter_Converter$TB,[this.source.randomAccess$net_imglib2_Interval(interval), this.converter, this.converted]);
});
