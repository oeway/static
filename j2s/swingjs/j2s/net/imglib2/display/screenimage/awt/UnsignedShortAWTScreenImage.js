(function(){var P$=Clazz.newPackage("net.imglib2.display.screenimage.awt"),I$=[[0,'java.awt.image.DataBufferUShort']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "UnsignedShortAWTScreenImage", null, 'net.imglib2.display.screenimage.awt.ArrayImgAWTScreenImage');
...
Clazz.newMeth(C$, 'c$$net_imglib2_type_numeric_integer_UnsignedShortType$net_imglib2_img_basictypeaccess_array_ShortArray$JA', function (type, data, dim) {
