(function(){var P$=Clazz.newPackage("net.imglib2.display.awt"),I$=[[0,'java.awt.image.DataBufferShort']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "SignedShortDataBuffer", null, 'java.awt.image.DataBuffer');
