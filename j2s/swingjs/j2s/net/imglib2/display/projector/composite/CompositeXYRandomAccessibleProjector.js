...
/*c*/var C$=Clazz.newClass(P$, "CompositeXYRandomAccessibleProjector", null, 'net.imglib2.display.projector.AbstractProjector2D');
...
C$.$fields$=[['I',['dimIndex'],'L',['positionCount','positionMin'],'O',['target','net.imglib2.RandomAccessibleInterval','converters','java.util.ArrayList','composite','boolean[]','currentPositions','long[]','currentConverters','net.imglib2.converter.Converter[]','source','net.imglib2.RandomAccessibleInterval']]]

Clazz.newMeth(C$, 'c$$net_imglib2_RandomAccessibleInterval$net_imglib2_RandomAccessibleInterval$java_util_ArrayList$I', function (source, target, converters, dimIndex) {
...
}this.min[dimIndex]=source.min$I(dimIndex);
this.max[dimIndex]=source.max$I(dimIndex);
...
sourceRandomAccess.setPosition$JA(this.min);
if (size == 1) {
sourceRandomAccess.setPosition$J$I(this.currentPositions[0], this.dimIndex);
...
var targetRandomAccess=this.target.randomAccess$();
targetRandomAccess.setPosition$J$I(this.min[1], 1);
while (targetRandomAccess.getLongPosition$I(1) <= this.max[1]){
sourceRandomAccess.setPosition$J$I(this.min[0], 0);
targetRandomAccess.setPosition$J$I(this.min[0], 0);
while (targetRandomAccess.getLongPosition$I(0) <= this.max[0]){
var aSum=0;
var rSum=0;
var gSum=0;
var bSum=0;
...
targetRandomAccess.get$().set$I($I$(3).rgba$I$I$I$I(rSum, gSum, bSum, aSum));
sourceRandomAccess.fwd$I(0);
targetRandomAccess.fwd$I(0);
}
sourceRandomAccess.fwd$I(1);
targetRandomAccess.fwd$I(1);
}
});
