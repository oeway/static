...
/*c*/var C$=Clazz.newClass(P$, "PlanarImgXYByteProjector", null, 'net.imglib2.display.projector.AbstractProjector2D');
...
C$.$fields$=[['Z',['isSigned'],'D',['$min','normalizationFactor'],'O',['source','net.imglib2.img.planar.PlanarImg','targetArray','byte[]','dims','long[]']]]
