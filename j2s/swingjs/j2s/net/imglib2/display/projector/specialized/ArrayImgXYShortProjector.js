...
/*c*/var C$=Clazz.newClass(P$, "ArrayImgXYShortProjector", null, 'net.imglib2.display.projector.AbstractProjector2D');
...
C$.$fields$=[['Z',['isSigned'],'D',['$min','normalizationFactor'],'O',['sourceArray','short[]','+targetArray','dims','long[]']]]
