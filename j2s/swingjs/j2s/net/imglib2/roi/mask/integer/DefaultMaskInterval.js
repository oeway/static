...
/*c*/var C$=Clazz.newClass(P$, "DefaultMaskInterval", null, 'net.imglib2.AbstractInterval', 'net.imglib2.roi.MaskInterval');
...
Clazz.newMeth(C$, 'c$$net_imglib2_Interval$net_imglib2_roi_BoundaryType$java_util_function_Predicate$net_imglib2_roi_KnownConstant', function (interval, boundaryType, predicate, knownConstant) {
...
if ($I$(1).contains$net_imglib2_Interval$net_imglib2_Localizable(this, localizable)) return this.predicate.test$(localizable);
return false;
});
