...
/*c*/var C$=Clazz.newClass(P$, "DefaultUnaryCompositeMaskInterval", null, 'net.imglib2.AbstractWrappedInterval', ['net.imglib2.roi.composite.UnaryCompositeMaskPredicate', 'net.imglib2.roi.MaskInterval']);
...
Clazz.newMeth(C$, 'c$$net_imglib2_roi_Operators_UnaryMaskOperator$java_util_function_Predicate$net_imglib2_Interval$net_imglib2_roi_BoundaryType$java_util_function_UnaryOperator', function (operator, arg0, interval, boundaryType, knownConstantOp) {
...
return $I$(1).isEmpty$net_imglib2_Interval(this.sourceInterval) ? $I$(2).ALL_FALSE : this.knownConstantOp.apply$($I$(2).of$java_util_function_Predicate(this.arg0));
});
...
if (!(Clazz.instanceOf(obj, "net.imglib2.roi.composite.UnaryCompositeMaskPredicate")) || !(Clazz.instanceOf(obj, "net.imglib2.roi.MaskInterval")) ) return false;
var u=obj;
return u.operator$() === this.operator  && this.arg0.equals$O(u.arg0$()) ;
});
