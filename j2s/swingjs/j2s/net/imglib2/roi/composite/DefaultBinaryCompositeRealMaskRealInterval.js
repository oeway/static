...
/*c*/var C$=Clazz.newClass(P$, "DefaultBinaryCompositeRealMaskRealInterval", null, 'net.imglib2.AbstractWrappedRealInterval', ['net.imglib2.roi.composite.BinaryCompositeMaskPredicate', 'net.imglib2.roi.RealMaskRealInterval']);
...
Clazz.newMeth(C$, 'c$$net_imglib2_roi_Operators_BinaryMaskOperator$java_util_function_Predicate$java_util_function_Predicate$net_imglib2_RealInterval$net_imglib2_roi_BoundaryType$java_util_function_BinaryOperator', function (operator, arg0, arg1, interval, boundaryType, knownConstantOp) {
...
return $I$(1).isEmpty$net_imglib2_RealInterval(this.sourceInterval) ? $I$(2).ALL_FALSE : this.knownConstantOp.apply$($I$(2).of$java_util_function_Predicate(this.arg0), $I$(2).of$java_util_function_Predicate(this.arg1));
});
...
if (!(Clazz.instanceOf(obj, "net.imglib2.roi.composite.BinaryCompositeMaskPredicate")) || !(Clazz.instanceOf(obj, "net.imglib2.roi.RealMaskRealInterval")) ) return false;
var b=obj;
return b.operator$() === this.operator  && this.arg0.equals$O(b.arg0$())  && this.arg1.equals$O(b.arg1$()) ;
});

Clazz.newMeth(C$, 'hashCode$', function () {
return (this.arg0.hashCode$() * this.arg0.hashCode$() + this.arg1.hashCode$() + this.operator.hashCode$()) * 63;
});
