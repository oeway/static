...
/*i*/var C$=Clazz.newInterface(P$, "UnaryCompositeMaskPredicate", null, null, 'net.imglib2.roi.composite.CompositeMaskPredicate');

C$.$clinit$=2;
C$.$defaults$ = function(C$){

Clazz.newMeth(C$, 'operand$I', function (index) {
if (index == 0) return this.arg0$();
throw Clazz.new_(Clazz.load('IllegalArgumentException'));
});

Clazz.newMeth(C$, 'operands$', function () {
return $I$(1).asList$TTA([this.arg0$()]);
});
};})();
