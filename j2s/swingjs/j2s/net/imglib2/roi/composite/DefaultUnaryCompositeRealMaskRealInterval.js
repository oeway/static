...
/*c*/var C$=Clazz.newClass(P$, "DefaultUnaryCompositeRealMaskRealInterval", null, 'net.imglib2.AbstractWrappedRealInterval', ['net.imglib2.roi.composite.UnaryCompositeMaskPredicate', 'net.imglib2.roi.RealMaskRealInterval']);
...
Clazz.newMeth(C$, 'c$$net_imglib2_roi_Operators_UnaryMaskOperator$java_util_function_Predicate$net_imglib2_RealInterval$net_imglib2_roi_BoundaryType$java_util_function_UnaryOperator', function (operator, arg0, interval, boundaryType, knownConstantOp) {
...
return $I$(1).isEmpty$net_imglib2_RealInterval(this.sourceInterval) ? $I$(2).ALL_FALSE : this.knownConstantOp.apply$($I$(2).of$java_util_function_Predicate(this.arg0));
});
...
if (!(Clazz.instanceOf(obj, "net.imglib2.roi.composite.UnaryCompositeMaskPredicate")) || !(Clazz.instanceOf(obj, "net.imglib2.roi.RealMaskRealInterval")) ) return false;
var u=obj;
return u.operator$().equals$O(this.operator) && this.arg0.equals$O(u.arg0$()) ;
});

Clazz.newMeth(C$, 'hashCode$', function () {
return this.arg0.hashCode$() + this.operator.hashCode$() * 37;
});
