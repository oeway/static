...
/*c*/var C$=Clazz.newClass(P$, "DefaultBinaryCompositeMask", null, 'net.imglib2.AbstractEuclideanSpace', ['net.imglib2.roi.composite.BinaryCompositeMaskPredicate', 'net.imglib2.roi.Mask']);
...
if (!(Clazz.instanceOf(obj, "net.imglib2.roi.composite.BinaryCompositeMaskPredicate")) || !(Clazz.instanceOf(obj, "net.imglib2.roi.Mask")) ) return false;
var b=obj;
return b.operator$() === this.operator  && this.arg0.equals$O(b.arg0$())  && this.arg1.equals$O(b.arg1$()) ;
});

Clazz.newMeth(C$, 'hashCode$', function () {
return (this.arg0.hashCode$() + this.arg1.hashCode$() + this.operator.hashCode$() ) * 103;
});
