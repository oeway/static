...
/*c*/var C$=Clazz.newClass(P$, "DefaultUnaryCompositeMask", null, 'net.imglib2.AbstractEuclideanSpace', ['net.imglib2.roi.composite.UnaryCompositeMaskPredicate', 'net.imglib2.roi.Mask']);
...
if (!(Clazz.instanceOf(obj, "net.imglib2.roi.composite.UnaryCompositeMaskPredicate")) || !(Clazz.instanceOf(obj, "net.imglib2.roi.Mask")) ) return false;
var u=obj;
return u.operator$() === this.operator  && this.arg0.equals$O(u.arg0$()) ;
});

Clazz.newMeth(C$, 'hashCode$', function () {
return this.arg0.hashCode$() + this.operator.hashCode$() * 71;
});
