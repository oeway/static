(function(){var P$=Clazz.newPackage("com.sun.imageio.spi"),I$=[[0,'java.io.RandomAccessFile','javax.imageio.stream.FileImageInputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
