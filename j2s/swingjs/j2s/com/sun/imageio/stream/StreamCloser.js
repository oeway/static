(function(){var P$=Clazz.newPackage("com.sun.imageio.stream"),I$=[[0,'java.util.WeakHashMap','com.sun.imageio.stream.StreamCloser',['com.sun.imageio.stream.StreamCloser','.CloseAction'],'java.security.AccessController','Thread','Runtime']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.toCloseQueue=Clazz.new_(1,{K:"com.sun.imageio.stream.StreamCloser.CloseAction",V:"java.lang.Object"},$I$(1,1));
}C$.toCloseQueue.put$TK$TV(ca, null);
...
actions=set.toArray$TTA(actions);
