(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.jpeg"),I$=[[0,'javax.imageio.metadata.IIOMetadataNode']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.transform=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "transform", 0, 2, true);
...
var value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "version", 100, 255, false);
this.version=(value != -1) ? value : this.version;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "flags0", 0, 65535, false);
this.flags0=(value != -1) ? value : this.flags0;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "flags1", 0, 65535, false);
...
ios.write$BA(id);
P$.MarkerSegment.write2bytes$javax_imageio_stream_ImageOutputStream$I(ios, this.version);
P$.MarkerSegment.write2bytes$javax_imageio_stream_ImageOutputStream$I(ios, this.flags0);
P$.MarkerSegment.write2bytes$javax_imageio_stream_ImageOutputStream$I(ios, this.flags1);
