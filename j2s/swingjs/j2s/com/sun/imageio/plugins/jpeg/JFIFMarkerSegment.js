...
this.thumb=null;
this.extSegments=Clazz.new_($I$(23,1));
...
newGuy.extSegments=Clazz.new_($I$(23,1));
for (var iter=this.extSegments.iterator$(); iter.hasNext$(); ) {
var jfxx=iter.next$();
newGuy.extSegments.add$TE(jfxx.clone$());
}
...
this.extSegments.add$TE(Clazz.new_($I$(25,1).c$$com_sun_imageio_plugins_jpeg_JPEGBuffer$com_sun_imageio_plugins_jpeg_JPEGImageReader, [this, null, buffer, reader]));
});
...
}this.tempICCSegment=Clazz.new_($I$(26,1).c$$com_sun_imageio_plugins_jpeg_JPEGBuffer, [this, null, buffer]);
if (this.inICC == false ) {
...
if (this.iccSegment != null ) {
throw Clazz.new_(Clazz.load('javax.imageio.IIOException').c$$S,["> 1 ICC APP2 Marker Segment not supported"]);
}this.iccSegment=Clazz.new_($I$(26,1).c$$java_awt_color_ICC_ColorSpace, [this, null, cs]);
});

Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(6,1).c$$S,["app0JFIF"]);
...
if (!this.extSegments.isEmpty$()) {
var JFXXnode=Clazz.new_($I$(6,1).c$$S,["JFXX"]);
...
var value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "majorVersion", 0, 255, false);
this.majorVersion=(value != -1) ? value : this.majorVersion;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "minorVersion", 0, 255, false);
this.minorVersion=(value != -1) ? value : this.minorVersion;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "resUnits", 0, 2, false);
this.resUnits=(value != -1) ? value : this.resUnits;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "Xdensity", 1, 65535, false);
this.Xdensity=(value != -1) ? value : this.Xdensity;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "Ydensity", 1, 65535, false);
this.Ydensity=(value != -1) ? value : this.Ydensity;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "thumbWidth", 0, 255, false);
this.thumbWidth=(value != -1) ? value : this.thumbWidth;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "thumbHeight", 0, 255, false);
...
this.extSegments.add$TE(Clazz.new_($I$(25,1).c$$org_w3c_dom_Node, [this, null, ext]));
}
...
}this.iccSegment=Clazz.new_($I$(26,1).c$$org_w3c_dom_Node, [this, null, child]);
}}
}});
...
P$.MarkerSegment.write2bytes$javax_imageio_stream_ImageOutputStream$I(ios, this.Xdensity);
P$.MarkerSegment.write2bytes$javax_imageio_stream_ImageOutputStream$I(ios, this.Ydensity);
...
var jfxx=null;
try {
jfxx=Clazz.new_($I$(25,1).c$$java_awt_image_BufferedImage, [this, null, thumbnail]);
} catch (e) {
...
var ret=Clazz.new_($I$(11,1).c$$I$I$I,[thumb.getWidth$(), thumb.getHeight$(), 1]);
...
ios.write$I(255);
ios.write$I(226);
$I$(27).write2bytes$javax_imageio_stream_ImageOutputStream$I(ios, segLength);
...
var attrs=node.getAttributes$();
if (attrs.getLength$() > 0) {
this.code=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "extensionCode", 16, 19, false);
if (this.code == 18) {
...
if (cm.hasAlpha$()) {
throw Clazz.new_($I$(4,1), [this, null]);
}if (Clazz.instanceOf(cm, "java.awt.image.IndexColorModel")) {
this.code=17;
...
if (Clazz.exceptionOf(e,"com.sun.imageio.plugins.jpeg.JFIFMarkerSegment.IllegalThumbException")){
throw Clazz.new_($I$(5,1).c$$S$Throwable,["Illegal thumb in setThumbnail!", e]);
} else {
throw e;
}
}
...
Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(6,1).c$$S,["app0JFXX"]);
...
var value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "thumbWidth", 0, 255, false);
this.thumbWidth=(value != -1) ? value : this.thumbWidth;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "thumbHeight", 0, 255, false);
this.thumbHeight=(value != -1) ? value : this.thumbHeight;
}}, 1);
...
Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(6,1).c$$S,[this.name]);
node.setAttribute$S$S("thumbWidth", Integer.toString$I(this.thumbWidth));
node.setAttribute$S$S("thumbHeight", Integer.toString$I(this.thumbHeight));
return node;
});
...
this.this$0.writeThumbnailData$javax_imageio_stream_ImageOutputStream$IA$com_sun_imageio_plugins_jpeg_JPEGImageWriter.apply(this.this$0, [ios, data, writer]);
});
...
var buffer=Clazz.new_($I$(7,1).c$$I,[this.getLength$()]);
...
iis.reset$();
var raster=$I$(8).createInterleavedRaster$java_awt_image_DataBuffer$I$I$I$I$IA$java_awt_Point(buffer, this.thumbWidth, this.thumbHeight, this.thumbWidth * 3, 3, Clazz.array(Integer.TYPE, -1, [0, 1, 2]), null);
var cm=Clazz.new_($I$(9,1).c$$java_awt_color_ColorSpace$Z$Z$I$I,[$I$(10).sRGB, false, false, 1, 0]);
return Clazz.new_($I$(11,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, raster, false, null]);
});
...
var buffer=Clazz.new_($I$(7,1).c$$I,[this.thumbWidth * this.thumbHeight]);
...
iis.read$();
iis.reset$();
var cm=Clazz.new_($I$(12,1).c$$I$I$BA$I$Z,[8, 256, palette, 0, false]);
var sm=cm.createCompatibleSampleModel$I$I(this.thumbWidth, this.thumbHeight);
var raster=$I$(8).createWritableRaster$java_awt_image_SampleModel$java_awt_image_DataBuffer$java_awt_Point(sm, buffer, null);
return Clazz.new_($I$(11,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, raster, false, null]);
});
...
for (var i=0; i < 256; i++) {
palette[i * 3]=(reds[i]|0);
palette[i * 3 + 1]=(greens[i]|0);
palette[i * 3 + 2]=(blues[i]|0);
}
...
;C$.superclazz.c$$com_sun_imageio_plugins_jpeg_JPEGBuffer.apply(this,[buffer]);C$.$init$.apply(this);
var finalPos=this.streamPos + (length - 6);
buffer.iis.seek$J(this.streamPos);
this.thumbMetadata=Clazz.new_($I$(13,1).c$$Z$Z$javax_imageio_stream_ImageInputStream$com_sun_imageio_plugins_jpeg_JPEGImageReader,[false, true, buffer.iis, reader]);
...
}this.thumbMetadata=Clazz.new_($I$(13,1).c$$Z$Z,[false, true]);
...
try {
var baos=Clazz.new_($I$(14,1).c$$I,[INITIAL_BUFSIZE]);
var mos=Clazz.new_($I$(15,1).c$$java_io_OutputStream,[baos]);
var thumbWriter=Clazz.new_($I$(16,1).c$$javax_imageio_spi_ImageWriterSpi,[null]);
thumbWriter.setOutput$O(mos);
var metadata=thumbWriter.getDefaultImageMetadata$javax_imageio_ImageTypeSpecifier$javax_imageio_ImageWriteParam(Clazz.new_($I$(17,1).c$$java_awt_image_RenderedImage,[thumb]), null);
var jfif=metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(18)), true);
if (jfif == null ) {
throw Clazz.new_($I$(4,1), [this, null]);
}metadata.markerSequence.remove$O(jfif);
thumbWriter.write$javax_imageio_IIOImage(Clazz.new_($I$(19,1).c$$java_awt_image_RenderedImage$java_util_List$javax_imageio_metadata_IIOMetadata,[thumb, null, metadata]));
thumbWriter.dispose$();
...
Clazz.newMeth(C$, 'getWidth$', function () {
var retval=0;
var sof=this.thumbMetadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(20)), true);
if (sof != null ) {
...
iis.mark$();
iis.seek$J(this.streamPos);
var thumbReader=Clazz.new_($I$(21,1).c$$javax_imageio_spi_ImageReaderSpi,[null]);
thumbReader.setInput$O(iis);
thumbReader.addIIOReadProgressListener$javax_imageio_event_IIOReadProgressListener(Clazz.new_($I$(22,1).c$$com_sun_imageio_plugins_jpeg_JPEGImageReader, [this, null, reader]));
...
Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(6,1).c$$S,["JFIFthumbJPEG"]);
if (this.thumbMetadata != null ) {
...
this.chunks=Clazz.new_($I$(23,1));
this.chunks.add$TE(profileData);
this.chunksRead=1;
...
Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(6,1).c$$S,["app2ICC"]);
if (this.profile != null ) {
node.setUserObject$O($I$(24).getInstance$BA(this.profile));
}return node;
});
