...
{
$I$(2).doPrivileged$java_security_PrivilegedAction(((P$.JPEGImageReader$1||
...
C$.$fields$=[['Z',['debug','haveSeeked','tablesOnlyChecked'],'F',['percentToDate','previousPassPercentage'],'I',['numImages','currentImage','width','height','colorSpaceCode','outColorSpaceCode','numComponents','imageMetadataIndex','minProgressivePass','maxProgressivePass','knownPassCount','pass','progInterval','theLockCount'],'L',['structPointer'],'O',['iis','javax.imageio.stream.ImageInputStream','imagePositions','java.util.List','iccCS','java.awt.color.ColorSpace','convert','java.awt.image.ColorConvertOp','image','java.awt.image.BufferedImage','raster','java.awt.image.WritableRaster','+target','buffer','java.awt.image.DataBufferByte','destROI','java.awt.Rectangle','destinationBands','int[]','streamMetadata','com.sun.imageio.plugins.jpeg.JPEGMetadata','+imageMetadata','abbrevQTables','javax.imageio.plugins.jpeg.JPEGQTable[]','abbrevDCHuffmanTables','javax.imageio.plugins.jpeg.JPEGHuffmanTable[]','+abbrevACHuffmanTables','disposerReferent','java.lang.Object','disposerRecord','sun.java2d.DisposerRecord','theThread','Thread','cbLock','com.sun.imageio.plugins.jpeg.JPEGImageReader.CallBackLock']]]
...
try {
if ((code < 0) || (code > 2) ) {
throw Clazz.new_($I$(9,1).c$$S,["Invalid warning index"]);
...
if (this.debug) {
System.out.println$S("saved pos is " + savePos);
System.out.println$S("length is " + this.iis.length$());
...
System.out.println$S("pos after return from native is " + pos);
}if (this.ignoreMetadata == false ) {
this.iis.seek$J(savePos);
this.haveSeeked=true;
this.streamMetadata=Clazz.new_($I$(10,1).c$$Z$Z$javax_imageio_stream_ImageInputStream$com_sun_imageio_plugins_jpeg_JPEGImageReader,[true, false, this.iis, this]);
var pos=this.iis.getStreamPosition$();
if (this.debug) {
System.out.println$S("pos after constructing stream metadata is " + pos);
}}if (p$2.hasNextImage.apply(this, [])) {
this.imagePositions.add$TE( new Long(this.iis.getStreamPosition$()));
}} else {
this.imagePositions.add$TE( new Long(savePos));
this.currentImage=0;
...
var buffer=Clazz.new_($I$(11,1).c$$javax_imageio_stream_ImageInputStream,[this.iis]);
buffer.loadBuf$I(0);
var done=false;
while (!done){
...
this.imagePositions.add$TE(pos);
if (this.seekForwardOnly) {
this.iis.flushBefore$J(pos.longValue$());
}if (index < imageIndex) {
p$2.skipImage.apply(this, []);
...
try {
this.iis.seek$J(this.iis.getStreamPosition$() - num);
} finally {
p$1.unlock.apply(this.cbLock, []);
}
}, p$2);
...
try {
newProfile=$I$(12).getInstance$BA(iccData);
} catch (e) {
...
}if (oldData == null  || !$I$(13).equals$BA$BA(oldData, newData) ) {
this.iccCS=Clazz.new_($I$(14,1).c$$java_awt_color_ICC_Profile,[newProfile]);
try {
...
var ret=null;
if ((code > 0) && (code < 12) ) {
ret=$I$(15).getTypeProducer$I(code);
}return ret;
}, p$2);
...
var list=Clazz.new_(1,{E:"com.sun.imageio.plugins.jpeg.ImageTypeProducer"},$I$(16,1).c$$I,[1]);
switch (this.colorSpaceCode) {
case 1:
list.add$TE(raw);
list.add$TE(p$2.getImageType$I.apply(this, [2]));
break;
case 2:
list.add$TE(raw);
list.add$TE(p$2.getImageType$I.apply(this, [1]));
list.add$TE(p$2.getImageType$I.apply(this, [5]));
break;
case 6:
list.add$TE(raw);
break;
...
list.add$TE(p$2.getImageType$I.apply(this, [2]));
if (this.iccCS != null ) {
list.add$TE(((P$.JPEGImageReader$2||
...
return $I$(17).createInterleaved$java_awt_color_ColorSpace$IA$I$Z$Z(this.b$['com.sun.imageio.plugins.jpeg.JPEGImageReader'].iccCS, $I$(18).bOffsRGB, 0, false, false);
});
})()
), Clazz.new_($I$(15,1), [this, null],P$.JPEGImageReader$2)));
}list.add$TE(p$2.getImageType$I.apply(this, [1]));
list.add$TE(p$2.getImageType$I.apply(this, [5]));
break;
case 7:
list.add$TE(p$2.getImageType$I.apply(this, [6]));
break;
}
return Clazz.new_($I$(19,1).c$$java_util_Iterator,[list.iterator$()]);
}, p$2);
...
this.convert=Clazz.new_($I$(20,1).c$$java_awt_color_ColorSpace$java_awt_color_ColorSpace$java_awt_RenderingHints,[this.iccCS, cs, null]);
} else if ((this.iccCS == null ) && (!cs.isCS_sRGB$()) && (cm.getNumComponents$() == this.numComponents)  ) {
this.convert=Clazz.new_($I$(20,1).c$$java_awt_color_ColorSpace$java_awt_color_ColorSpace$java_awt_RenderingHints,[$I$(21).sRGB, cs, null]);
} else if (csType != 5) {
throw Clazz.new_(Clazz.load('javax.imageio.IIOException').c$$S,["Incompatible color conversion"]);
}break;
case 6:
...
this.convert=Clazz.new_($I$(20,1).c$$java_awt_color_ColorSpace$java_awt_color_ColorSpace$java_awt_RenderingHints,[YCC, cs, null]);
}}break;
case 10:
{
var YCC=$I$(21).getYCC$();
...
p$2.gotoImage$I.apply(this, [imageIndex]);
this.imageMetadata=Clazz.new_($I$(10,1).c$$Z$Z$javax_imageio_stream_ImageInputStream$com_sun_imageio_plugins_jpeg_JPEGImageReader,[false, false, this.iis, this]);
...
}this.image=javax.imageio.ImageReader.getDestination$javax_imageio_ImageReadParam$java_util_Iterator$I$I(param, imageTypes, this.width, this.height);
...
javax.imageio.ImageReader.checkReadParamBandSettings$javax_imageio_ImageReadParam$I$I(param, this.numComponents, numImageBands);
} else {
p$2.setOutColorSpace$J$I.apply(this, [this.structPointer, this.colorSpaceCode]);
this.image=null;
}var srcBands=$I$(18).bandOffsets[this.numComponents - 1];
var numRasterBands=(wantRaster ? this.numComponents : numImageBands);
this.destinationBands=null;
var srcROI=Clazz.new_($I$(23,1).c$$I$I$I$I,[0, 0, 0, 0]);
this.destROI=Clazz.new_($I$(23,1).c$$I$I$I$I,[0, 0, 0, 0]);
javax.imageio.ImageReader.computeRegions$javax_imageio_ImageReadParam$I$I$java_awt_image_BufferedImage$java_awt_Rectangle$java_awt_Rectangle(param, this.width, this.height, this.image, srcROI, this.destROI);
var periodX=1;
var periodY=1;
this.minProgressivePass=0;
this.maxProgressivePass=2147483647;
...
this.buffer=Clazz.new_($I$(24,1).c$$I,[lineSize]);
var bandOffs=$I$(18).bandOffsets[numRasterBands - 1];
this.raster=$I$(25).createInterleavedRaster$java_awt_image_DataBuffer$I$I$I$I$IA$java_awt_Point(this.buffer, this.destROI.width, 1, lineSize, numRasterBands, bandOffs, null);
if (wantRaster) {
this.target=$I$(25).createInterleavedRaster$I$I$I$I$I$IA$java_awt_Point(0, this.destROI.width, this.destROI.height, lineSize, numRasterBands, bandOffs, null);
} else {
this.target=imRas;
...
param.setDestinationOffset$java_awt_Point(Clazz.new_($I$(26,1).c$$I$I,[0, 0]));
...
var jfif=this.imageMetadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(27)), true);
var retval=0;
if (jfif != null ) {
...
this.numImages=0;
this.imagePositions=Clazz.new_($I$(16,1));
this.currentImage=-1;
this.image=null;
this.raster=null;
this.target=null;
...
Clazz.newMeth(C$, 'dispose$', function () {
if (this.pData != 0) {
P$.JPEGImageReader.disposeReader$J(this.pData);
this.pData=0;
}});
