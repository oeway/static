(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.jpeg"),I$=[[0,'javax.imageio.plugins.jpeg.JPEGQTable','com.sun.imageio.plugins.jpeg.JPEG','javax.imageio.metadata.IIOMetadataNode','java.util.ArrayList',['com.sun.imageio.plugins.jpeg.DQTMarkerSegment','.Qtable']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.tables.add$TE(Clazz.new_($I$(5,1).c$$Z$F, [this, null, true, quality]));
if (needTwo) {
this.tables.add$TE(Clazz.new_($I$(5,1).c$$Z$F, [this, null, false, quality]));
}}, 1);
...
this.tables.add$TE(Clazz.new_($I$(5,1).c$$javax_imageio_plugins_jpeg_JPEGQTable$I, [this, null, qtables[i], i]));
}
}, 1);
...
this.tables.add$TE(Clazz.new_($I$(5,1).c$$org_w3c_dom_Node, [this, null, children.item$I(i)]));
}
}, 1);

Clazz.newMeth(C$, 'clone$', function () {
var newGuy=C$.superclazz.prototype.clone$.apply(this, []);
newGuy.tables=Clazz.new_($I$(4,1).c$$I,[this.tables.size$()]);
...
var node=Clazz.new_($I$(3,1).c$$S,["dqt"]);
...
newGuy=Clazz.new_($I$(5,1).c$$javax_imageio_plugins_jpeg_JPEGQTable$I, [this, null, jpegTable, 1]);
}return newGuy;
});
...
this.tableID=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "qtableId", 0, 3, true);
...
Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(3,1).c$$S,["dqtable"]);
