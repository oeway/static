(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.jpeg"),I$=[[0,'java.util.ArrayList','java.awt.color.ICC_Profile','com.sun.imageio.plugins.jpeg.JPEG']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.addObjectValue$S$Class$Z$TT("app2ICC", Clazz.getClass($I$(2)), false, null);
