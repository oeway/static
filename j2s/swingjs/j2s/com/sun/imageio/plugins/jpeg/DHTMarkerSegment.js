(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.jpeg"),I$=[[0,'javax.imageio.metadata.IIOMetadataNode','javax.imageio.plugins.jpeg.JPEGHuffmanTable','java.util.ArrayList',['com.sun.imageio.plugins.jpeg.DHTMarkerSegment','.Htable']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.tables.add$TE(Clazz.new_($I$(4,1).c$$javax_imageio_plugins_jpeg_JPEGHuffmanTable$Z$I, [this, null, $I$(2).StdDCLuminance, true, 0]));
if (needFour) {
this.tables.add$TE(Clazz.new_($I$(4,1).c$$javax_imageio_plugins_jpeg_JPEGHuffmanTable$Z$I, [this, null, $I$(2).StdDCChrominance, true, 1]));
}this.tables.add$TE(Clazz.new_($I$(4,1).c$$javax_imageio_plugins_jpeg_JPEGHuffmanTable$Z$I, [this, null, $I$(2).StdACLuminance, false, 0]));
if (needFour) {
this.tables.add$TE(Clazz.new_($I$(4,1).c$$javax_imageio_plugins_jpeg_JPEGHuffmanTable$Z$I, [this, null, $I$(2).StdACChrominance, false, 1]));
}}, 1);
...
while (count > 0){
var newGuy=Clazz.new_($I$(4,1).c$$com_sun_imageio_plugins_jpeg_JPEGBuffer, [this, null, buffer]);
this.tables.add$TE(newGuy);
...
this.tables.add$TE(Clazz.new_($I$(4,1).c$$javax_imageio_plugins_jpeg_JPEGHuffmanTable$Z$I, [this, null, dcTables[i], true, i]));
}
for (var i=0; i < acTables.length; i++) {
this.tables.add$TE(Clazz.new_($I$(4,1).c$$javax_imageio_plugins_jpeg_JPEGHuffmanTable$Z$I, [this, null, acTables[i], false, i]));
}
}, 1);
...
this.tables.add$TE(Clazz.new_($I$(4,1).c$$org_w3c_dom_Node, [this, null, children.item$I(i)]));
}
}, 1);

Clazz.newMeth(C$, 'clone$', function () {
var newGuy=C$.superclazz.prototype.clone$.apply(this, []);
newGuy.tables=Clazz.new_($I$(3,1).c$$I,[this.tables.size$()]);
var iter=this.tables.iterator$();
while (iter.hasNext$()){
var table=iter.next$();
newGuy.tables.add$TE(table.clone$());
}
return newGuy;
});

Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(1,1).c$$S,["dht"]);
...
return Clazz.new_($I$(4,1).c$$org_w3c_dom_Node, [this, null, node]);
});

Clazz.newMeth(C$, 'addHtable$javax_imageio_plugins_jpeg_JPEGHuffmanTable$Z$I', function (table, isDC, id) {
this.tables.add$TE(Clazz.new_($I$(4,1).c$$javax_imageio_plugins_jpeg_JPEGHuffmanTable$Z$I, [this, null, table, isDC, id]));
});
;
...
}this.tableClass=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "class", 0, 1, true);
this.tableID=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "htableId", 0, 3, true);
...
Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(1,1).c$$S,["dhtable"]);
...
node.setUserObject$O(Clazz.new_($I$(2,1).c$$HA$HA,[this.numCodes, this.values]));
return node;
});
...
(Clazz.new_($I$(2,1).c$$HA$HA,[this.numCodes, this.values])).toString();
});
