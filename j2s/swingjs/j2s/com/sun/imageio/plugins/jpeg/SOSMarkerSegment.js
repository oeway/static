(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.jpeg"),I$=[[0,'javax.imageio.metadata.IIOMetadataNode',['com.sun.imageio.plugins.jpeg.SOSMarkerSegment','.ScanComponentSpec']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if ((i == 1) || (i == 2) ) {
tableSel=1;
}}this.componentSpecs[i]=Clazz.new_($I$(2,1).c$$B$I, [this, null, (componentIDs[i]|0), tableSel]);
}
}, 1);
...
var node=Clazz.new_($I$(1,1).c$$S,["sos"]);
...
var numComponents=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "numScanComponents", 1, 4, true);
var value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "startSpectralSelection", 0, 63, false);
this.startSpectralSelection=(value != -1) ? value : this.startSpectralSelection;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "endSpectralSelection", 0, 63, false);
this.endSpectralSelection=(value != -1) ? value : this.endSpectralSelection;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "approxHigh", 0, 15, false);
this.approxHigh=(value != -1) ? value : this.approxHigh;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "approxLow", 0, 15, false);
...
return Clazz.new_($I$(2,1).c$$B$I, [this, null, ($b$[0] = componentSel, $b$[0]), tableSel]);
});
...
;C$.$init$.apply(this);
var attrs=node.getAttributes$();
this.componentSelector=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "componentSelector", 0, 255, true);
this.dcHuffTable=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "dcHuffTable", 0, 3, true);
this.acHuffTable=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "acHuffTable", 0, 3, true);
}, 1);
...
Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(1,1).c$$S,["scanComponentSpec"]);
