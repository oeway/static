(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.jpeg"),p$1={},p$2={},I$=[[0,['com.sun.imageio.plugins.jpeg.JPEGImageWriter','.CallBackLock','.State'],'java.security.AccessController','javax.imageio.plugins.jpeg.JPEGQTable','javax.imageio.plugins.jpeg.JPEGHuffmanTable','java.awt.Dimension',['com.sun.imageio.plugins.jpeg.JPEGImageWriter','.CallBackLock'],['com.sun.imageio.plugins.jpeg.JPEGImageWriter','.JPEGWriterDisposerRecord'],'sun.java2d.Disposer','javax.imageio.plugins.jpeg.JPEGImageWriteParam','com.sun.imageio.plugins.jpeg.JPEGMetadata','com.sun.imageio.plugins.jpeg.JPEG','com.sun.imageio.plugins.jpeg.JFIFMarkerSegment','java.awt.Rectangle','javax.imageio.ImageTypeSpecifier','com.sun.imageio.plugins.jpeg.AdobeMarkerSegment','com.sun.imageio.plugins.jpeg.SOFMarkerSegment',['com.sun.imageio.plugins.jpeg.JPEG','.JCS'],'java.awt.image.ColorConvertOp','com.sun.imageio.plugins.jpeg.DQTMarkerSegment','com.sun.imageio.plugins.jpeg.DHTMarkerSegment','com.sun.imageio.plugins.jpeg.DRIMarkerSegment','java.awt.image.DataBufferByte','java.awt.image.Raster','InternalError','java.util.ArrayList',['com.sun.imageio.plugins.jpeg.DHTMarkerSegment','.Htable'],'Thread']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
{
$I$(2).doPrivileged$java_security_PrivilegedAction(((P$.JPEGImageWriter$1||
...
C$.initWriterIDs$Class$Class(Clazz.getClass($I$(3)), Clazz.getClass($I$(4)));
};
C$.preferredThumbSizes=Clazz.array($I$(5), -1, [Clazz.new_($I$(5,1).c$$I$I,[1, 1]), Clazz.new_($I$(5,1).c$$I$I,[255, 255])]);
}
...
this.theThread=null;
this.theLockCount=0;
this.cbLock=Clazz.new_($I$(6,1));
}, 1);

C$.$fields$=[['Z',['debug','indexed','convertTosRGB','isAlphaPremultiplied','ignoreJFIF','forceJFIF','ignoreAdobe','writeDefaultJFIF','writeAdobe','sequencePrepared'],'I',['sourceXOffset','sourceYOffset','sourceWidth','sourceHeight','currentImage','newAdobeTransform','numScans','theLockCount'],'L',['structPointer'],'O',['ios','javax.imageio.stream.ImageOutputStream','srcRas','java.awt.image.Raster','raster','java.awt.image.WritableRaster','indexCM','java.awt.image.IndexColorModel','converted','java.awt.image.WritableRaster','srcCM','java.awt.image.ColorModel','thumbnails','java.util.List','iccProfile','java.awt.color.ICC_Profile','srcBands','int[]','convertOp','java.awt.image.ColorConvertOp','streamQTables','javax.imageio.plugins.jpeg.JPEGQTable[]','streamDCHuffmanTables','javax.imageio.plugins.jpeg.JPEGHuffmanTable[]','+streamACHuffmanTables','metadata','com.sun.imageio.plugins.jpeg.JPEGMetadata','disposerReferent','java.lang.Object','disposerRecord','sun.java2d.DisposerRecord','theThread','Thread','cbLock','com.sun.imageio.plugins.jpeg.JPEGImageWriter.CallBackLock']]
...
this.disposerRecord=Clazz.new_($I$(7,1).c$$J,[this.structPointer]);
$I$(8).addRecord$O$sun_java2d_DisposerRecord(this.disposerReferent, this.disposerRecord);
}, 1);
...
return Clazz.new_($I$(9,1).c$$java_util_Locale,[null]);
});

Clazz.newMeth(C$, 'getDefaultStreamMetadata$javax_imageio_ImageWriteParam', function (param) {
p$2.setThreadLock.apply(this, []);
try {
return Clazz.new_($I$(10,1).c$$javax_imageio_ImageWriteParam$com_sun_imageio_plugins_jpeg_JPEGImageWriter,[param, this]);
} finally {
p$2.clearThreadLock.apply(this, []);
}
});
...
p$2.setThreadLock.apply(this, []);
try {
return Clazz.new_($I$(10,1).c$$javax_imageio_ImageTypeSpecifier$javax_imageio_ImageWriteParam$com_sun_imageio_plugins_jpeg_JPEGImageWriter,[imageType, param, this]);
} finally {
p$2.clearThreadLock.apply(this, []);
}
});
...
if (tree != null ) {
var jpegData=Clazz.new_($I$(10,1).c$$javax_imageio_ImageTypeSpecifier$javax_imageio_ImageWriteParam$com_sun_imageio_plugins_jpeg_JPEGImageWriter,[imageType, param, this]);
try {
...
if ((imageType != null ) && (!$I$(11).isJFIFcompliant$javax_imageio_ImageTypeSpecifier$Z(imageType, true)) ) {
return false;
...
}if (metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(12)), true) == null ) {
return false;
}}return true;
}, p$2);
...
this.srcCM=cm;
}}}this.srcBands=$I$(11).bandOffsets[numSrcBands - 1];
...
var imageBounds=Clazz.new_($I$(13,1).c$$I$I$I$I,[this.sourceXOffset, this.sourceYOffset, this.sourceWidth, this.sourceHeight]);
...
quality=$I$(11).convertToLinearQuality$F(quality);
qTables=Clazz.array($I$(3), [2]);
qTables[0]=$I$(3).K1Luminance.getScaledInstance$F$Z(quality, true);
qTables[1]=$I$(3).K2Chrominance.getScaledInstance$F$Z(quality, true);
break;
case 1:
qTables=Clazz.array($I$(3), [2]);
qTables[0]=$I$(3).K1Div2Luminance;
qTables[1]=$I$(3).K2Div2Chrominance;
break;
}
...
var type=destType;
if (type == null ) {
type=Clazz.new_($I$(14,1).c$$java_awt_image_RenderedImage,[rimage]);
...
jfif=this.metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(12)), true);
adobe=this.metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(15)), true);
sof=this.metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(16)), true);
}this.iccProfile=null;
this.convertTosRGB=false;
this.converted=null;
if (destType != null ) {
...
if ($I$(11).isNonStandardICC$java_awt_color_ColorSpace(cs)) {
...
if ($I$(11).isJFIFcompliant$javax_imageio_ImageTypeSpecifier$Z(destType, false)) {
this.writeDefaultJFIF=true;
if ($I$(11).isNonStandardICC$java_awt_color_ColorSpace(cs)) {
this.iccProfile=(cs).getProfile$();
}} else {
var transform=$I$(11).transformForType$javax_imageio_ImageTypeSpecifier$Z(destType, false);
if (transform != -1) {
this.writeAdobe=true;
this.newAdobeTransform=transform;
}}this.metadata=Clazz.new_($I$(10,1).c$$javax_imageio_ImageTypeSpecifier$javax_imageio_ImageWriteParam$com_sun_imageio_plugins_jpeg_JPEGImageWriter,[destType, null, this]);
...
if (this.metadata == null ) {
if (fullImage) {
this.metadata=Clazz.new_($I$(10,1).c$$javax_imageio_ImageTypeSpecifier$javax_imageio_ImageWriteParam$com_sun_imageio_plugins_jpeg_JPEGImageWriter,[Clazz.new_($I$(14,1).c$$java_awt_image_RenderedImage,[rimage]), param, this]);
if (this.metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(12)), true) != null ) {
...
p$2.checkSOFBands$com_sun_imageio_plugins_jpeg_SOFMarkerSegment$I.apply(this, [sof, numBandsUsed]);
if (fullImage) {
var inputType=Clazz.new_($I$(14,1).c$$java_awt_image_RenderedImage,[rimage]);
inCsType=p$2.getSrcCSType$java_awt_image_RenderedImage.apply(this, [rimage]);
if (cm != null ) {
...
if (jfif != null ) {
outCsType=3;
if ($I$(11).isNonStandardICC$java_awt_color_ColorSpace(cs) || ((Clazz.instanceOf(cs, "java.awt.color.ICC_ColorSpace")) && (jfif.iccSegment != null ) ) ) {
this.iccProfile=(cs).getProfile$();
}} else if (adobe != null ) {
...
this.convertOp=Clazz.new_($I$(18,1).c$$java_awt_color_ColorSpace$java_awt_color_ColorSpace$java_awt_RenderingHints,[cs, $I$(17).sRGB, null]);
outCsType=3;
} else if (adobe != null ) {
...
if (this.metadata != null ) {
dqt=this.metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(19)), true);
dht=this.metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(20)), true);
var dri=this.metadata.findMarkerSegment$Class$Z(Clazz.getClass($I$(21)), true);
if (dri != null ) {
...
qTables=$I$(11).getDefaultQTables$();
...
DCHuffmanTables=$I$(11).getDefaultHuffmanTables$Z(true);
ACHuffmanTables=$I$(11).getDefaultHuffmanTables$Z(false);
...
var buffer=Clazz.new_($I$(22,1).c$$I,[lineSize]);
var bandOffs=$I$(11).bandOffsets[numBandsUsed - 1];
this.raster=$I$(23).createInterleavedRaster$java_awt_image_DataBuffer$I$I$I$I$IA$java_awt_Point(buffer, this.sourceWidth, 1, lineSize, numBandsUsed, bandOffs, null);
...
this.streamQTables=$I$(11).getDefaultQTables$();
...
this.streamDCHuffmanTables=$I$(11).getDefaultHuffmanTables$Z(true);
...
this.streamACHuffmanTables=$I$(11).getDefaultHuffmanTables$Z(false);
...
try {
if ((code < 0) || (code > 15) ) {
throw Clazz.new_($I$(24,1).c$$S,["Invalid warning index"]);
...
if (jfif != null ) {
if (!$I$(11).isJFIFcompliant$javax_imageio_ImageTypeSpecifier$Z(type, input)) {
this.ignoreJFIF=true;
...
if (adobe != null ) {
var rightTransform=$I$(11).transformForType$javax_imageio_ImageTypeSpecifier$Z(type, input);
...
var segments=Clazz.new_($I$(25,1));
var SCAN_SIZE=9;
...
var retval=null;
if (tables.size$() != 0) {
retval=Clazz.array($I$(3), [tables.size$()]);
for (var i=0; i < retval.length; i++) {
retval[i]=Clazz.new_($I$(3,1).c$$IA,[(tables.get$I(i)).data]);
}
}return retval;
}, p$2);
...
tables.add$TE(htable);
}}
}}
var retval=null;
if (tables.size$() != 0) {
var htables=Clazz.array($I$(26), [tables.size$()]);
tables.toArray$TTA(htables);
...
}retval[i]=Clazz.new_($I$(4,1).c$$HA$HA,[htables[j].numCodes, htables[j].values]);
}}
}
}return retval;
}, p$2);
...
if (this.metadata == null ) {
if (this.writeDefaultJFIF) {
$I$(12).writeDefaultJFIF$javax_imageio_stream_ImageOutputStream$java_util_List$java_awt_color_ICC_Profile$com_sun_imageio_plugins_jpeg_JPEGImageWriter(this.ios, this.thumbnails, this.iccProfile, this);
}if (this.writeAdobe) {
$I$(15).writeAdobeSegment$javax_imageio_stream_ImageOutputStream$I(this.ios, this.newAdobeTransform);
}} else {
...
var currThread=$I$(27).currentThread$();
...
Clazz.newMeth(C$, 'dispose$', function () {
if (this.pData != 0) {
P$.JPEGImageWriter.disposeWriter$J(this.pData);
this.pData=0;
}});
