(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.jpeg"),I$=[[0,'javax.imageio.metadata.IIOMetadataNode',['com.sun.imageio.plugins.jpeg.SOFMarkerSegment','.ComponentSpec']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.componentSpecs=Clazz.array($I$(2), [numComponents]);
...
factor=1;
qsel=1;
}}this.componentSpecs[i]=Clazz.new_($I$(2,1).c$$B$I$I, [this, null, (componentIDs[i]|0), factor, qsel]);
}
}, 1);
...
this.componentSpecs=Clazz.array($I$(2), [numComponents]);
for (var i=0; i < numComponents; i++) {
this.componentSpecs[i]=Clazz.new_($I$(2,1).c$$com_sun_imageio_plugins_jpeg_JPEGBuffer, [this, null, buffer]);
}
...
var node=Clazz.new_($I$(1,1).c$$S,["sof"]);
...
var value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "process", 0, 2, false);
this.tag=(value != -1) ? value + 192 : this.tag;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "samplePrecision", 8, 8, false);
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "numLines", 0, 65535, false);
this.numLines=(value != -1) ? value : this.numLines;
value=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "samplesPerLine", 0, 65535, false);
this.samplesPerLine=(value != -1) ? value : this.samplesPerLine;
var numComponents=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "numFrameComponents", 1, 4, false);
...
for (var i=0; i < numComponents; i++) {
this.componentSpecs[i]=Clazz.new_($I$(2,1).c$$org_w3c_dom_Node, [this, null, children.item$I(i)]);
}
});
...
return Clazz.new_($I$(2,1).c$$B$I$I, [this, null, ($b$[0] = id, $b$[0]), factor, qSelector]);
});
...
;C$.$init$.apply(this);
var attrs=node.getAttributes$();
this.componentId=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "componentId", 0, 255, true);
this.HsamplingFactor=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "HsamplingFactor", 1, 255, true);
this.VsamplingFactor=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "VsamplingFactor", 1, 255, true);
this.QtableSelector=P$.MarkerSegment.getAttributeValue$org_w3c_dom_Node$org_w3c_dom_NamedNodeMap$S$I$I$Z(node, attrs, "QtableSelector", 0, 3, true);
}, 1);
...
Clazz.newMeth(C$, 'getNativeNode$', function () {
var node=Clazz.new_($I$(1,1).c$$S,["componentSpec"]);
