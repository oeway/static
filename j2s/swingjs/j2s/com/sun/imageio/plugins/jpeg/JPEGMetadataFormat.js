(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.jpeg"),I$=[[0,'java.util.ArrayList','javax.imageio.plugins.jpeg.JPEGQTable','javax.imageio.plugins.jpeg.JPEGHuffmanTable']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.addObjectValue$S$Class$Z$TT("dqtable", Clazz.getClass($I$(2)), true, null);
...
this.addObjectValue$S$Class$Z$TT("dhtable", Clazz.getClass($I$(3)), true, null);
