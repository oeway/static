...
C$.$fields$=[['I',['chunkLength','bytesRemaining'],'L',['startPos'],'O',['stream','javax.imageio.stream.ImageOutputStream','crc','com.sun.imageio.plugins.png.CRC','def','java.util.zip.Deflater','buf','byte[]']]
,['O',['chunkType','byte[]']]]
...
this.stream.writeInt$I(((pos - this.startPos)|0) - 12);
