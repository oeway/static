(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.png"),I$=[[0,'java.util.Arrays','com.sun.imageio.plugins.png.PNGMetadata']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.addAttribute$S$S$I$Z$S$java_util_List("IHDR", "bitDepth", 2, true, null, $I$(1).asList$TTA($I$(2).IHDR_bitDepths));
var colorTypes=Clazz.array(String, -1, ["Grayscale", "RGB", "Palette", "GrayAlpha", "RGBAlpha"]);
this.addAttribute$S$S$I$Z$S$java_util_List("IHDR", "colorType", 0, true, null, $I$(1).asList$TTA(colorTypes));
this.addAttribute$S$S$I$Z$S$java_util_List("IHDR", "compressionMethod", 0, true, null, $I$(1).asList$TTA($I$(2).IHDR_compressionMethodNames));
this.addAttribute$S$S$I$Z$S$java_util_List("IHDR", "filterMethod", 0, true, null, $I$(1).asList$TTA($I$(2).IHDR_filterMethodNames));
this.addAttribute$S$S$I$Z$S$java_util_List("IHDR", "interlaceMethod", 0, true, null, $I$(1).asList$TTA($I$(2).IHDR_interlaceMethodNames));
...
this.addAttribute$S$S$I$Z$S$java_util_List("iCCP", "compressionMethod", 0, true, null, $I$(1).asList$TTA($I$(2).iCCP_compressionMethodNames));
...
this.addAttribute$S$S$I$Z$S$java_util_List("pHYS", "unitSpecifier", 0, true, null, $I$(1).asList$TTA($I$(2).unitSpecifierNames));
...
this.addAttribute$S$S$I$Z$S$java_util_List("sRGB", "renderingIntent", 0, true, null, $I$(1).asList$TTA($I$(2).renderingIntentNames));
...
this.addAttribute$S$S$I$Z$S$java_util_List("zTXtEntry", "compressionMethod", 0, true, null, $I$(1).asList$TTA($I$(2).zTXt_compressionMethodNames));
