(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.png"),p$1={},I$=[[0,'java.util.ArrayList','javax.imageio.metadata.IIOMetadataNode','StringBuffer','Boolean','java.util.StringTokenizer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.iTXt_keyword=Clazz.new_(1,{E:"String"},$I$(1,1));
this.iTXt_compressionFlag=Clazz.new_(1,{E:"Boolean"},$I$(1,1));
this.iTXt_compressionMethod=Clazz.new_(1,{E:"Integer"},$I$(1,1));
this.iTXt_languageTag=Clazz.new_(1,{E:"String"},$I$(1,1));
this.iTXt_translatedKeyword=Clazz.new_(1,{E:"String"},$I$(1,1));
this.iTXt_text=Clazz.new_(1,{E:"String"},$I$(1,1));
this.tEXt_keyword=Clazz.new_(1,{E:"String"},$I$(1,1));
this.tEXt_text=Clazz.new_(1,{E:"String"},$I$(1,1));
this.zTXt_keyword=Clazz.new_(1,{E:"String"},$I$(1,1));
this.zTXt_compressionMethod=Clazz.new_(1,{E:"Integer"},$I$(1,1));
this.zTXt_text=Clazz.new_(1,{E:"String"},$I$(1,1));
this.unknownChunkType=Clazz.new_(1,{E:"String"},$I$(1,1));
this.unknownChunkData=Clazz.new_(1,{E:"byte[]"},$I$(1,1));
}, 1);
...
for (var i=0; i < len; i++) {
this.PLTE_red[this.PLTE_order[i]]=(oldRed[i]|0);
this.PLTE_green[this.PLTE_order[i]]=(oldGreen[i]|0);
this.PLTE_blue[this.PLTE_order[i]]=(oldBlue[i]|0);
}
...
var list=Clazz.new_(1,{E:"byte[]"},$I$(1,1).c$$I,[$in.size$()]);
for (var b, $b = $in.iterator$(); $b.hasNext$()&&((b=($b.next$())),1);) {
list.add$TE((b == null ) ? null : b.clone$());
}
return list;
}}, p$1);
...
iTXt_node.setAttribute$S$S("compressionFlag", this.iTXt_compressionFlag.get$I(i) ? "TRUE" : "FALSE");
...
if (times == 1) {
return s;
}var sb=Clazz.new_($I$(3,1).c$$I,[(s.length$() + 1) * times - 1]);
sb.append$S(s);
...
this.IHDR_bitDepth=(Integer.valueOf$S(C$.IHDR_bitDepths[p$1.getEnumeratedAttribute$org_w3c_dom_Node$S$SA.apply(this, [node, "bitDepth", C$.IHDR_bitDepths])])).valueOf();
...
maxindex=index;
}red[index]=((p$1.getIntAttribute$org_w3c_dom_Node$S.apply(this, [PLTE_entry, "red"])|0)|0);
green[index]=((p$1.getIntAttribute$org_w3c_dom_Node$S.apply(this, [PLTE_entry, "green"])|0)|0);
blue[index]=((p$1.getIntAttribute$org_w3c_dom_Node$S.apply(this, [PLTE_entry, "blue"])|0)|0);
...
maxindex=index;
}alpha[index]=((p$1.getIntAttribute$org_w3c_dom_Node$S.apply(this, [tRNS_paletteEntry, "alpha"])|0)|0);
...
this.zTXt_keyword.add$TE(keyword);
...
this.zTXt_compressionMethod.add$TE( new Integer(compressionMethod));
var text=p$1.getAttribute$org_w3c_dom_Node$S.apply(this, [zTXt_node, "text"]);
this.zTXt_text.add$TE(text);
...
}this.unknownChunkType.add$TE(chunkType);
this.unknownChunkData.add$TE((chunkData).clone$());
...
if (index >= 0 && index <= 255 ) {
red[index]=((p$1.getIntAttribute$org_w3c_dom_Node$S.apply(this, [entry, "red"])|0)|0);
green[index]=((p$1.getIntAttribute$org_w3c_dom_Node$S.apply(this, [entry, "green"])|0)|0);
blue[index]=((p$1.getIntAttribute$org_w3c_dom_Node$S.apply(this, [entry, "blue"])|0)|0);
if (index > maxindex) {
maxindex=index;
...
this.zTXt_keyword.add$TE(keyword);
this.zTXt_text.add$TE(value);
this.zTXt_compressionMethod.add$TE(Integer.valueOf$I(0));
} else {
this.tEXt_keyword.add$TE(keyword);
this.tEXt_text.add$TE(value);
}} else {
this.iTXt_keyword.add$TE(keyword);
this.iTXt_compressionFlag.add$TE($I$(4).valueOf$Z(compression.equals$O("zip")));
this.iTXt_compressionMethod.add$TE(Integer.valueOf$I(0));
this.iTXt_languageTag.add$TE(language);
this.iTXt_translatedKeyword.add$TE(keyword);
this.iTXt_text.add$TE(value);
}}child=child.getNextSibling$();
}
}node=node.getNextSibling$();
}
