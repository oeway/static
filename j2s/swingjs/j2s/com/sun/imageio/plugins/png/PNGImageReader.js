(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.png"),p$1={},I$=[[0,'com.sun.imageio.plugins.common.SubImageInputStream','com.sun.imageio.plugins.common.InputStreamAdapter','java.awt.Point','com.sun.imageio.plugins.png.PNGMetadata','java.io.ByteArrayOutputStream','Boolean','java.io.ByteArrayInputStream','java.util.zip.InflaterInputStream','StringBuilder','java.awt.image.DataBufferByte','java.awt.image.Raster','java.awt.image.DataBufferUShort','com.sun.imageio.plugins.common.ReaderUtil','com.sun.imageio.plugins.png.PNGImageDataEnumeration','java.io.SequenceInputStream','java.util.zip.Inflater','java.io.BufferedInputStream','java.io.DataInputStream','java.awt.Rectangle','java.util.ArrayList','javax.imageio.ImageTypeSpecifier','java.awt.color.ColorSpace','java.util.Arrays','javax.imageio.ImageReadParam']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['gotHeader','gotMetadata'],'I',['sourceXSubsampling','sourceYSubsampling','sourceMinProgressivePass','sourceMaxProgressivePass','pixelsDone','totalPixels'],'L',['imageStartPosition'],'O',['stream','javax.imageio.stream.ImageInputStream','lastParam','javax.imageio.ImageReadParam','sourceRegion','java.awt.Rectangle','sourceBands','int[]','+destinationBands','destinationOffset','java.awt.Point','metadata','com.sun.imageio.plugins.png.PNGMetadata','pixelStream','java.io.DataInputStream','theImage','java.awt.image.BufferedImage']]
...
this.metadata.PLTE_red[i]=(palette[index++]|0);
this.metadata.PLTE_green[i]=(palette[index++]|0);
this.metadata.PLTE_blue[i]=(palette[index++]|0);
}
}, p$1);
...
var keyword=p$1.readNullTerminatedString$S$I.apply(this, ["ISO-8859-1", 80]);
this.metadata.iTXt_keyword.add$TE(keyword);
var compressionFlag=this.stream.readUnsignedByte$();
this.metadata.iTXt_compressionFlag.add$TE($I$(6).valueOf$Z(compressionFlag == 1));
var compressionMethod=this.stream.readUnsignedByte$();
this.metadata.iTXt_compressionMethod.add$TE(Integer.valueOf$I(compressionMethod));
var languageTag=p$1.readNullTerminatedString$S$I.apply(this, ["UTF8", 80]);
this.metadata.iTXt_languageTag.add$TE(languageTag);
var pos=this.stream.getStreamPosition$();
var maxLen=((chunkStart + chunkLength - pos)|0);
var translatedKeyword=p$1.readNullTerminatedString$S$I.apply(this, ["UTF8", maxLen]);
this.metadata.iTXt_translatedKeyword.add$TE(translatedKeyword);
var text;
pos=this.stream.getStreamPosition$();
var b=Clazz.array(Byte.TYPE, [((chunkStart + chunkLength - pos)|0)]);
this.stream.readFully$BA(b);
if (compressionFlag == 1) {
text= String.instantialize(C$.inflate$BA(b), "UTF8");
} else {
text= String.instantialize(b, "UTF8");
}this.metadata.iTXt_text.add$TE(text);
}, p$1);
...
var keyword=p$1.readNullTerminatedString$S$I.apply(this, ["ISO-8859-1", 80]);
this.metadata.tEXt_keyword.add$TE(keyword);
var b=Clazz.array(Byte.TYPE, [chunkLength - keyword.length$() - 1 ]);
this.stream.readFully$BA(b);
this.metadata.tEXt_text.add$TE( String.instantialize(b, "ISO-8859-1"));
}, p$1);
...
var bais=Clazz.new_($I$(7,1).c$$BA,[b]);
var iis=Clazz.new_($I$(8,1).c$$java_io_InputStream,[bais]);
var baos=Clazz.new_($I$(5,1));
var c;
try {
while ((c=iis.read$()) != -1){
...
var keyword=p$1.readNullTerminatedString$S$I.apply(this, ["ISO-8859-1", 80]);
this.metadata.zTXt_keyword.add$TE(keyword);
var method=this.stream.readUnsignedByte$();
this.metadata.zTXt_compressionMethod.add$TE( new Integer(method));
var b=Clazz.array(Byte.TYPE, [chunkLength - keyword.length$() - 2 ]);
this.stream.readFully$BA(b);
this.metadata.zTXt_text.add$TE( String.instantialize(C$.inflate$BA(b), "ISO-8859-1"));
}, p$1);
...
this.stream.mark$();
this.stream.seek$J(this.stream.getStreamPosition$() + chunkLength);
...
this.stream.readFully$BA(b);
var chunkName=Clazz.new_($I$(9,1).c$$I,[4]);
...
}this.metadata.unknownChunkType.add$TE(chunkName.toString());
this.metadata.unknownChunkData.add$TE(b);
break;
}
...
curr[i + coff]=(((raw + (priorRow/2|0))|0)|0);
}
for (var i=bpp; i < count; i++) {
raw=curr[i + coff] & 255;
priorPixel=curr[i + coff - bpp] & 255;
priorRow=prev[i + poff] & 255;
curr[i + coff]=(((raw + ((priorPixel + priorRow)/2|0))|0)|0);
}
}, 1);
...
curr[i + coff]=(((raw + C$.paethPredictor$I$I$I(priorPixel, priorRow, priorRowPixel))|0)|0);
}
}, 1);
...
dataBuffer=Clazz.new_($I$(10,1).c$$I,[height * scanlineStride]);
ras=$I$(11).createPackedRaster$java_awt_image_DataBuffer$I$I$I$java_awt_Point(dataBuffer, width, height, bitDepth, origin);
} else if (bitDepth <= 8) {
dataBuffer=Clazz.new_($I$(10,1).c$$I,[height * scanlineStride]);
ras=$I$(11).createInterleavedRaster$java_awt_image_DataBuffer$I$I$I$I$IA$java_awt_Point(dataBuffer, width, height, scanlineStride, bands, C$.bandOffsets[bands], origin);
} else {
dataBuffer=Clazz.new_($I$(12,1).c$$I,[height * scanlineStride]);
ras=$I$(11).createInterleavedRaster$java_awt_image_DataBuffer$I$I$I$I$IA$java_awt_Point(dataBuffer, width, height, scanlineStride, bands, C$.bandOffsets[bands], origin);
}return ras;
}, p$1);
...
var vals=$I$(13).computeUpdatedPixels$java_awt_Rectangle$java_awt_Point$I$I$I$I$I$I$I$I$I$I$I$I(this.sourceRegion, this.destinationOffset, dstMinX, dstMinY, dstMaxX, dstMaxY, this.sourceXSubsampling, this.sourceYSubsampling, xStart, yStart, passWidth, passHeight, xStep, yStep);
...
var e=Clazz.new_($I$(14,1).c$$javax_imageio_stream_ImageInputStream,[this.stream]);
var is=Clazz.new_($I$(15,1).c$$java_util_Enumeration,[e]);
inf=Clazz.new_($I$(16,1));
is=Clazz.new_($I$(8,1).c$$java_io_InputStream$java_util_zip_Inflater,[is, inf]);
is=Clazz.new_($I$(17,1).c$$java_io_InputStream,[is]);
this.pixelStream=Clazz.new_($I$(18,1).c$$java_io_InputStream,[is]);
this.theImage=javax.imageio.ImageReader.getDestination$javax_imageio_ImageReadParam$java_util_Iterator$I$I(param, this.getImageTypes$I(0), width, height);
var destRegion=Clazz.new_($I$(19,1).c$$I$I$I$I,[0, 0, 0, 0]);
this.sourceRegion=Clazz.new_($I$(19,1).c$$I$I$I$I,[0, 0, 0, 0]);
javax.imageio.ImageReader.computeRegions$javax_imageio_ImageReadParam$I$I$java_awt_image_BufferedImage$java_awt_Rectangle$java_awt_Rectangle(param, width, height, this.theImage, this.sourceRegion, destRegion);
this.destinationOffset.setLocation$java_awt_Point(destRegion.getLocation$());
var colorType=this.metadata.IHDR_colorType;
javax.imageio.ImageReader.checkReadParamBandSettings$javax_imageio_ImageReadParam$I$I(param, C$.inputBandsForColorType[colorType], this.theImage.getSampleModel$().getNumBands$());
...
var l=Clazz.new_(1,{E:"javax.imageio.ImageTypeSpecifier"},$I$(20,1).c$$I,[1]);
var rgb;
var gray;
var bandOffsets;
var bitDepth=this.metadata.IHDR_bitDepth;
...
case 0:
l.add$TE($I$(21).createGrayscale$I$I$Z(bitDepth, dataType, false));
break;
case 2:
if (bitDepth == 8) {
l.add$TE($I$(21).createFromBufferedImageType$I(5));
l.add$TE($I$(21).createFromBufferedImageType$I(1));
l.add$TE($I$(21).createFromBufferedImageType$I(4));
}rgb=$I$(22).getInstance$I(1000);
bandOffsets=Clazz.array(Integer.TYPE, [3]);
bandOffsets[0]=0;
bandOffsets[1]=1;
bandOffsets[2]=2;
l.add$TE($I$(21).createInterleaved$java_awt_color_ColorSpace$IA$I$Z$Z(rgb, bandOffsets, dataType, false, false));
break;
case 3:
p$1.readMetadata.apply(this, []);
...
$I$(23).fill$BA$I$I$B(red, this.metadata.PLTE_red.length, plength, ($b$[0] = this.metadata.PLTE_red[this.metadata.PLTE_red.length - 1], $b$[0]));
green=$I$(23).copyOf$BA$I(this.metadata.PLTE_green, plength);
$I$(23).fill$BA$I$I$B(green, this.metadata.PLTE_green.length, plength, ($b$[0] = this.metadata.PLTE_green[this.metadata.PLTE_green.length - 1], $b$[0]));
blue=$I$(23).copyOf$BA$I(this.metadata.PLTE_blue, plength);
$I$(23).fill$BA$I$I$B(blue, this.metadata.PLTE_blue.length, plength, ($b$[0] = this.metadata.PLTE_blue[this.metadata.PLTE_blue.length - 1], $b$[0]));
}var alpha=null;
...
$I$(23).fill$BA$I$I$B(alpha, this.metadata.tRNS_alpha.length, red.length, ($b$[0] = -1, $b$[0]));
}}l.add$TE($I$(21).createIndexed$BA$BA$BA$BA$I$I(red, green, blue, alpha, bitDepth, 0));
break;
case 4:
...
bandOffsets[0]=0;
bandOffsets[1]=1;
l.add$TE($I$(21).createInterleaved$java_awt_color_ColorSpace$IA$I$Z$Z(gray, bandOffsets, dataType, true, false));
break;
case 6:
if (bitDepth == 8) {
l.add$TE($I$(21).createFromBufferedImageType$I(6));
l.add$TE($I$(21).createFromBufferedImageType$I(2));
}rgb=$I$(22).getInstance$I(1000);
...
bandOffsets[2]=2;
bandOffsets[3]=3;
l.add$TE($I$(21).createInterleaved$java_awt_color_ColorSpace$IA$I$Z$Z(rgb, bandOffsets, dataType, true, false));
break;
default:
break;
}
