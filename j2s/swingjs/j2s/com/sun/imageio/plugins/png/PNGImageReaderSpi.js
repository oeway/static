(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.png"),I$=[[0,'javax.imageio.stream.ImageInputStream','com.sun.imageio.plugins.png.PNGImageReader']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
