(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.wbmp"),I$=[[0,'javax.imageio.stream.ImageInputStream','com.sun.imageio.plugins.common.ReaderUtil','com.sun.imageio.plugins.wbmp.WBMPImageReader']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
