(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.wbmp"),p$1={},I$=[[0,'com.sun.imageio.plugins.common.I18N','javax.imageio.metadata.IIOMetadataNode','com.sun.imageio.plugins.common.ImageUtil']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
