(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.gif"),I$=[[0,'java.util.Arrays','com.sun.imageio.plugins.gif.GIFStreamMetadata']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
