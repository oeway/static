(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.gif"),p$1={},I$=[[0,'java.util.ArrayList','java.awt.image.IndexColorModel','java.awt.image.PixelInterleavedSampleModel','java.awt.image.MultiPixelPackedSampleModel','javax.imageio.ImageTypeSpecifier','javax.imageio.ImageReadParam','com.sun.imageio.plugins.gif.GIFStreamMetadata','java.nio.ByteOrder','StringBuffer','com.sun.imageio.plugins.gif.GIFImageMetadata','com.sun.imageio.plugins.common.ReaderUtil','java.awt.Rectangle','java.awt.Point','java.awt.image.BufferedImage']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
r[i]=(colorTable[rgbIndex++]|0);
g[i]=(colorTable[rgbIndex++]|0);
b[i]=(colorTable[rgbIndex++]|0);
}
l.add$TE(p$1.createIndexed$BA$BA$BA$I.apply(this, [r, g, b, bits]));
return l.iterator$();
});
...
this.rowBuf[this.streamX - this.sourceRegion.x]=(string[i]|0);
}++this.streamX;
...
}this.imageStartPosition.add$TE(Long.valueOf$J(this.stream.getStreamPosition$()));
} catch (e) {
...
this.imageStartPosition.add$TE(l1);
++index;
}
} catch (e) {
if (Clazz.exceptionOf(e,"java.io.IOException")){
...
}this.imageMetadataLength=((this.stream.getStreamPosition$() - startPosition)|0);
return;
} else if (blockType == 33) {
var label=this.stream.readUnsignedByte$();
if (label == 249) {
...
}this.imageMetadata.comments.add$TE(comment);
} else if (label == 255) {
...
}this.imageMetadata.applicationIDs.add$TE(applicationID);
this.imageMetadata.authenticationCodes.add$TE(authCode);
this.imageMetadata.applicationData.add$TE(applicationData);
} else {
var length=0;
do {
length=this.stream.readUnsignedByte$();
...
this.theImage=javax.imageio.ImageReader.getDestination$javax_imageio_ImageReadParam$java_util_Iterator$I$I(param, imageTypes, this.imageMetadata.imageWidth, this.imageMetadata.imageHeight);
...
this.rowsDone=0;
this.interlacePass=0;
this.sourceRegion=Clazz.new_($I$(12,1).c$$I$I$I$I,[0, 0, 0, 0]);
this.destinationRegion=Clazz.new_($I$(12,1).c$$I$I$I$I,[0, 0, 0, 0]);
javax.imageio.ImageReader.computeRegions$javax_imageio_ImageReadParam$I$I$java_awt_image_BufferedImage$java_awt_Rectangle$java_awt_Rectangle(param, this.width, this.height, this.theImage, this.sourceRegion, this.destinationRegion);
this.destinationOffset=Clazz.new_($I$(13,1).c$$I$I,[this.destinationRegion.x, this.destinationRegion.y]);
...
var oc=oldCode;
prefix[ti]=oc;
suffix[ti]=(initial[newSuffixIndex]|0);
initial[ti]=(initial[oc]|0);
...
var img=Clazz.new_($I$(14,1).c$$I$I$I,[1, 1, 13]);
...
C$.defaultPalette[3 * i + 0]=(r[i]|0);
C$.defaultPalette[3 * i + 1]=(g[i]|0);
C$.defaultPalette[3 * i + 2]=(b[i]|0);
}
