...
return Clazz.new_($I$(3,1).c$$I$Z,[argb, this.transparency != 1]);
}, p$1);
...
C$.$fields$=[['Z',['isLeaf'],'I',['childCount','colorCount','paletteIndex','level'],'L',['red','blue','green'],'O',['children','com.sun.imageio.plugins.common.PaletteBuilder.ColorNode[]','nextReducible','com.sun.imageio.plugins.common.PaletteBuilder.ColorNode']]]
