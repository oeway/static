(function(){var P$=Clazz.newPackage("com.sun.imageio.plugins.common"),I$=[[0,'com.sun.imageio.plugins.common.BitFile','com.sun.imageio.plugins.common.LZWStringTable']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
c=($b$[0] = buf[idx], $b$[0]);
if ((index=this.lzss.findCharString$H$B(this.prefix, ($b$[0] = c, $b$[0]))) != -1) {
this.prefix=index;
} else {
this.bf.writeBits$I$I(this.prefix, this.numBits);
if (this.lzss.addCharString$H$B(this.prefix, ($b$[0] = c, $b$[0])) > this.limit) {
if (this.numBits == 12) {
this.bf.writeBits$I$I(this.clearCode, this.numBits);
