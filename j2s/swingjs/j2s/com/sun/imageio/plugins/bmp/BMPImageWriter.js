...
var rect=Clazz.new_($I$(7,1).c$$I$I$I$I,[input.getMinX$(), input.getMinY$(), input.getWidth$(), input.getHeight$()]);
...
var src=inputRaster;
var srcRect=Clazz.new_($I$(7,1).c$$I$I$I$I,[minX * scaleX + xOffset, row * scaleY + yOffset, (this.w - 1) * scaleX + 1, 1]);
