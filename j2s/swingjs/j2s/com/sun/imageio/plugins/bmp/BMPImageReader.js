...
colorSpace=Clazz.new_($I$(5,1).c$$java_awt_color_ICC_Profile,[$I$(6).getInstance$S(path)]);
} else {
colorSpace=Clazz.new_($I$(5,1).c$$java_awt_color_ICC_Profile,[$I$(6).getInstance$BA(profile)]);
}} catch (e) {
...
return new Boolean($I$(23).getBoolean$S("sun.imageio.plugins.bmp.disableLinkedProfiles"));
});
})()
), Clazz.new_(P$.BMPImageReader$4.$init$, [this, null]));
C$.isLinkedProfileDisabled=$I$(24).doPrivileged$java_security_PrivilegedAction(a);
}return !(C$.isLinkedProfileDisabled).valueOf();
}, 1);
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:49:08 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
