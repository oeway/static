...
p$1.addChildNode$javax_imageio_metadata_IIOMetadataNode$S$O.apply(this, [entry, "Red",  new Byte(($b$[0] = (this.red|0), $b$[0]))]);
p$1.addChildNode$javax_imageio_metadata_IIOMetadataNode$S$O.apply(this, [entry, "Green",  new Byte(($b$[0] = (this.green|0), $b$[0]))]);
p$1.addChildNode$javax_imageio_metadata_IIOMetadataNode$S$O.apply(this, [entry, "Blue",  new Byte(($b$[0] = (this.blue|0), $b$[0]))]);
if (numComps == 4) p$1.addChildNode$javax_imageio_metadata_IIOMetadataNode$S$O.apply(this, [entry, "Alpha",  new Byte(($b$[0] = ((this.palette[j++] & 255)|0), $b$[0]))]);
}
}return root;
}, p$1);
