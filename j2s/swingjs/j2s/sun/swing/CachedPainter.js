(function(){var P$=Clazz.newPackage("sun.swing"),p$1={},I$=[[0,'java.util.HashMap','sun.swing.ImageCache','java.awt.image.BufferedImage']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "CachedPainter");

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.cacheMap=Clazz.new_(1,{K:"java.lang.Object",V:"sun.swing.ImageCache"},$I$(1,1));
}
