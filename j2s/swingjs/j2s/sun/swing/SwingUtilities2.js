...
C$.softBearingCache=Clazz.new_(1,{E:"java.lang.ref.SoftReference"},$I$(3,1));
...
if (oldestEntry != null ) {
C$.softBearingCache.add$TE(Clazz.new_(1,{T:"sun.swing.SwingUtilities2.BearingCacheEntry"},$I$(6,1).c$$TT,[oldestEntry]));
}C$.putEntryInStrongCache$sun_swing_SwingUtilities2_BearingCacheEntry(entry);
}, 1);
...
var measurer=Clazz.new_($I$(8,1).c$$java_text_AttributedCharacterIterator$java_awt_font_FontRenderContext,[aString.getIterator$(), frc]);
...
if (g2d != null ) {
var layout=Clazz.new_($I$(10,1).c$$S$java_awt_Font$java_awt_font_FontRenderContext,[text, g2d.getFont$(), g2d.getFontRenderContext$()]);
if (isPrinting) {
...
this.cache=Clazz.new_(1,{K:"Character",V:"Short"},$I$(1,1));
}, 1);
