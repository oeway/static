(function(){var P$=Clazz.newPackage("sun.audio"),I$=[[0,'javax.sound.sampled.AudioFormat',['javax.sound.sampled.AudioFormat','.Encoding'],'javax.sound.sampled.AudioSystem','java.io.ByteArrayInputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "AudioData");

C$.$clinit$=2;

C$.$static$ = function() {C$.$static$=0;
C$.DEFAULT_FORMAT=Clazz.new_($I$(1,1).c$$javax_sound_sampled_AudioFormat_Encoding$F$I$I$I$F$Z,[$I$(2).ULAW, 8000, 8, 1, 1, 8000, true]);
}
