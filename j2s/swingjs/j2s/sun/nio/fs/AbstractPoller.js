...
;C$.$init$.apply(this);
this.requestList=Clazz.new_(1,{E:"sun.nio.fs.AbstractPoller.Request"},$I$(2,1));
this.shutdown=false;
}, 1);
...
var eventSet=Clazz.new_(1,{E:"java.nio.file.WatchEvent.Kind"},$I$(4,1).c$$I,[events.length]);
...
throw Clazz.new_($I$(7,1).c$$O,[x.getMessage$()]);
} else {
throw x;
}
}
