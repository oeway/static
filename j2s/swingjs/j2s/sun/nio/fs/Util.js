(function(){var P$=Clazz.newPackage("sun.nio.fs"),I$=[[0,'java.nio.charset.Charset','java.security.AccessController','sun.security.action.GetPropertyAction','java.util.HashSet','java.nio.file.LinkOption','AssertionError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var set=Clazz.new_(1,{E:"Object"},$I$(4,1));
...
var set=Clazz.new_(1,{E:"Object"},$I$(4,1).c$$java_util_Collection,[other]);
for (var e, $e = 0, $$e = elements; $e<$$e.length&&((e=($$e[$e])),1);$e++) {
set.add$TE(e);
}
return set;
...
[['M:newSet','java.util.Set','newSet$TEA',['SafeVarargs']],['']],
  [['M:newSet','.','newSet$java_util_Set$TEA',['SafeVarargs']],['']]]}
})();
