...
this.map=Clazz.new_(1,{K:"java.lang.Object",V:"sun.nio.fs.PollingWatchService.PollingWatchKey"},$I$(1,1));
}, 1);
...
var eventSet=Clazz.new_(1,{E:"java.nio.file.WatchEvent.Kind"},$I$(9,1).c$$I,[events.length]);
...
C$.$fields$=[['I',['lastTickCount'],'L',['lastModified']]]
...
this.valid=true;
this.tickCount=0;
this.entries=Clazz.new_(1,{K:"java.nio.file.Path",V:"sun.nio.fs.PollingWatchService.CacheEntry"},$I$(1,1));
try {
...
this.entries.put$TK$TV(entry.getFileName$(), Clazz.new_($I$(4,1).c$$J$I,[lastModified, this.tickCount]));
}
} catch (e) {
