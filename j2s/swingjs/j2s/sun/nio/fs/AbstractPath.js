(function(){var P$=Clazz.newPackage("sun.nio.fs"),I$=[[0,'java.io.File',['java.nio.file.WatchEvent','.Modifier']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(1,1).c$$S,[this.toString()]);
});
