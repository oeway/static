(function(){var P$=Clazz.newPackage("sun.nio.fs"),I$=[[0,'RuntimePermission','java.nio.ByteBuffer','java.util.ArrayList','java.util.HashMap','java.util.Arrays']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var result=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(4,1));
