(function(){var P$=Clazz.newPackage("sun.nio.fs"),p$1={},I$=[[0,'sun.misc.Unsafe','Thread']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['completed'],'L',['pollingAddress'],'O',['lock','java.lang.Object','exception','Throwable']]
