(function(){var P$=Clazz.newPackage("sun.nio.cs"),I$=[[0,'java.nio.charset.CoderResult','sun.nio.cs.DoubleByte','java.util.Arrays',['sun.nio.cs.Surrogate','.Parser'],'StringUTF16']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
