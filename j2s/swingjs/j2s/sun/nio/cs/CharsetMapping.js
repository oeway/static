(function(){var P$=Clazz.newPackage("sun.nio.cs"),p$1={},I$=[[0,'java.util.Arrays','java.security.AccessController','sun.nio.cs.CharsetMapping',['sun.nio.cs.CharsetMapping','.Entry']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
