(function(){var P$=Clazz.newPackage("sun.nio.cs"),p$1={},p$2={},I$=[[0,'java.nio.charset.CoderResult','java.nio.ByteBuffer','java.nio.charset.CodingErrorAction',['sun.nio.cs.Surrogate','.Parser'],'sun.nio.cs.StandardCharsets',['sun.nio.cs.CESU_8','.Decoder'],['sun.nio.cs.CESU_8','.Encoder']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
;C$.superclazz.c$$S$SA.apply(this,["CESU-8", $I$(5).aliases_CESU_8]);C$.$init$.apply(this);
}, 1);
...
return Clazz.new_($I$(6,1).c$$java_nio_charset_Charset,[this]);
});
...
;Clazz.setTVer('3.2.6-v1');//Created 2020-01-04 08:51:02 Java2ScriptVisitor version 3.2.6-v1 net.sf.j2s.core.jar version 3.2.6-v1
