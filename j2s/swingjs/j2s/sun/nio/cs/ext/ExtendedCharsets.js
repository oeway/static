(function(){var P$=Clazz.newPackage("sun.nio.cs.ext"),I$=[[0,'sun.misc.VM','java.security.AccessController','sun.security.action.GetPropertyAction']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
