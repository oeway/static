(function(){var P$=Clazz.newPackage("sun.reflect.annotation"),p$1={},I$=[[0,'AssertionError','java.lang.reflect.Array','java.lang.reflect.Proxy','java.util.Arrays']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
case "hashCode":
return new Integer(p$1.hashCodeImpl.apply(this, []));
case "annotationType":
return this.type;
}
...
if (o === this ) return new Boolean(true);
if (!this.type.isInstance$O(o)) return new Boolean(false);
...
try {
hisValue=memberMethod.invoke$O$OA(o, []);
} catch (e$$) {
...
}if (!C$.memberValueEquals$O$O(ourValue, hisValue)) return new Boolean(false);
}
