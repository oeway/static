(function(){var P$=Clazz.newPackage("sun.reflect.annotation"),I$=[[0,'java.util.ArrayList','java.lang.reflect.Method','java.util.HashMap','java.lang.reflect.Array','Enum','sun.reflect.annotation.AnnotationType','java.util.LinkedHashMap','java.util.Collections','java.lang.annotation.AnnotationFormatError','java.lang.annotation.Annotation',['sun.reflect.annotation.AnnotationParser','.JSAnnotationObject'],'java.lang.reflect.Proxy','sun.reflect.annotation.AnnotationInvocationHandler']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return $I$(12).newProxyInstance$ClassLoader$ClassA$reflect_InvocationHandler(type.getClassLoader$(), Clazz.array(Class, -1, [type]), Clazz.new_($I$(13,1).c$$Class$java_util_Map,[type, memberValues]));
}, 1);

Clazz.newMeth(C$, 'toArray$java_util_Map', function (annotations) {
return annotations.values$().toArray$TTA(C$.EMPTY_ANNOTATION_ARRAY);
}, 1);
...
var list=Clazz.new_(1,{E:"java.lang.reflect.Method"},$I$(1,1).c$$I,[members.length]);
...
return list.toArray$TTA(Clazz.array($I$(2), [list.size$()]));
}, 1);
...
var apt=-1;
var qpt=-1;
var arrayData=Clazz.new_(1,{E:"String"},$I$(1,1));
var key=null;
...
if (apt >= 0) {
arrayData.add$TE(quote);
} else {
map.put$TK$TV(key, quote);
}qpt=-1;
} else {
qpt=i + 1;
}kpt=i + 1;
...
Clazz.newMeth(C$, 'setLocalAnnotationValue$annotation_Annotation$S$O$Class', function (a, key, o, type) {
var val=o;
...
for (var i=av.length; --i >= 0; ) av[i]=C$.setLocalAnnotationValue$annotation_Annotation$S$O$Class(null, null, ao.get$I(i), avType);
...
val=type.getConstructor$ClassA([Clazz.getClass(String)]).newInstance$OA(Clazz.array(java.lang.Object, -1, [val]));
}
(function(val){ var f;
...
var memberValues=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(7,1).c$$java_util_Map,[type.memberDefaults$()]);
...
memberValues.put$TK$TV(key, C$.setLocalAnnotationValue$annotation_Annotation$S$O$Class(a, key, values.get$O(key), memberTypes.get$O(key)));
...
var result=Clazz.new_(1,{K:"Class",V:"java.lang.annotation.Annotation"},$I$(7,1));
...
if (result.put$TK$TV(klass, a) != null ) {
...
var classes=Clazz.array(Class, [args.length - 1]);
if (args.length > 1) {
