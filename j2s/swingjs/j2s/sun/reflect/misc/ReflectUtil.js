(function(){var P$=Clazz.newPackage("sun.reflect.misc"),I$=[[0,'java.lang.reflect.Proxy','java.lang.reflect.Modifier']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
Clazz.newMeth(C$, 'conservativeCheckMemberAccess$reflect_Member', function (m) {
}, 1);
...
Clazz.newMeth(C$, 'checkProxyMethod$O$reflect_Method', function (proxy, method) {
