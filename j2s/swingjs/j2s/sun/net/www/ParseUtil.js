...
return $b$[0] = (Integer.parseInt$S$I(s.substring$I$I(i + 1, i + 3), 16)|0), $b$[0];
}, 1);
...
try {
bb.put$B(($b$[0] = C$.unescape$S$I(s, i), $b$[0]));
} catch (e) {
...
var b=bb.get$() & 255;
if (b >= 128) C$.appendEscape$StringBuffer$B(sb, ($b$[0] = (b|0), $b$[0]));
