(function(){var P$=Clazz.newPackage("sun.net.www"),p$1={},I$=[[0,'java.util.StringJoiner',['sun.net.www.MessageHeader','.HeaderIterator'],'java.util.HashMap','java.util.ArrayList','java.util.Collections']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var skipIt=false;
var m=Clazz.new_(1,{K:"String",V:"java.util.List"},$I$(3,1));
...
if (l == null ) {
l=Clazz.new_(1,{E:"String"},$I$(4,1));
m.put$TK$TV(this.keys[i], l);
}l.add$TE(this.values[i]);
} else {
skipIt=false;
}}
if (include != null ) {
...
if (this.key.equalsIgnoreCase$S(this.this$0.keys[this.index])) {
this.haveNext=true;
...
if (this.haveNext) {
this.haveNext=false;
return this.this$0.values[this.next];
}if (this.hasNext$()) {
return this.next$();
} else {
