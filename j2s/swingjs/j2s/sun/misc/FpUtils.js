(function(){var P$=Clazz.newPackage("sun.misc"),I$=[[0,'StrictMath']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
transducer&=4503599627370495;
Clazz.assert(C$, this, function(){return (transducer != 0)});
while (transducer < (4503599627370496)){
transducer*=2;
exponent--;
}
exponent++;
