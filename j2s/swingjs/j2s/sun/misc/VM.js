(function(){var P$=Clazz.newPackage("sun.misc"),I$=[[0,'java.util.Properties','Runtime','Boolean','sun.misc.OSEnvironment',['Thread','.State']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[[]
,['Z',['suspended','booted','pageAlignDirectMemory','defaultAllowArraySyntax','allowArraySyntax'],'I',['finalRefCount','peakFinalRefCount'],'L',['directMemory'],'O',['lock','java.lang.Object','savedProps','java.util.Properties']]]
...
C$.allowArraySyntax=(s == null  ? C$.defaultAllowArraySyntax : $I$(3).parseBoolean$S(s));
...
return $I$(5).TIMED_WAITING;
} else if ((threadStatus & 2) != 0) {
return $I$(5).TERMINATED;
