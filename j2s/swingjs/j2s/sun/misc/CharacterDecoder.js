(function(){var P$=Clazz.newPackage("sun.misc"),I$=[[0,'sun.misc.CEStreamExhausted','java.io.PushbackInputStream','java.io.ByteArrayInputStream','java.io.ByteArrayOutputStream','java.nio.ByteBuffer']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
