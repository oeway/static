(function(){var P$=Clazz.newPackage("sun.misc"),I$=[[0,'java.lang.reflect.Modifier','IllegalAccessError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return $b$[0] = this.getByte$O$J(o, offset), $b$[0];
});

Clazz.newMeth(C$, 'putByte$O$I$B', function (o, offset, x) {
this.putByte$O$J$B(o, offset, ($b$[0] = x, $b$[0]));
});
...
this.setMemory$O$J$J$B(null, address, bytes, ($b$[0] = value, $b$[0]));
});
...
Clazz.newMeth(C$, 'fieldOffset$reflect_Field', function (f) {
if ($I$(1).isStatic$I(f.getModifiers$())) return (this.staticFieldOffset$reflect_Field(f)|0);
 else return (this.objectFieldOffset$reflect_Field(f)|0);
});
...
return this.staticFieldBase$reflect_Field(fields[i]);
}}
return null;
});

Clazz.newMeth(C$, 'staticFieldOffset$reflect_Field', function (f) {
return 0;
});

Clazz.newMeth(C$, 'objectFieldOffset$reflect_Field', function (f) {
return 0;
});

Clazz.newMeth(C$, 'staticFieldBase$reflect_Field', function (f) {
...
} while (!this.compareAndSwapLong$O$J$J$J(o, offset, v, v + delta));
return v;
});
