...
Clazz.newMeth(C$, 'enqueue$TT', function (obj) {
var newElt=Clazz.new_(1,{T:"Object"},$I$(1,1).c$$TT,[obj]);
if (this.head == null ) {
this.head=newElt;
this.tail=newElt;
this.length=1;
...
return Clazz.new_(1,{T:"Object"},$I$(2,1).c$$sun_misc_Queue,[this]);
});

Clazz.newMeth(C$, 'reverseElements$', function () {
return Clazz.new_(1,{T:"Object"},$I$(3,1).c$$sun_misc_Queue,[this]);
});
