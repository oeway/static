...
C$.hexDigit$java_io_PrintStream$B(this.pStream, ($b$[0] = (((this.offset >>> 8) & 255)|0), $b$[0]));
C$.hexDigit$java_io_PrintStream$B(this.pStream, ($b$[0] = ((this.offset & 255)|0), $b$[0]));
...
this.thisLine[this.currentByte]=(buf[off]|0);
C$.hexDigit$java_io_PrintStream$B(this.pStream, ($b$[0] = buf[off], $b$[0]));
this.pStream.print$S(" ");
this.currentByte++;
