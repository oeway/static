...
;C$.$init$.apply(this);
this.indexMap=Clazz.new_(1,{K:"String",V:"java.util.LinkedList"},$I$(1,1));
this.jarMap=Clazz.new_(1,{K:"String",V:"java.util.LinkedList"},$I$(1,1));
}, 1);
...
if (list == null ) {
list=Clazz.new_(1,{E:"String"},$I$(2,1));
list.add$TE(value);
t.put$TK$TV(key, list);
...
currentJar=files[i];
var zrf=Clazz.new_($I$(3,1).c$$S,[currentJar.replace$C$C("/", $I$(4).separatorChar)]);
...
var bw=Clazz.new_($I$(5,1).c$$java_io_Writer,[Clazz.new_($I$(6,1).c$$java_io_OutputStream$S,[out, "UTF8"])]);
...
var br=Clazz.new_($I$(7,1).c$$java_io_Reader,[Clazz.new_($I$(8,1).c$$java_io_InputStream$S,[is, "UTF8"])]);
var line=null;
var currentJar=null;
var jars=Clazz.new_(1,{E:"String"},$I$(9,1));
while ((line=br.readLine$()) != null  && !line.endsWith$S(".jar") );
for (; line != null ; line=br.readLine$()) {
if (line.length$() == 0) continue;
if (line.endsWith$S(".jar")) {
currentJar=line;
jars.add$TE(currentJar);
} else {
var name=line;
p$1.addMapping$S$S.apply(this, [name, currentJar]);
}}
this.jarFiles=jars.toArray$TTA(Clazz.array(String, [jars.size$()]));
});
