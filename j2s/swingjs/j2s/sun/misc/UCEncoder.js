(function(){var P$=Clazz.newPackage("sun.misc"),I$=[[0,'sun.misc.CRC16']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
b=($b$[0] = 0, $b$[0]);
}this.crc.update$B(($b$[0] = a, $b$[0]));
if (len == 2) {
this.crc.update$B(($b$[0] = b, $b$[0]));
...
outStream.write$I("*".$c());
this.crc.value=0;
this.tmp[0]=((length|0)|0);
this.tmp[1]=((this.sequence|0)|0);
...
this.tmp[0]=((((this.crc.value >>> 8) & 255)|0)|0);
this.tmp[1]=(((this.crc.value & 255)|0)|0);
this.encodeAtom$java_io_OutputStream$BA$I$I(outStream, this.tmp, 0, 2);
