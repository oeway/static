...
C$.dispatcher=Clazz.new_($I$(1,1).c$$Runnable$S,[Clazz.new_(C$), "Request Processor"]);
...
C$.requestQueue=Clazz.new_(1,{T:"sun.misc.Request"},$I$(2,1));
}}, 1);
