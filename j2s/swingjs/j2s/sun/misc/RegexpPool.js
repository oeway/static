(function(){var P$=Clazz.newPackage("sun.misc"),p$1={},I$=[[0,'sun.misc.RegexpNode']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var o=best.result;
if (o != null  && Clazz.instanceOf(o, "sun.misc.RegexpTarget") ) o=(o).found$(s.substring$I$I(bst, bend));
return o;
}, p$1);
