...
if (this.nWords == 0) {
return "0";
}var sb=Clazz.new_($I$(2,1).c$$I,[(this.nWords + this.offset) * 8]);
...
var w=this.data[i];
magnitude[magnitude.length - 4 * i - 1]=((w|0)|0);
magnitude[magnitude.length - 4 * i - 2]=(((w >> 8)|0)|0);
magnitude[magnitude.length - 4 * i - 3]=(((w >> 16)|0)|0);
magnitude[magnitude.length - 4 * i - 4]=(((w >> 24)|0)|0);
}
