...
C$.B2AC_POSITIVE_ZERO=Clazz.new_($I$(5,1).c$$Z$CA,[false, Clazz.array(Character.TYPE, -1, ["0"])]);
C$.B2AC_NEGATIVE_ZERO=Clazz.new_($I$(5,1).c$$Z$CA,[true, Clazz.array(Character.TYPE, -1, ["0"])]);
...
), Clazz.new_(1,{T:"sun.misc.FloatingDecimal.BinaryToASCIIBuffer"},$I$(6,1), [this, null],P$.FloatingDecimal$1));
...
var isNegative=(dBits & -9223372036854775808) != 0;
var fractBits=dBits & 4503599627370495;
var binExp=(((dBits & 9218868437227405312) >> 52)|0);
if (binExp == 2047) {
if (fractBits == 0) {
...
var buf=C$.getBinaryToASCIIBuffer$();
p$1.setSign$Z.apply(buf, [isNegative]);
p$1.dtoa$I$J$I$Z.apply(buf, [binExp, (fractBits) << (29), nSignificantBits, true]);
return buf;
}, 1);
...
var rawExponent=(positiveExponent ? 1 : -1) * unsignedRawExponent;
...
var threshShift=28;
var floatSticky=(significand & ((1 << threshShift) - 1)) != 0 || round  || sticky ;
var iValue=((significand >>> threshShift)|0);
if ((iValue & 3) != 1 || floatSticky ) {
iValue++;
}floatBits|=(((((exponent|0)) + (126))) << 23) + (iValue >> 1);
}} else {
if (exponent < -150) {
} else {
var threshShift=(((-98) - exponent)|0);
...
significand=(((exponent + 1023) << (52)) & 9218868437227405312) | (4503599627370495 & significand);
} else {
if (exponent < (-1075)) {
return isNegative ? C$.A2BC_NEGATIVE_ZERO : C$.A2BC_POSITIVE_ZERO;
} else {
sticky=sticky || round ;
round=false;
var bitsDiscarded=53 - ((exponent|0) - -1074 + 1);
Clazz.assert(C$, this, function(){return bitsDiscarded >= 1 && bitsDiscarded <= 53 });
round=(significand & (1 << (bitsDiscarded - 1))) != 0;
if (bitsDiscarded > 1) {
var mask=~((~0) << (bitsDiscarded - 1));
sticky=sticky || ((significand & mask) != 0) ;
}significand=significand >> bitsDiscarded;
significand=(0) | (4503599627370495 & significand);
}}var leastZero=((significand & 1) == 0);
if ((leastZero && round && sticky  ) || ((!leastZero) && round ) ) {
significand++;
}var value=isNegative ? Double.longBitsToDouble$J(significand | -9223372036854775808) : Double.longBitsToDouble$J(significand);
...
if (value <= -1 || value >= 16 ) {
throw Clazz.new_($I$(10,1).c$$O,["Unexpected failure of digit conversion of " + s.charAt$I(position)]);
}return value;
}, 1);
...
var pow10=$I$(1).LONG_5_POW[insignificantDigits] << insignificantDigits;
var residue=lvalue % pow10;
lvalue=(lvalue/(pow10)|0);
...
Clazz.assert(C$, this, function(){return lvalue > 0}, function(){return lvalue});
var ivalue=(lvalue|0);
c=ivalue % 10;
ivalue=(ivalue/(10)|0);
while (c == 0){
...
Clazz.assert(C$, this, function(){return fractBits > 0});
Clazz.assert(C$, this, function(){return (fractBits & 4503599627370496) != 0});
...
var b=((fractBits|0) * $I$(1).SMALL_5_POW[B5]) << B2;
...
var b=(fractBits * $I$(1).LONG_5_POW[B5]) << B2;
var s=$I$(1).LONG_5_POW[S5] << S2;
var m=$I$(1).LONG_5_POW[M5] << M2;
var tens=s * 10;
ndigit=0;
q=(((b/s|0))|0);
b=10 * (b % s);
...
var d2=Double.longBitsToDouble$J(4607182418800017408 | (fractBits & 4503599627370495));
var d=(d2 - 1.5) * 0.289529654 + 0.176091259 + binExp * 0.301029995663981;
var dBits=Double.doubleToRawLongBits$D(d);
var exponent=(((dBits & 9218868437227405312) >> 52)|0) - 1023;
var isNegative=(dBits & -9223372036854775808) != 0;
if (exponent >= 0 && exponent < 52 ) {
var mask=4503599627370495 >> exponent;
var r=((((dBits & 4503599627370495) | 4503599627370496) >> (52 - exponent))|0);
return isNegative ? (((mask & dBits) == 0) ? -r : -r - 1) : r;
} else if (exponent < 0) {
return (((dBits & ~-9223372036854775808) == 0) ? 0 : ((isNegative) ? -1 : 0));
} else {
return (d|0);
}}, 1);
...
insignificant=(insignificant/(10)|0);
}
return i;
}, 1);
...
lValue=lValue * 10 + (this.digits[i].$c() - 48);
}
var dValue=lValue;
...
var binexp=((ieeeBits >>> 52)|0);
var bigBbits=ieeeBits & 4503599627370495;
if (binexp > 0) {
bigBbits|=4503599627370496;
} else {
...
ieeeBits+=overvalue ? -1 : 1;
if (ieeeBits == 0 || ieeeBits == 9218868437227405312 ) {
break correctionLoop;
}continue;
}}
if (this.isNegative) {
ieeeBits|=-9223372036854775808;
