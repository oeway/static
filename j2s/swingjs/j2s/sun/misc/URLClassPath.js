...
{
C$.JAVA_VERSION=$I$(9).doPrivileged$java_security_PrivilegedAction(Clazz.new_($I$(21,1).c$$S,["java.version"]));
C$.DEBUG=($I$(9).doPrivileged$java_security_PrivilegedAction(Clazz.new_($I$(21,1).c$$S,["sun.misc.URLClassPath.debug"])) != null );
C$.DEBUG_LOOKUP_CACHE=($I$(9).doPrivileged$java_security_PrivilegedAction(Clazz.new_($I$(21,1).c$$S,["sun.misc.URLClassPath.debugLookupCache"])) != null );
var p=$I$(9).doPrivileged$java_security_PrivilegedAction(Clazz.new_($I$(21,1).c$$S,["sun.misc.URLClassPath.disableJarChecking"]));
C$.DISABLE_JAR_CHECKING=p != null  ? p.equals$O("true") || p.equals$O("")  : false;
};
C$.lookupCacheEnabled="true".equals$O($I$(22).getSavedProperty$S("sun.cds.enableSharedLookupCache"));
}

Clazz.newMeth(C$, '$init$', function () {
this.path=Clazz.new_(1,{E:"java.net.URL"},$I$(23,1));
this.urls=Clazz.new_(1,{E:"java.net.URL"},$I$(24,1));
this.loaders=Clazz.new_(1,{E:"sun.misc.URLClassPath.Loader"},$I$(23,1));
this.lmap=Clazz.new_(1,{K:"String",V:"sun.misc.URLClassPath.Loader"},$I$(25,1));
this.closed=false;
}, 1);
...
}var result=Clazz.new_(1,{E:"java.io.IOException"},$I$(27,1));
...
this.urls.add$I$TE(0, url);
this.path.add$TE(url);
...
{
return this.path.toArray$TTA(Clazz.array($I$(1), [this.path.size$()]));
}});
...
Clazz.newMeth(C$, '$init$', function () {
this.index=0;
this.cache=p$2.getLookupCache$S.apply(this.b$['sun.misc.URLClassPath'], [this.$finals$.name]);
this.url=null;
}, 1);
...
this.loaders.add$TE(loader);
this.lmap.put$TK$TV(urlNoFragString, loader);
}
if (C$.DEBUG_LOOKUP_CACHE) {
...
return Clazz.new_($I$(29,1).c$$java_net_URL,[this.$finals$.url]);
}} else {
...
var f=Clazz.new_($I$(7,1).c$$S,[st.nextToken$()]);
try {
f=Clazz.new_($I$(7,1).c$$S,[f.getCanonicalPath$()]);
} catch (x) {
...
var url;
try {
url=Clazz.new_($I$(1,1).c$$java_net_URL$S,[this.base, $I$(2).encodePath$S$Z(name, false)]);
} catch (e) {
...
), Clazz.new_($I$(5,1), [this, {name:name,uc:uc,url:url}],P$.URLClassPath$Loader$1));
});
...
this.b$['sun.misc.URLClassPath.JarLoader'].lmap.put$TK$TV(urlNoFragString, null);
}} catch (e) {
if (Clazz.exceptionOf(e,"java.net.MalformedURLException")){
continue;
} else {
...
if (System.getSecurityManager$() != null  && !$I$(3).DISABLE_JAR_CHECKING  && !C$.zipAccess.startsWithLocHeader$(jar) ) {
...
}return C$.checkJar$java_util_jar_JarFile(Clazz.new_($I$(14,1).c$$S,[p.getPath$()]));
...
var url;
try {
url=Clazz.new_($I$(1,1).c$$java_net_URL$S,[this.getBaseURL$(), $I$(2).encodePath$S$Z(name, false)]);
if (check) {
$I$(3).check$java_net_URL(url);
}} catch (e$$) {
if (Clazz.exceptionOf(e$$,"java.net.MalformedURLException")){
...
Clazz.newMeth(C$, 'getContentLength$', function () {
return (this.$finals$.entry.getSize$()|0);
});
...
), Clazz.new_($I$(5,1), [this, {entry:entry,name:name,url:url}],P$.URLClassPath$JarLoader$2));
});
...
var visited=Clazz.new_(1,{E:"String"},$I$(16,1));
...
jarFiles=jarFilesList.toArray$TTA(Clazz.array(String, [size]));
while (count < size){
...
}this.lmap.put$TK$TV(urlNoFragString, newLoader);
}} catch (e$$) {
...
var visitedURL=!visited.add$TE($I$(12).urlNoFragString$java_net_URL(url));
if (!visitedURL) {
try {
...
var url;
try {
var normalizedBase=Clazz.new_($I$(1,1).c$$java_net_URL$S,[this.getBaseURL$(), "."]);
url=Clazz.new_($I$(1,1).c$$java_net_URL$S,[this.getBaseURL$(), $I$(2).encodePath$S$Z(name, false)]);
...
var file;
if (name.indexOf$S("..") != -1) {
file=(Clazz.new_($I$(7,1).c$$java_io_File$S,[this.dir, name.replace$C$C("/", $I$(7).separatorChar)])).getCanonicalFile$();
if (!((file.getPath$()).startsWith$S(this.dir.getPath$()))) {
return null;
}} else {
file=Clazz.new_($I$(7,1).c$$java_io_File$S,[this.dir, name.replace$C$C("/", $I$(7).separatorChar)]);
}if (file.exists$()) {
...
Clazz.newMeth(C$, 'getContentLength$', function () {
return (this.$finals$.file.length$()|0);
});
})()
