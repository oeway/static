(function(){var P$=Clazz.newPackage("sun.misc"),p$1={},p$2={},I$=[[0,['sun.misc.SoftCache','.ValueCell'],['sun.misc.SoftCache','.Entry'],'java.util.HashMap',['sun.misc.SoftCache','.EntrySet']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
Clazz.super_(C$, this);
this.hash=Clazz.new_($I$(3,1).c$$I$F,[initialCapacity, loadFactor]);
}, 1);

Clazz.newMeth(C$, 'c$$I', function (initialCapacity) {
Clazz.super_(C$, this);
this.hash=Clazz.new_($I$(3,1).c$$I,[initialCapacity]);
}, 1);

Clazz.newMeth(C$, 'c$', function () {
Clazz.super_(C$, this);
this.hash=Clazz.new_($I$(3,1));
}, 1);
...
v=this.fill$O(key);
if (v != null ) {
this.hash.put$TK$TV(key, $I$(1).create$O$O(key, v));
return v;
...
return $I$(1).strip$O$Z(this.hash.put$TK$TV(key, vc), true);
});
...
if (this.entrySet == null ) this.entrySet=Clazz.new_($I$(4,1), [this, null]);
...
return this.ent.setValue$TV($I$(1).create$O$O(this.ent.getKey$(), value));
});

Clazz.newMeth(C$, 'equals$O', function (o) {
if (!(Clazz.instanceOf(o, "java.util.Map.Entry"))) return false;
var e=o;
return (P$.SoftCache.valEquals$O$O(this.ent.getKey$(), e.getKey$()) && P$.SoftCache.valEquals$O$O(this.value, e.getValue$()) );
});
...
Clazz.newMeth(C$, '$init$', function () {
this.hashEntries=this.this$0.hash.entrySet$();
}, 1);
...
continue;
}this.next=Clazz.new_($I$(2,1).c$$java_util_Map_Entry$O, [this, null, ent, v]);
return true;
}
return false;
});
...
p$2.processQueue.apply(this.this$0, []);
