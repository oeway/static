(function(){var P$=Clazz.newPackage("sun.misc"),I$=[[0,'sun.misc.CRC16','java.io.ByteArrayOutputStream','sun.misc.CEStreamExhausted']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
high_byte=($b$[0] = ((((a & 56) << 2) + (b & 31))|0), $b$[0]);
low_byte=($b$[0] = ((((a & 7) << 5) + (c & 31))|0), $b$[0]);
p1=0;
p2=0;
for (i=1; i < 256; i=i * 2) {
if ((high_byte & i) != 0) p1++;
...
this.crc.update$B(($b$[0] = high_byte, $b$[0]));
if (l == 2) {
outStream.write$I(low_byte);
this.crc.update$B(($b$[0] = low_byte, $b$[0]));
}});
