(function(){var P$=Clazz.newPackage("sun.misc"),p$1={},I$=[[0,'ThreadLocal','sun.misc.FloatingDecimal',['sun.misc.FormattedFloatingDecimal','.Form'],'java.util.Arrays']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
), Clazz.new_(1,{T:"java.lang.Object"},$I$(1,1), [this, null],P$.FormattedFloatingDecimal$1));
}
