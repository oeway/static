(function(){var P$=Clazz.newPackage("sun.misc"),I$=[[0,'StringBuffer','sun.misc.CEStreamExhausted']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.decoderBuffer[i]=((((c1 - 32) & 63)|0)|0);
}
