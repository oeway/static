(function(){var P$=Clazz.newPackage("sun.misc"),p$1={},p$2={},p$3={},I$=[[0,'java.io.ByteArrayOutputStream','java.util.ArrayList',['sun.misc.ProxyGenerator','.MethodInfo'],'java.io.DataOutputStream',['sun.misc.ProxyGenerator','.ExceptionTableEntry'],['sun.misc.ProxyGenerator','.PrimitiveTypeInfo'],'AssertionError','java.util.HashMap','Boolean','java.lang.reflect.Array','InternalError',['sun.misc.ProxyGenerator','.ConstantPool','.IndirectEntry'],['sun.misc.ProxyGenerator','.ConstantPool','.ValueEntry'],'java.security.AccessController','sun.security.action.GetBooleanAction','NoSuchMethodError',['sun.misc.ProxyGenerator','.ConstantPool'],'java.nio.file.Paths','java.io.File','java.nio.file.Files',['sun.misc.ProxyGenerator','.FieldInfo'],['sun.misc.ProxyGenerator','.ProxyMethod'],'java.util.LinkedList','StringBuilder','Error','Throwable']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
{
try {
C$.hashCodeMethod=Clazz.getClass(java.lang.Object).getMethod$S$ClassA("hashCode", []);
...
C$.toStringMethod=Clazz.getClass(java.lang.Object).getMethod$S$ClassA("toString", []);
} catch (e) {
if (Clazz.exceptionOf(e,"NoSuchMethodException")){
throw Clazz.new_($I$(16,1).c$$S,[e.getMessage$()]);
} else {
throw e;
}
}
...
this.fields=Clazz.new_(1,{E:"sun.misc.ProxyGenerator.FieldInfo"},$I$(2,1));
this.methods=Clazz.new_(1,{E:"sun.misc.ProxyGenerator.MethodInfo"},$I$(2,1));
this.proxyMethods=Clazz.new_(1,{K:"String",V:"java.util.List"},$I$(8,1));
...
var path;
if (i > 0) {
var dir=$I$(18).get$S$SA(this.$finals$.name.substring$I$I(0, i).replace$C$C(".", $I$(19).separatorChar), []);
$I$(20).createDirectories$java_nio_file_Path$java_nio_file_attribute_FileAttributeA(dir, []);
path=dir.resolve$S(this.$finals$.name.substring$I$I(i + 1, this.$finals$.name.length$()) + ".class");
} else {
path=$I$(18).get$S$SA(this.$finals$.name + ".class", []);
}$I$(20).write$java_nio_file_Path$BA$java_nio_file_OpenOptionA(path, this.$finals$.classFile, []);
return null;
} catch (e) {
...
p$1.addProxyMethod$reflect_Method$Class.apply(this, [C$.hashCodeMethod, Clazz.getClass(java.lang.Object)]);
p$1.addProxyMethod$reflect_Method$Class.apply(this, [C$.equalsMethod, Clazz.getClass(java.lang.Object)]);
p$1.addProxyMethod$reflect_Method$Class.apply(this, [C$.toStringMethod, Clazz.getClass(java.lang.Object)]);
...
p$1.addProxyMethod$reflect_Method$Class.apply(this, [m, intf]);
}
}
...
try {
this.methods.add$TE(p$1.generateConstructor.apply(this, []));
for (var sigmethods, $sigmethods = this.proxyMethods.values$().iterator$(); $sigmethods.hasNext$()&&((sigmethods=($sigmethods.next$())),1);) {
for (var pm, $pm = sigmethods.iterator$(); $pm.hasNext$()&&((pm=($pm.next$())),1);) {
this.fields.add$TE(Clazz.new_($I$(21,1).c$$S$S$I, [this, null, pm.methodFieldName, "Ljava/lang/reflect/Method;", 10]));
this.methods.add$TE(p$2.generateMethod.apply(pm, []));
}
}
this.methods.add$TE(p$1.generateStaticInitializer.apply(this, []));
} catch (e) {
if (Clazz.exceptionOf(e,"java.io.IOException")){
...
var dout=Clazz.new_($I$(4,1).c$$java_io_OutputStream,[bout]);
try {
...
Clazz.newMeth(C$, 'addProxyMethod$reflect_Method$Class', function (m, fromClass) {
var name=m.getName$();
...
var legalExceptions=Clazz.new_(1,{E:"Class"},$I$(2,1));
...
pm.exceptionTypes=legalExceptions.toArray$TTA(pm.exceptionTypes);
return;
}}
} else {
sigmethods=Clazz.new_(1,{E:"sun.misc.ProxyGenerator.ProxyMethod"},$I$(2,1).c$$I,[3]);
this.proxyMethods.put$TK$TV(sig, sigmethods);
}sigmethods.add$TE(Clazz.new_($I$(22,1).c$$S$ClassA$Class$ClassA$Class, [this, null, name, parameterTypes, returnType, exceptionTypes, fromClass]));
}, p$1);

Clazz.newMeth(C$, 'checkReturnTypes$java_util_List', function (methods) {
if (methods.size$() < 2) {
return;
}var uncoveredReturnTypes=Clazz.new_(1,{E:"Class"},$I$(23,1));
...
if (!added) {
liter.set$TE(newReturnType);
added=true;
} else {
liter.remove$();
}}}
if (!added) {
uncoveredReturnTypes.add$TE(newReturnType);
}}
...
var minfo=Clazz.new_($I$(3,1).c$$S$S$I, [this, null, "<init>", "(Ljava/lang/reflect/InvocationHandler;)V", 1]);
var out=Clazz.new_($I$(4,1).c$$java_io_OutputStream,[minfo.code]);
...
var minfo=Clazz.new_($I$(3,1).c$$S$S$I, [this, null, "<clinit>", "()V", 8]);
var localSlot0=1;
var pc;
...
minfo.exceptionTable.add$TE(Clazz.new_($I$(5,1).c$$H$H$H$H,[tryBegin, tryEnd, pc, this.cp.getClass$S("java/lang/NoSuchMethodException")]));
...
minfo.exceptionTable.add$TE(Clazz.new_($I$(5,1).c$$H$H$H$H,[tryBegin, tryEnd, pc, this.cp.getClass$S("java/lang/ClassNotFoundException")]));
p$1.code_astore$I$java_io_DataOutputStream.apply(this, [localSlot0, out]);
out.writeByte$I(187);
...
var desc=Clazz.new_($I$(24,1).c$$S,["("]);
...
if (type.isPrimitive$()) {
return $I$(6).get$Class(type).baseTypeString;
...
var sig=Clazz.new_($I$(24,1).c$$S,[name]);
sig.append$C("(");
for (var i=0; i < parameterTypes.length; i++) {
if (i > 0) {
sig.append$C(",");
...
var uniqueList=Clazz.new_(1,{E:"Class"},$I$(2,1));
uniqueList.add$TE(Clazz.getClass($I$(25)));
uniqueList.add$TE(Clazz.getClass(Clazz.load('RuntimeException')));
 nextException : for (var ex, $ex = 0, $$ex = exceptions; $ex<$$ex.length&&((ex=($$ex[$ex])),1);$ex++) {
if (ex.isAssignableFrom$Class(Clazz.getClass($I$(26)))) {
uniqueList.clear$();
break;
} else if (!Clazz.getClass($I$(26)).isAssignableFrom$Class(ex)) {
continue;
...
this.accessFlags=accessFlags;
this.this$0.cp.getUtf8$S(name);
this.this$0.cp.getUtf8$S(descriptor);
}, 1);

Clazz.newMeth(C$, 'write$java_io_DataOutputStream', function (out) {
out.writeShort$I(this.accessFlags);
out.writeShort$I(this.this$0.cp.getUtf8$S(this.name));
out.writeShort$I(this.this$0.cp.getUtf8$S(this.descriptor));
out.writeShort$I(0);
});
...
this.exceptionTable=Clazz.new_(1,{E:"sun.misc.ProxyGenerator.ExceptionTableEntry"},$I$(2,1));
}, 1);
...
this.this$0.cp.getUtf8$S(name);
this.this$0.cp.getUtf8$S(descriptor);
this.this$0.cp.getUtf8$S("Code");
this.this$0.cp.getUtf8$S("Exceptions");
}, 1);
...
out.writeShort$I(this.this$0.cp.getUtf8$S(this.descriptor));
out.writeShort$I(2);
out.writeShort$I(this.this$0.cp.getUtf8$S("Code"));
...
out.writeShort$I(0);
out.writeShort$I(this.this$0.cp.getUtf8$S("Exceptions"));
...
this.methodFieldName="m" + this.this$0.proxyMethodCount++;
}, 1);

Clazz.newMeth(C$, 'generateMethod', function () {
var desc=P$.ProxyGenerator.getMethodDescriptor$ClassA$Class(this.parameterTypes, this.returnType);
var minfo=Clazz.new_($I$(3,1).c$$S$S$I, [this, null, this.methodName, desc, 17]);
var parameterSlot=Clazz.array(Integer.TYPE, [this.parameterTypes.length]);
var nextSlot=1;
for (var i=0; i < parameterSlot.length; i++) {
parameterSlot[i]=nextSlot;
nextSlot+=P$.ProxyGenerator.getWordsPerType$Class(this.parameterTypes[i]);
}
...
var tryEnd;
var out=Clazz.new_($I$(4,1).c$$java_io_OutputStream,[minfo.code]);
p$1.code_aload$I$java_io_DataOutputStream.apply(this.this$0, [0, out]);
out.writeByte$I(180);
out.writeShort$I(this.this$0.cp.getFieldRef$S$S$S("java/lang/reflect/Proxy", "h", "Ljava/lang/reflect/InvocationHandler;"));
p$1.code_aload$I$java_io_DataOutputStream.apply(this.this$0, [0, out]);
out.writeByte$I(178);
out.writeShort$I(this.this$0.cp.getFieldRef$S$S$S(P$.ProxyGenerator.dotToSlash$S(this.this$0.className), this.methodFieldName, "Ljava/lang/reflect/Method;"));
if (this.parameterTypes.length > 0) {
p$1.code_ipush$I$java_io_DataOutputStream.apply(this.this$0, [this.parameterTypes.length, out]);
out.writeByte$I(189);
out.writeShort$I(this.this$0.cp.getClass$S("java/lang/Object"));
for (var i=0; i < this.parameterTypes.length; i++) {
out.writeByte$I(89);
p$1.code_ipush$I$java_io_DataOutputStream.apply(this.this$0, [i, out]);
...
out.writeShort$I(this.this$0.cp.getInterfaceMethodRef$S$S$S("java/lang/reflect/InvocationHandler", "invoke", "(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;"));
out.writeByte$I(4);
out.writeByte$I(0);
...
var catchList=P$.ProxyGenerator.computeUniqueCatchList$ClassA(this.exceptionTypes);
if (catchList.size$() > 0) {
for (var ex, $ex = catchList.iterator$(); $ex.hasNext$()&&((ex=($ex.next$())),1);) {
minfo.exceptionTable.add$TE(Clazz.new_($I$(5,1).c$$H$H$H$H,[tryBegin, tryEnd, pc, this.this$0.cp.getClass$S(P$.ProxyGenerator.dotToSlash$S(ex.getName$()))]));
}
out.writeByte$I(191);
pc=($s$[0] = minfo.code.size$(), $s$[0]);
minfo.exceptionTable.add$TE(Clazz.new_($I$(5,1).c$$H$H$H$H,[tryBegin, tryEnd, pc, this.this$0.cp.getClass$S("java/lang/Throwable")]));
p$1.code_astore$I$java_io_DataOutputStream.apply(this.this$0, [localSlot0, out]);
out.writeByte$I(187);
out.writeShort$I(this.this$0.cp.getClass$S("java/lang/reflect/UndeclaredThrowableException"));
out.writeByte$I(89);
p$1.code_aload$I$java_io_DataOutputStream.apply(this.this$0, [localSlot0, out]);
out.writeByte$I(183);
out.writeShort$I(this.this$0.cp.getMethodRef$S$S$S("java/lang/reflect/UndeclaredThrowableException", "<init>", "(Ljava/lang/Throwable;)V"));
out.writeByte$I(191);
}if (minfo.code.size$() > 65535) {
throw Clazz.new_(Clazz.load('IllegalArgumentException').c$$S,["code size limit exceeded"]);
}minfo.maxStack=($s$[0] = 10, $s$[0]);
...
minfo.declaredExceptions[i]=this.this$0.cp.getClass$S(P$.ProxyGenerator.dotToSlash$S(this.exceptionTypes[i].getName$()));
}
return minfo;
}, p$2);
...
if (type.isPrimitive$()) {
var prim=$I$(6).get$Class(type);
if (type === Integer.TYPE  || type === Boolean.TYPE   || type === Byte.TYPE   || type === Character.TYPE   || type === Short.TYPE  ) {
p$1.code_iload$I$java_io_DataOutputStream.apply(this.this$0, [slot, out]);
} else if (type === Long.TYPE ) {
p$1.code_lload$I$java_io_DataOutputStream.apply(this.this$0, [slot, out]);
} else if (type === Float.TYPE ) {
p$1.code_fload$I$java_io_DataOutputStream.apply(this.this$0, [slot, out]);
} else if (type === Double.TYPE ) {
p$1.code_dload$I$java_io_DataOutputStream.apply(this.this$0, [slot, out]);
} else {
throw Clazz.new_($I$(7,1));
}out.writeByte$I(184);
out.writeShort$I(this.this$0.cp.getMethodRef$S$S$S(prim.wrapperClassName, "valueOf", prim.wrapperValueOfDesc));
} else {
p$1.code_aload$I$java_io_DataOutputStream.apply(this.this$0, [slot, out]);
}}, p$2);
...
var prim=$I$(6).get$Class(type);
out.writeByte$I(192);
out.writeShort$I(this.this$0.cp.getClass$S(prim.wrapperClassName));
out.writeByte$I(182);
out.writeShort$I(this.this$0.cp.getMethodRef$S$S$S(prim.wrapperClassName, prim.unwrapMethodName, prim.unwrapMethodDesc));
if (type === Integer.TYPE  || type === Boolean.TYPE   || type === Byte.TYPE   || type === Character.TYPE   || type === Short.TYPE  ) {
out.writeByte$I(172);
} else if (type === Long.TYPE ) {
out.writeByte$I(173);
...
out.writeByte$I(192);
out.writeShort$I(this.this$0.cp.getClass$S(P$.ProxyGenerator.dotToSlash$S(type.getName$())));
out.writeByte$I(176);
}}, p$2);

Clazz.newMeth(C$, 'codeFieldInitialization$java_io_DataOutputStream', function (out) {
p$1.codeClassForName$Class$java_io_DataOutputStream.apply(this.this$0, [this.fromClass, out]);
p$1.code_ldc$I$java_io_DataOutputStream.apply(this.this$0, [this.this$0.cp.getString$S(this.methodName), out]);
p$1.code_ipush$I$java_io_DataOutputStream.apply(this.this$0, [this.parameterTypes.length, out]);
out.writeByte$I(189);
out.writeShort$I(this.this$0.cp.getClass$S("java/lang/Class"));
for (var i=0; i < this.parameterTypes.length; i++) {
out.writeByte$I(89);
p$1.code_ipush$I$java_io_DataOutputStream.apply(this.this$0, [i, out]);
if (this.parameterTypes[i].isPrimitive$()) {
var prim=$I$(6).get$Class(this.parameterTypes[i]);
out.writeByte$I(178);
out.writeShort$I(this.this$0.cp.getFieldRef$S$S$S(prim.wrapperClassName, "TYPE", "Ljava/lang/Class;"));
} else {
p$1.codeClassForName$Class$java_io_DataOutputStream.apply(this.this$0, [this.parameterTypes[i], out]);
}out.writeByte$I(83);
}
out.writeByte$I(182);
out.writeShort$I(this.this$0.cp.getMethodRef$S$S$S("java/lang/Class", "getMethod", "(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;"));
out.writeByte$I(179);
out.writeShort$I(this.this$0.cp.getFieldRef$S$S$S(P$.ProxyGenerator.dotToSlash$S(this.this$0.className), this.methodFieldName, "Ljava/lang/reflect/Method;"));
}, p$2);
var $s$ = new Int16Array(1);
...
C$.$static$ = function() {C$.$static$=0;
C$.table=Clazz.new_(1,{K:"Class",V:"sun.misc.ProxyGenerator.PrimitiveTypeInfo"},$I$(8,1));
{
...
C$.add$Class$Class(Boolean.TYPE, Clazz.getClass($I$(9)));
};
}
...
C$.table.put$TK$TV(primitiveClass, Clazz.new_(C$.c$$Class$Class,[primitiveClass, wrapperClass]));
}, 1);
...
this.wrapperClassName=P$.ProxyGenerator.dotToSlash$S(wrapperClass.getName$());
...
Clazz.newMeth(C$, '$init$', function () {
this.pool=Clazz.new_(1,{E:"sun.misc.ProxyGenerator.ConstantPool.Entry"},$I$(2,1).c$$I,[32]);
this.map=Clazz.new_(1,{K:"java.lang.Object",V:"Short"},$I$(8,1).c$$I,[16]);
this.readOnly=false;
}, 1);
...
var dataOut=Clazz.new_($I$(4,1).c$$java_io_OutputStream,[out]);
...
this.map.put$TK$TV(key,  new Short(i));
return i;
}}, p$3);
...
this.map.put$TK$TV(e,  new Short(i));
return i;
}}, p$3);
var $s$ = new Int16Array(1);
;
