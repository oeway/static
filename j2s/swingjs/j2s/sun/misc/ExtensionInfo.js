(function(){var P$=Clazz.newPackage("sun.misc"),p$1={},I$=[[0,'java.util.ResourceBundle',['java.util.jar.Attributes','.Name'],'java.util.StringTokenizer','java.text.MessageFormat']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var mf=Clazz.new_($I$(4,1).c$$S,[C$.rb.getString$S("optpkg.versionerror")]);
