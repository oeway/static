(function(){var P$=Clazz.newPackage("sun.java2d.loops"),I$=[[0,'sun.java2d.SunCompositeContext']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
