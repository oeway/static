(function(){var P$=Clazz.newPackage("sun.java2d.loops"),I$=[[0,'java.awt.Font','sun.java2d.loops.RenderCache','sun.java2d.loops.GraphicsPrimitiveMgr',['sun.java2d.loops.BlitBg','.General'],['sun.java2d.loops.BlitBg','.TraceBlitBg']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.blitcache=Clazz.new_($I$(2,1).c$$I,[20]);
{
...
return Clazz.new_($I$(4,1).c$$sun_java2d_loops_SurfaceType$sun_java2d_loops_CompositeType$sun_java2d_loops_SurfaceType,[srctype, comptype, dsttype]);
});

Clazz.newMeth(C$, 'traceWrap$', function () {
return Clazz.new_($I$(5,1).c$$sun_java2d_loops_BlitBg,[this]);
});
;
