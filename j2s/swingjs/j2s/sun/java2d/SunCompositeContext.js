...
var srcImg=Clazz.new_($I$(2,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[this.srcCM, src, this.srcCM.isAlphaPremultiplied$(), null]);
var dstImg=Clazz.new_($I$(2,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[this.dstCM, dstOut, this.dstCM.isAlphaPremultiplied$(), null]);
});
