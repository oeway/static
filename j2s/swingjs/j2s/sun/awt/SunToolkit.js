...
var pe=Clazz.new_($I$(7,1).c$$O$Runnable$J,[$I$(8).getDefaultToolkit$(), ((P$.SunToolkit$1||
...
C$.postEvent$sun_awt_AppContext$java_awt_AWTEvent(appContext, Clazz.new_($I$(7,1).c$$O$Runnable$J,[$I$(8).getDefaultToolkit$(), dispatcher, 1]));
}, 1);
...
return Clazz.new_($I$(9,1).c$$I$I,[this.getScreenWidth$(), this.getScreenHeight$()]);
});
