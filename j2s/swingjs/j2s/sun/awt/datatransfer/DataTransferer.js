(function(){var P$=Clazz.newPackage("sun.awt.datatransfer"),p$1={},I$=[[0,'java.util.HashMap','sun.awt.datatransfer.DataTransferer','java.util.Collections','java.io.InputStream','java.io.Reader',['sun.awt.datatransfer.DataTransferer','.CharsetComparator'],'java.util.HashSet','java.awt.datatransfer.DataFlavor','Boolean','java.util.ArrayList',['sun.awt.datatransfer.DataTransferer','.DataFlavorComparator'],'sun.awt.SunToolkit','java.awt.AWTError','java.security.AccessController','java.util.TreeSet','java.util.TreeMap',['sun.awt.datatransfer.DataTransferer','.IndexOrderComparator'],'java.util.Arrays','StringBuffer','java.io.ByteArrayOutputStream','java.io.ByteArrayInputStream','java.io.File','java.io.StringReader','java.io.InputStreamReader','java.lang.reflect.Modifier','java.io.SequenceInputStream','java.util.Stack','java.awt.EventQueue','sun.awt.AppContext']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.textNatives=$I$(3).synchronizedSet$java_util_Set(Clazz.new_($I$(7,1)));
...
try {
tPlainTextStringFlavor=Clazz.new_($I$(8,1).c$$S,["text/plain;charset=Unicode;class=java.lang.String"]);
} catch (cannotHappen) {
if (Clazz.exceptionOf(cannotHappen,"ClassNotFoundException")){
} else {
throw cannotHappen;
...
try {
tJavaTextEncodingFlavor=Clazz.new_($I$(8,1).c$$S,["application/x-java-text-encoding;class=\"[B\""]);
} catch (cannotHappen) {
if (Clazz.exceptionOf(cannotHappen,"ClassNotFoundException")){
} else {
throw cannotHappen;
...
C$.defaultCharsetComparator=Clazz.new_($I$(6,1).c$$Z,[false]);
...
var mappingSet=Clazz.new_($I$(7,1).c$$I,[formats.length]);
var flavorSet=Clazz.new_($I$(7,1).c$$I,[formats.length]);
...
var fileList=Clazz.new_(1,{E:"String"},$I$(10,1));
var nFiles=0;
...
return Clazz.new_($I$(23,1).c$$S,[p$1.translateBytesOrStreamToString$java_io_InputStream$BA$J$java_awt_datatransfer_Transferable.apply(this, [str, bytes, format, localeTransferable])]);
} else if (flavor.isRepresentationClassInputStream$()) {
...
var allowedFiles=Clazz.new_($I$(19,1).c$$I,[str.length$()]);
...
), Clazz.new_(P$.DataTransferer$4.$init$, [this, {format:format,contents:contents,stack:stack,formatMap:formatMap}]));
...
Clazz.newMeth(C$, 'c$$Z', function (order) {
;C$.superclazz.c$$Z.apply(this,[order]);C$.$init$.apply(this);
this.charsetComparator=Clazz.new_($I$(6,1).c$$Z,[order]);
...
;C$.superclazz.c$$Z.apply(this,[order]);C$.$init$.apply(this);
this.charsetComparator=Clazz.new_($I$(6,1).c$$Z,[order]);
var hashMap=Clazz.new_($I$(1,1).c$$I,[map.size$()]);
