...
this.CLIPBOARD_FLAVOR_LISTENER_KEY=Clazz.new_($I$(2,1).c$$S,[name + "_CLIPBOARD_FLAVOR_LISTENER_KEY"]);
}, 1);
...
try {
this.owner=owner;
this.contents=Clazz.new_($I$(3,1).c$$java_awt_datatransfer_Transferable$Z,[contents, true]);
...
}return Clazz.new_($I$(6,1).c$$sun_awt_datatransfer_SunClipboard,[this]);
});
...
$I$(9).postEvent$sun_awt_AppContext$java_awt_AWTEvent(context, Clazz.new_($I$(10,1).c$$O$Runnable$J,[this, runnable, 1]));
});
...
contextFlavorListeners=Clazz.new_($I$(11,1).c$$Class,[Clazz.getClass($I$(12),['flavorsChanged$java_awt_datatransfer_FlavorEvent'])]);
...
$I$(9).postEvent$sun_awt_AppContext$java_awt_AWTEvent(appContext, Clazz.new_($I$(10,1).c$$O$Runnable$J,[this, Clazz.new_(P$.SunClipboard$1SunFlavorChangeNotifier.$init$, [this, null]), 1]));
}
}}
});
;
...
this.flavorListener.flavorsChanged$(Clazz.new_($I$(13,1).c$$java_awt_datatransfer_Clipboard,[this.this$0]));
}});
