...
var bi=Clazz.new_($I$(3,1).c$$java_awt_image_ColorModel$java_awt_image_WritableRaster$Z$java_util_Hashtable,[cm, raster, isRasterPremultiplied, null]);
...
var size=w * h;
var dbi=Clazz.new_($I$(6,1).c$$I,[size]);
...
alert('native method must be replaced! setICMpixels');
}
, p$1);
...
alert('native method must be replaced! setDiffICM');
}
, p$1);
...
icm=Clazz.new_($I$(9,1).c$$I$I$IA$I$Z$I$I,[nbits, this.numSrcLUT, this.srcLUT, 0, hasAlpha, this.srcLUTtransIndex, (nbits > 8 ? 1 : 0)]);
this.cmodel=icm;
...
var opModel=Clazz.new_($I$(10,1).c$$I$I$I$I,[24, 16711680, 65280, 255]);
