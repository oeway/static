(function(){var P$=Clazz.newPackage("sun.awt.image"),I$=[[0,'sun.java2d.StateTrackableDelegate',['sun.java2d.StateTrackable','.State']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
