...
throw Clazz.new_($I$(1,1).c$$S,["bad curvelink [" + new Double(this.ytop).toString() + "=>" + new Double(this.ybot).toString() + "] for " + curve ]);
}}, 1);
...
throw Clazz.new_($I$(1,1).c$$S,["bad curvelink [" + new Double(ystart).toString() + "=>" + new Double(yend).toString() + "] for " + curve ]);
...
return Clazz.new_($I$(2,1).c$$D$D,[this.getXTop$(), this.getYTop$()]);
});
