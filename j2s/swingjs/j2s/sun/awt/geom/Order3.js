(function(){var P$=Clazz.newPackage("sun.awt.geom"),I$=[[0,'java.awt.geom.QuadCurve2D','sun.awt.geom.Order2']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
