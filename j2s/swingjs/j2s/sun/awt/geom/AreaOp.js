(function(){var P$=Clazz.newPackage("sun.awt.geom"),p$1={},I$=[[0,'sun.awt.geom.CurveLink','sun.awt.geom.ChainEnd','java.util.Vector','sun.awt.geom.Curve','sun.awt.geom.Edge','java.util.Arrays','InternalError']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (c.getOrder$() > 0) {
edges.add$TE(Clazz.new_($I$(5,1).c$$sun_awt_geom_Curve$I,[c, curvetag]));
}}
}, 1);
...
throw Clazz.new_($I$(7,1).c$$S,["backstepping to " + new Double(yrange[1]).toString() + " from " + new Double(yrange[0]).toString() ]);
}if (ordering >= 0) {
if (ordering == 0) {
...
links.add$TE(Clazz.new_($I$(1,1).c$$sun_awt_geom_Curve$D$D$I,[e.getCurve$(), ystart, yend, etag]));
}}
if (this.getState$() != -1) {
