(function(){var P$=Clazz.newPackage("sun.font"),I$=[[0,'java.io.File']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var lucidaFile=Clazz.new_($I$(1,1).c$$S,[jreFontDirName + $I$(1).separator + "LucidaSansRegular.ttf" ]);
