...
C$.metricsCache=Clazz.new_(1,{K:"java.lang.Object",V:"sun.font.FontDesignMetrics.KeyReference"},$I$(2,1));
...
C$.metricsCache.put$TK$TV(font, Clazz.new_($I$(3,1).c$$O$O,[font, m]));
