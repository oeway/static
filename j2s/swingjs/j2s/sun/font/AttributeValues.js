(function(){var P$=Clazz.newPackage("sun.font"),p$1={},I$=[[0,'sun.font.EAttribute','java.awt.geom.AffineTransform','InternalError','java.util.HashMap','StringBuilder','java.awt.font.TextAttribute','Boolean',['java.awt.geom.Point2D','.Double']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['strikethrough','swapColors'],'B',['imUnderline','superscript','underline','runDirection','bidiEmbedding','kerning','ligatures'],'F',['weight','width','posture','size','tracking','justification'],'I',['defined','nondefault'],'S',['family'],'O',['transform','java.awt.geom.AffineTransform','foreground','java.awt.Paint','+background','imHighlight','java.lang.Object','font','java.awt.Font','baselineTransform','java.awt.geom.AffineTransform','+charTransform']]
...
if (fill == null ) {
fill=Clazz.new_(1,{K:"java.awt.font.TextAttribute",V:"java.lang.Object"},$I$(4,1));
...
return C$.extractRotation$java_awt_geom_Point2D_Double$java_awt_geom_AffineTransform$Z(Clazz.new_($I$(8,1).c$$D$D,[1, 0]), tx, andTranslation);
}, 1);

Clazz.newMeth(C$, 'extractYRotation$java_awt_geom_AffineTransform$Z', function (tx, andTranslation) {
return C$.extractRotation$java_awt_geom_Point2D_Double$java_awt_geom_AffineTransform$Z(Clazz.new_($I$(8,1).c$$D$D,[0, 1]), tx, andTranslation);
}, 1);
