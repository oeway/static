(function(){var P$=Clazz.newPackage("sun.util.logging"),I$=[[0,'java.security.AccessController','AssertionError','java.util.Date']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
try {
String.format$S$OA(format, [Clazz.new_($I$(3,1)), "", "", "", "", ""]);
} catch (e) {
