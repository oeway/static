(function(){var P$=Clazz.newPackage("sun.util.logging"),p$1={},p$2={},I$=[[0,'java.util.Arrays','sun.util.logging.LoggingSupport','java.util.Date',['sun.util.logging.PlatformLogger','.Level'],'sun.util.logging.PlatformLogger','java.text.MessageFormat','java.io.StringWriter','java.io.PrintWriter','sun.misc.SharedSecrets','Throwable','java.util.HashMap',['sun.util.logging.PlatformLogger','.DefaultLoggerProxy'],['sun.util.logging.PlatformLogger','.JavaLoggerProxy']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.DEFAULT_LEVEL=$I$(4).INFO;
C$.loggingEnabled=true;
C$.loggers=Clazz.new_(1,{K:"String",V:"sun.util.logging.PlatformLogger"},$I$(11,1));
}
...
var lp=Clazz.getClass($I$(12)).cast$O(this.loggerProxy);
var jlp=Clazz.new_($I$(13,1).c$$S$sun_util_logging_PlatformLogger_Level,[lp.name, lp.level]);
...
;C$.$init$.apply(this);
if (C$.loggingEnabled) {
this.loggerProxy=this.javaLoggerProxy=Clazz.new_($I$(13,1).c$$S,[name]);
} else {
this.loggerProxy=Clazz.new_($I$(12,1).c$$S,[name]);
}}, 1);
...
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S($I$(4).SEVERE, msg);
});

Clazz.newMeth(C$, 'severe$S$Throwable', function (msg, t) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$Throwable($I$(4).SEVERE, msg, t);
});

Clazz.newMeth(C$, 'severe$S$OA', function (msg, params) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$OA($I$(4).SEVERE, msg, params);
});

Clazz.newMeth(C$, 'warning$S', function (msg) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S($I$(4).WARNING, msg);
});

Clazz.newMeth(C$, 'warning$S$Throwable', function (msg, t) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$Throwable($I$(4).WARNING, msg, t);
});

Clazz.newMeth(C$, 'warning$S$OA', function (msg, params) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$OA($I$(4).WARNING, msg, params);
});

Clazz.newMeth(C$, 'info$S', function (msg) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S($I$(4).INFO, msg);
});

Clazz.newMeth(C$, 'info$S$Throwable', function (msg, t) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$Throwable($I$(4).INFO, msg, t);
});

Clazz.newMeth(C$, 'info$S$OA', function (msg, params) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$OA($I$(4).INFO, msg, params);
});

Clazz.newMeth(C$, 'config$S', function (msg) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S($I$(4).CONFIG, msg);
});

Clazz.newMeth(C$, 'config$S$Throwable', function (msg, t) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$Throwable($I$(4).CONFIG, msg, t);
});

Clazz.newMeth(C$, 'config$S$OA', function (msg, params) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$OA($I$(4).CONFIG, msg, params);
});

Clazz.newMeth(C$, 'fine$S', function (msg) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S($I$(4).FINE, msg);
});

Clazz.newMeth(C$, 'fine$S$Throwable', function (msg, t) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$Throwable($I$(4).FINE, msg, t);
});

Clazz.newMeth(C$, 'fine$S$OA', function (msg, params) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$OA($I$(4).FINE, msg, params);
});

Clazz.newMeth(C$, 'finer$S', function (msg) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S($I$(4).FINER, msg);
});

Clazz.newMeth(C$, 'finer$S$Throwable', function (msg, t) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$Throwable($I$(4).FINER, msg, t);
});

Clazz.newMeth(C$, 'finer$S$OA', function (msg, params) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$OA($I$(4).FINER, msg, params);
});

Clazz.newMeth(C$, 'finest$S', function (msg) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S($I$(4).FINEST, msg);
});

Clazz.newMeth(C$, 'finest$S$Throwable', function (msg, t) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$Throwable($I$(4).FINEST, msg, t);
});

Clazz.newMeth(C$, 'finest$S$OA', function (msg, params) {
this.loggerProxy.doLog$sun_util_logging_PlatformLogger_Level$S$OA($I$(4).FINEST, msg, params);
});
;
...
Clazz.newMeth(C$, 'isEnabled$', function () {
return this.effectiveLevel !== $I$(4).OFF ;
});
...
return level.intValue$() >= effectiveLevel.intValue$() && effectiveLevel !== $I$(4).OFF  ;
});

Clazz.newMeth(C$, 'deriveEffectiveLevel$sun_util_logging_PlatformLogger_Level', function (level) {
return level == null  ? $I$(5).DEFAULT_LEVEL : level;
}, p$1);
...
return $I$(6).format$S$OA(format, parameters);
}return format;
} catch (ex) {
...
var throwable="";
if (thrown != null ) {
var sw=Clazz.new_($I$(7,1));
var pw=Clazz.new_($I$(8,1).c$$java_io_Writer,[sw]);
pw.println$();
thrown.printStackTrace$java_io_PrintWriter(pw);
pw.close$();
throwable=sw.toString();
}return String.format$S$OA(C$.formatString, [this.date, p$1.getCallerInfo.apply(this, []), this.name, level.name$(), msg, throwable]);
}, p$1);

Clazz.newMeth(C$, 'getCallerInfo', function () {
var sourceClassName=null;
var sourceMethodName=null;
var access=$I$(9).getJavaLangAccess$();
var throwable=Clazz.new_($I$(10,1));
...
C$.$static$ = function() {C$.$static$=0;
{
for (var level, $level = 0, $$level = $I$(4).values$(); $level<$$level.length&&((level=($$level[$level])),1);$level++) {
...
Clazz.newMeth(C$, 'isEnabled$', function () {
return $I$(2).isLoggable$O$O(this.javaLogger, $I$(4).OFF.javaLevel);
});
...
try {
return $I$(4).valueOf$S($I$(2).getLevelName$O(javaLevel));
} catch (e) {
if (Clazz.exceptionOf(e,"IllegalArgumentException")){
return $I$(4).valueOf$I($I$(2).getLevelValue$O(javaLevel));
} else {
throw e;
}
}
