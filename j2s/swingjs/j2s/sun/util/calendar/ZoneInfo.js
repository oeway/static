(function(){var P$=Clazz.newPackage("sun.util.calendar"),p$1={},I$=[[0,'java.util.Date','sun.util.calendar.CalendarSystem','java.util.SimpleTimeZone']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
if (type != 0) {
msec-=this.rawOffset;
}var dstoffset=tz.inDaylightTime$java_util_Date(Clazz.new_($I$(1,1).c$$J,[msec])) ? tz.getDSTSavings$() : 0;
if (offsets != null ) {
offsets[0]=rawoffset;
offsets[1]=dstoffset;
...
return Clazz.new_($I$(3,1).c$$I$S$I$I$I$I$I$I$I$I$I$I$I,[p$1.getLastRawOffset.apply(this, []), this.getID$(), this.simpleTimeZoneParams[0], this.simpleTimeZoneParams[1], this.simpleTimeZoneParams[2], this.simpleTimeZoneParams[3], this.simpleTimeZoneParams[4], this.simpleTimeZoneParams[5], this.simpleTimeZoneParams[6], this.simpleTimeZoneParams[7], this.simpleTimeZoneParams[8], this.simpleTimeZoneParams[9], this.dstSavings]);
}return Clazz.new_($I$(3,1).c$$I$S$I$I$I$I$I$I$I$I$I,[p$1.getLastRawOffset.apply(this, []), this.getID$(), this.simpleTimeZoneParams[0], this.simpleTimeZoneParams[1], this.simpleTimeZoneParams[2], this.simpleTimeZoneParams[3], this.simpleTimeZoneParams[4], this.simpleTimeZoneParams[5], this.simpleTimeZoneParams[6], this.simpleTimeZoneParams[7], this.dstSavings]);
});
