(function(){var P$=Clazz.newPackage("sun.util.calendar"),I$=[[0,'java.util.TimeZone','InternalError','StringBuilder','sun.util.calendar.CalendarUtils']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
C$.$fields$=[['Z',['leapYear','normalized','forceStandardTime'],'I',['year','month','dayOfMonth','dayOfWeek','hours','minutes','seconds','millis','zoneOffset','daylightSaving'],'L',['fraction'],'O',['era','sun.util.calendar.Era','zoneinfo','java.util.TimeZone','locale','java.util.Locale']]]
