(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[[0,'java.util.Vector','gnu.jpdf.PDFStream','gnu.jpdf.PDFStringHelper']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.outlines=Clazz.new_(1,{E:"gnu.jpdf.PDFOutline"},$I$(1,1));
this.title=null;
this.dest=null;
this.destMode=false;
}, 1);
