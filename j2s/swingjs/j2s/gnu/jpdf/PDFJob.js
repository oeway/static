(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[[0,'java.awt.Rectangle','gnu.jpdf.PDFDocument','gnu.jpdf.PDFPage',['gnu.jpdf.PDFJob','.PDFGraphic']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
