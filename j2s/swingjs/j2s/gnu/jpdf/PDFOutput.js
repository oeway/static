(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[[0,'java.util.Vector','java.io.ByteArrayOutputStream','gnu.jpdf.PDFStream','gnu.jpdf.PDFXref']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.os=os;
this.offset=0;
this.offsets=Clazz.new_(1,{E:"gnu.jpdf.PDFXref"},$I$(1,1));
...
this.offsets.addElement$TE(Clazz.new_($I$(4,1).c$$I$I,[ob.getSerialID$(), this.offset]));
this.baos.reset$();
...
var firstid=0;
var lastid=-1;
var block=Clazz.new_(1,{E:"gnu.jpdf.PDFXref"},$I$(1,1));
block.addElement$TE(Clazz.new_($I$(4,1).c$$I$I$I,[0, 0, 65535]));
