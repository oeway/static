(function(){var P$=Clazz.newPackage("gnu.jpdf"),p$1={},I$=[[0,'java.awt.geom.AffineTransform','java.awt.BasicStroke','java.text.DecimalFormat','java.awt.image.BufferedImage','java.awt.RenderingHints','java.awt.geom.Area','java.awt.Rectangle',['java.awt.geom.Point2D','.Double'],'gnu.jpdf.PDFImage','java.util.Hashtable','gnu.jpdf.PDFStringHelper','java.awt.Color','java.awt.Font','java.awt.font.FontRenderContext','gnu.jpdf.PDFStream',['java.awt.geom.Point2D','.Float']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var properties=Clazz.new_(1,{K:"String",V:"java.lang.Object"},$I$(10,1));
...
return Clazz.new_($I$(14,1).c$$java_awt_geom_AffineTransform$Z$Z,[Clazz.new_($I$(1,1)), antialias, fractions]);
});
...
}return Clazz.new_($I$(2,1).c$$F$I$I$F$FA$F,[st.getLineWidth$() * scale, st.getEndCap$(), st.getLineJoin$(), st.getMiterLimit$(), dash, st.getDashPhase$() * scale]);
}, p$1);
