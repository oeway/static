(function(){var P$=Clazz.newPackage("gnu.jpdf"),p$1={},I$=[[0,'java.io.ByteArrayOutputStream','java.io.PrintWriter','java.util.zip.DeflaterOutputStream']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
