(function(){var P$=Clazz.newPackage("gnu.jpdf"),I$=[[0,'java.util.Vector','gnu.jpdf.PDFPageList','gnu.jpdf.PDFCatalog','gnu.jpdf.PDFInfo','gnu.jpdf.PDFOutline','gnu.jpdf.PDFFont','gnu.jpdf.PDFOutput']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
;C$.$init$.apply(this);
this.objser=1;
this.objects=Clazz.new_(1,{E:"gnu.jpdf.PDFObject"},$I$(1,1));
