(function(){var P$=Clazz.newPackage("gnu.jpdf"),p$1={},I$=[[0,'StringBuffer','java.util.Vector','java.io.ByteArrayOutputStream','java.util.zip.DeflaterOutputStream','gnu.jpdf.PDFStream','java.awt.image.PixelGrabber']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
var digitVector=Clazz.new_(1,{E:"Integer"},$I$(2,1));
