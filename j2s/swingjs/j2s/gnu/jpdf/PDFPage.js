(function(){var P$=Clazz.newPackage("gnu.jpdf"),p$1={},I$=[[0,'java.util.Vector','gnu.jpdf.PDFStream','java.awt.print.PageFormat','gnu.jpdf.PDFGraphics','java.awt.Dimension','java.awt.Rectangle','gnu.jpdf.PDFAnnot','gnu.jpdf.PDFOutline','gnu.jpdf.PDFObject',['gnu.jpdf.PDFPage','.procset']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
this.xobjects=Clazz.new_(1,{E:"String"},$I$(1,1));
}, 1);
...
this.contents=Clazz.new_(1,{E:"gnu.jpdf.PDFObject"},$I$(1,1));
this.thumbnail=null;
this.annotations=Clazz.new_(1,{E:"gnu.jpdf.PDFObject"},$I$(1,1));
this.resources=Clazz.new_(1,{E:"String"},$I$(1,1));
this.imageResources=Clazz.new_(1,{E:"String"},$I$(1,1));
this.fonts=Clazz.new_(1,{E:"gnu.jpdf.PDFFont"},$I$(1,1));
this.procset=null;
}, 1);
...
return Clazz.new_($I$(5,1).c$$I$I,[(this.pageFormat.getWidth$()|0), (this.pageFormat.getHeight$()|0)]);
});

Clazz.newMeth(C$, 'getImageableArea$', function () {
return Clazz.new_($I$(6,1).c$$I$I$I$I,[(this.pageFormat.getImageableX$()|0), (this.pageFormat.getImageableY$()|0), ((this.pageFormat.getImageableX$() + this.pageFormat.getImageableWidth$())|0), ((this.pageFormat.getImageableY$() + this.pageFormat.getImageableHeight$())|0)]);
});
...
this.set=Clazz.new_(1,{E:"String"},$I$(1,1));
