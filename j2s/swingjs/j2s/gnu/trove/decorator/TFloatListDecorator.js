...
/*c*/var C$=Clazz.newClass(P$, "TFloatListDecorator", null, 'java.util.AbstractList', ['java.util.List', 'java.io.Externalizable', 'Cloneable']);
...
if (value == this.list.getNoEntryValue$() ) return null;
 else return Float.valueOf$F(value);
});

Clazz.newMeth(C$, ['set$I$Float','set$I$TE'], function (index, value) {
var previous_value=this.list.set$I$F(index, (value).valueOf());
if (previous_value == this.list.getNoEntryValue$() ) return null;
 else return Float.valueOf$F(previous_value);
});

Clazz.newMeth(C$, ['add$I$Float','add$I$TE'], function (index, value) {
this.list.insert$I$F(index, value.floatValue$());
});
