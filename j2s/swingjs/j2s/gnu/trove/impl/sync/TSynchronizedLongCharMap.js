(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedLongSet','gnu.trove.impl.sync.TSynchronizedCharCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedLongCharMap", null, null, ['gnu.trove.map.TLongCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TLongCharMap','mutex','java.lang.Object','keySet','gnu.trove.set.TLongSet','values','gnu.trove.TCharCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TLongCharMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TLongCharMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$J$C(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TLongCharMap(map);
}});
...
{
return this.m.putIfAbsent$J$C(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TLongCharProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TLongCharProcedure(procedure);
}});
...
{
return this.m.adjustValue$J$C(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$J$C$C', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$J$C$C(key, adjust_amount, put_amount);
}});
