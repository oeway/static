(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.SynchronizedSet','gnu.trove.impl.sync.TSynchronizedFloatCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedObjectFloatMap", null, null, ['gnu.trove.map.TObjectFloatMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TObjectFloatMap','mutex','java.lang.Object','keySet','java.util.Set','values','gnu.trove.TFloatCollection']]]
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TObjectFloatMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$TK$F(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TObjectFloatMap(map);
}});
...
{
return this.m.putIfAbsent$TK$F(key, value);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TObjectFloatProcedure(procedure);
}});
...
{
return this.m.adjustValue$TK$F(key, amount);
}});

Clazz.newMeth(C$, ['adjustOrPutValue$TK$F$F'], function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$TK$F$F(key, adjust_amount, put_amount);
}});
