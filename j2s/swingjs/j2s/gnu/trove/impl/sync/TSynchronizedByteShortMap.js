(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedByteSet','gnu.trove.impl.sync.TSynchronizedShortCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedByteShortMap", null, null, ['gnu.trove.map.TByteShortMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TByteShortMap','mutex','java.lang.Object','keySet','gnu.trove.set.TByteSet','values','gnu.trove.TShortCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteShortMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteShortMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$B$H(($b$[0] = key, $b$[0]), value);
}});
...
{
this.m.putAll$gnu_trove_map_TByteShortMap(map);
}});
...
{
return this.m.putIfAbsent$B$H(($b$[0] = key, $b$[0]), value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TByteShortProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TByteShortProcedure(procedure);
}});
...
{
return this.m.adjustValue$B$H(($b$[0] = key, $b$[0]), amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$B$H$H', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$B$H$H(($b$[0] = key, $b$[0]), adjust_amount, put_amount);
}});
