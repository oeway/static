(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedRandomAccessFloatList']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedFloatList", null, 'gnu.trove.impl.sync.TSynchronizedFloatCollection', 'gnu.trove.list.TFloatList');
...
;C$.superclazz.c$$gnu_trove_TFloatCollection$O.apply(this,[list, mutex]);C$.$init$.apply(this);
this.list=list;
}, 1);
...
Clazz.newMeth(C$, 'set$I$F', function (index, element) {
{
return this.list.set$I$F(index, element);
}});

Clazz.newMeth(C$, 'set$I$FA', function (offset, values) {
{
this.list.set$I$FA(offset, values);
}});

Clazz.newMeth(C$, 'set$I$FA$I$I', function (offset, values, valOffset, length) {
{
this.list.set$I$FA$I$I(offset, values, valOffset, length);
}});

Clazz.newMeth(C$, 'replace$I$F', function (offset, val) {
{
return this.list.replace$I$F(offset, val);
}});
...
{
this.list.fill$F(val);
}});

Clazz.newMeth(C$, 'fill$I$I$F', function (fromIndex, toIndex, val) {
{
this.list.fill$I$I$F(fromIndex, toIndex, val);
}});
...
{
this.list.transformValues$gnu_trove_function_TFloatFunction($function);
}});
