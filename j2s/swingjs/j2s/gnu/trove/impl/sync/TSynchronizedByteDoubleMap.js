(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedByteSet','gnu.trove.impl.sync.TSynchronizedDoubleCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedByteDoubleMap", null, null, ['gnu.trove.map.TByteDoubleMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TByteDoubleMap','mutex','java.lang.Object','keySet','gnu.trove.set.TByteSet','values','gnu.trove.TDoubleCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteDoubleMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteDoubleMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$B$D(($b$[0] = key, $b$[0]), value);
}});
...
{
this.m.putAll$gnu_trove_map_TByteDoubleMap(map);
}});
...
{
return this.m.putIfAbsent$B$D(($b$[0] = key, $b$[0]), value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TByteDoubleProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TByteDoubleProcedure(procedure);
}});
...
{
return this.m.adjustValue$B$D(($b$[0] = key, $b$[0]), amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$B$D$D', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$B$D$D(($b$[0] = key, $b$[0]), adjust_amount, put_amount);
}});
