(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedDoubleSet','gnu.trove.impl.sync.TSynchronizedLongCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedDoubleLongMap", null, null, ['gnu.trove.map.TDoubleLongMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TDoubleLongMap','mutex','java.lang.Object','keySet','gnu.trove.set.TDoubleSet','values','gnu.trove.TLongCollection']]]
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleLongMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$D$J(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TDoubleLongMap(map);
}});
...
{
return this.m.putIfAbsent$D$J(key, value);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TDoubleLongProcedure(procedure);
}});
...
{
return this.m.adjustValue$D$J(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$D$J$J', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$D$J$J(key, adjust_amount, put_amount);
}});
