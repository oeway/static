(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedFloatSet','gnu.trove.impl.sync.TSynchronizedLongCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedFloatLongMap", null, null, ['gnu.trove.map.TFloatLongMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TFloatLongMap','mutex','java.lang.Object','keySet','gnu.trove.set.TFloatSet','values','gnu.trove.TLongCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TFloatLongMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TFloatLongMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$F$J(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TFloatLongMap(map);
}});
...
{
return this.m.putIfAbsent$F$J(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TFloatLongProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TFloatLongProcedure(procedure);
}});
...
{
return this.m.adjustValue$F$J(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$F$J$J', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$F$J$J(key, adjust_amount, put_amount);
}});
