(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedDoubleSet','gnu.trove.impl.sync.TSynchronizedIntCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedDoubleIntMap", null, null, ['gnu.trove.map.TDoubleIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TDoubleIntMap','mutex','java.lang.Object','keySet','gnu.trove.set.TDoubleSet','values','gnu.trove.TIntCollection']]]
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleIntMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$D$I(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TDoubleIntMap(map);
}});
...
{
return this.m.putIfAbsent$D$I(key, value);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TDoubleIntProcedure(procedure);
}});
...
{
return this.m.adjustValue$D$I(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$D$I$I', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$D$I$I(key, adjust_amount, put_amount);
}});
