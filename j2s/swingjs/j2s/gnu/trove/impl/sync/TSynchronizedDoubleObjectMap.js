(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedDoubleSet','gnu.trove.impl.sync.SynchronizedCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedDoubleObjectMap", null, null, ['gnu.trove.map.TDoubleObjectMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TDoubleObjectMap','mutex','java.lang.Object','keySet','gnu.trove.set.TDoubleSet','values','java.util.Collection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleObjectMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleObjectMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$D$TV(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TDoubleObjectMap(map);
}});
...
{
return this.m.putIfAbsent$D$TV(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TDoubleObjectProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TDoubleObjectProcedure(procedure);
}});
