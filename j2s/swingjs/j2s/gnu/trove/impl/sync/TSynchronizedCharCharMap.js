(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedCharSet','gnu.trove.impl.sync.TSynchronizedCharCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedCharCharMap", null, null, ['gnu.trove.map.TCharCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TCharCharMap','mutex','java.lang.Object','keySet','gnu.trove.set.TCharSet','values','gnu.trove.TCharCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharCharMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharCharMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$C$C(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TCharCharMap(map);
}});
...
{
return this.m.putIfAbsent$C$C(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TCharCharProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TCharCharProcedure(procedure);
}});
...
{
return this.m.adjustValue$C$C(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$C$C$C', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$C$C$C(key, adjust_amount, put_amount);
}});
