(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedDoubleSet','gnu.trove.impl.sync.TSynchronizedShortCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedDoubleShortMap", null, null, ['gnu.trove.map.TDoubleShortMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TDoubleShortMap','mutex','java.lang.Object','keySet','gnu.trove.set.TDoubleSet','values','gnu.trove.TShortCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleShortMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleShortMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$D$H(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TDoubleShortMap(map);
}});
...
{
return this.m.putIfAbsent$D$H(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TDoubleShortProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TDoubleShortProcedure(procedure);
}});
...
{
return this.m.adjustValue$D$H(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$D$H$H', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$D$H$H(key, adjust_amount, put_amount);
}});
