(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedIntSet','gnu.trove.impl.sync.TSynchronizedDoubleCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedIntDoubleMap", null, null, ['gnu.trove.map.TIntDoubleMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TIntDoubleMap','mutex','java.lang.Object','keySet','gnu.trove.set.TIntSet','values','gnu.trove.TDoubleCollection']]]
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TIntDoubleMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$I$D(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TIntDoubleMap(map);
}});
...
{
return this.m.putIfAbsent$I$D(key, value);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TIntDoubleProcedure(procedure);
}});
...
{
return this.m.adjustValue$I$D(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$I$D$D', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$I$D$D(key, adjust_amount, put_amount);
}});
