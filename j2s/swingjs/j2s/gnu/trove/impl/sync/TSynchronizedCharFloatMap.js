(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedCharSet','gnu.trove.impl.sync.TSynchronizedFloatCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedCharFloatMap", null, null, ['gnu.trove.map.TCharFloatMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TCharFloatMap','mutex','java.lang.Object','keySet','gnu.trove.set.TCharSet','values','gnu.trove.TFloatCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharFloatMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharFloatMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$C$F(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TCharFloatMap(map);
}});
...
{
return this.m.putIfAbsent$C$F(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TCharFloatProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TCharFloatProcedure(procedure);
}});
...
{
return this.m.adjustValue$C$F(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$C$F$F', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$C$F$F(key, adjust_amount, put_amount);
}});
