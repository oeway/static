(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedIntSet','gnu.trove.impl.sync.TSynchronizedShortCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedIntShortMap", null, null, ['gnu.trove.map.TIntShortMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TIntShortMap','mutex','java.lang.Object','keySet','gnu.trove.set.TIntSet','values','gnu.trove.TShortCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TIntShortMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TIntShortMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$I$H(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TIntShortMap(map);
}});
...
{
return this.m.putIfAbsent$I$H(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TIntShortProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TIntShortProcedure(procedure);
}});
...
{
return this.m.adjustValue$I$H(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$I$H$H', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$I$H$H(key, adjust_amount, put_amount);
}});
