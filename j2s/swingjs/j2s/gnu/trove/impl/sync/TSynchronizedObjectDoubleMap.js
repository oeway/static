(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.SynchronizedSet','gnu.trove.impl.sync.TSynchronizedDoubleCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedObjectDoubleMap", null, null, ['gnu.trove.map.TObjectDoubleMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TObjectDoubleMap','mutex','java.lang.Object','keySet','java.util.Set','values','gnu.trove.TDoubleCollection']]]
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TObjectDoubleMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$TK$D(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TObjectDoubleMap(map);
}});
...
{
return this.m.putIfAbsent$TK$D(key, value);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TObjectDoubleProcedure(procedure);
}});
...
{
return this.m.adjustValue$TK$D(key, amount);
}});

Clazz.newMeth(C$, ['adjustOrPutValue$TK$D$D'], function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$TK$D$D(key, adjust_amount, put_amount);
}});
