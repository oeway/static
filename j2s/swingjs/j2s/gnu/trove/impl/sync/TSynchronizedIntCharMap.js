(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedIntSet','gnu.trove.impl.sync.TSynchronizedCharCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedIntCharMap", null, null, ['gnu.trove.map.TIntCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TIntCharMap','mutex','java.lang.Object','keySet','gnu.trove.set.TIntSet','values','gnu.trove.TCharCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TIntCharMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TIntCharMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
Clazz.newMeth(C$, 'put$I$C', function (key, value) {
{
return this.m.put$I$C(key, value);
}});
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TIntCharMap', function (map) {
{
this.m.putAll$gnu_trove_map_TIntCharMap(map);
}});
...
Clazz.newMeth(C$, 'putIfAbsent$I$C', function (key, value) {
{
return this.m.putIfAbsent$I$C(key, value);
}});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TIntCharProcedure', function (procedure) {
{
return this.m.forEachEntry$gnu_trove_procedure_TIntCharProcedure(procedure);
}});
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TIntCharProcedure', function (procedure) {
{
return this.m.retainEntries$gnu_trove_procedure_TIntCharProcedure(procedure);
}});
...
Clazz.newMeth(C$, 'adjustValue$I$C', function (key, amount) {
{
return this.m.adjustValue$I$C(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$I$C$C', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$I$C$C(key, adjust_amount, put_amount);
}});
