(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedLongSet','gnu.trove.impl.sync.TSynchronizedIntCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedLongIntMap", null, null, ['gnu.trove.map.TLongIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TLongIntMap','mutex','java.lang.Object','keySet','gnu.trove.set.TLongSet','values','gnu.trove.TIntCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TLongIntMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TLongIntMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$J$I(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TLongIntMap(map);
}});
...
{
return this.m.putIfAbsent$J$I(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TLongIntProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TLongIntProcedure(procedure);
}});
...
{
return this.m.adjustValue$J$I(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$J$I$I', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$J$I$I(key, adjust_amount, put_amount);
}});
