(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedByteSet','gnu.trove.impl.sync.TSynchronizedIntCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedByteIntMap", null, null, ['gnu.trove.map.TByteIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TByteIntMap','mutex','java.lang.Object','keySet','gnu.trove.set.TByteSet','values','gnu.trove.TIntCollection']]]
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteIntMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$B$I(($b$[0] = key, $b$[0]), value);
}});
...
{
this.m.putAll$gnu_trove_map_TByteIntMap(map);
}});
...
{
return this.m.putIfAbsent$B$I(($b$[0] = key, $b$[0]), value);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TByteIntProcedure(procedure);
}});
...
{
return this.m.adjustValue$B$I(($b$[0] = key, $b$[0]), amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$B$I$I', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$B$I$I(($b$[0] = key, $b$[0]), adjust_amount, put_amount);
}});
