(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedShortSet','gnu.trove.impl.sync.TSynchronizedLongCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedShortLongMap", null, null, ['gnu.trove.map.TShortLongMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TShortLongMap','mutex','java.lang.Object','keySet','gnu.trove.set.TShortSet','values','gnu.trove.TLongCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TShortLongMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TShortLongMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$H$J(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TShortLongMap(map);
}});
...
{
return this.m.putIfAbsent$H$J(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TShortLongProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TShortLongProcedure(procedure);
}});
...
{
return this.m.adjustValue$H$J(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$H$J$J', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$H$J$J(key, adjust_amount, put_amount);
}});
