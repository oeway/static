(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedCharSet','gnu.trove.impl.sync.TSynchronizedLongCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedCharLongMap", null, null, ['gnu.trove.map.TCharLongMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TCharLongMap','mutex','java.lang.Object','keySet','gnu.trove.set.TCharSet','values','gnu.trove.TLongCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharLongMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharLongMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$C$J(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TCharLongMap(map);
}});
...
{
return this.m.putIfAbsent$C$J(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TCharLongProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TCharLongProcedure(procedure);
}});
...
{
return this.m.adjustValue$C$J(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$C$J$J', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$C$J$J(key, adjust_amount, put_amount);
}});
