(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.TSynchronizedFloatSet','gnu.trove.impl.sync.TSynchronizedCharCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedFloatCharMap", null, null, ['gnu.trove.map.TFloatCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TFloatCharMap','mutex','java.lang.Object','keySet','gnu.trove.set.TFloatSet','values','gnu.trove.TCharCollection']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_TFloatCharMap', function (m) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TFloatCharMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$F$C(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TFloatCharMap(map);
}});
...
{
return this.m.putIfAbsent$F$C(key, value);
}});
...
{
return this.m.forEachEntry$gnu_trove_procedure_TFloatCharProcedure(procedure);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TFloatCharProcedure(procedure);
}});
...
{
return this.m.adjustValue$F$C(key, amount);
}});

Clazz.newMeth(C$, 'adjustOrPutValue$F$C$C', function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$F$C$C(key, adjust_amount, put_amount);
}});
