(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.SynchronizedSet','gnu.trove.impl.sync.TSynchronizedLongCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedObjectLongMap", null, null, ['gnu.trove.map.TObjectLongMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TObjectLongMap','mutex','java.lang.Object','keySet','java.util.Set','values','gnu.trove.TLongCollection']]]
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TObjectLongMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$TK$J(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TObjectLongMap(map);
}});
...
{
return this.m.putIfAbsent$TK$J(key, value);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TObjectLongProcedure(procedure);
}});
...
{
return this.m.adjustValue$TK$J(key, amount);
}});

Clazz.newMeth(C$, ['adjustOrPutValue$TK$J$J'], function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$TK$J$J(key, adjust_amount, put_amount);
}});
