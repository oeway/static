(function(){var P$=Clazz.newPackage("gnu.trove.impl.sync"),p$1={},I$=[[0,'gnu.trove.impl.sync.SynchronizedSet','gnu.trove.impl.sync.TSynchronizedIntCollection']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TSynchronizedObjectIntMap", null, null, ['gnu.trove.map.TObjectIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TObjectIntMap','mutex','java.lang.Object','keySet','java.util.Set','values','gnu.trove.TIntCollection']]]
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_TObjectIntMap$O', function (m, mutex) {
;C$.$init$.apply(this);
this.m=m;
this.mutex=mutex;
}, 1);
...
{
return this.m.put$TK$I(key, value);
}});
...
{
this.m.putAll$gnu_trove_map_TObjectIntMap(map);
}});
...
{
return this.m.putIfAbsent$TK$I(key, value);
}});
...
{
return this.m.retainEntries$gnu_trove_procedure_TObjectIntProcedure(procedure);
}});
...
{
return this.m.adjustValue$TK$I(key, amount);
}});

Clazz.newMeth(C$, ['adjustOrPutValue$TK$I$I'], function (key, adjust_amount, put_amount) {
{
return this.m.adjustOrPutValue$TK$I$I(key, adjust_amount, put_amount);
}});
