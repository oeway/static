...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatLongMap", null, null, ['gnu.trove.map.TFloatLongMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TFloatLongMap','keySet','gnu.trove.set.TFloatSet','values','gnu.trove.TLongCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TFloatLongMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableFloatLongMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatLongMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TFloatLongIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableFloatLongMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TFloatLongIterator']]]
...
), Clazz.new_(P$.TUnmodifiableFloatLongMap$1.$init$, [this, null]));
});
