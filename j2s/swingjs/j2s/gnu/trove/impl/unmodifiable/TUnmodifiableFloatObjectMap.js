...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatObjectMap", null, null, ['gnu.trove.map.TFloatObjectMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TFloatObjectMap','keySet','gnu.trove.set.TFloatSet','values','java.util.Collection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TFloatObjectMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableFloatObjectMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatObjectMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TFloatObjectIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableFloatObjectMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TFloatObjectIterator']]]
...
), Clazz.new_(P$.TUnmodifiableFloatObjectMap$1.$init$, [this, null]));
});
