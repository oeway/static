...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableIntCharMap", null, null, ['gnu.trove.map.TIntCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TIntCharMap','keySet','gnu.trove.set.TIntSet','values','gnu.trove.TCharCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TIntCharMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableIntCharMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableIntCharMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TIntCharIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableIntCharMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TIntCharIterator']]]
...
), Clazz.new_(P$.TUnmodifiableIntCharMap$1.$init$, [this, null]));
});
