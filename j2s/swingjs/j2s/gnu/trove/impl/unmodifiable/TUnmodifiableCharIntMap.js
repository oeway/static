...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableCharIntMap", null, null, ['gnu.trove.map.TCharIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TCharIntMap','keySet','gnu.trove.set.TCharSet','values','gnu.trove.TIntCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TCharIntMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableCharIntMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableCharIntMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TCharIntIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableCharIntMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TCharIntIterator']]]
...
), Clazz.new_(P$.TUnmodifiableCharIntMap$1.$init$, [this, null]));
});
