...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableShortLongMap", null, null, ['gnu.trove.map.TShortLongMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TShortLongMap','keySet','gnu.trove.set.TShortSet','values','gnu.trove.TLongCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortLongMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableShortLongMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableShortLongMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TShortLongIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableShortLongMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TShortLongIterator']]]
...
), Clazz.new_(P$.TUnmodifiableShortLongMap$1.$init$, [this, null]));
});
