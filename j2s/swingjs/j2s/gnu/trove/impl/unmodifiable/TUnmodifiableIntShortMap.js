...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableIntShortMap", null, null, ['gnu.trove.map.TIntShortMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TIntShortMap','keySet','gnu.trove.set.TIntSet','values','gnu.trove.TShortCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TIntShortMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableIntShortMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableIntShortMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TIntShortIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableIntShortMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TIntShortIterator']]]
...
), Clazz.new_(P$.TUnmodifiableIntShortMap$1.$init$, [this, null]));
});
