...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableDoubleShortMap", null, null, ['gnu.trove.map.TDoubleShortMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TDoubleShortMap','keySet','gnu.trove.set.TDoubleSet','values','gnu.trove.TShortCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TDoubleShortMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableDoubleShortMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableDoubleShortMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TDoubleShortIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableDoubleShortMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TDoubleShortIterator']]]
...
), Clazz.new_(P$.TUnmodifiableDoubleShortMap$1.$init$, [this, null]));
});
