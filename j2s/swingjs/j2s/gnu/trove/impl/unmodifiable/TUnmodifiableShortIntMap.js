...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableShortIntMap", null, null, ['gnu.trove.map.TShortIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TShortIntMap','keySet','gnu.trove.set.TShortSet','values','gnu.trove.TIntCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortIntMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableShortIntMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableShortIntMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TShortIntIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableShortIntMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TShortIntIterator']]]
...
), Clazz.new_(P$.TUnmodifiableShortIntMap$1.$init$, [this, null]));
});
