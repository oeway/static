...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableShortFloatMap", null, null, ['gnu.trove.map.TShortFloatMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TShortFloatMap','keySet','gnu.trove.set.TShortSet','values','gnu.trove.TFloatCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortFloatMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableShortFloatMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableShortFloatMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TShortFloatIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableShortFloatMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TShortFloatIterator']]]
...
), Clazz.new_(P$.TUnmodifiableShortFloatMap$1.$init$, [this, null]));
});
