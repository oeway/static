...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableShortShortMap", null, null, ['gnu.trove.map.TShortShortMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TShortShortMap','keySet','gnu.trove.set.TShortSet','values','gnu.trove.TShortCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortShortMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableShortShortMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableShortShortMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TShortShortIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableShortShortMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TShortShortIterator']]]
...
), Clazz.new_(P$.TUnmodifiableShortShortMap$1.$init$, [this, null]));
});
