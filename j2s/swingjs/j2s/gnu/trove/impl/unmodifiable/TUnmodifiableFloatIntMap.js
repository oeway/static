...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatIntMap", null, null, ['gnu.trove.map.TFloatIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TFloatIntMap','keySet','gnu.trove.set.TFloatSet','values','gnu.trove.TIntCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TFloatIntMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableFloatIntMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatIntMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TFloatIntIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableFloatIntMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TFloatIntIterator']]]
...
), Clazz.new_(P$.TUnmodifiableFloatIntMap$1.$init$, [this, null]));
});
