...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableDoubleObjectMap", null, null, ['gnu.trove.map.TDoubleObjectMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TDoubleObjectMap','keySet','gnu.trove.set.TDoubleSet','values','java.util.Collection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TDoubleObjectMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableDoubleObjectMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableDoubleObjectMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TDoubleObjectIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableDoubleObjectMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TDoubleObjectIterator']]]
...
), Clazz.new_(P$.TUnmodifiableDoubleObjectMap$1.$init$, [this, null]));
});
