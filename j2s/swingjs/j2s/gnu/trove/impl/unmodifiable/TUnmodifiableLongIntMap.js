...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableLongIntMap", null, null, ['gnu.trove.map.TLongIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TLongIntMap','keySet','gnu.trove.set.TLongSet','values','gnu.trove.TIntCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TLongIntMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableLongIntMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableLongIntMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TLongIntIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableLongIntMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TLongIntIterator']]]
...
), Clazz.new_(P$.TUnmodifiableLongIntMap$1.$init$, [this, null]));
});
