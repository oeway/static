...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableCharFloatMap", null, null, ['gnu.trove.map.TCharFloatMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TCharFloatMap','keySet','gnu.trove.set.TCharSet','values','gnu.trove.TFloatCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TCharFloatMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableCharFloatMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableCharFloatMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TCharFloatIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableCharFloatMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TCharFloatIterator']]]
...
), Clazz.new_(P$.TUnmodifiableCharFloatMap$1.$init$, [this, null]));
});
