...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableDoubleDoubleMap", null, null, ['gnu.trove.map.TDoubleDoubleMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TDoubleDoubleMap','keySet','gnu.trove.set.TDoubleSet','values','gnu.trove.TDoubleCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TDoubleDoubleMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableDoubleDoubleMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableDoubleDoubleMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TDoubleDoubleIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableDoubleDoubleMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TDoubleDoubleIterator']]]
...
), Clazz.new_(P$.TUnmodifiableDoubleDoubleMap$1.$init$, [this, null]));
});
