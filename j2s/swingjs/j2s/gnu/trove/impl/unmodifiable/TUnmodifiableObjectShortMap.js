...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableObjectShortMap", null, null, ['gnu.trove.map.TObjectShortMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TObjectShortMap','keySet','java.util.Set','values','gnu.trove.TShortCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TObjectShortMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
if (this.values == null ) this.values=$I$(2).unmodifiableCollection$gnu_trove_TShortCollection(this.m.valueCollection$());
return this.values;
});
...
return ((P$.TUnmodifiableObjectShortMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableObjectShortMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TObjectShortIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableObjectShortMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TObjectShortIterator']]]
...
), Clazz.new_(P$.TUnmodifiableObjectShortMap$1.$init$, [this, null]));
});
