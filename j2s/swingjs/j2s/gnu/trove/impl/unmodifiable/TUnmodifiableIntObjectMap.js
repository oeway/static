...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableIntObjectMap", null, null, ['gnu.trove.map.TIntObjectMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TIntObjectMap','keySet','gnu.trove.set.TIntSet','values','java.util.Collection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TIntObjectMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableIntObjectMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableIntObjectMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TIntObjectIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableIntObjectMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TIntObjectIterator']]]
...
), Clazz.new_(P$.TUnmodifiableIntObjectMap$1.$init$, [this, null]));
});
