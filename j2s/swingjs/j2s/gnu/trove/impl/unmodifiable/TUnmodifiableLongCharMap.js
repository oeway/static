...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableLongCharMap", null, null, ['gnu.trove.map.TLongCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TLongCharMap','keySet','gnu.trove.set.TLongSet','values','gnu.trove.TCharCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TLongCharMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableLongCharMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableLongCharMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TLongCharIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableLongCharMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TLongCharIterator']]]
...
), Clazz.new_(P$.TUnmodifiableLongCharMap$1.$init$, [this, null]));
});
