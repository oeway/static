...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableCharCharMap", null, null, ['gnu.trove.map.TCharCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TCharCharMap','keySet','gnu.trove.set.TCharSet','values','gnu.trove.TCharCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TCharCharMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableCharCharMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableCharCharMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TCharCharIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableCharCharMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TCharCharIterator']]]
...
), Clazz.new_(P$.TUnmodifiableCharCharMap$1.$init$, [this, null]));
});
