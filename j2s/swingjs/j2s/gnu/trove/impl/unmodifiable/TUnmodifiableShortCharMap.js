...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableShortCharMap", null, null, ['gnu.trove.map.TShortCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TShortCharMap','keySet','gnu.trove.set.TShortSet','values','gnu.trove.TCharCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortCharMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableShortCharMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableShortCharMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TShortCharIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableShortCharMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TShortCharIterator']]]
...
), Clazz.new_(P$.TUnmodifiableShortCharMap$1.$init$, [this, null]));
});
