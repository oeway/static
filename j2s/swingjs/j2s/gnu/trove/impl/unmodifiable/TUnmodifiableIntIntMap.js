...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableIntIntMap", null, null, ['gnu.trove.map.TIntIntMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TIntIntMap','keySet','gnu.trove.set.TIntSet','values','gnu.trove.TIntCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TIntIntMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableIntIntMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableIntIntMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TIntIntIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableIntIntMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TIntIntIterator']]]
...
), Clazz.new_(P$.TUnmodifiableIntIntMap$1.$init$, [this, null]));
});
