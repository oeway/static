...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatDoubleMap", null, null, ['gnu.trove.map.TFloatDoubleMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TFloatDoubleMap','keySet','gnu.trove.set.TFloatSet','values','gnu.trove.TDoubleCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TFloatDoubleMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableFloatDoubleMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatDoubleMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TFloatDoubleIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableFloatDoubleMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TFloatDoubleIterator']]]
...
), Clazz.new_(P$.TUnmodifiableFloatDoubleMap$1.$init$, [this, null]));
});
