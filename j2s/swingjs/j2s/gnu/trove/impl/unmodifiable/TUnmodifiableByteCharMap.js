...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableByteCharMap", null, null, ['gnu.trove.map.TByteCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TByteCharMap','keySet','gnu.trove.set.TByteSet','values','gnu.trove.TCharCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TByteCharMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableByteCharMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableByteCharMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TByteCharIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableByteCharMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TByteCharIterator']]]
...
), Clazz.new_(P$.TUnmodifiableByteCharMap$1.$init$, [this, null]));
});
