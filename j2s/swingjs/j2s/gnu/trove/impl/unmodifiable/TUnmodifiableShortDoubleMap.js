...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableShortDoubleMap", null, null, ['gnu.trove.map.TShortDoubleMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TShortDoubleMap','keySet','gnu.trove.set.TShortSet','values','gnu.trove.TDoubleCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortDoubleMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableShortDoubleMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableShortDoubleMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TShortDoubleIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableShortDoubleMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TShortDoubleIterator']]]
...
), Clazz.new_(P$.TUnmodifiableShortDoubleMap$1.$init$, [this, null]));
});
