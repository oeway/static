...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableCharLongMap", null, null, ['gnu.trove.map.TCharLongMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TCharLongMap','keySet','gnu.trove.set.TCharSet','values','gnu.trove.TLongCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TCharLongMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableCharLongMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableCharLongMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TCharLongIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableCharLongMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TCharLongIterator']]]
...
), Clazz.new_(P$.TUnmodifiableCharLongMap$1.$init$, [this, null]));
});
