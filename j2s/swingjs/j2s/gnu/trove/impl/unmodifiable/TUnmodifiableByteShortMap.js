...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableByteShortMap", null, null, ['gnu.trove.map.TByteShortMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TByteShortMap','keySet','gnu.trove.set.TByteSet','values','gnu.trove.TShortCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TByteShortMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableByteShortMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableByteShortMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TByteShortIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableByteShortMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TByteShortIterator']]]
...
), Clazz.new_(P$.TUnmodifiableByteShortMap$1.$init$, [this, null]));
});
