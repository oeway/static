...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatCharMap", null, null, ['gnu.trove.map.TFloatCharMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TFloatCharMap','keySet','gnu.trove.set.TFloatSet','values','gnu.trove.TCharCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TFloatCharMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableFloatCharMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableFloatCharMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TFloatCharIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableFloatCharMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TFloatCharIterator']]]
...
), Clazz.new_(P$.TUnmodifiableFloatCharMap$1.$init$, [this, null]));
});
