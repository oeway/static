...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableLongDoubleMap", null, null, ['gnu.trove.map.TLongDoubleMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TLongDoubleMap','keySet','gnu.trove.set.TLongSet','values','gnu.trove.TDoubleCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TLongDoubleMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableLongDoubleMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableLongDoubleMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TLongDoubleIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableLongDoubleMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TLongDoubleIterator']]]
...
), Clazz.new_(P$.TUnmodifiableLongDoubleMap$1.$init$, [this, null]));
});
