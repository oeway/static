...
/*c*/var C$=Clazz.newClass(P$, "TUnmodifiableIntFloatMap", null, null, ['gnu.trove.map.TIntFloatMap', 'java.io.Serializable']);
...
C$.$fields$=[['O',['m','gnu.trove.map.TIntFloatMap','keySet','gnu.trove.set.TIntSet','values','gnu.trove.TFloatCollection']]]
...
Clazz.newMeth(C$, 'putAll$gnu_trove_map_TIntFloatMap', function (m) {
throw Clazz.new_(Clazz.load('UnsupportedOperationException'));
});
...
return ((P$.TUnmodifiableIntFloatMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TUnmodifiableIntFloatMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TIntFloatIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.iter=this.b$['gnu.trove.impl.unmodifiable.TUnmodifiableIntFloatMap'].m.iterator$();
}, 1);

C$.$fields$=[['O',['iter','gnu.trove.iterator.TIntFloatIterator']]]
...
), Clazz.new_(P$.TUnmodifiableIntFloatMap$1.$init$, [this, null]));
});
