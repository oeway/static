...
/*c*/var C$=Clazz.newClass(P$, "TIntDoubleHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'D',['no_entry_value'],'I',['no_entry_key'],'O',['_set','int[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$I$D', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
