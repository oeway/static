...
/*c*/var C$=Clazz.newClass(P$, "TByteIntHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'B',['no_entry_key'],'I',['no_entry_value'],'O',['_set','byte[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$B$I', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
