...
/*c*/var C$=Clazz.newClass(P$, "TCharIntHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'C',['no_entry_key'],'I',['no_entry_value'],'O',['_set','char[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$C$I', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
