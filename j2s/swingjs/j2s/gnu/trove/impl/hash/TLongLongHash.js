...
/*c*/var C$=Clazz.newClass(P$, "TLongLongHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'L',['no_entry_key','no_entry_value'],'O',['_set','long[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$J$J', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
