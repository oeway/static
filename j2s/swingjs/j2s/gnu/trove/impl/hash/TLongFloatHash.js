...
/*c*/var C$=Clazz.newClass(P$, "TLongFloatHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'F',['no_entry_value'],'L',['no_entry_key'],'O',['_set','long[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$J$F', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
