...
/*c*/var C$=Clazz.newClass(P$, "TDoubleFloatHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'D',['no_entry_key'],'F',['no_entry_value'],'O',['_set','double[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$D$F', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
