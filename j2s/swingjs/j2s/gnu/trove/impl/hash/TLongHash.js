...
/*c*/var C$=Clazz.newClass(P$, "TLongHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'L',['no_entry_value'],'O',['_set','long[]']]]

Clazz.newMeth(C$, 'c$', function () {
;C$.superclazz.c$.apply(this,[]);C$.$init$.apply(this);
this.no_entry_value=$I$(1).DEFAULT_LONG_NO_ENTRY_VALUE;
if (this.no_entry_value != 0) {
$I$(2).fill$JA$J(this._set, this.no_entry_value);
}}, 1);
...
Clazz.newMeth(C$, 'c$$I$F$J', function (initialCapacity, loadFactor, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
this.no_entry_value=no_entry_value;
if (no_entry_value != 0) {
$I$(2).fill$JA$J(this._set, no_entry_value);
}}, 1);
...
Clazz.newMeth(C$, 'index$J', function (val) {
var hash;
var probe;
var index;
var length;
...
hash=$I$(3).hash$J(val) & 2147483647;
index=hash % length;
var state=($b$[0] = states[index], $b$[0]);
if (state == 0) return -1;
if (state == 1 && set[index] == val ) return index;
return this.indexRehashed$J$I$I$B(val, index, hash, ($b$[0] = state, $b$[0]));
});
