...
/*c*/var C$=Clazz.newClass(P$, "TIntHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'I',['no_entry_value'],'O',['_set','int[]']]]

Clazz.newMeth(C$, 'c$', function () {
;C$.superclazz.c$.apply(this,[]);C$.$init$.apply(this);
this.no_entry_value=$I$(1).DEFAULT_INT_NO_ENTRY_VALUE;
if (this.no_entry_value != 0) {
$I$(2).fill$IA$I(this._set, this.no_entry_value);
}}, 1);
...
Clazz.newMeth(C$, 'c$$I$F$I', function (initialCapacity, loadFactor, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
this.no_entry_value=no_entry_value;
if (no_entry_value != 0) {
$I$(2).fill$IA$I(this._set, no_entry_value);
}}, 1);
...
this._set=Clazz.array(Integer.TYPE, [capacity]);
return capacity;
});

Clazz.newMeth(C$, 'contains$I', function (val) {
return this.index$I(val) >= 0;
});
...
Clazz.newMeth(C$, 'index$I', function (val) {
var hash;
var probe;
var index;
var length;
...
return this.indexRehashed$I$I$I$B(val, index, hash, ($b$[0] = state, $b$[0]));
});

Clazz.newMeth(C$, 'indexRehashed$I$I$I$B', function (key, index, hash, state) {
...
Clazz.newMeth(C$, 'insertKey$I', function (val) {
var hash;
var index;
hash=$I$(3).hash$I(val) & 2147483647;
...
this.insertKeyAt$I$I(index, val);
return index;
}if (state == 1 && this._set[index] == val ) {
return -index - 1;
}return this.insertKeyRehash$I$I$I$B(val, index, hash, ($b$[0] = state, $b$[0]));
});

Clazz.newMeth(C$, 'insertKeyRehash$I$I$I$B', function (val, index, hash, state) {
var length=this._set.length;
var probe=1 + (hash % (length - 2));
var loopIndex=index;
var firstRemoved=-1;
...
if (state == 0) {
if (firstRemoved != -1) {
this.insertKeyAt$I$I(firstRemoved, val);
return firstRemoved;
} else {
this.consumeFreeSlot=true;
this.insertKeyAt$I$I(index, val);
...
Clazz.newMeth(C$, 'insertKeyAt$I$I', function (index, val) {
this._set[index]=val;
