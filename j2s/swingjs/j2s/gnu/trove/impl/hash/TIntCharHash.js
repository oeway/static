...
/*c*/var C$=Clazz.newClass(P$, "TIntCharHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'C',['no_entry_value'],'I',['no_entry_key'],'O',['_set','int[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$I$C', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
