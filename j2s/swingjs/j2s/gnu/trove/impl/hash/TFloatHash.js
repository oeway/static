...
/*c*/var C$=Clazz.newClass(P$, "TFloatHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'F',['no_entry_value'],'O',['_set','float[]']]]

Clazz.newMeth(C$, 'c$', function () {
;C$.superclazz.c$.apply(this,[]);C$.$init$.apply(this);
this.no_entry_value=$I$(1).DEFAULT_FLOAT_NO_ENTRY_VALUE;
if (this.no_entry_value != 0.0 ) {
$I$(2).fill$FA$F(this._set, this.no_entry_value);
}}, 1);
...
Clazz.newMeth(C$, 'c$$I$F$F', function (initialCapacity, loadFactor, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
this.no_entry_value=no_entry_value;
if (no_entry_value != 0.0 ) {
$I$(2).fill$FA$F(this._set, no_entry_value);
}}, 1);
...
Clazz.newMeth(C$, 'index$F', function (val) {
var hash;
var probe;
var index;
var length;
...
hash=$I$(3).hash$F(val) & 2147483647;
index=hash % length;
var state=($b$[0] = states[index], $b$[0]);
if (state == 0) return -1;
if (state == 1 && set[index] == val  ) return index;
return this.indexRehashed$F$I$I$B(val, index, hash, ($b$[0] = state, $b$[0]));
});
