...
/*c*/var C$=Clazz.newClass(P$, "TIntLongHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'I',['no_entry_key'],'L',['no_entry_value'],'O',['_set','int[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$I$J', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
