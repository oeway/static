...
/*c*/var C$=Clazz.newClass(P$, "TDoubleByteHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'B',['no_entry_value'],'D',['no_entry_key'],'O',['_set','double[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$D$B', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
