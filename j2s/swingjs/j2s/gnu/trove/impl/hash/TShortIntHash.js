...
/*c*/var C$=Clazz.newClass(P$, "TShortIntHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'I',['no_entry_value'],'H',['no_entry_key'],'O',['_set','short[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$H$I', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
