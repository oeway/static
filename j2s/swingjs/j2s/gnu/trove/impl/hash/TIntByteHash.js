...
/*c*/var C$=Clazz.newClass(P$, "TIntByteHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'B',['no_entry_value'],'I',['no_entry_key'],'O',['_set','int[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$I$B', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'index$I', function (key) {
var hash;
var probe;
var index;
var length;
...
return this.indexRehashed$I$I$I$B(key, index, hash, ($b$[0] = state, $b$[0]));
});
...
Clazz.newMeth(C$, 'XinsertKey$I', function (key) {
var hash;
var probe;
var index;
var length;
