...
/*c*/var C$=Clazz.newClass(P$, "TFloatFloatHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'F',['no_entry_key','no_entry_value'],'O',['_set','float[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$F$F', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
