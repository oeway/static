...
/*c*/var C$=Clazz.newClass(P$, "TFloatCharHash", null, 'gnu.trove.impl.hash.TPrimitiveHash');
...
C$.$fields$=[['Z',['consumeFreeSlot'],'C',['no_entry_value'],'F',['no_entry_key'],'O',['_set','float[]']]]
...
Clazz.newMeth(C$, 'c$$I$F$F$C', function (initialCapacity, loadFactor, no_entry_key, no_entry_value) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
