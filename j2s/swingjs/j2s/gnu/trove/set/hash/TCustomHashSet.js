(function(){var P$=Clazz.newPackage("gnu.trove.set.hash"),I$=[[0,'gnu.trove.impl.HashFunctions',['gnu.trove.set.hash.TCustomHashSet','.HashProcedure'],'java.util.Arrays','gnu.trove.impl.hash.TObjectHash','gnu.trove.procedure.array.ToObjectArrayProceedure','java.lang.reflect.Array','gnu.trove.iterator.hash.TObjectHashIterator','StringBuilder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TCustomHashSet", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCustomObjectHash', ['java.util.Set', 'Iterable', 'java.io.Externalizable']);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$java_util_Collection', function (strategy, collection) {
C$.c$$gnu_trove_strategy_HashingStrategy$I.apply(this, [strategy, collection.size$()]);
...
this.forEach$gnu_trove_procedure_TObjectProcedure(((P$.TCustomHashSet$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCustomHashSet$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectProcedure', 1);
...
), Clazz.new_(P$.TCustomHashSet$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCustomHashSet, "HashProcedure", function(){
