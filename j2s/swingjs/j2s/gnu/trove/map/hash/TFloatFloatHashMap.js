(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TFloatFloatHashMap','.TFloatFloatKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TFloatFloatHashMap','.TFloatFloatValueHashIterator'],['gnu.trove.map.hash.TFloatFloatHashMap','.TKeyView'],['gnu.trove.map.hash.TFloatFloatHashMap','.TValueView'],['gnu.trove.map.hash.TFloatFloatHashMap','.TFloatFloatHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TFloatFloatHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TFloatFloatHash', ['gnu.trove.map.TFloatFloatMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TFloatFloatKeyHashIterator',0],['TFloatFloatValueHashIterator',0],['TFloatFloatHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$F$F', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$F$F.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$FA$FA', function (keys, values) {
...
this.put$F$F(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TFloatFloatMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TFloatFloatHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TFloatFloatMap(map);
}, 1);
...
return p$1.doPut$F$F$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$F$F$I', function (key, value, index) {
...
this.put$F$F(entry.getKey$().floatValue$(), entry.getValue$().floatValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$F$F(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TFloatFloatHashMap, [this, null, this]);
});
...
return this.adjustValue$F$F(key, 1.0);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TFloatFloatMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$F(this._set[i]) ^ $I$(3).hash$F(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TFloatFloatProcedure(((P$.TFloatFloatHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatFloatHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatFloatProcedure', 1);
...
Clazz.newMeth(C$, ['execute$F$F','execute$'], function (key, value) {
...
), Clazz.new_(P$.TFloatFloatHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$F$F(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatFloatHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TFloatFloatHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatFloatHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TFloatFloatHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatFloatHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TFloatFloatHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatFloatHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TFloatFloatHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatFloatHashMap, "TFloatFloatKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatFloatHashMap, "TFloatFloatValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TFloatIterator');
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatFloatHashMap, "TFloatFloatHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TFloatFloatIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TFloatFloatHashMap', function (map) {
