(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TCharCharHashMap','.TCharCharKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TCharCharHashMap','.TCharCharValueHashIterator'],['gnu.trove.map.hash.TCharCharHashMap','.TKeyView'],['gnu.trove.map.hash.TCharCharHashMap','.TValueView'],['gnu.trove.map.hash.TCharCharHashMap','.TCharCharHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TCharCharHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCharCharHash', ['gnu.trove.map.TCharCharMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TCharCharKeyHashIterator',0],['TCharCharValueHashIterator',0],['TCharCharHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$C$C', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$C$C.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$CA$CA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TCharCharMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$C$C', function (key, value) {
var index=this.insertKey$C(key);
return p$1.doPut$C$C$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$C$C', function (key, value) {
var index=this.insertKey$C(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$C$C$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$C$C$I', function (key, value, index) {
...
this.put$C$C(entry.getKey$().charValue$(), entry.getValue$().charValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TCharCharMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$C$C(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TCharCharHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TCharCharProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TCharCharProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$C$C(key, "\u0001");
});

Clazz.newMeth(C$, 'adjustValue$C$C', function (key, amount) {
var index=this.index$C(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$C$C$C', function (key, adjust_amount, put_amount) {
var index=this.insertKey$C(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TCharCharMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$I(this._set[i].$c()) ^ $I$(3).hash$I(this._values[i].$c());
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TCharCharProcedure(((P$.TCharCharHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharCharHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharCharProcedure', 1);
...
Clazz.newMeth(C$, ['execute$C$C','execute$'], function (key, value) {
...
), Clazz.new_(P$.TCharCharHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var key=$in.readChar$();
var val=$in.readChar$();
this.put$C$C(key, val);
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharCharHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TCharCharHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharCharHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TCharCharHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharCharHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TCharCharHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharCharHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TCharCharHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharCharHashMap, "TCharCharKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharCharHashMap, "TCharCharValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TCharIterator');
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharCharHashMap, "TCharCharHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TCharCharIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TCharCharHashMap', function (map) {
