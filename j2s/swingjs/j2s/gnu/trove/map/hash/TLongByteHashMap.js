(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TLongByteHashMap','.TLongByteKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TLongByteHashMap','.TLongByteValueHashIterator'],['gnu.trove.map.hash.TLongByteHashMap','.TKeyView'],['gnu.trove.map.hash.TLongByteHashMap','.TValueView'],['gnu.trove.map.hash.TLongByteHashMap','.TLongByteHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TLongByteHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TLongByteHash', ['gnu.trove.map.TLongByteMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TLongByteKeyHashIterator',0],['TLongByteValueHashIterator',0],['TLongByteHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$J$B', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$J$B.apply(this,[initialCapacity, loadFactor, noEntryKey, ($b$[0] = noEntryValue, $b$[0])]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$JA$BA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TLongByteMap(map);
}, 1);
...
return $b$[0] = p$1.doPut$J$B$I.apply(this, [key, (value|0), index]), $b$[0];
});
...
Clazz.newMeth(C$, 'doPut$J$B$I', function (key, value, index) {
...
this.put$J$B(entry.getKey$().longValue$(), ($b$[0] = entry.getValue$().byteValue$(), $b$[0]));
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$J$B(iter.key$(), ($b$[0] = iter.value$(), $b$[0]));
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TLongByteHashMap, [this, null, this]);
});
...
return this.adjustValue$J$B(key, ($b$[0] = 1, $b$[0]));
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TLongByteMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
var key=this._set[i];
var that_value=($b$[0] = that.get$J(key), $b$[0]);
...
this.forEachEntry$gnu_trove_procedure_TLongByteProcedure(((P$.TLongByteHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongByteHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongByteProcedure', 1);
...
Clazz.newMeth(C$, ['execute$J$B','execute$'], function (key, value) {
...
), Clazz.new_(P$.TLongByteHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$J$B(key, ($b$[0] = val, $b$[0]));
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongByteHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TLongByteHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongByteHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TLongByteHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongByteHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TLongByteHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongByteHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TLongByteHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongByteHashMap, "TLongByteKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongByteHashMap, "TLongByteValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongByteHashMap, "TLongByteHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TLongByteIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TLongByteHashMap', function (map) {
