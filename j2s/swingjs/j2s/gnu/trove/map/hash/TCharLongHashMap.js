(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TCharLongHashMap','.TCharLongKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TCharLongHashMap','.TCharLongValueHashIterator'],['gnu.trove.map.hash.TCharLongHashMap','.TKeyView'],['gnu.trove.map.hash.TCharLongHashMap','.TValueView'],['gnu.trove.map.hash.TCharLongHashMap','.TCharLongHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TCharLongHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCharLongHash', ['gnu.trove.map.TCharLongMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TCharLongKeyHashIterator',0],['TCharLongValueHashIterator',0],['TCharLongHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$C$J', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$C$J.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$CA$JA', function (keys, values) {
...
this.put$C$J(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharLongMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TCharLongHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TCharLongMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$C$J', function (key, value) {
var index=this.insertKey$C(key);
return p$1.doPut$C$J$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$C$J', function (key, value) {
var index=this.insertKey$C(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$C$J$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$C$J$I', function (key, value, index) {
...
this.put$C$J(entry.getKey$().charValue$(), entry.getValue$().longValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TCharLongMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$C$J(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TCharLongHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TCharLongProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TCharLongProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$C$J(key, 1);
});

Clazz.newMeth(C$, 'adjustValue$C$J', function (key, amount) {
var index=this.index$C(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$C$J$J', function (key, adjust_amount, put_amount) {
var index=this.insertKey$C(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TCharLongMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$I(this._set[i].$c()) ^ $I$(3).hash$J(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TCharLongProcedure(((P$.TCharLongHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharLongHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharLongProcedure', 1);
...
Clazz.newMeth(C$, ['execute$C$J','execute$'], function (key, value) {
...
), Clazz.new_(P$.TCharLongHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var key=$in.readChar$();
var val=$in.readLong$();
this.put$C$J(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharLongHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TCharLongHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharLongHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TCharLongHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharLongHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TCharLongHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharLongHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TCharLongHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharLongHashMap, "TCharLongKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharLongHashMap, "TCharLongValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharLongHashMap, "TCharLongHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TCharLongIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TCharLongHashMap', function (map) {
