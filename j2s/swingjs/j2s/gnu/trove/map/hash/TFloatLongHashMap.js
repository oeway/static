(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TFloatLongHashMap','.TFloatLongKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TFloatLongHashMap','.TFloatLongValueHashIterator'],['gnu.trove.map.hash.TFloatLongHashMap','.TKeyView'],['gnu.trove.map.hash.TFloatLongHashMap','.TValueView'],['gnu.trove.map.hash.TFloatLongHashMap','.TFloatLongHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TFloatLongHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TFloatLongHash', ['gnu.trove.map.TFloatLongMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TFloatLongKeyHashIterator',0],['TFloatLongValueHashIterator',0],['TFloatLongHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$F$J', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$F$J.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$FA$JA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TFloatLongMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$F$J', function (key, value) {
var index=this.insertKey$F(key);
return p$1.doPut$F$J$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$F$J', function (key, value) {
var index=this.insertKey$F(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$F$J$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$F$J$I', function (key, value, index) {
...
this.put$F$J(entry.getKey$().floatValue$(), entry.getValue$().longValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TFloatLongMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$F$J(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TFloatLongHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TFloatLongProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TFloatLongProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$F$J(key, 1);
});

Clazz.newMeth(C$, 'adjustValue$F$J', function (key, amount) {
var index=this.index$F(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$F$J$J', function (key, adjust_amount, put_amount) {
var index=this.insertKey$F(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TFloatLongMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$F(this._set[i]) ^ $I$(3).hash$J(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TFloatLongProcedure(((P$.TFloatLongHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatLongHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatLongProcedure', 1);
...
Clazz.newMeth(C$, ['execute$F$J','execute$'], function (key, value) {
...
), Clazz.new_(P$.TFloatLongHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var val=$in.readLong$();
this.put$F$J(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatLongHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TFloatLongHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatLongHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TFloatLongHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatLongHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TFloatLongHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatLongHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TFloatLongHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatLongHashMap, "TFloatLongKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatLongHashMap, "TFloatLongValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatLongHashMap, "TFloatLongHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TFloatLongIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TFloatLongHashMap', function (map) {
