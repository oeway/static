(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TCharFloatHashMap','.TCharFloatKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TCharFloatHashMap','.TCharFloatValueHashIterator'],['gnu.trove.map.hash.TCharFloatHashMap','.TKeyView'],['gnu.trove.map.hash.TCharFloatHashMap','.TValueView'],['gnu.trove.map.hash.TCharFloatHashMap','.TCharFloatHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TCharFloatHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCharFloatHash', ['gnu.trove.map.TCharFloatMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TCharFloatKeyHashIterator',0],['TCharFloatValueHashIterator',0],['TCharFloatHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$C$F', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$C$F.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$CA$FA', function (keys, values) {
...
this.put$C$F(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharFloatMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TCharFloatHashMap")) {
var hashmap=map;
this._loadFactor=hashmap._loadFactor;
this.no_entry_key=hashmap.no_entry_key;
this.no_entry_value=hashmap.no_entry_value;
if (this.no_entry_key != "\u0000") {
$I$(2).fill$CA$C(this._set, this.no_entry_key);
}if (this.no_entry_value != 0.0 ) {
$I$(2).fill$FA$F(this._values, this.no_entry_value);
}this.setUp$I((Math.ceil(10 / this._loadFactor)|0));
}this.putAll$gnu_trove_map_TCharFloatMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$C$F', function (key, value) {
var index=this.insertKey$C(key);
return p$1.doPut$C$F$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$C$F', function (key, value) {
var index=this.insertKey$C(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$C$F$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$C$F$I', function (key, value, index) {
...
this.put$C$F(entry.getKey$().charValue$(), entry.getValue$().floatValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TCharFloatMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$C$F(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TCharFloatHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TCharFloatProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TCharFloatProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$C$F(key, 1.0);
});

Clazz.newMeth(C$, 'adjustValue$C$F', function (key, amount) {
var index=this.index$C(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$C$F$F', function (key, adjust_amount, put_amount) {
var index=this.insertKey$C(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TCharFloatMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$I(this._set[i].$c()) ^ $I$(3).hash$F(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TCharFloatProcedure(((P$.TCharFloatHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharFloatHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharFloatProcedure', 1);
...
Clazz.newMeth(C$, ['execute$C$F','execute$'], function (key, value) {
...
), Clazz.new_(P$.TCharFloatHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$C$F(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharFloatHashMap, "TKeyView", function(){
...
return this.this$0.contains$C.apply(this.this$0, [entry]);
});
...
return this.this$0.keys$CA.apply(this.this$0, [dest]);
});
...
return this.this$0.no_entry_value != this.this$0.remove$C.apply(this.this$0, [entry]) ;
});
...
if (!this.this$0.containsKey$C.apply(this.this$0, [ele])) {
return false;
}} else {
return false;
}}
...
while (iter.hasNext$()){
if (!this.this$0.containsKey$C.apply(this.this$0, [iter.next$()])) {
return false;
}}
return true;
});
...
if (!this.this$0.contains$C.apply(this.this$0, [element])) {
return false;
}}
return true;
});
...
return this.this$0.forEachKey$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [procedure]);
});
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TCharFloatHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharFloatHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
Clazz.newMeth(C$, ['execute$C','execute$'], function (key) {
if (this.first) {
this.first=false;
} else {
this.$finals$.buf.append$S(", ");
...
), Clazz.new_(P$.TCharFloatHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharFloatHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
var set=this.this$0._set;
for (var i=values.length; i-- > 0; ) {
if (((set[i]).$c() != 0  && (set[i]).$c() != 2  ) && entry == values[i]  ) {
this.this$0.removeAt$I.apply(this.this$0, [i]);
return true;
}}
return false;
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TCharFloatHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharFloatHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TCharFloatHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharFloatHashMap, "TCharFloatKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharFloatHashMap, "TCharFloatValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharFloatHashMap, "TCharFloatHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TCharFloatIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TCharFloatHashMap', function (map) {
