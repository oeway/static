(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TLongDoubleHashMap','.TLongDoubleKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TLongDoubleHashMap','.TLongDoubleValueHashIterator'],['gnu.trove.map.hash.TLongDoubleHashMap','.TKeyView'],['gnu.trove.map.hash.TLongDoubleHashMap','.TValueView'],['gnu.trove.map.hash.TLongDoubleHashMap','.TLongDoubleHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TLongDoubleHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TLongDoubleHash', ['gnu.trove.map.TLongDoubleMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TLongDoubleKeyHashIterator',0],['TLongDoubleValueHashIterator',0],['TLongDoubleHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$J$D', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$J$D.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$JA$DA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TLongDoubleMap(map);
}, 1);
...
return p$1.doPut$J$D$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$J$D$I', function (key, value, index) {
...
this.put$J$D(entry.getKey$().longValue$(), entry.getValue$().doubleValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$J$D(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TLongDoubleHashMap, [this, null, this]);
});
...
return this.adjustValue$J$D(key, 1.0);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TLongDoubleMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$J(this._set[i]) ^ $I$(3).hash$D(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TLongDoubleProcedure(((P$.TLongDoubleHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongDoubleHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongDoubleProcedure', 1);
...
Clazz.newMeth(C$, ['execute$J$D','execute$'], function (key, value) {
...
), Clazz.new_(P$.TLongDoubleHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$J$D(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongDoubleHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TLongDoubleHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongDoubleHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TLongDoubleHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongDoubleHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TLongDoubleHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongDoubleHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TLongDoubleHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongDoubleHashMap, "TLongDoubleKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongDoubleHashMap, "TLongDoubleValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongDoubleHashMap, "TLongDoubleHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TLongDoubleIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TLongDoubleHashMap', function (map) {
