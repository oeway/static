(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TShortByteHashMap','.TShortByteKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TShortByteHashMap','.TShortByteValueHashIterator'],['gnu.trove.map.hash.TShortByteHashMap','.TKeyView'],['gnu.trove.map.hash.TShortByteHashMap','.TValueView'],['gnu.trove.map.hash.TShortByteHashMap','.TShortByteHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TShortByteHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TShortByteHash', ['gnu.trove.map.TShortByteMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TShortByteKeyHashIterator',0],['TShortByteValueHashIterator',0],['TShortByteHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$H$B', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$H$B.apply(this,[initialCapacity, loadFactor, noEntryKey, ($b$[0] = noEntryValue, $b$[0])]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$HA$BA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TShortByteMap(map);
}, 1);
...
return $b$[0] = p$1.doPut$H$B$I.apply(this, [key, (value|0), index]), $b$[0];
});
...
Clazz.newMeth(C$, 'doPut$H$B$I', function (key, value, index) {
...
this.put$H$B(entry.getKey$().shortValue$(), ($b$[0] = entry.getValue$().byteValue$(), $b$[0]));
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$H$B(iter.key$(), ($b$[0] = iter.value$(), $b$[0]));
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TShortByteHashMap, [this, null, this]);
});
...
return this.adjustValue$H$B(key, ($b$[0] = 1, $b$[0]));
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TShortByteMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
var key=this._set[i];
var that_value=($b$[0] = that.get$H(key), $b$[0]);
...
this.forEachEntry$gnu_trove_procedure_TShortByteProcedure(((P$.TShortByteHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortByteHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortByteProcedure', 1);
...
Clazz.newMeth(C$, ['execute$H$B','execute$'], function (key, value) {
...
), Clazz.new_(P$.TShortByteHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$H$B(key, ($b$[0] = val, $b$[0]));
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortByteHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TShortByteHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortByteHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TShortByteHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortByteHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TShortByteHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortByteHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TShortByteHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortByteHashMap, "TShortByteKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortByteHashMap, "TShortByteValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortByteHashMap, "TShortByteHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TShortByteIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TShortByteHashMap', function (map) {
