(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TDoubleDoubleHashMap','.TDoubleDoubleKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TDoubleDoubleHashMap','.TDoubleDoubleValueHashIterator'],['gnu.trove.map.hash.TDoubleDoubleHashMap','.TKeyView'],['gnu.trove.map.hash.TDoubleDoubleHashMap','.TValueView'],['gnu.trove.map.hash.TDoubleDoubleHashMap','.TDoubleDoubleHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TDoubleDoubleHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TDoubleDoubleHash', ['gnu.trove.map.TDoubleDoubleMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TDoubleDoubleKeyHashIterator',0],['TDoubleDoubleValueHashIterator',0],['TDoubleDoubleHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$D$D', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$D$D.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$DA$DA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TDoubleDoubleMap(map);
}, 1);
...
return p$1.doPut$D$D$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$D$D$I', function (key, value, index) {
...
this.put$D$D(entry.getKey$().doubleValue$(), entry.getValue$().doubleValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$D$D(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TDoubleDoubleHashMap, [this, null, this]);
});
...
return this.adjustValue$D$D(key, 1.0);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TDoubleDoubleMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$D(this._set[i]) ^ $I$(3).hash$D(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TDoubleDoubleProcedure(((P$.TDoubleDoubleHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleDoubleHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleDoubleProcedure', 1);
...
Clazz.newMeth(C$, ['execute$D$D','execute$'], function (key, value) {
...
), Clazz.new_(P$.TDoubleDoubleHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$D$D(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleDoubleHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TDoubleDoubleHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleDoubleHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TDoubleDoubleHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleDoubleHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TDoubleDoubleHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleDoubleHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TDoubleDoubleHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleDoubleHashMap, "TDoubleDoubleKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleDoubleHashMap, "TDoubleDoubleValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TDoubleIterator');
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleDoubleHashMap, "TDoubleDoubleHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TDoubleDoubleIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TDoubleDoubleHashMap', function (map) {
