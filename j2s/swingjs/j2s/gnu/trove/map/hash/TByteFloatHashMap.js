(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TByteFloatHashMap','.TByteFloatKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TByteFloatHashMap','.TByteFloatValueHashIterator'],['gnu.trove.map.hash.TByteFloatHashMap','.TKeyView'],['gnu.trove.map.hash.TByteFloatHashMap','.TValueView'],['gnu.trove.map.hash.TByteFloatHashMap','.TByteFloatHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TByteFloatHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TByteFloatHash', ['gnu.trove.map.TByteFloatMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TByteFloatKeyHashIterator',0],['TByteFloatValueHashIterator',0],['TByteFloatHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$B$F', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$B$F.apply(this,[initialCapacity, loadFactor, ($b$[0] = noEntryKey, $b$[0]), noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$BA$FA', function (keys, values) {
...
this.put$B$F(($b$[0] = keys[i], $b$[0]), values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteFloatMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TByteFloatHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TByteFloatMap(map);
}, 1);
...
return p$1.doPut$B$F$I.apply(this, [($b$[0] = key, $b$[0]), value, index]);
});
...
Clazz.newMeth(C$, 'doPut$B$F$I', function (key, value, index) {
...
this.put$B$F(($b$[0] = entry.getKey$().byteValue$(), $b$[0]), entry.getValue$().floatValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$B$F(($b$[0] = iter.key$(), $b$[0]), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TByteFloatHashMap, [this, null, this]);
});
...
return this.adjustValue$B$F(($b$[0] = key, $b$[0]), 1.0);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TByteFloatMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TByteFloatProcedure(((P$.TByteFloatHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteFloatHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteFloatProcedure', 1);
...
Clazz.newMeth(C$, ['execute$B$F','execute$'], function (key, value) {
...
), Clazz.new_(P$.TByteFloatHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$B$F(($b$[0] = key, $b$[0]), val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteFloatHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TByteFloatHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteFloatHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TByteFloatHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteFloatHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TByteFloatHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteFloatHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TByteFloatHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteFloatHashMap, "TByteFloatKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteFloatHashMap, "TByteFloatValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteFloatHashMap, "TByteFloatHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TByteFloatIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TByteFloatHashMap', function (map) {
