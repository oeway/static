(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TByteIntHashMap','.TByteIntKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TByteIntHashMap','.TByteIntValueHashIterator'],['gnu.trove.map.hash.TByteIntHashMap','.TKeyView'],['gnu.trove.map.hash.TByteIntHashMap','.TValueView'],['gnu.trove.map.hash.TByteIntHashMap','.TByteIntHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TByteIntHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TByteIntHash', ['gnu.trove.map.TByteIntMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TByteIntKeyHashIterator',0],['TByteIntValueHashIterator',0],['TByteIntHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$B$I', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$B$I.apply(this,[initialCapacity, loadFactor, ($b$[0] = noEntryKey, $b$[0]), noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$BA$IA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TByteIntMap(map);
}, 1);
...
return p$1.doPut$B$I$I.apply(this, [($b$[0] = key, $b$[0]), value, index]);
});
...
Clazz.newMeth(C$, 'doPut$B$I$I', function (key, value, index) {
...
this.put$B$I(($b$[0] = entry.getKey$().byteValue$(), $b$[0]), entry.getValue$().intValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TByteIntMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$B$I(($b$[0] = iter.key$(), $b$[0]), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TByteIntHashMap, [this, null, this]);
});
...
return this.adjustValue$B$I(($b$[0] = key, $b$[0]), 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TByteIntMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TByteIntProcedure(((P$.TByteIntHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteIntHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteIntProcedure', 1);
...
Clazz.newMeth(C$, ['execute$B$I','execute$'], function (key, value) {
...
), Clazz.new_(P$.TByteIntHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var val=$in.readInt$();
this.put$B$I(($b$[0] = key, $b$[0]), val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteIntHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TByteIntHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteIntHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TByteIntHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteIntHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TByteIntHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteIntHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TByteIntHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteIntHashMap, "TByteIntKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteIntHashMap, "TByteIntValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteIntHashMap, "TByteIntHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TByteIntIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TByteIntHashMap', function (map) {
