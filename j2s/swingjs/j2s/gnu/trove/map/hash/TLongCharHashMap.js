(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TLongCharHashMap','.TLongCharKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TLongCharHashMap','.TLongCharValueHashIterator'],['gnu.trove.map.hash.TLongCharHashMap','.TKeyView'],['gnu.trove.map.hash.TLongCharHashMap','.TValueView'],['gnu.trove.map.hash.TLongCharHashMap','.TLongCharHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TLongCharHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TLongCharHash', ['gnu.trove.map.TLongCharMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TLongCharKeyHashIterator',0],['TLongCharValueHashIterator',0],['TLongCharHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$J$C', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$J$C.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$JA$CA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TLongCharMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$J$C', function (key, value) {
var index=this.insertKey$J(key);
return p$1.doPut$J$C$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$J$C', function (key, value) {
var index=this.insertKey$J(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$J$C$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$J$C$I', function (key, value, index) {
...
this.put$J$C(entry.getKey$().longValue$(), entry.getValue$().charValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TLongCharMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$J$C(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TLongCharHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TLongCharProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TLongCharProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$J$C(key, "\u0001");
});

Clazz.newMeth(C$, 'adjustValue$J$C', function (key, amount) {
var index=this.index$J(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$J$C$C', function (key, adjust_amount, put_amount) {
var index=this.insertKey$J(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TLongCharMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$J(this._set[i]) ^ $I$(3).hash$I(this._values[i].$c());
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TLongCharProcedure(((P$.TLongCharHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongCharHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongCharProcedure', 1);
...
Clazz.newMeth(C$, ['execute$J$C','execute$'], function (key, value) {
...
), Clazz.new_(P$.TLongCharHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var key=$in.readLong$();
var val=$in.readChar$();
this.put$J$C(key, val);
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongCharHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TLongCharHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongCharHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TLongCharHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongCharHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TLongCharHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongCharHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TLongCharHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongCharHashMap, "TLongCharKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongCharHashMap, "TLongCharValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongCharHashMap, "TLongCharHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TLongCharIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TLongCharHashMap', function (map) {
