(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TShortDoubleHashMap','.TShortDoubleKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TShortDoubleHashMap','.TShortDoubleValueHashIterator'],['gnu.trove.map.hash.TShortDoubleHashMap','.TKeyView'],['gnu.trove.map.hash.TShortDoubleHashMap','.TValueView'],['gnu.trove.map.hash.TShortDoubleHashMap','.TShortDoubleHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TShortDoubleHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TShortDoubleHash', ['gnu.trove.map.TShortDoubleMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TShortDoubleKeyHashIterator',0],['TShortDoubleValueHashIterator',0],['TShortDoubleHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$H$D', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$H$D.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$HA$DA', function (keys, values) {
...
this.put$H$D(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TShortDoubleMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TShortDoubleHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TShortDoubleMap(map);
}, 1);
...
return p$1.doPut$H$D$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$H$D$I', function (key, value, index) {
...
this.put$H$D(entry.getKey$().shortValue$(), entry.getValue$().doubleValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$H$D(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TShortDoubleHashMap, [this, null, this]);
});
...
return this.adjustValue$H$D(key, 1.0);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TShortDoubleMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TShortDoubleProcedure(((P$.TShortDoubleHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortDoubleHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortDoubleProcedure', 1);
...
Clazz.newMeth(C$, ['execute$H$D','execute$'], function (key, value) {
...
), Clazz.new_(P$.TShortDoubleHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$H$D(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortDoubleHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TShortDoubleHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortDoubleHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TShortDoubleHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortDoubleHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TShortDoubleHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortDoubleHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TShortDoubleHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortDoubleHashMap, "TShortDoubleKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortDoubleHashMap, "TShortDoubleValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortDoubleHashMap, "TShortDoubleHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TShortDoubleIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TShortDoubleHashMap', function (map) {
