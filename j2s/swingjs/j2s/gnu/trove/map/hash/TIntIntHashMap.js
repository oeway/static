(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TIntIntHashMap','.TIntIntKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TIntIntHashMap','.TIntIntValueHashIterator'],['gnu.trove.map.hash.TIntIntHashMap','.TKeyView'],['gnu.trove.map.hash.TIntIntHashMap','.TValueView'],['gnu.trove.map.hash.TIntIntHashMap','.TIntIntHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TIntIntHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TIntIntHash', ['gnu.trove.map.TIntIntMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TIntIntKeyHashIterator',0],['TIntIntValueHashIterator',0],['TIntIntHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$I$I', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$I$I.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$IA$IA', function (keys, values) {
...
this.put$I$I(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TIntIntMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TIntIntHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TIntIntMap(map);
}, 1);
...
return p$1.doPut$I$I$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$I$I$I', function (key, value, index) {
...
this.put$I$I(entry.getKey$().intValue$(), entry.getValue$().intValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$I$I(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TIntIntHashMap, [this, null, this]);
});
...
return this.adjustValue$I$I(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TIntIntMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TIntIntProcedure(((P$.TIntIntHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntIntHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntIntProcedure', 1);
...
Clazz.newMeth(C$, ['execute$I$I','execute$'], function (key, value) {
...
), Clazz.new_(P$.TIntIntHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var key=$in.readInt$();
var val=$in.readInt$();
this.put$I$I(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntIntHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TIntIntHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntIntHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TIntIntHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntIntHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TIntIntHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntIntHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TIntIntHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntIntHashMap, "TIntIntKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntIntHashMap, "TIntIntValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TIntIterator');
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntIntHashMap, "TIntIntHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TIntIntIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TIntIntHashMap', function (map) {
