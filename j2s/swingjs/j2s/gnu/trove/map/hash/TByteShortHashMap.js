(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TByteShortHashMap','.TByteShortKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TByteShortHashMap','.TByteShortValueHashIterator'],['gnu.trove.map.hash.TByteShortHashMap','.TKeyView'],['gnu.trove.map.hash.TByteShortHashMap','.TValueView'],['gnu.trove.map.hash.TByteShortHashMap','.TByteShortHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TByteShortHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TByteShortHash', ['gnu.trove.map.TByteShortMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TByteShortKeyHashIterator',0],['TByteShortValueHashIterator',0],['TByteShortHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$B$H', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$B$H.apply(this,[initialCapacity, loadFactor, ($b$[0] = noEntryKey, $b$[0]), noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$BA$HA', function (keys, values) {
...
this.put$B$H(($b$[0] = keys[i], $b$[0]), values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteShortMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TByteShortHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TByteShortMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$B$H', function (key, value) {
var index=this.insertKey$B(($b$[0] = key, $b$[0]));
return p$1.doPut$B$H$I.apply(this, [($b$[0] = key, $b$[0]), value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$B$H', function (key, value) {
var index=this.insertKey$B(($b$[0] = key, $b$[0]));
if (index < 0) return this._values[-index - 1];
return p$1.doPut$B$H$I.apply(this, [($b$[0] = key, $b$[0]), value, index]);
});

Clazz.newMeth(C$, 'doPut$B$H$I', function (key, value, index) {
...
this.put$B$H(($b$[0] = entry.getKey$().byteValue$(), $b$[0]), entry.getValue$().shortValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TByteShortMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$B$H(($b$[0] = iter.key$(), $b$[0]), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TByteShortHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TByteShortProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TByteShortProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$B$H(($b$[0] = key, $b$[0]), 1);
});

Clazz.newMeth(C$, 'adjustValue$B$H', function (key, amount) {
var index=this.index$B(($b$[0] = key, $b$[0]));
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$B$H$H', function (key, adjust_amount, put_amount) {
var index=this.insertKey$B(($b$[0] = key, $b$[0]));
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TByteShortMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TByteShortProcedure(((P$.TByteShortHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteShortHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteShortProcedure', 1);
...
Clazz.newMeth(C$, ['execute$B$H','execute$'], function (key, value) {
...
), Clazz.new_(P$.TByteShortHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$B$H(($b$[0] = key, $b$[0]), val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteShortHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TByteShortHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteShortHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TByteShortHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteShortHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TByteShortHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteShortHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TByteShortHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteShortHashMap, "TByteShortKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteShortHashMap, "TByteShortValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteShortHashMap, "TByteShortHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TByteShortIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TByteShortHashMap', function (map) {
