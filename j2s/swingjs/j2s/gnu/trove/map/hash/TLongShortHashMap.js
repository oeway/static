(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TLongShortHashMap','.TLongShortKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TLongShortHashMap','.TLongShortValueHashIterator'],['gnu.trove.map.hash.TLongShortHashMap','.TKeyView'],['gnu.trove.map.hash.TLongShortHashMap','.TValueView'],['gnu.trove.map.hash.TLongShortHashMap','.TLongShortHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TLongShortHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TLongShortHash', ['gnu.trove.map.TLongShortMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TLongShortKeyHashIterator',0],['TLongShortValueHashIterator',0],['TLongShortHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$J$H', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$J$H.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$JA$HA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TLongShortMap(map);
}, 1);
...
return p$1.doPut$J$H$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$J$H$I', function (key, value, index) {
...
this.put$J$H(entry.getKey$().longValue$(), entry.getValue$().shortValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$J$H(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TLongShortHashMap, [this, null, this]);
});
...
return this.adjustValue$J$H(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TLongShortMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TLongShortProcedure(((P$.TLongShortHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongShortHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongShortProcedure', 1);
...
Clazz.newMeth(C$, ['execute$J$H','execute$'], function (key, value) {
...
), Clazz.new_(P$.TLongShortHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$J$H(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongShortHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TLongShortHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongShortHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TLongShortHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongShortHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TLongShortHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongShortHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TLongShortHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongShortHashMap, "TLongShortKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongShortHashMap, "TLongShortValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongShortHashMap, "TLongShortHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TLongShortIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TLongShortHashMap', function (map) {
