(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TLongIntHashMap','.TLongIntKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TLongIntHashMap','.TLongIntValueHashIterator'],['gnu.trove.map.hash.TLongIntHashMap','.TKeyView'],['gnu.trove.map.hash.TLongIntHashMap','.TValueView'],['gnu.trove.map.hash.TLongIntHashMap','.TLongIntHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TLongIntHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TLongIntHash', ['gnu.trove.map.TLongIntMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TLongIntKeyHashIterator',0],['TLongIntValueHashIterator',0],['TLongIntHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$J$I', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$J$I.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$JA$IA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TLongIntMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$J$I', function (key, value) {
var index=this.insertKey$J(key);
return p$1.doPut$J$I$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$J$I', function (key, value) {
var index=this.insertKey$J(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$J$I$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$J$I$I', function (key, value, index) {
...
this.put$J$I(entry.getKey$().longValue$(), entry.getValue$().intValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TLongIntMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$J$I(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TLongIntHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TLongIntProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TLongIntProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$J$I(key, 1);
});

Clazz.newMeth(C$, 'adjustValue$J$I', function (key, amount) {
var index=this.index$J(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$J$I$I', function (key, adjust_amount, put_amount) {
var index=this.insertKey$J(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TLongIntMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$J(this._set[i]) ^ $I$(3).hash$I(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TLongIntProcedure(((P$.TLongIntHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongIntHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongIntProcedure', 1);
...
Clazz.newMeth(C$, ['execute$J$I','execute$'], function (key, value) {
...
), Clazz.new_(P$.TLongIntHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var key=$in.readLong$();
var val=$in.readInt$();
this.put$J$I(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongIntHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TLongIntHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongIntHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TLongIntHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongIntHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TLongIntHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongIntHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TLongIntHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongIntHashMap, "TLongIntKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongIntHashMap, "TLongIntValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongIntHashMap, "TLongIntHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TLongIntIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TLongIntHashMap', function (map) {
