(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TLongFloatHashMap','.TLongFloatKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TLongFloatHashMap','.TLongFloatValueHashIterator'],['gnu.trove.map.hash.TLongFloatHashMap','.TKeyView'],['gnu.trove.map.hash.TLongFloatHashMap','.TValueView'],['gnu.trove.map.hash.TLongFloatHashMap','.TLongFloatHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TLongFloatHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TLongFloatHash', ['gnu.trove.map.TLongFloatMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TLongFloatKeyHashIterator',0],['TLongFloatValueHashIterator',0],['TLongFloatHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$J$F', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$J$F.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$JA$FA', function (keys, values) {
...
this.put$J$F(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TLongFloatMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TLongFloatHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TLongFloatMap(map);
}, 1);
...
return p$1.doPut$J$F$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$J$F$I', function (key, value, index) {
...
this.put$J$F(entry.getKey$().longValue$(), entry.getValue$().floatValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$J$F(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TLongFloatHashMap, [this, null, this]);
});
...
return this.adjustValue$J$F(key, 1.0);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TLongFloatMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$J(this._set[i]) ^ $I$(3).hash$F(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TLongFloatProcedure(((P$.TLongFloatHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongFloatHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongFloatProcedure', 1);
...
Clazz.newMeth(C$, ['execute$J$F','execute$'], function (key, value) {
...
), Clazz.new_(P$.TLongFloatHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$J$F(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongFloatHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TLongFloatHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongFloatHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TLongFloatHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongFloatHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TLongFloatHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TLongFloatHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TLongFloatHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongFloatHashMap, "TLongFloatKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongFloatHashMap, "TLongFloatValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TLongFloatHashMap, "TLongFloatHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TLongFloatIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TLongFloatHashMap', function (map) {
