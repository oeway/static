(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TDoubleFloatHashMap','.TDoubleFloatKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TDoubleFloatHashMap','.TDoubleFloatValueHashIterator'],['gnu.trove.map.hash.TDoubleFloatHashMap','.TKeyView'],['gnu.trove.map.hash.TDoubleFloatHashMap','.TValueView'],['gnu.trove.map.hash.TDoubleFloatHashMap','.TDoubleFloatHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TDoubleFloatHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TDoubleFloatHash', ['gnu.trove.map.TDoubleFloatMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TDoubleFloatKeyHashIterator',0],['TDoubleFloatValueHashIterator',0],['TDoubleFloatHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$D$F', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$D$F.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$DA$FA', function (keys, values) {
...
this.put$D$F(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleFloatMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TDoubleFloatHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TDoubleFloatMap(map);
}, 1);
...
return p$1.doPut$D$F$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$D$F$I', function (key, value, index) {
...
this.put$D$F(entry.getKey$().doubleValue$(), entry.getValue$().floatValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$D$F(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TDoubleFloatHashMap, [this, null, this]);
});
...
return this.adjustValue$D$F(key, 1.0);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TDoubleFloatMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$D(this._set[i]) ^ $I$(3).hash$F(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TDoubleFloatProcedure(((P$.TDoubleFloatHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleFloatHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleFloatProcedure', 1);
...
Clazz.newMeth(C$, ['execute$D$F','execute$'], function (key, value) {
...
), Clazz.new_(P$.TDoubleFloatHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$D$F(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleFloatHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TDoubleFloatHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleFloatHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TDoubleFloatHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleFloatHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TDoubleFloatHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleFloatHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TDoubleFloatHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleFloatHashMap, "TDoubleFloatKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleFloatHashMap, "TDoubleFloatValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleFloatHashMap, "TDoubleFloatHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TDoubleFloatIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TDoubleFloatHashMap', function (map) {
