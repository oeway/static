(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TFloatDoubleHashMap','.TFloatDoubleKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TFloatDoubleHashMap','.TFloatDoubleValueHashIterator'],['gnu.trove.map.hash.TFloatDoubleHashMap','.TKeyView'],['gnu.trove.map.hash.TFloatDoubleHashMap','.TValueView'],['gnu.trove.map.hash.TFloatDoubleHashMap','.TFloatDoubleHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TFloatDoubleHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TFloatDoubleHash', ['gnu.trove.map.TFloatDoubleMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TFloatDoubleKeyHashIterator',0],['TFloatDoubleValueHashIterator',0],['TFloatDoubleHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$F$D', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$F$D.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$FA$DA', function (keys, values) {
...
Clazz.newMeth(C$, 'put$F$D', function (key, value) {
var index=this.insertKey$F(key);
return p$1.doPut$F$D$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$F$D', function (key, value) {
var index=this.insertKey$F(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$F$D$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$F$D$I', function (key, value, index) {
...
this.put$F$D(entry.getKey$().floatValue$(), entry.getValue$().doubleValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TFloatDoubleMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$F$D(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TFloatDoubleHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TFloatDoubleProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TFloatDoubleProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$F$D(key, 1.0);
});

Clazz.newMeth(C$, 'adjustValue$F$D', function (key, amount) {
var index=this.index$F(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$F$D$D', function (key, adjust_amount, put_amount) {
var index=this.insertKey$F(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TFloatDoubleMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$F(this._set[i]) ^ $I$(3).hash$D(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TFloatDoubleProcedure(((P$.TFloatDoubleHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatDoubleHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatDoubleProcedure', 1);
...
Clazz.newMeth(C$, ['execute$F$D','execute$'], function (key, value) {
...
), Clazz.new_(P$.TFloatDoubleHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$F$D(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatDoubleHashMap, "TKeyView", function(){
...
return this.this$0.contains$F.apply(this.this$0, [entry]);
});
...
return this.this$0.keys$FA.apply(this.this$0, [dest]);
});
...
return this.this$0.no_entry_value != this.this$0.remove$F.apply(this.this$0, [entry]) ;
});
...
if (!this.this$0.containsKey$F.apply(this.this$0, [ele])) {
return false;
}} else {
return false;
}}
...
while (iter.hasNext$()){
if (!this.this$0.containsKey$F.apply(this.this$0, [iter.next$()])) {
return false;
}}
return true;
});
...
if (!this.this$0.contains$F.apply(this.this$0, [element])) {
return false;
}}
return true;
});
...
return this.this$0.forEachKey$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [procedure]);
});
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TFloatDoubleHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatDoubleHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
Clazz.newMeth(C$, ['execute$F','execute$'], function (key) {
if (this.first) {
this.first=false;
} else {
this.$finals$.buf.append$S(", ");
...
), Clazz.new_(P$.TFloatDoubleHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatDoubleHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TFloatDoubleHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatDoubleHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TFloatDoubleHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatDoubleHashMap, "TFloatDoubleKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatDoubleHashMap, "TFloatDoubleValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatDoubleHashMap, "TFloatDoubleHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TFloatDoubleIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TFloatDoubleHashMap', function (map) {
