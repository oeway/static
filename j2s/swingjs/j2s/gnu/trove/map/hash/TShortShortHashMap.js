(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TShortShortHashMap','.TShortShortKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TShortShortHashMap','.TShortShortValueHashIterator'],['gnu.trove.map.hash.TShortShortHashMap','.TKeyView'],['gnu.trove.map.hash.TShortShortHashMap','.TValueView'],['gnu.trove.map.hash.TShortShortHashMap','.TShortShortHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TShortShortHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TShortShortHash', ['gnu.trove.map.TShortShortMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TShortShortKeyHashIterator',0],['TShortShortValueHashIterator',0],['TShortShortHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$H$H', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$H$H.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$HA$HA', function (keys, values) {
...
this.put$H$H(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TShortShortMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TShortShortHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TShortShortMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$H$H', function (key, value) {
var index=this.insertKey$H(key);
return p$1.doPut$H$H$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$H$H', function (key, value) {
var index=this.insertKey$H(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$H$H$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$H$H$I', function (key, value, index) {
...
this.put$H$H(entry.getKey$().shortValue$(), entry.getValue$().shortValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortShortMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$H$H(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TShortShortHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TShortShortProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TShortShortProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$H$H(key, 1);
});

Clazz.newMeth(C$, 'adjustValue$H$H', function (key, amount) {
var index=this.index$H(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$H$H$H', function (key, adjust_amount, put_amount) {
var index=this.insertKey$H(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TShortShortMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TShortShortProcedure(((P$.TShortShortHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortShortHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortShortProcedure', 1);
...
Clazz.newMeth(C$, ['execute$H$H','execute$'], function (key, value) {
...
), Clazz.new_(P$.TShortShortHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$H$H(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortShortHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TShortShortHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortShortHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TShortShortHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortShortHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TShortShortHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortShortHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TShortShortHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortShortHashMap, "TShortShortKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortShortHashMap, "TShortShortValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TShortIterator');
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortShortHashMap, "TShortShortHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TShortShortIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TShortShortHashMap', function (map) {
