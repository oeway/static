(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TCharDoubleHashMap','.TCharDoubleKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TCharDoubleHashMap','.TCharDoubleValueHashIterator'],['gnu.trove.map.hash.TCharDoubleHashMap','.TKeyView'],['gnu.trove.map.hash.TCharDoubleHashMap','.TValueView'],['gnu.trove.map.hash.TCharDoubleHashMap','.TCharDoubleHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TCharDoubleHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCharDoubleHash', ['gnu.trove.map.TCharDoubleMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TCharDoubleKeyHashIterator',0],['TCharDoubleValueHashIterator',0],['TCharDoubleHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$C$D', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$C$D.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$CA$DA', function (keys, values) {
...
this.put$C$D(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharDoubleMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TCharDoubleHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TCharDoubleMap(map);
}, 1);
...
return p$1.doPut$C$D$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$C$D$I', function (key, value, index) {
...
this.put$C$D(entry.getKey$().charValue$(), entry.getValue$().doubleValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$C$D(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TCharDoubleHashMap, [this, null, this]);
});
...
return this.adjustValue$C$D(key, 1.0);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TCharDoubleMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$I(this._set[i].$c()) ^ $I$(3).hash$D(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TCharDoubleProcedure(((P$.TCharDoubleHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharDoubleHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharDoubleProcedure', 1);
...
Clazz.newMeth(C$, ['execute$C$D','execute$'], function (key, value) {
...
), Clazz.new_(P$.TCharDoubleHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$C$D(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharDoubleHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TCharDoubleHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharDoubleHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TCharDoubleHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharDoubleHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TCharDoubleHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharDoubleHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TCharDoubleHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharDoubleHashMap, "TCharDoubleKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharDoubleHashMap, "TCharDoubleValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharDoubleHashMap, "TCharDoubleHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TCharDoubleIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TCharDoubleHashMap', function (map) {
