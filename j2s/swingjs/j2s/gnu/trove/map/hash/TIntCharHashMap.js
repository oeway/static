(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TIntCharHashMap','.TIntCharKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TIntCharHashMap','.TIntCharValueHashIterator'],['gnu.trove.map.hash.TIntCharHashMap','.TKeyView'],['gnu.trove.map.hash.TIntCharHashMap','.TValueView'],['gnu.trove.map.hash.TIntCharHashMap','.TIntCharHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TIntCharHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TIntCharHash', ['gnu.trove.map.TIntCharMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TIntCharKeyHashIterator',0],['TIntCharValueHashIterator',0],['TIntCharHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$I$C', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$I$C.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$IA$CA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TIntCharMap(map);
}, 1);
...
return p$1.doPut$I$C$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$I$C$I', function (key, value, index) {
...
this.put$I$C(entry.getKey$().intValue$(), entry.getValue$().charValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$I$C(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TIntCharHashMap, [this, null, this]);
});
...
return this.adjustValue$I$C(key, "\u0001");
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TIntCharMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TIntCharProcedure(((P$.TIntCharHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntCharHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntCharProcedure', 1);
...
Clazz.newMeth(C$, ['execute$I$C','execute$'], function (key, value) {
...
), Clazz.new_(P$.TIntCharHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var key=$in.readInt$();
var val=$in.readChar$();
this.put$I$C(key, val);
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntCharHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TIntCharHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntCharHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TIntCharHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntCharHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TIntCharHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntCharHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TIntCharHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntCharHashMap, "TIntCharKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntCharHashMap, "TIntCharValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntCharHashMap, "TIntCharHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TIntCharIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TIntCharHashMap', function (map) {
