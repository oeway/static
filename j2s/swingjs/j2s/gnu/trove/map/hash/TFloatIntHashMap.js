(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TFloatIntHashMap','.TFloatIntKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TFloatIntHashMap','.TFloatIntValueHashIterator'],['gnu.trove.map.hash.TFloatIntHashMap','.TKeyView'],['gnu.trove.map.hash.TFloatIntHashMap','.TValueView'],['gnu.trove.map.hash.TFloatIntHashMap','.TFloatIntHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TFloatIntHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TFloatIntHash', ['gnu.trove.map.TFloatIntMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TFloatIntKeyHashIterator',0],['TFloatIntValueHashIterator',0],['TFloatIntHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$F$I', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$F$I.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$FA$IA', function (keys, values) {
...
this.put$F$I(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TFloatIntMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TFloatIntHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TFloatIntMap(map);
}, 1);
...
return p$1.doPut$F$I$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$F$I$I', function (key, value, index) {
...
this.put$F$I(entry.getKey$().floatValue$(), entry.getValue$().intValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$F$I(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TFloatIntHashMap, [this, null, this]);
});
...
return this.adjustValue$F$I(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TFloatIntMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TFloatIntProcedure(((P$.TFloatIntHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatIntHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatIntProcedure', 1);
...
Clazz.newMeth(C$, ['execute$F$I','execute$'], function (key, value) {
...
), Clazz.new_(P$.TFloatIntHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var val=$in.readInt$();
this.put$F$I(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatIntHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TFloatIntHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatIntHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TFloatIntHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatIntHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TFloatIntHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatIntHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TFloatIntHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatIntHashMap, "TFloatIntKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatIntHashMap, "TFloatIntValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatIntHashMap, "TFloatIntHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TFloatIntIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TFloatIntHashMap', function (map) {
