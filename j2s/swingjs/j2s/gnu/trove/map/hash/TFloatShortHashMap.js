(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TFloatShortHashMap','.TFloatShortKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TFloatShortHashMap','.TFloatShortValueHashIterator'],['gnu.trove.map.hash.TFloatShortHashMap','.TKeyView'],['gnu.trove.map.hash.TFloatShortHashMap','.TValueView'],['gnu.trove.map.hash.TFloatShortHashMap','.TFloatShortHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TFloatShortHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TFloatShortHash', ['gnu.trove.map.TFloatShortMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TFloatShortKeyHashIterator',0],['TFloatShortValueHashIterator',0],['TFloatShortHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$F$H', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$F$H.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$FA$HA', function (keys, values) {
...
}this.putAll$gnu_trove_map_TFloatShortMap(map);
}, 1);
...
return p$1.doPut$F$H$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$F$H$I', function (key, value, index) {
...
this.put$F$H(entry.getKey$().floatValue$(), entry.getValue$().shortValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$F$H(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TFloatShortHashMap, [this, null, this]);
});
...
return this.adjustValue$F$H(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TFloatShortMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TFloatShortProcedure(((P$.TFloatShortHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatShortHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatShortProcedure', 1);
...
Clazz.newMeth(C$, ['execute$F$H','execute$'], function (key, value) {
...
), Clazz.new_(P$.TFloatShortHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$F$H(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatShortHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TFloatShortHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatShortHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TFloatShortHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatShortHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TFloatShortHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatShortHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TFloatShortHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatShortHashMap, "TFloatShortKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatShortHashMap, "TFloatShortValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatShortHashMap, "TFloatShortHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TFloatShortIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TFloatShortHashMap', function (map) {
