(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TByteByteHashMap','.TByteByteKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TByteByteHashMap','.TByteByteValueHashIterator'],['gnu.trove.map.hash.TByteByteHashMap','.TKeyView'],['gnu.trove.map.hash.TByteByteHashMap','.TValueView'],['gnu.trove.map.hash.TByteByteHashMap','.TByteByteHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TByteByteHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TByteByteHash', ['gnu.trove.map.TByteByteMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TByteByteKeyHashIterator',0],['TByteByteValueHashIterator',0],['TByteByteHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$B$B', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$B$B.apply(this,[initialCapacity, loadFactor, ($b$[0] = noEntryKey, $b$[0]), ($b$[0] = noEntryValue, $b$[0])]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$BA$BA', function (keys, values) {
...
this.put$B$B(($b$[0] = keys[i], $b$[0]), ($b$[0] = values[i], $b$[0]));
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteByteMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TByteByteHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TByteByteMap(map);
}, 1);
...
return $b$[0] = p$1.doPut$B$B$I.apply(this, [(key|0), (value|0), index]), $b$[0];
});
...
Clazz.newMeth(C$, 'doPut$B$B$I', function (key, value, index) {
...
this.put$B$B(($b$[0] = entry.getKey$().byteValue$(), $b$[0]), ($b$[0] = entry.getValue$().byteValue$(), $b$[0]));
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$B$B(($b$[0] = iter.key$(), $b$[0]), ($b$[0] = iter.value$(), $b$[0]));
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TByteByteHashMap, [this, null, this]);
});
...
if (states[i] == 1 && !procedure.execute$(($b$[0] = keys[i], $b$[0]), ($b$[0] = values[i], $b$[0])) ) {
return false;
}}
return true;
});
...
return this.adjustValue$B$B(($b$[0] = key, $b$[0]), ($b$[0] = 1, $b$[0]));
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TByteByteMap"))) {
return false;
}var that=other;
...
var that_value=($b$[0] = that.get$B((key|0)), $b$[0]);
...
this.forEachEntry$gnu_trove_procedure_TByteByteProcedure(((P$.TByteByteHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteByteHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteByteProcedure', 1);
...
Clazz.newMeth(C$, ['execute$B$B','execute$'], function (key, value) {
...
), Clazz.new_(P$.TByteByteHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$B$B(($b$[0] = key, $b$[0]), ($b$[0] = val, $b$[0]));
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteByteHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TByteByteHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteByteHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TByteByteHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteByteHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TByteByteHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteByteHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TByteByteHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteByteHashMap, "TByteByteKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteByteHashMap, "TByteByteValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TByteIterator');
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteByteHashMap, "TByteByteHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TByteByteIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TByteByteHashMap', function (map) {
