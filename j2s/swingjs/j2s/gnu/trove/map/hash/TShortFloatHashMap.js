(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TShortFloatHashMap','.TShortFloatKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TShortFloatHashMap','.TShortFloatValueHashIterator'],['gnu.trove.map.hash.TShortFloatHashMap','.TKeyView'],['gnu.trove.map.hash.TShortFloatHashMap','.TValueView'],['gnu.trove.map.hash.TShortFloatHashMap','.TShortFloatHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TShortFloatHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TShortFloatHash', ['gnu.trove.map.TShortFloatMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TShortFloatKeyHashIterator',0],['TShortFloatValueHashIterator',0],['TShortFloatHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$H$F', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$H$F.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$HA$FA', function (keys, values) {
...
this.put$H$F(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TShortFloatMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TShortFloatHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TShortFloatMap(map);
}, 1);
...
Clazz.newMeth(C$, 'put$H$F', function (key, value) {
var index=this.insertKey$H(key);
return p$1.doPut$H$F$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'putIfAbsent$H$F', function (key, value) {
var index=this.insertKey$H(key);
if (index < 0) return this._values[-index - 1];
return p$1.doPut$H$F$I.apply(this, [key, value, index]);
});

Clazz.newMeth(C$, 'doPut$H$F$I', function (key, value, index) {
...
this.put$H$F(entry.getKey$().shortValue$(), entry.getValue$().floatValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortFloatMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$H$F(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TShortFloatHashMap, [this, null, this]);
});
...
Clazz.newMeth(C$, 'forEachEntry$gnu_trove_procedure_TShortFloatProcedure', function (procedure) {
var states=this._states;
var keys=this._set;
var values=this._values;
...
Clazz.newMeth(C$, 'retainEntries$gnu_trove_procedure_TShortFloatProcedure', function (procedure) {
var modified=false;
var states=this._states;
var keys=this._set;
var values=this._values;
...
return this.adjustValue$H$F(key, 1.0);
});

Clazz.newMeth(C$, 'adjustValue$H$F', function (key, amount) {
var index=this.index$H(key);
if (index < 0) {
return false;
} else {
...
Clazz.newMeth(C$, 'adjustOrPutValue$H$F$F', function (key, adjust_amount, put_amount) {
var index=this.insertKey$H(key);
var isNewMapping;
var newValue;
if (index < 0) {
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TShortFloatMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TShortFloatProcedure(((P$.TShortFloatHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortFloatHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortFloatProcedure', 1);
...
Clazz.newMeth(C$, ['execute$H$F','execute$'], function (key, value) {
...
), Clazz.new_(P$.TShortFloatHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$H$F(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortFloatHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TShortFloatHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortFloatHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TShortFloatHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortFloatHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TShortFloatHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortFloatHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TShortFloatHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortFloatHashMap, "TShortFloatKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortFloatHashMap, "TShortFloatValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortFloatHashMap, "TShortFloatHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TShortFloatIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TShortFloatHashMap', function (map) {
