(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TCharIntHashMap','.TCharIntKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TCharIntHashMap','.TCharIntValueHashIterator'],['gnu.trove.map.hash.TCharIntHashMap','.TKeyView'],['gnu.trove.map.hash.TCharIntHashMap','.TValueView'],['gnu.trove.map.hash.TCharIntHashMap','.TCharIntHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TCharIntHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCharIntHash', ['gnu.trove.map.TCharIntMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TCharIntKeyHashIterator',0],['TCharIntValueHashIterator',0],['TCharIntHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$C$I', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$C$I.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$CA$IA', function (keys, values) {
...
this.put$C$I(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharIntMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TCharIntHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TCharIntMap(map);
}, 1);
...
return p$1.doPut$C$I$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$C$I$I', function (key, value, index) {
...
this.put$C$I(entry.getKey$().charValue$(), entry.getValue$().intValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$C$I(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TCharIntHashMap, [this, null, this]);
});
...
return this.adjustValue$C$I(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TCharIntMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TCharIntProcedure(((P$.TCharIntHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharIntHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharIntProcedure', 1);
...
Clazz.newMeth(C$, ['execute$C$I','execute$'], function (key, value) {
...
), Clazz.new_(P$.TCharIntHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var key=$in.readChar$();
var val=$in.readInt$();
this.put$C$I(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharIntHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TCharIntHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharIntHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TCharIntHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharIntHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TCharIntHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharIntHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TCharIntHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharIntHashMap, "TCharIntKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharIntHashMap, "TCharIntValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharIntHashMap, "TCharIntHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TCharIntIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TCharIntHashMap', function (map) {
