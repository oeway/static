(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TShortObjectHashMap','.KeyView','.TShortHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TShortObjectHashMap','.ValueView','.TShortObjectValueHashIterator'],'java.lang.reflect.Array','gnu.trove.impl.Constants',['gnu.trove.map.hash.TShortObjectHashMap','.KeyView'],['gnu.trove.map.hash.TShortObjectHashMap','.ValueView'],['gnu.trove.map.hash.TShortObjectHashMap','.TShortObjectHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TShortObjectHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TShortHash', ['gnu.trove.map.TShortObjectMap', 'java.io.Externalizable']);
C$.$classes$=[['KeyView',0],['ValueView',4],['MapBackedView',1026],['TShortObjectHashIterator',0]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.PUT_ALL_PROC=((P$.TShortObjectHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortObjectHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortObjectProcedure', 1);
...
Clazz.newMeth(C$, ['execute$H$TV','execute$','execute$H$TT'], function (key, value) {
this.b$['gnu.trove.map.hash.TShortObjectHashMap'].put$H$TV.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [key, value]);
return true;
});
})()
), Clazz.new_(P$.TShortObjectHashMap$1.$init$, [this, null]));
}, 1);

C$.$fields$=[['H',['no_entry_key'],'O',['PUT_ALL_PROC','gnu.trove.procedure.TShortObjectProcedure','_values','_.V[]']]]
...
this.no_entry_key=$I$(7).DEFAULT_SHORT_NO_ENTRY_VALUE;
}, 1);
...
Clazz.newMeth(C$, 'c$$I$F$H', function (initialCapacity, loadFactor, noEntryKey) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
this.no_entry_key=noEntryKey;
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TShortObjectMap', function (map) {
C$.c$$I$F$H.apply(this, [map.size$(), 0.5, map.getNoEntryKey$()]);
this.putAll$gnu_trove_map_TShortObjectMap(map);
}, 1);
...
this.put$H$TV((entry.getKey$()).valueOf(), entry.getValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TShortObjectMap', function (map) {
map.forEachEntry$gnu_trove_procedure_TShortObjectProcedure(this.PUT_ALL_PROC);
});
...
Clazz.newMeth(C$, 'keys$HA', function (dest) {
if (dest.length < this._size) {
dest=Clazz.array(Short.TYPE, [this._size]);
}var k=this._set;
var states=this._states;
for (var i=k.length, j=0; i-- > 0; ) {
if (states[i] == 1) {
...
return Clazz.new_(1,{V:"Object"},$I$(10,1).c$$gnu_trove_map_hash_TShortObjectHashMap, [this, null, this]);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TShortObjectMap"))) {
return false;
}var that=other;
...
if (value == null ) {
if (!(that.get$H(key) == null  && that.containsKey$H(key) )) {
return false;
}} else {
if (!value.equals$O(that.get$H(key))) {
return false;
}}}
} catch (ex) {
...
this.put$H$TV(key, val);
}
});

Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.forEachEntry$gnu_trove_procedure_TShortObjectProcedure(((P$.TShortObjectHashMap$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortObjectHashMap$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortObjectProcedure', 1);
...
Clazz.newMeth(C$, ['execute$H$O','execute$','executenull'], function (key, value) {
...
), Clazz.new_(P$.TShortObjectHashMap$2.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortObjectHashMap, "KeyView", function(){
...
return this.b$['gnu.trove.map.hash.TShortObjectHashMap'].containsKey$H.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [entry]);
});

Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(1,1).c$$gnu_trove_impl_hash_TShortHash, [this, null, this.b$['gnu.trove.map.hash.TShortObjectHashMap']]);
});

Clazz.newMeth(C$, 'toArray$', function () {
return this.b$['gnu.trove.map.hash.TShortObjectHashMap'].keys$.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], []);
});

Clazz.newMeth(C$, 'toArray$HA', function (dest) {
return this.b$['gnu.trove.map.hash.TShortObjectHashMap'].keys$HA.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [dest]);
});
...
return null != this.b$['gnu.trove.map.hash.TShortObjectHashMap'].remove$H.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [entry]) ;
});
...
if (!this.b$['gnu.trove.map.hash.TShortObjectHashMap'].containsKey$H.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [(element).shortValue$()])) {
return false;
}}
return true;
});
...
while (iter.hasNext$()){
if (!this.b$['gnu.trove.map.hash.TShortObjectHashMap'].containsKey$H.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [iter.next$()])) {
return false;
}}
return true;
});
...
if (!this.b$['gnu.trove.map.hash.TShortObjectHashMap'].containsKey$H.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [element])) {
return false;
}}
return true;
});
...
this.b$['gnu.trove.map.hash.TShortObjectHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [i]);
changed=true;
}}
return changed;
});
...
Clazz.newMeth(C$, 'clear$', function () {
this.b$['gnu.trove.map.hash.TShortObjectHashMap'].clear$.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], []);
});

Clazz.newMeth(C$, 'forEach$gnu_trove_procedure_TShortProcedure', function (procedure) {
return this.b$['gnu.trove.map.hash.TShortObjectHashMap'].forEachKey$gnu_trove_procedure_TShortProcedure.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [procedure]);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortObjectHashMap.KeyView, "TShortHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortObjectHashMap, "ValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, ['gnu.trove.map.hash.TShortObjectHashMap','.MapBackedView']);
C$.$classes$=[['TShortObjectValueHashIterator',0]];
...
Clazz.newMeth(C$, 'iterator$', function () {
return ((P$.TShortObjectHashMap$ValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortObjectHashMap$ValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load(['gnu.trove.map.hash.TShortObjectHashMap','.ValueView','.TShortObjectValueHashIterator']), null, 1);
...
return this.b$['gnu.trove.map.hash.TShortObjectHashMap']._values[index];
});
})()
), Clazz.new_($I$(5,1).c$$gnu_trove_map_hash_TShortObjectHashMap, [this, null, this.b$['gnu.trove.map.hash.TShortObjectHashMap']],P$.TShortObjectHashMap$ValueView$1));
});

Clazz.newMeth(C$, ['containsElement$TV','containsElement$TE'], function (value) {
return this.b$['gnu.trove.map.hash.TShortObjectHashMap'].containsValue$O.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], [value]);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortObjectHashMap.ValueView, "TShortObjectValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
C$.$fields$=[['O',['_map','gnu.trove.map.hash.TShortObjectHashMap']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TShortObjectHashMap', function (map) {
...
var states=this.b$['gnu.trove.map.hash.TShortObjectHashMap']._states;
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortObjectHashMap, "MapBackedView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'size$', function () {
return this.b$['gnu.trove.map.hash.TShortObjectHashMap'].size$.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], []);
});
...
Clazz.newMeth(C$, 'isEmpty$', function () {
return this.b$['gnu.trove.map.hash.TShortObjectHashMap'].isEmpty$.apply(this.b$['gnu.trove.map.hash.TShortObjectHashMap'], []);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortObjectHashMap, "TShortObjectHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TShortObjectIterator');
