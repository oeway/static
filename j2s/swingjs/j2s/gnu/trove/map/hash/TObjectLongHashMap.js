(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,'gnu.trove.iterator.hash.TObjectHashIterator','java.lang.reflect.Array','gnu.trove.impl.hash.TObjectHash',['gnu.trove.map.hash.TObjectLongHashMap','.TLongValueCollection','.TObjectLongValueHashIterator'],'java.util.Arrays','StringBuilder','gnu.trove.impl.Constants',['gnu.trove.map.hash.TObjectLongHashMap','.KeyView'],['gnu.trove.map.hash.TObjectLongHashMap','.TLongValueCollection'],['gnu.trove.map.hash.TObjectLongHashMap','.TObjectLongHashIterator'],'gnu.trove.impl.HashFunctions']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TObjectLongHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TObjectHash', ['gnu.trove.map.TObjectLongMap', 'java.io.Externalizable']);
C$.$classes$=[['KeyView',4],['MapBackedView',1026],['TLongValueCollection',0],['TObjectLongHashIterator',0]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.PUT_ALL_PROC=((P$.TObjectLongHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectLongHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectLongProcedure', 1);
...
this.b$['gnu.trove.map.hash.TObjectLongHashMap'].put$TK$J.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [key, value]);
return true;
});
})()
), Clazz.new_(P$.TObjectLongHashMap$1.$init$, [this, null]));
}, 1);
...
Clazz.newMeth(C$, 'c$$I$F$J', function (initialCapacity, loadFactor, noEntryValue) {
;C$.superclazz.c$$I$F.apply(this,[initialCapacity, loadFactor]);C$.$init$.apply(this);
...
C$.c$$I$F$J.apply(this, [map.size$(), 0.5, map.getNoEntryValue$()]);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TObjectLongHashMap")) {
var hashmap=map;
...
return Clazz.new_(1,{K:"Object"},$I$(10,1).c$$gnu_trove_map_hash_TObjectLongHashMap, [this, null, this]);
});
...
this.forEachEntry$gnu_trove_procedure_TObjectLongProcedure(((P$.TObjectLongHashMap$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectLongHashMap$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectLongProcedure', 1);
...
), Clazz.new_(P$.TObjectLongHashMap$2.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectLongHashMap, "KeyView", function(){
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(1,1).c$$gnu_trove_impl_hash_TObjectHash,[this.b$['gnu.trove.map.hash.TObjectLongHashMap']]);
});

Clazz.newMeth(C$, ['removeElement$TK','removeElement$TE'], function (key) {
return this.this$0.no_entry_value != this.b$['gnu.trove.map.hash.TObjectLongHashMap'].remove$O.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [key]);
});

Clazz.newMeth(C$, ['containsElement$TK','containsElement$TE'], function (key) {
return this.b$['gnu.trove.map.hash.TObjectLongHashMap'].contains$O.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [key]);
});

Clazz.newMeth(C$);
})()
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectLongHashMap, "MapBackedView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'clear$', function () {
this.b$['gnu.trove.map.hash.TObjectLongHashMap'].clear$.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], []);
});
...
return this.b$['gnu.trove.map.hash.TObjectLongHashMap'].size$.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], []);
});
...
return this.b$['gnu.trove.map.hash.TObjectLongHashMap'].isEmpty$.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], []);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectLongHashMap, "TLongValueCollection", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
return this.b$['gnu.trove.map.hash.TObjectLongHashMap'].containsValue$J.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [entry]);
});

Clazz.newMeth(C$, 'toArray$', function () {
return this.b$['gnu.trove.map.hash.TObjectLongHashMap'].values$.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], []);
});

Clazz.newMeth(C$, 'toArray$JA', function (dest) {
return this.b$['gnu.trove.map.hash.TObjectLongHashMap'].values$JA.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [dest]);
});
...
this.b$['gnu.trove.map.hash.TObjectLongHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [i]);
return true;
}}
return false;
});
...
if (!this.b$['gnu.trove.map.hash.TObjectLongHashMap'].containsValue$J.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [ele])) {
return false;
}} else {
return false;
}}
...
while (iter.hasNext$()){
if (!this.b$['gnu.trove.map.hash.TObjectLongHashMap'].containsValue$J.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [iter.next$()])) {
return false;
}}
return true;
});
...
if (!this.b$['gnu.trove.map.hash.TObjectLongHashMap'].containsValue$J.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [element])) {
return false;
}}
return true;
});
...
return this.b$['gnu.trove.map.hash.TObjectLongHashMap'].forEachValue$gnu_trove_procedure_TLongProcedure.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [procedure]);
});

Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(6,1).c$$S,["{"]);
this.b$['gnu.trove.map.hash.TObjectLongHashMap'].forEachValue$gnu_trove_procedure_TLongProcedure.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [((P$.TObjectLongHashMap$TLongValueCollection$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectLongHashMap$TLongValueCollection$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TObjectLongHashMap$TLongValueCollection$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectLongHashMap.TLongValueCollection, "TObjectLongValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, '$init$', function () {
this._hash=this.b$['gnu.trove.map.hash.TObjectLongHashMap'];
}, 1);
...
return this.b$['gnu.trove.map.hash.TObjectLongHashMap']._values[this._index];
});
...
this.b$['gnu.trove.map.hash.TObjectLongHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.hash.TObjectLongHashMap'], [this._index]);
} finally {
...
if (this._expectedSize != this._hash.size$()) {
throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
}var set=this.b$['gnu.trove.map.hash.TObjectLongHashMap']._set;
var i=this._index;
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectLongHashMap, "TObjectLongHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
C$.$fields$=[['O',['_map','gnu.trove.map.hash.TObjectLongHashMap']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TObjectLongHashMap', function (map) {
