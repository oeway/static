(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TFloatByteHashMap','.TFloatByteKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TFloatByteHashMap','.TFloatByteValueHashIterator'],['gnu.trove.map.hash.TFloatByteHashMap','.TKeyView'],['gnu.trove.map.hash.TFloatByteHashMap','.TValueView'],['gnu.trove.map.hash.TFloatByteHashMap','.TFloatByteHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TFloatByteHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TFloatByteHash', ['gnu.trove.map.TFloatByteMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TFloatByteKeyHashIterator',0],['TFloatByteValueHashIterator',0],['TFloatByteHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$F$B', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$F$B.apply(this,[initialCapacity, loadFactor, noEntryKey, ($b$[0] = noEntryValue, $b$[0])]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$FA$BA', function (keys, values) {
...
this.put$F$B(keys[i], ($b$[0] = values[i], $b$[0]));
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TFloatByteMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TFloatByteHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TFloatByteMap(map);
}, 1);
...
return $b$[0] = p$1.doPut$F$B$I.apply(this, [key, (value|0), index]), $b$[0];
});
...
Clazz.newMeth(C$, 'doPut$F$B$I', function (key, value, index) {
...
this.put$F$B(entry.getKey$().floatValue$(), ($b$[0] = entry.getValue$().byteValue$(), $b$[0]));
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$F$B(iter.key$(), ($b$[0] = iter.value$(), $b$[0]));
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TFloatByteHashMap, [this, null, this]);
});
...
return this.adjustValue$F$B(key, ($b$[0] = 1, $b$[0]));
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TFloatByteMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
var key=this._set[i];
var that_value=($b$[0] = that.get$F(key), $b$[0]);
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$F(this._set[i]) ^ $I$(3).hash$I(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TFloatByteProcedure(((P$.TFloatByteHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatByteHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatByteProcedure', 1);
...
Clazz.newMeth(C$, ['execute$F$B','execute$'], function (key, value) {
...
), Clazz.new_(P$.TFloatByteHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$F$B(key, ($b$[0] = val, $b$[0]));
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatByteHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TFloatProcedure.apply(this.this$0, [((P$.TFloatByteHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatByteHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TFloatByteHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatByteHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TFloatByteHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatByteHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TFloatByteHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatByteHashMap, "TFloatByteKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatByteHashMap, "TFloatByteValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatByteHashMap, "TFloatByteHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TFloatByteIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TFloatByteHashMap', function (map) {
