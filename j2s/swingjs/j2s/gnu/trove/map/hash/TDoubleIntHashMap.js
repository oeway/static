(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TDoubleIntHashMap','.TDoubleIntKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TDoubleIntHashMap','.TDoubleIntValueHashIterator'],['gnu.trove.map.hash.TDoubleIntHashMap','.TKeyView'],['gnu.trove.map.hash.TDoubleIntHashMap','.TValueView'],['gnu.trove.map.hash.TDoubleIntHashMap','.TDoubleIntHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TDoubleIntHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TDoubleIntHash', ['gnu.trove.map.TDoubleIntMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TDoubleIntKeyHashIterator',0],['TDoubleIntValueHashIterator',0],['TDoubleIntHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$D$I', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$D$I.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$DA$IA', function (keys, values) {
...
this.put$D$I(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleIntMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TDoubleIntHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TDoubleIntMap(map);
}, 1);
...
return p$1.doPut$D$I$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$D$I$I', function (key, value, index) {
...
this.put$D$I(entry.getKey$().doubleValue$(), entry.getValue$().intValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TDoubleIntMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$D$I(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TDoubleIntHashMap, [this, null, this]);
});
...
return this.adjustValue$D$I(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TDoubleIntMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TDoubleIntProcedure(((P$.TDoubleIntHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleIntHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleIntProcedure', 1);
...
Clazz.newMeth(C$, ['execute$D$I','execute$'], function (key, value) {
...
), Clazz.new_(P$.TDoubleIntHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var val=$in.readInt$();
this.put$D$I(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleIntHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TDoubleIntHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleIntHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TDoubleIntHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleIntHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TDoubleIntHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleIntHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TDoubleIntHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleIntHashMap, "TDoubleIntKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleIntHashMap, "TDoubleIntValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleIntHashMap, "TDoubleIntHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TDoubleIntIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TDoubleIntHashMap', function (map) {
