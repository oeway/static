(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TCharByteHashMap','.TCharByteKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TCharByteHashMap','.TCharByteValueHashIterator'],['gnu.trove.map.hash.TCharByteHashMap','.TKeyView'],['gnu.trove.map.hash.TCharByteHashMap','.TValueView'],['gnu.trove.map.hash.TCharByteHashMap','.TCharByteHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TCharByteHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCharByteHash', ['gnu.trove.map.TCharByteMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TCharByteKeyHashIterator',0],['TCharByteValueHashIterator',0],['TCharByteHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$C$B', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$C$B.apply(this,[initialCapacity, loadFactor, noEntryKey, ($b$[0] = noEntryValue, $b$[0])]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$CA$BA', function (keys, values) {
...
this.put$C$B(keys[i], ($b$[0] = values[i], $b$[0]));
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharByteMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TCharByteHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TCharByteMap(map);
}, 1);
...
return $b$[0] = p$1.doPut$C$B$I.apply(this, [key, (value|0), index]), $b$[0];
});
...
Clazz.newMeth(C$, 'doPut$C$B$I', function (key, value, index) {
...
this.put$C$B(entry.getKey$().charValue$(), ($b$[0] = entry.getValue$().byteValue$(), $b$[0]));
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$C$B(iter.key$(), ($b$[0] = iter.value$(), $b$[0]));
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TCharByteHashMap, [this, null, this]);
});
...
return this.adjustValue$C$B(key, ($b$[0] = 1, $b$[0]));
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TCharByteMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
var key=this._set[i];
var that_value=($b$[0] = that.get$C(key), $b$[0]);
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$I(this._set[i].$c()) ^ $I$(3).hash$I(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TCharByteProcedure(((P$.TCharByteHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharByteHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharByteProcedure', 1);
...
Clazz.newMeth(C$, ['execute$C$B','execute$'], function (key, value) {
...
), Clazz.new_(P$.TCharByteHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$C$B(key, ($b$[0] = val, $b$[0]));
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharByteHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TCharByteHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharByteHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TCharByteHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharByteHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TCharByteHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharByteHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TCharByteHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharByteHashMap, "TCharByteKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharByteHashMap, "TCharByteValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharByteHashMap, "TCharByteHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TCharByteIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TCharByteHashMap', function (map) {
