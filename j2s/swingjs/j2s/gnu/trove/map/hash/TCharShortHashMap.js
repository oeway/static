(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TCharShortHashMap','.TCharShortKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TCharShortHashMap','.TCharShortValueHashIterator'],['gnu.trove.map.hash.TCharShortHashMap','.TKeyView'],['gnu.trove.map.hash.TCharShortHashMap','.TValueView'],['gnu.trove.map.hash.TCharShortHashMap','.TCharShortHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TCharShortHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCharShortHash', ['gnu.trove.map.TCharShortMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TCharShortKeyHashIterator',0],['TCharShortValueHashIterator',0],['TCharShortHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$C$H', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$C$H.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$CA$HA', function (keys, values) {
...
this.put$C$H(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TCharShortMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TCharShortHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TCharShortMap(map);
}, 1);
...
return p$1.doPut$C$H$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$C$H$I', function (key, value, index) {
...
this.put$C$H(entry.getKey$().charValue$(), entry.getValue$().shortValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$C$H(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TCharShortHashMap, [this, null, this]);
});
...
return this.adjustValue$C$H(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TCharShortMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TCharShortProcedure(((P$.TCharShortHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharShortHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharShortProcedure', 1);
...
Clazz.newMeth(C$, ['execute$C$H','execute$'], function (key, value) {
...
), Clazz.new_(P$.TCharShortHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
this.put$C$H(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharShortHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TCharShortHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharShortHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TCharShortHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharShortHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TShortProcedure.apply(this.this$0, [((P$.TCharShortHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TCharShortHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TCharShortHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharShortHashMap, "TCharShortKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharShortHashMap, "TCharShortValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TCharShortHashMap, "TCharShortHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TCharShortIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TCharShortHashMap', function (map) {
