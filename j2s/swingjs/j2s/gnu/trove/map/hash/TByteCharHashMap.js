(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TByteCharHashMap','.TByteCharKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TByteCharHashMap','.TByteCharValueHashIterator'],['gnu.trove.map.hash.TByteCharHashMap','.TKeyView'],['gnu.trove.map.hash.TByteCharHashMap','.TValueView'],['gnu.trove.map.hash.TByteCharHashMap','.TByteCharHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TByteCharHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TByteCharHash', ['gnu.trove.map.TByteCharMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TByteCharKeyHashIterator',0],['TByteCharValueHashIterator',0],['TByteCharHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$B$C', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$B$C.apply(this,[initialCapacity, loadFactor, ($b$[0] = noEntryKey, $b$[0]), noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$BA$CA', function (keys, values) {
...
this.put$B$C(($b$[0] = keys[i], $b$[0]), values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TByteCharMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TByteCharHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TByteCharMap(map);
}, 1);
...
return p$1.doPut$B$C$I.apply(this, [($b$[0] = key, $b$[0]), value, index]);
});
...
Clazz.newMeth(C$, 'doPut$B$C$I', function (key, value, index) {
...
this.put$B$C(($b$[0] = entry.getKey$().byteValue$(), $b$[0]), entry.getValue$().charValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$B$C(($b$[0] = iter.key$(), $b$[0]), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TByteCharHashMap, [this, null, this]);
});
...
return this.adjustValue$B$C(($b$[0] = key, $b$[0]), "\u0001");
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TByteCharMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TByteCharProcedure(((P$.TByteCharHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteCharHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteCharProcedure', 1);
...
Clazz.newMeth(C$, ['execute$B$C','execute$'], function (key, value) {
...
), Clazz.new_(P$.TByteCharHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var val=$in.readChar$();
this.put$B$C(($b$[0] = key, $b$[0]), val);
}
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteCharHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TByteProcedure.apply(this.this$0, [((P$.TByteCharHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteCharHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TByteCharHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteCharHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TCharProcedure.apply(this.this$0, [((P$.TByteCharHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TByteCharHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TCharProcedure', 1);
...
), Clazz.new_(P$.TByteCharHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteCharHashMap, "TByteCharKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteCharHashMap, "TByteCharValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TByteCharHashMap, "TByteCharHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TByteCharIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TByteCharHashMap', function (map) {
