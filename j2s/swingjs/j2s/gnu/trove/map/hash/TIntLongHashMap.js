(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TIntLongHashMap','.TIntLongKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TIntLongHashMap','.TIntLongValueHashIterator'],['gnu.trove.map.hash.TIntLongHashMap','.TKeyView'],['gnu.trove.map.hash.TIntLongHashMap','.TValueView'],['gnu.trove.map.hash.TIntLongHashMap','.TIntLongHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TIntLongHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TIntLongHash', ['gnu.trove.map.TIntLongMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TIntLongKeyHashIterator',0],['TIntLongValueHashIterator',0],['TIntLongHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$I$J', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$I$J.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$IA$JA', function (keys, values) {
...
this.put$I$J(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TIntLongMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TIntLongHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TIntLongMap(map);
}, 1);
...
return p$1.doPut$I$J$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$I$J$I', function (key, value, index) {
...
this.put$I$J(entry.getKey$().intValue$(), entry.getValue$().longValue$());
}
});
...
while (iter.hasNext$()){
iter.advance$();
this.put$I$J(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TIntLongHashMap, [this, null, this]);
});
...
return this.adjustValue$I$J(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TIntLongMap"))) {
return false;
}var that=other;
...
this.forEachEntry$gnu_trove_procedure_TIntLongProcedure(((P$.TIntLongHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntLongHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntLongProcedure', 1);
...
Clazz.newMeth(C$, ['execute$I$J','execute$'], function (key, value) {
...
), Clazz.new_(P$.TIntLongHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var key=$in.readInt$();
var val=$in.readLong$();
this.put$I$J(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntLongHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TIntProcedure.apply(this.this$0, [((P$.TIntLongHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntLongHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TIntLongHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntLongHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TIntLongHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TIntLongHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TIntLongHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntLongHashMap, "TIntLongKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntLongHashMap, "TIntLongValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TIntLongHashMap, "TIntLongHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TIntLongIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TIntLongHashMap', function (map) {
