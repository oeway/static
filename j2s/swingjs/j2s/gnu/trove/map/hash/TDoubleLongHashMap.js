(function(){var P$=Clazz.newPackage("gnu.trove.map.hash"),p$1={},I$=[[0,['gnu.trove.map.hash.TDoubleLongHashMap','.TDoubleLongKeyHashIterator'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder',['gnu.trove.map.hash.TDoubleLongHashMap','.TDoubleLongValueHashIterator'],['gnu.trove.map.hash.TDoubleLongHashMap','.TKeyView'],['gnu.trove.map.hash.TDoubleLongHashMap','.TValueView'],['gnu.trove.map.hash.TDoubleLongHashMap','.TDoubleLongHashIterator']]],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TDoubleLongHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TDoubleLongHash', ['gnu.trove.map.TDoubleLongMap', 'java.io.Externalizable']);
C$.$classes$=[['TKeyView',4],['TValueView',4],['TDoubleLongKeyHashIterator',0],['TDoubleLongValueHashIterator',0],['TDoubleLongHashIterator',0]];
...
Clazz.newMeth(C$, 'c$$I$F$D$J', function (initialCapacity, loadFactor, noEntryKey, noEntryValue) {
;C$.superclazz.c$$I$F$D$J.apply(this,[initialCapacity, loadFactor, noEntryKey, noEntryValue]);C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$DA$JA', function (keys, values) {
...
this.put$D$J(keys[i], values[i]);
}
}, 1);

Clazz.newMeth(C$, 'c$$gnu_trove_map_TDoubleLongMap', function (map) {
;C$.superclazz.c$$I.apply(this,[map.size$()]);C$.$init$.apply(this);
if (Clazz.instanceOf(map, "gnu.trove.map.hash.TDoubleLongHashMap")) {
var hashmap=map;
...
}this.putAll$gnu_trove_map_TDoubleLongMap(map);
}, 1);
...
return p$1.doPut$D$J$I.apply(this, [key, value, index]);
});
...
Clazz.newMeth(C$, 'doPut$D$J$I', function (key, value, index) {
...
this.put$D$J(entry.getKey$().doubleValue$(), entry.getValue$().longValue$());
}
});

Clazz.newMeth(C$, 'putAll$gnu_trove_map_TDoubleLongMap', function (map) {
this.ensureCapacity$I(map.size$());
var iter=map.iterator$();
while (iter.hasNext$()){
iter.advance$();
this.put$D$J(iter.key$(), iter.value$());
}
});
...
return Clazz.new_($I$(8,1).c$$gnu_trove_map_hash_TDoubleLongHashMap, [this, null, this]);
});
...
return this.adjustValue$D$J(key, 1);
});
...
if (!(Clazz.instanceOf(other, "gnu.trove.map.TDoubleLongMap"))) {
return false;
}var that=other;
...
if (states[i] == 1) {
hashcode+=$I$(3).hash$D(this._set[i]) ^ $I$(3).hash$J(this._values[i]);
}}
return hashcode;
});
...
this.forEachEntry$gnu_trove_procedure_TDoubleLongProcedure(((P$.TDoubleLongHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleLongHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleLongProcedure', 1);
...
Clazz.newMeth(C$, ['execute$D$J','execute$'], function (key, value) {
...
), Clazz.new_(P$.TDoubleLongHashMap$1.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
...
var val=$in.readLong$();
this.put$D$J(key, val);
}
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleLongHashMap, "TKeyView", function(){
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachKey$gnu_trove_procedure_TDoubleProcedure.apply(this.this$0, [((P$.TDoubleLongHashMap$TKeyView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleLongHashMap$TKeyView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TDoubleLongHashMap$TKeyView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleLongHashMap, "TValueView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(4,1).c$$S,["{"]);
this.this$0.forEachValue$gnu_trove_procedure_TLongProcedure.apply(this.this$0, [((P$.TDoubleLongHashMap$TValueView$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TDoubleLongHashMap$TValueView$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TLongProcedure', 1);
...
), Clazz.new_(P$.TDoubleLongHashMap$TValueView$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleLongHashMap, "TDoubleLongKeyHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleLongHashMap, "TDoubleLongValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TDoubleLongHashMap, "TDoubleLongHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, 'gnu.trove.impl.hash.THashPrimitiveIterator', 'gnu.trove.iterator.TDoubleLongIterator');
...
Clazz.newMeth(C$, 'c$$gnu_trove_map_hash_TDoubleLongHashMap', function (map) {
