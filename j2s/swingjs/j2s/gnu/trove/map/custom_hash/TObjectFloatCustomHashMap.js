(function(){var P$=Clazz.newPackage("gnu.trove.map.custom_hash"),p$1={},I$=[[0,'gnu.trove.iterator.hash.TObjectHashIterator','java.lang.reflect.Array','gnu.trove.impl.hash.TObjectHash',['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap','.TFloatValueCollection','.TObjectFloatValueHashIterator'],'java.util.Arrays','StringBuilder','gnu.trove.impl.Constants',['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap','.KeyView'],['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap','.TFloatValueCollection'],['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap','.TObjectFloatHashIterator'],'gnu.trove.impl.HashFunctions']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TObjectFloatCustomHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCustomObjectHash', ['gnu.trove.map.TObjectFloatMap', 'java.io.Externalizable']);
C$.$classes$=[['KeyView',4],['MapBackedView',1026],['TFloatValueCollection',0],['TObjectFloatHashIterator',0]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.PUT_ALL_PROC=((P$.TObjectFloatCustomHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectFloatCustomHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectFloatProcedure', 1);
...
this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].put$TK$F.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [key, value]);
return true;
});
})()
), Clazz.new_(P$.TObjectFloatCustomHashMap$1.$init$, [this, null]));
}, 1);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$I$F$F', function (strategy, initialCapacity, loadFactor, noEntryValue) {
;C$.superclazz.c$$gnu_trove_strategy_HashingStrategy$I$F.apply(this,[strategy, initialCapacity, loadFactor]);C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$gnu_trove_map_TObjectFloatMap', function (strategy, map) {
C$.c$$gnu_trove_strategy_HashingStrategy$I$F$F.apply(this, [strategy, map.size$(), 0.5, map.getNoEntryValue$()]);
if (Clazz.instanceOf(map, "gnu.trove.map.custom_hash.TObjectFloatCustomHashMap")) {
var hashmap=map;
...
return Clazz.new_(1,{K:"Object"},$I$(10,1).c$$gnu_trove_map_custom_hash_TObjectFloatCustomHashMap, [this, null, this]);
});
...
this.forEachEntry$gnu_trove_procedure_TObjectFloatProcedure(((P$.TObjectFloatCustomHashMap$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectFloatCustomHashMap$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectFloatProcedure', 1);
...
), Clazz.new_(P$.TObjectFloatCustomHashMap$2.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectFloatCustomHashMap, "KeyView", function(){
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(1,1).c$$gnu_trove_impl_hash_TObjectHash,[this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap']]);
});

Clazz.newMeth(C$, ['removeElement$TK','removeElement$TE'], function (key) {
return this.this$0.no_entry_value != this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].remove$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [key]) ;
});

Clazz.newMeth(C$, ['containsElement$TK','containsElement$TE'], function (key) {
return this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].contains$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [key]);
});

Clazz.newMeth(C$);
})()
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectFloatCustomHashMap, "MapBackedView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'clear$', function () {
this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].clear$.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].size$.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].isEmpty$.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], []);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectFloatCustomHashMap, "TFloatValueCollection", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
return this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].containsValue$F.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [entry]);
});

Clazz.newMeth(C$, 'toArray$', function () {
return this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].values$.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], []);
});

Clazz.newMeth(C$, 'toArray$FA', function (dest) {
return this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].values$FA.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [dest]);
});
...
this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [i]);
return true;
}}
return false;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].containsValue$F.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [ele])) {
return false;
}} else {
return false;
}}
...
while (iter.hasNext$()){
if (!this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].containsValue$F.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [iter.next$()])) {
return false;
}}
return true;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].containsValue$F.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [element])) {
return false;
}}
return true;
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].forEachValue$gnu_trove_procedure_TFloatProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [procedure]);
});

Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(6,1).c$$S,["{"]);
this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].forEachValue$gnu_trove_procedure_TFloatProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [((P$.TObjectFloatCustomHashMap$TFloatValueCollection$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectFloatCustomHashMap$TFloatValueCollection$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TFloatProcedure', 1);
...
), Clazz.new_(P$.TObjectFloatCustomHashMap$TFloatValueCollection$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectFloatCustomHashMap.TFloatValueCollection, "TObjectFloatValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, '$init$', function () {
this._hash=this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'];
}, 1);
...
return this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap']._values[this._index];
});
...
this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap'], [this._index]);
} finally {
...
if (this._expectedSize != this._hash.size$()) {
throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
}var set=this.b$['gnu.trove.map.custom_hash.TObjectFloatCustomHashMap']._set;
var i=this._index;
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectFloatCustomHashMap, "TObjectFloatHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
C$.$fields$=[['O',['_map','gnu.trove.map.custom_hash.TObjectFloatCustomHashMap']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_custom_hash_TObjectFloatCustomHashMap', function (map) {
