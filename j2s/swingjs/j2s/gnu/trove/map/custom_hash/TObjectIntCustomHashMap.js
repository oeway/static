(function(){var P$=Clazz.newPackage("gnu.trove.map.custom_hash"),p$1={},I$=[[0,'gnu.trove.iterator.hash.TObjectHashIterator','java.lang.reflect.Array','gnu.trove.impl.hash.TObjectHash',['gnu.trove.map.custom_hash.TObjectIntCustomHashMap','.TIntValueCollection','.TObjectIntValueHashIterator'],'java.util.Arrays','StringBuilder','gnu.trove.impl.Constants',['gnu.trove.map.custom_hash.TObjectIntCustomHashMap','.KeyView'],['gnu.trove.map.custom_hash.TObjectIntCustomHashMap','.TIntValueCollection'],['gnu.trove.map.custom_hash.TObjectIntCustomHashMap','.TObjectIntHashIterator'],'gnu.trove.impl.HashFunctions']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TObjectIntCustomHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCustomObjectHash', ['gnu.trove.map.TObjectIntMap', 'java.io.Externalizable']);
C$.$classes$=[['KeyView',4],['MapBackedView',1026],['TIntValueCollection',0],['TObjectIntHashIterator',0]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.PUT_ALL_PROC=((P$.TObjectIntCustomHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectIntCustomHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectIntProcedure', 1);
...
this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].put$TK$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [key, value]);
return true;
});
})()
), Clazz.new_(P$.TObjectIntCustomHashMap$1.$init$, [this, null]));
}, 1);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$I$F$I', function (strategy, initialCapacity, loadFactor, noEntryValue) {
;C$.superclazz.c$$gnu_trove_strategy_HashingStrategy$I$F.apply(this,[strategy, initialCapacity, loadFactor]);C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$gnu_trove_map_TObjectIntMap', function (strategy, map) {
C$.c$$gnu_trove_strategy_HashingStrategy$I$F$I.apply(this, [strategy, map.size$(), 0.5, map.getNoEntryValue$()]);
if (Clazz.instanceOf(map, "gnu.trove.map.custom_hash.TObjectIntCustomHashMap")) {
var hashmap=map;
...
return Clazz.new_(1,{K:"Object"},$I$(10,1).c$$gnu_trove_map_custom_hash_TObjectIntCustomHashMap, [this, null, this]);
});
...
this.forEachEntry$gnu_trove_procedure_TObjectIntProcedure(((P$.TObjectIntCustomHashMap$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectIntCustomHashMap$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectIntProcedure', 1);
...
), Clazz.new_(P$.TObjectIntCustomHashMap$2.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectIntCustomHashMap, "KeyView", function(){
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(1,1).c$$gnu_trove_impl_hash_TObjectHash,[this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap']]);
});

Clazz.newMeth(C$, ['removeElement$TK','removeElement$TE'], function (key) {
return this.this$0.no_entry_value != this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].remove$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [key]);
});

Clazz.newMeth(C$, ['containsElement$TK','containsElement$TE'], function (key) {
return this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].contains$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [key]);
});

Clazz.newMeth(C$);
})()
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectIntCustomHashMap, "MapBackedView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'clear$', function () {
this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].clear$.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].size$.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].isEmpty$.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], []);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectIntCustomHashMap, "TIntValueCollection", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
return this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].containsValue$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [entry]);
});

Clazz.newMeth(C$, 'toArray$', function () {
return this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].values$.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], []);
});

Clazz.newMeth(C$, 'toArray$IA', function (dest) {
return this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].values$IA.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [dest]);
});
...
this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [i]);
return true;
}}
return false;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].containsValue$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [ele])) {
return false;
}} else {
return false;
}}
...
while (iter.hasNext$()){
if (!this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].containsValue$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [iter.next$()])) {
return false;
}}
return true;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].containsValue$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [element])) {
return false;
}}
return true;
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].forEachValue$gnu_trove_procedure_TIntProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [procedure]);
});

Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(6,1).c$$S,["{"]);
this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].forEachValue$gnu_trove_procedure_TIntProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [((P$.TObjectIntCustomHashMap$TIntValueCollection$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectIntCustomHashMap$TIntValueCollection$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TIntProcedure', 1);
...
), Clazz.new_(P$.TObjectIntCustomHashMap$TIntValueCollection$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectIntCustomHashMap.TIntValueCollection, "TObjectIntValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, '$init$', function () {
this._hash=this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'];
}, 1);
...
return this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap']._values[this._index];
});
...
this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap'], [this._index]);
} finally {
...
if (this._expectedSize != this._hash.size$()) {
throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
}var set=this.b$['gnu.trove.map.custom_hash.TObjectIntCustomHashMap']._set;
var i=this._index;
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectIntCustomHashMap, "TObjectIntHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
C$.$fields$=[['O',['_map','gnu.trove.map.custom_hash.TObjectIntCustomHashMap']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_custom_hash_TObjectIntCustomHashMap', function (map) {
