(function(){var P$=Clazz.newPackage("gnu.trove.map.custom_hash"),p$1={},I$=[[0,'gnu.trove.iterator.hash.TObjectHashIterator','java.lang.reflect.Array','gnu.trove.impl.hash.TObjectHash',['gnu.trove.map.custom_hash.TObjectShortCustomHashMap','.TShortValueCollection','.TObjectShortValueHashIterator'],'java.util.Arrays','StringBuilder','gnu.trove.impl.Constants',['gnu.trove.map.custom_hash.TObjectShortCustomHashMap','.KeyView'],['gnu.trove.map.custom_hash.TObjectShortCustomHashMap','.TShortValueCollection'],['gnu.trove.map.custom_hash.TObjectShortCustomHashMap','.TObjectShortHashIterator'],'gnu.trove.impl.HashFunctions']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TObjectShortCustomHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCustomObjectHash', ['gnu.trove.map.TObjectShortMap', 'java.io.Externalizable']);
C$.$classes$=[['KeyView',4],['MapBackedView',1026],['TShortValueCollection',0],['TObjectShortHashIterator',0]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.PUT_ALL_PROC=((P$.TObjectShortCustomHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectShortCustomHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectShortProcedure', 1);
...
this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].put$TK$H.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [key, value]);
return true;
});
})()
), Clazz.new_(P$.TObjectShortCustomHashMap$1.$init$, [this, null]));
}, 1);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$I$F$H', function (strategy, initialCapacity, loadFactor, noEntryValue) {
;C$.superclazz.c$$gnu_trove_strategy_HashingStrategy$I$F.apply(this,[strategy, initialCapacity, loadFactor]);C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$gnu_trove_map_TObjectShortMap', function (strategy, map) {
C$.c$$gnu_trove_strategy_HashingStrategy$I$F$H.apply(this, [strategy, map.size$(), 0.5, map.getNoEntryValue$()]);
if (Clazz.instanceOf(map, "gnu.trove.map.custom_hash.TObjectShortCustomHashMap")) {
var hashmap=map;
...
return Clazz.new_(1,{K:"Object"},$I$(10,1).c$$gnu_trove_map_custom_hash_TObjectShortCustomHashMap, [this, null, this]);
});
...
this.forEachEntry$gnu_trove_procedure_TObjectShortProcedure(((P$.TObjectShortCustomHashMap$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectShortCustomHashMap$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectShortProcedure', 1);
...
), Clazz.new_(P$.TObjectShortCustomHashMap$2.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectShortCustomHashMap, "KeyView", function(){
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(1,1).c$$gnu_trove_impl_hash_TObjectHash,[this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap']]);
});

Clazz.newMeth(C$, ['removeElement$TK','removeElement$TE'], function (key) {
return this.this$0.no_entry_value != this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].remove$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [key]);
});

Clazz.newMeth(C$, ['containsElement$TK','containsElement$TE'], function (key) {
return this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].contains$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [key]);
});

Clazz.newMeth(C$);
})()
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectShortCustomHashMap, "MapBackedView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'clear$', function () {
this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].clear$.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].size$.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].isEmpty$.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], []);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectShortCustomHashMap, "TShortValueCollection", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
return this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].containsValue$H.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [entry]);
});

Clazz.newMeth(C$, 'toArray$', function () {
return this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].values$.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], []);
});

Clazz.newMeth(C$, 'toArray$HA', function (dest) {
return this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].values$HA.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [dest]);
});
...
this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [i]);
return true;
}}
return false;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].containsValue$H.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [ele])) {
return false;
}} else {
return false;
}}
...
while (iter.hasNext$()){
if (!this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].containsValue$H.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [iter.next$()])) {
return false;
}}
return true;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].containsValue$H.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [element])) {
return false;
}}
return true;
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].forEachValue$gnu_trove_procedure_TShortProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [procedure]);
});

Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(6,1).c$$S,["{"]);
this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].forEachValue$gnu_trove_procedure_TShortProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [((P$.TObjectShortCustomHashMap$TShortValueCollection$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectShortCustomHashMap$TShortValueCollection$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TShortProcedure', 1);
...
), Clazz.new_(P$.TObjectShortCustomHashMap$TShortValueCollection$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectShortCustomHashMap.TShortValueCollection, "TObjectShortValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, '$init$', function () {
this._hash=this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'];
}, 1);
...
return this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap']._values[this._index];
});
...
this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap'], [this._index]);
} finally {
...
if (this._expectedSize != this._hash.size$()) {
throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
}var set=this.b$['gnu.trove.map.custom_hash.TObjectShortCustomHashMap']._set;
var i=this._index;
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectShortCustomHashMap, "TObjectShortHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
C$.$fields$=[['O',['_map','gnu.trove.map.custom_hash.TObjectShortCustomHashMap']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_custom_hash_TObjectShortCustomHashMap', function (map) {
