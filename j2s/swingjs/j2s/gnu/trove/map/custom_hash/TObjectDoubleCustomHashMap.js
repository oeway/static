(function(){var P$=Clazz.newPackage("gnu.trove.map.custom_hash"),p$1={},I$=[[0,'gnu.trove.iterator.hash.TObjectHashIterator','java.lang.reflect.Array','gnu.trove.impl.hash.TObjectHash',['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap','.TDoubleValueCollection','.TObjectDoubleValueHashIterator'],'java.util.Arrays','StringBuilder','gnu.trove.impl.Constants',['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap','.KeyView'],['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap','.TDoubleValueCollection'],['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap','.TObjectDoubleHashIterator'],'gnu.trove.impl.HashFunctions']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TObjectDoubleCustomHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCustomObjectHash', ['gnu.trove.map.TObjectDoubleMap', 'java.io.Externalizable']);
C$.$classes$=[['KeyView',4],['MapBackedView',1026],['TDoubleValueCollection',0],['TObjectDoubleHashIterator',0]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.PUT_ALL_PROC=((P$.TObjectDoubleCustomHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectDoubleCustomHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectDoubleProcedure', 1);
...
this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].put$TK$D.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [key, value]);
return true;
});
})()
), Clazz.new_(P$.TObjectDoubleCustomHashMap$1.$init$, [this, null]));
}, 1);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$I$F$D', function (strategy, initialCapacity, loadFactor, noEntryValue) {
;C$.superclazz.c$$gnu_trove_strategy_HashingStrategy$I$F.apply(this,[strategy, initialCapacity, loadFactor]);C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$gnu_trove_map_TObjectDoubleMap', function (strategy, map) {
C$.c$$gnu_trove_strategy_HashingStrategy$I$F$D.apply(this, [strategy, map.size$(), 0.5, map.getNoEntryValue$()]);
if (Clazz.instanceOf(map, "gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap")) {
var hashmap=map;
...
return Clazz.new_(1,{K:"Object"},$I$(10,1).c$$gnu_trove_map_custom_hash_TObjectDoubleCustomHashMap, [this, null, this]);
});
...
this.forEachEntry$gnu_trove_procedure_TObjectDoubleProcedure(((P$.TObjectDoubleCustomHashMap$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectDoubleCustomHashMap$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectDoubleProcedure', 1);
...
), Clazz.new_(P$.TObjectDoubleCustomHashMap$2.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectDoubleCustomHashMap, "KeyView", function(){
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(1,1).c$$gnu_trove_impl_hash_TObjectHash,[this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap']]);
});

Clazz.newMeth(C$, ['removeElement$TK','removeElement$TE'], function (key) {
return this.this$0.no_entry_value != this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].remove$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [key]) ;
});

Clazz.newMeth(C$, ['containsElement$TK','containsElement$TE'], function (key) {
return this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].contains$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [key]);
});

Clazz.newMeth(C$);
})()
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectDoubleCustomHashMap, "MapBackedView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'clear$', function () {
this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].clear$.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].size$.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].isEmpty$.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], []);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectDoubleCustomHashMap, "TDoubleValueCollection", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
return this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].containsValue$D.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [entry]);
});

Clazz.newMeth(C$, 'toArray$', function () {
return this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].values$.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], []);
});

Clazz.newMeth(C$, 'toArray$DA', function (dest) {
return this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].values$DA.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [dest]);
});
...
this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [i]);
return true;
}}
return false;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].containsValue$D.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [ele])) {
return false;
}} else {
return false;
}}
...
while (iter.hasNext$()){
if (!this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].containsValue$D.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [iter.next$()])) {
return false;
}}
return true;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].containsValue$D.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [element])) {
return false;
}}
return true;
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].forEachValue$gnu_trove_procedure_TDoubleProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [procedure]);
});

Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(6,1).c$$S,["{"]);
this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].forEachValue$gnu_trove_procedure_TDoubleProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [((P$.TObjectDoubleCustomHashMap$TDoubleValueCollection$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectDoubleCustomHashMap$TDoubleValueCollection$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TDoubleProcedure', 1);
...
), Clazz.new_(P$.TObjectDoubleCustomHashMap$TDoubleValueCollection$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectDoubleCustomHashMap.TDoubleValueCollection, "TObjectDoubleValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, '$init$', function () {
this._hash=this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'];
}, 1);
...
return this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap']._values[this._index];
});
...
this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap'], [this._index]);
} finally {
...
if (this._expectedSize != this._hash.size$()) {
throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
}var set=this.b$['gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap']._set;
var i=this._index;
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectDoubleCustomHashMap, "TObjectDoubleHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
C$.$fields$=[['O',['_map','gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_custom_hash_TObjectDoubleCustomHashMap', function (map) {
