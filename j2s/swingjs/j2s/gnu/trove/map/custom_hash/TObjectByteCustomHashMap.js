(function(){var P$=Clazz.newPackage("gnu.trove.map.custom_hash"),p$1={},I$=[[0,'gnu.trove.iterator.hash.TObjectHashIterator','java.lang.reflect.Array','gnu.trove.impl.hash.TObjectHash',['gnu.trove.map.custom_hash.TObjectByteCustomHashMap','.TByteValueCollection','.TObjectByteValueHashIterator'],'java.util.Arrays','StringBuilder','gnu.trove.impl.Constants',['gnu.trove.map.custom_hash.TObjectByteCustomHashMap','.KeyView'],['gnu.trove.map.custom_hash.TObjectByteCustomHashMap','.TByteValueCollection'],['gnu.trove.map.custom_hash.TObjectByteCustomHashMap','.TObjectByteHashIterator'],'gnu.trove.impl.HashFunctions']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TObjectByteCustomHashMap", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'gnu.trove.impl.hash.TCustomObjectHash', ['gnu.trove.map.TObjectByteMap', 'java.io.Externalizable']);
C$.$classes$=[['KeyView',4],['MapBackedView',1026],['TByteValueCollection',0],['TObjectByteHashIterator',0]];

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.PUT_ALL_PROC=((P$.TObjectByteCustomHashMap$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectByteCustomHashMap$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectByteProcedure', 1);
...
this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].put$TK$B.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [key, ($b$[0] = value, $b$[0])]);
return true;
});
var $b$ = new Int8Array(1);
})()
), Clazz.new_(P$.TObjectByteCustomHashMap$1.$init$, [this, null]));
}, 1);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$I$F$B', function (strategy, initialCapacity, loadFactor, noEntryValue) {
;C$.superclazz.c$$gnu_trove_strategy_HashingStrategy$I$F.apply(this,[strategy, initialCapacity, loadFactor]);C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'c$$gnu_trove_strategy_HashingStrategy$gnu_trove_map_TObjectByteMap', function (strategy, map) {
C$.c$$gnu_trove_strategy_HashingStrategy$I$F$B.apply(this, [strategy, map.size$(), 0.5, ($b$[0] = map.getNoEntryValue$(), $b$[0])]);
if (Clazz.instanceOf(map, "gnu.trove.map.custom_hash.TObjectByteCustomHashMap")) {
var hashmap=map;
...
return Clazz.new_(1,{K:"Object"},$I$(10,1).c$$gnu_trove_map_custom_hash_TObjectByteCustomHashMap, [this, null, this]);
});
...
this.forEachEntry$gnu_trove_procedure_TObjectByteProcedure(((P$.TObjectByteCustomHashMap$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectByteCustomHashMap$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TObjectByteProcedure', 1);
...
), Clazz.new_(P$.TObjectByteCustomHashMap$2.$init$, [this, {buf:buf}])));
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
var $k$;
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectByteCustomHashMap, "KeyView", function(){
...
Clazz.newMeth(C$, 'iterator$', function () {
return Clazz.new_($I$(1,1).c$$gnu_trove_impl_hash_TObjectHash,[this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap']]);
});

Clazz.newMeth(C$, ['removeElement$TK','removeElement$TE'], function (key) {
return this.this$0.no_entry_value != this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].remove$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [key]);
});

Clazz.newMeth(C$, ['containsElement$TK','containsElement$TE'], function (key) {
return this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].contains$O.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [key]);
});

Clazz.newMeth(C$);
})()
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectByteCustomHashMap, "MapBackedView", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, 'clear$', function () {
this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].clear$.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].size$.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], []);
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].isEmpty$.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], []);
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectByteCustomHashMap, "TByteValueCollection", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
return this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].containsValue$B.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [($b$[0] = entry, $b$[0])]);
});

Clazz.newMeth(C$, 'toArray$', function () {
return this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].values$.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], []);
});

Clazz.newMeth(C$, 'toArray$BA', function (dest) {
return this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].values$BA.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [dest]);
});
...
this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [i]);
return true;
}}
return false;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].containsValue$B.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [($b$[0] = ele, $b$[0])])) {
return false;
}} else {
return false;
}}
...
while (iter.hasNext$()){
if (!this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].containsValue$B.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [($b$[0] = iter.next$(), $b$[0])])) {
return false;
}}
return true;
});
...
if (!this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].containsValue$B.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [($b$[0] = element, $b$[0])])) {
return false;
}}
return true;
});
...
return this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].forEachValue$gnu_trove_procedure_TByteProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [procedure]);
});

Clazz.newMeth(C$, 'toString', function () {
var buf=Clazz.new_($I$(6,1).c$$S,["{"]);
this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].forEachValue$gnu_trove_procedure_TByteProcedure.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [((P$.TObjectByteCustomHashMap$TByteValueCollection$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TObjectByteCustomHashMap$TByteValueCollection$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.procedure.TByteProcedure', 1);
...
), Clazz.new_(P$.TObjectByteCustomHashMap$TByteValueCollection$1.$init$, [this, {buf:buf}]))]);
buf.append$S("}");
return buf.toString();
});
var $b$ = new Int8Array(1);
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectByteCustomHashMap.TByteValueCollection, "TObjectByteValueHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
Clazz.newMeth(C$, '$init$', function () {
this._hash=this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'];
}, 1);
...
return $b$[0] = this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap']._values[this._index], $b$[0];
});
...
this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'].removeAt$I.apply(this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap'], [this._index]);
} finally {
...
if (this._expectedSize != this._hash.size$()) {
throw Clazz.new_(Clazz.load('java.util.ConcurrentModificationException'));
}var set=this.b$['gnu.trove.map.custom_hash.TObjectByteCustomHashMap']._set;
var i=this._index;
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TObjectByteCustomHashMap, "TObjectByteHashIterator", function(){
Clazz.newInstance(this, arguments[0],true,C$);
...
C$.$fields$=[['O',['_map','gnu.trove.map.custom_hash.TObjectByteCustomHashMap']]]

Clazz.newMeth(C$, 'c$$gnu_trove_map_custom_hash_TObjectByteCustomHashMap', function (map) {
