(function(){var P$=Clazz.newPackage("gnu.trove.list.array"),p$1={},I$=[[0,'java.util.Arrays',['gnu.trove.list.array.TFloatArrayList','.TFloatArrayIterator'],'gnu.trove.impl.HashFunctions','StringBuilder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TFloatArrayList", function(){
Clazz.newInstance(this, arguments,0,C$);
}, null, ['gnu.trove.list.TFloatList', 'java.io.Externalizable']);
C$.$classes$=[['TFloatArrayIterator',0]];
...
C$.$fields$=[['F',['no_entry_value'],'I',['_pos'],'O',['_data','float[]']]]

Clazz.newMeth(C$, 'c$', function () {
C$.c$$I$F.apply(this, [10, 0.0]);
}, 1);

Clazz.newMeth(C$, 'c$$I', function (capacity) {
C$.c$$I$F.apply(this, [capacity, 0.0]);
}, 1);

Clazz.newMeth(C$, 'c$$I$F', function (capacity, no_entry_value) {
;C$.$init$.apply(this);
this._data=Clazz.array(Float.TYPE, [capacity]);
this._pos=0;
...
Clazz.newMeth(C$, 'c$$FA', function (values) {
C$.c$$I.apply(this, [values.length]);
this.add$FA(values);
}, 1);

Clazz.newMeth(C$, 'c$$FA$F$Z', function (values, no_entry_value, wrap) {
;C$.$init$.apply(this);
...
Clazz.newMeth(C$, 'wrap$FA', function (values) {
return C$.wrap$FA$F(values, 0.0);
}, 1);

Clazz.newMeth(C$, 'wrap$FA$F', function (values, no_entry_value) {
return ((P$.TFloatArrayList$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TFloatArrayList$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, Clazz.load('gnu.trove.list.array.TFloatArrayList'), null, 1);
...
), Clazz.new_(C$.c$$FA$F$Z, [this, null, values, no_entry_value, true],P$.TFloatArrayList$1));
}, 1);
...
var tmp=Clazz.array(Float.TYPE, [newCap]);
...
var tmp=Clazz.array(Float.TYPE, [this.size$()]);
this.toArray$FA$I$I(tmp, 0, tmp.length);
this._data=tmp;
}});
...
this.add$FA$I$I(vals, 0, vals.length);
});
...
this.insert$I$FA$I$I(offset, values, 0, values.length);
});

Clazz.newMeth(C$, 'insert$I$FA$I$I', function (offset, values, valOffset, len) {
if (offset == this._pos) {
this.add$FA$I$I(values, valOffset, len);
return;
...
Clazz.newMeth(C$, 'setQuick$I$F', function (offset, val) {
this._data[offset]=val;
});
...
this._pos=0;
$I$(1).fill$FA$F(this._data, this.no_entry_value);
});
...
if ($I$(1).binarySearch$FA$F(array, data[i]) < 0) {
this.remove$I$I(i, 1);
changed=true;
}}
return changed;
...
var rv=Clazz.array(Float.TYPE, [len]);
this.toArray$FA$I$I(rv, offset, len);
return rv;
});
...
}this.toArray$FA$I$I(dest, 0, len);
return dest;
});
...
if (other === this ) {
return true;
} else if (Clazz.instanceOf(other, "gnu.trove.list.array.TFloatArrayList")) {
var that=other;
...
$I$(1).sort$FA$I$I(this._data, 0, this._pos);
});

Clazz.newMeth(C$, 'sort$I$I', function (fromIndex, toIndex) {
$I$(1).sort$FA$I$I(this._data, fromIndex, toIndex);
});

Clazz.newMeth(C$, 'fill$F', function (val) {
$I$(1).fill$FA$I$I$F(this._data, 0, this._pos, val);
});
...
this._pos=toIndex;
}$I$(1).fill$FA$I$I$F(this._data, fromIndex, toIndex, val);
});

Clazz.newMeth(C$, 'binarySearch$F', function (value) {
return this.binarySearch$F$I$I(value, 0, this._pos);
});
...
return this.lastIndexOf$I$F(this._pos, value);
});
...
return this.lastIndexOf$F(value) >= 0;
});
...
buf.append$F(this._data[i]);
buf.append$S(", ");
}
if (this.size$() > 0) {
buf.append$F(this._data[this._pos - 1]);
}buf.append$S("}");
return buf.toString();
});
...
var len=$in.readInt$();
this._data=Clazz.array(Float.TYPE, [len]);
for (var i=0; i < len; i++) {
this._data[i]=$in.readFloat$();
}
});
;
(function(){/*c*/var C$=Clazz.newClass(P$.TFloatArrayList, "TFloatArrayIterator", function(){
