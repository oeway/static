(function(){var P$=Clazz.newPackage("gnu.trove.list.linked"),p$1={},I$=[[0,['gnu.trove.list.linked.TShortLinkedList','.TShortLink'],'java.util.Arrays','gnu.trove.impl.HashFunctions','StringBuilder']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
/*c*/var C$=Clazz.newClass(P$, "TShortLinkedList", function(){
Clazz.newInstance(this, arguments,0,C$);
}, null, ['gnu.trove.list.TShortList', 'java.io.Externalizable']);
C$.$classes$=[['TShortLink',8],['RemoveProcedure',0]];
...
C$.$fields$=[['I',['size'],'H',['no_entry_value'],'O',['head','gnu.trove.list.linked.TShortLinkedList.TShortLink','+tail']]]

Clazz.newMeth(C$, 'c$', function () {
;C$.$init$.apply(this);
}, 1);

Clazz.newMeth(C$, 'c$$H', function (no_entry_value) {
;C$.$init$.apply(this);
...
var l=Clazz.new_($I$(1,1).c$$H,[val]);
if (C$.no$O(this.head)) {
this.head=l;
this.tail=l;
} else {
l.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(this.tail);
this.tail.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(l);
this.tail=l;
}this.size++;
return true;
});
...
tmp.add$H(value);
this.insert$I$gnu_trove_list_linked_TShortLinkedList(offset, tmp);
});

Clazz.newMeth(C$, 'insert$I$HA', function (offset, values) {
this.insert$I$gnu_trove_list_linked_TShortLinkedList(offset, C$.link$HA$I$I(values, 0, values.length));
});

Clazz.newMeth(C$, 'insert$I$HA$I$I', function (offset, values, valOffset, len) {
this.insert$I$gnu_trove_list_linked_TShortLinkedList(offset, C$.link$HA$I$I(values, valOffset, len));
});

Clazz.newMeth(C$, 'insert$I$gnu_trove_list_linked_TShortLinkedList', function (offset, tmp) {
var l=this.getLinkAt$I(offset);
this.size=this.size + tmp.size;
if (l === this.head ) {
tmp.tail.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(this.head);
this.head.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(tmp.tail);
this.head=tmp.head;
return;
}if (C$.no$O(l)) {
if (this.size == 0) {
...
this.tail.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(tmp.head);
tmp.head.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(this.tail);
this.tail=tmp.tail;
}} else {
var prev=l.getPrevious$();
l.getPrevious$().setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(tmp.head);
tmp.tail.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(l);
l.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(tmp.tail);
tmp.head.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(prev);
}});

Clazz.newMeth(C$, 'link$HA$I$I', function (values, valOffset, len) {
var ret=Clazz.new_(C$);
for (var i=0; i < len; i++) {
ret.add$H(values[valOffset + i]);
}
return ret;
}, 1);
...
if (offset <= (this.size$() >>> 1)) return C$.getLink$gnu_trove_list_linked_TShortLinkedList_TShortLink$I$I$Z(this.head, 0, offset, true);
 else return C$.getLink$gnu_trove_list_linked_TShortLinkedList_TShortLink$I$I$Z(this.tail, this.size$() - 1, offset, false);
});

Clazz.newMeth(C$, 'getLink$gnu_trove_list_linked_TShortLinkedList_TShortLink$I$I', function (l, idx, offset) {
return C$.getLink$gnu_trove_list_linked_TShortLinkedList_TShortLink$I$I$Z(l, idx, offset, true);
}, 1);

Clazz.newMeth(C$, 'getLink$gnu_trove_list_linked_TShortLinkedList_TShortLink$I$I$Z', function (l, idx, offset, next) {
var i=idx;
while (C$.got$O(l)){
if (i == offset) {
return l;
...
this.set$I$H(offset + i, value);
}
});

Clazz.newMeth(C$, 'replace$I$H', function (offset, val) {
return this.set$I$H(offset, val);
});
...
if (l.getValue$() == value) {
changed=true;
p$1.removeLink$gnu_trove_list_linked_TShortLinkedList_TShortLink.apply(this, [l]);
}}
return changed;
});

Clazz.newMeth(C$, 'removeLink$gnu_trove_list_linked_TShortLinkedList_TShortLink', function (l) {
if (C$.no$O(l)) return;
this.size--;
var prev=l.getPrevious$();
var next=l.getNext$();
if (C$.got$O(prev)) {
prev.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(next);
} else {
this.head=next;
}if (C$.got$O(next)) {
next.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(prev);
} else {
this.tail=prev;
}l.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(null);
l.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(null);
}, p$1);
...
var i=o;
if (!(this.contains$H((i).valueOf()))) return false;
} else {
return false;
}}
return true;
...
var i=it.next$();
if (!(this.contains$H(i))) return false;
}
return true;
});
...
if (this.add$H(v.shortValue$())) ret=true;
}
return ret;
});
...
var iter=this.iterator$();
while (iter.hasNext$()){
if ($I$(2).binarySearch$HA$H(array, iter.next$()) < 0) {
iter.remove$();
modified=true;
}}
return modified;
...
l.setValue$H($function.execute$(l.getValue$()));
l=l.getNext$();
}
});
...
tmp=l;
l=l.getNext$();
tmp.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(prev);
tmp.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(next);
}
this.head=t;
this.tail=h;
});
...
if (C$.got$O(tmp)) {
tmpHead.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(tmp);
stop.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(tmpHead);
}start.setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink(stop);
stop.setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink(start);
});
...
return this.toArray$HA$I$I(Clazz.array(Short.TYPE, [this.size]), 0, this.size);
});

Clazz.newMeth(C$, 'toArray$I$I', function (offset, len) {
return this.toArray$HA$I$I$I(Clazz.array(Short.TYPE, [len]), offset, 0, len);
});

Clazz.newMeth(C$, 'toArray$HA', function (dest) {
return this.toArray$HA$I$I(dest, 0, this.size);
});

Clazz.newMeth(C$, 'toArray$HA$I$I', function (dest, offset, len) {
return this.toArray$HA$I$I$I(dest, offset, 0, len);
});
...
$I$(2).sort$HA(vals);
this.set$I$HA(fromIndex, vals);
});

Clazz.newMeth(C$, 'fill$H', function (val) {
this.fill$I$I$H(0, this.size, val);
});
...
return this.binarySearch$H$I$I(value, 0, this.size$());
});
...
while (from < to){
mid=(from + to) >>> 1;
middle=C$.getLink$gnu_trove_list_linked_TShortLinkedList_TShortLink$I$I(fromLink, from, mid);
...
return this.lastIndexOf$I$H(0, value);
});
...
return ((P$.TShortLinkedList$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "TShortLinkedList$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'gnu.trove.iterator.TShortIterator', 1);

C$.$clinit$=2;

Clazz.newMeth(C$, '$init$', function () {
this.l=this.b$['gnu.trove.list.linked.TShortLinkedList'].head;
}, 1);

C$.$fields$=[['O',['l','gnu.trove.list.linked.TShortLinkedList.TShortLink','+current']]]

Clazz.newMeth(C$, 'next$', function () {
if (P$.TShortLinkedList.no$O(this.l)) throw Clazz.new_(Clazz.load('java.util.NoSuchElementException'));
...
return P$.TShortLinkedList.got$O(this.l);
});

Clazz.newMeth(C$, 'remove$', function () {
if (this.current == null ) throw Clazz.new_(Clazz.load('IllegalStateException'));
p$1.removeLink$gnu_trove_list_linked_TShortLinkedList_TShortLink.apply(this.b$['gnu.trove.list.linked.TShortLinkedList'], [this.current]);
this.current=null;
});
})()
), Clazz.new_(P$.TShortLinkedList$1.$init$, [this, null]));
});

Clazz.newMeth(C$, 'grep$gnu_trove_procedure_TShortProcedure', function (condition) {
var ret=Clazz.new_(C$);
for (var l=this.head; C$.got$O(l); l=l.getNext$()) {
if (condition.execute$(l.getValue$())) ret.add$H(l.getValue$());
}
return ret;
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortLinkedList, "TShortLink", function(){
...
C$.$fields$=[['H',['value'],'O',['previous','gnu.trove.list.linked.TShortLinkedList.TShortLink','+next']]]
...
Clazz.newMeth(C$, 'setValue$H', function (value) {
this.value=value;
});
...
Clazz.newMeth(C$, 'setPrevious$gnu_trove_list_linked_TShortLinkedList_TShortLink', function (previous) {
...
Clazz.newMeth(C$, 'setNext$gnu_trove_list_linked_TShortLinkedList_TShortLink', function (next) {
this.next=next;
});
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.TShortLinkedList, "RemoveProcedure", function(){
Clazz.newInstance(this, arguments[0],true,C$);
}, null, 'gnu.trove.procedure.TShortProcedure');
...
if (this.this$0.remove$H.apply(this.this$0, [value])) this.changed=true;
return true;
});
