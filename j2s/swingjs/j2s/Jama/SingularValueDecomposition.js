(function(){var P$=Clazz.newPackage("Jama"),I$=[[0,'Jama.util.Maths','Jama.Matrix']],$I$=function(i,n){return(i=(I$[i]||(I$[i]=Clazz.load(I$[0][i])))),!n&&i.$load$&&Clazz.load(i,2),i};
...
return Clazz.new_($I$(2,1).c$$DAA$I$I,[this.U, this.m, Math.min(this.m + 1, this.n)]);
});
